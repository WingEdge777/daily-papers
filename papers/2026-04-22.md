...
### 1. **[OneVL: One-Step Latent Reasoning and Planning with Vision-Language Explanation](https://arxiv.org/abs/2604.18486v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Jinghui Lu, Jiayi Guan, Zhijian Huang et al.
- **标签**: `cs.CV` `cs.CL` `cs.RO`
- **AI摘要**: 提出OneVL实现端到端自动驾驶实时推理与规划
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过视觉世界模型辅助潜空间推理，兼顾精度与速度

### 2. **[XEmbodied: A Foundation Model with Enhanced Geometric and Physical Cues for Large-Scale Embodied Environments](https://arxiv.org/abs/2604.18484v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Kangan Qian, ChuChu Xie, Yang Zhong et al.
- **标签**: `cs.CV` `cs.MM` `cs.RO`
- **AI摘要**: 提出XEmbodied模型，增强具身智能的3D几何感知能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过3D适配器提升了VLA模型的空间推理与物理交互性能，实验扎实。

### 3. **[Progressive Online Video Understanding with Evidence-Aligned Timing and Transparent Decisions](https://arxiv.org/abs/2604.18459v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Kecheng Zhang, Zongxin Yang, Mingfei Han et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出在线视频理解框架，实现证据对齐与透明决策。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决在线视频推理时效与透明度问题，实验效果显著。

### 4. **[EVE: Verifiable Self-Evolution of MLLMs via Executable Visual Transformations](https://arxiv.org/abs/2604.18320v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Yongrui Heng, Chaoya Jiang, Han Yang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出EVE框架实现MLLM可验证的自我演化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过代码执行生成真值，有效解决了伪标签漂移问题。

### 5. **[S2H-DPO: Hardness-Aware Preference Optimization for Vision-Language Models](https://arxiv.org/abs/2604.18512v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Nitish Shukla, Surgan Jandial, Arun Ross
- **标签**: `cs.CV`
- **AI摘要**: 提出S2H-DPO框架提升多图推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分级难度数据构建优化多图对齐，方法论严谨且实用。
...
### 1. **[Attraction, Repulsion, and Friction: Introducing DMF, a Friction-Augmented Drifting Model](https://arxiv.org/abs/2604.18194v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Arkadii Kazanskii, Tatiana Petrova, Konstantin Bagrianskii et al.
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 引入摩擦项优化漂移模型，提升生成效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨且实验效率提升显著，贡献扎实。

### 2. **[Long-Text-to-Image Generation via Compositional Prompt Decomposition](https://arxiv.org/abs/2604.18258v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Jen-Yuan Huang, Tong Lin, Yilun Du
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出PRISM框架实现长文本到图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过提示词分解与能量结合提升长文本生成能力，方法创新且实验扎实。

### 3. **[Extending One-Step Image Generation from Class Labels to Text via Discriminative Text Representation](https://arxiv.org/abs/2604.18168v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Chenxi Zhao, Chen Zhu, Xiaokun Feng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于判别式文本表征的单步图像生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了单步生成中文本条件难以对齐的问题，方法创新且实用。

## Video Generation

### 1. **[Training and Agentic Inference Strategies for LLM-based Manim Animation Generation](https://arxiv.org/abs/2604.18364v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Ravidu Suien Rammuni Silva, Ahmad Lotfi, Isibor Kennedy Ihianle et al.
- **标签**: `cs.AI` `cs.GR` `cs.MA`
- **AI摘要**: 提出Manim动画生成训练与推理框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合SFT与RL优化，显著提升代码与视觉生成质量。

### 2. **[AdaCluster: Adaptive Query-Key Clustering for Sparse Attention in Video Generation](https://arxiv.org/abs/2604.18348v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Haoyue Tan, Shengnan Wang, Yulin Qiao et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出AdaCluster加速视频扩散模型推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验在主流模型上验证了显著加速效果。

### 3. **[OmniHuman: A Large-scale Dataset and Benchmark for Human-Centric Video Generation](https://arxiv.org/abs/2604.18326v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Lei Zhu, Xing Cai, Yingjie Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出OmniHuman数据集与基准以提升人像视频生成质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模数据集与多维度评估体系填补了人像生成领域空白

### 4. **[Memorize When Needed: Decoupled Memory Control for Spatially Consistent Long-Horizon Video Generation](https://arxiv.org/abs/2604.18215v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Yanjun Guo, Zhengqiang Zhang, Pengfei Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出解耦记忆控制框架以提升视频生成空间一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了长视频生成中的一致性难题

### 5. **[MultiWorld: Scalable Multi-Agent Multi-View Video World Models](https://arxiv.org/abs/2604.18564v1)**
- **评分**: ⭐ 72/100 | **日期**: 2026-04-20
- **作者**: Haoyu Wu, Jiwen Yu, Yingtian Zou et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MultiWorld框架，实现多智能体多视角的一致性视频生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对多智能体多视角建模提出创新模块，实验充分，在视频一致性和控制性上表现优异。
...
### 1. **[Block-encodings as programming abstractions: The Eclipse Qrisp BlockEncoding Interface](https://arxiv.org/abs/2604.18276v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Matic Petrič, René Zander
- **标签**: `quant-ph` `cs.ET` `cs.LG`
- **AI摘要**: 提出Qrisp框架的块编码接口以简化量子算法开发。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该工作为量子算法开发提供了实用的编程抽象，架构清晰且具有较高工程价值。

### 2. **[Semantic-based Distributed Learning for Diverse and Discriminative Representations](https://arxiv.org/abs/2604.18237v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-04-20
- **作者**: Zhuojun Tian, Chaouki Ben Issaid, Mehdi Bennis
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出一种分布式学习框架以增强表示的多样性与判别性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论严谨，有效解决了非独立同分布下的表示坍缩问题。

## Operating Systems

### 1. **[Proxics: an efficient programming model for far memory accelerators](https://arxiv.org/abs/2604.18120v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Zikai Liu, Niels Pressel, Jasmin Schult et al.
- **标签**: `cs.OS` `cs.AR` `cs.ET`
- **AI摘要**: 提出Proxics模型以高效编程远端内存加速器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地通过轻量级OS抽象解决NDP编程难题，实验扎实且具有实用价值。

## Information Retrieval

### 1. **[Document-as-Image Representations Fall Short for Scientific Retrieval](https://arxiv.org/abs/2604.18508v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Ghazal Khalighinejad, Raghuveer Thirukovalluru, Alexander H. Oh et al.
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 提出ArXivDoc基准，论证文本表示优于图像表示。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，对科学文档检索范式有重要启发。

### 2. **[Balanced Co-Clustering of Users and Items for Embedding Table Compression in Recommender Systems](https://arxiv.org/abs/2604.18351v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Runhao Jiang, Renchi Yang, Donghao Wu
- **标签**: `cs.IR` `cs.LG`
- **AI摘要**: 提出BACO框架实现嵌入表压缩与高效推荐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过协同聚类显著降低参数量并提升计算速度，实验扎实。

### 3. **[Decisive: Guiding User Decisions with Optimal Preference Elicitation from Unstructured Documents](https://arxiv.org/abs/2604.18122v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Akriti Jain, Anish Mulay, Divyansh Verma et al.
- **标签**: `cs.CL`
- **AI摘要**: 基于贝叶斯推理的交互式决策框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合文档推理与偏好学习，方法创新且实验扎实。

### 4. **[Context-Aware Search and Retrieval Under Token Erasure](https://arxiv.org/abs/2604.18424v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Sara Ghasvarianjahromi, Joshua Barr, Yauhen Yakimenka et al.
- **标签**: `cs.IR` `cs.IT`
- **AI摘要**: 提出基于特征重要性的抗擦除检索模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析严谨且具有实际应用潜力，创新性较强。

### 5. **[Towards Robust Text-to-Image Person Retrieval: Multi-View Reformulation for Semantic Compensation](https://arxiv.org/abs/2604.18376v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Chao Yuan, Yujian Zhao, Haoxuan Xu et al.
- **标签**: `cs.CV`
- **AI摘要**: 利用LLM重构多视角语义提升行人检索鲁棒性
<details>
<summary>原始摘要</summary>
...
### 1. **[Learning the Riccati solution operator for time-varying LQR via Deep Operator Networks](https://arxiv.org/abs/2604.18507v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
...
- **评分理由**: 结合工业级CFD数据与图神经网络，创新性强且实用

### 3. **[Physics-Informed Neural Networks: A Didactic Derivation of the Complete Training Cycle](https://arxiv.org/abs/2604.18481v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Abdeladhim Tahimi
- **标签**: `math.NA` `cs.LG`
- **AI摘要**: 通过手动推导揭示PINN训练全流程的数学本质。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 教学价值极高，通过显式推导弥补了现有教程的黑盒缺陷。

### 4. **[An Integrated Deep-Learning Framework for Peptide-Protein Interaction Prediction and Target-Conditioned Peptide Generation with ConGA-PePPI and TC-PepGen](https://arxiv.org/abs/2604.18467v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Chupei Tang, Junxiao Kong, Moyu Tang et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 集成深度学习框架实现多肽相互作用预测与生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在多肽药物筛选领域具有较高应用价值。

### 5. **[Random Matrix Theory of Early-Stopped Gradient Flow: A Transient BBP Scenario](https://arxiv.org/abs/2604.18450v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Florentin Coeurdoux, Grégoire Ferré, Jean-Philippe Bouchaud
- **标签**: `stat.ML` `cs.LG` `math.ST`
- **AI摘要**: 利用随机矩阵理论揭示早停机制的瞬态BBP相变现象
<details>
<summary>原始摘要</summary>
