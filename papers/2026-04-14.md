...
### 1. **[Arbitration Failure, Not Perceptual Blindness: How Vision-Language Models Resolve Visual-Linguistic Conflicts](https://arxiv.org/abs/2604.09364v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-10
- **作者**: Farhad Nooralahzadeh, Omid Rohanian, Yi Zhang et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 揭示VLM视觉冲突源于仲裁机制而非感知能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且方法严谨，对VLM可解释性有重要贡献。

### 2. **[ECHO: Efficient Chest X-ray Report Generation with One-step Block Diffusion](https://arxiv.org/abs/2604.09450v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-10
- **作者**: Lifeng Chen, Tianqi You, Hao Liu et al.
- **标签**: `cs.LG` `cs.AI` `eess.IV`
- **AI摘要**: 提出ECHO模型实现胸片报告的一步扩散生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过DCD框架实现高效一步生成，性能与速度兼顾。

### 3. **[Tango: Taming Visual Signals for Efficient Video Large Language Models](https://arxiv.org/abs/2604.09547v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Shukang Yin, Sirui Zhao, Hanchao Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Tango框架优化视频LLM的视觉token剪枝效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多样性选择与位置编码改进，显著提升了推理效率与性能。

### 4. **[VL-Calibration: Decoupled Confidence Calibration for Large Vision-Language Models Reasoning](https://arxiv.org/abs/2604.09529v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Wenyi Xiao, Xinchi Xu, Leilei Gan
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出解耦视觉与推理置信度的校准框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，有效缓解了多模态幻觉问题。

### 5. **[RIRF: Reasoning Image Restoration Framework](https://arxiv.org/abs/2604.09511v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Wending Yan, Rongkai Zhang, Kaihua Tang et al.
- **标签**: `cs.CV`
- **AI摘要**: 引入CoT推理的通用图像修复框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合多模态推理与图像修复，实验扎实且具有可解释性。
...
### 1. **[ELT: Elastic Looped Transformers for Visual Generation](https://arxiv.org/abs/2604.09168v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Sahil Goyal, Swayam Agrawal, Gautham Govind Anil et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出弹性循环Transformer，实现高效视觉生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过权重共享与自蒸馏提升参数效率，实验效果显著。

### 2. **[Region-Constrained Group Relative Policy Optimization for Flow-Based Image Editing](https://arxiv.org/abs/2604.09386v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-10
- **作者**: Zhuohan Ouyang, Zhe Qian, Wenhuo Cui et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出RC-GRPO框架优化流模型图像编辑的局部一致性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过区域约束解决GRPO在图像编辑中的噪声分配问题，方法创新且实验扎实。

## Video Generation

### 1. **[Rays as Pixels: Learning A Joint Distribution of Videos and Camera Trajectories](https://arxiv.org/abs/2604.09429v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Wonbong Jang, Shikun Liu, Soubhik Sanyal et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 联合学习视频与相机轨迹的扩散模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将相机轨迹与视频生成建模，方法严谨且实用。

### 2. **[CT-1: Vision-Language-Camera Models Transfer Spatial Reasoning Knowledge to Camera-Controllable Video Generation](https://arxiv.org/abs/2604.09201v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Haoyu Zhao, Zihao Zhang, Jiaxi Gu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CT-1模型实现精准摄像机轨迹控制视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且数据集规模大，实验结果显著优于现有方案。

### 3. **[Tora3: Trajectory-Guided Audio-Video Generation with Physical Coherence](https://arxiv.org/abs/2604.09057v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Junchao Liao, Zhenghao Zhang, Xiangyu Meng et al.
...
- **评分理由**: 通过轨迹先验提升了音视频物理一致性，方法创新且实验扎实。

### 4. **[VAG: Dual-Stream Video-Action Generation for Embodied Data Synthesis](https://arxiv.org/abs/2604.09330v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-10
- **作者**: Xiaolei Lang, Yang Wang, Yukun Zhou et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出VAG双流框架实现视频与动作的联合生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过流匹配实现视动对齐，有效缓解具身智能数据匮乏问题。

### 5. **[Camera Artist: A Multi-Agent Framework for Cinematic Language Storytelling Video Generation](https://arxiv.org/abs/2604.09195v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-10
- **作者**: Haobo Hu, Qi Mao, Yuanhang Li et al.
- **标签**: `cs.AI`
- **AI摘要**: 引入多智能体框架提升视频叙事连贯性
<details>
<summary>原始摘要</summary>
...
### 1. **[TensorHub: Scalable and Elastic Weight Transfer for LLM RL Training](https://arxiv.org/abs/2604.09107v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-10
- **作者**: Chenhao Ye, Huaizheng Zhang, Mingcong Han et al.
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 提出ROS存储抽象以优化LLM强化学习权重传输效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决分布式训练瓶颈，实验数据详实且具工业价值

### 2. **[Sustaining Exascale Performance: Lessons from HPL and HPL-MxP on Aurora](https://arxiv.org/abs/2604.09517v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Kazushige Goto, Huda Ibeid, Kalyan Kumaran et al.
- **标签**: `cs.DC`
- **AI摘要**: Aurora超算系统性能优化与实战经验总结
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统级实战经验丰富，对超大规模计算具有重要参考价值。

### 3. **[Distributed Online Convex Optimization with Compressed Communication: Optimal Regret and Applications](https://arxiv.org/abs/2604.09276v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Sifan Yang, Dan-Yue Li, Lijun Zhang
- **标签**: `cs.LG`
- **AI摘要**: 提出分布式在线凸优化压缩通信算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且界限最优，在分布式学习中具实用价值

### 4. **[XFED: Non-Collusive Model Poisoning Attack Against Byzantine-Robust Federated Classifiers](https://arxiv.org/abs/2604.09489v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-10
- **作者**: Israt Jahan Mouri, Muhammad Ridowan, Muhammad Abdullah Adnan
- **标签**: `cs.CR` `cs.AI` `cs.DC`
- **AI摘要**: 提出非共谋联邦学习投毒攻击XFED
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出非共谋攻击模型，实验验证充分且有效。

### 5. **[NOMAD: Generating Embeddings for Massive Distributed Graphs](https://arxiv.org/abs/2604.09419v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-10
- **作者**: Aishwarya Sarkar, Sayan Ghosh, Nathan R. Tallent et al.
- **标签**: `cs.LG` `cs.DC`
- **AI摘要**: 提出NOMAD分布式图嵌入框架，大幅提升大规模图处理效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过MPI实现分布式图嵌入，显著提升了大规模图计算的性能。

## Information Retrieval

### 1. **[Trans-RAG: Query-Centric Vector Transformation for Secure Cross-Organizational Retrieval](https://arxiv.org/abs/2604.09541v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Yu Liu, Kun Peng, Wenxiao Zhang et al.
- **标签**: `cs.CR` `cs.IR`
- **AI摘要**: 提出跨组织安全检索的向量转换框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决跨域隐私与检索效率平衡，实验详实。

### 2. **[Facet-Level Tracing of Evidence Uncertainty and Hallucination in RAG](https://arxiv.org/abs/2604.09174v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Passant Elchafei, Monorama Swain, Shahed Masoudian et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出细粒度RAG诊断框架以分析幻觉成因
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过原子化推理切面揭示了RAG幻觉的生成端根源，方法严谨且具有高实用价值。

### 3. **[Dynamic Ranked List Truncation for Reranking Pipelines via LLM-generated Reference-Documents](https://arxiv.org/abs/2604.09492v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-10
- **作者**: Nilanjan Sinhababu, Soumedhik Bharati, Debasis Ganguly et al.
- **标签**: `cs.IR`
- **AI摘要**: 利用LLM生成参考文档实现高效重排序截断
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，显著提升了重排序效率。

### 4. **[Decoupling Vector Data and Index Storage for Space Efficiency](https://arxiv.org/abs/2604.09173v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-10
- **作者**: Yuanming Ren, Juncheng Zhang, Yanjing Ren et al.
- **标签**: `cs.DB` `cs.OS`
- **AI摘要**: 提出DecoupleVS架构，优化向量存储效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦存储提升了大规模向量检索的性能与空间效率

### 5. **[FIRE-CIR: Fine-grained Reasoning for Composed Fashion Image Retrieval](https://arxiv.org/abs/2604.09114v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-10
- **作者**: François Gardères, Camille-Sovanneary Gauthier, Jean Ponce et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出FIRE-CIR模型，通过视觉推理提升时尚图像检索准确性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入视觉问答机制增强检索可解释性，方法创新且实验扎实。
...
### 1. **[SafeMind: A Risk-Aware Differentiable Control Framework for Adaptive and Safe Quadruped Locomotion](https://arxiv.org/abs/2604.09474v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-10
- **作者**: Zukun Zhang, Kai Shu, Mingqiao Mo
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出风险感知四足机器人控制框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合CBF与元学习，在复杂环境下显著提升安全性与能效。

### 2. **[Physics-guided surrogate learning enables zero-shot control of turbulent wings](https://arxiv.org/abs/2604.09434v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-10
- **作者**: Yuning Wang, Pol Suarez, Mathis Bode et al.
- **标签**: `physics.flu-dyn` `cs.AI`
- **AI摘要**: 物理引导的强化学习实现机翼湍流零样本控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入物理约束实现高效零样本迁移，实验严谨且效果显著。

### 3. **[Iterative Identification Closure: Amplifying Causal Identifiability in Linear SEMs](https://arxiv.org/abs/2604.09309v1)**
- **评分**: ⭐ 86/100 | **日期**: 2026-04-10
- **作者**: Ziyi Ding, Xiao-Ping Zhang
- **标签**: `stat.ML` `cs.LG` `stat.CO`
- **AI摘要**: 提出迭代识别闭包框架，显著提升线性SEM因果识别率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，通过迭代传播机制大幅弥补了HTC的识别缺口，实验验证严谨。

### 4. **[EquiformerV3: Scaling Efficient, Expressive, and General SE(3)-Equivariant Graph Attention Transformers](https://arxiv.org/abs/2604.09130v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-10
- **作者**: Yi-Lun Liao, Alexander J. Hoffman, Sabrina C. Shen et al.
- **标签**: `cs.LG` `cs.AI` `physics.comp-ph`
- **AI摘要**: 提出EquiformerV3，提升SE(3)等变图Transformer效率与性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在原子建模领域实现显著性能提升，实验严谨且具有高实用价值。

### 5. **[ANTIC: Adaptive Neural Temporal In-situ Compressor](https://arxiv.org/abs/2604.09543v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-10
- **作者**: Sandeep S. Cranganore, Andrei Bodnar, Gianluca Galleti et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出一种自适应神经时空原位压缩框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过神经场实现高效时空压缩，对HPC领域具有显著应用价值
