...
### 1. **[Natural Ungrokking: Asymmetric Control of Which Rules Survive Pretraining](https://arxiv.org/abs/2606.26050v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-24
- **作者**: Juliana Li, Diya Sreedhar
- **标签**: `cs.LG` `cond-mat.dis-nn` `cs.AI`
- **AI摘要**: 揭示预训练中规则遗忘的自然机制
<details>
...
- **评分理由**: 研究深入揭示了模型预训练中规则消失的规律，实验严谨且具有重要理论价值。

### 2. **[Reclaim Evaluation: A Lossy Memory Is Worse Than an Empty One](https://arxiv.org/abs/2606.25449v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-24
- **作者**: Alex Kwon
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出保留源信息而非结论的内存优化策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了模型记忆丢失的机制并提供有效修复方案

### 3. **[On-Policy Self-Distillation with Sampled Demonstrations Reduces Output Diversity](https://arxiv.org/abs/2606.26091v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Andrei Liviu Nicolicioiu, Mohammad Pezeshki, Aaron Courville
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 揭示自蒸馏导致输出多样性下降的机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入且实验设计严谨，揭示了模型训练的隐性缺陷。

### 4. **[Weave of Formal Thought](https://arxiv.org/abs/2606.25987v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Alexandre Bouayad
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出WoFT框架实现代码生成语法约束与结构学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合GLR解析与潜在变量训练，显著提升代码生成质量。
...
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出投资哲学推理基准InvestPhilBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了严谨的投资决策推理评估框架，指标体系完善。

## Natural Language Processing

### 1. **[When Certainty Is an Artifact: Keyword Lexicon Blindness and the (Mis)Measurement of Rhetorical Stance](https://arxiv.org/abs/2606.26062v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Bo Chen
- **标签**: `cs.CL`
- **AI摘要**: 揭示关键词词典在测量修辞立场时的系统性偏差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对比LLM与关键词法，有力论证了测量工具的局限性。

### 2. **[AI translation of literary texts is "fine", but readers still prefer human translations](https://arxiv.org/abs/2606.26040v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Yves Ferstler, Adam Podoxin, Ty Brassington et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示文学翻译中读者对AI与人类译文的偏好差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，填补了文学翻译评估中读者体验的空白。

### 3. **[Detect, Unlearn, Restore: Defending Text Summarization Models Against Data Poisoning](https://arxiv.org/abs/2606.26036v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
...
### 4. **[Overview of HIPE-2026: Person-Place Relation Extraction from Multilingual Historical Texts](https://arxiv.org/abs/2606.25935v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Juri Opitz, Maud Ehrmann, Corina Raclé et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出多语言历史文本中人物与地点关系提取的评估框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模评测推动了历史文档关系抽取技术的发展，方法严谨。

### 5. **[Do Encoders Suffice? A Systematic Comparison of Encoder and Decoder Safety Judges for LLM Adversarial Evaluation](https://arxiv.org/abs/2606.25782v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Han Jeon, Shiv Medler, Joseph Voyles et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 评估编码器作为LLM安全判别器的效能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，为低成本安全评估提供了实用方案

## Vision Language Models

### 1. **[Disease-Centric Vision-Language Pretraining with Hybrid Visual Encoding for 3D Computed Tomography](https://arxiv.org/abs/2606.25546v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-24
- **作者**: Bowen Shi, Weiwei Cao, Ruifeng Yuan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出混合编码与疾病对比学习的3D CT视觉语言预训练框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在多项CT诊断任务上取得显著提升。

### 2. **[TriViewBench: Controlled Complexity Scaling for Multi-View Structural Reasoning in MLLMs](https://arxiv.org/abs/2606.26029v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Yu-Yang Chen, Lan-Zhe Guo
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出TriViewBench评估多视图结构推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过受控合成场景揭示了多模态模型在空间推理上的局限性，方法严谨且具有诊断价值。

### 3. **[Enhancing Brain MRI Anomaly Detection and Reasoning with ROI Rethink and Synthetic Data](https://arxiv.org/abs/2606.25894v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Shangkun Li, Jie Xu, Yi Guo et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出BrReMark框架提升脑部MRI诊断可解释性与准确度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入ROI标记与验证机制，显著降低幻觉并提升诊断性能

### 4. **[Graph it first! Enabling Reasoning on Long-form Egocentric Videos through Scene Graphs](https://arxiv.org/abs/2606.25842v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Agnese Taluzzi, Riccardo Santambrogio, Simone Mentasti et al.
- **标签**: `cs.CV`
- **AI摘要**: 利用场景图压缩视频以提升长视频理解能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出EgoSG结构化表示，有效解决MLLM长视频处理瓶颈，实验效果显著。

### 5. **[ROAD-VLA: Robust Online Adaptation via Self-Distillation for Vision-Language-Action Models](https://arxiv.org/abs/2606.25800v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Kejing Wang, Toan Nguyen, Minh Hoang Nguyen et al.
- **标签**: `cs.LG` `cs.RO`
- **AI摘要**: 提出基于优势引导的自蒸馏框架，实现VLA模型在线自适应。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了机器人在线学习难题。

## Diffusion Models

### 1. **[UniTeD: Unified Temporal Diffusion for Joint Perception and Planning in Autonomous Driving](https://arxiv.org/abs/2606.25736v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Bo Zhao, Xinting Zhao, Naifan Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出统一时序扩散框架，实现感知与规划联合优化。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过扩散模型整合感知与规划，有效提升自动驾驶鲁棒性。

### 2. **[Spatio-Temporal Mixture-of-Modality-Experts Diffusion for Quantitative DCE-MRI Synthesis from Incomplete MR Sequences](https://arxiv.org/abs/2606.25535v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Junhyeok Lee, Kyu Sung Choi
- **标签**: `cs.CV`
- **AI摘要**: 基于混合专家扩散模型的DCE-MRI合成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，解决了多模态缺失下的定量合成难题。

### 3. **[In-context Region-based Drag: Drag Any Region to Any Shape](https://arxiv.org/abs/2606.25907v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Jiacheng Sui, Tianyu Hao, Bingjie Gao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于区域的扩散模型拖拽编辑方法ICRDrag
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入区域注意力正则化与新数据集，提升了编辑精度

## Multimodal

### 1. **[SurgAtlas: A Large-Scale Surgical Video-Language Dataset with 2,391 Hours of Open and Minimally Invasive Surgery](https://arxiv.org/abs/2606.25905v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-24
- **作者**: Filippos Bellos, Andre S. Gala-Garza, Miaowei Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 构建大规模手术视频语言数据集SurgAtlas
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模宏大且覆盖面广，显著推动手术AI研究进展。

### 2. **[Same Evidence, Different Answer: Auditing Order Sensitivity in Multimodal Large Language Models](https://arxiv.org/abs/2606.26079v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-24
- **作者**: Akshay Paruchuri, Sanmi Koyejo, Ehsan Adeli
- **标签**: `cs.CL` `cs.CV` `cs.LG`
- **AI摘要**: 提出Facet-Probe评估多模态模型顺序敏感性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨，揭示了多模态模型普遍存在的顺序偏差问题。

### 3. **[Real-Time Voice AI Hears but Does Not Listen](https://arxiv.org/abs/2606.26083v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Martijn Bartelds, Federico Bianchi, James Zou
- **标签**: `cs.CL` `eess.AS`
- **AI摘要**: 揭示实时语音AI存在情感智能鸿沟，忽视语调信息。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了主流语音AI在处理情感语境时的决策缺陷，具有重要现实意义。
...
- **AI摘要**: 提出SpeechEQ基准评估语音模型的社交情感智能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了语音对话模型情感智能评估的空白，方法严谨且具有高实用价值。

### 5. **[STEB: A Speech-to-Speech Translation Expressiveness Benchmark for Evaluating Beyond Translation Fidelity](https://arxiv.org/abs/2606.25529v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Sitong Cheng, Weizhen Bian, Songjun Cao et al.
- **标签**: `cs.SD` `cs.AI`
- **AI摘要**: 提出STEB基准以评估语音翻译的表达能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了语音翻译在情感与非语言表达评估上的空白，方法严谨且具有实用价值。

## Image Generation

### 1. **[MIMFlow: Integrating Masked Image Modeling with Normalizing Flows for End-to-End Image Generation](https://arxiv.org/abs/2606.26016v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Yang Chen, Xiaowei Xu, Shuai Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MIM与流模型结合的生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦语义与细节提升了生成质量与效率，实验表现优异。

### 2. **[Concept Removal for Frontier Image Generative Models](https://arxiv.org/abs/2606.25548v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Aditya Kumar, Pierre Joly, Adam Dziedzic et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出一种基于转码器的图像生成模型概念移除方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验充分，在模型安全性上表现出色。

### 3. **[H-Adapter: Pose-Robust Hairstyle Transfer via Attention-Derived, Source-Aligned Hair Masks](https://arxiv.org/abs/2606.25578v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Seulgi Jeong, Yunseong Cho, Sanghun Park
- **标签**: `cs.CV`
- **AI摘要**: 提出H-Adapter实现姿态鲁棒的发型迁移
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过注意力机制优化发型迁移，实验验证效果显著。

## Video Generation

### 1. **[MVTrack4Gen: Multi-View Point Tracking as Geometric Supervision for 4D Video Generation](https://arxiv.org/abs/2606.26087v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: JoungBin Lee, Jaewoo Jung, Jongmin Lee et al.
- **标签**: `cs.CV`
- **AI摘要**: 引入多视角点追踪提升4D视频生成一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过点追踪监督增强扩散模型几何与运动一致性，方法创新且实验扎实。

### 2. **[VPA-Guard: Defending and Benchmarking Image-to-Video Generation Against Visual Prompt Attacks](https://arxiv.org/abs/2606.25592v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Yining Sun, Haoyu Kang, Jiajun Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出VPA-Guard防御框架与VVA-Bench基准以应对I2V视觉提示攻击
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对I2V生成模型安全性的开创性研究，基准与防御方案设计严谨且实用。

### 3. **[Recommendation as Generation: Unifying Personalized Video Generation and Recommendation at Industrial Scale](https://arxiv.org/abs/2606.25496v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Yanhua Cheng, Bo Wang, Haotian Zhang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出RaG框架，实现个性化视频生成与推荐的统一。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业级规模验证，创新性地将生成模型引入推荐系统。

### 4. **[Causal-rCM: A Unified Teacher-Forcing and Self-Forcing Open Recipe for Autoregressive Diffusion Distillation in Streaming Video Generation and Interactive World Models](https://arxiv.org/abs/2606.25473v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Kaiwen Zheng, Guande He, Min Zhao et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出Causal-rCM实现高效流式视频生成与交互世界模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过TF与SF结合实现高效蒸馏，在视频生成领域性能领先且具备实用性。

### 5. **[DomainShuttle: Freeform Open Domain Subject-driven Text-to-video Generation](https://arxiv.org/abs/2606.26058v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Nan Chen, Yiyang Cai, Rongchang Xie et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出DomainShuttle实现跨域视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦与双RoPE机制提升了视频生成的主体保真度与灵活性
...
- **评分理由**: 通过形式化验证与架构隔离实现高鲁棒性AI控制，方法严谨且创新。

### 2. **[Uncertainty Quantification for Computer-Use Agents: A Benchmark across Vision-Language Models and GUI Grounding Datasets](https://arxiv.org/abs/2606.25760v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-24
- **作者**: Divake Kumar, Sina Tayebati, Devashri Naik et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出GUI智能体不确定性量化基准Argus
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估了多模型与数据集下的UQ方法，实验严谨且具有极高实用价值。

### 3. **[Agentic evolution of physically constrained foundation models](https://arxiv.org/abs/2606.25532v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-24
- **作者**: Jiangwei Zhang, Wen Sun, Chong Wang et al.
- **标签**: `cs.AI` `cs.AR` `cs.LG`
- **AI摘要**: 提出物理约束下的智能体演化架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过知识图谱实现硬件协同设计，性能提升显著，方法论创新。

### 4. **[Neglected Free Lunch from Post-training: Progress Advantage for LLM Agents](https://arxiv.org/abs/2606.26080v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-24
- **作者**: Changdae Oh, Wendi Li, Seongheon Park et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 利用RL训练副产品实现零样本步级奖励评估
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新显著，无需额外标注即可提升智能体性能

### 5. **[Learning Action Priors for Cross-embodiment Robot Manipulation](https://arxiv.org/abs/2606.26095v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Dong Jing, Tianqi Zhang, Jiaqi Liu et al.
- **标签**: `cs.RO` `cs.AI` `cs.CV`
- **AI摘要**: 提出两阶段预训练框架，通过动作先验提升机器人操控性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效解决了跨具身动作学习难题。

## Distributed Computing

### 1. **[EmuGEMM: Fused Tensor Core Kernels for Precision Emulation in Matrix Multiplication](https://arxiv.org/abs/2606.25453v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-24
- **作者**: Denghui Lu, Alexander Maeder, Mathieu Luisier et al.
- **标签**: `cs.DC` `cs.MS` `cs.PF`
- **AI摘要**: 提出EmuGEMM实现高精度矩阵乘法加速
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过算子融合显著提升了GPU矩阵运算性能

### 2. **[Endeavor: Efficient PairHMM for Detection of DNA Variants in Genome-Scale Datasets](https://arxiv.org/abs/2606.25738v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Miguel Graça, Aleksandar Ilic
- **标签**: `cs.DC`
- **AI摘要**: 提出Endeavor加速PairHMM变异检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过行级并行优化显著提升了基因组数据处理效率

### 3. **[Interference-Aware Cross-Application Placement: A Multi-Objective Optimization Approach for Microservice Clusters](https://arxiv.org/abs/2606.25922v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Iqra Zafar, Christian Medeiros Adriano, Holger Giese
- **标签**: `cs.DC`
- **AI摘要**: 基于因果推理的微服务干扰感知部署优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果建模解决资源竞争问题，方法论严谨且实用。

### 4. **[NEURON-Fabric: Architecture-Runtime Co-Design for Controlled Low-Bit Gradient Communication](https://arxiv.org/abs/2606.25759v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
...
- **评分理由**: 通过运行时协同设计优化分布式训练通信，兼具创新与实用性。

### 5. **[TL++: Accuracy and Privacy Preserving Traversal Learning for Distributed Intelligent Systems](https://arxiv.org/abs/2606.25627v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Erdenebileg Batbaatar, Young Yoon
- **标签**: `cs.LG` `cs.AI` `cs.CR`
- **AI摘要**: 提出TL++框架实现分布式隐私保护训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过虚拟批处理与秘密共享提升了分布式学习的效率与安全性

## Information Retrieval

### 1. **[Security and Privacy in Retrieval-Augmented Generation: Architectures, Threats, Defenses, and Future Directions for Building Trustworthy Systems](https://arxiv.org/abs/2606.25533v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Balamurugan Palanisamy, G S S Chalapathi, Vikas Hassija et al.
- **标签**: `cs.CR` `cs.CL`
- **AI摘要**: 全面梳理RAG架构的安全威胁与防御机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性综述了RAG安全挑战，分类清晰，实用价值高。

### 2. **[AutoRelAnnotator: Calibrated Model Cascades for Cost-Efficient Relevance Evaluation in Sponsored Search](https://arxiv.org/abs/2606.25871v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Md Omar Faruk Rokon, Shasvat Desai, Hong Yao et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 提出级联模型实现高效搜索相关性标注
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且在大规模生产中验证了有效性

### 3. **[Tracing Target Answers in Poisoned Retrieval Corpora via Token Influence Attribution](https://arxiv.org/abs/2606.25721v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Yan-Lun Chen, Pin-Yu Chen, Chia-Mu Yu et al.
- **标签**: `cs.CR` `cs.CL` `cs.IR`
- **AI摘要**: 提出TRACE框架通过影响归因检测RAG投毒攻击。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且轻量，实验充分，在RAG安全领域有实用价值。

### 4. **[BitNet Text Embeddings](https://arxiv.org/abs/2606.25674v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Zhen Li, Xin Huang, Liang Wang et al.
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 提出BITEMBED框架实现低比特高效文本嵌入。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过量化技术显著降低嵌入模型存储与推理成本，方法论证充分。

### 5. **[Is GraphRAG Needed? From Basic RAG to Graph-/Agentic Solutions with Context Optimization](https://arxiv.org/abs/2606.25656v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-24
- **作者**: Long Chen, Ryan Razkenari, Yuxuan Zhou et al.
- **标签**: `cs.CL` `cs.AI` `cs.IR`
- **AI摘要**: 提出RAG评估框架并优化上下文以提升效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性对比多种RAG架构，实验严谨且具有实用价值

## Computer Vision

### 1. **[RoboAtlas: Contextual Active SLAM](https://arxiv.org/abs/2606.26046v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-24
- **作者**: Alexander Schperberg, Shivam K. Panda, Abraham P. Vinod et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出RoboAtlas框架实现语义驱动的主动SLAM
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合语义地图与VLM，在复杂环境导航中表现优异

### 2. **[1000 Rallies: An Event-Camera Dataset and Real-Time Learned Ball-State Estimation for Robotic Table Tennis](https://arxiv.org/abs/2606.25620v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-24
- **作者**: Raphaela Kreiser, Asude Aydin, Yin Bi et al.
- **标签**: `cs.RO` `cs.CV` `eess.IV`
- **AI摘要**: 首个乒乓球事件相机数据集及实时追踪系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大，方法创新且实现了机器人闭环控制。

### 3. **[TryOnCrafter: Unleashing Camera Trajectories for Realistic Video Virtual Try-on via a Renderable 4D Try-on Proxy](https://arxiv.org/abs/2606.26092v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Hao Sun, Hao Yan, Mengting Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个可控视角视频虚拟试穿框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入4D代理实现视角与动态的解耦，创新性强且逻辑严密。

### 4. **[USS: Unified Spatial-Semantic Prompts for Embodied Visual Tracking with Latent Dynamics Learning](https://arxiv.org/abs/2606.25880v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Yuchen Xie, Xinyu Zhou, Kuangji Zuo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出统一空间语义提示的具身视觉追踪框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多模态提示增强追踪鲁棒性，实验验证充分。

### 5. **[Naturalness Predicts but Does Not Cause Transferability in Image Encodings of Real-World Streams](https://arxiv.org/abs/2606.25844v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Faruk Alpay, Baris Basaran
- **标签**: `cs.CV`
- **AI摘要**: 揭示图像编码自然度与迁移性能的相关性非因果关系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨实验证明自然度指标与迁移性能仅是相关而非因果

## Machine Learning

### 1. **[Is Variational Monte Carlo Robust? Sharp Moment Thresholds and Heavy-tailed Stochastic Optimization](https://arxiv.org/abs/2606.26009v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-24
- **作者**: Philipp Grohs, Davide Nobile
- **标签**: `cs.LG`
- **AI摘要**: 提出PS-Clip-VMC算法解决VMC重尾优化问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且创新性强，显著提升了量子蒙特卡洛稳定性

### 2. **[When Does Synthetic Data Augmentation Improve Score-Based Imbalanced Classification?](https://arxiv.org/abs/2606.26053v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Zhengchi Ma, Pengfei Lyu, Anru R. Zhang
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 揭示合成数据增强在不平衡分类中的理论边界与改善机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，深入剖析了模型误设下增强的有效性。

### 3. **[Improving Neural Network Training by Decoupling the Magnitude and Direction of Weight Vectors](https://arxiv.org/abs/2606.25971v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Alexander Hägele, Alejandro Hernández-Cano, Atli Kosson et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出MD解耦优化器，分离权重幅值与方向。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验充分，显著提升训练稳定性。

### 4. **[Knowledge Cascade: Reverse Knowledge Distillation on Nonparametric Multivariate Functional Estimation](https://arxiv.org/abs/2606.25927v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Luyang Fang, Haoran Lu, Yongkai Chen et al.
- **标签**: `stat.ME` `cs.LG`
- **AI摘要**: 提出反向知识蒸馏框架KCas，优化模型训练效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出学生指导教师的范式，理论严谨且应用广泛。

### 5. **[$\text{DT}^2$: Decision-Targeted Digital Twins](https://arxiv.org/abs/2606.25923v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-24
- **作者**: Harry Amad, Mihaela van der Schaar
- **标签**: `cs.LG`
- **AI摘要**: 提出决策导向的数字孪生训练范式
<details>
<summary>原始摘要</summary>
