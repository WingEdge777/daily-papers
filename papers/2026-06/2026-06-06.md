...
### 1. **[Subspace-Aware Sparse Autoencoders for Effective Mechanistic Interpretability](https://arxiv.org/abs/2606.06333v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-04
- **作者**: Seyed Arshan Dalili, Mehrdad Mahdavi
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出子空间感知稀疏自编码器以解决特征分裂问题
<details>
...
- **评分理由**: 理论证明严谨且有效解决了SAE特征分裂难题，具有高实用价值

### 2. **[Decomposing Factual Sycophancy in Language Models: How Size and Instruction Tuning Shape Robustness](https://arxiv.org/abs/2606.06306v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-04
- **作者**: Victor De Marez, Luna De Bruyne, Walter Daelemans
- **标签**: `cs.CL`
- **AI摘要**: 提出事实谄媚的分解框架，揭示模型规模与指令微调的影响。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论创新且实验严谨，对模型鲁棒性研究有重要价值。

### 3. **[Vortex: Efficient and Programmable Sparse Attention Serving for AI Agents](https://arxiv.org/abs/2606.06453v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-04
- **作者**: Zhuoming Chen, Xinrui Zhong, Qilong Feng et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出Vortex系统以高效实现稀疏注意力机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统创新性强，显著提升了大模型推理吞吐量，实验严谨。

### 4. **[Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution](https://arxiv.org/abs/2606.06492v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Liliana Hotsko, Yinxi Li, Yuntian Deng et al.
- **标签**: `cs.SE` `cs.AI` `cs.CL`
- **AI摘要**: 提出超网络生成LoRA以适配代码演进
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，有效解决了代码库适配问题。

### 5. **[You Only Index Once: Cross-Layer Sparse Attention with Shared Routing](https://arxiv.org/abs/2606.06467v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Yutao Sun, Yanqi Zhang, Li Dong et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出跨层共享路由索引的稀疏注意力机制以提升长文本推理效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过共享KV缓存与路由索引显著提升长文本推理速度，方法创新且实验扎实。

## Natural Language Processing

### 1. **[Self-Augmenting Retrieval for Diffusion Language Models](https://arxiv.org/abs/2606.06474v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Paul Jünger, Justin Lovelace, Linxi Zhao et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出SARDI框架，利用扩散模型中间预测提升检索增强生成效果。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性利用扩散模型中间信号，方法高效且实验验证充分。

### 2. **[A Komi-Yazva--Russian Parallel Corpus and Evaluation Protocol for Zero- and Few-Shot LLM Translation](https://arxiv.org/abs/2606.06420v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Petr Parshakov
- **标签**: `cs.CL`
- **AI摘要**: 构建科米-亚兹瓦语平行语料库及评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了极低资源语言翻译研究空白，评估方法严谨。

### 3. **[Operation-Guided Progressive Human-to-AI Text Transformation Benchmark for Multi-Granularity AI-Text Detection](https://arxiv.org/abs/2606.06481v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Sondos Mahmoud Bsharat, Jiacheng Liu, Xiaohan Zhao et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出OpAI-Bench基准以评估人机协作文本的检测能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多粒度编辑操作构建基准，揭示了混合文本检测的非单调性，具有较高实用价值。

### 4. **[Reinforcement Learning Elicits Contextual Learning of Unseen Language Translation](https://arxiv.org/abs/2606.06428v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Hanxu Hu, Zdeněk Šnajdr, Pinzhen Chen et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出RL方法提升LLM对未见语言的上下文翻译能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过强化学习优化上下文翻译，方法创新且实验扎实。

### 5. **[FOXGLOVE: Understanding Goal-Oriented and Anchored Writing Feedback from Experts and LLMs on Argumentative Essays](https://arxiv.org/abs/2606.06271v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Yijun Liu, Yifan Song, John Gallagher et al.
- **标签**: `cs.CL` `cs.HC`
- **AI摘要**: 构建FOXGLOVE数据集对比专家与LLM写作反馈差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，数据集具有实际教育应用价值。

## Vision Language Models

### 1. **[A Vision-language Framework for Comparative Reasoning in Radiology](https://arxiv.org/abs/2606.06407v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-04
- **作者**: Tengfei Zhang, Ziheng Zhao, Lisong Dai et al.
- **标签**: `cs.CV` `cs.IR` `cs.LG`
- **AI摘要**: 提出MedReCo框架实现放射影像的实体感知比较推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模数据集构建扎实，跨模态比较推理具有高临床应用价值。

### 2. **[TempoVLA: Learning Speed-Controllable Vision-Language-Action Policies](https://arxiv.org/abs/2606.06491v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Dong Jing, Jingchen Nie, Tianqi Zhang et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出TempoVLA实现机器人动作速度实时可控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入主动想象机制，实验验证充分，方法论严谨。

### 4. **[Towards One-to-Many Temporal Grounding](https://arxiv.org/abs/2606.06294v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Qi Xu, Yue Tan, Shihao Chen et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出多段时序定位任务及基准，提升模型多事件感知能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 定义新任务并提供高质量数据集与评估指标，方法论严谨。

### 5. **[MPCoT: Reward-Guided Multi-Path Latent Reasoning for Test-Time Scalable Vision-Language-Action](https://arxiv.org/abs/2606.06245v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Boyang Zhang, Lianlei Shan
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出奖励引导的多路径潜在推理框架以提升VLA模型性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多路径推理提升决策能力，方法创新且实验扎实。

## Diffusion Models

### 1. **[Diffusion Models Observe Only Gradients: A Geometric Perspective on Score Matching Errors](https://arxiv.org/abs/2606.06179v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-04
- **作者**: Naïl B. Khelifa, Richard E. Turner, Ramji Venkataramanan
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 揭示扩散模型得分匹配误差的几何本质
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论扎实且实验效果显著，提升了生成效率与质量

### 3. **[Where Should Knowledge Enter? A Layered Framework for Knowledge Infusion in Multimodal Iterative Generative Mo](https://arxiv.org/abs/2606.06356v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Renjith Prasad, Chathurangi Shyalika, Anushka Pawar et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出多模态生成模型知识注入的分层框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 框架具有系统性创新，实验验证充分且效果显著。

### 4. **[Plug-and-Play Guidance for Discrete Diffusion Models via Gradient-Informed Logit Correction](https://arxiv.org/abs/2606.06303v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Hongkun Dou, Zike Chen, Fengji Li et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出GILC框架实现离散扩散模型高效引导
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需重训，在多领域表现优异，实验扎实

### 5. **[Diff-CA: Separating Common and Salient Factors with Diffusion Models](https://arxiv.org/abs/2606.06120v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Michaël Soumm, Alexandre Fournier Montgieux, Yunlong He et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于扩散模型的对比分析框架以分离公共与显著特征
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入扩散模型进行对比分析，理论与实验扎实。

## Multimodal

### 1. **[StoryVideoQA: Scaling Deep Video Understanding with a Large-Scale, Multi-Genre and Auto-Generated Dataset](https://arxiv.org/abs/2606.06338v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Zhengqian Wu, Zhixian Liu, Aodong Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出StoryVideoQA数据集与PlotTree推理框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模数据集构建与多智能体框架具有显著学术价值与实用性

### 2. **[CLEAR: Cognition and Latent Evaluation for Adaptive Routing in End-to-End Autonomous Driving](https://arxiv.org/abs/2606.06219v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Yining Xing, Zehong Ke, Zhiyuan Liu et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出CLEAR框架实现高效自动驾驶规划
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过单步扩散与大模型推理提升了自动驾驶的实时性与准确性

### 3. **[DisasterBench: A Multimodal Benchmark for UAV-Based Disaster Response in Complex Environments](https://arxiv.org/abs/2606.06217v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Tan Zhang, Quanyou Li, Lu Zhang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出无人机灾害响应多模态基准与轻量化模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基准全面且模型高效，在灾害响应领域具有显著应用价值。

### 4. **[USAD 2.0: Scaling Representation Distillation for Universal Audio Understanding](https://arxiv.org/abs/2606.06444v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Heng-Jui Chang, Alexander H. Liu, Saurabhchand Bhati et al.
- **标签**: `eess.AS` `cs.CL` `cs.SD`
- **AI摘要**: 提出USAD 2.0通用音频编码器，提升多领域理解能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏与规模化提升了音频编码性能，方法扎实且实用。

### 5. **[F3-Tokenizer: Taming Audio Autoencoder Latents for Understanding and Generation](https://arxiv.org/abs/2606.06357v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Dinghao Zhou, Xingchen Song, Di Wu et al.
- **标签**: `cs.SD` `cs.AI` `eess.AS`
- **AI摘要**: 提出F3-Tokenizer实现音频理解与生成的统一。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过正则化瓶颈与表征编码器提升音频模型性能。

## Image Generation

### 1. **[Where, What, Why, and Importance: Structured Defect Grounding for Text-to-Image Feedback](https://arxiv.org/abs/2606.06113v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Huaisong Zhang, Hao Yu, Yuxuan Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出结构化缺陷定位框架SDG以优化文生图模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过结构化预测解决缺陷诊断瓶颈，方法创新且实验扎实。

### 2. **[FontFusion: Enhancing Generative Text in Diffusion Models with Typographic Conditioning](https://arxiv.org/abs/2606.06066v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Marian Lupascu, Nipun Jindal, Ionut Mironica et al.
- **标签**: `cs.CV` `cs.GR`
- **AI摘要**: 提出FontFusion框架以提升扩散模型字体生成精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入层级令牌与双编码器，显著提升字体一致性与生成质量。

### 3. **[SAM-Flow: Source-Anchored Masked Flow for Training-Free Image Editing](https://arxiv.org/abs/2606.06228v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Haowang Cui, Rui Chen, Tao Luo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SAM-Flow实现无需训练的局部图像编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过源锚定掩码流解决背景泄露，方法创新且实用性强。

### 4. **[Knowledge Distillation for Visual Autoregressive Models](https://arxiv.org/abs/2606.06078v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Elia Peruzzo, Aritra Bhowmik, Guillaume Sautiere et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出VarKD框架以优化视觉自回归模型蒸馏
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对视觉模型特性改进蒸馏策略，实验详实且有效。

## Video Generation

### 1. **[Physics in 2-Steps: Locking Motion Priors Before Visual Refinement Erases Them](https://arxiv.org/abs/2606.06361v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Woojung Han, Seil Kang, Youngjun Jun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PhaseLock通过锁定运动先验提升视频生成物理一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过谱分析揭示相位退化机制，方法创新且高效实用。

### 2. **[RhymeFlow: Training-Free Acceleration for Video Generation with Asynchronous Denoising Flow Scheduling](https://arxiv.org/abs/2606.06309v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Chensheng Dai, Shengjun Zhang, Yifan Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出异步去噪流调度加速视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过关键帧解耦去噪轨迹，显著提升了生成效率与质量。

### 3. **[LoomVideo: Unifying Multimodal Inputs into Video Generation and Editing](https://arxiv.org/abs/2606.06042v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Jianzong Wu, Hao Lian, Jiongfan Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出LoomVideo实现高效视频生成与编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Scale-and-Add机制显著降低计算开销，性能优异。

## Agent

### 1. **[Goedel-Architect: Streamlining Formal Theorem Proving with Blueprint Generation and Refinement](https://arxiv.org/abs/2606.06468v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-04
- **作者**: Jui-Hui Chung, Ziyang Cai, Zihao Li et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出基于蓝图生成与精炼的Lean 4自动定理证明框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入蓝图分解策略，在多项基准测试中达到SOTA水平。

### 2. **[Agent Memory: Characterization and System Implications of Stateful Long-Horizon Workloads](https://arxiv.org/abs/2606.06448v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-04
- **作者**: Yasmine Omri, Ziyu Gan, Zachary Broveak et al.
- **标签**: `cs.AI`
- **AI摘要**: 首次对智能体记忆系统进行系统级表征与分类。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了智能体记忆系统性能评估的空白，方法严谨且实用。

### 3. **[A Finite Certificate for the Positive $n=9$ Vasc Inequality](https://arxiv.org/abs/2606.06136v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-04
- **作者**: Dakai Guo, Ruichen Qiu, Yichuan Cao et al.
- **标签**: `cs.SC` `cs.AI`
- **AI摘要**: 利用AI辅助证明了Vasc不等式n=9情形
<details>
<summary>原始摘要</summary>
...
- **评分理由**: AI辅助数学证明的开创性工作，严谨且具有高实用价值。

### 4. **[HANDOFF: Humanoid Agentic Task-Space Whole-Body Control via Distilled Complementary Teachers](https://arxiv.org/abs/2606.06493v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Lizhi Yang, Junheng Li, Nehar Poddar et al.
- **标签**: `cs.RO` `cs.AI` `cs.LG`
- **AI摘要**: 提出HANDOFF人形机器人全身控制框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多教师蒸馏实现鲁棒控制，实验验证充分且实用性强。

### 5. **[MLEvolve: A Self-Evolving Framework for Automated Machine Learning Algorithm Discovery](https://arxiv.org/abs/2606.06473v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Shangheng Du, Xiangchao Yan, Jinxin Shi et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出MLEvolve框架实现自动化机器学习算法发现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多智能体与树搜索优化，显著提升了算法发现效率与性能。

## Distributed Computing

### 1. **[CarbonSim: A Lifecycle-Aware Framework for Evaluating Carbon Tradeoffs in Hardware Upgrade Decisions](https://arxiv.org/abs/2606.06438v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Kartik Hans, Kaiwen Zhao, Stephen Lee
- **标签**: `cs.DC` `cs.OS`
- **AI摘要**: 提出CarbonSim框架以优化硬件碳足迹决策
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，对可持续计算有重要指导意义

### 2. **[Amortizing Federated Adaptation: Hypernetwork Driven LoRA for Personalized Foundation Models](https://arxiv.org/abs/2606.06154v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Sunny Gupta, Shambhavi Shanker, Amit Sethi
- **标签**: `cs.AI`
- **AI摘要**: 提出HyperLoRA优化联邦微调
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过超网络解决聚合偏差与初始化滞后，方法创新且实验扎实。

### 3. **[Discrete Incremental Voting: New Bounds for General Graphs and Expanders](https://arxiv.org/abs/2606.06381v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Petra Berenbrink, Colin Cooper, Thorsten Götte et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出离散增量投票过程的收敛时间新界限。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析严谨，为图论投票模型提供了关键性能界限。

### 4. **[A Swarm Approach to Public Transit Using On-demand Routing in a Slime-Mold-Inspired Framework](https://arxiv.org/abs/2606.06189v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Lindsay Burke, Maxfield Comstock, Jason Graham et al.
- **标签**: `cs.MA`
- **AI摘要**: 基于黏菌算法的分布式公交调度系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入生物启发式算法，在交通调度领域效果显著。

### 5. **[On GPU Implementation for Multi-Precision Integer Division](https://arxiv.org/abs/2606.06386v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-04
- **作者**: Martin B. Marchioro, Aske N. Raahauge, Marc I. Løvenskjold et al.
- **标签**: `cs.DC` `cs.MS` `cs.SC`
- **AI摘要**: 提出GPU高效多精度整数除法算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对特定精度优化了除法性能，方法严谨且实用。

## Information Retrieval

### 1. **[Bridging the Semantic-Collaborative Gap: An Asymmetric Graph Architecture for Cold-Start Item Recommendation](https://arxiv.org/abs/2606.06225v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Anh Truong, John Trenkle, Yuanbo Chen et al.
- **标签**: `cs.IR` `cs.AI` `cs.LG`
- **AI摘要**: 提出非对称图架构解决冷启动推荐问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决冷启动难题，工业级实验验证有效。

### 2. **[IA-RAG: Interval-Algebra-Driven Temporal Reasoning for Dynamic Knowledge Retrieval](https://arxiv.org/abs/2606.06044v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Xiaoman Wang, Yaoze Zhang, Wenzhuo Fan et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出基于区间代数的时序RAG框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入区间代数解决时序推理难题，方法创新且实验扎实。

### 3. **[OneReason Technical Report](https://arxiv.org/abs/2606.06260v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: OneRec Team, Biao Yang, Boyang Ding et al.
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 提出OneReason框架提升推荐模型的推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过感知与认知增强提升推荐推理，方法创新且逻辑清晰。

### 4. **[Harnessing Structural Context for Entity Alignment Foundation Models](https://arxiv.org/abs/2606.06109v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Xingyu Chen, Yuanning Cui, Zequn Sun et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出ContextEA模型增强跨图实体对齐能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过结构化上下文增强编码与解码，显著提升迁移性能

### 5. **[WebKnoGraph: GNN-Powered Internal Linking](https://arxiv.org/abs/2606.06106v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-04
- **作者**: Emilija Gjorgjevska, Georgina Mirceva, Miroslav Mirchev
- **标签**: `cs.IR`
- **AI摘要**: 提出基于GNN的网站内部链接优化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，对SEO实践有明确指导价值。

## Computer Vision

### 1. **[ActiveMimic: Egocentric Video Pretraining with Active Perception](https://arxiv.org/abs/2606.06194v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-04
- **作者**: Xingyao Lin, Guojin Zhong, Tianyi Lu et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出ActiveMimic框架，通过主动感知提升机器人预训练效果
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决人机视频差异，实验严谨且效果显著

### 2. **[HomeWorld: A Unified Floorplan-to-Furnished Framework for Generating Controllable, Densely Interactive Whole-Home Scenes](https://arxiv.org/abs/2606.06390v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Wenbo Li, Xiaoliang Ju, Zipeng Qin et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出分层框架实现全屋布局与家具生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用性强，实验设计严谨，流程清晰。

### 3. **[Geodesic Flow Matching on a Riemannian Degradation Manifold for Blind Image Restoration](https://arxiv.org/abs/2606.06278v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Akshay Janardan Bankar, Ankita Chatterjee, Sayan Banerjee et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出黎曼流形测地线流匹配算法用于盲图像恢复
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 将测地线引入流匹配，理论新颖且框架严谨，应用潜力大。

### 4. **[RadiusFPS: Efficient Farthest Point Sampling on CPUs and GPUs via Spherical Voxel Pruning](https://arxiv.org/abs/2606.06255v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Ziyang Yu, Xiang Li, Qiong Chang et al.
- **标签**: `cs.RO` `cs.CV` `cs.DC`
- **AI摘要**: 提出RadiusFPS算法加速点云采样
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过球形体素剪枝优化FPS采样，显著提升了实时性能。

### 5. **[Symb-xMIL: Symbolic Explanations for Multiple Instance Learning in Digital Pathology](https://arxiv.org/abs/2606.06224v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Yanqing Luo, Julius Hense, Niklas Prenißl et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出Symb-xMIL框架，实现病理MIL模型逻辑规则解释
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，有效提升了模型可解释性

## Machine Learning

### 1. **[Equivariant Neural Belief Propagation](https://arxiv.org/abs/2606.06344v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-04
- **作者**: Zehua Cheng, Wei Dai, Jiahao Sun
- **标签**: `cs.LG` `cs.SC`
- **AI摘要**: 提出等变神经置信传播框架，提升推理效率与精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该方法在SE(3)等变性与概率推理结合上具有突破性，实验严谨且性能卓越。

### 2. **[Regret Minimization with Adaptive Opponents in Repeated Games](https://arxiv.org/abs/2606.06486v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Mingyang Liu, Asuman Ozdaglar, Tiancheng Yu et al.
- **标签**: `cs.LG` `cs.AI` `cs.GT`
- **AI摘要**: 提出RP-Regret以应对重复博弈中的自适应对手。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入新博弈论指标，理论严谨且实验结果显著。

### 3. **[Pretraining Recurrent Networks without Recurrence](https://arxiv.org/abs/2606.06479v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Akarsh Kumar, Phillip Isola
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出SMT方法实现RNN并行训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Transformer预训练实现RNN高效并行，创新性强。

### 4. **[How abundant are good interpolators?](https://arxiv.org/abs/2606.06469v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: August Y. Chen, Ahmed El Alaoui
- **标签**: `math.ST` `cs.LG` `math.PR`
- **AI摘要**: 揭示过参数化模型中插值分类器的泛化性能分布规律。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具有深刻的统计学习洞察，分析了插值器的泛化行为。

### 5. **[In-Context Multiple Instance Learning](https://arxiv.org/abs/2606.06458v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-04
- **作者**: Alexander Möllers, Marvin Sextro, Julius Hense et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出上下文多示例学习方法，实现少样本高效分类。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入上下文学习解决MIL少样本难题，实验扎实。
