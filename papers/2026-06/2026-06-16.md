...
### 1. **[MIRAGE: Auditing Anti-Muslim Bias in Frontier LLMs Across Reasoning, Agentic, and Time-Coupled Conditions](https://arxiv.org/abs/2606.16562v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-15
- **作者**: Noor Islam S. Mohammad, Tamim Sheikh
- **标签**: `cs.LG`
- **AI摘要**: 提出MIRAGE基准评估大模型反穆斯林偏见
<details>
...
- **评分理由**: 针对复杂场景的偏见评估具有极高学术与现实价值

### 2. **[The Value Axis: Language Models Encode Whether They're on the Right Track](https://arxiv.org/abs/2606.17056v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Nick Jiang, Isaac Kauvar, Jack Lindsey
- **标签**: `cs.CL`
- **AI摘要**: 发现大模型内部存在表征目标成功率的价值轴
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过激活干预揭示模型内部价值表征，方法创新且论证严谨。

### 3. **[KVEraser: Learning to Steer KV Cache for Efficient Localized Context Erasing](https://arxiv.org/abs/2606.17034v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Mufei Li, Shikun Liu, Dongqi Fu et al.
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出KVEraser实现高效KV缓存局部擦除
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.LG`
- **AI摘要**: 提出ExpRL利用参考答案作为奖励支架优化LLM推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验设计严谨，对RL训练有显著提升。

### 5. **[Selection Without Signal, Recovery Through Expression: A Measurement Study of Post-Hoc Falsification Operators for Frozen Small Code Models](https://arxiv.org/abs/2606.16999v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Mehmet Iscan
- **标签**: `cs.SE` `cs.CL` `cs.LG`
- **AI摘要**: 揭示后处理算子局限并提出M1恢复机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验严谨且结论深刻，对小模型推理有实际价值

## Natural Language Processing

### 1. **[IMPACTeen: Intentions, Manipulation, Persuasion, Annotations, and Consequences in Teen Communication Dataset](https://arxiv.org/abs/2606.16910v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Aleksander Szczęsny, Wiktoria Mieleszczenko-Kowszewicz, Maciej Markiewicz et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 发布多视角青少年社交影响力数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建严谨且具有多维标注，对社交分析有高实用价值

### 2. **[Robust Dual-Signal Fusion: Hybrid Neuro-Symbolic Gating with Compressed Chain-of-Thought Refinement for Irony Detection in Social Media Texts](https://arxiv.org/abs/2606.16845v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Ankit Bhattacharjee, Krityapriya Bhaumik
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出RDS框架实现零样本反讽检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效提升了零样本检测性能。

### 3. **[P3B3: A Multi-Turn Conversational Benchmark for Measuring European and Brazilian Portuguese Variety Bias in LLMs](https://arxiv.org/abs/2606.16753v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Rafael Ferreira, Inês Vieira, Inês Calvo et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出P3B3基准以评估LLM的葡语变体偏见。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了葡语变体评估空白，方法严谨且具有实用价值。

### 4. **[From Affect Prediction to Affect Forecasting: Evidence for Distinct Information Sources in Longitudinal Text](https://arxiv.org/abs/2606.16687v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Sadia Noor, Seemab Latif, Raja Khurram Shahzad et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出TSAP框架区分情感预测与趋势预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，明确了文本与轨迹对情感预测的不同作用。

### 5. **[How Far Can Machine Translation Quality Take You? Extrinsic Discourse Evaluation in Goal-Oriented Setups](https://arxiv.org/abs/2606.16596v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Wafaa Mohammed, Kata Naszadi, Vlad Niculae
- **标签**: `cs.CL`
- **AI摘要**: 提出基于目标导向环境的机器翻译外在语篇评估框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过任务导向评估翻译质量，方法创新且实验严谨。

## Vision Language Models

### 1. **[Qwen-RobotWorld Technical Report: Unifying Embodied World Modeling through Language-Conditioned Video Generation](https://arxiv.org/abs/2606.17030v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-15
- **作者**: Jie Zhang, Xiaoyue Chen, Anzhe Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出统一具身世界模型Qwen-RobotWorld
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型架构创新，在多项具身基准测试中表现卓越，实用性强。

### 2. **[Vision-Language Models as Zero-Annotation Oracles in Histopathology](https://arxiv.org/abs/2606.16658v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-15
- **作者**: Vishal Jain, Giorgio Buzzanca, Sarah Cechnicka et al.
- **标签**: `cs.CV`
- **AI摘要**: 利用VLM实现病理图像零样本分割
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且泛化性强，实验设计严谨，实用价值高。

### 3. **[Hierarchical Advantage Weighting for Online RL Fine-Tuning of VLAs from Sparse Episode Outcomes](https://arxiv.org/abs/2606.17043v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Tongyan Fang, Siyuan Huang, Naiyu Fang et al.
- **标签**: `cs.RO` `cs.LG`
- **AI摘要**: 提出分层优势加权法优化VLA在线强化学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了机器人任务成功率

### 4. **[Look Again Before You Abstain:Budgeted Conformal Evidence Acquisition for Reliable Vision-Language Model](https://arxiv.org/abs/2606.16667v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Jian Xu, Delu Zeng, John Paisley et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出BCEA框架以减少视觉模型幻觉
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过证据获取策略优化了模型选择性预测的覆盖率

### 5. **[LOCUS: Local Visual Cue Search for Enhancing Fine-Grained Perception in Multimodal Large Language Models](https://arxiv.org/abs/2606.16586v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Zhou Tao, Fang Zhang, Zewen Ding et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出LOCUS框架提升多模态模型细粒度感知能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过训练时引入局部线索搜索，有效缓解视觉上下文冗余问题，方法创新且实验扎实。
...
- **评分理由**: 通过互稳定性采样显著降低推理步数，方法创新且实验扎实。

### 3. **[Diffusion Flow Matching: Dimension-Improved KL Bounds and Wasserstein Guarantees](https://arxiv.org/abs/2606.16610v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
...
- **评分理由**: 提供了更优的KL与Wasserstein收敛界，理论严谨。

### 4. **[Redirecting the Flow: Image Customization through Attention Distribution Shift](https://arxiv.org/abs/2606.16866v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Jie Li, Suorong Yang, Jian Zhao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CustomShift实现高效图像定制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基于最大熵理论优化注意力分布，提升了定制化效果。

### 5. **[A Perception vs. Distortion Perspective on Score-Based Generative Channel Estimation](https://arxiv.org/abs/2606.16815v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Marco Skocaj, Lukas Eller, Mate Boban
- **标签**: `eess.SP` `cs.AI` `cs.LG`
- **AI摘要**: 利用感知-失真权衡分析信道估计中的扩散模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入，明确了扩散模型在无线通信中的适用边界。

## Multimodal

### 1. **[Multimodal Evaluator Preference Collapse: Cross-Modal Contagion in Self-Evolving Agents](https://arxiv.org/abs/2606.16682v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-15
- **作者**: Zewen Liu
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 揭示多模态代理评估偏好崩溃与跨模态传染现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验严谨，揭示了多模态评估中的关键风险。

### 2. **[Geometric Action Model for Robot Policy Learning](https://arxiv.org/abs/2606.17046v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Jisang Han, Seonghu Jeon, Jaewoo Jung et al.
- **标签**: `cs.RO` `cs.CV` `cs.LG`
- **AI摘要**: 提出GAM模型，利用几何基础模型实现具身智能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入几何先验，实验扎实，提升了机器人操作性能。

### 3. **[A Multi-Center Benchmark for Abdominal Disease Diagnosis and Report Generation from Non-Contrast CT](https://arxiv.org/abs/2606.16991v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Mariam Elbakry, Aliaa Sayed Sheha, Salma Hassan Tantawy et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出非增强CT辅助腹部诊断与报告生成基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建扎实，临床应用价值高，实验设计严谨。

### 4. **[SUP-MCRL: Subject-aware Unified Pseudo-feature Coded Multimodal Contrastive Representation Learning for EEG Visual Decoding](https://arxiv.org/abs/2606.16615v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Shengyu Gong, Weiming Zeng, Yueyang Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SUP-MCRL框架提升脑电视觉解码性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合语义与主体特征，实验效果显著，方法严谨。

### 5. **[Multi-Modal Spatio-Temporal Graph Neural Network with Mixture of Experts for Soil Organic Carbon Prediction](https://arxiv.org/abs/2606.16580v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Daniele Mos, Felipe Drummond, Anton Bossenbroek et al.
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出多模态时空图神经网络用于土壤碳预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合图神经网络与混合专家模型，方法创新且实验扎实。

## Video Generation

### 1. **[DreamX-World 1.0: A General-Purpose Interactive World Model](https://arxiv.org/abs/2606.16993v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-15
- **作者**: DreamX Team, Yancheng Bai, Rui Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 交互式长序列视频生成世界模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 技术创新显著，在相机控制与长程一致性上表现优异。

## Agent

### 1. **[Greed Is Learned: Visible Incentives as Reward-Hacking Triggers](https://arxiv.org/abs/2606.16914v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-15
- **作者**: Tong Che, Rui Wu
- **标签**: `cs.AI`
- **AI摘要**: 揭示了可见奖励渠道导致AI产生贪婪成瘾与对齐失效。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了奖励机制对AI对齐的潜在风险，具有极高的安全研究价值。

### 2. **[GIST-CMTF: Goal-State Inference for Causal Minimal Tool Filtering in LLM Agents](https://arxiv.org/abs/2606.16813v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-15
- **作者**: Rahul Suresh Babu, Rohit Shukla
- **标签**: `cs.AI`
- **AI摘要**: 引入目标推理层以提升工具代理的因果过滤准确性
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 提出MetaSyn数据集以评估LLM在元分析中的推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建严谨，针对性地揭示了LLM在文献筛选中的瓶颈。

### 4. **[DEEPRUBRIC: Evidence-Tree Rubric Supervision for Efficient Reinforcement Learning of Deep Research Agents](https://arxiv.org/abs/2606.17029v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Minghang Zhu, Chuyang Wei, Junhao Xu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出证据树框架优化研究智能体强化学习效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过证据树反向构建评估标准，显著提升RL训练效率。

### 5. **[Agent trajectories as programs: fingerprinting and programming coding-agent behavior](https://arxiv.org/abs/2606.16988v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Hamidah Oderinwale
- **标签**: `cs.SE` `cs.LG`
- **AI摘要**: 提出通过程序化轨迹指纹识别与分析编码智能体行为的方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地引入轨迹指纹分析，评估框架严谨且具有高实用价值。

## Distributed Computing

### 1. **[Decoupling Inference from State Updates in Low-Latency Feature Engines via Probabilistic Thinning](https://arxiv.org/abs/2606.16981v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Augusto Peres, Iker Perez, Pedro Valdeira et al.
- **标签**: `cs.DB` `cs.LG`
- **AI摘要**: 通过概率稀疏化解耦推理与状态更新以降低延迟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地优化了流式机器学习的存储I/O开销，理论严谨且实验充分。

### 2. **[Diagonal-Budgeted Trotterization for Efficient Quantum Hamiltonian Simulation](https://arxiv.org/abs/2606.16959v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Srikar Chundury, Blake Burgstahler, Jiajia Li et al.
- **标签**: `quant-ph` `cs.DC`
- **AI摘要**: 提出对角预算Trotter化算法，显著提升哈密顿量模拟效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法创新显著，实验对比充分，在量子模拟领域具有极高实用价值。

### 3. **[Single-Connection Mixed-Criticality Transport with CATS: Bounded Guarantees, Three Structural Limits, and a QUIC Escape](https://arxiv.org/abs/2606.16924v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Syed Muhammad Aqdas Rizvi
- **标签**: `cs.NI` `cs.DC` `cs.OS`
- **AI摘要**: 提出CATS方案解决单连接混合关键性传输延迟问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决单流优先级调度难题，理论与实验扎实

### 4. **[Tangram: Hiding GPU Heterogeneity for Efficient LLM Parallelization](https://arxiv.org/abs/2606.16907v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Yanda Tao, Pedro F. Silvestre, Marcel Wagenländer et al.
- **标签**: `cs.DC`
- **AI摘要**: 通过解耦异构GPU实现高效LLM并行
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决异构集群并行难题，实验效果显著。

### 5. **[Robust and Automated Reconfiguration of Byzantine Wide-Area Replication](https://arxiv.org/abs/2606.16740v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Rowdy Chotkan, Bulat Nasrulin, Johan Pouwelse et al.
- **标签**: `cs.DC` `cs.CR` `cs.NI`
- **AI摘要**: 提出Beware框架实现拜占庭容错系统的鲁棒重配置
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过机器学习优化配置，显著提升了分布式共识性能

## Information Retrieval

### 1. **[OneRank: Unified Transformer-Native Ranking Architecture for Multi-Task Recommendation](https://arxiv.org/abs/2606.16838v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Jiakai Tang, Sunhao Dai, Kun Wang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出OneRank架构实现多任务推荐的统一Transformer建模
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决多任务干扰问题，实验充分且具有工业落地价值。

### 2. **[SCAR: Semantic Continuity-Aware Retrieval for Efficient Context Expansion in RAG](https://arxiv.org/abs/2606.16661v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Nathanaël Langlois
- **标签**: `cs.IR` `cs.CL`
- **AI摘要**: 提出语义连续性感知检索，优化RAG上下文扩展效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，显著降低了RAG检索的冗余开销。

### 3. **[A Theoretical Framework for Risk Analysis of Stochastic Rankers](https://arxiv.org/abs/2606.16970v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Debasis Ganguly
- **标签**: `cs.IR`
- **AI摘要**: 提出随机排序策略的风险评估理论框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，实验验证了DCG波动预测的准确性

### 4. **[Understanding the Behaviors of Environment-aware Information Retrieval](https://arxiv.org/abs/2606.16817v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Ruifeng Yuan, Chaohao Yuan, David Dai et al.
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 提出基于RL的检索器感知查询优化策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性分析了检索器差异并提出有效优化方法，实验扎实。

### 5. **[Harmonizing Semantic and Collaborative in LLMs: Reasoning-based Embedding Generator for Sequential Recommendation](https://arxiv.org/abs/2606.16703v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-15
- **作者**: Qidong Liu, Mingyao Huang, Moranxin Wang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出ReaEmb框架，通过推理增强与协同强化提升序列推荐。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效结合了LLM推理与协同信号。

## Computer Vision

### 1. **[BRDFusion: Physics Meets Generation for Urban Scene Inverse Rendering](https://arxiv.org/abs/2606.17049v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Yi-Ruei Liu, Jie-Ying Lee, Zheng-Hui Huang et al.
- **标签**: `cs.CV`
- **AI摘要**: 结合物理渲染与生成模型实现城市场景逆向渲染
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 融合物理建模与生成先验，显著提升了场景重建质量与可控性。

### 2. **[The Importance of Phase in Neural Representations: An Internal Oppenheim-Lim Test of Image Classifiers](https://arxiv.org/abs/2606.17037v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Alper Yıldırım
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 揭示神经网络表征中相位对图像识别的核心作用。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果干预实验深入剖析表征机制，严谨且具洞察力。

### 3. **[MeshLoom: Feed-Forward Non-Rigid Registration of Mesh Sequences](https://arxiv.org/abs/2606.17027v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Jianqi Chen, Jiraphon Yenphraphai, Xiangjun Tang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出高效非刚性网格序列配准网络MeshLoom
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入拓扑感知编码，实现了高效且高质量的网格形变重建。

### 4. **[Learning the Geometry of Data: A Mathematical Review of Shape Space Analysis](https://arxiv.org/abs/2606.17022v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Gary P. T. Choi, Khanh Dao Duc, Shira Faigenbaum-Golovin et al.
- **标签**: `math.ST` `cs.LG` `stat.ML`
- **AI摘要**: 系统综述形状空间分析的数学框架与机器学习应用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 全面梳理几何数据分析方法，理论严谨且应用广泛。

### 5. **[ActiveSAM: Image-Conditional Class Pruning for Fast and Accurate Open-Vocabulary Segmentation](https://arxiv.org/abs/2606.16996v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Tran Dinh Tien, Zhiqiang Shen
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出ActiveSAM实现高效零样本语义分割
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过图像条件类剪枝显著提升SAM推理速度与精度

## Machine Learning

### 1. **[Task-Error Residual Learning for Real-Robot Five-Ball Juggling](https://arxiv.org/abs/2606.16978v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-15
- **作者**: Kai Ploeger, Jan Peters
- **标签**: `cs.RO` `cs.LG` `eess.SY`
- **AI摘要**: 提出任务误差残差学习实现五球杂耍
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过方向性误差反馈显著提升机器人学习效率

### 2. **[Cross-Silo De-Anonymization Under Local Differential Privacy: Threat Model, Phase Transition, and Coordination Necessity](https://arxiv.org/abs/2606.16763v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-15
- **作者**: Ziniu Liu, Aiping Li
- **标签**: `cs.CR` `cs.IT` `cs.LG`
- **AI摘要**: 揭示跨孤岛差分隐私去匿名化相变阈值
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，首次量化了跨孤岛隐私泄露的相变临界点。

### 3. **[Elastic ODYN: Differentiable Optimization for Infeasible Control and Learning in Robotics](https://arxiv.org/abs/2606.16564v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-15
- **作者**: Aristotelis Papatheodorou, Jose Rojas, Ioannis Havoutis et al.
- **标签**: `cs.RO` `cs.LG`
- **AI摘要**: 提出处理不可行QP问题的弹性优化求解器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决机器人控制中的不可行性问题，理论与实验扎实。

### 4. **[Learning Hybrid Biophysical Neuron Models with Neural ODEs](https://arxiv.org/abs/2606.16693v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-06-15
- **作者**: Jonas Beck, Michael Deistler, Dóra Viktória Molnár et al.
- **标签**: `q-bio.NC` `cs.LG`
- **AI摘要**: 提出神经ODE与生物物理模型融合的混合建模框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合神经ODE与生物物理模型，实验严谨且实用性强。

### 5. **[Your Privacy My Cloak: Backdoor Attacks on Differentially Private Federated Learning](https://arxiv.org/abs/2606.17035v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-15
- **作者**: Xiaolin Li, Ning Wang, Ninghui Li et al.
- **标签**: `cs.LG` `cs.CR`
- **AI摘要**: 揭示差分隐私对后门攻击的掩护效应并提出RING攻击
<details>
<summary>原始摘要</summary>
