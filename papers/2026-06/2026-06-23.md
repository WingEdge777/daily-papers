...
### 1. **[Evaluation Awareness Is Not One Capability: Evidence from Open Language Models](https://arxiv.org/abs/2606.23583v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-22
- **作者**: Nilesh Nayan, Aishwarya Sampath Kumar, Rishiraj Girmal et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示模型评估感知能力的多元独立性与基准幻觉。
<details>
...
- **评分理由**: 研究深入揭示了模型评估感知机制，实验严谨且见解深刻。

### 2. **[GIF: Locally Sound Geometric Information Flow Control for LLMs](https://arxiv.org/abs/2606.23277v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-22
- **作者**: Adam Storek, Nikolaus Holzer, Zhuo Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出GIF框架实现LLM信息流安全控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具备形式化证明，兼顾性能与效率。

### 3. **[The Language Blind Spot: How Query Language and Brand Recognition Tier Shape AI-Constructed Brand Reputation Across Twelve European Languages](https://arxiv.org/abs/2606.23165v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-22
- **作者**: Dmitrij Żatuchin
- **标签**: `cs.IR` `cs.CL`
- **AI摘要**: 揭示AI品牌声誉存在语言盲点，本地品牌在母语查询中更具优势。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，跨语言实验设计出色，对AI评估具有重要启示。

### 4. **[Abstract representational geometry supports inference in large language models](https://arxiv.org/abs/2606.23345v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-22
- **作者**: Yunan Zeng, Yuwang Wang
- **标签**: `cs.AI`
- **AI摘要**: 揭示LLM推理依赖抽象几何表征机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入剖析LLM内部表征与人类推理的相似性，方法严谨。

### 5. **[Same question, different history: language, national identity, and credit in large language models](https://arxiv.org/abs/2606.23164v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-22
- **作者**: William Guey, Pierrick Bougault, Wei Zhang et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示大模型语言偏见导致的民族记忆差异。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究视角新颖，实验规模大且方法论严谨，论证充分。

## Natural Language Processing

### 1. **[SQLConductor: Search-to-Policy Learning for Step-wise Text-to-SQL Orchestration](https://arxiv.org/abs/2606.23537v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Yizhang Zhu, Zhangyang Peng, Boyan Li et al.
- **标签**: `cs.DB` `cs.AI` `cs.LG`
- **AI摘要**: 提出基于搜索策略的SQL编排框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过MCTS优化SQL生成流程，方法创新且实验扎实。
...
- **评分理由**: 框架标准化了优化器开发，显著降低了研究门槛。

### 3. **[War in the Abstract: The Rise and Consequences of Militarized Language in Scientific Communication](https://arxiv.org/abs/2606.23462v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Sovesh Mohapatra, David Lydon-Staley, Dani S. Bassett
- **标签**: `cs.CL` `cs.AI` `cs.CY`
- **AI摘要**: 量化科学文献军事化语言的增长及其负面影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模数据分析与实验结合，揭示了语言风格对科学传播的损害。

### 4. **[Energy-Based Transformers as Predictors of Reading Difficulty](https://arxiv.org/abs/2606.23382v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Jakub Dotlacil, Ece Takmaz
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出基于能量的Transformer作为阅读难度预测指标
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入能量模型，实验验证了其在心理语言学中的统一预测能力。

### 5. **[WaveDetect: Robust Framework for Machine-Generated Text Detection via Wavelet Transform](https://arxiv.org/abs/2606.23336v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Zhichen Liu, Kaitong Qin, Linhan He et al.
- **标签**: `cs.CL`
- **AI摘要**: 利用小波变换检测AI生成文本的鲁棒性框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入频域分析，实验充分且鲁棒性强。

## Vision Language Models

### 1. **[Brain-Adapter: A Dual-Stream Vision-Language MIL Framework for Comprehensive 3D CT Diagnosis of Acute Intracranial Pathologies](https://arxiv.org/abs/2606.23494v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Zhenyu Yi, Zhiyun Song, Yusong Sun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出双流MIL框架实现3D CT精准诊断
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合VLM与MIL技术，无需密集标注，临床应用价值高。

### 2. **[CADRE: Stable, Parameter Efficient Adaptation of Medical Vision Language Models with Bounded Forgetting and Prior Drift](https://arxiv.org/abs/2606.23487v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Amrita Singh, Rishabh Jha
- **标签**: `cs.AI`
- **AI摘要**: 提出CADRE框架以解决医疗VLM的灾难性遗忘与先验漂移问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效提升了医疗模型持续学习的稳定性。

### 3. **[Faithful Grounded Visual Reasoning via Learned Proxy-Tokens](https://arxiv.org/abs/2606.23354v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Tom Hodemon, Mohamed Chaouch, Aboubacar Tuo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出代理标记机制提升视觉推理的可解释性与准确度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了多模态模型幻觉问题。

### 4. **[Data Selection Through Iterative Self-Filtering for Vision-Language Settings](https://arxiv.org/abs/2606.23611v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Andrei Liviu Nicolicioiu, Sarvjeet Singh Ghotra, Morgane M. Moss et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出一种视觉语言模型自过滤数据选择方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过迭代自过滤优化数据质量，方法创新且实用性强。

### 5. **[Dense Reward for Multi-View 3D Reasoning with Global Maps and Local Views](https://arxiv.org/abs/2606.23557v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Jiho Choi, Seonho Lee, Seojeong Park et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出稠密奖励机制优化多视角3D推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入过程级监督提升了多视角推理的准确性与一致性

## Diffusion Models

### 1. **[Diffusion Models Adapt to Low-Dimensional Structure Under Flexible Coefficient Choices](https://arxiv.org/abs/2606.23627v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Changxiao Cai, Yuchen Jiao, Gen Li
- **标签**: `stat.ML` `cs.LG` `math.ST`
- **AI摘要**: 证明扩散模型对低维结构的适应性具有鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论贡献扎实，扩展了扩散模型采样收敛性的适用范围

### 2. **[DiT-Reward: Generative Representations for Text-to-Image Reward Modeling](https://arxiv.org/abs/2606.23626v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Yuanming Yang, Guoqing Ma, Bo Wang et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 利用扩散模型表征提升图像奖励模型性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地复用生成式DiT作为奖励模型，实验扎实且效果显著。

### 3. **[Scheduling Thoughts: Learning the Order of Thought in Diffusion Language Models](https://arxiv.org/abs/2606.23567v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Jiawei Xu, Minghui Liu, Aakriti Agrawal et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出SAS框架优化扩散语言模型推理顺序
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，在推理任务中显著提升了模型性能

### 4. **[TooBad: Backdoor Diffusion Models with Ultra-Low Poison Rate and Imperceptible Trigger](https://arxiv.org/abs/2606.23362v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Vu Tuan Truong, Long Bao Le
- **标签**: `cs.CR` `cs.CV`
- **AI摘要**: 提出TooBad框架实现扩散模型高效隐蔽后门攻击
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 显著降低中毒率并提升攻击效率，实验验证充分且具有威胁性。
...
- **标签**: `cs.DC` `cs.AI` `cs.CV`
- **AI摘要**: 提出无需训练的KV缓存重用机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过低秩补丁解决多模态缓存重用精度损失，创新性极高。

### 2. **[VeriEvol: Scaling Multimodal Mathematical Reasoning via Verifiable Evol-Instruct](https://arxiv.org/abs/2606.23543v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Haoling Li, Kai Zheng, Jie Wu et al.
- **标签**: `cs.AI` `cs.CL` `cs.CV`
- **AI摘要**: 提出VeriEvol框架，通过可验证演化提升视觉数学推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效解决了多模态推理数据质量问题。

### 3. **[AIR: Adaptive Interleaved Reasoning with Code in MLLMs](https://arxiv.org/abs/2606.23678v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Cong Han, Xiaohan Lan, Haibo Qiu et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出自适应交错推理框架以增强多模态大模型数值计算能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过强化学习与代码增强提升推理性能，方法论严谨且实验结果显著。

### 4. **[TailorMind: Towards Preference-Aligned Multimodal Content Generation](https://arxiv.org/abs/2606.23643v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Hengji Zhou, Ye Liu, Yufeng Liu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出TailorMind实现个性化多模态内容生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合协同过滤与多模态生成，方法创新且实验详实。

### 5. **[Real-Time Multimodal Activity-Aware Error Detection in Robot-Assisted Surgery](https://arxiv.org/abs/2606.23593v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
...
- **评分理由**: 结合视觉、运动学与文本提示，显著提升了手术错误识别性能。

## Image Generation

### 1. **[Keep The Essentials: Efficient Reference Conditioned Generation via Token Dropping](https://arxiv.org/abs/2606.23682v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Rishubh Parihar, Ayush Raina, R. Venkatesh Babu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出稀疏上下文方法，通过令牌剪枝提升参考图像生成效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，通过训练策略实现高效推理，实验充分。

### 2. **[GeoFidelity-Bench: Evaluating Segment-Level Geographic Fidelity in Text-to-Image Street-View Generation](https://arxiv.org/abs/2606.23669v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Kaizhen Tan, Hanzhe Hong, Siru Tao
- **标签**: `cs.CV`
- **AI摘要**: 提出评估街景生成地理保真度的基准测试
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，通过文本级控制提升了生成多样性。

### 4. **[Safe Few-Step Generation via Velocity Editing](https://arxiv.org/abs/2606.23267v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Yujin Choi, Jaehong Yoon
- **标签**: `cs.CV` `cs.CY`
- **AI摘要**: 提出VESFlow实现流匹配模型的安全生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对流匹配的训练无关安全方法，实验效果显著且逻辑清晰。

### 5. **[RS-Gen: A Multi-Stage Agentic Framework for Reasoning and Search-Augmented Image Generation](https://arxiv.org/abs/2606.23221v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Feifei Bian, Zhimin Zheng, Wei Deng et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出RS-Gen多阶段智能体框架以提升图像生成逻辑与知识能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 框架创新性强，实验验证充分，显著提升了生成模型性能。

## Video Generation

### 1. **[Vera: A Layered Diffusion Model for Content-Preserving Video Editing](https://arxiv.org/abs/2606.23610v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-22
- **作者**: Hongkai Zheng, Ta-Ying Cheng, Benjamin Klein et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出分层扩散模型实现视频内容保持编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分层架构与MoT设计有效提升了视频编辑的保真度与质量

### 2. **[SteerVTE: Seamless Video Text Editing with Style and Glyph Control](https://arxiv.org/abs/2606.23254v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Kai Zeng, Moran Li, Zhengwei Wang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出SteerVTE框架实现视频文本精准编辑与风格保持
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且数据集规模大，实验验证充分，实用价值高

## Agent

### 1. **[Superhuman AI for Generals.io Using Self-Play Reinforcement Learning](https://arxiv.org/abs/2606.23348v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-22
- **作者**: Matej Straka, Viliam Lisý, Martin Schmid
- **标签**: `cs.LG`
- **AI摘要**: 利用JAX加速模拟器实现Generals.io超人AI
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过极速模拟器与自博弈训练实现顶尖性能，贡献显著

### 2. **[CoorDex: Coordinating Body and Hand Priors for Continuous Dexterous Humanoid Loco-Manipulation](https://arxiv.org/abs/2606.23680v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Sikai Li, Shuning Li, Zhenyu Wei et al.
- **标签**: `cs.RO` `cs.AI` `cs.LG`
- **AI摘要**: 提出协同全身与灵巧手控制的移动操作框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过潜在残差学习实现了高自由度移动操作，方法创新且实验扎实。

### 3. **[Causal Discovery in the Era of Agents](https://arxiv.org/abs/2606.23608v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
...
- **评分理由**: 明确了LLM辅助因果分析的边界，方法论严谨且实用。

### 4. **[Self-Compacting Language Model Agents](https://arxiv.org/abs/2606.23525v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Tianjian Li, Jingyu Zhang, William Jurayj et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出SelfCompact框架，通过模型自主决策实现高效上下文压缩。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入元认知准则优化代理上下文，实验严谨且实用。

### 5. **[Detecting Malicious Agent Skills in the Wild using Attention](https://arxiv.org/abs/2606.23416v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Bacem Etteib, Daniele Lunghi, Tégawendé F. Bissyandé
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出Locate-and-Judge检测恶意智能体技能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过注意力机制高效识别恶意技能，具有高实用性与创新性。

## Distributed Computing

### 1. **[Asymmetry PRISM: A CPU/GPU Portfolio Optimization Engine for Deadline-Bounded Institutional Rebalancing](https://arxiv.org/abs/2606.23367v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-22
- **作者**: Debdoot Ghosh
- **标签**: `q-fin.CP` `cs.CE` `cs.DC`
- **AI摘要**: 高性能CPU/GPU组合优化引擎
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 显著提升金融投资组合重平衡的计算效率

### 2. **[Concordia: JIT-Compiled Persistent-Kernel Checkpointing for Fault-Tolerant LLM Inference](https://arxiv.org/abs/2606.23521v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Yuhang Gan, Yiwei Yang, Yuyi Li et al.
- **标签**: `cs.DC` `cs.LG`
- **AI摘要**: 提出GPU驻留持久内核实现LLM容错检查点
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决LLM推理容错难题，架构设计严谨高效

### 3. **[Solving Approximate Agreement on continuous and discrete spaces](https://arxiv.org/abs/2606.23260v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Augustin Albert, Sergio Rajsbaum
- **标签**: `cs.DC`
- **AI摘要**: 提出连续与离散空间近似一致性问题的通用解法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，解决了拓扑空间一致性问题的关键猜想

### 4. **[The Energy Consumption of Transformer Fine-Tuning: A Roofline-Inspired Scaling Model](https://arxiv.org/abs/2606.23546v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Mansour Zoubeirou a Mayaki
- **标签**: `cs.LG` `cs.AI` `cs.AR`
- **AI摘要**: 提出Transformer能耗预测模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，对大模型能效评估有重要参考价值。

### 5. **[Development and Design of FLKit: A Structured Onboarding Toolkit for Federated Learning in Health and Life Sciences](https://arxiv.org/abs/2606.23500v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Ashkan Pirmani, Ilse Vermeulen, Goran Vinterhalter et al.
- **标签**: `cs.DC` `cs.LG`
- **AI摘要**: 开发FLKit以简化联邦学习落地流程
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过跨学科工具包降低联邦学习门槛，实用性强且结构清晰。

## Operating Systems

### 1. **[AOHP: An Open-Source OS-Level Agent Harness for Personalized, Efficient and Secure Interaction](https://arxiv.org/abs/2606.23449v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Shanhui Zhao, Jiacheng Liu, Guohong Liu et al.
- **标签**: `cs.AI` `cs.OS`
- **AI摘要**: 基于AOSP构建的AI智能体操作系统框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将智能体作为OS一级实体，实验结果显著且架构设计严谨。

### 2. **[FlexServe: A Fast and Secure LLM Serving System for Mobile Devices with Flexible Resource Isolation](https://arxiv.org/abs/2606.23370v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Yinpeng Wu, Yitong Chen, Lixiang Wang et al.
- **标签**: `cs.CR` `cs.LG` `cs.OS`
- **AI摘要**: 提出FlexServe系统，实现移动端LLM安全高效推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦资源权限与管理，显著提升TrustZone推理性能。

## Information Retrieval

### 1. **[Multi-Vector Embeddings are Provably More Expressive than Single Vector Embeddings](https://arxiv.org/abs/2606.23475v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-22
- **作者**: Rajesh Jayaram
- **标签**: `cs.DS` `cs.IR`
- **AI摘要**: 证明多向量嵌入比单向量更具表达力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过理论证明确立了多向量嵌入的表达优势，严谨性极高。

### 2. **[LightSTAR: Efficient Visual Document Retrieval via Lightweight Selection with Vision-Adaptive Refinement](https://arxiv.org/abs/2606.23539v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Tongkun Guan, Haocheng Wang, Wei Shen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出LightSTAR框架提升文档检索效率与精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过两阶段检索策略有效平衡了计算成本与检索性能

### 3. **[Improving Long-Context Retrieval with Multi-Prefix Embedding](https://arxiv.org/abs/2606.23642v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Zhenglin Yu, Xueguang Ma, Shengyao Zhuang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出MPE方法优化长文本检索效率与精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效平衡了检索性能与存储开销

### 4. **[Towards Root Memories: Benchmarking and Enhancing Implicit Logical Memory Retrieval for Personalized LLMs](https://arxiv.org/abs/2606.23283v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-22
- **作者**: Hongxun Ding, Xiang Yu, Chengbing Wang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出根记忆框架提升LLM逻辑检索能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入新颖的根记忆概念，弥补了语义检索的逻辑缺失，实验扎实。

### 5. **[Ranking Companion: A Visual Analytics Approach to Item-Based Ranking with Hybrid Item Selection](https://arxiv.org/abs/2606.23263v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-22
- **作者**: Aman Kumar, Maximilian Tornow, Michaela Benk et al.
- **标签**: `cs.HC` `cs.IR`
- **AI摘要**: 提出混合式交互排序可视化分析方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合主动学习与人工选择，提升用户个性化排序体验，实验设计扎实。
...
- **评分理由**: 通过自动化闭环显著提升了真实世界抓取数据的采集效率与质量。

### 2. **[Lift4D: Harmonizing Single-View 3D Estimation for 4D Reconstruction In-the-Wild](https://arxiv.org/abs/2606.23688v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Yehonathan Litman, Xiaoxuan Ma, Manan Shah et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Lift4D实现野外动态场景4D重建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合扩散先验与高斯溅射，有效解决遮挡与非刚性形变。

### 3. **[IMAGIN-4D: Image-Guided Controllable Interaction Generation](https://arxiv.org/abs/2606.23675v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Sai Kumar Dwivedi, Federica Bogo, Buğra Tekin et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于图像引导的4D人机交互生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过时空解耦的图像条件化提升了交互生成的细粒度控制能力。

### 4. **[Pose Anything Anywhere:Model-free Object Poses from Arbitrary References](https://arxiv.org/abs/2606.23634v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Hongli Xu, Jiaqi Hu, Junwen Huang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PANY框架实现通用物体6D位姿估计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 多视图Transformer架构创新，实验效果显著优于现有方法。

### 5. **[Polycepta: Object-Centric Appearance Estimation for Multi-Object Tracking](https://arxiv.org/abs/2606.23604v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Mohamed Nagy, Naoufel Werghi, Jorge Dias et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出递归外观状态估计框架提升多目标追踪性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将外观建模转化为递归估计，实验扎实且性能优异。

## Machine Learning

### 1. **[Solve for the Hyperparameter, Skip the Search: Kolmogorov-Optimal Scaling Laws for Spline Regression](https://arxiv.org/abs/2606.23575v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-22
- **作者**: Yong Yi Bay, Kathleen A. Yearick
- **标签**: `cs.LG` `cs.AI` `math.NA`
- **AI摘要**: 提出KORE算法实现样条回归超参解析求解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新扎实，通过解析解替代搜索，显著提升效率与精度。

### 2. **[SPADE: Structure-Prior Adaptive Decision Estimation](https://arxiv.org/abs/2606.23219v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-22
- **作者**: Yifan Wang
- **标签**: `cs.AI`
- **AI摘要**: 提出SPADE框架自适应整合物理先验
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且实验效果显著，在科学机器学习领域具有创新性。

### 3. **[HyperQuant: A Rate-Distortion-Optimal Quantization Pipeline for Large Language and Diffusion Models](https://arxiv.org/abs/2606.23406v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-22
- **作者**: Yuval Domb, Hadar Sackstein, Tomer Solberg
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出HyperQuant量化流水线，实现LLM与扩散模型高效压缩。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合多种量化技术，在LLM与视频生成模型中表现优异，实用性强。

### 4. **[PHAST-Net: Attention-Guided, Physics-Informed Network for Unified Estimation of Ideal Time-Frequency Representations](https://arxiv.org/abs/2606.23665v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: James M. Cozens, Simon J. Godsill
- **标签**: `eess.AS` `cs.CV`
- **AI摘要**: 提出PHAST-Net实现统一时频表示估计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理约束与注意力机制，在信号处理领域具有创新性与实用价值。

### 5. **[Action-BED: Task-Driven Bayesian Experimental Design with Singly Intractable Objectives](https://arxiv.org/abs/2606.23662v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-22
- **作者**: Tom Rossa, Angus Phillips, Tom Rainforth
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出任务驱动的贝叶斯实验设计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过重构目标函数简化了优化过程，具有理论创新与实用价值。
