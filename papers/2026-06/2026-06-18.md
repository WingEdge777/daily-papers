...
### 1. **[STARE: Surprisal-Guided Token-Level Advantage Reweighting for Policy Entropy Stability](https://arxiv.org/abs/2606.19236v1)**
- **评分**: ⭐ 86/100 | **日期**: 2026-06-17
- **作者**: Haipeng Luo, Qingfeng Sun, Songli Wu et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出STARE算法解决GRPO训练中的熵崩塌问题
<details>
...
- **评分理由**: 理论分析深入，实验验证充分，有效提升RL训练稳定性

### 2. **[Learning User Simulators with Turing Rewards](https://arxiv.org/abs/2606.19336v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Yingshan Susan Wang, Cedegao E. Zhang, Linlu Qiu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出图灵奖励强化学习训练用户模拟器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过图灵测试优化模拟器，方法创新且效果显著。

### 3. **[Explaining Attention with Program Synthesis](https://arxiv.org/abs/2606.19317v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Amiri Hayes, Belinda Li, Jacob Andreas
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 利用程序合成技术实现Transformer注意力机制的可解释性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，有效提升了模型透明度。

### 4. **[User as Engram: Internalizing Per-User Memory as Local Parametric Edits](https://arxiv.org/abs/2606.19172v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Bojie Li
- **标签**: `cs.AI`
- **AI摘要**: 提出Engram模型实现高效个性化记忆存储
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过哈希表实现局部参数编辑，显著提升推理精度与存储效率。

### 5. **[OpenAnt: LLM-Powered Vulnerability Discovery Through Code Decomposition, Adversarial Verification, and Dynamic Testing](https://arxiv.org/abs/2606.19149v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Nahum Korda, Gadi Evron
- **标签**: `cs.CR` `cs.LG`
- **AI摘要**: 基于LLM的自动化漏洞挖掘系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合静态分析与动态验证，有效降低了误报率。

## Natural Language Processing

### 1. **[Freeing the Law with LOCUS: A Local Ordinance Corpus for the United States](https://arxiv.org/abs/2606.19334v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Denis Peskoff, Joe Barrow, Christopher Vu et al.
- **标签**: `cs.CL` `cs.CY` `cs.LG`
- **AI摘要**: 构建了美国首个大规模地方条例数据集LOCUS
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了法律AI领域数据空白，具有极高的研究价值

### 2. **[X+Slides: Benchmarking Audience-Conditioned Slide Generation](https://arxiv.org/abs/2606.19256v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Haodong Chen, Xuanhe Zhou, Wei Zhou et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出首个面向受众的幻灯片生成基准评估框架X+Slides。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入受众条件评估指标，方法严谨且具有显著的实际应用价值。

### 3. **[RECOM: A Validity Discrimination Tradeoff in Automatic Metrics for Open Ended Reddit Question Answering](https://arxiv.org/abs/2606.19218v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Pushwitha Krishnappa, Amit Das, Vinija Jain et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示自动评估指标在有效性与区分度间的权衡困境。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过构建RECOM数据集，严谨论证了现有指标的局限性。

### 4. **[Generalised Eigenvalue Geometry of Semantic Adversarial Attacks](https://arxiv.org/abs/2606.19212v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Martin Anthony, Kaveh Salehzadeh Nobari
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出语义对抗攻击的广义特征值几何分析框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且视角新颖，为语义鲁棒性提供了数学支撑。

### 5. **[Correct Yourself, Keep My Trust: How Self-Correction and Social Connection Shape Credibility in Social Chatbots](https://arxiv.org/abs/2606.19286v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Biswadeep Sen, Yi-Chieh Lee
- **标签**: `cs.HC` `cs.AI` `cs.CY`
- **AI摘要**: 社交聊天机器人自纠错能提升信任度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了自纠错对维持用户信任的关键作用，实验设计严谨。

## Vision Language Models

### 1. **[Does VLA Even Know the Basics? Measuring Commonsense and World Knowledge Retention in Vision-Language-Action Models](https://arxiv.org/abs/2606.19297v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Nikita Kachaev, Andrey Moskalenko, Matvey Skripkin et al.
- **标签**: `cs.LG` `cs.RO`
- **AI摘要**: 提出Act2Answer评估VLA模型常识与世界知识保留能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动作执行评估知识保留，方法创新且实验严谨，具有较高学术价值。

### 2. **[OneCanvas: 3D Scene Understanding via Panoramic Reprojection](https://arxiv.org/abs/2606.19253v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Bartłomiej Baranowski, Dave Zhenyu Chen, Matthias Nießner
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 通过全景重投影实现高效3D场景理解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用全景画布简化3D空间推理，计算效率高且效果显著。

### 3. **[Visual-OPSD: Cross-Modal On-Policy Self-Distillation for Efficient Unified Multimodal Reasoning](https://arxiv.org/abs/2606.18974v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Pengyu Li, Zhitao Gao, Lingling Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Visual-OPSD实现高效多模态推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过自蒸馏消除视觉生成开销，性能提升且速度显著优化。

### 4. **[Motion-Focused Latent Action Enables Cross-Embodiment VLA Training from Human EgoVideos](https://arxiv.org/abs/2606.18955v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Runze Xu, Yiluo Zhang, Jian Wang et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 利用人类视频训练通用机器人动作模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦动作与背景实现跨具身学习，方法新颖且实用性强。

### 5. **[A Unified Framework for Efficient Remote Sensing Visual Question Answering: Adapting Dual, Hybrid, and Encoder-Decoder Architectures](https://arxiv.org/abs/2606.19277v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Timothy Agboada, Shikha Chandel, Yadav Raj Ghimire et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出高效遥感视觉问答的统一微调框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过PEFT策略有效适配多架构，实验严谨且具有实用价值。

## Diffusion Models

### 1. **[Spotlight: Synergizing Seed Exploration and Spot GPUs for DiT RL Post-Training](https://arxiv.org/abs/2606.19004v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-17
- **作者**: Ruiqi Lai, Dakai An, Wei Gao et al.
- **标签**: `cs.DC` `cs.AI` `cs.LG`
- **AI摘要**: 利用Spot GPU加速DiT强化学习训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统设计创新且实验扎实，显著降低了训练成本。

### 2. **[Pulse: Training Acceleration for Large Diffusion Models with Automatic Pipeline Parallelism](https://arxiv.org/abs/2606.19163v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-17
- **作者**: Boran Sun, Guoyong Jiang, Lin Zhang et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出PULSE优化扩散模型并行训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过跳跃连接局部化显著提升了训练吞吐量与通信效率。

### 3. **[BindEdit: Taming Attention Leakage for Precise Multi-Object Image Editing](https://arxiv.org/abs/2606.18906v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Chaewon Park, Soyoon Lee, Naeun Lee et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出BindEdit解决多目标图像编辑中的注意力泄露问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过注意力约束机制有效提升了多目标编辑的精确度与鲁棒性

### 4. **[Sumi: Open Uniform Diffusion Language Model from Scratch](https://arxiv.org/abs/2606.19005v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Mengyu Ye, Keito Kudo, Wataru Ikeda et al.
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 首个大规模从头训练的均匀扩散语言模型Sumi
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了大规模均匀扩散模型研究空白，实验扎实且开源

### 5. **[Generative-Model Predictive Planning for Navigation in Partially Observable Environments](https://arxiv.org/abs/2606.18888v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Thomas Quilter, Yifan Zhu, Guorui Quan et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出BeliefDiffusion实现部分可观测环境导航
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合扩散模型与MPC，有效解决多模态信念空间规划问题。
...
- **标签**: `cs.CV` `cs.CL` `cs.SD`
- **AI摘要**: 提出OmniAgent实现主动感知视频理解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过POMDP框架解耦推理与视频时长，性能显著优于大模型

### 2. **[Reference-Driven Multi-Speaker Audio Scene Generation from In-the-Wild Priors](https://arxiv.org/abs/2606.19325v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Michael Finkelson, Daniel Segal, Eitan Richardson et al.
- **标签**: `cs.SD` `cs.AI` `cs.CV`
- **AI摘要**: 提出ScenA模型实现多说话人场景音频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决参考捷径问题，实验严谨且效果显著。

### 3. **[IndicContextEval: A Benchmark for Evaluating Context Utilisation in Audio Large Language Models Across 8 Indic Languages](https://arxiv.org/abs/2606.19157v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Sakshi Joshi, Dhruv Subhash Rathi, Sanskar Singh et al.
- **标签**: `eess.AS` `cs.CL`
- **AI摘要**: 提出评估音频大模型语境利用能力的基准。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了多语言音频模型语境评估的空白，方法严谨。

### 4. **[ThinkDeception: A Progressive Reinforcement Learning Framework for Interpretable Multimodal Deception Detection](https://arxiv.org/abs/2606.18988v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Jinhao Song, Shan Liang, Yiqun Yue et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出基于MLLM的渐进式多模态欺诈检测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新引入CoT与渐进式强化学习，提升了检测可解释性。

### 5. **[Beyond the Current Observation: Evaluating Multimodal Large Language Models in Controllable Non-Markov Games](https://arxiv.org/abs/2606.19338v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Shengyuan Ding, Xilin Wei, Xinyu Fang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出RNG-Bench评估多模态模型在非马尔可夫博弈中的记忆与推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该基准针对多模态模型长期记忆与决策能力提供了严谨的评估框架。

## Image Generation

### 1. **[The Reward Was in Your Data All Along: Correcting Flow Matching with Discriminator-Guided RL](https://arxiv.org/abs/2606.19162v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-17
- **作者**: Nicolas Beltran-Velez, Felix Friedrich, Zhang Xiaofeng et al.
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出DRL方法通过判别器引导提升生成模型质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效改善了生成模型的分布对齐能力。

## Video Generation

### 1. **[TurboServe: Serving Streaming Video Generation Efficiently and Economically](https://arxiv.org/abs/2606.19271v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Youhe Jiang, Haoxu Wang, Haotong Bao et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出TurboServe优化流式视频生成服务的调度与成本
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对流式视频生成的调度与资源分配创新，实验严谨且效果显著。

### 2. **[Physics-IQ Verified](https://arxiv.org/abs/2606.18943v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-17
- **作者**: Tim Rädsch, Yuki M Asano, Hilde Kuehne et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Physics-IQ Verified基准以提升视频模型物理理解评估
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过改进提示词与评分机制，显著提升了物理评估的可靠性。

## Agent

### 1. **[AdsMind: A Physics-Grounded Multi-Agent System for Self-Correcting Discovery of Adsorption Configurations on Heterogeneous Catalyst Surfaces](https://arxiv.org/abs/2606.19152v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-17
- **作者**: Zongmin Zhang, Yuyang Lou, Bowen Zhang et al.
- **标签**: `cond-mat.mtrl-sci` `cs.AI`
- **AI摘要**: AdsMind通过闭环多智能体框架实现催化吸附构型自修正
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入物理反馈闭环，显著提升计算效率与准确性。

### 2. **[TRAP: Benchmark for Task-completion and Resistance to Active Privacy-extraction](https://arxiv.org/abs/2606.18996v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-17
- **作者**: Moon Ye-Bin, Nam Hyeon-Woo, Baek Seong-Eun et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出TRAP基准并引入隐私字段隔离技术
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 定义了隐私与任务完成的权衡，理论证明严谨且方案实用。

### 3. **[Decoupling Search from Reasoning: A Vendor-Agnostic Grounding Architecture for LLM Agents](https://arxiv.org/abs/2606.18947v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-17
...
- **评分理由**: 架构创新显著降低成本并提升控制力，实验扎实。

### 4. **[Data Intelligence Agents: Interpreting, Modeling, and Querying Enterprise Data via Autonomous Coding Agents](https://arxiv.org/abs/2606.19319v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Anoushka Vyas, Aarushi Dhanuka, Sina Khoshfetrat Pakazad et al.
- **标签**: `cs.MA` `cs.AI` `cs.DB`
- **AI摘要**: 基于自主编码代理的企业数据集成系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过执行反馈与共享记忆提升了数据查询与建模的自动化水平
...
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出药物研发AI智能体评估基准TxBench-PP
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了药物研发领域智能体评估的空白，方法严谨且具有高实用价值。
...
- **评分理由**: 提出全设备驻留解压流水线，显著提升吞吐与访问效率

### 2. **[Giskard : Byzantine Robust and Confidential Aggregation for Large-Scale Decentralized Learning](https://arxiv.org/abs/2606.19129v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Ousmane Touat, César Sabater, Mohamed Maouche et al.
- **标签**: `cs.CR` `cs.LG`
- **AI摘要**: 提出Giskard实现去中心化学习的隐私保护与拜占庭鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决大规模分布式学习中的隐私与鲁棒性平衡，实验充分

### 3. **[A performance portable fast Ewald summation for Stokes flow](https://arxiv.org/abs/2606.19059v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Gabriel Kosmacher, Ziyu Du, Joar Bagge et al.
- **标签**: `math.NA` `cs.DC` `physics.comp-ph`
- **AI摘要**: 提出高性能可移植Stokes流Ewald求和算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法优化显著，跨平台性能评估详尽，实用性强。

### 4. **[FoMoE: Breaking the Full-Replica Barrier with a Federation of MoEs](https://arxiv.org/abs/2606.19025v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Lorenzo Sani, Zeyu Cao, Meghdad Kurmanji et al.
- **标签**: `cs.LG` `cs.AI` `cs.DC`
- **AI摘要**: 提出FoMoE架构实现MoE模型跨域分布式训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过专家层分区打破全副本限制，显著降低通信与显存开销。

### 5. **[A Composable CRDT Layer for Byzantine-Resilient Deterministic Reconstruction](https://arxiv.org/abs/2606.18966v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Amos Brocco
- **标签**: `cs.DC` `cs.CR`
- **AI摘要**: 提出拜占庭容错CRDT重构模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦更新与状态推导实现拜占庭容错，理论严谨且创新。

## Operating Systems

### 1. **[PuDGhost: Experimental Analysis of Computation Result Corruption in Processing-using-DRAM Operations on Real DRAM Chips and Implications for Future Systems](https://arxiv.org/abs/2606.19119v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-17
- **作者**: Daichi Tokuda, İsmail Emir Yüksel, Tatsuya Kubo et al.
- **标签**: `cs.AR` `cs.DC`
- **AI摘要**: 揭示DRAM计算干扰现象并提出缓解方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验详实，对DRAM计算架构的安全性贡献显著

### 2. **[LiveStack: OS Support for Cluster-Scale Full-Stack Live Simulation](https://arxiv.org/abs/2606.18958v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Yiliang Wan, Haifeng Sun, Yihan Yang et al.
- **标签**: `cs.DC` `cs.OS`
- **AI摘要**: 提出LiveStack实现集群级全栈仿真
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过OS级创新解决仿真保真度与性能的平衡问题

### 3. **[Graph-ESBMC-PLC: Formal Verification of Graphical PLCopen XML Ladder Diagram Programs Using SMT-Based Model Checking](https://arxiv.org/abs/2606.18941v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Pierre Dantas, Lucas Cordeiro, Waldir Junior
- **标签**: `cs.PL` `cs.CL`
- **AI摘要**: 提出图结构PLC梯形图形式化验证方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了图形化PLC代码解析缺失问题，验证方法严谨且实用。

## Information Retrieval

### 1. **[Show, Don't Ask: Generative Visual Disambiguation for Composed Image Retrieval with Turn-Valid Coverage](https://arxiv.org/abs/2606.18992v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Amsisan Tran, Baogh Le, Tuan Kiet Pham et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出视觉消歧框架CLARA，通过图像选择提升检索精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入视觉交互解决检索歧义，实验严谨且效果显著。

### 2. **[JourneyFormer: Encoding Airbnb Guest Journey with Sequence Modeling](https://arxiv.org/abs/2606.19108v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Daochen Zha, Chun How Tan, Xin Liu et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出JourneyFormer优化Airbnb搜索排序
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业界落地经验丰富，但创新性偏向工程实践

### 3. **[Querit-Reranker: Training Compact Multilingual Rerankers via Efficient Label-Free Distribution Adaptation](https://arxiv.org/abs/2606.19037v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Yunfei Zhong, Jun Yang, Wei Huang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出一种高效多语言重排序模型训练框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过合成数据与模型融合实现高效且高性能的跨语言重排序

### 4. **[SAERec: Constructing Fine-grained Interpretable Intents Priors via Sparse Autoencoders for Recommendation](https://arxiv.org/abs/2606.18897v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Jiangnan Xia, Xuansheng Wu, Yu Yang et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 利用稀疏自编码器构建可解释意图推荐模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入SAE解耦意图语义，方法创新且实验扎实。

### 5. **[Rescaling MLM-Head for Neural Sparse Retrieval](https://arxiv.org/abs/2606.18811v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Youngjoon Jang, Seongtae Hong, Jonah Turner et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 提出MLM头重缩放法提升稀疏检索训练稳定性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过简单的初始化调整解决了模型训练崩溃问题，实用性强。

## Computer Vision

### 1. **[Moebius: 0.2B Lightweight Image Inpainting Framework with 10B-Level Performance](https://arxiv.org/abs/2606.19195v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-17
- **作者**: Kangsheng Duan, Ziyang Xu, Wenyu Liu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Moebius框架，以极小参数实现高性能图像补全
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型压缩技术卓越，在保持高质量的同时大幅提升推理效率

### 2. **[URDF Synthesis from RGB-D Sequences via Differentiable Joint Inference and Energy-Consistent Verification](https://arxiv.org/abs/2606.18861v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-17
- **作者**: Xinze Zhang
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出KinemaForge实现物理一致的URDF重建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且物理约束严谨，实验对比充分，实用性强。

### 3. **[Do as I Do: Dexterous Manipulation Data from Everyday Human Videos](https://arxiv.org/abs/2606.19333v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Bhawna Paliwal, Haritheja Etukuru, William Liang et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 从RGB视频重构并迁移至灵巧手操作
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了视频到机器人动作迁移的难题，方法创新且实用。

### 4. **[Beyond Algorithms: Conceptual Innovation in Medical Imaging AI](https://arxiv.org/abs/2606.19270v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Mark A. Anastasio
- **标签**: `eess.IV` `cs.LG` `physics.med-ph`
- **AI摘要**: 倡导医学影像AI从算法转向概念创新
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深刻剖析领域现状，对研究范式具有指导意义

### 5. **[CABLE: Cloud-Assisted Bandwidth-efficient LMM-based Encoding for V2X Systems](https://arxiv.org/abs/2606.19258v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Haohua Que, Zhipeng Bao, Qianyi Wu et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出CABLE框架优化V2X感知带宽
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过ROI掩码反馈机制有效降低带宽并提升推理速度

## Machine Learning

### 1. **[Scaling Learning-based AEB with Massive Unlabeled Data](https://arxiv.org/abs/2606.18864v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-17
- **作者**: Xiangyu Wang, Yang Zhan, Mengxiang Hao et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出MF-SSL框架提升自动紧急制动性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模数据应用与工业级部署验证，方法创新且严谨

### 2. **[P-K-GCN: Physics-augmented Koopman-enhanced Graph Convolutional Network for Deep Spatiotemporal Super-resolution](https://arxiv.org/abs/2606.19303v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Xizhuo, Zhang, Zekai Wang et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出物理增强的Koopman图卷积网络实现时空超分
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理约束与算子理论，在复杂几何建模上表现优异。

### 3. **[Optimal scenario design for climate emulation](https://arxiv.org/abs/2606.19302v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Christopher B. Womack, Shahine Bouabid, Andrei Sokolov et al.
- **标签**: `physics.ao-ph` `cs.LG`
- **AI摘要**: 提出优化气候模拟训练数据的方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过优化训练场景提升了气候模拟器的泛化能力与效率。

### 4. **[Language Models as Interfaces, Not Oracles: A Hybrid LLM-ML System for Pediatric Appendicitis](https://arxiv.org/abs/2606.19183v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Soheyl Bateni, Maryam Abdolali
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出LLM接口与ML预测结合的阑尾炎诊断系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构设计合理，通过混合模型提升了临床诊断的稳健性与准确度。

### 5. **[Essential Subspace Merging for Multi-Task Learning](https://arxiv.org/abs/2606.19164v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Longhua Li, Lei Qi, Xin Geng et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出本质子空间合并法以解决多任务干扰
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过子空间分解有效缓解模型合并干扰，方法创新且实验扎实。
