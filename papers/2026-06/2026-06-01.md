...
### 1. **[Knowing What to Solve Before How: Preplan Empowered LLM Mathematical Reasoning](https://arxiv.org/abs/2605.30245v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Shaojie Wang, Liang Zhang
- **标签**: `cs.CL`
- **AI摘要**: 提出PPC框架，通过预规划提升数学推理能力。
<details>
...
- **评分理由**: 创新性引入预规划阶段，实验严谨且效果显著。

### 2. **[Do Language Models Track Entities Across State Changes?](https://arxiv.org/abs/2605.30233v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Zilu Tang, Qiao Zhao, Gabriel Franco et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 揭示大模型处理实体追踪的非序列机制与缺陷
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入剖析了LLM实体追踪的机制，方法严谨且具启发性。

### 3. **[When Should Models Change Their Minds? Contextual Belief Management in Large Language Models](https://arxiv.org/abs/2605.30219v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Haoming Xu, Weihong Xu, Zongrui Li et al.
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 提出CBM框架以优化大模型信念状态管理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入BeliefTrack基准并验证了强化学习与表征干预的有效性

### 4. **[A Dual-Path Architecture for Scaling Compute and Capacity in LLMs](https://arxiv.org/abs/2605.30202v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Markus Frey, Behzad Shomali, Joachim Koehler et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出双路径架构以平衡LLM计算与容量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性架构设计，实验严谨且性能优于基线

### 5. **[Double-Edged Sword or Sharp Tool? Designing and Evaluating Triadic LLM-Teacher Collaboration for K-12 Writing at Scale](https://arxiv.org/abs/2605.30200v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Canran Wang, Yuwen Yang, Zhen Wang et al.
- **标签**: `cs.AI`
- **AI摘要**: 构建大模型辅助K-12写作教学的协作机制与实证评估。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模实证研究，创新性提出三方协作框架，方法严谨且具有教育应用价值。

## Vision Language Models

### 1. **[VisualThink-VLA: Visual Intermediate Reasoning for Effective and Low-Latency Vision-Language-Action Policies](https://arxiv.org/abs/2605.30011v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Mingjian Gao, Wenqiao Zhang, Yuqian Yuan et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出视觉中间推理框架，实现低延迟机器人控制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过视觉证据接口替代文本推理，显著提升了机器人策略的实时性与性能。

### 2. **[Tiny but Trusted: Efficient Vision-Language Reasoning for Time-Series Anomaly Detection](https://arxiv.org/abs/2605.30344v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-28
- **作者**: Xiaona Zhou, Muntasir Wahed, Tianjiao Yu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出VisAnomBench与VisAnomReasoner，提升时序异常检测性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过构建高质量基准与高效微调，显著提升了多模态模型在时序异常检测中的表现。

### 3. **[FakeVLM-R1: Internalizing Physical Laws via CoT for Synthetic Image Detection](https://arxiv.org/abs/2605.30062v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-28
- **作者**: Leqi Zhu, Junyan Ye, Kaiqing Lin et al.
- **标签**: `cs.CV`
- **AI摘要**: 通过CoT与物理常识提升合成图像检测的逻辑推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入GRPO与辩证推理机制，显著提升了检测的鲁棒性与可解释性

### 4. **[EarlyTom: Early Token Compression Completes Fast Video Understanding](https://arxiv.org/abs/2605.30010v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-28
- **作者**: Hesong Wang, Xin Jin, Lu Lu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出EarlyTom实现视觉编码器内早期Token压缩
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过优化编码阶段显著降低TTFT，实用性强且方法创新。

## Video Generation

### 1. **[Native Audio-Visual Alignment for Generation](https://arxiv.org/abs/2605.30073v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-28
- **作者**: Longbin Ji, Guan Wang, Xuan Wei et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出NAVA框架实现音视频原生对齐生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且实验充分，音视频同步效果显著

## Agent

### 1. **[BORA: Bridging Offline Reinforcement Learning and Online Residual Adaptation for Real-World Dexterous VLA Models](https://arxiv.org/abs/2605.30226v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Zhongxi Chen, Yifan Han, Yanming Shao et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出BORA框架优化灵巧手离线强化学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合离线价值评估与在线残差适配，显著提升机器人操作性能。

### 2. **[Dissociative Identity: Language Model Agents Lack Grounding for Reputation Mechanisms](https://arxiv.org/abs/2605.30169v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Botao Amber Hu, Helena Rong, Max Van Kleek
- **标签**: `cs.CY` `cs.AI` `cs.MA`
- **AI摘要**: 论证声誉机制不适用于解离性AI代理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深刻剖析AI代理身份缺失问题，视角独特且论证严密。

### 3. **[Meta-Cognitive Memory Policy Optimization for Long-Horizon LLM Agents](https://arxiv.org/abs/2605.30159v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Ziyan Liu, Zhezheng Hao, Yeqiu Chen et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出MMPO通过信念熵优化长程LLM智能体记忆策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入信念熵作为监督信号，有效提升长程任务表现

### 4. **[AgentSchool: An LLM-Powered Multi-Agent Simulation for Education](https://arxiv.org/abs/2605.30144v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Yulei Ye, Wenhao Li, Zhong Wen et al.
- **标签**: `cs.AI` `cs.MA`
- **AI摘要**: 提出AgentSchool多智能体教育模拟框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将学习建模为状态转移，实验设计严谨且具有高应用价值。

### 5. **[HEART-Bench: Do LLM Agents Exhibit Human-like Psychology?](https://arxiv.org/abs/2605.30058v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Weihan Peng, Chenxu Zhang, Qianao Wang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出HEART-Bench评估LLM代理的人格心理一致性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了基于心理学框架的基准，评估方法严谨且具有创新性。

## Computer Vision

### 1. **[REST3D: Reconstructing Physically Stable 3D Scenes from a Single Image](https://arxiv.org/abs/2605.30338v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Xiaoxuan Ma, Jiashun Wang, Nicolas Ugrinovic et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于物理约束的单图3D场景重建框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过物理场景理解与优化解决了重建的物理一致性问题

### 2. **[Towards Consistent Video Geometry Estimation](https://arxiv.org/abs/2605.30060v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Zhu Yu, Jingnan Gao, Runmin Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ViGeo实现视频几何一致性估计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且实验扎实，在多项任务上达到SOTA。

### 3. **[GenEraser: Generalizable Video Object Removal via Balanced Text-Mask Guidance and Decoupled Locator-Preserver](https://arxiv.org/abs/2605.30045v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Yuqing Chen, Lin Liu, Haisu Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GenEraser实现通用视频物体与特效移除
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入多模态引导与解耦架构，显著提升移除效果与泛化性

### 4. **[FRUC: Feedforward Dynamic Scene Reconstruction from Uncalibrated Collaborative Driving Views](https://arxiv.org/abs/2605.29997v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Yihang Tao, Yu Guo, Zhengru Fang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出无需标定的多车协同动态场景重建框架FRUC
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决多车协同重建的对齐与效率难题，实验扎实。

### 5. **[Stable-Layers: Fine-Tuning Image Layer Decomposition Models with VLM-Scored Reinforcement Learning](https://arxiv.org/abs/2605.30257v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-28
- **作者**: Ciara Rowles, Reshinth Adithyan, Nikhil Pinnaparaju et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于VLM反馈的无监督图层分解优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入GRPO与校准机制提升分解质量，方法创新且实验扎实。
...
- **评分理由**: 通过因子分析解构MPNN架构，实验严谨且具有实用指导意义。

### 2. **[CalArena: A Large-Scale Post-Hoc Calibration Benchmark](https://arxiv.org/abs/2605.30188v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Eugène Berta, David Holzmüller, Francis Bach et al.
- **标签**: `cs.LG` `cs.AI` `stat.ML`
- **AI摘要**: 构建大规模后验校准基准与评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基准全面且方法论严谨，对校准领域贡献显著

### 3. **[Can AI Weather Models Predict Beyond Two Weeks? A Quantitative Benchmark and Analysis of Long Rollouts](https://arxiv.org/abs/2605.30184v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Fanny Lehmann, Firat Ozdemir, Yun Cheng et al.
- **标签**: `cs.LG` `physics.ao-ph`
- **AI摘要**: 提出AI气象模型长期预测的稳定性分类与评估框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性分类了模型失效模式，实验严谨且具有重要实用价值。

### 4. **[iLoRA: Bayesian Low-Rank Adaptation with Latent Interaction Graphs for Microbiome Diagnosis](https://arxiv.org/abs/2605.30179v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Yang Song, Yixuan Zhang, Lingfa Meng et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出iLoRA实现微生物组诊断的图结构推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合贝叶斯LoRA与潜在图结构，方法严谨且应用价值高。

### 5. **[SAHG: Sector-Anisotropic Hyperbolic Graph Model for Social Bot Detection](https://arxiv.org/abs/2605.30166v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-28
- **作者**: Hanning Lu, Yingguang Yang, Jinwei Su et al.
- **标签**: `cs.SI` `cs.LG`
- **AI摘要**: 提出扇区各向异性双曲图模型用于社交机器人检测
<details>
<summary>原始摘要</summary>
