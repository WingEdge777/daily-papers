...
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出BINEVAL框架，通过原子化二元问题提升LLM评估可解释性。
<details>
...
- **评分理由**: 方法创新且实用，实验详实，有效解决了LLM评估的黑盒问题。

### 2. **[Forecasting With LLMs: Improved Generalization Through Feature Steering](https://arxiv.org/abs/2606.27199v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Humzah Merchant, Bradford Levy
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 利用稀疏自编码器干预特征以提升LLM预测的泛化能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过特征干预解决预测偏差，方法创新且实验严谨。

### 3. **[The Riddle Riddle: Testing Flexible Reasoning in Large Language Models and Humans](https://arxiv.org/abs/2606.27103v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
...
- **评分理由**: 实验设计巧妙，对比分析严谨，揭示了模型推理局限。

### 4. **[Inherited Circuits, Learned Semantics: How Fine-Tuning Creates Evasion Vulnerabilities Invisible to Standard Evaluation](https://arxiv.org/abs/2606.27091v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Ryan Fetterman
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 揭示微调导致安全分类器产生隐蔽逃逸漏洞
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且方法严谨，揭示了微调带来的安全风险。

### 5. **[Jailbreaking for the Average Jane: Choosing Optimal Jailbreaks via Bandit Algorithms for Automatically Enhanced Queries](https://arxiv.org/abs/2606.26936v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Prarabdh Shukla, Ritik, Suhas Rao et al.
- **标签**: `cs.CR` `cs.CL` `cs.LG`
- **AI摘要**: 利用多臂老虎机算法优化大模型越狱攻击
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效揭示了自动化攻击风险

## Natural Language Processing

### 1. **[How Surprising Is Historical Italian to Language Models? Tokenization Tax, Comprehension Tax, and a Simple Mitigation](https://arxiv.org/abs/2606.27275v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Maria Levchenko
- **标签**: `cs.CL` `cs.DL`
- **AI摘要**: 提出诊断框架量化历史文本处理难度并提供缓解策略。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，对历史语言模型处理提供了实用见解。

### 2. **[From Vajrayana Tara to Bengali Baul: A Computational Study of Lexical Transmission Across Buddhist, Shakta, and Vaishnava Traditions in Bengal](https://arxiv.org/abs/2606.26803v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Joy Bose
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 量化分析孟加拉佛教与印度教词汇演变。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过计算语言学方法量化宗教词汇演变，方法严谨且结论具有历史价值。

### 3. **[RSPC: A Benchmark for Modeling Stress and Psychiatric Conditions in Digitally Mediated Relationships using Psychiatrist Annotations](https://arxiv.org/abs/2606.27247v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Parmitha Vangapandu, Sai Ganesh Mokkapati, Sathwik Narkedimilli et al.
- **标签**: `cs.LG`
- **AI摘要**: 构建了包含精神病学标注的关系压力与心理健康数据集。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建扎实，填补了人际关系背景下心理健康建模的空白。

### 4. **[Syntactic Belief Update as the Driver of Garden Path Processing Difficulty](https://arxiv.org/abs/2606.27206v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Alan Zhou, Miloš Stanojević, John T. Hale
- **标签**: `cs.CL`
- **AI摘要**: 提出句法信念更新模型以解释花园路径句处理难度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入Rényi散度量化句法更新，有效弥补了词汇惊喜度的不足。

### 5. **[RecallRisk-BERT: A Multi-Task Framework for Post-Report Medical Device Recall Triage](https://arxiv.org/abs/2606.27174v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Ali Semih Atalay, Sevgi Yigit-Sert
- **标签**: `cs.LG`
- **AI摘要**: 提出多任务BERT框架用于医疗器械召回分级与归因分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在医疗监管领域具有较强实用价值

## Vision Language Models

### 1. **[ViQ: Text-Aligned Visual Quantized Representations at Any Resolution](https://arxiv.org/abs/2606.27313v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Xumin Yu, Zuyan Liu, Zhenyu Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ViQ框架实现视觉与文本的统一离散化表示
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过两阶段量化平衡了语义与细节，提升了多模态训练效率。

### 2. **[Automating Potential-based Reward Shaping with Vision Language Model Guidance](https://arxiv.org/abs/2606.27180v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Henrik Müller, Daniel Kudenko
- **标签**: `cs.LG` `cs.AI` `cs.RO`
- **AI摘要**: 利用VLM引导势函数以加速强化学习训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合VLM与PBRS，实验验证了样本效率提升

### 3. **[GAVEL: Grounded Caption Error Verification and Localization](https://arxiv.org/abs/2606.26923v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Zixian Gao, Atsushi Hashimoto, Kuniaki Saito
- **标签**: `cs.CL`
- **AI摘要**: 提出GAVEL任务以验证并定位多模态模型幻觉。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 任务定义清晰，基准测试有效，对多模态对齐有贡献。

### 4. **[Bridging Vision and Language Concepts through Optimal Transport Semantic Flow](https://arxiv.org/abs/2606.26891v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Chenyang Zhang, Anqi Dong, Guangming Zhu et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出基于最优传输的跨模态概念对齐模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过最优传输优化概念对齐，方法新颖且实验扎实。

### 5. **[Improving Vision-Language-Action Model Fine-Tuning with Structured Stage and Keyframe Supervision](https://arxiv.org/abs/2606.26801v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Yuan Xu, Yixiang Chen, Kai Wang et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出StaKe框架优化VLA模型微调
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过辅助监督提升机器人长序列操作性能，方法有效且实验扎实。

## Multimodal

### 1. **[HarmVideoBench: Benchmarking Harmful Video Understanding in Large Multimodal Models](https://arxiv.org/abs/2606.27187v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Jiajun Wu, Haoyu Kang, Yining Sun et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出HarmVideoBench评估多层级有害视频理解能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对有害视频理解的局限性提出了多维度基准与BCR方法，实验扎实且贡献显著。

### 2. **[Modeling Local, Global, and Cross-Modal Context in Multimodal 3D MRI](https://arxiv.org/abs/2606.26894v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Minh Duc Do, Tillmann Rheude, Noel Kronenberg et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MICViT模型，有效融合多模态3D脑部MRI信息。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型架构创新，实验规模大且验证充分，性能优异。

### 3. **[MIRROR: Novelty-Constrained Memory-Guided MCTS Red-Teaming for Agentic RAG](https://arxiv.org/abs/2606.26793v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Inderjeet Singh, Andrés Murillo, Motoyoshi Sekiya et al.
- **标签**: `cs.CR` `cs.AI` `cs.LG`
- **AI摘要**: 提出MIRROR框架以增强多模态RAG系统的安全性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入记忆引导MCTS与新颖性约束，实验严谨且效果显著。

### 4. **[FlameVQA: A Physically-Grounded UAV Wildfire VQA Benchmark with Radiometric Thermal Supervision](https://arxiv.org/abs/2606.27128v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Mobin Habibpour, John Spodnik, Niloufar Alipour Talemi et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出首个基于热成像的无人机野火视觉问答基准。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入多模态热成像数据，对野火监测任务具有实际应用价值。

### 5. **[Unison: Benchmarking Unified Multimodal Models via Synergistic Understanding and Generation](https://arxiv.org/abs/2606.26984v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Jinyu Liu, Xincheng Shuai, Henghui Ding et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出评估多模态模型协同能力的基准Unison
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了理解与生成协同评估的空白，方法严谨且实用。

## Image Generation

### 1. **[TMP: Tree-structured Mixed-policy Pruning for Large-scale Image Generation and Editing](https://arxiv.org/abs/2606.27089v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Peizhen Zhang, Yang Li, Xunsong Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出树状混合策略剪枝框架，显著降低大模型显存需求。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，在SOTA模型上验证了实用性，实验严谨且逻辑清晰。

### 2. **[Scaling Multi-Reference Image Generation with Dynamic Reward Optimization](https://arxiv.org/abs/2606.26947v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Wenwang Huang, Yusen Fu, Junjie Wang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出DyRef框架提升多参考图像生成效果
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入新基准与动态奖励优化，方法论扎实且有效

### 3. **[PortraitGen: Exemplar-Driven GRPO with Dual-Reward Guidance for Photorealistic Portrait Generation](https://arxiv.org/abs/2606.26930v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Xiaomin Li, Qian Liang, Yinan Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PortraitGen框架以提升人像生成真实感
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入真实图像与双重奖励机制，有效解决AI伪影问题。

### 4. **[SpatialFlow-GRPO: Where Spatial Credit Drives Image Editing](https://arxiv.org/abs/2606.26872v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Yankai Yang, Yancheng Long, Wei Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出空间细粒度奖励优化图像编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过历史感知迭代优化提升机器人任务性能，实验充分且效果显著。

### 2. **[OpenRCA 2.0: From Outcome Labels to Causal Process Supervision](https://arxiv.org/abs/2606.27154v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Aoyang Fang, Yifan Yang, Jin'ao Shang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出PAVE协议与OpenRCA 2.0基准，提升根因分析评估准确性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果路径监督解决LLM根因分析评估的局限，方法严谨且具实用价值

### 3. **[Mostly Automatic Translation of Language Interpreters from C to Safe Rust](https://arxiv.org/abs/2606.27122v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Bo Wang, Brandon Paulsen, Joey Dodds et al.
- **标签**: `cs.PL` `cs.MA` `cs.SE`
- **AI摘要**: 提出Reboot框架实现C到安全Rust的自动化翻译
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过特征缩减与多智能体架构有效解决了代码翻译难题

### 4. **[Parametric Open Source Games](https://arxiv.org/abs/2606.27068v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Aleksandar Todorov, Jesse ten Napel, Alexander Müller
- **标签**: `cs.GT` `cs.AI` `cs.LG`
- **AI摘要**: 提出参数化开源博弈框架以实现合作优化。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，数学严谨，为多智能体协作提供新视角。

### 5. **[Improving General Role-Playing Agents via Psychology-Grounded Reasoning and Role-Aware Policy Optimization](https://arxiv.org/abs/2606.27025v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Zhenhua Xu, Dongsheng Chen, Jian Li et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出Psy-CoT与RAPO提升角色扮演智能体性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合心理学推理与信息论优化，方法创新且实验扎实。

## Distributed Computing

### 1. **[Quantization in Federated Learning: Methods, Challenges and Future Directions](https://arxiv.org/abs/2606.26822v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Farwa Ikram, Dipanwita Thakur, Antonella Guzzo et al.
- **标签**: `cs.LG`
- **AI摘要**: 联邦学习量化技术的系统性综述
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 全面梳理了联邦学习量化方法，具有很高的学术参考价值。

### 2. **[Fortress and Gatekeeper: Theorizing Transitive Trust in Third-Party Cybersecurity Risk Governance](https://arxiv.org/abs/2606.26866v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Yijun Chen, Misita Anwar
- **标签**: `cs.CR` `cs.AI` `cs.CY`
- **AI摘要**: 提出传递信任框架以治理第三方网络安全风险
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架创新且对治理实践有指导意义，逻辑严密

## Information Retrieval

### 1. **[TriPAH: Imbalance-Aware Tri-Prompt Affinity Hashing for Cross-Modal Medical Retrieval](https://arxiv.org/abs/2606.27010v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Jiaming Bian, Songming Li, Yurui Song et al.
- **标签**: `cs.IR` `cs.MM`
- **AI摘要**: 提出TriPAH框架优化跨模态医疗检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，解决了医疗数据不平衡问题

### 2. **[AI Healthcare Chatbots as Information Infrastructure: A Large-Scale Study of User-Reported Breakdowns](https://arxiv.org/abs/2606.27302v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-25
- **作者**: Muhammad Hassan, Ramazan Yener, Ece Gumusel et al.
- **标签**: `cs.HC` `cs.AI`
- **AI摘要**: 分析医疗聊天机器人用户反馈的常见故障与基础设施挑战
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，通过大规模数据揭示了医疗AI的实际应用痛点。

## Computer Vision

### 1. **[Exact and Deterministic Patch Descriptor Retrieval via Hierarchical Normalization](https://arxiv.org/abs/2606.27280v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Koichi Sato
- **标签**: `cs.CV`
- **AI摘要**: 提出分层归一化实现精确补丁检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且性能优异，理论严谨，实用性强。

### 2. **[EO-WM: A Physically Informed World Model for Probabilistic Earth Observation Forecasting](https://arxiv.org/abs/2606.27277v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Junwei Luo, Shuai Yuan, Zhenya Yang et al.
- **标签**: `cs.AI` `cs.CV`
- **AI摘要**: 提出物理驱动的扩散模型以提升卫星遥感预测精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入物理信息约束与新基准，在气象响应预测上表现优异。

### 3. **[SubdivAR: Autoregressive Next-Scale Prediction for Neural Mesh Subdivision](https://arxiv.org/abs/2606.27088v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Huipeng Guo, Zikai Song, Hang Long et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于自回归预测的神经网格细分框架SubdivAR
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入自回归建模，实验充分且指标提升显著

### 4. **[In-Context Model Predictive Generation: Open-Vocabulary Motion Synthesis from Language Models to Physics](https://arxiv.org/abs/2606.26981v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Xiaomeng Fu, Junfan Lin, Yang Liu et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出ICMPG框架实现物理感知运动合成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合LLM规划与物理反馈，显著提升运动合成质量

### 5. **[Not All Actions Are Equal: Rethinking Conditioning for Dexterous World Model](https://arxiv.org/abs/2606.27325v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-25
- **作者**: Zizhao Yuan, Zhengtu Liang, Taowen Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出DexAC-WM优化高自由度动作建模
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过结构化动作编码与语义分支提升了视频预测精度

## Machine Learning

### 1. **[Simulation-based inference for rapid Bayesian parameter estimation in epidemiological models: a comparison with MCMC](https://arxiv.org/abs/2606.27286v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Alina Bazarova, Johann Fredrik Jadebeck, Henrik Zunker et al.
- **标签**: `cs.AI`
- **AI摘要**: 利用SBI加速流行病学模型贝叶斯推断
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过SBI显著提升了流行病学模型参数估计的计算效率

### 2. **[Recovering Governing Equations from Solution Data: Identifiability Bounds for Linear and Nonlinear ODEs](https://arxiv.org/abs/2606.27285v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Yang Pan, Helmut Bölcskei
- **标签**: `cs.LG` `cs.IT` `math.CA`
- **AI摘要**: 提出ODE方程辨识的理论界限与样本复杂度分析。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且填补了科学机器学习领域的重要空白。

### 3. **[How Good Can Linear Models Be for Time-Series Forecasting?](https://arxiv.org/abs/2606.27282v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Lang Huang, Jinglue Xu, Luke Darlow
- **标签**: `cs.LG`
- **AI摘要**: 通过优化线性模型预处理实现高效时序预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 挑战大模型趋势，通过线性模型优化实现卓越性能，方法严谨且具启发性。

### 4. **[Ribbon: Scalable Approximation and Robust Uncertainty Quantification](https://arxiv.org/abs/2606.27269v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Graham Gibson, John Tipton, Kellin Rumsey et al.
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出Ribbon方法实现高效不确定性量化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用影响函数近似重采样，计算效率高且理论严谨。

### 5. **[Graph Neural Networks Applications Across Domains: All Insights You Need](https://arxiv.org/abs/2606.27202v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-25
- **作者**: Abderaouf Bahi
- **标签**: `cs.LG`
- **AI摘要**: 全面综述图神经网络在多领域的应用与设计原则。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性梳理了图神经网络的理论框架与跨领域应用，严谨且具有高参考价值。
