...
### 1. **[Closing the Prior-Posterior Loop: Self-Reflective Molecular Design with Analysis-Driven LLM Iteration](https://arxiv.org/abs/2606.09520v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-08
- **作者**: Junyi Gong, Zijie Qiu, Ben Zhong Tang
- **标签**: `physics.chem-ph` `cs.AI`
- **AI摘要**: 引入物理分析反馈提升分子设计精度
<details>
...
- **评分理由**: 通过引入物理化学原理反馈，显著提升了LLM的分子设计能力。

### 2. **[Capacity, Not Format: Rethinking Structured Reasoning Failures](https://arxiv.org/abs/2606.09410v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-08
- **作者**: Hengxin Fan
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 揭示结构化输出对模型推理能力的容量竞争机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，深入剖析了格式约束对模型性能的影响，结论具有极高的工程指导价值。

### 3. **[The Neutral Mask: How RLHF Provides Shallow Alignment while Leaving Partisan Structure Intact in a Large Language Model](https://arxiv.org/abs/2606.09735v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Wendy K. Tam
- **标签**: `cs.CL`
- **AI摘要**: 揭示RLHF仅通过阻断而非消除偏见实现中立
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用稀疏自编码器深入解析对齐机制，研究视角新颖且严谨。

### 4. **[IS-CoT: Breaking the Long-form Generation Collapse via Interleaved Structural Thinking](https://arxiv.org/abs/2606.09709v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Zechen Sun, Yuyang Sun, Zecheng Tang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出IS-CoT框架解决长文本生成坍缩问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入动态规划循环，实验效果显著且方法严谨。

### 5. **[What the Eyes See, the LLMs Miss: Exploiting Human Perception for Adversarial Text Attacks](https://arxiv.org/abs/2606.09700v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Qin Yang, Lu Malloy, Joshua Lee et al.
- **标签**: `cs.CR` `cs.HC` `cs.LG`
- **AI摘要**: 利用视觉排版攻击绕过大模型内容审核
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 揭示了视觉与文本感知差异，攻击方法有效且实验严谨。

## Natural Language Processing

### 1. **[Precision Is Not Faithfulness: Coverage-Aware Evaluation of Grounded Generation with a Complete Oracle](https://arxiv.org/abs/2606.09376v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-08
- **作者**: Juan S. Santillana
- **标签**: `cs.CL`
- **AI摘要**: 提出覆盖率感知评估指标以解决生成式模型忠实度评估盲点。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过完整预言机基准揭示了现有指标的精度偏差，方法论严谨且具有高实用价值。

### 2. **[Correlation Is Not Enough: Embedding Human Metadata for Individual Causal Discovery](https://arxiv.org/abs/2606.09672v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Suraj Biswas, Saurabh Gupta, Pritam Mukherjee
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 提出BODHI方法修正生物医学模型因果推断偏差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，对因果发现有重要意义。

### 3. **[Automated IEP Generation from Traditional Chinese Parent-Teacher Interviews via Corpus-Grounded Feature Diffusion](https://arxiv.org/abs/2606.09603v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Kuanlin Chen, Cheng-En Ou
- **标签**: `cs.CL`
- **AI摘要**: 提出CGFD框架实现繁体中文IEP自动化生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，有效解决低资源场景下的教育文档生成问题。

### 4. **[Data Synthesis and Parameter-Efficient Fine-Tuning for Low-Resource NMT: A Case Study on Q'eqchi' Mayan](https://arxiv.org/abs/2606.09767v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-08
- **作者**: Alexander Chulzhanov, Soeren Eberhardt, Arjun Mukherjee
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 利用合成数据与PEFT提升低资源语言NMT性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，但存在语义泛化不足的局限性。

### 5. **[Beyond Accuracy: Community Perspectives on Machine Translation](https://arxiv.org/abs/2606.09655v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-08
- **作者**: Yujun Wang, Ehud Reiter, Shimei Pan et al.
- **标签**: `cs.CL`
- **AI摘要**: 分析多方社区对机器翻译的观点差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模社交媒体分析揭示了技术与用户需求的脱节，研究视角新颖且方法扎实。

## Vision Language Models

### 1. **[MemoryVLA++: Temporal Modeling via Memory and Imagination in Vision-Language-Action Models](https://arxiv.org/abs/2606.09827v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Hao Shi, Weiye Li, Bin Xie et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 引入记忆与想象机制提升机器人时序建模能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过记忆库与世界模型增强VLA，实验验证充分且效果显著。

### 2. **[Your Model Already Knows: Attention-Guided Safety Filter for Vision-Language-Action Models](https://arxiv.org/abs/2606.09749v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Seongbin Park, Fan Zhang, Baharan Mirzasoleiman et al.
- **标签**: `cs.RO` `cs.LG`
- **AI摘要**: 利用VLA注意力头实现实时机器人避障
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性利用模型内部注意力机制，无需额外训练即可提升安全性。

### 3. **[Optical Reasoning: Rethinking Images as an Expressive Reasoning Medium Beyond Text](https://arxiv.org/abs/2606.09585v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Yutong Bian, Dongjie Cheng, Heming Xia et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出光学推理，以图像作为推理媒介。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过视觉化推理提升了模型效率。

### 4. **[LangRetrieval: Language-Guided Self-Evolving Satellite-to-Radar Retrieval via CSI-Driven Reward](https://arxiv.org/abs/2606.09486v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Chunlei Shi, Junming Hou, Yi-Lin Wei et al.
- **标签**: `cs.MM`
- **AI摘要**: 基于语言引导与CSI奖励的卫星降水反演框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合视觉语言模型与强化学习优化反演，创新性强且方法严谨。

### 5. **[CapRL++: Unified Reinforcement Learning with Verifiable Rewards for Dense Image and Video Captioning](https://arxiv.org/abs/2606.09393v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Penghui Yang, Long Xing, Xiaoyi Dong et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CapRL++框架，通过RLVR提升多模态描述质量。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过可验证奖励机制优化描述生成，方法创新且实验详实。

## Diffusion Models

### 1. **[Evaluating the Representation Space of Diffusion Models via Self-Supervised Principles](https://arxiv.org/abs/2606.09718v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Xiao Li, Yixuan Jia, Zekai Zhang et al.
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出ICR指标评估扩散模型表征与生成能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过自监督视角量化表征几何，方法创新且分析严谨。

### 2. **[When Do Local Score Models Extrapolate Across Size? A Diagnostic Theory and Benchmark](https://arxiv.org/abs/2606.09705v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Wenjie Xi
- **标签**: `cs.LG` `cond-mat.stat-mech`
- **AI摘要**: 揭示了局部评分模型外推的准局部性机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过周期性终端定律优化流形数据生成，理论严谨且实验有效。

### 4. **[Cranio-Diff: Diffusion-based Cross-domain Craniofacial Reconstruction with 2D X-ray Skull Guidance and Structural Identity Constraints](https://arxiv.org/abs/2606.09699v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-08
- **作者**: Ravi Shankar Prasad, Naresh Gurjar, Shashank Baghel et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于扩散模型的颅面重建方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出新颖的跨模态重建框架，实验设计严谨且数据集规模大。

### 5. **[Echo-DM: Ultrasound Marker Removal via Conditional Latent Diffusion and Region-Aware Fusion](https://arxiv.org/abs/2606.09378v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-08
- **作者**: Zhiwei Wang, Tao Huang, Wentao Jiang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Echo-DM框架实现超声图像标记去除与解剖结构修复
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效解决了超声图像分析中的偏差问题。

## Multimodal

### 1. **[Next-Token Prediction Learns Generalisable Representations of Sleep Physiology](https://arxiv.org/abs/2606.09605v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-08
- **作者**: Jonathan F. Carter, Lionel Tarassenko
- **标签**: `cs.AI`
- **AI摘要**: 提出Hypnos模型，利用预测下一token实现睡眠生理信号表征学习。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在多模态生理信号处理上表现优异。

### 2. **[Discovering Functionally Selective Brain Regions with a Deep Topographic Multimodal Model](https://arxiv.org/abs/2606.09770v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-08
- **作者**: Badr AlKhamissi, Johannes Mehrer, Lara Marinov et al.
- **标签**: `q-bio.NC` `cs.LG`
- **AI摘要**: 提出Topo-Omni模型揭示跨模态脑区拓扑结构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型创新性强，结合神经科学验证，方法严谨且逻辑清晰。

### 3. **[HDSL: A Hierarchical Domain-Specific Language for Structured 3D Indoor Scene Generation and Localized Editing with LLM Agents](https://arxiv.org/abs/2606.09738v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Letian Li, Chao Shen, Shuzhao Xie et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出HDSL语言实现室内场景生成与局部编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分层DSL与RAG机制显著提升了场景编辑效率与准确性

### 4. **[SpatialWorld: Benchmarking Interactive Spatial Reasoning of Multimodal Agents in Real-World Tasks](https://arxiv.org/abs/2606.09669v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Hongcheng Gao, Hailong Qu, Jingyi Tang et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出多模态智能体空间推理基准测试集SpatialWorld
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了统一的交互式空间推理基准，评估方法严谨且具有高实用价值。
...
- **评分理由**: 通过控制变量法系统评估了不同表格表示对模型性能的影响
...
- **评分理由**: 创新性地在潜空间构建3D记忆，显著提升了生成效率与质量。

### 2. **[Echo-Memory: A Controlled Study of Memory in Action World Models](https://arxiv.org/abs/2606.09803v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Wayne King, Zeyue Xue, Yuxuan Bian et al.
- **标签**: `cs.CV` `cs.GR` `cs.LG`
- **AI摘要**: 提出Echo-Memory框架评估世界模型记忆机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过受控实验系统性对比记忆机制，方法严谨且具洞察力

### 3. **[CineDance: Towards Next-Generation Multi-Shot Long-Form Cinematic Audio-Video Generation](https://arxiv.org/abs/2606.09639v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Yuheng Chen, Teng Hu, Yuji Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CineDance-1M数据集与评估基准，推动长视频生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大且标注严谨，在多镜头视频生成领域具有显著价值。

### 4. **[Prisma-World: Camera-Controllable Multi-Agent Video World Model](https://arxiv.org/abs/2606.09507v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Huiqiang Sun, Zhan Peng, Size Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出多智能体视频世界模型以实现跨视角几何一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过几何感知去噪与多智能体RoPE设计解决了多视角一致性难题

## Agent

### 1. **[iOSWorld: A Benchmark for Personally Intelligent Phone Agents](https://arxiv.org/abs/2606.09764v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-08
- **作者**: Lawrence Keunho Jang, Mareks Woodside, Geronimo Carom et al.
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出首个iOS个人智能体基准测试iOSWorld
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出OmniGameArena基准以评估VLM智能体游戏能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将视觉图像作为动作输入，提升了泛化能力与控制灵活性。

### 4. **[AHA-WAM:Asynchronous Horizon-Adaptive World-Action Modeling with Observation-Guided Context Routing](https://arxiv.org/abs/2606.09811v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Jisong Cai, Long Ling, Shiwei Chu et al.
- **标签**: `cs.RO` `cs.AI` `cs.CV`
- **AI摘要**: 提出异步时序自适应世界-动作模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦世界预测与动作执行提升了机器人控制效率与性能

### 5. **[FASE: Fast Adaptive Semantic Entropy for Code Quality](https://arxiv.org/abs/2606.09800v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Shizhe Lin, Ladan Tahvildari
- **标签**: `cs.SE` `cs.AI` `cs.MA`
- **AI摘要**: 提出FASE指标以高效评估代码生成不确定性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且显著降低计算成本，实验验证充分。

## Distributed Computing

### 1. **[FMplex: Model Virtualization for Serving Extensible Foundation Models](https://arxiv.org/abs/2606.09643v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-08
- **作者**: Hetvi Shastri, Pragya Sharma, Walid A. Hanafy et al.
- **标签**: `cs.DC` `cs.AI` `cs.LG`
- **AI摘要**: 提出FMplex系统实现基础模型虚拟化与高效共享服务
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过虚拟化技术显著提升模型部署效率，实验详实且创新性强。

### 2. **[AutoMegaKernel: A Statically-Checked Agent Harness for Self-Retargeting Megakernel Synthesis](https://arxiv.org/abs/2606.09682v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Jaber Jaber, Osama Jaber
- **标签**: `cs.LG` `cs.DC` `cs.PF`
- **AI摘要**: 提出自动生成安全Megakernel的框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，验证机制严谨，但适用范围有局限。

### 3. **[Powering the Future of AI: Navigating the Trade-offs for Europe's Energy Transition and Net-Zero Goals](https://arxiv.org/abs/2606.09617v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Mohammad Hemmati, Gbemi Oluleye, Vassilis M. Charitopoulos
- **标签**: `math.OC` `cs.AI` `cs.CY`
- **AI摘要**: 量化AI数据中心对欧洲能源转型的长期影响与挑战
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，对AI基础设施能源需求提供了量化洞察。

### 4. **[Parent-Hash DAG: A Cost Analysis of Constant-Time Append for On-Chain Registries](https://arxiv.org/abs/2606.09593v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Ian C. Moore, Fernando Paredes Garcia
- **标签**: `cs.DC` `cs.CR`
- **AI摘要**: 提出PHDAG结构实现链上注册表O(1)开销
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且实证充分，对区块链数据结构有贡献

### 5. **[Coupling Complementary Simulations for Combined Performance and Energy Optimization](https://arxiv.org/abs/2606.09356v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Adel Dabah, Gregor Häfner, Sonja Happ et al.
- **标签**: `cs.DC`
- **AI摘要**: 耦合UDM与SOMA实现高性能聚合物模拟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过异构模型耦合与GPU优化显著提升能效，方法严谨且创新。
...
- **评分理由**: 理论深度极高，精准指出法律检索的本体论局限，具有重要学术价值。

### 2. **[MAVIS: Multi-Agent Video Retrieval via Structured Video Understanding](https://arxiv.org/abs/2606.09641v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
...
- **评分理由**: 通过智能体协作与逻辑辩论优化检索，方法创新且实验扎实。

### 3. **[AbstRAG: Learning to Abstract for Retrieval Problems](https://arxiv.org/abs/2606.09459v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Lei Xu, Xin Quan, Daniel Pedronette et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出AbstRAG框架以解决检索抽象鸿沟问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过反射式细化机制有效提升检索与生成精度

## Computer Vision

### 1. **[Context-Aware Deep Learning for Defect Classification in Atomic-Resolution STEM](https://arxiv.org/abs/2606.09419v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-08
- **作者**: Jiadong Dan, Cheng Zhang, Leyi Loh et al.
- **标签**: `cond-mat.mtrl-sci` `cs.AI`
- **AI摘要**: 引入上下文感知的STEM缺陷分类框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理元数据显著提升了缺陷分类的准确性与可靠性

### 2. **[Beyond Spherical Harmonics: Rethinking Appearance Models for Radiance Reconstruction](https://arxiv.org/abs/2606.09794v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Ewa Miazga, Jorge Condor, Piotr Didyk
- **标签**: `cs.CV` `cs.GR`
- **AI摘要**: 提出归一化各向异性球谐Gabor函数，提升渲染效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了高频外观建模难题。

### 3. **[End-to-End Optimization of Incoherent Imaging for Classification Under Detector-Limited Readout](https://arxiv.org/abs/2606.09792v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Archer Wang, Joshua Chen, Sachin Vaidya et al.
- **标签**: `cs.CV`
- **AI摘要**: 揭示了受限探测器下光学与神经网络协同优化的性能边界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架严谨，深入探讨了端到端光学设计的局限与优势

### 4. **[POTATR: A Lightweight Image-to-Graph Model for Page-Level Table Extraction](https://arxiv.org/abs/2606.09788v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Brandon Smock, Libin Liang, Max Sokolov et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出轻量级表格提取模型POTATR
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型高效且性能优越，在文档处理领域实用性强。

### 5. **[Hybrid Robustness Verification for Spatio-Temporal Neural Networks](https://arxiv.org/abs/2606.09746v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Sherwin Varghese, Matthew Wicker, Alessio Lomuscio
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出STBP框架提升视频模型鲁棒性验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了视频验证的计算瓶颈

## Machine Learning

### 1. **[Topological Neural Operators](https://arxiv.org/abs/2606.09806v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-08
- **作者**: Lennart Bastian, Samuel Leventhal, Mustafa Hajij et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出拓扑神经算子，实现复杂几何上的算子学习。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架创新，将离散外微分与算子学习结合，实验扎实。

### 2. **[Proxy Reward Internalization and Mechanistic Exploitation: A Learned Precursor to Reward Hacking and Its Generalization](https://arxiv.org/abs/2606.09711v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-08
- **作者**: Mohammad Beigi, Ming Jin, Lifu Huang
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出PRIME机制预测奖励欺骗风险
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过机制可解释性手段量化奖励黑客行为，具有极高预警价值。

### 3. **[Data-driven discovery of governing differential equations across physical systems](https://arxiv.org/abs/2606.09638v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-08
- **作者**: Siyu Lou, Hao Xu, Wenguan Wang et al.
- **标签**: `cs.LG` `cs.SC` `math-ph`
- **AI摘要**: 提出数据驱动微分方程发现的REO框架与相图分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性梳理了物理方程发现方法，理论框架极具洞察力。

### 4. **[GD-MIL: Grade-Disentangled Multiple Instance Learning for Multimodal Biochemical Recurrence Prediction in Prostate Cancer](https://arxiv.org/abs/2606.09453v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-08
- **作者**: Dasari Naga Raju
- **标签**: `cs.CV`
- **AI摘要**: 提出GD-MIL模型提升前列腺癌复发预测精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效挖掘了病理图像的预后信息。

### 5. **[Causally Evaluating the Learnability of Formal Language Tasks](https://arxiv.org/abs/2606.09822v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-08
- **作者**: Vésteinn Snæbjarnarson, Anej Svete, Josef Valvoda et al.
- **标签**: `cs.CL` `cs.FL`
- **AI摘要**: 引入因果干预框架评估语言模型任务学习能力
<details>
<summary>原始摘要</summary>
