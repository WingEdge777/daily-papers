...
### 1. **[One-shot learning for the complex dynamical behaviors of weakly nonlinear forced oscillators](https://arxiv.org/abs/2604.15181v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
...
- **评分理由**: 方法创新且在MEMS应用中验证了高效性与准确性

### 2. **[No More Guessing: a Verifiable Gradient Inversion Attack in Federated Learning](https://arxiv.org/abs/2604.15063v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Francesco Diana, Chuan Xu, André Nusser et al.
- **标签**: `cs.LG` `cs.AI` `cs.CR`
- **AI摘要**: 提出可验证梯度反演攻击，实现表格数据精准重构。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过几何视角实现梯度反演验证，方法创新且实验严谨。

### 3. **[DLink: Distilling Layer-wise and Dominant Knowledge from EEG Foundation Models](https://arxiv.org/abs/2604.15016v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Jingyuan Wang, Meiyan Xu, Zhihao Jia et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出DLink框架，高效压缩EEG基础模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入层级蒸馏与频域对齐，实验效果显著。

### 4. **[Predicting Power-System Dynamic Trajectories with Foundation Models](https://arxiv.org/abs/2604.14991v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Haoran Li, Lihao Mai, Chenhan Xiao et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出LASS-ODE-Power模型实现电力系统轨迹预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模预训练实现零样本预测，方法创新且实验扎实。

### 5. **[AI-Enabled Covert Channel Detection in RF Receiver Architectures](https://arxiv.org/abs/2604.14987v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Abdelrahman Emad Abdelazim, Alan Rodrigo Diaz-Rizo, Hassan Aboushady et al.
- **标签**: `cs.AI` `eess.SP`
- **AI摘要**: 提出一种射频接收机隐蔽信道检测的轻量化AI加速方案
<details>
<summary>原始摘要</summary>
