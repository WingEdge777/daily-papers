...
### 1. **[Post-Training Language Models for Gold-Medal Performance in Coding Competitions](https://arxiv.org/abs/2609.02849v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-09-02
- **作者**: Aleksander Ficek, Sean Narenthiran, Mehrzad Samadi et al.
...
- **评分理由**: 创新性强，实用价值高，实验充分

### 2. **[LoRA-TSD: Tangent-Space Spectral Descent for LoRA via Muon-Style Updates](https://arxiv.org/abs/2609.02734v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-09-02
- **作者**: Dmitrii Andriianov, Andrey Veprikov, Aleksandr Beznosikov
- **标签**: `cs.LG`
- **AI摘要**: 提出LoRA-TSD优化器提升大模型微调效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合流形优化与Muon方法，理论严谨且实验充分。

### 3. **[AceSpec: An Asymmetric Edge-Cloud Collaborative Framework for Communication-Efficient LLM Inference](https://arxiv.org/abs/2609.02514v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-09-02
- **作者**: Yida Zhang, Zhiyong Gao, Shuaibing Yue et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出高效的边云协同大模型推理框架AceSpec
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决WAN通信瓶颈，实验充分且性能提升显著

### 4. **[When Decodability Is Not Enough: Logical Validity Representations, Behavioral Dissociation, and Causal Tests in Language Models](https://arxiv.org/abs/2609.02438v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-09-02
- **作者**: Smitha Muthya Sudheendra, Jaideep Srivastava
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 揭示语言模型逻辑有效性的表征与行为表现存在差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验严谨，但因果干预效果较弱限制了应用价值

### 5. **[How LLMs Build Fictional Worlds: Setting and Narrative Space in AI-Generated Creative Storytelling](https://arxiv.org/abs/2609.02482v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Katrin Rohrbacher, Björn Nieth, Emmanuelle Salin et al.
- **标签**: `cs.CL`
- **AI摘要**: 分析大语言模型的虚构世界构建与空间叙事特征
<details>
<summary>原始摘要</summary>
...
### 1. **[NE-R1: Enhancing Named Entity Recognition Model via Reinforcement Learning](https://arxiv.org/abs/2609.02366v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Meixuan Chen, Hehan Li, Ruizhi Zhao et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出NE-R1框架实现按需检索的增强命名实体识别。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入强化学习实现按需检索，实验扎实且提升明显。

### 2. **[A Common Measure of Communication for Speech Brain-Computer Interfaces](https://arxiv.org/abs/2609.02887v1)**
...
### 3. **[DiscoSign: Discourse-Aware Text to Sign Language Gloss Translation](https://arxiv.org/abs/2609.02796v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Vasileios Baltatzis, Mert Inan, Connor Gillis et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出了首个语篇级手语光泽翻译框架DiscoSign
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实用，评估严谨，结构清晰

### 4. **[HyperStyler: Low-resource Authorship Style Transfer via Context-aware Style Navigation and Hypernetworks](https://arxiv.org/abs/2609.02772v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Jongkyung Shin, Minguk Jeon, Chanwoo Park et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出HyperStyler实现低资源风格迁移
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，具有较高实用价值

### 5. **[WinoQueer-NL: Assessing Bias in Dutch Language Models toward LGBTQ+ Identities](https://arxiv.org/abs/2609.02651v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Jiska Beuk, Gerasimos Spanakis
- **标签**: `cs.CL`
- **AI摘要**: 构建荷语LGBTQ+偏见评估数据集并分析大模型偏见
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集有新意且评估严谨，但研究范围局限于荷语。

## Vision Language Models

### 1. **[ShallowStream: Index Shallow then Answer Deep for Streaming Video Understanding](https://arxiv.org/abs/2609.02780v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Jitai Hao, Ke Yang, Qiang Huang et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出ShallowStream实现高效流式视频理解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性利用浅层网络降低计算开销，实验充分，应用价值高

### 2. **[RVSD: Retrieval Vision Sparse Decoding for Mitigating Visual Hallucinations in Large Vision-Language Models](https://arxiv.org/abs/2609.02731v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
...
- **评分理由**: 创新解码方法有效减少幻觉，实验详尽。

### 3. **[Characterizing Text Branch Sensitivity in Medical Vision-Language Segmentation via Evidence Decoupling](https://arxiv.org/abs/2609.02663v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Ziquan Liu, Zhewei Zhu, Xuyang Shi
- **标签**: `cs.CV`
- **AI摘要**: 揭示医学VLM中文本分支的敏感性与影响机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新了解耦解码器分析模态交互，实验充分且结论有实用价值。

### 4. **[TempoGround: State-Aware Streaming Visual Grounding with Vision-Language Models](https://arxiv.org/abs/2609.02359v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Leqian Ding, Junning Qiu, Manwen Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出了TempoGround流式视觉 grounding 框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实验充分，但属于特定任务的改进

### 5. **[Deeply Interleaved Text-Image Contexts for Multimodal LLMs Assessment](https://arxiv.org/abs/2609.02573v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Zihao Wang, Xi Xiang, Yuwen Sun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出评估交错图文语境的新基准TIC-Bench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补交错图文评估空白，实验详实，基准实用性强

## Diffusion Models

### 1. **[Spatially Aware World Action Model via Geometric Latent Diffusion](https://arxiv.org/abs/2609.02531v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
...
- **评分理由**: 方法创新实用，实验扎实，提升3D具身智能能力

## Multimodal

### 1. **[The Diagnosis a Reporter Leaves Unspoken: Surfacing Frozen Tumor Features for Brain-Tumor MRI Reporting](https://arxiv.org/abs/2609.02411v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Khawaja Murad ul Hassan, Ruqiyya Adil, Adil Qayyum et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出NeuroFusion以显式解码脑肿瘤MRI隐式特征
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合线性探针与大模型，实验严谨且实用价值高

### 2. **[LookStep: Efficient Vision-Language Navigation with Linguistic Foresight and Event Driven Memory](https://arxiv.org/abs/2609.02350v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Kun-Yang Yu, Yingzhe Li, Hongyu Xu et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出了LookStep以实现高效视觉语言导航
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新结合未来状态建模与事件滚动记忆，实验扎实。

### 3. **[Predictors of Loneliness in Older Adults Using Multimodal Analysis of Speech and Language](https://arxiv.org/abs/2609.02606v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Vinmay Khandode, Sai Karthik Kosuri, Neil K. R. Sehgal et al.
- **标签**: `cs.CL`
- **AI摘要**: 多模态语音语言分析预测老年人孤独感
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合声学与文本特征，方法合理但创新幅度适中

### 4. **[Beauty is in the AI of the beholder: MLLMs systematically overrate facial attractiveness](https://arxiv.org/abs/2609.02512v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Santiago Grandas, Juan Sebastian Cely-Acosta, Mohit Mendiratta et al.
- **标签**: `cs.CV` `cs.HC`
- **AI摘要**: 揭示多模态大模型系统性高估人脸美感
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 预注册研究严谨，评估多款主流模型，具实用价值

### 5. **[Subcellularly Resolved Single-Cell Embedding Learning with Transcriptomic data, Protein Structure and Localization Information](https://arxiv.org/abs/2609.02344v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Zhen Zhou, Jiachen Li, Yuan Liu et al.
- **标签**: `q-bio.GN` `cs.AI`
- **AI摘要**: 提出亚细胞级多模态细胞嵌入方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合结构与转录组，多模态融合设计合理

## Image Generation

### 1. **[GlyphAnchor: Enhancing Visual Text Rendering via Position-Anchored Glyph Priors](https://arxiv.org/abs/2609.02349v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-09-02
- **作者**: Qiang Xiang, Shuang Sun, Binglei Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GlyphAnchor以增强图像生成中的文字渲染
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补推理生成空白，但属于基准评测，创新性中等

### 3. **[GDB-Reward: From Evaluation Metrics to Training Rewards for Graphic Design](https://arxiv.org/abs/2609.02813v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Adrienne Deganutti, Purvanshi Mehta, Simon Hadfield et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GDB-Reward将设讥评价指标转为场景奖励。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性良好，实用性高，评分符合预期。

### 4. **[Balancing Frequencies and Pixels in Flow Matching](https://arxiv.org/abs/2609.02748v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Lucas Degeorge, Paul Couairon, Arijit Ghosh et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出频域损失函数优化流匹配模型的训练效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用，实验充分，写作清晰流畅。

### 5. **[Blending Concepts: Benchmarking Visual Metaphor Generation in Text-to-Image Models](https://arxiv.org/abs/2609.02502v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Chuer Chen, Zichen Wang, Yi He et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出首个文本到图像模型视觉隐喻生成基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 任务新颖且评估全面，但属于基准测试，方法创新性一般
...
- **评分理由**: 数据引擎与多模型适配创新性强且实用

### 2. **[The Missing Temporal Link: Temporal Context Routing for Script-Driven Audio-Video Generation](https://arxiv.org/abs/2609.02367v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Yichen Liu, Quanwei Zhang, Haozhe Wang et al.
- **标签**: `cs.MM` `cs.CV`
- **AI摘要**: 提出时间上下文路由方法以精准控制视听生成时序
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新有效，实验详实，提升脚本对齐能力

## Agent

### 1. **[Bilevel Coordinated Reflection: A Game-Theoretic Approach to Multi-Agent LLM Systems](https://arxiv.org/abs/2609.02750v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-09-02
- **作者**: Yihang Chen, Yuxiang Chen, Yuxuan Huang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出了多智能体LLM的博弈论双层反射框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且实验扎实，推进了多智能体系统研究

### 2. **[LLM-as-a-Judge Is Not an Oracle: Why Self-Improving Agents Need Deterministic Guardrails](https://arxiv.org/abs/2609.02246v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-09-02
- **作者**: Vansh Wahi
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出用确定性护栏限制LLM裁判
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合实际生产发现盲点并设计了PROCTOR架构

### 3. **[CAPTURE: Disentangling Preference Drift from Memory Poisoning in Personalized LLM Agents](https://arxiv.org/abs/2609.02265v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-02
- **作者**: S M Asif Hossain, Ruksat Khan Shayoni, Md Kishor Morol
- **标签**: `cs.LG`
- **AI摘要**: 提出CAPTURE框架以区分个性化智能体中的偏好漂移与记忆投毒。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的协同演化方法，实验充分但范围受限

### 5. **[Competitive Market Behavior of LLMs](https://arxiv.org/abs/2609.02580v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Pawel Struski, Jakub Swistak, Inez Okulska et al.
- **标签**: `cs.MA` `cs.AI` `econ.GN`
- **AI摘要**: 评估大模型在双重拍卖市场中的竞争行为与效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实用，实验较为扎实，分析深入。

## Distributed Computing

### 1. **[CACTUS: Mask-Guided Semantic Clean-Label Backdoors in Decentralized Federated Learning](https://arxiv.org/abs/2609.02450v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Chao Feng, Burkhard Stiller
- **标签**: `cs.LG` `cs.DC`
- **AI摘要**: 提出了去中心化联邦学习中的掩码引导语义后门攻击方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点有效但属于安全攻防领域增量改进，实验全面

### 2. **[Similarity-Aware Personalized Federated Learning in Heterogeneous Environments](https://arxiv.org/abs/2609.02241v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Arun Kumar A, Sunil Gupta, Dang Ngyuen et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出SAPE-FL个性化联邦学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法设计合理且实验充分，但缺乏突破性创新。

### 3. **[When Does Authorization End? Effect Closure at Provider Boundaries](https://arxiv.org/abs/2609.02866v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-09-02
- **作者**: Igor Santos-Grueiro
- **标签**: `cs.CR` `cs.DC`
- **AI摘要**: 提出EFFECTBOUND验证权限撤销边界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 形式化分析权限终结问题，方法严谨但应用面特定

### 4. **[Federated Learning on the American Science Cloud using APPFL](https://arxiv.org/abs/2609.02238v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-09-02
- **作者**: Zilinghan Li, Abhijit Chunduru, Harinarayan Krishnan et al.
- **标签**: `cs.DC`
- **AI摘要**: 在美科学云上部署APPFL实现联邦学习服务
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合云平台与联邦学习，实用性强但创新属常规工程应用

## Information Retrieval

### 1. **[MARS: What Retrieval Signals Are Hidden in Multimodal Large Language Models for Text-Video Retrieval?](https://arxiv.org/abs/2609.02565v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Uicheol Jung, Juyoung Hong, Geuntaek Lim et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出了多层多槽嵌入框架MARS用于文本视频检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用，实验充分，但属于检索任务的改进

### 2. **[ViSAR: Training-Free Adaptive-$k$ Retrieval for Visual Document Question Answering](https://arxiv.org/abs/2609.02486v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Adrien Mialland, Marc Plantevit, Julien Gallois et al.
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 提出ViSAR自适应k检索方法提升文档问答效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用，实验充分，写作清晰，分值合理

### 3. **[Incremental Pooled LLM Evaluation for Cost-Effective Retrieval Model Selection](https://arxiv.org/abs/2609.02745v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Max Nelson, Hanoz Bhathena, Aviral Joshi et al.
- **标签**: `cs.IR` `cs.CL`
- **AI摘要**: 提出增量池化大模型评测以实现高效检索模型选择
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且实验充分，具有较高的落地价值。

### 4. **[CORAL: An LLM-Native Harness for Production Recommender Systems](https://arxiv.org/abs/2609.02730v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Muhammad Rafay Azhar, Yuhang Zhou, Gilbert Jiang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出CORAL智能体实现推荐系统持续优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入LLM智能体进行线上推荐系统优化，实验扎实且效果显著。

### 5. **[Recommender System as Slow and Fast Thinkers](https://arxiv.org/abs/2609.02671v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Zichen Yuan, Xiaoxuan Dong, Linkun Dai et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出自适应快慢推理框架以优化序列推荐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新融合快慢系统，方法严谨且实验充分。

## Computer Vision

### 1. **[Structured-Prior-Guided Diffusion Inpainting with Physical Consistency for Traffic Sign Augmentation](https://arxiv.org/abs/2609.02348v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-09-02
- **作者**: Luo Li, Chongchong Huang, Jun Jia et al.
- **标签**: `cs.CV`
- **AI摘要**: 结构先验引导的扩散交通标志修复方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合几何颜色先验，实验扎实且实用性强

### 2. **[VoRTeC: Taming Foundation Flow for One-step Real time Video Compression](https://arxiv.org/abs/2609.02291v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Yichong Xia, Qinhong Wu, Qinhong Wu et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出VoRTeC实现单步实时视频压缩
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合流模型实现实时高质量视频压缩，实验充分

### 3. **[Video-Based Palm-Vein Authentication under Challenging Conditions](https://arxiv.org/abs/2609.02776v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-02
- **作者**: Xiaofeng Yan, Kechen Liu, Abhilash Venkatesh et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个视频掌静脉数据集及鲁棒识别方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集填补空白，实验详尽且方法创新

### 4. **[Genesis: A Generative Engine for Hierarchical Satellite Image Synthesis](https://arxiv.org/abs/2609.02683v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Subash Khanal, Yangzhi Cui, Daniel Cher et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出生成式引擎实现多尺度卫星图像合成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 任务定义新颖且方法完整，评估扎实，但属于特定垂直领域。

### 5. **[Learning to Track from Privileged Target Appearances](https://arxiv.org/abs/2609.02471v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Xin Chen, Jiao Xu, Dong Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PATT视觉跟踪框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性高且应用广泛，实验充分，结构清晰。

### 2. **[Learning Spectral-Like Mesh-Free Discretisations](https://arxiv.org/abs/2609.02833v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-09-02
- **作者**: Lucas Gerken Starepravo, Henry Broadley, Steven Lind et al.
- **标签**: `physics.comp-ph` `cs.LG`
- **AI摘要**: 提出神经离散化方法提升无网格算子精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合物理与学习方法，实验严谨，应用潜力良好

### 3. **[Dimension Dependent Correlation Gap Bounds under Restricted Independence](https://arxiv.org/abs/2609.02659v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Arjun Ramachandra
- **标签**: `math.PR` `cs.LG` `math.CO`
- **AI摘要**: 解决4元对独立相关性间隙猜想并证明其渐近界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性与理论严谨度高，但实用面较窄。

### 4. **[What Is Worth Representing? Representational Empowerment for Continual Model Construction](https://arxiv.org/abs/2609.02322v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Fei Dai, Hanqi Zhou, Alison Gopnik et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出了代表性赋能框架以优化持续模型构建
<details>
<summary>原始摘要</summary>
...
### 5. **[GRADSOLVE: fast exact gradients for ODE ensembles on GPUs](https://arxiv.org/abs/2609.02876v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-02
- **作者**: Alessio Spurio Mancini
- **标签**: `cs.MS` `cs.DC` `cs.LG`
- **AI摘要**: 提出求解与反向微分ODE系综的极速JAX库
<details>
<summary>原始摘要</summary>
