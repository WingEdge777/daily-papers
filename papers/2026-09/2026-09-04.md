...
### 1. **[Unlocking Lossless Speedups in LLMs via Discrete Diffusion](https://arxiv.org/abs/2609.04010v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-09-03
- **作者**: Subham Sekhar Sahoo, Lingjie Chen, Khiem Pham et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出离散扩散实现大模型无损加速
<details>
...
- **评分**: ⭐ 84/100 | **日期**: 2026-09-03
- **作者**: Haoyaun Zhu, Jie Zhang
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 揭示大语言模型作为裁判的不稳定性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 预注册审计严谨，对LLM评估体系具重大警示。

### 3. **[Representational alignment yields generalizable safety in language models](https://arxiv.org/abs/2609.04022v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-09-03
- **作者**: Lingyu Li, Yan Teng, Yingchun Wang et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出表征对齐方法提升大模型安全鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入原型理论，方法严谨且实用价值高

### 4. **[Rethinking On-Policy Distillation of Large Language Models II: One Training Example](https://arxiv.org/abs/2609.04172v1)**
...
- **评分理由**: 实验扎实且发现深刻，对大模型后训练有重要指导意义。

### 5. **[The Dice Roll Method: A Standardized Protocol for Repeated-Query Auditing of Large Language Model Brand Recommendations](https://arxiv.org/abs/2609.04047v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Dmitrij Żatuchin
- **标签**: `cs.IR` `cs.CL`
- **AI摘要**: 提出了大模型品牌推荐审计的标准化Dice Roll方法协议
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨创新，对大模型审计具有较高的实用价值与清晰度

## Natural Language Processing

### 1. **[ESPO: Error-Structured Prompt Optimization via Diagnose, Diversify, and Stabilize](https://arxiv.org/abs/2609.04197v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-03
- **作者**: Lihao Liu, Peng Tang, Kunwar Yashraj Singh et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出ESPO误差结构化提示词优化方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新有效，实验充分，显著提升大模型提示词性能

### 2. **[More Criticism Does Not Make a Better Review: EquiReview-R](https://arxiv.org/abs/2609.03943v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Zexing Zhang, Jichao Li, Tianyang Lei et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出EquiReview-R改进AI论文评审
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖实用，实验充分，清晰度高

### 4. **[Last Translation Benchmark](https://arxiv.org/abs/2609.04173v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Vilém Zouhar, Niyati Bafna, Mukund Choudhary et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出了突破当前机器翻译极限的最新基准LTB
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作具备创新性与实用价值，评测方法严谨清晰

### 5. **[Translation as a Decision Space: A Multi-Agent Perspective on Low-Resource Dialect Generation](https://arxiv.org/abs/2609.04048v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Hasan Alkhder, Mohammad Abboush, Igor Tchappi et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 多智能体视角下的低资源方言翻译决策空间研究
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入多智能体分析，方法严谨但应用较窄。

## Vision Language Models

### 1. **[Beyond Retrieval: Progressive Latent Memory Evolution for Streaming Video Understanding](https://arxiv.org/abs/2609.04131v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-09-03
- **作者**: Hongyu Qu, Guangming Yao, Ling Xing et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出LatentStream框架实现流式视频理解中的渐进式潜内存演化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实验充分，应用价值高，写作清晰流畅

### 2. **[GraFT: A Training-Free Framework for Spatial Reasoning in Multimodal Large Language Models via 3D Scene Graphs](https://arxiv.org/abs/2609.03892v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-03
- **作者**: Junqing Du, Fernando Ropero, Erkin Turkoz et al.
- **标签**: `cs.CV` `cs.AI` `cs.RO`
- **AI摘要**: 提出GraFT框架实现免训练的3D场景图空间推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 无需训练即可显著提升多模态大模型的3D空间推理能力

### 3. **[Adaptive Vision-Language Grasping via Composable Foundation Priors and Generalizable Grasp Synthesis](https://arxiv.org/abs/2609.04096v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Sixu Yan, Shikang Wang, Binhua Huang et al.
- **标签**: `cs.RO` `cs.AI` `cs.CV`
- **AI摘要**: 提出解耦物理抓取与视觉语言任务的自适应抓取框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新了解耦设计，实验充分，具备较高实用价值

### 4. **[Continuous Actions from Discrete Minds: Latent-Aligned Planning for End-to-End Autonomous Driving](https://arxiv.org/abs/2609.04070v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Ruoyu Yao, Yusen Xie, Qingzhao Liu et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出LaPla实现端到端自动驾驶
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合VLM与连续动作规划，实验充分

### 5. **[FWBC-VLA: Force-Aware Whole-Body Compensation for Contact-Rich Loco-Manipulation](https://arxiv.org/abs/2609.03889v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Yutian Zhang, Siyuan Ma, Liwen Yang et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出FWBC-VLA力感知全身体系，实现接触密集型移动操作。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新结合VLA与无传感器力估计，实验充实但范围受限。
...
### 2. **[ToPO: Token-Conditioned Preference Routing for Attention-Based Latent Diffusion Models](https://arxiv.org/abs/2609.03688v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Juntao Xu, Shihong Li, Hoi Fan Au et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ToPO优化扩散模型偏好对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新有效，实验充分，写作清晰度一般。

## Multimodal

### 1. **[Urban Boundaries, Social Barriers: A Benchmark and Vision-Centric Framework for Mapping Gated Communities and Equity Implications](https://arxiv.org/abs/2609.03804v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Minwei Zhao, Weiming Zhang, Jiawang Du et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出了封闭式社区多模态基准与识别框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作完整且具应用价值，但局限于特定区域与场景。

### 2. **[CORE: Improving Compositional Reasoning in MLLM Embedding via Reranker Distillation](https://arxiv.org/abs/2609.04083v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Tingyu Song, Mingxin Li, Yanzhao Zhang et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出CORE蒸馏方法提升多模态嵌入模型的组合推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新蒸馏策略提升组合检索能力，实验扎实且效果显著。

### 3. **[Alignment-Free Text-Audiobox for Voice Dubbing and Full-Duplex Dialogue Synthesis](https://arxiv.org/abs/2609.03992v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
...
- **评分理由**: 架构有创新且实用性强，实验充分

### 4. **[When Vision Meets Graphs: A Survey on Graph Reasoning and Learning](https://arxiv.org/abs/2609.03816v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Xinjian Zhao, Wei Pang, Zhixuan Yu et al.
- **标签**: `cs.SI` `cs.CV` `cs.LG`
- **AI摘要**: 首篇视觉与图学习交叉领域的系统综述
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实用，结构清晰，属于优质综述性论文。

### 5. **[VisCAD: A Foundation Model Suite with Multimodal Industrial CAD Intelligence](https://arxiv.org/abs/2609.03811v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: JoyIndustrial VisCAD Team, Linxin Cai, Qiuhe Hong et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出VisCAD工业CAD多模态基础模型套件
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型套件在CAD生成上表现优异，评估严谨但部分方法属于工程集成

## Image Generation

### 1. **[Persistent Identity Preservation in Generative Image Models: A Benchmark and Evaluation System](https://arxiv.org/abs/2609.04151v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Mengwei Ren, Xuaner Zhang, Zhihao Xia
- **标签**: `cs.CV`
- **AI摘要**: 提出了身份保持基准与持久化机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统评估了生成模型的身份保持能力，方法扎实。

### 2. **[LLaDA-Image: Building Strong Image Generators with Fully Open Training Recipes](https://arxiv.org/abs/2609.03796v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Chuyan Chen, Haoxing Chen, Kun Chen et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出了开源的LLaDA-Image统一图像生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合了DiT与扩散语言模型，方法扎实且性能达SOTA
...
- **评分理由**: 针对性对齐去噪阶段，大幅提升极低比特量化效果

### 2. **[Principia: Relational Physics Tests for Video Models](https://arxiv.org/abs/2609.04200v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-03
- **作者**: Varun Varma Thozhiyoor, Shivam Tripathi, Venkatesh Babu Radhakrishnan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出评估视频模型物理推理的Principia基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的相对物理评估方法，实验严谨且实用价值高

### 3. **[WorldReward: Reward Modeling for Camera-Conditioned World Models](https://arxiv.org/abs/2609.03952v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-03
- **作者**: Yibin Wang, Zehan Wang, Junshu Tang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出WorldReward提升世界模型奖励建模
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合VLM与分块投票，实验充分且有效。

### 4. **[OctWorld: Long-Range World-Consistent Video Generation with Octree-Based 3D Mapping](https://arxiv.org/abs/2609.03919v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-03
- **作者**: Zelong Lv, Sicheng Xu, Jianfeng Xiang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于八叉树3D记忆的持久视频生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入八叉树3D记忆提升视频一致性，实验扎实。

### 5. **[Do Video Generators Track the World Across Segments? A Benchmark and Method for World-State Reasoning in Video Continuation](https://arxiv.org/abs/2609.03673v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Yingmao Miao, Pengfei Zhang, Chaoran Xu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出视频生成世界状态推理基准Statebench与方法Stateagent
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入状态推理基准与代理方法，实验详实，实用性强

## Agent

### 1. **[Terminal-Universe: Turning Agent Trajectories into Scalable Terminal Environments](https://arxiv.org/abs/2609.04148v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-09-03
- **作者**: Jie Wu, Zhenru Zhang, Beichen Zhang et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 轨迹转化为可执行环境的创新框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖实用，显著提升智能体性能

### 2. **[Speak for Me: Giving LLMs the Situational Awareness to Participate in a Meeting](https://arxiv.org/abs/2609.03923v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-09-03
- **作者**: Muneeb Khan, Frederic Kirstein, Terry Ruas et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出CAPA架构以解决大模型在在线会议中的发言时机决策问题
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出Sentinel-RL架构，解耦LLM与拓扑推理以优化安全运营。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合人机交互与模型适应，实验扎实且实用性强

### 5. **[PatchBench: Evaluating AI Agents for Vulnerability Patching](https://arxiv.org/abs/2609.04075v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Chihao Shen, Jiacheng Li, Aastha Mahajan et al.
- **标签**: `cs.CR` `cs.AI` `cs.SE`
- **AI摘要**: 提出PatchBench基准评估AI代码修复能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作完整且对漏洞修复基准有重要改进，实验扎实

## Distributed Computing

### 1. **[Every Kernel Is a Join: Automatic Multi-GPU Parallelism for AI Computations in Einsummable](https://arxiv.org/abs/2609.03905v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-03
- **作者**: Zhimin Ding, Chen-Kuan Liao, Chima Adiole et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出Einsummable系统实现自动多GPU并行
<details>
<summary>原始摘要</summary>
...
### 2. **[Barnacle: Adaptive Multi-Leader Scheduling for DAG-Based Consensus](https://arxiv.org/abs/2609.03978v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Zeno De Angeli, Alexandru Ianov Vitanov, Philipp Jovanovic et al.
- **标签**: `cs.DC` `cs.CR`
- **AI摘要**: 提出Barnacle自适应多领导者DAG共识调度机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实用，跨多个故障模型验证，写作清晰

### 3. **[Para-Pipe: Exploiting Hierarchical Operator Parallelism of ML Computational Graphs on SoCs](https://arxiv.org/abs/2609.04168v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Yujie Zhang, Huiying Lan, Ehsan Aghapour et al.
- **标签**: `cs.DC` `cs.LG` `cs.PF`
- **AI摘要**: 提出Para-Pipe层级算子并行框架以优化SoC上的深度学习推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合流水线与算子并行，在SoC边缘端评估充分且实用

### 4. **[sp-DBA: a general framework for adaptive transform-domain computation](https://arxiv.org/abs/2609.03922v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Jingkun Jiang, Pingchuan Deng, Yang Xia
- **标签**: `cs.CE` `cs.DC`
- **AI摘要**: 提出频域自适应加速框架sp-DBA
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法创新显著且在多领域实现有效加速

### 5. **[Artificial Intelligence for Energy Optimization in Data Centers](https://arxiv.org/abs/2609.03716v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Mohammed Basharath Ullah, Summaiya Unnisa Begum, Mohammed Nadeem Ullah
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 揭示数据中心AI优化的盲区并提出CLEAR-DC框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 软硬件协同设计创新，性能表现优秀，评估扎实。

## Information Retrieval

### 1. **[Rent-a-RAG: Embedding-Space Watermarks for Auditing Third-Party RAG](https://arxiv.org/abs/2609.03749v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Alexandr Goultiaev Tolstokorov, Kyriakos Mouratidis, Javad Dogani et al.
- **标签**: `cs.CR` `cs.CL`
- **AI摘要**: 提出了DirBucket水印框架审计第三方RAG数据复用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性与实用性较强，实验扎实，分类准确

### 2. **[Comparing Retrieval Methods for Academic Advisor Discovery: A Six-Method Study of 768 CS Faculty Profiles Across 9 US Universities](https://arxiv.org/abs/2609.03901v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Biraj Subedi
- **标签**: `cs.IR` `cs.LG`
- **AI摘要**: 比较六种学术顾问检索方法并进行消融实验
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究系统严谨且实用，但属于垂直领域增量创新

### 3. **[STAIR (STructure Aware Information Retriever): A novel dataset and LLM based retriever for document structure augmentation](https://arxiv.org/abs/2609.03874v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Vineet Kumar, Meghanadh Pulivarthi, vishwajeet kumar et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出利用文档全局结构的STAIR检索系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且有基准测试，实验较为充分。

### 4. **[LLM4AIGQ: LLM-based AI Guidance Query Generation Framework for Multi Interest Mining](https://arxiv.org/abs/2609.03674v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-03
- **作者**: Xiangchen Pan, Jiayi Xu, Jing Wang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出基于大模型的AI引导查询生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合LLM与多兴趣挖掘，实验充分且具实用价值

### 5. **[The WebKurator.de Platform: Combined Regional and Topical Web Curation](https://arxiv.org/abs/2609.03971v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-09-03
- **作者**: Michael Dinzinger, Natanael Arndt, Ben Böck et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出了结合区域与主题的网页策展平台WebKurator.de
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性和实用性良好，实验和方法较为扎实。

## Computer Vision

### 1. **[Tree-Structured Vector Quantization For Efficient And Progressive Image Compression](https://arxiv.org/abs/2609.03641v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-09-03
- **作者**: Xinkun Wang, Tianyi Xu, Qingyu Luo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出树结构向量量化方法实现渐进式图像压缩
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性采用曲率引导的分词与Transformer机制，实验充分。

### 3. **[Sparse auto-regressive modeling for scene generation from multi-view images](https://arxiv.org/abs/2609.03931v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Thomas Lucas, Maxime Pietrantoni, Philippe Weinzaepfel et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出稀疏自回归3D场景生成模型SPAR3S
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新有效，但在真实数据集上泛化性仍有提升空间

### 4. **[CauseCollab: Causal Unified and Modality-Agnostic Network for Heterogeneous Collaborative Perception](https://arxiv.org/abs/2609.03818v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Weize Li, Yang Li, Quan Yuan et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出因果统一的异构协同感知网络
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入因果学习解决模态差异，实验充分

### 5. **[SignSeek: Learning Transferable Representations for Sign Dictionary Retrieval](https://arxiv.org/abs/2609.03695v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Sobhan Asasi, Ozge Mercanoglu Sincan, Richard Bowden
- **标签**: `cs.CV`
- **AI摘要**: 提出SignSeek用于手语字典检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖有效，检索性能提升显著

## Machine Learning

### 1. **[Projected Riemannian Gradient Descent for the Bures-Wasserstein Barycenter: Dimension-Independent Linear Convergence at Unit Step Size](https://arxiv.org/abs/2609.03762v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-03
- **作者**: A. Afham
- **标签**: `cs.LG` `math.OC` `quant-ph`
- **AI摘要**: 提出了投影黎曼梯度下降算法求解BW重心
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新显著且解决长期理论与实践脱节问题

### 2. **[Prospective Coding Improves Learning in Deep Continuous-Time Recurrent Networks](https://arxiv.org/abs/2609.04134v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-03
- **作者**: Shivang Rawat, Mirko Morello, Flaviano Morone et al.
- **标签**: `cs.LG` `cs.NE` `q-bio.NC`
- **AI摘要**: 提出前瞻性编码以改善深度连续时间循环网络
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性和实验充分，但属于架构改进范畴

### 3. **[Differentiable Interval Bottlenecks for Interpretable Anomaly Detection in Numerical Data](https://arxiv.org/abs/2609.03878v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-03
- **作者**: Lamine Diop, Marc Plantevit
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出DIFFINT用于可解释异常检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详尽，对提升可解释性具有较高实用价值

### 4. **[High-Dimensional Learning Dynamics of Attention-Indexed Models](https://arxiv.org/abs/2609.03858v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-09-03
- **作者**: Yizhou Xu, Margarita Sagitova, Lenka Zdeborová et al.
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 揭示注意力机制的高维学习动力学与隐式偏差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具创新性，但对实际应用指导有限

### 5. **[A Computationally Feasible Framework for Causal Probabilistic Explanation](https://arxiv.org/abs/2609.04177v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-03
- **作者**: Rafal Urbaniak, Sam Witty, Daniel Waxman et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出了概率因果影响(PCI)框架以实现可扩展的因果解释
<details>
<summary>原始摘要</summary>
