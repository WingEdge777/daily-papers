...
### 1. **[RISE: Recursive Improvement via Self-Extrapolating Policy Distillation](https://arxiv.org/abs/2609.05295v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Yang Li, Semih Yavuz, Shafiq Joty
- **标签**: `cs.AI`
- **AI摘要**: 提出自外推策略蒸馏的递归改进方法
<details>
...
- **评分理由**: 新颖的自蒸馏范畴提升了推理性能，实验扎实且应用广泛。

### 2. **[Language models judge war differently when tested for alignment](https://arxiv.org/abs/2609.05009v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Maxim Chupilkin
- **标签**: `cs.AI` `cs.CY`
- **AI摘要**: 揭示对齐提示会显著改变大模型战争决策及考量权重
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨且规模大，选题具有重要的安全评估价值

### 3. **[Fractal basins trap latent reasoning](https://arxiv.org/abs/2609.04963v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Jeffrey Lai, Anthony Bao, John Quinn et al.
- **标签**: `cs.LG`
- **AI摘要**: 揭示AI推理模型中的分形盆地与暂态混沌现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合动力系统理论解释推理延迟，物理视角独特，分析扎实

### 4. **[Necessary or Sufficient? Evaluating LLM Explanations With Behavioural Evidence](https://arxiv.org/abs/2609.05385v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Urja Pawar, Rajitha Ramanayake, Nabeel Kemal et al.
- **标签**: `cs.AI`
- **AI摘要**: 评估大模型解释的必要性与充分性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究系统评估大模型解释的可靠性，方法严谨且应用价值高。

### 5. **[Molecular Déjà Vu: Digit-Level Retrieval of Published Values in Frontier Language Models](https://arxiv.org/abs/2609.05381v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Matthias Busch, Marius Tacke, Sviatlana V. Lamaka et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示大模型在分子属性预测中的记忆检索现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且有实用价值，实验详实，结构清晰。

## Natural Language Processing

### 1. **[CC-Mediation: Evaluating Large Language Models for Cross-Cultural Conflict Mediation](https://arxiv.org/abs/2609.04855v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Suhyun Lee, Wenxuan Zhang, W. Quin Yow et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出跨文化调解基准CC-Mediation并评估大模型能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 任务新颖且基准扎实，评估指标设计合理，应用潜力良好

### 2. **[A Human-in-the-Loop Framework for AI-Assisted Scoring in Large-Scale Writing Assessment](https://arxiv.org/abs/2609.05143v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: María Eugenia Curi, Germán Capdehourat, Isabel Amigo et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出了大模型辅助的大规模写作评分人机协作框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究结合实际数据设计了评分框架，实用性强但创新属常规应用。

### 3. **[NS-ST-GraphRAG: Neuro-Symbolic Spatio-Temporal GraphRAG for Literary Knowledge Processing](https://arxiv.org/abs/2609.05139v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Zheng Kui Lin
- **标签**: `cs.CL`
- **AI摘要**: 提出神经符号时空图检索增强生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合时空图与大模型，实验和基准详实但提升边缘。

### 4. **[Improving Language Identification for Code-Switched Utterances with Integer Linear Programming](https://arxiv.org/abs/2609.05099v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Joanna Radoła, Josep Maria Crego, François Yvon
- **标签**: `cs.CL`
- **AI摘要**: 用整数线性规划改进语码转换语言识别
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有创新且实验扎实，但实用性受限

### 5. **[Influence Score and Transformers interpretability: Measure of the Effective Impact of Attention Heads at inference time](https://arxiv.org/abs/2609.05074v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Lisa Bouger, Yannick Teglia, Philippe Loubet Moundi
- **标签**: `cs.CL`
- **AI摘要**: 提出注意力头影响力分数用于Transformer可解释性分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有新意且实用，实验验证充分，写作清晰。

## Vision Language Models

### 1. **[MM-IFEval-Pro: A Multilingual and Attack-Resistant Benchmark for Instruction-Following in Vision-Language Models](https://arxiv.org/abs/2609.04859v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Changming Xiao, Zhenliang Ni, Jinhui He et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出多语言抗攻击视觉语言模型指令遵循基准MM-IFEval-Pro
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补可穿戴数据推理基准空白，多模态评估严谨

### 2. **[Towards Neuro-Symbolic Procedural Reasoning for Long-Horizon Vision-Language-Action Manipulation](https://arxiv.org/abs/2609.05369v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Vivek Chavan, Yahuan Shi, Oliver Heimann et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出神经符号程序推理提升VLA长周期操作
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合符号推理与VLA模型，方法新颖且实验充分

### 3. **[InterSing: Explicit Interaction Dynamics for 3D Duet Singing Animation and Beyond](https://arxiv.org/abs/2609.04903v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Yihan Zhou, Zikai Huang, Yuyang Yu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出InterSing框架用于3D双人对唱动画生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入交互对数几率，方法和实验较为扎实

### 4. **[PRISM-Bench: An Audio-Centric Diagnostic Benchmark for Text-to-Audio-Video Generation](https://arxiv.org/abs/2609.04867v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Yuchen Sun, Qian Yang, Jun Wang et al.
- **标签**: `cs.MM` `cs.AI` `cs.SD`
- **AI摘要**: 提出了首个音视频生成的音频中心诊断基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新设计了基准与评估协议，实验较充分且贴合当前多模态需求

## Agent

### 1. **[Forgetting Without Restarting: Execution-State Unlearning for Stateful LLM Agents](https://arxiv.org/abs/2609.04875v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-04
- **作者**: Chao Yao, Yangbo Wei, Zhen Huang et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出有状态LLM智能体的执行状态遗忘方法
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Dain Kim, Eungi Cho, Kyumin Kim et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出韩国公共API多步工具调用基准及合成方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补多步工具调用空白，方法与实验扎实但局限于特定区域。

### 3. **[Optimal Rates for Agentic Networked Information Aggregation](https://arxiv.org/abs/2609.05318v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: MohammadHossein Bateni, Zahra Hadizadeh, MohammadTaghi Hajiaghayi et al.
- **标签**: `cs.LG` `cs.GT` `econ.TH`
- **AI摘要**: 解决智能体网络信息聚合最优收敛率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析严谨，填补了网络学习模型中误差率的理论空白。

### 4. **[Testing Interchangeability in LLM Agent Teams](https://arxiv.org/abs/2609.05279v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Jianxin Gao, Tianyi Yu, Linna Deng et al.
- **标签**: `cs.AI` `cs.MA`
- **AI摘要**: 评估大模型智能体团队的可替代性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究新颖且实验扎实，实用性强，结构清晰

### 5. **[How to Speculate about Uncertainty in Agentic Coding? A Draft-Model Gate Method](https://arxiv.org/abs/2609.05274v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Konstantin Grotov, Valentin Malykh
- **标签**: `cs.LG`
- **AI摘要**: 提出SU方法预测智能体编码失败
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新反向推测解码，实用性强，实验充分

## Information Retrieval

### 1. **[A Tree-based RAG Framework for Evidence-Intensive QA via Adaptive Planning and Topology-Aware Evidence Gathering](https://arxiv.org/abs/2609.04981v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Songeun Lee, Kyungjin Min, Injae Na et al.
- **标签**: `cs.AI` `cs.IR`
- **AI摘要**: 提出APT-RAG框架以解决证据密集型QA问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结构创新且实验扎实，提升信息检索与生成效率

### 2. **[Repeated Queries Exhaust an LLM's Brand Recommendations but Not Its Sources](https://arxiv.org/abs/2609.05059v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Dmitrij Żatuchin
- **标签**: `cs.IR` `cs.CL`
- **AI摘要**: 揭示重复查询对LLM品牌推荐与来源的影响机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实验充分，具有较高的学术与应用价值。

### 3. **[AtomRec: Evolving Atomic Memory for Agentic Recommendation](https://arxiv.org/abs/2609.04882v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Peiyu Hu, Weihai Lu, Siying Gu et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出原子级演化记忆的智能体推荐模型AtomRec
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖有效，实验充分，但属特定场景的改进

## Computer Vision

### 1. **[MEOX: Compact Multimodal Mixture-of-Experts for Earth Observation](https://arxiv.org/abs/2609.05351v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-04
- **作者**: Mohanad Albughdadi
- **标签**: `cs.CV`
- **AI摘要**: 提出轻量级多模态遥感混合专家模型MEOX
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.CV` `q-bio.QM`
- **AI摘要**: 利用脑龄预测模型作为钼位实现肴菲海默疼病相关MRI任务的迁移学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新和实用性良好，实验验诏段蓝丰富

### 4. **[CrossDepth: Geometry-Constrained Attention for Generalizable Multi-View Surround Depth Estimation](https://arxiv.org/abs/2609.05397v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Samer Abualhanud, Max Mehltretter
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出CrossDepth提升自动驾驶多视角深度估计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，实验扎实，实用性强

### 5. **[Reflection-aware Generative Novel View Synthesis](https://arxiv.org/abs/2609.05382v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: GeonU Kim, Shin Dong-Yeon, Tae-Hyun Oh
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出无需训练的反射感知新视点合成方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖解决镜面反射视点合成，方法巧妙且有效。

## Machine Learning

### 1. **[A Unified Physics-Aware Quantum Machine Learning Framework across Power GaN HEMTs and Logic Nanowire FETs: Predicting Unseen Process Splits and Held-Out Geometry Combinations with Lower Error and Tighter Split-to-Split Variability](https://arxiv.org/abs/2609.05251v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Rushat Rai, Yun-Yuan Wang, Autsada Kakaen et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出量子机器学习框架用于半导体器件建模
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合RL与PQC建模，实验充分但范围较窄

### 2. **[A Deep Generative Model for Synthesizing Labeled Wireless Signals](https://arxiv.org/abs/2609.05396v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Yuxiao Li, Keke Hu, Santiago Mazuelas et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出IIns-GAN生成带标签的无线信号
<details>
<summary>原始摘要</summary>
...
### 3. **[Variational Continuation for Double Pendulum Periodic Orbits](https://arxiv.org/abs/2609.05337v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Leo Yao, Ziming Liu, Max Tegmark
- **标签**: `cs.LG` `math-ph` `nlin.CD`
- **AI摘要**: 提出基于Hessian与自动微分的周期轨道变分延拓方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新有效，物理应用严谨，写作清晰。

### 4. **[Embedded Graph Flows for Categorical Graph Generation](https://arxiv.org/abs/2609.05328v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Ethan Ma, Zihan Wang, Chris Siu Yeung Chow et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出嵌入图流用于分类图生成
<details>
<summary>原始摘要</summary>
...
### 5. **[AI for Computational Design Science: A Responsible Human-AI Framework and Case Study on Short-Form Video Safety Surveillance](https://arxiv.org/abs/2609.05270v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Wenli Zhang, Jiaheng Xie, Zhihe Pan et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出负责任的AI计算设计科学框架及应用
<details>
<summary>原始摘要</summary>
