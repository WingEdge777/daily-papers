...
### 1. **[Data Scarcity and Model Sparsity: Mixtures-of-Experts Overfit More to Repeated Data](https://arxiv.org/abs/2609.11917v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Atindra Jha, Margaret Li, Jure Leskovec et al.
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 揭示MoE模型在重复数据训练下更易过拟合的机制与对策
<details>
...
- **评分理由**: 研究深入探讨了稀疏模型与数据重复的交互，实验严谨且结论具有重要实践指导意义。

### 2. **[SpecGuard: Inference-Time Backdoor Detection For Free](https://arxiv.org/abs/2609.11799v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Rui Wen, Ahmed Salem, Andrew Paverd et al.
- **标签**: `cs.CR` `cs.CL`
- **AI摘要**: 利用投机采样实现零额外计算的后门检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用投机采样机制，兼顾了检测性能与推理效率。

### 3. **[The widening evaluation gap in medical large language model research 2023 to 2026](https://arxiv.org/abs/2609.11770v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Raad Bin Tareaf, Murad Al-Rajab, Samia Loucif
- **标签**: `cs.CL`
- **AI摘要**: 揭示医学大模型研究存在严重的评估滞后现象。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 量化分析了模型迭代与临床评估间的脱节，方法严谨。

### 4. **[SIRF: A Spec-Internalized Risk Foundation Model for Industrial Content Risk Control](https://arxiv.org/abs/2609.11752v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Suwan Wu, Yumeng Lin, Pengcheng Yuan et al.
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 通过CPT将合规策略内化至模型权重，提升风控效率。
<details>
<summary>原始摘要</summary>
...
### 1. **[Cross-Lingual Clinical Annotation Projection as Constrained Text Generation: A Six-Language Study](https://arxiv.org/abs/2609.11450v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-10
- **作者**: Álvaro Rey-Blanes, Francisco J. Moreno-Barea, Francisco J. Veredas
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出基于大模型的临床标注跨语言迁移新方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，显著提升了多语言标注效率。

### 2. **[Beyond Word Error Rate: A Switch Aware Evaluation of ASR and Audio Language Models on English Yoruba Code-Switched Speech](https://arxiv.org/abs/2609.11786v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Chibuzor Okocha, Christan Earl Grant
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出英约语码转换语音评估新指标
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对低资源语码转换提出细粒度评估指标，揭示了WER的局限性，方法严谨且具有重要实用价值。

### 3. **[TransClean: A Benchmark for Detecting and Extracting Clean Translations from Large Language Model Outputs](https://arxiv.org/abs/2609.11399v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Shenbin Qian, Yves Scherrer
- **标签**: `cs.CL`
- **AI摘要**: 提出TransClean基准以清洗大模型翻译输出中的噪声。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了LLM翻译噪声研究的空白，方法严谨且实用性强。

### 4. **[MUtE: A Dual Framework for Concept Erasure and Counterfactual Interventions](https://arxiv.org/abs/2609.11253v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Antoine Saillenfest
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出双重框架实现概念擦除与反事实干预
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨且兼顾公平性与生成任务，具有较高实用价值。

### 5. **[Epistemic orientation predicts legislative effectiveness among members of the US Congress](https://arxiv.org/abs/2609.11865v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-10
- **作者**: Segun Aroyehun, Stephan Lewandowsky, David Garcia
- **标签**: `cs.CL`
- **AI摘要**: 研究发现议员的证据导向语言与立法效能呈正相关。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨，将语言分析与政治效能结合，具有跨学科价值。

## Vision Language Models

### 1. **[Prompt Revision as a Source of Cultural Bias in Text-to-Image Systems](https://arxiv.org/abs/2609.11532v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-10
- **作者**: Aleksandra Urman, Elsa Lichtenegger, Salima Jaoua et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示提示词修订层是文生图系统文化偏见的主要来源。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过认知科学视角构建拓扑推理基准，实验设计严谨且具有启发性。

### 3. **[Caption-once, Frames-on-Demand: Visual-Need Routing for Budget-Aware Agentic Long Video Understanding](https://arxiv.org/abs/2609.11899v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Weitong Cai, Hang Zhang, Yukai Huang et al.
- **标签**: `cs.CV` `cs.HC`
- **AI摘要**: 提出CFD框架实现长视频高效理解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过视觉文本双轨索引与路由机制，显著提升了边缘计算效率。

### 4. **[Your Model Already Knows Don't Teach It, Learn to Ask It: Soft Prompting for Few-Shot Adaptation of Vision-Language Models](https://arxiv.org/abs/2609.11310v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Gautam Rajendrakumar Gare, Siyi Li, Hewei Wang et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出软提示微调方法，高效适配视觉语言模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且参数高效，实验设计严谨，对比全面。

### 5. **[Can Edge-Deployable Vision-Language Models Identify Species?](https://arxiv.org/abs/2609.11916v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-10
- **作者**: William Zhou, Mayukha Siripuram, Xiao Yan et al.
- **标签**: `cs.AI`
- **AI摘要**: 评估边缘VLM在物种识别中的性能与局限
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，对比了VLM与专用模型在野外环境的差距。
...
- **评分理由**: 理论创新扎实，实验效果显著，具有广泛应用价值。

### 2. **[Thinking with Looped Flows](https://arxiv.org/abs/2609.11801v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-10
- **作者**: Ayhan Suleymanzade, Chanhyuk Lee, Floor Eijkelboom et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出循环流模型提升推理计算能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过局部去噪目标优化循环，在推理任务中表现优异

### 3. **[RDDMPI: Residual Denoising Diffusion Model for Probabilistic Multivariate Time Series Imputation](https://arxiv.org/abs/2609.11648v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-10
- **作者**: Ramiro Valdes Jara, David Chapman, Adam Meyers
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出残差扩散模型提升时间序列插补
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过残差分解简化扩散过程，方法创新且实验扎实。

### 4. **[LoaDiff: Conditional Generation of Electricity Consumption Time Series for Energy Analytics](https://arxiv.org/abs/2609.11639v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-10
- **作者**: Mariia Baranova, Adrien Petralia, Etienne Le Naour et al.
- **标签**: `cs.LG` `cs.AI` `eess.SP`
- **AI摘要**: 提出基于扩散模型的电力负荷序列生成方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且评估全面，在能源数据合成领域具有较高实用价值。

## Multimodal

### 1. **[SenseNova-U1.5: Towards Native Unified Visual Intelligence](https://arxiv.org/abs/2609.11929v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Haiwen Diao, Jiahao Wang, Chenjing Ding et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出无编码器原生统一多模态模型SenseNova-U1.5
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且性能优异，多任务处理能力强，实验设计严谨。

### 2. **[TART: A Modular Tool for Technique-Aware Audio-to-Tablature Guitar Transcription](https://arxiv.org/abs/2609.11904v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Akshaj Gupta, Hwi Joo Park, Andrea Guzman et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出TART模型实现吉他音频到指法与技巧的自动转录
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模块化设计创新且性能显著提升，实验评估扎实全面。

### 3. **[Component-Aware Differential Privacy for Federated Multilingual Speech-LLMs](https://arxiv.org/abs/2609.11762v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Jordi Luque, Fernando López, Aleix Sant
- **标签**: `cs.CL`
- **AI摘要**: 提出α-split解决语音LLM联邦学习隐私预算分配失衡问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对性解决跨模态梯度范数差异，方法严谨且实用性强。

### 4. **[OmniKVQuant: KV Cache Quantization for Omni-LLMs](https://arxiv.org/abs/2609.11582v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Suho Yoo, Hyunjong Ok, Jongmin Choi et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出OmniKVQuant实现多模态大模型KV缓存2-bit量化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对多模态KV缓存特性提出创新量化方法，实验充分且性能优异。

### 5. **[Exploring Diffusion Transformers for Cross-Modal Augmentation in Multimodal Brain State Decoding](https://arxiv.org/abs/2609.11341v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Ziwei Wang, Xingyi He, Hongbin Wang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出CoMA-DiT模型实现多模态脑电信号的交叉增强与解码。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用扩散模型进行跨模态数据增强，实验详实且效果显著。

## Image Generation

### 1. **[Logit Refiner: Improving Visual Autoregressive Models via Intra-Scale Dependency Modeling](https://arxiv.org/abs/2609.11804v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Meimingwei Li, Stefan Andreas Baumann, Felix Krause et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出Logit Refiner优化VAR模型内尺度依赖
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过轻量级模块解决VAR并行解码局限，提升生成质量且无需重训。

### 2. **[Learning Interaction between Image and Layout Priors for Joint Image-Layout Generation in Design Templates](https://arxiv.org/abs/2609.11519v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-10
- **作者**: Shirong Yang, Bo Yang, Ying Cao
- **标签**: `cs.CV` `cs.AI` `cs.GR`
- **AI摘要**: 提出InterIL模型实现图像与布局联合生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过通信模块融合预训练模型，提升设计生成和谐度

## Video Generation

### 1. **[World in World: Explore the World with World Models](https://arxiv.org/abs/2609.11548v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Chenxi Song, Yanming Yang, Chi Zhang
- **标签**: `cs.CV`
- **AI摘要**: 提出无需训练的视频世界模型控制框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过推理时接口实现高效视频重渲染与控制，方法创新且实验扎实。

### 2. **[Harnessing Intrinsic Subject-Aware Attention for Controllable Multi-Subject Video Generation](https://arxiv.org/abs/2609.11507v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Niange Yu, Ye Tian, Biaolong Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出DIAL框架实现多主体视频生成的高保真与可控性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用DiT内部注意力机制优化生成，方法创新且实验扎实。

### 3. **[Uncertainty DMD: Restoring Diversity in Few-Step Autoregressive Video Distillation](https://arxiv.org/abs/2609.11265v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Zixuan Duan, Xunzhi Xiang, Yabo Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Uncertainty DMD解决AR视频生成多样性崩溃问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过扰动机制有效缓解了蒸馏带来的确定性偏差，方法简洁且实验扎实。

### 4. **[Vidu S2: Real-Time Interactive, Editable, and Spatial Video Generation](https://arxiv.org/abs/2609.11638v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-10
- **作者**: Jintao Zhang, Kai Jiang, Jintao Chen et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出支持实时交互与编辑的视频生成模型Vidu S2。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实现了实时视频生成与编辑的突破，应用潜力大，实验详实。

## Agent

### 1. **[Magenta: Closing the Loop Between Mathematical Reasoning and Lean Verification](https://arxiv.org/abs/2609.11319v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-10
- **作者**: Joshua Ong Jun Leang, Haonan Li, Zheng Zhao et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出Magenta框架实现非形式化推理与Lean形式化验证闭环。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过形式化验证解决数学推理可靠性，性能表现卓越。

### 2. **[ORCH: Organizational Principles Enable Collective Intelligence in Embodied AI](https://arxiv.org/abs/2609.11737v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-09-10
- **作者**: Zhengran Ji, Jonathan Hyun, Boyuan Chen
- **标签**: `cs.MA` `cs.AI` `cs.LG`
- **AI摘要**: 引入组织理论构建具身智能体协作框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过组织理论优化多智能体协作，实验严谨且提升显著。

### 3. **[ActSafeGuard: Differentiable and Training-Aligned Constraint Enforcement for Flow-Matching Policies](https://arxiv.org/abs/2609.11697v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-09-10
- **作者**: Jianming Ma, Rongjun Jin, Xiaxi Si et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出ActSafeGuard实现流匹配策略的硬约束安全保障
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，有效解决了机器人安全部署问题

### 4. **[When Agents Disagree: Bayesian Backward Reasoning as a Label-Free Anchor for Multi-Agent Collective Decision-Making](https://arxiv.org/abs/2609.11709v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Ken Chen, Wei Wang, Sachith Seneviratne et al.
- **标签**: `cs.AI` `cs.MA`
- **AI摘要**: 提出贝叶斯反向推理锚点以优化多智能体决策一致性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过反向推理解决多智能体冲突，方法创新且实验扎实。

### 5. **[COBRA-Skills: Contextual Bandit-Guided Evolution for Agent Skill Optimization](https://arxiv.org/abs/2609.11682v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Pingchen Lu, Xiangyi Wang, Xiang Li et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出COBRA-Skills框架优化智能体技能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过上下文赌博机机制显著提升了技能演化效率与性能

## Distributed Computing

### 1. **[Characterizing Job Power Elasticity for Power-Flexible AI Training](https://arxiv.org/abs/2609.11542v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-09-10
- **作者**: Philip Colangelo, Charles Dawson, Shayan Sengupta et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出量化大模型训练功耗弹性的指标PFI并优化资源分配。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性量化了训练功耗弹性，实验扎实且具有极高的工程实用价值。

### 2. **[Entwine: Coordinating Tiled Computation and Fine-Grained Communication across GPUs](https://arxiv.org/abs/2609.11562v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Kai Ma, Quanfeng Lv, Jingguo Ge et al.
- **标签**: `cs.DC` `cs.AR`
- **AI摘要**: 提出Entwine框架优化GPU计算与通信的协同调度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过精细化调度提升了分布式计算效率，实验结果显著。

### 3. **[Can AI Remediate Backend Failures Safely? GuardedAct with Blast-Radius-Aware Sandboxing](https://arxiv.org/abs/2609.11264v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Wanrong Cai, Tianyu Yu, Shaorui Pi et al.
- **标签**: `cs.DC` `cs.SE`
- **AI摘要**: 提出GuardedAct框架，实现AI修复微服务故障的安全沙箱化。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过数字孪生沙箱有效降低了AI自动化运维的风险，实验设计严谨且实用。

### 4. **[You've Got a BUD in Me: Authenticated Reads from Per-Block Write Logs](https://arxiv.org/abs/2609.11251v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Alejandro Ranchal-Pedrosa, Cody Littley, Ben Marsh
- **标签**: `cs.CR` `cs.DB` `cs.DC`
- **AI摘要**: 提出BUD机制优化区块链历史状态验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分层摘要显著提升了区块链状态查询效率与扩展性

### 5. **[The Semantic Elevation Operator and the Closure of the Undecidable Class under Preservation](https://arxiv.org/abs/2609.11326v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-10
- **作者**: Jose Pascual Gumbau Mezquita
- **标签**: `cs.LO` `cs.AI` `cs.CL`
- **AI摘要**: 提出语义提升算子以证明自修改系统属性的不可判定性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，逻辑严密，但应用场景较为抽象。

## Information Retrieval

### 1. **[INDRA: A New AI Tool for Exploring Tobacco, Fossil Fuel, and Chemical Industry Archives](https://arxiv.org/abs/2609.11261v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-09-10
- **作者**: Daniel Akselrad, Robert N. Proctor
- **标签**: `cs.DL` `cs.CL` `cs.CY`
- **AI摘要**: INDRA通过架构约束提升档案检索的准确性与可审计性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地解决了大模型在专业档案检索中的幻觉问题

### 2. **[Generative Late-Interaction Embeddings For Visual Document Retrieval](https://arxiv.org/abs/2609.11808v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Mohamed Eltahir, Talal Aloushan, Rose Khairoalsendi et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出GLIE实现高效视觉文档检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过生成式重构优化存储，方法创新且实验扎实。

### 3. **[Your Retriever Already Knows: Distribution-Shape QPP for RAG Retrieval Sufficiency](https://arxiv.org/abs/2609.11646v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Matyáš Veselý, Michal Průšek, Jiří Franc
- **标签**: `cs.IR`
- **AI摘要**: 提出分布形状QPP方法提升RAG检索质量预测效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，显著提升了检索评估的效率与准确性。

### 4. **[TimelyRAG: Semantic-Temporal Hybrid Retrieval for Time-Critical Question Answering in Overlapping-Evolving Documents](https://arxiv.org/abs/2609.11572v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Youngeun Nam, Joeun Kim, Hwanjun Song et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出TimelyRAG解决重叠演化文档的时效性检索问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对法律法规等重叠演化文档提出了创新检索框架，实验扎实且具有实际应用价值。

### 5. **[From Document Silos to Process Intelligence: A Multi-Layer Knowledge Graph for CMC Process Development](https://arxiv.org/abs/2609.11493v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Reza Amirmoshiri, Faryad Sahneh, Yasser Jangjou
- **标签**: `cs.AI` `cs.MA`
- **AI摘要**: 构建多层知识图谱实现CMC流程智能化管理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出双层知识图谱架构，评估协议严谨且具有行业应用价值。

## Computer Vision

### 1. **[Revisiting Avatar-As-Image: High-Fidelity Registration is All You Need](https://arxiv.org/abs/2609.11722v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-10
- **作者**: Margaret Kostyrko, Yuxuan Xue, Garvita Tiwari et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出AvaImg实现高保真人体扫描到UV映射的精确注册。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过高效优化流程解决了人体注册难题，实验验证效果显著。

### 2. **[A Two-Mirror Faceted Projection System for EUV Lithography](https://arxiv.org/abs/2609.11299v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-10
...
- **评分理由**: 设计创新且理论严谨，显著提升了EUV光刻效率

### 3. **[3D Point Splatting for mmWave Radar Novel View Synthesis](https://arxiv.org/abs/2609.11894v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-09-10
- **作者**: Adnan Armouti, Yixuan Gao, Rajalakshmi Nandakumar
- **标签**: `cs.CV` `cs.GR` `cs.LG`
- **AI摘要**: 提出3DPS雷达渲染器，实现高效物理级新视角合成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合物理模型与点渲染，性能显著优于现有基线。

### 4. **[GRIPNet: Gaussian Radial Intensity Prior Guided Architecture for Pulmonary Nodule Detection in CT](https://arxiv.org/abs/2609.11312v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-09-10
- **作者**: Haojie Yang, Ran Su
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 基于高斯径向先验的肺结节检测网络
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用成像物理特性改进卷积结构，性能提升显著且逻辑严密。

### 5. **[Geospatial Foundation Models Capture Health-Relevant Dimensions of Place Beyond Conventional Social Risk Indices](https://arxiv.org/abs/2609.11689v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Nathaniel Hendrix, Carl Y. Zhang, Chris Heitzig et al.
- **标签**: `stat.AP` `cs.LG`
- **AI摘要**: 利用地理基础模型补充社会风险指数以提升健康预测精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，通过卫星数据挖掘环境健康特征，具有显著应用价值。
...
- **标签**: `cs.DC` `cs.AI` `cs.GT`
- **AI摘要**: 通过编译优化实现CFR算法GPU加速
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决GPU调度瓶颈，性能提升显著且实验扎实

### 2. **[Target leakage, not model class, explains reported accuracy in survey-based cardiovascular screening: a leakage-tiered audit of glass-box and tabular foundation models](https://arxiv.org/abs/2609.11838v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-10
- **作者**: Raad Bin Tareaf, Murad Al-Rajab, Samia Loucif et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示心血管筛查高精度源于数据泄露而非模型能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨的审计证明特征选择比模型架构更关键

### 3. **[Dynamic language model representations for multi-objective reaction optimisation](https://arxiv.org/abs/2609.11790v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-10
- **作者**: Joshua W. Sin, David Ming Segura, Bojana Ranković et al.
- **标签**: `cs.LG`
- **AI摘要**: 利用语言模型动态表征优化化学反应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且实验验证充分，显著提升优化效率

### 4. **[Taming Bitwise Behavior in GPU Kernels with Tensor Core: Black-Box Reconstruction, Compiler Enforcement, and Static Verification](https://arxiv.org/abs/2609.11356v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-10
- **作者**: Ziteng Yang, Nicholas J. Riasanovsky, Warren Deng et al.
- **标签**: `cs.DC` `cs.PF` `cs.PL`
- **AI摘要**: 提出GPU内核位级确定性重构与验证框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了GPU算术不确定性难题，兼具理论创新与工程实用价值。

### 5. **[Biology-in-the-loop: Amortized Adaptive Hit Discovery in CRISPR Screens](https://arxiv.org/abs/2609.11877v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-09-10
- **作者**: Carl Edwards, Edward De Brouwer, Xiner Li et al.
- **标签**: `q-bio.QM` `cs.AI` `cs.CL`
- **AI摘要**: 提出AssayLoop框架实现高效CRISPR筛选。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模基准与Transformer策略提升了实验发现效率。
