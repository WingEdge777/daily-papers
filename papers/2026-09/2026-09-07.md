...
### 1. **[Unifying ICL, SFT, KL-Regularized RL Through a Bayesian Lens](https://arxiv.org/abs/2609.05111v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-04
- **作者**: Junxin Fan
- **标签**: `cs.AI`
- **AI摘要**: 从贝叶斯视角统一了ICL、SFT与KL正则化RL
<details>
...
- **评分理由**: 理论统一视角新颖，对大模型训练范式具较好指导价值

### 2. **[LLM-Guided Program Evolution for Circle Packing: Breaking 10 Packomania Records for $28](https://arxiv.org/abs/2609.05093v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-04
- **作者**: Wes Sander
- **标签**: `cs.AI`
- **AI摘要**: 提出Discovery Loop系统用大模型演化圆堆打包算法并打破多项纪录
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合LLM与算法演化，实用价值高，实验扎实且成本低。

### 3. **[Large Language Models for HVAC Operations in Building Energy Systems: A Critical Review of Methods, Applications, and Deployment Readiness](https://arxiv.org/abs/2609.05314v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-04
- **作者**: Alexander Neubauer, Tianzhen Hong, Han Li et al.
- **标签**: `cs.AI` `cs.CL` `eess.SY`
- **AI摘要**: 系统评述大语言模型在HVAC运行中的应用与成熟度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 文献综述系统全面，分析严谨，对实际部署评估客观

### 4. **[Can Large Language Models Anticipate Behavioral Responses to Social Policies? A Case of Pension Enrollment Prediction among China's Flexible Workers](https://arxiv.org/abs/2609.05189v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-04
- **作者**: Yumiao Li, Peixin Liu, Donglin Di et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出大模型预测中国灵活就业人员养老金参保行为
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合社保政策与大模型，实验设计严谨且实用价值高

### 5. **[Don't Drop Dropout: Optimizing Layer Sparsity for Efficient LLM Training and Inference](https://arxiv.org/abs/2609.05275v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-09-04
- **作者**: Mostafa Elhoushi, Alex Pretko, Nolan Dey et al.
- **标签**: `cs.AI`
- **AI摘要**: 优化大模型层丢弃策略以加速训练与推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验全面且效果显著，对大模型训练具有较高实用价值

## Natural Language Processing

### 1. **[Beyond Aggregate Scores: Behavioral Correctness Assumptions for Assessing Reference-Based Automatic Evaluation Methods](https://arxiv.org/abs/2609.05289v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Maria Mahbub, Ashley Rice, Michael R. Munroe et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出自动评估方法的行为正确性假设框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入行为假设框架，实验扎实且实用性强

### 2. **[EuroAlpaca: Task-Preserving Localisation of Instruction Data for European Languages](https://arxiv.org/abs/2609.05043v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Aleix Sant, Jordi Luque, Carlos Escolano
- **标签**: `cs.CL`
- **AI摘要**: 提出EuroAlpaca本地化流水线以提升欧洲多语言指令微调
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且实验充分，具有较高的多语言大模型应用价值

### 3. **[Technical Manual for a Toolkit for Measuring Contextual Individuation in Transformer Language Models](https://arxiv.org/abs/2609.05333v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: José Luciano Verçosa Marques, Frederico Jorge Heitmann, Daniel Omar Perez et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 发布用于测量Transformer语境个体化工具包的技术手册
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论清晰且实用性强，属于增量式的工具创新

### 4. **[LexFlip: A Dissociation Diagnostic for Legal Meaning Preservation Metrics](https://arxiv.org/abs/2609.05296v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Gaurab Baral
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出LexFlip数据集与解耦诊断法评估法律文本语义保持度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且严谨，但受限于特定法律法语场景，实用性适中。

### 5. **[Self-Supervised Lexical Representation Learning for Fast, Large-Scale Phylogenetic Inference](https://arxiv.org/abs/2609.05262v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Tim Wientzek
- **标签**: `cs.CL`
- **AI摘要**: 提出无监督词汇表示学习方法实现高效的大规模系统发生推断
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实用性高，实验扎实且表述清晰。

## Vision Language Models

### 1. **[Cross-Domain Tracker Adaptation Without Target-Domain Labels via Vision-Language Agents](https://arxiv.org/abs/2609.05239v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-04
- **作者**: Daniel Davila, Ravikumar Balakrishnan, Mike Cochran
- **标签**: `cs.CV`
- **AI摘要**: 提出利用VLM实现无监督跨域多目标跟踪自适应的方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合VLM与目标追踪，实验充分且实用性强

### 2. **[From Vision to Language: Investigating Causal Information Flow in Multimodal Decision-Making](https://arxiv.org/abs/2609.05149v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Davide Testa, Hugh Mee Wong, Alessandro Lenci et al.
- **标签**: `cs.CL` `cs.CV`
- **AI摘要**: 探究多模态大模型中跨模态因果信息流
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且具新颖性，但应用场景有一定局限

### 3. **[MCPO: Modality-Contrastive Preference Optimization for Multimodal Chain-of-Thought Compression](https://arxiv.org/abs/2609.04947v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Guangheng Yang, Zhenliang Ni, Zhenkai Wu et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出MCPO实现多模态思维链的高效压缩与对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合跨模态对比与偏好优化，实验充分，实用性较强。
...
- **作者**: Homayoun Afshari, Pietro Basci, Alessandro Russo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出神经符号视觉推理框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新结合VLM与D-LTN，实验充分

### 5. **[Same Trajectory, Contradictory Rewards (ROBORMBENCH): Paraphrase Fragility in Vision Language Reward Models](https://arxiv.org/abs/2609.05401v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Wonje Jeung, Sangyeon Yoon, Hyesoo Hong et al.
- **标签**: `cs.RO` `cs.CL`
- **AI摘要**: 提出评估VLM奖励模型指令鲁棒性的新基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作完整但属于特定任务的鲁棒性评估，增量适中

## Diffusion Models

### 1. **[One Diffusion Model, Two Roles: Guided Trajectory Planning and Safety-Critical Scenario Generation in Closed-Loop Simulation](https://arxiv.org/abs/2609.04921v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-04
- **作者**: Arka Pal, Rajesh Kumar, Hannes Eriksson et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 利用扩散模型同时实现端到端运动规划与安全场景生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合规划与场景生成，实验扎实且应用价值高

### 2. **[When Genomic Masking Priors Fail to Transfer: Strong Variant Prediction, Weak Functional Generation](https://arxiv.org/abs/2609.04861v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Susu Hu, Preetam Gattogi, Jens Lehmann et al.
- **标签**: `cs.LG`
- **AI摘要**: 揭示基因组扩散模型变异预测与泛化能力的分离现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法与消融实验扎实，结论对领域有重要警示意义

### 3. **[Diffusion TV: Experiencing Diffusion Models through Tangible, Embodied Interaction](https://arxiv.org/abs/2609.05404v1)**
...
- **评分理由**: 创新性结合实体交互与生成模型，工程实现直观但理论贡献有限。

## Multimodal

### 1. **[ProCA: Progressive Contrastive Alignment for Robust EEG Visual Decoding](https://arxiv.org/abs/2609.05094v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Kanglei Zhou, Chunyan Lan, Dongyang Li et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出渐进式对比对齐方法用于鲁棒的脑电视觉解码
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合视觉语言先验与脑电自适应对齐，实验全面且提升显著。

### 2. **[Real-World Multi-Modal and Longitudinal Lung Cancer Dataset](https://arxiv.org/abs/2609.05202v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Rita Cordeiro Mendes, Maria Rita Fonseca Verdelho, Carlos Santiago et al.
- **标签**: `eess.IV` `cs.CV`
- **AI摘要**: 提出真实世界肺癌多模态纵向数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实验充分，具有较高医疗应用价值

### 4. **[WeAgent-MMGenEdit: A Full-Stack Recipe for Multimodal Agentic Image Generation and Editing](https://arxiv.org/abs/2609.05171v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Hui Zhang, Zongkai Liu, Liqiang Niu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出WeAgent-MMGenEdit图文生成代理方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新全面但属应用探索，方法严谨且实用价值高

### 5. **[SciDocBench: A Workflow-Centered Benchmark and Data Pipeline for Scientific Document Understanding](https://arxiv.org/abs/2609.05141v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Shenxi Wu, Yuhong Liu, Haosong Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出科研文档理解基准与训练框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作完整且实用，基准与数据管线设计扎实。

## Image Generation

### 1. **[Compositional Reward Models for Conditional Medical Image Generation](https://arxiv.org/abs/2609.05028v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-09-04
- **作者**: Aayush Kumar Tyagi, Prathosh A. P., Mausam
- **标签**: `cs.CV`
- **AI摘要**: 提出医疗图像生成的多阶段组合奖励模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用，实验扎实且提升明显

### 2. **[Measured Sliders: Learning Continuous Controls from Differentiable Image Measurements](https://arxiv.org/abs/2609.05234v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Yijia Chen, Boyu Wei, Xuanhua Yin
- **标签**: `cs.CV`
- **AI摘要**: 提出了基于可微图像测量的连续滑动条学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点明确且实验扎实，提升了生成控制的精确度与可组合性

### 3. **[RefDiT: Local Attribute Guidance in Reference-Based Image Generation](https://arxiv.org/abs/2609.04976v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Rameshwar Mishra, Srikrishna Karanam, A V Subramanyam
- **标签**: `cs.CV`
- **AI摘要**: 提出RefDiT实现局部属性引导的图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新但评估一般，属于常规改进

## Video Generation

### 1. **[TourPhysics: Bringing Physics to World Models for Exploration and Manipulation from a Single Image](https://arxiv.org/abs/2609.04911v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Xin Zhang, Yabo Chen, Zixuan Duan et al.
- **标签**: `cs.CV`
- **AI摘要**: 结合物理模拟与视频生成的世界模型框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合物理模拟与生成模型，方法扎实

## Agent

### 1. **[Trace2Tower: Transition-Aware EigenTrace Induction of Multi-Level Skills for LLM Agents](https://arxiv.org/abs/2609.05261v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-09-04
- **作者**: Jiazheng Sun, Boyu Yang, Binhao Yuan et al.
- **标签**: `cs.AI` `cs.SE`
- **AI摘要**: 提出转换感知特征轨迹框架构建技能塔
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.AI`
- **AI摘要**: 提出了联合训练推理与元技能智能体的CoSkill框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性高且在复杂基准上效果显著，实验扎实。

### 3. **[CUA-Universe: A Scalable and Dynamic Environment for Hybrid GUI+CLI Agents](https://arxiv.org/abs/2609.05374v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-04
- **作者**: Haoting Shi, Wenhao Wang, Weicheng Fang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出支持混合GUI与CLI的智能体环境CUA-Universe
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合GUI与CLI，实验扎实且提升显著。

### 4. **[Design Docs Are All You Need: An AI-native Machine-Learning Performance Tool](https://arxiv.org/abs/2609.05364v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-04
- **作者**: Samuel Kushnir, Kimia Noorbakhsh, Kavya Sreedhar et al.
- **标签**: `cs.PL` `cs.AI`
- **AI摘要**: 提出以设计文档为主体的AI原生机器学习性能工具。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实用性与严谨度兼备，表述清晰。

### 5. **[CONTINUITY: Security-Context Contracts for Composable LLM Agent Controls](https://arxiv.org/abs/2609.05269v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-04
- **作者**: Chris Zheng, Geng Yang
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出可验证智能体安全控制组合框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，形式化证明与实验充分，具有较高应用价值

## Distributed Computing

### 1. **[Beyond Scalar Flexibility: From Eligible AI Workloads to Dependable Load Relief](https://arxiv.org/abs/2609.05406v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Meiyi Li
- **标签**: `eess.SY` `cs.DC`
- **AI摘要**: 基于真实GPUTrace量化AI数据中心电网柔性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究切入点新颖且基于实证，对电网和算力协同有较高实用价值

### 2. **[RegionFed: Federated Learning for Personalized Query Understanding in Heterogeneous Retail Environments](https://arxiv.org/abs/2609.05403v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Quoc H. Nguyen, Ali Lafzi, Abhijeet Phatak et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出RegionFed联邦学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新梯度个性化方法，实验充分，效果显著。

### 3. **[Solution-space heterogeneity shapes federated learning dynamics across partial differential equations](https://arxiv.org/abs/2609.05012v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Ping Luo, Jiahuan Wang, Ziqing Wen et al.
- **标签**: `cs.LG` `cs.DC`
- **AI摘要**: 提出PDE联邦学习解空间异质性评估协议
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨创新，但应用场景相对垂直受限

### 4. **[GreenPipe: Power Modeling for Containerized DNN Inference on Kubernetes Edge Nodes](https://arxiv.org/abs/2609.04952v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Mengxue Wang, Peini Liu, Amir Taherkordi et al.
- **标签**: `cs.DC` `cs.PF`
- **AI摘要**: 边缘节点容器化DNN推理的功耗建模与评估管道
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用有效，实验扎实，但创新性相对一般

## Information Retrieval

### 1. **[SAM-D2Q: Aligning Multimodal Doc2Query with Search Demand and Conversion for E-commerce](https://arxiv.org/abs/2609.04961v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-04
- **作者**: Hui Zhou, Jian Hui Ji, Lei Ma et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出多模态电商文档扩展框架SAM-D2Q
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合多模态与强化学习提升电商检索，工业界落地效果显著

### 2. **[Compression Beyond the Uncompressed: A Two-Stage Training Recipe for Soft Context Compression in RAG](https://arxiv.org/abs/2609.05152v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Shuyu Guo, Shuo Zhang, Zhaochun Ren
- **标签**: `cs.CL`
- **AI摘要**: 提出了双阶段软上下文压缩方案提升RAG效率
<details>
<summary>原始摘要</summary>
...
### 3. **[Embedding Surgery: Localized Updates for Adaptive Ranking Correction in Dense Retrieval](https://arxiv.org/abs/2609.05110v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Maddalena Amendola, Antonio Mallia, Raffaele Perego
- **标签**: `cs.IR`
- **AI摘要**: 提出嵌入手术方法，实现稠密检索的局部自适应排序纠正。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点清晰，实验充分，实用性较强。

### 4. **[Distill Globally, Adapt Locally: Reasoning Distillation and Product-Type Test-Time Training for Scalable Trade-Up Recommendation](https://arxiv.org/abs/2609.05363v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Siliang Liu, Mohammad Ghasemi, Sapan Patel et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出高效的商品升级推荐双层框架
<details>
<summary>原始摘要</summary>
...
### 5. **[Beyond Co-purchase Relation: Evolution of Complementary Recommendations at Allegro](https://arxiv.org/abs/2609.05063v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-04
- **作者**: Aleksandra Osowska-Kurczab, Klaudia Nazarko, Eliška Kosturová et al.
- **标签**: `cs.IR` `cs.AI` `cs.LG`
- **AI摘要**: 提出电商互补推荐生产级框架AlleCompanion
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合单物体先验与多视点观察，实验扎实且应用广泛。

### 2. **[Compact Neural Appearance Models for Efficient Gaussian Splatting](https://arxiv.org/abs/2609.05255v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-04
- **作者**: Florian Hahlbohm, Jorge Condor, Linus Franke et al.
- **标签**: `cs.CV` `cs.GR`
- **AI摘要**: 提出紧凑神经外观模型优化高斯喷洒
<details>
<summary>原始摘要</summary>
...
### 3. **[MINT: A Unified Model for World-Space Camera and Hand Motion Estimation from Scalable Egocentric Pipeline Supervision](https://arxiv.org/abs/2609.04958v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-09-04
- **作者**: Zijie Zhu, Weiren Cai, Yizhou Wang et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出MINT模型用于第一视角手部与相机运动联合估计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合大规模弱监督与微调，在第一视角追踪上效果显著。

### 4. **[BLASt3R: Bundle Adjustment of Any Image Set with Multi-View Matching and Monocular Priors](https://arxiv.org/abs/2609.05210v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Vincent Leroy, Philippe Weinzaepfel, Lojze Zust et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出结合多视匹配与单目先验的束差调整框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且兼顾在线视觉SLAM与离线重建，实验扎实

### 5. **[VICAL: Vicinal Consistency Alignment for Long-Tailed Visual Recognition](https://arxiv.org/abs/2609.04948v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Jiangang Zhu, Zheng Wang, Bin Zhu et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出VICAL框架解决长尾视觉识别的方差问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性与实验较扎实，分类准确，但在长尾领域属于渐进创新。

## Machine Learning

### 1. **[GLASS: Graph-Language Alignment with Spherical Scoring for Transferable Graph-Level Anomaly Detection](https://arxiv.org/abs/2609.05253v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Xudong Wang, Chris Ding, Tongxin Li et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出GLASS图语言对齐框架实现跨域图级异常检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新图语言对齐与球面评分，实验充分但评分偏严

### 2. **[Fast Gauss Sums via Flash Attention](https://arxiv.org/abs/2609.04910v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Nicolaj Rux, Sebastian Neumayer
- **标签**: `cs.LG` `math.NA`
- **AI摘要**: 利用Flash Attention加速高斯求和
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 巧妙借力硬件加速，创新性与实用性均较强。

### 3. **[Personalized Task Dependency Graphs for Mitigating Signal Erosion in Multi-Task Recommendation](https://arxiv.org/abs/2609.04862v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Fuyuan Liu, Tiandeng Wu, Yaqun Fang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出个性化任务依赖图解决多任务推荐中的信号侵蚀问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用，实验扎实，工业界落地效果好。

### 4. **[Measuring the Novelty of Biomedical Papers Using the Latent Distances between Knowledge Units](https://arxiv.org/abs/2609.05175v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-09-04
- **作者**: Yi Zhao, Heng Zhang, Yuzhuo Wang et al.
- **标签**: `cs.DL` `cs.CL`
- **AI摘要**: 提出整合多重关系的生物医学论文创新性测量方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新严谨且实用，对科学计量有较好价值

### 5. **[Physics-Aware Random Walk Fingerprints for Scalable Power Grid Graph Classification](https://arxiv.org/abs/2609.04943v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-09-04
- **作者**: Adnan Anwar
- **标签**: `cs.LG` `eess.SY`
- **AI摘要**: 提出物理感知的多通道随机游走指纹用于电网图分类
<details>
<summary>原始摘要</summary>
