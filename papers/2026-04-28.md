...
### 1. **[SpaMEM: Benchmarking Dynamic Spatial Reasoning via Perception-Memory Integration in Embodied Environments](https://arxiv.org/abs/2604.22409v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-24
- **作者**: Chih-Ting Liao, Xi Xiao, Chunlei Meng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SpaMEM基准以评估具身智能的空间记忆与推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该研究构建了大规模高质量数据集，对具身空间推理进行了系统性诊断。

### 2. **[CharTide: Data-Centric Chart-to-Code Generation via Tri-Perspective Tuning and Inquiry-Driven Evolution](https://arxiv.org/abs/2604.22192v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-24
- **作者**: Xiangxi Zheng, Kuang He, Jiayi Hu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CharTide框架，通过多视角调优提升图表代码生成能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据驱动与强化学习结合，在图表生成任务上表现卓越，方法创新且严谨。

### 3. **[CGC: Compositional Grounded Contrast for Fine-Grained Multi-Image Understanding](https://arxiv.org/abs/2604.22498v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Lihao Zheng, Zhenwei Shao, Yu Zhou et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出CGC框架提升多图细粒度理解能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对比学习与强化学习优化多图理解，方法创新且实验扎实。

### 4. **[Knowledge Visualization: A Benchmark and Method for Knowledge-Intensive Text-to-Image Generation](https://arxiv.org/abs/2604.22302v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Ran Zhao, Sheng Jin, Size Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出KVBench基准与KE-Check框架以提升科学绘图准确性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了高质量科学知识基准，并提出了有效的约束引导修正框架，方法严谨且实用。

### 5. **[Towards Safe Mobility: A Unified Transportation Foundation Model enabled by Open-Ended Vision-Language Dataset](https://arxiv.org/abs/2604.22260v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Wenhui Huang, Songyan Zhang, Collister Chua et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出交通基础模型UniVLT与LTD数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了城市级交通视觉推理空白，方法论严谨且具备高实用价值。
...
### 1. **[Efficient Diffusion Distillation via Embedding Loss](https://arxiv.org/abs/2604.22379v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-24
- **作者**: Jincheng Ying, Yitao Chen, Li Wenlin et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Embedding Loss加速扩散模型蒸馏
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，显著提升了蒸馏效率与生成质量。

## Video Generation

### 1. **[FlowAnchor: Stabilizing the Editing Signal for Inversion-Free Video Editing](https://arxiv.org/abs/2604.22586v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-24
- **作者**: Ze Chen, Lan Chen, Yuanhang Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出FlowAnchor实现稳定高效的免反演视频编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过空间锚定与强度调制解决视频编辑信号不稳问题，方法创新且实验扎实。

### 2. **[Video Analysis and Generation via a Semantic Progress Function](https://arxiv.org/abs/2604.22554v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-24
- **作者**: Gal Metzer, Sagi Polaczek, Ali Mahdavi-Amiri et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出语义进度函数实现视频语义线性化与平滑控制。
<details>
<summary>原始摘要</summary>
...
### 1. **[LaissezCloud: Continuous Resource Renegotiation for the Public Cloud](https://arxiv.org/abs/2604.22509v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Tejas Harith, Antoine Kaufmann
- **标签**: `cs.DC`
- **AI摘要**: 提出持续资源重协商云平台
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决云资源分配效率问题，实验严谨且规模大。

### 2. **[Data-Free Contribution Estimation in Federated Learning using Gradient von Neumann Entropy](https://arxiv.org/abs/2604.22562v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-24
- **作者**: Asim Ukaye, Mubarak Abdu-Aguye, Nurbek Tastan et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出基于谱熵的联邦学习贡献评估方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需验证数据，实验验证充分，逻辑清晰。

### 3. **[Accelerating Intra-Node GPU-to-GPU Communication Through Multi-Path Transfers with CUDA Graphs](https://arxiv.org/abs/2604.22228v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-24
- **作者**: Amirhossein Sojoodi, Yiltan Hassan Temucin, Amirreza Baratisedeh et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出基于CUDA Graphs的UCX多路径通信优化方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入CUDA Graphs优化GPU通信，实验验证充分。

### 4. **[$O(K)$-Approximation Coflow Scheduling in $K$-Core Optical Circuit Switching Networks](https://arxiv.org/abs/2604.22146v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-24
- **作者**: Xin Wang, Hong Shen, Hui Tian et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出多核OCS网络协同流调度算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法理论保障强，解决了多核光交换调度难题。

### 5. **[A comprehensive evaluation of spatial co-execution on GPUs using MPS and MIG technologies](https://arxiv.org/abs/2604.22430v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-04-24
- **作者**: Jorge Villarrubia, Luis Costero, Francisco D. Igual et al.
- **标签**: `cs.DC` `cs.AR`
- **AI摘要**: 评估MPS与MIG在GPU空间共享中的性能表现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性对比了两种主流GPU共享技术，实验设计严谨且实用。

## Operating Systems

### 1. **[Chamelio: A Fast Shared Cloud Network Stack for Isolated Tenant-Defined Protocols](https://arxiv.org/abs/2604.22603v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-24
- **作者**: Matheus Stolet, Simon Peter, Antoine Kaufmann
- **标签**: `cs.NI` `cs.OS`
- **AI摘要**: 一种高性能且隔离的共享云网络栈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过eBPF实现租户协议自定义并保证性能隔离，创新性强。

## Information Retrieval

### 1. **[ReCast: Recasting Learning Signals for Reinforcement Learning in Generative Recommendation](https://arxiv.org/abs/2604.22169v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-24
- **作者**: Peiyan Zhang, Hanmo Liu, Chengxuan Tong et al.
- **标签**: `cs.LG` `cs.AI` `cs.IR`
- **AI摘要**: 提出ReCast框架优化生成式推荐的RL学习信号。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过修复稀疏奖励提升训练效率，实验效果显著且实用性强。

### 2. **[Aligning Dense Retrievers with LLM Utility via DistillationAligning Dense Retrievers with LLM Utility via Distillation](https://arxiv.org/abs/2604.22722v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Rajinder Sandhu, Di Mu, Cheng Chang et al.
- **标签**: `cs.IR` `cs.AI` `cs.LG`
- **AI摘要**: 提出UAE框架，通过蒸馏提升检索器效用。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将LLM效用蒸馏至嵌入空间，显著提升检索效率。

### 3. **[ASPIRE: Make Spectral Graph Collaborative Filtering Great Again via Adaptive Filter Learning](https://arxiv.org/abs/2604.22549v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Yunhang He, Cong Xu, Zhangchi Zhu et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出自适应谱图协同过滤框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了低频爆炸问题，理论与实验表现均很扎实。

### 4. **[Objective Shaping with Hard Negatives: Windowed Partial AUC Optimization for RL-based LLM Recommenders](https://arxiv.org/abs/2604.22504v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Wentao Shi, Qifan Wang, Chen Chen et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出WPAUC优化目标提升LLM推荐系统Top-K性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，方法创新且实验验证充分，实用性强。

### 5. **[Rethinking Semantic Collaborative Integration: Why Alignment Is Not Enough](https://arxiv.org/abs/2604.22195v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Maolin Wang, Dongze Wu, Jianing Zhou et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出互补融合范式替代对齐范式
<details>
<summary>原始摘要</summary>
...
### 1. **[The Exact Replica Threshold for Nonlinear Moments of Quantum States](https://arxiv.org/abs/2604.22627v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-24
- **作者**: Shuai Zeng
- **标签**: `quant-ph` `cs.CC` `cs.IT`
- **AI摘要**: 证明量子态非线性矩的精确副本阈值
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了量子信息论中关于副本数的长期公开问题，理论严谨且具有重要意义。

### 2. **[Learning-augmented robotic automation for real-world manufacturing](https://arxiv.org/abs/2604.22235v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-24
- **作者**: Yunho Kim, Quan Nguyen, Taewhan Kim et al.
- **标签**: `cs.RO` `cs.AI` `cs.LG`
- **AI摘要**: 提出学习增强型机器人自动化系统，实现工业生产线高效部署。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 将学习型控制与安全监控结合，在真实生产环境中验证了高可靠性。

### 3. **[Spend Less, Fit Better: Budget-Efficient Scaling Law Fitting via Active Experiment Selection](https://arxiv.org/abs/2604.22753v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Sijie Li, Shanda Li, Haowei Lin et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出预算高效的缩放定律拟合主动实验选择方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过主动学习显著降低训练预算，方法创新且实用性强。

### 4. **[Relaxation-Informed Training of Neural Network Surrogate Models](https://arxiv.org/abs/2604.22746v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Calvin Tsay
- **标签**: `math.OC` `cs.LG`
- **AI摘要**: 提出正则化方法优化神经网络MILP求解效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过正则化直接提升代理模型MILP求解性能，方法创新且实验扎实。

### 5. **[Rethinking XAI Evaluation: A Human-Centered Audit of Shapley Benchmarks in High-Stakes Settings](https://arxiv.org/abs/2604.22662v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-24
- **作者**: Inês Oliveira e Silva, Sérgio Jesus, Iker Perez et al.
- **标签**: `cs.LG` `cs.AI` `cs.HC`
- **AI摘要**: 揭示Shapley解释方法与人类决策效用间的脱节风险
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模实证研究挑战了现有XAI评估指标的有效性，具有极高的实践指导意义。
