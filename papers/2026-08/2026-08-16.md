...
### 1. **[CROP: Task Relevance via Counterfactuals for Selective On-Policy Distillation](https://arxiv.org/abs/2608.13387v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Enhan Li, Junhao He, Hongyang Du
- **标签**: `cs.CL`
- **AI摘要**: 提出CROP方法用于选择性在线蒸馏
<details>
...
- **评分理由**: 创新性较好且实验充分，具有实用价值

### 2. **[It's How You Ask: Gender-Associated Linguistic Bias in LLMs](https://arxiv.org/abs/2608.13328v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Katherine Van Koevering, Anjalie Field
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 揭示了大语言模型中存在的性别相关语言偏见
<details>
<summary>原始摘要</summary>
...
### 3. **[TsuGO: Probing Search Efficiency in LLM Reasoning via Go Life-and-Death Problems](https://arxiv.org/abs/2608.13221v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Shunwen Bai, Ziping Ma, Chaoyang Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出TsuGO基准评估大模型搜索效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性与实验较强，但应用领域相对垂类。

### 4. **[CAPRI: Contract-Aware Proof Repair for Isabelle](https://arxiv.org/abs/2608.13459v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Jim Woodcock, Gabriel Leite, Augusto Sampaio et al.
- **标签**: `cs.SE` `cs.AI` `cs.LO`
- **AI摘要**: 提出支持契约感知的Isabelle证明修复工作流
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Md Wasiul Haque, Sagar Dasgupta, Mizanur Rahman et al.
- **标签**: `cs.SE` `cs.CR` `cs.LG`
- **AI摘要**: 评估大模型在自动驾驶软件动态威胁分析中的应用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖但未能成功验证，实验方法扎实，结构清晰。

## Vision Language Models

### 1. **[NARU: A Benchmark for NARrative Evolution and Cultural Nuance Understanding in Japanese Extreme Long Video](https://arxiv.org/abs/2608.13210v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Yuheng Huang, Jianlang Chen, Jiayang Song et al.
- **标签**: `cs.CV` `cs.AI` `cs.MM`
- **AI摘要**: 提出日语超长视频叙事与文化理解基准NARU
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补高语境长视频空白，基准构建严谨，但创新性一般

### 2. **[QuISE: Defense against Typographic Attacks on VLMs via Query-Irrelevant Semantic Editing](https://arxiv.org/abs/2608.13119v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Shubin Lu, Jiaqi Yin, Yihao Huang
- **标签**: `cs.CV`
- **AI摘要**: 提出黑盒视觉语言模型排版攻击防御方法
<details>
<summary>原始摘要</summary>
...
### 1. **[UniTraffic-Agent: Unified Traffic Video Reasoning for AI City Challenge 2026 Track 3 with Two Out-of-Domain Evaluations](https://arxiv.org/abs/2608.13031v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Peng Li, Qianqian Xu, Shilong Bao et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出UniTraffic-Agent实现交通视频推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有效但创新性一般，任务应用性较好

## Video Generation

### 1. **[H2R-Bench: Benchmarking Human-to-Robot Manipulation Video Generation in World Models](https://arxiv.org/abs/2608.13049v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Dingyi Rong, Yue Shi, Chaofan Ma et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出H2R-Bench基准评估人机跨具身视频生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补跨具身视频生成评估空白，实验全面但创新性中等。

### 2. **[Spatially-Grounded Text-to-Video Generation via Inference-Time Gradient-Free Optimization](https://arxiv.org/abs/2608.13037v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Guillaume Jeanneret, Mathis Koroglu, Hugo Caselles-Dupré et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出无梯度视频空间引导方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新了解析优化方案，提升效率但应用场景相对垂直。

## Agent

### 1. **[AaLLM: An End-to-End Analog Circuit Design Framework from Topology Generation to Sizing Using Large Language Models](https://arxiv.org/abs/2608.13472v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Mohammed Ayman Habib, Rylan Hart, Morteza Fayazi
- **标签**: `eess.SY` `cs.AI`
- **AI摘要**: 提出首个端到端大模型模拟电路设计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合多智能体与RAG实现端到端设计，效率提升显著

### 2. **[Enhancing Virtual Agents through SLMs and Edge-Computing: An Exploratory Evaluation of Think and Memory Processes](https://arxiv.org/abs/2608.13420v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Aimilios Hadjiliasi, Louis Nisiotis
- **标签**: `cs.AI`
- **AI摘要**: 边缘计算与小语言模型赋能虚拟代理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构设计新颖且实验充分，具有良好应用前景

### 3. **[Capability Sheaves for Compositional Agent-Harness Repair: Controlled Quotients and a Real-Repository Stress Test](https://arxiv.org/abs/2608.13228v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Saveliy Batruin
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出能力束模型修复智能体框架
...
- **评分理由**: 理论与实验详实，但实战优势有限。

### 4. **[SkillShapley: Boundary-Adaptive Shapley Valuation for Skill Step Attribution in LLM Agents](https://arxiv.org/abs/2608.13173v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Chang Liu, Yuqi Zhang, Yiman Zhong et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出SkillShapley量化智能体技能步骤贡献
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖有效，实验充分，对技能构建具实用价值

### 5. **[Validation-Centric AI-Assisted GPU Porting of a 250,000+ Line Legacy Weather Simulation Code](https://arxiv.org/abs/2608.13122v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Tetsuya Hoshino, Masaya Kato, Kazuhisa Tsuboki et al.
- **标签**: `cs.DC`
- **AI摘要**: AI赋能遗留天气模拟代码GPU移植验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合AI代理与科学验证的遗留代码移植工作有较高实用价值。

## Computer Vision

### 1. **[SketchSense: Learning to Interpret Imperfect Sketch Guidance for Image Inpainting](https://arxiv.org/abs/2608.13186v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Zian Yang
- **标签**: `cs.CV`
- **AI摘要**: 提出SketchSense实现草图引导的图像修复
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实验扎实，属于高质量的计算机视觉论文。

### 2. **[Splat-based Metal Artifact Reduction in Cone-Beam CT via Polychromatic Modeling](https://arxiv.org/abs/2608.13159v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Kiseok Choi, Inchul Kim, Jaemin Cho et al.
- **标签**: `cs.CV` `cs.GR`
- **AI摘要**: 提出首个基于高斯溅射的CBCT金属伪影消除方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理模型创新性好，实验充分且具实用价值

### 3. **[P2Fusion: Prompt-based Progressive Infrared-Visible Image Fusion via Dual-Prior Distillation](https://arxiv.org/abs/2608.13045v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Yi Shi, Huichao Xie, Yuqing Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出P2Fusion实现红外可见光图像融合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实验充分，应用价值高

### 4. **[HumanTracker: Towards Comprehensive and Human-Aligned Motion Tracking Benchmark](https://arxiv.org/abs/2608.13555v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Dairu Liu, Zekun Qi, Jiayu Zeng et al.
- **标签**: `cs.RO` `cs.AI` `cs.CV`
- **AI摘要**: 提出人体动作追踪基准与评估指标
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，对具身智能和机器人动作评估实用性强。

### 5. **[GS$^{2}$CI: Robust Gaussian Splatting For Snapshot Compressive Imaging via Large Vision Model Priors](https://arxiv.org/abs/2608.13502v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Yanming Yang, Chenxi Song, Ping Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 结合视觉大模型与高斯泼溅的快照压缩成像三维重建方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新融合大模型先验与3DGS，实验充分但应用面较窄

## Machine Learning

### 1. **[Bagging Robustly Learns VC Classes with Linear Sample Complexity](https://arxiv.org/abs/2608.13514v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Omar Montasser
- **标签**: `stat.ML` `cs.DS` `cs.LG`
- **AI摘要**: 证明集成学习可线性样本复杂度鲁棒学习VC类
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论贡献显著但应用局限于理论学习框架

### 2. **[Physics-informed distribution of relaxation times estimation and latent-space condition monitoring of solid oxide fuel and electrolysis cells from electrochemical impedance spectroscopy](https://arxiv.org/abs/2608.13305v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Žan Gorenc, Žiga Gradišar, Felix Mütter et al.
- **标签**: `stat.AP` `cs.AI`
- **AI摘要**: 提出物理信息自编码器实现SOC/SOEC的DRT估计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好且应用实用，方法严谨结构清晰。

### 3. **[Robust Dempster-Shafer Evidence Fusion with Chaos-Conflict Measurement and Historical-Experience Weighting](https://arxiv.org/abs/2608.13108v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Huiyu Li, Weibo Liu, Xinru Xu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出一种鲁棒的D-S证据融合与冲突度量框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，方法严谨，实验充分，实用价值较高

### 4. **[Incremental Evaluation and Training in Relational Deep Learning](https://arxiv.org/abs/2608.13023v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Jakub Peleška, Gustav Šír
- **标签**: `cs.LG` `cs.DB`
- **AI摘要**: 提出关系深度学习的增量评估与训练范式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补时序数据库动态演化评估空白，方法扎实实用

### 5. **[TabSOM: A tabular-to-image encoding method based on self-organizing maps](https://arxiv.org/abs/2608.13513v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-08-13
- **作者**: David Chushig-Muzo, María Ángeles Rodríguez de Cara, Eva Milara et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出TabSOM表格转图像编码方法
<details>
<summary>原始摘要</summary>
