...
### 1. **[Algebraic Decomposition Theory for Transformer Length Generalization](https://arxiv.org/abs/2608.13433v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-08-13
- **作者**: Andy Yang, Blerta Veseli, Corentin Barloy et al.
- **标签**: `cs.FL` `cs.AI`
- **AI摘要**: 提出Transformer长度泛化代数分解理论
<details>
...
- **评分理由**: 理论突破重大，形式化严谨，对LLM长序列泛化指导意义强。

### 2. **[A Probe Direction Is a Property of Its Prompt](https://arxiv.org/abs/2608.13329v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-13
- **作者**: Valentin Noël
- **标签**: `cs.LG`
- **AI摘要**: 揭示大模型评估中提示词对探测方向的关键影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且方法严谨，对大模型评估具有重要警示与方法论价值

### 3. **[vToken: Token-Level Virtualization for Reclaimable KV Caches](https://arxiv.org/abs/2608.13263v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-13
- **作者**: Yuanhang Gao, Xiangrui Yang, Yuanfeng Chen et al.
- **标签**: `cs.AI` `cs.DC` `cs.OS`
- **AI摘要**: 提出vToken实现KV缓存细粒度回收
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 设计新颖且实用，实验充分，解决LLM内存瓶颈

### 4. **[SPADE: Speculative Decoding for Precise and Low Cost Distributed Edge Cloud Inference](https://arxiv.org/abs/2608.13076v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-13
...
- **标签**: `cs.CL`
- **AI摘要**: 提出SAEVerbalizer自动解释稀疏自编码器特征
<details>
<summary>原始摘要</summary>
...
### 1. **[Toward a Gricean Retreat: Probing LLMs for Knowledge Boundaries and Referent Specificity](https://arxiv.org/abs/2608.13484v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Dananjay Srinivas, Saksham Khatwani, Maria Pacheco
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 探究LLM知识边界与指代特异性的Gricean对齐机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 视角新颖且实验扎实，实用性有待对齐算法落地。

### 2. **[Are You Sure You're Sure? On the Impact of Instruction Tuning on Confidence and Lexical Diversity](https://arxiv.org/abs/2608.13430v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Irina Proskurina, Mayank Kumar, Oyindolapo O. Komolafe
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 研究指令微调对大模型置信度与词汇多样性的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验严谨，具有较好的理论与应用价值

### 3. **[Better Decomposition, Free Aggregation: A Synthesizer-Folding Framework for Multilingual Multi-Hop Question Answering](https://arxiv.org/abs/2608.13160v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Yilin Wang, Yuchun Fan, Weidong Bao et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出了多语言多跳问答的Syfer框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点合理，实验较为充分，行文清晰。

### 4. **[HybridRAG-BN: A Retrieval-Augmented Framework with Fine-Tuned Verification for Bangla KBQA](https://arxiv.org/abs/2608.13004v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Rathijit Aich, Nirjhar Das, Mahfuzulhoq Chowdhury
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 提出孟加拉语知识库问答的HybridRAG-BN框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合检索与验证，竞赛夺冠，方法完整清晰

## Vision Language Models

### 1. **[TRAPSBench: Vision-Language Models Encode but Fail to Express Epistemic Restraint](https://arxiv.org/abs/2608.13167v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-13
- **作者**: Fnu Pramono, John Cai, Sourabh Kulkarni
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 揭示视觉语言模型具备认知克制但难以表达的缺陷
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入基准与指标，实验严谨，结论深刻

### 2. **[EgoMonth: A Month-Level Egocentric Video Benchmark for Long-Term Spatiotemporal Memory](https://arxiv.org/abs/2608.13113v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-13
- **作者**: Weitao Chen, Hu Jiaxin, Xie Tianyidan et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出首个月度第一人称视频理解基准EgoMonth
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了长期时空记忆基准的空白，任务设计严谨全面

### 3. **[When Is a Task Vector Enough? An Empirical Theory of Implicit Multimodal ICL](https://arxiv.org/abs/2608.13385v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Jiaqian Li
- **标签**: `cs.CV`
- **AI摘要**: 提出多模态ICL的选择实现假说
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验严谨，对方法选择具实用价值

### 4. **[How Good are Foundation Models in Longitudinal MRI Disease Progression Reasoning?](https://arxiv.org/abs/2608.13309v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Wafa Al Ghallabi, Ritesh Thawkar, Sara Ghaboura et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出纵向磁共振成像时空推理基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补多时相磁共振评测空白，实验全面但创新力度适中

### 5. **[UniTexture: Cross-Task Universal Adversarial Textures for Vision-Language-Action Models](https://arxiv.org/abs/2608.13453v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Yukun Dai, Mingzhe Dai, Tianshi Wang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出跨任务通用对抗纹理攻击UniTexture
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验充实，对VLA安全有较高参考价值。

## Diffusion Models

### 1. **[From Local Mismatch to Global Impact: Optimizing Cache Reuse Policy for Efficient Diffusion](https://arxiv.org/abs/2608.13043v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-08-13
- **作者**: Xichen Ye, Yifan Wu, Zhikang Xie et al.
- **标签**: `cs.AI` `cs.CV` `cs.LG`
- **AI摘要**: 提出全局影响缓存策略优化扩散模型推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论与实验扎实，显著提升视频生成速度与质量

### 2. **[Learning Discrete Decisions for MIPs with Constraint-Aware Diffusion](https://arxiv.org/abs/2608.13079v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Vincenzo Di Vito, Mehdi Taghizadeh, Deepjyoti Deka et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出约束感知扩散模型求解混合整数规划问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合扩散与优化，实验扎实，实用性强

### 3. **[The data geometry of masking diffusion: Certified-optimal schedules via unmasking growth complexity](https://arxiv.org/abs/2608.13520v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Martin J. Wainwright
- **标签**: `cs.LG` `cs.AI` `cs.IT`
- **AI摘要**: 提出掩码扩散数据的几何分析与最优调度方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨但偏理论，实际应用有待验证

### 4. **[MapRoute++: Surrogate-Guided Semantic Routing for Visual Concept Unlearning](https://arxiv.org/abs/2608.13478v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Ashok Urlana, L. D. M. S. Sai Teja, Vivek Hruday Kavuri et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MapRoute++用于视觉概念遗忘
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 改进有效但属特定挑战赛方案，泛化性有待验证

### 5. **[Symmetry-Breaking De Novo Crystal Generation via Markovian Jump Diffusion](https://arxiv.org/abs/2608.13457v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Van Khoa Nguyen, Alexandros Kalousis
- **标签**: `cs.LG`
- **AI摘要**: 提出马尔可夫跳跃扩散模型实现晶体对称性破缺生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入对称性破缺，实验充分但理论门槛较高

## Multimodal

### 1. **[Edit2TikZ: A Comprehensive and Challenging Benchmark for Scientific Figure Editing with TikZ](https://arxiv.org/abs/2608.13441v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Zongyun Zhang, Jiacheng Ruan, Xian Gao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出科学图形编辑基准Edit2TikZ及评测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作完整且基准有实用价值，实验充分

### 2. **[Towards Context-Aware Clinical Motion Understanding in Daily Living at Home: Freezing of Gait Detection with Egocentric Vision](https://arxiv.org/abs/2608.13283v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Vayalet Stefanova, Diwas Lamsal, Margot Genbrugge et al.
- **标签**: `cs.AI`
- **AI摘要**: 基于第一人称视角与可穿戴传感器的帕金森步态冻结检测研究
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合多模态数据与基础模型，评估了情境感知在临床动作理解中的价值

### 3. **[Reasoning for Social Audio-Visual Question Answering: Where Do We Stand?](https://arxiv.org/abs/2608.13239v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Koen P. de Vries, Xavier Alameda-Pineda, Estefanía Talavera et al.
- **标签**: `cs.CV`
- **AI摘要**: 揭示社会视听问答中推理方法的局限与基准噪声
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 发现基准噪声并提出强基线，分析深入但增量有限

### 4. **[CASA: Content-Acoustic Speaking Assessment with Speech Encoder and Large Language Model](https://arxiv.org/abs/2608.13101v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Nhan Phan, Ilona Lähteenmäki, Anna von Zansen et al.
- **标签**: `cs.CL` `eess.AS`
- **AI摘要**: 提出CASA模型用于自动口语评估
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合语音编码器与LLM，性能优秀但属架构组合

## Image Generation

### 1. **[PixSDS: Why Latent SDS Makes Noisy Pixels](https://arxiv.org/abs/2608.12997v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Vsevolod Skorokhodov
- **标签**: `cs.CV`
- **AI摘要**: 揭示潜在SDS伪影根源并提出PixSDS
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 分析深入且方法实用，但属于渐进式改进

### 2. **[Evaluation of Clinically Steerable Retinal Image Generation from Foundation Model Latent Spaces](https://arxiv.org/abs/2608.13455v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Zuzanna A. Wakefield-Skórniewska, Bartłomiej W. Papież
- **标签**: `cs.CV`
- **AI摘要**: 评估视网膜基础模型在可控图像生成中的应用与合成-真实鸿沟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 评估全面且发现新鸿沟，方法严谨，具有较好应用价值

### 3. **[GeoCache: Training-Free Acceleration of Multi-View Texture Diffusion via Geometric Delta Transport](https://arxiv.org/abs/2608.13255v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Haotang Li, Zhenyu Qi, Shaohan Henry Wang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出多视纹理扩散加速方法GeoCache
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有效且实验全面，具有较高实用价值

### 4. **[Towards Physics-Faithful Generation of Scientific Diagrams](https://arxiv.org/abs/2608.13112v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Minghui Zhang, Jinxin Shi, Yifan Chang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出物理真实性科学图表生成模型Princigram
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新与数据集构建扎实，评估指标设计合理

## Video Generation

### 1. **[Context-Matched Distillation: Teacher Causality for Autoregressive Video Distillation](https://arxiv.org/abs/2608.13391v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-13
- **作者**: Hmrishav Bandyopadhyay, Xuanchi Ren, Zijian Huang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出上下文匹配蒸馏实现因果视频蒸馏
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新严谨，实验全面，有效提升因果视频生成

### 2. **[RGB-D Video Generation for Improving Human-to-Robot Object Handover Prediction](https://arxiv.org/abs/2608.13028v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-13
- **作者**: Tianyu Sun, Zhoujie Fu, Zihui Gao et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出Hand2Bot数据集与PassGen生成管线
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入多模态Agent评估长视野世界模型，实验扎实。

### 5. **[Alaya-EVOKE: From Linear-Scaling Supervision to Endless World](https://arxiv.org/abs/2608.13546v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Yuanyang Yin, Gongxuan Wang, Yifan Zhan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Alaya-EVOKE交互式世界模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新显著且性能领先，实验扎实全面

## Agent

### 1. **[RippleMem: From Isolated Retrieval to Associative Recollection for Long-Term Agent Memory](https://arxiv.org/abs/2608.13334v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-13
- **作者**: Jingbo Ji, Lingyi Li, Xilong Cheng et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出了RippleMem长周期代理记忆系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 记忆检索创新且效果显著，但仍具增量性质

### 2. **[Beyond Final Scores: A Systematic Evaluation of Agents for Long-Horizon AI Research and Development](https://arxiv.org/abs/2608.13417v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Yiwei Li, Wanli Yang, Hexiang Tan et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出了长周期AI研发智能体的系统性评估框架
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Zechuan Wang, Siyuan Lu, Hongxuan Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出层级信用分配框架CrEST提升智能体性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，提升多轮智能体训练效果。

### 4. **[LycheeMemory V2: Efficient Long-Term Memory for LLM Agents via Semantic Segment-Level Consolidation](https://arxiv.org/abs/2608.12990v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Dongfang Li, Zixuan Liu, Junmai Wang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出了语义分段记忆整合框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好且效果显著，评估严谨，结构清晰。

### 5. **[AutoDesign: Meta-Harness Optimization for Long-Horizon Agentic Design](https://arxiv.org/abs/2608.13560v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Yaxin Luo, Haobin Jiang, Jialv Zou et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出AutoDesign框架实现长周期智能体设计优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性与实用性较好，实验扎实，写作清晰

## Distributed Computing

### 1. **[TEMPO: Makespan-Aware Expert-Parallel Load Balancing Across Memory- and Compute-Bound Regimes](https://arxiv.org/abs/2608.13057v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-13
- **作者**: Jie Li, Chenxin Jia, Jinliang Shen et al.
- **标签**: `cs.DC` `cs.AI` `cs.CL`
- **AI摘要**: 提出TEMPO专家并行负载均衡器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 机制创新显著，实验严谨，实用性强

### 2. **[OpScale: Operator-level Provisioning and Autoscaling for LLM Serving](https://arxiv.org/abs/2608.13499v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-13
- **作者**: Xingqi Cui, Chieh-Jan Mike Liang, Ziang Tang et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出算子级LLM弹性伸缩框架
<details>
<summary>原始摘要</summary>
...
### 3. **[Joint Communication-Control Strategy Optimization with Partially Nested Information Structures: The Linear-Quadratic Case](https://arxiv.org/abs/2608.13535v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Haoyi You, Kaiqing Zhang
- **标签**: `eess.SY` `cs.MA` `math.OC`
- **AI摘要**: 研究多智能体线性二次系统的联合通信控制策略优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入，方法严谨，具分布式计算应用潜力

### 4. **[Fast Tendermint: Speeding Up a Foundational Consensus Protocol](https://arxiv.org/abs/2608.13434v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Preston Vander Vos, Daniel Cason
- **标签**: `cs.DC`
- **AI摘要**: 提出Fast Tendermint，将共识缩减至两步通信。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新改进了经典协议，严谨性与实用性良好。

### 5. **[Triangle-Free Coloring in LOCAL via Resilient Lovász Local Lemma](https://arxiv.org/abs/2608.13357v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Peter Davies-Peck, Xusheng Zhang
- **标签**: `cs.DC` `cs.DS`
- **AI摘要**: 提出三角形无色算法突破局部模型复杂度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法创新显著，理论严谨，应用面较窄

## Operating Systems

### 1. **[TopoIntent: Compiling Security Intent into Executable, Compliance-Checked Network Topologies](https://arxiv.org/abs/2608.13389v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Xiaokang Qu, Jianliang Ma, Zao Fan et al.
- **标签**: `cs.AI` `cs.CR` `cs.NI`
- **AI摘要**: 提出将安全意图编译为网络拓扑的TopoIntent系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且评估完整，但属于垂直领域增量创新

## Information Retrieval

### 1. **[Who Speaks Matters: Authority-Aware Multi-View RAG over Italian Parliamentary Proceedings](https://arxiv.org/abs/2608.13410v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Mirko Tritella, Riccardo Pozzi, Matteo Palmonari
- **标签**: `cs.AI`
- **AI摘要**: 提出结合权威度模型的议会文本多视角RAG系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合权威度与RAG，评估扎实，实用性强

### 2. **[Structure then Query: Enabling Precise Analytical Queries over Unstructured Documents](https://arxiv.org/abs/2608.13384v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Teng Lin, Yuyu Luo, Nan Tang
- **标签**: `cs.IR` `cs.DB`
- **AI摘要**: 提出了AnnoIndex系统实现非结构化文档的精准分析
<details>
<summary>原始摘要</summary>
...
### 3. **[GEM: A Generative Embedding Model Bridging Reasoning and Retrieval](https://arxiv.org/abs/2608.13200v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Zhili Shen, Craig Macdonald
- **标签**: `cs.CL` `cs.AI` `cs.IR`
- **AI摘要**: 提出GEM模型，结合推理与嵌入提升检索能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性融合生成推理与嵌入，实验表现扎实

### 4. **[Operationalizing Cyber Threat Intelligence with GraphRAG](https://arxiv.org/abs/2608.13050v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Atul Kabra, Prakhar Paliwal, Manjesh K. Hanawal
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 利用GraphRAG提升威胁情报检测能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好且实用，评估全面但范围局限。卡在75分

### 5. **[RAGSieve: Self-Referenced Local Contrast for Knowledge-Poison Detection in Retrieval-Augmented Generation](https://arxiv.org/abs/2608.13010v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-13
- **作者**: Xinlong Xu, Yoshua Y. Li
- **标签**: `cs.CL` `cs.CR` `cs.IR`
- **AI摘要**: 提出RAGSieve框架以检测RAG中的知识投毒。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性与实用性较好，实验扎实但属于特定安全领域。

## Computer Vision

### 1. **[Geometry-Grounded Unified 3D Perception for Autonomous Driving](https://arxiv.org/abs/2608.13147v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-13
- **作者**: Longfei Xu, Xiaohui Wang, Zehao Huang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出几何基础统一3D自动驾驶感知框架GeoUP
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入几何对齐表征，实验扎实且性能领先。

### 2. **[LipCache: A Local Inference Proxy with Certified Caching for Edge Image Classification Service](https://arxiv.org/abs/2608.13144v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Zhengzhe Xiang, Yinlin Chen, Fuli Ying et al.
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 提出LipCache图像分类 certified缓存框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入Lipschitz约束的certified缓存机制，但应用场景较窄

### 3. **[Paths: Prompt-aware Spatio-temporal Transformer with Hierarchical Multi-modal Fusion for RGB-Event Video Person Re-Identification](https://arxiv.org/abs/2608.13092v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Yakun Huo, Yingquan Wang, Yangyang Liu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出了Paths视频行人重识别框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新融合RGB与事件流，实验充分，结构清晰

### 4. **[Learning Unified Video and Image Representation for Video Face Forgery Detection](https://arxiv.org/abs/2608.13064v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Haotian Liu, Yang Liu, Guoying Zhao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出UVIF框架用于视频人脸伪造检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，联合图文建模，实验充分且有效。

### 5. **[Topology-Unified 2D Pose Estimation across Intact, Residual and Prosthetic Limbs](https://arxiv.org/abs/2608.13047v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-13
- **作者**: Tianye Qi, Tengyue Zhang, Jiaying Ying et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出了统一拓扑的假肢人体姿态估计基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实用，方法扎实但属于特定垂直领域

## Machine Learning

### 1. **[Exponential quantum advantage for learning signals with a single qubit](https://arxiv.org/abs/2608.13521v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-13
- **作者**: Ishaan Kannan, Sridhar Prabhu, Saeed A. Khan et al.
- **标签**: `quant-ph` `cs.IT` `cs.LG`
- **AI摘要**: 单量子比特实现指数级量子传感优势
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论与实验结合紧密，创新性与实用性均较高。

### 2. **[Equivariant learning of a transferable three-dimensional classical density functional](https://arxiv.org/abs/2608.13506v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-13
- **作者**: Bingqing Cheng
- **标签**: `cond-mat.stat-mech` `cond-mat.soft` `cs.LG`
- **AI摘要**: 提出可迁移的三维经典密度泛函学习方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且实用价值高，方法严谨清晰。

### 3. **[Simulation-to-real transfer learning for infrared spectroscopic chemical sensing and analysis from molecules to complex samples](https://arxiv.org/abs/2608.13341v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-13
- **作者**: Yusen Tan, Yixuan Chen, Zheng Fang et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出红外光谱基础模型UltraIR，实现仿真到真实的迁移学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型创新性强且应用广泛，但属于特定科学领域，评价严格

### 4. **[Neural Quadratic Forms: A Unified Minimal Model for Sudden Learning and Scaling Laws](https://arxiv.org/abs/2608.13335v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-13
- **作者**: Liu Ziyin, Yizhou Xu, Tomaso Poggio et al.
- **标签**: `cs.LG` `cond-mat.dis-nn` `cond-mat.stat-mech`
- **AI摘要**: 揭示神经元二次型统一突发学习与标度律
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论新颖且具普适性，严格推导了解析动力学。

### 5. **[Wasserstein Filtering: A Sample Selection Method for Robust Distribution Learning](https://arxiv.org/abs/2608.13418v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-13
- **作者**: Yikai Xu, Zhao Chen, Jian Huang
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出Wasserstein过滤算法用于鲁棒分布学习
<details>
<summary>原始摘要</summary>
