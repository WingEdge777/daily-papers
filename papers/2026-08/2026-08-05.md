...
- **评分理由**: 对推理时扩展进行了严谨的分类与评估框架构建

### 2. **[MultiGlobeQA: A Multilingual and Globally Diverse Benchmark for Geospatial Reasoning](https://arxiv.org/abs/2608.03882v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Martin Böckling, Elizaveta Nosova, Heiko Paulheim et al.
- **标签**: `cs.CL` `cs.AI` `cs.IR`
- **AI摘要**: 提出多语言地理空间推理基准MultiGlobeQA
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大、覆盖广且评估严谨，揭示了LLM推理瓶颈。
...
- **评分**: ⭐ 84/100 | **日期**: 2026-08-04
- **作者**: Zhenran Wang, Zhonghan Bian, Jinsong Li et al.
- **标签**: `cs.CL`
- **AI摘要**: 构建无数据泄露的实时世界杯预测基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过反事实推理评估LLM社会预测能力，方法严谨且创新。

### 5. **[Can Large Language Models Recover Semantic Optimization Opportunities That Compilers Miss?](https://arxiv.org/abs/2608.03983v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Hailong Jiang, Feng Yu, Emran Hossain et al.
- **标签**: `cs.PL` `cs.AI`
- **AI摘要**: 利用大模型恢复编译器缺失的语义优化机会。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出新基准并验证了LLM在编译器优化中的潜力，实验严谨。

## Natural Language Processing

### 1. **[M-GATE: Multilingual Grammar, Accuracy in Translation, and Efficiency Benchmark for Large Language Models](https://arxiv.org/abs/2608.03803v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Tomáš Burkert, Angelika Peljak-Łapińska, David Zelený
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出多语言能力评估基准M-GATE，揭示模型语法与翻译能力的差异。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基准设计严谨，揭示了模型在低资源语言下的能力瓶颈，具有重要研究价值。

### 2. **[ChronoLens: Measuring Language Change Across Time, Languages, and Linguistic Levels](https://arxiv.org/abs/2608.03507v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Gagan Bhatia, Julian Schlenker, Simone Paolo Ponzetto et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出ChronoLens框架量化多语言跨时空演变。
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.AI`
- **AI摘要**: 提出TACT框架，通过教学分类法优化ESL辅导模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论严谨，结合教育学分类法提升了模型教学适应性。

### 4. **[Beyond Representational Similarity: Source-Conditioned Description-Length Gain for Generative Plagiarism Detection and Candidate Source Reranking](https://arxiv.org/abs/2608.03859v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-08-04
- **作者**: Peijia Guo, Wenxuan Xie, ZiGuang Li et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出SCDG框架，有效检测生成式抄袭。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在抄袭检测任务中表现优异。

### 5. **[VIBE: A VAD-Informed Benchmark for Entity-Centered Affective Profiling of Large Language Model Outputs](https://arxiv.org/abs/2608.03810v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Andrei Chetvergov, Alexander Evseev, Timofei Sivoraksha et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出VIBE基准实现实体情感分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且创新，有效量化大模型情感偏见。

## Vision Language Models

### 1. **[CARE-X: Towards Clinically Useful Radiology VLMs with Auxiliary Supervision, Reward-Aligned Learning, and Tool-Augmented Measurement](https://arxiv.org/abs/2608.03890v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Mercy Prasanna Ranjit, Anirban Porya, Sathvik Joel et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出CARE-X模型，融合辅助监督与工具调用提升放射影像诊断能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且临床实用性强，实验严谨，在多项指标上表现优异。

### 2. **[UniEvo-RS: Omni-Prompt Unified Remote Sensing Segmentation with Representative Exemplar-Driven Prototype Evolution](https://arxiv.org/abs/2608.03911v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Kunquan Zhang, Peilang Li, Xikun Hu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出UniEvo-RS框架，实现遥感图像高效提示分割。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入原型演化机制，在遥感分割任务中表现优异。

### 3. **[MuRA: Multi-Rank Adaptation for Efficient and Effective Test-Time Vision-Language Generalization](https://arxiv.org/abs/2608.03885v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Gengyuan Liu, Nanzhou Wang, Chang Liu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MuRA动态多秩自适应框架以提升视觉模型泛化能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态秩分配解决分布偏移问题，方法创新且实验扎实。

### 4. **[UHP Detection: LVLMs have their Unique Hallucination Pattern in the Consistency Space](https://arxiv.org/abs/2608.03817v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Amir Mohammad Ezzati, Kiyan Rezaee, Bardiya Kariminia et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出UHP检测框架，通过多维度一致性模式识别LVLM幻觉。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升了黑盒幻觉检测的性能。

### 5. **[MissClick: Exploiting Digit-Serialized Coordinates to Attack GUI Grounding Models](https://arxiv.org/abs/2608.03740v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Yu Ran, Wentao Zhao, Xin Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出MissClick攻击GUI模型坐标生成漏洞
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对GUI模型坐标解析的对抗攻击，方法新颖且实验充分。
...
- **评分理由**: 通过中间潜变量实现高效奖励评估，显著提升对齐性能与训练速度。

### 2. **[MultiCompose: Multi-Concept Personalized Composition with Per-Subject Attribute Binding](https://arxiv.org/abs/2608.03708v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Ruirui Zhang, Zhengkai Zhao, Pan Gao
- **标签**: `cs.CV`
- **AI摘要**: 提出多概念个性化图像合成框架MultiCompose
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了多主体属性绑定与空间干扰问题，并引入了新基准。

### 3. **[Assessment of Conditional Diffusion Model for Synthetic Histopathology Image Generation](https://arxiv.org/abs/2608.03990v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-04
- **作者**: Seyed Kahaki, Shijie Li, Weijie Chen et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出病理专用指标评估扩散模型生成质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过病理预训练模型改进评估指标，验证了多样性对下游任务的重要性。

### 4. **[MDLMPE: Distribution Aware Positional Encoding for Masked Diffusion Language Models](https://arxiv.org/abs/2608.03769v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-04
- **作者**: Tong Ling, Hang Lei, Feng Xiao et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出MDLMPE以增强掩码扩散模型的空间感知能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对MDLM特性设计的编码方法，实验充分且提升显著
...
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Junhao Chen, Mingjin Chen, Jingjia Mao et al.
- **标签**: `cs.SD` `cs.CL`
- **AI摘要**: 提出Agogic表示法，显著提升音乐生成质量。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨的对比实验证明表示法优于模型规模，方法论扎实且贡献突出。

### 2. **[Video-DeepResearch: Towards the Next-Generation Multimodal Deepresearch Agent](https://arxiv.org/abs/2608.03979v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Zhen Fang, Yu Zeng, Wenxuan Huang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出视频深度研究智能体，提升多模态时空推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦感知与探索流程解决模态偏见，基准测试表现优异。

### 3. **[Geo-Embed: Towards Unified Multimodal Embeddings for Urban Understanding](https://arxiv.org/abs/2608.03826v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Jiapeng Li, Yong Li, Junjie Zhou et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出GeoMEB基准与Geo-Embed模型以统一城市多模态理解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了大规模基准并显著提升了多模态城市任务性能

### 4. **[Taming the Implicit: Dual-Channel Risk-Aware Reinforcement Fine-Tuning for Continual Multimodal Post-Training](https://arxiv.org/abs/2608.03660v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Yibei Liu, Jiajun Chen, Qianle Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出RAPO框架缓解多模态持续学习遗忘问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出双通道风险治理，实验验证效果显著

### 5. **[OmniPack: Unified Token Compression for Efficient Omni-modal Large Language Models](https://arxiv.org/abs/2608.03812v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-04
- **作者**: Wanshun Su, Yang Shi, Feihu Liu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出OmniPack框架实现多模态大模型高效压缩。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，在保持性能的同时显著降低计算开销。

## Image Generation

### 1. **[UniWorld-Design: From Pixel Generation to Layer-Native Design](https://arxiv.org/abs/2608.03971v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Zongjian Li, Zhiyuan Yan, Chenxu Bai et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出UniWorld-Design实现图层级图像生成与编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地引入图层原生设计空间，实验效果显著且逻辑清晰。

### 2. **[FlowForm: Synergizing Fluid Physics with Topological Consistency for Satellite Flood Synthesis](https://arxiv.org/abs/2608.03822v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Zhang Weihui, Wang Ruizhi, Xu Hongye et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出FlowForm框架，通过物理约束提升卫星洪水图像生成质量。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合流体力学与扩散模型，方法创新且实验设计严谨，具有较高应用价值。

### 3. **[IRIS: Visual-Semantic Binding for Forgery-Resistant Watermarking of Diffusion Images](https://arxiv.org/abs/2608.03539v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Xiaoyan Feng, Zheng Gao, Tong Guan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出IRIS水印，实现扩散模型图像的视觉语义绑定防伪。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地解决了水印移植与伪造问题，实验严谨且实用性强。

## Video Generation

### 1. **[JoyAI-Video-Edit: Real-Time Open-Ended Video Editing with Autoregressive Diffusion](https://arxiv.org/abs/2608.03974v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Yicheng Xiao, Wenxun Dai, Xinran Qin et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出实时自回归扩散视频编辑框架，实现高效长视频处理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏与自回归机制实现实时编辑，技术创新且性能优异。
...
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Alexander Meulemans, Maciej Wołczyk, Marissa A. Weis et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出嵌入式均衡理论解释AI合作行为
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过嵌入式代理视角重构博弈论，理论创新性极强。

### 2. **[Resume Means Resume: A Machine-Checked Conformance Contract for Checkpoint, Interrupt, and Resume Semantics in Workflow Persistence Layers](https://arxiv.org/abs/2608.03836v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Sajjad Khan
- **标签**: `cs.LG` `cs.DC` `cs.LO`
- **AI摘要**: 提出RESUME契约并构建REMIT系统解决工作流持久化一致性问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过形式化验证与实证分析揭示了主流框架的缺陷，方法严谨且贡献显著。

### 3. **[GenOS: Compositional Certificates for Semantic Robustness in AI Code Generation](https://arxiv.org/abs/2608.03588v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Corrado Priami
- **标签**: `cs.PL` `cs.AI` `cs.SE`
- **AI摘要**: 提出GenOS框架实现AI代码生成工作流的语义鲁棒性证明。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且创新，通过马尔可夫核实现工作流的组合式验证。

### 4. **[PAST-Bench: Benchmarking the Foundations of Recursive Self-Improvement in Personal Agents](https://arxiv.org/abs/2608.04003v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Shuhan Xue, Zixin Ding, Yichen Shen et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出PAST-Bench基准评估个人智能体递归自我改进能力。
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Sebastián Andrés Cajas Ordóñez, Agastya Munnangi, Aldo Marzullo et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示多智能体临床决策中的社会性偏见与捷径博弈问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入探讨了多智能体协作中的鲁棒性，实验严谨且具有临床应用价值。

## Distributed Computing

### 1. **[Real-time decoding of quantum error correction codes using high-performance computing](https://arxiv.org/abs/2608.03948v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
...
- **评分理由**: 该架构有效降低了量子纠错解码延迟，具备高扩展性。

### 2. **[FedCritic-MIMO: Communication-Efficient Serverless Federated Critic Learning for Massive-MIMO Resource Control in Open and Disaggregated 6G RANs](https://arxiv.org/abs/2608.03852v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Amin Farajzadeh, Melike Erol-Kantarci
- **标签**: `cs.LG` `cs.MA` `cs.NI`
- **AI摘要**: 提出FedCritic-MIMO实现6G基站高效协同资源控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，理论证明与实验验证充分，通信效率提升显著。

### 3. **[TAOT: Topology-Aware Optimal Transport for Dynamic Expert Replica Placement in MoE Training](https://arxiv.org/abs/2608.03676v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Lingyun Zhang, Henghua Zhang, Shilei Gu et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出拓扑感知最优传输方法优化MoE专家副本放置
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过最优传输解决通信与负载平衡矛盾，性能提升显著

### 4. **[When Does Disaggregation Pay? Simulating Prefill--Decode--Attention--FFN Specialization for Agentic LLM Inference](https://arxiv.org/abs/2608.03741v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-04
- **作者**: Przemyslaw Forys, Haoran Wu, Can Xiao et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出异构推理仿真框架HeteroPanacea
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对智能体推理的硬件解耦仿真，方法创新且实用性强。

### 5. **[Accelerating Dynamic Graph Clustering on GPU Architectures with cuGraph](https://arxiv.org/abs/2608.03695v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-04
...
- **评分理由**: 显著提升了动态图社区检测效率，工程实用性强。

## Information Retrieval

### 1. **[Less Traffic, Better Outcomes: Competition-Aware Request Dispatch in Real-Time Ad Exchanges](https://arxiv.org/abs/2608.03705v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-08-04
- **作者**: Jonaid Shianifar, Blaz Mramor, Fangda Zou et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出竞争感知请求分发框架，提升广告竞价效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业级实验规模大，方法创新且具备显著商业价值。

### 2. **[ATLAS: Learning to Recommend Across Unseen Domains](https://arxiv.org/abs/2608.03899v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Pervez Shaik, Prosenjit Biswas, Abhinav Thorat et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出ATLAS框架实现零样本跨域推荐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验充分，有效解决跨域推荐泛化难题

### 3. **[Conditionally Identifiable Latent-Environment Modeling for Out-of-Distribution Recommendation](https://arxiv.org/abs/2608.03647v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Qianqian Wang, Wenwu Gong, Yunshan Li et al.
- **标签**: `cs.IR` `cs.LG`
- **AI摘要**: 提出CILER框架解决OOD推荐中的环境偏移问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨且在多场景下验证了OOD性能提升

### 4. **[LegalPincite: Multi-level Legal Information Retrieval Dataset](https://arxiv.org/abs/2608.03756v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-04
- **作者**: Theresia Veronika Rampisela, Henrik Palmer Olsen, Giovanni Colavizza
- **标签**: `cs.IR`
- **AI摘要**: 提出LegalPincite数据集以改进法律信息检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了法律领域段落级引用标注的空白，方法严谨且实用。

### 5. **[SITA: Semantic Interest Tokens for Target-Aware Compression in Long-Sequence Recommendation](https://arxiv.org/abs/2608.03692v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-04
- **作者**: Rui Zhou, Bo Chen, Qinglin Jia et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出SITA框架实现长序列推荐的语义压缩与目标感知。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新性强，兼顾效率与精度，实验验证充分。

## Computer Vision

### 1. **[From Multi-Resolution Cells to Gigapixel Whole Slide Images Foundation Model for Computational Pathology](https://arxiv.org/abs/2608.03508v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-08-04
- **作者**: Basit Alawode, Moshira Ali Abdalla, Dwarikanath Mahapatra et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出多分辨率金字塔Transformer，提升病理图像分析性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入多尺度注意力机制，实验覆盖广泛，方法论严谨。

### 2. **[StreamDAM: Presence-Aware Memory for Real-Time Streaming Video Object Segmentation](https://arxiv.org/abs/2608.03912v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Xiang Chen
- **标签**: `cs.CV`
- **AI摘要**: 提出流式视频分割模型StreamDAM，实现实时高效跟踪。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对流式视频分割的实时性与准确性平衡提出了创新架构，实验充分。

### 3. **[When Efficiency Becomes Fragility: Exploiting Dynamic Routing Vulnerabilities in Adaptive UAV Tracking](https://arxiv.org/abs/2608.03902v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Shaofeng Liang, Runwei Guan, Wenshuo Chen et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示自适应追踪器路径决策的脆弱性并提出攻击框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，揭示了动态路由架构的新型安全风险。

### 4. **[BanglaWild: An In-the-Wild Bengali Scene Text Recognition Benchmark for OCR and Vision-Language Models](https://arxiv.org/abs/2608.03884v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Sadab Shiper, Tawsif Tashwar Dipto, Mir Md Inzamam et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出孟加拉语场景文本识别基准及误差分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了孟加拉语场景文字识别的空白，评估详尽且分析深入。

### 5. **[Keep the Needle, Prune the Haystack: Defect-Preserving Token Pruning for Efficient Zero-Shot Anomaly Detection](https://arxiv.org/abs/2608.03681v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Yanning Hou, Jingyuan Zhang, Xiaoyun Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出KeepAD框架，通过缺陷保留令牌剪枝提升异常检测效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，显著提升了零样本异常检测的推理速度。

## Machine Learning

### 1. **[Predicting Deep Neural Network Training Outcomes from Early Training Telemetry](https://arxiv.org/abs/2608.03709v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Ranjita Naik, Anh D. Nguyen, Pankaj Kumar Singh
- **标签**: `cs.CL`
- **AI摘要**: 利用早期训练遥测预测模型最终表现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验规模巨大，对算力优化有极高实用价值

### 2. **[LAEF: A Lead-Agnostic ECG Foundation Model Towards Point-of-Care Diagnostics](https://arxiv.org/abs/2608.03690v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-04
- **作者**: Edoardo Coppola, Stefano Fiorini, Pietro Liò et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出一种支持任意导联输入的通用心电图基础模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型架构创新且实用，实验验证充分，在临床诊断中表现优异。

### 3. **[DiffPower: GPU-Accelerated Differentiable Switching Power Analysis and Optimization](https://arxiv.org/abs/2608.03778v1)**
- **评分**: ⭐ 86/100 | **日期**: 2026-08-04
- **作者**: Isaac Jacobson, Zheng Zhao, Rashmi Mehrotra et al.
- **标签**: `cs.AR` `cs.DC`
- **AI摘要**: 提出GPU加速的可微功耗分析与优化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过自动微分实现高效功耗优化，性能提升显著且实验严谨。

### 4. **[Information-Geometric Forward Policy Training in GFlowNets](https://arxiv.org/abs/2608.03967v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Yordan Raykov, Rodrigo Veiga
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出基于信息几何的GFlowNet训练框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Fisher-Rao度量优化策略训练，理论严谨且具有创新性。

### 5. **[A Physics-Flavored Transformer Network for Parametrizing Contraction Dynamics of Engineered Skeletal Muscle Tissues](https://arxiv.org/abs/2608.03927v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-04
- **作者**: Mattias Luber, Timo Betz
- **标签**: `cs.LG`
- **AI摘要**: 提出物理启发网络实现肌肉组织动力学参数化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理模型与深度学习，有效解决生物数据稀缺与复杂建模问题。
