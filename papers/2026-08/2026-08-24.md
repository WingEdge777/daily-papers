...
### 1. **[Large Language Models at the Intersection of Software Engineering and Software Security:An Evidence-Centered Structured Survey and Research Agenda](https://arxiv.org/abs/2608.21107v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-21
- **作者**: Wei Lin, Tao Zhou, Zhaofei Xie et al.
- **标签**: `cs.AI` `cs.SE`
- **AI摘要**: 评述大语言模型在软件工程与安全交叉领域的应用
<details>
...
- **评分理由**: 结构严谨且极具实用价值的综述，对未来研究指明了方向。

### 2. **[Move by Move: Measuring and Steering How LLMs Conduct Psychotherapy](https://arxiv.org/abs/2608.21325v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Afonso Baldo, Hugo Pitorro, Areti Vassilopoulos et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出语言模型心理治疗分析本体
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且具实用价值，但创新性中等

### 3. **[Rethinking Expressivity and Efficiency in Test-Time Training](https://arxiv.org/abs/2608.21308v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Zeyun Zhong, Joya Chen, Manuel Martin et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出高效且具表达力的测试时训练方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性平衡了计算效率与表达力，实验扎实。

### 4. **[Affective Context Amplifies Sycophancy in LLM Responses](https://arxiv.org/abs/2608.21242v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Jiayi Li, Sanjana Menon, Brett Frischmann et al.
- **标签**: `cs.CL`
- **AI摘要**: 研究发现情感背景会加剧大语言模型的谄媚现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实用，实验扎实，分析深入

### 5. **[RARE: Decoupling Representation Steering from Expert Routing in Mixture-of-Experts Language Models](https://arxiv.org/abs/2608.21236v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Zhibo Zhang, Zhen Ouyang, Ling Shi et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出RARE框架解决MoE模型表征干预的路由冲突问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实验充分，具有较高的实用价值。

## Natural Language Processing

### 1. **[A Neurosymbolic Approach for Constructing Planning Domain Models from Clinical Narratives](https://arxiv.org/abs/2608.21186v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Ranveer Singh, Saurabh Mathur, Michael Skinner et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出神经符号学方法从临床文本构建手术规划模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性与实用性较好，实验扎实且临床验证充分

### 2. **[Scaling Unsupervised Word Alignment to Documents via Structural Constraints](https://arxiv.org/abs/2608.21023v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
...
- **评分理由**: 创新性较好且实验充分，具有较高实用价值

### 3. **[EnSI-RAG: Entity-Structure-Indexed Retrieval-Augmented Generation for Long-Document Question Answering](https://arxiv.org/abs/2608.21252v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Xuanyu Meng, Jiashuo Sun, Jash Rajesh Parekh et al.
- **标签**: `cs.CL` `cs.AI` `cs.DB`
- **AI摘要**: 提出实体结构索引的RAG框架以优化长文档问答
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性和实用性良好，实验扎实，写作清晰

### 4. **[Benchmarking Patent Drafting from Inventor-Style Disclosures](https://arxiv.org/abs/2608.21249v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Lekang Jiang, Wenjun Sun, Stephan Goetz
- **标签**: `cs.CL`
- **AI摘要**: 提出专利起草数据集及多智能体框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨创新，对大模型评估有实用价值

## Vision Language Models

### 1. **[COMET: Contrastive Motion-Enhanced Temporal Reasoning for Video Multimodal Large Language Models](https://arxiv.org/abs/2608.21030v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-21
- **作者**: Chenghua Zhu, Zhaolu Kang, Qifan Shi et al.
- **标签**: `cs.CV` `cs.CL` `cs.LG`
- **AI摘要**: 提出COMET框架增强视频大模型的时空理解与运动推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构与优化创新显著，实验扎实，写作清晰

### 2. **[Enhancing Localized Reasoning for Long Video Understanding via Efficient Segment-to-Video Supervision](https://arxiv.org/abs/2608.20814v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Beibei Zhang, Chao Xu, Jun Lan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出高效的片段到视频监督方法提升长视频推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好且效率高，但属于特定任务的改进

### 3. **[When Generated Images Look Right and Retrieve Wrong: Coverage-Guided Cross-Scale Re-Indexing for Knowledge-Faithful Generative Perception](https://arxiv.org/abs/2608.20810v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Guangyuan Dong, Chuang Liu, Yangchen Zeng et al.
- **标签**: `cs.MM` `cs.AI` `cs.CV`
- **AI摘要**: 提出CERES框架解决生成图像的多尺度检索失效问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效改善图文检索的一致性

### 4. **[CertVLA: Certified Defense against Physical Visual Attacks for Vision-Language-Action Models](https://arxiv.org/abs/2608.20791v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Hui Lu, Zhijie Peng, Yuqi Lin et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出首个VLA模型物理对抗攻击的认证防御方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对VLA模型提出认证防御，新颖性与严谨性较好，实用性强

### 5. **[VIALS: A Benchmark for Visual Interpretation of Artifacts in the Life Sciences](https://arxiv.org/abs/2608.21357v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
...
- **评分理由**: 填补科学图像基准空白，但属评测类工作

## Diffusion Models

### 1. **[Anchoring Instruction Outside Mask: Exact Reference Caching for Efficient In-Context Diffusion Transformers](https://arxiv.org/abs/2608.21229v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-21
- **作者**: Yangshuai Liu, Zheming Li, Jiaao Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出了基于掩码外指令锚定的高效上下文扩散变压器方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合缓存与蒸馏技术，实验充分且性能显著提升。

### 2. **[Denoising the Future: Context-Aware Spectral Diffusion for Temporal Knowledge Graph Extrapolation](https://arxiv.org/abs/2608.20804v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Yanglei Gan, Peng He, Run Lin et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出频域感知扩散模型进行时序知识图谱外推
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合扩散与频域方法，创新性好且实验充分

## Multimodal

### 1. **[Kinematic Knowledge Maps for Pattern Alignment: Structured Latent Representational Learning in Multimodal Gait Analysis](https://arxiv.org/abs/2608.20969v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-21
- **作者**: Chen Dong, He Zonglin, Cheung Kenneth M. C
- **标签**: `cs.CV`
- **AI摘要**: 提出可解释的步态多模态融合筛查框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结构化特征表示新颖且临床验证严谨

### 2. **[VT-MUSE: Multimodal Unified Sequential Visuotactile Representation Learning for Manipulation](https://arxiv.org/abs/2608.21290v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Congsheng Xu, Qiaochu Yang, Fangyuan Shi et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出VT-MUSE视触觉多模态表征学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，提升了机器人操作性能

### 3. **[ReFrame: Evidence-Guided Test-Time Safety Alignment in Multimodal Large Language Models](https://arxiv.org/abs/2608.21100v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Wenzheng Jiang, Xuankun Rong, Yuanzhao Zhai et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ReFrame框架实现多模态模型测试期安全对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用且评估充分，但属于框架改进

### 4. **[EviRank: Structured Relevance Evidence for Multimodal Image Re-ranking](https://arxiv.org/abs/2608.20886v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Enjun Du, Siyi Liu, Zirong Chen et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出了基于结构化证据的多模态图像重排方法
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.CV`
- **AI摘要**: 提出OmniAssistBench基准评估全能大模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补全能多模态模型交互基准空白，评估严谨但模型属于应用测试

## Image Generation

### 1. **[OccluRank: Controllable Occlusion-Aware Layout-to-Image Generation by Adding Just an Ordinal Rank](https://arxiv.org/abs/2608.20932v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-21
- **作者**: Wenyang Hong, Yuan Wang, Yanbin Hao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出OccluRank实现可控的遮挡感知图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖有效，实验全面，具有较高实用价值

### 2. **[Difficulty-Calibrated Interpolation Paths for Conditional Flow Matching](https://arxiv.org/abs/2608.21286v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
...
### 1. **[InfinityEdit: Infinite Video Editing with a Lightweight Edit-Ignition Adapter](https://arxiv.org/abs/2608.20910v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Yunze Tong, Mushui Liu, Canyu Zhao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出支持无限视频编辑的轻量化适配器InfinityEdit
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新任务定义与适配器设计有创新，实验和论述较为扎实

## Agent

### 1. **[ClawSentry: A Progressive Multi-Tier Security Monitor for Safeguarding Autonomous LLM Agents](https://arxiv.org/abs/2608.21101v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-21
- **作者**: Kai Wang, Zeming Wei, BiaoJie Zeng et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出ClawSentry多层级大模型智能体安全监控网关
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出多 locus 防护体系，实验充分且实用性强

### 2. **[AI with Authority, from Application to Silicon](https://arxiv.org/abs/2608.21356v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-21
- **作者**: Jason Hickey
- **标签**: `cs.SE` `cs.AI` `cs.AR`
- **AI摘要**: 生成式AI与机器验证驱动单人端到端硅片设计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性极高且方法严密，展现了AI智能体在硬件设计中的突破性应用。

### 3. **[AUSO: Action-Level Unified Skill Optimization from Internalization to Utilization](https://arxiv.org/abs/2608.21292v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Huizu Lin, Chengkai Huang, Tianqi Gao et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出了AUSO方法以优化智能体技能学习与利用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好且实验充分，但属于强化学习智能体常规改进

### 4. **[TRACE: Agentic Catalog Enrichment with Multi-source Evidence Grounding](https://arxiv.org/abs/2608.20844v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-08-21
- **作者**: Rohan Kumar, Steven Xu, Kyle MacDonald et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出TRACE智能体框架用于电商目录丰富
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性采用多智能体多源证据 grounding，兼具工业界落地效果。

### 5. **[Utility Under Attack: Agent Memory Poisoning and the Limits of Content Screening and Provenance Ranking](https://arxiv.org/abs/2608.21230v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Arulnidhi Karunanidhi
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 揭示AI智能体记忆投毒与防御局限
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验扎实，选题具有较高实用价值

## Distributed Computing

### 1. **[Thermo-FL: Thermal-Aware Robust Federated Fine-Tuning of Large Language Models for Edge AI](https://arxiv.org/abs/2608.21172v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-21
- **作者**: Shiva Shrestha, Kazi Shaharair Sharif, Zongxing Xie et al.
- **标签**: `cs.LG` `cs.DC`
- **AI摘要**: 提出兼顾热管理与鲁棒聚合的边缘大模型联邦微调框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合硬件热管理与鲁棒聚合，兼顾仿真与实测验证，创新性强且实用。

### 2. **[Integrating a Python Dynamical core into ICON](https://arxiv.org/abs/2608.21150v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Mauro Bianco, Till Ehrengruber, Enrique González Paredes et al.
- **标签**: `cs.DC`
- **AI摘要**: Python核心成功嵌入ICON并提速
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合DSL与DaCe提升气候模拟性能

### 3. **[BackDFL: A Unified Benchmark For Backdoor Attacks and Defenses In Decentralized Federated Learning](https://arxiv.org/abs/2608.21137v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Mouhamed Amine Bouchiha, Gregory Blanc, Yufei Han
- **标签**: `cs.LG` `cs.CR` `cs.DC`
- **AI摘要**: 提出去中心化联邦学习的后门攻击统一基准。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了去中心化联邦学习安全基准的空白，实验详实。

### 4. **[AI Infrastructure in Space: How Far Can We Go?](https://arxiv.org/abs/2608.21034v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Qing Li, Qiyang Zhang, Daliang Xu et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出太空人工智能基础设施系统愿景与案例分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且具实用价值，结合了真实卫星实验验证

### 5. **[A Safety-Driven Architectural Framework for Fail-Operational Drone Swarms in Critical Missions](https://arxiv.org/abs/2608.20906v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Luiz Giacomossi, Zafer Yigit, Marwan Shakarna et al.
- **标签**: `eess.SY` `cs.MA` `cs.RO`
- **AI摘要**: 提出无人机蜂群安全架构与可靠性模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合航空标准与形式化验证，具备较高应用潜力与严谨性

## Information Retrieval

### 1. **[RAG Deserves an Index: Why Ingest-Time Compilation Beats Query-Time Interpretation](https://arxiv.org/abs/2608.20845v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-21
- **作者**: Kyle Wild, Yusuke Takahashi, Asako Uraki
- **标签**: `cs.AI` `cs.DB` `cs.IR`
- **AI摘要**: 提出摄入时语义编译以优化RAG检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验充分，具有较高的系统实用价值

### 2. **[Recommendation Quality and the Concentration of Consumption: Experimental Evidence from Netflix](https://arxiv.org/abs/2608.21274v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Guy Aridor, Winston Chou, Nathan Kallus et al.
- **标签**: `econ.GN` `cs.IR`
- **AI摘要**: 网飞推荐系统对消费集中度的影响研究
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基于海量用户实验，评估严谨但方法相对传统

### 3. **[Adapting Knowledge Graphs for Behavior Denoising in Sequential Recommendation](https://arxiv.org/abs/2608.21243v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Zichun Jin, Zihan Zhou, Yinan Liu et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 提出利用知识图谱进行序列推荐去噪的AdaptedKG方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合知识图谱去噪有创新性，但属于特定应用领域的改进

### 4. **[GrAND: GPU-based Dynamic Graph Indexes for Approximate Nearest Neighbour Search](https://arxiv.org/abs/2608.21163v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Karthik Venkatasubba, Shivendra Deshpande, Shivram S et al.
- **标签**: `cs.DC` `cs.DB`
- **AI摘要**: 提出GPU动态图索引GrAND加速向量检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且性能提升显著，实验评估充分

### 5. **[Trustworthy RAG: An Evaluation Agent for Detecting Misinformation and Knowledge Poisoning in Generative AI Systems](https://arxiv.org/abs/2608.21095v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-21
- **作者**: Balkrishna Giri, Md Toufique Hasan, Jussi Rasku et al.
- **标签**: `cs.SE` `cs.AI` `cs.CL`
- **AI摘要**: 提出评估代理防范RAG知识投毒
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合NLI与多信号检测，实验详实

## Computer Vision

### 1. **[Multi-Modal Traffic Sign Detection with Semantic Attributes for Autonomous Driving](https://arxiv.org/abs/2608.20874v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-21
- **作者**: Meda Lazar, Sourab Sridhar, Shashwata Gupta et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出多模态交通标志检测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，具有很高实用价值

### 2. **[ES-VP : Energy-Shaped Dynamic Visual Prompting for Efficient Model Adaptation](https://arxiv.org/abs/2608.21194v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-21
- **作者**: Can Jin, Ying Li, Jingchen Sun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出能源塑造视觉提示的高效模型自适应方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，显著提升了参数效率与泛化能力

### 3. **[Triangulation-Free Bundle Adjustment with Graduated Non-Convexity for Camera Pose Refinement from Coarse Priors](https://arxiv.org/abs/2608.21008v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-21
- **作者**: Nikolaos Kyriazis
- **标签**: `cs.CV`
- **AI摘要**: 提出无三角化束差分法优化相机位姿
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新显著且实验扎实，实用性强

### 4. **[GAP-SAM: A Global Artifact Prior for Generalizable AI-Generated Image Manipulation Localization](https://arxiv.org/abs/2608.20929v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-21
- **作者**: Haozhen Yan, Siyuan Shan, Zijian Yu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GAP-SAM方法提升AI生成图像篡改定位能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，实验扎实，应用前景明确，写作清晰。

### 5. **[CoAnchor: Robust Collaborative Perception under Spatio-Temporal Misalignment via Object-Level Anchors](https://arxiv.org/abs/2608.21055v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Chi Li, Rui Lin, Aobo Ji et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出CoAnchor实现鲁棒的协同感知对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点有效，实验充分，实用性强

## Machine Learning

### 1. **[RODE: A Radial-Orthogonal Decoupled Engine for Optimization](https://arxiv.org/abs/2608.21024v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-21
- **作者**: Guoxiang Xu, Bince Qu, Qi Sun et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出RODE优化器解耦径向与方向动力学
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实验充分，大规模效果显著

### 2. **[Scaling Muon for Diffusion Transformers](https://arxiv.org/abs/2608.20818v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-21
- **作者**: Chenghao Li, Xiao Han, Xinxin Huang et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出了周期性行向Muon以加速大模型训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法创新显著，扩展性实验充分，实用价值高

### 3. **[Beyond Imitation: Self-Improving Robot Policies via Off-Policy Q-Planning](https://arxiv.org/abs/2608.21204v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-21
- **作者**: Varun Giridhar, Anant Khandelwal, Jeremy A. Collins et al.
- **标签**: `cs.RO` `cs.LG`
- **AI摘要**: 提出Q-Planning方法实现机器人策略自改进
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合Q函数与行为克隆，实验充分，效果显著。

### 4. **[Prediction certification cannot replace explanation certification: a competence envelope for trustworthy AI under compound stress](https://arxiv.org/abs/2608.20825v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-21
- **作者**: Nataliya Shakhovska, Ivan Izonin, Stergios-Aristoteles Mitoulis
- **标签**: `cs.AI`
- **AI摘要**: 证明预测认证无法替代解释认证并提出能力包络框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论证明严谨且具实用价值，跨数据集验证充分

### 5. **[PerturbRx: Learning Treatment-Conditioned Latent Transitions for Patient Drug Response Prediction](https://arxiv.org/abs/2608.21349v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-21
- **作者**: Yoshitaka Inoue, Minoh Jeong, Alfred Hero et al.
- **标签**: `q-bio.QM` `cs.LG`
- **AI摘要**: 提出了基于治疗条件潜空间转移的肿瘤药物反应预测框架。
<details>
<summary>原始摘要</summary>
