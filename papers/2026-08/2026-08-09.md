...
### 1. **[EpiBench: Can LLMs Understand Epitopes for Antibody Drug Discovery?](https://arxiv.org/abs/2608.06022v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Zirui Wang, Jiaqi Wang, Qinghan Wang et al.
- **标签**: `cs.CL` `q-bio.GN`
- **AI摘要**: 提出评估LLM抗原表位理解能力的EpiBench基准
<details>
...
- **评分理由**: 填补抗原表位空白，评估严谨但属于基准测试

### 2. **[ProDVI: Programmatic Dynamics Priors for Value Network Initialization](https://arxiv.org/abs/2608.06015v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Xinwei Liu, Junyuan Liang, Jianting Zhang et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 利用大模型生成动力学先验提升强化学习样本效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实用，实验充分，方法具启发性

### 3. **[The em-dash em-beds in Congress: A population-level rise in em-dash frequency in U.S. congressional press releases at the dawn of the large-language-model era, 2021-2025](https://arxiv.org/abs/2608.05889v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Przemysław Czuma
- **标签**: `cs.DL` `cs.AI` `cs.CL`
- **AI摘要**: 研究美国国会新闻稿中破折号激增与大模型使用的关联
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实证严谨，但因注册规则未完全满足结论转为探索性

## Natural Language Processing

### 1. **[Cautious Context Steering for Language Model Personalization](https://arxiv.org/abs/2608.05813v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Gihoon Kim, Jeyoung Lee, Suhan Woo et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出谨慎上下文引导方法实现高效语言模型个性化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且泛化性好，但实验部分可更深入

## Agent

### 1. **[AgentOPSD: Recursive Self-Distillation for Agentic Reinforcement Learning](https://arxiv.org/abs/2608.05987v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-06
- **作者**: Zi-Han Wang, Zhengxi Lu, Zhiyuan Yao et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出递归自蒸馏方法解决智能体信用分配问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的递归信用分配方法，实验充分但属局部改进。

### 2. **[Benchmarking the Benchmarks: Evaluating Benchmarks for Conversational Agents](https://arxiv.org/abs/2608.06329v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Noam Koren, Roy Bar-Haim, Abigail Goldsteen
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出评估对话智能体基准质量的无参考框架。
<details>
<summary>原始摘要</summary>
...
- **AI摘要**: 提出了用于评估大模型提示词与智能体框架优化能力的基准HarnessOpt-Bench。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实用，实验完备，对智能体优化有重要价值。

### 4. **[The Next Screenshot Knows: Gated Hindsight Distillation for Mobile GUI Agents](https://arxiv.org/abs/2608.06065v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Weiwei Li, Junzhuo Liu, Tong Chu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出门控事后蒸馏法提升移动GUI智能体
<details>
<summary>原始摘要</summary>
...
### 5. **[From Economic Agents to Agentic Economies: A Systems Blueprint for Economic World Models](https://arxiv.org/abs/2608.06020v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Jiale Han, Xiang Li, Jing Qian et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出了经济世界模型的六层能力阶梯与实现蓝图
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性强且具有实用价值，属于有意义的框架提升

## Computer Vision

### 1. **[DTRNet: Dual Text-Radical Decoding for Handwritten Chinese Text Recognition with Faked Character Detection](https://arxiv.org/abs/2608.05848v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Runrui Li, Lin Zhu, Hua Huang
- **标签**: `cs.CV`
- **AI摘要**: 提出DTRNet双分支框架实现手写中文文本识别与伪造字检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题切中教育场景痛点，创新性地结合文本与部首解码，方法合理且实验充分。

### 2. **[Support Operation Factorization: Compositional Readout of Frozen Vision Encoders under Controlled Interventions](https://arxiv.org/abs/2608.06174v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-08-06
- **作者**: Zhongyao Wang, Wanli Ouyang, Taoyong Cui et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出支持操作因式分解法来解析冻结视觉编码器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且实验扎实，推进了视觉表征的可解释性研究。

### 3. **[Reversible Unlearnable Examples: Towards the Copyright Protection in Deep Learning Era](https://arxiv.org/abs/2608.06211v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Binze Wang, Jinyu Tian, Xingrun Wang et al.
- **标签**: `cs.CR` `cs.CV`
- **AI摘要**: 提出可逆不可学习样本以保护图像版权
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合版权保护与不可学习样本，实验充分

### 4. **[CFGPNet: Cross-Attention-Based Fused Gradient Programmed Network Framework for Multispectral Object Detection](https://arxiv.org/abs/2608.06205v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Nima Hatami, Karim Faez, Saeed Sharifian et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CFGPNet实现高效多光谱目标检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性融合多模态特征，实验充分，实用性强。

### 5. **[Threshold-Based Early Stopping of Accumulations in Neural Networks with Binary Activation](https://arxiv.org/abs/2608.06177v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Quentin Luquet de Saint-Germain, Massil Ait Abdeslam, Jean Pierre David
- **标签**: `cs.LG` `cs.NE`
- **AI摘要**: 提出二值神经网络早停机制以减少计算量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新有效且实验扎实，但适用场景较窄

## Machine Learning

### 1. **[Dynamic Graph Prompting via Topology-Routed Mixed-Curvature Experts](https://arxiv.org/abs/2608.06031v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-06
- **作者**: Quanxin Wang, Xuanting Xie, Bingheng Li et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出拓扑路由混合曲率专家动态图提示框架
<details>
<summary>原始摘要</summary>
...
### 2. **[RxnCLF: Contrastive Transformation-Aware Reaction Foundation Model for Improved Reactivity Prediction](https://arxiv.org/abs/2608.06259v1)**
- **评分**: ⭐ 77/100 | **日期**: 2026-08-06
- **作者**: Yiting Zheng, Cheng Fang, Anthony Donofrio et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出RxnCLF反应基础模型以提升产率预测
<details>
<summary>原始摘要</summary>
...
### 3. **[A Six-Dimensional Taxonomy of Post-Training Adaptation Techniques with Applications in AI Governance](https://arxiv.org/abs/2608.06246v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Fardin Afdideh, Fernando Seoane, Farhad Abtahi
- **标签**: `cs.LG`
- **AI摘要**: 提出了后训练适应技术的六维分类法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统梳理文献并提出分类法，对治理有较高价值。

### 4. **[Timestep-Conditioned Transformers for Global Weather Forecasting](https://arxiv.org/abs/2608.06241v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Sam Levang, Fran Bartolic, Ty Dickinson et al.
- **标签**: `cs.LG` `cs.OS`
- **AI摘要**: 提出支持多时间步推理的全球天气预报模型GEM-3
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决时间步权衡问题，方法扎实但属于特定领域改进
...
- **标签**: `cs.RO` `cs.HC` `cs.LG`
- **AI摘要**: 提出从人类示范中学习类人机器人运动的框架。
<details>
<summary>原始摘要</summary>
