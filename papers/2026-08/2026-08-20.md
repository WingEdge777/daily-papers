...
### 1. **[Beyond Teacher Likelihood: Group-Calibrated On-Policy Distillation for Long-Context Reasoning](https://arxiv.org/abs/2608.19181v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-19
- **作者**: Zhu Zhang, Jixun Wang, Xiaoang Xu et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出GC-OPD方法优化长文本推理蒸馏
<details>
...
- **评分理由**: 新颖度与实验扎实，提升长文本推理能力，但偏垂直领域。

### 2. **[Test-Time Scaling in the Wild: Why Exploitation, Not Exploration, Is the Bottleneck](https://arxiv.org/abs/2608.18931v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-19
- **作者**: Davide Romano, Kanak Raj, Jerrod Parker et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 揭示测试期扩展在开放任务中的瓶颈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估测试期扩展方法，对LLM推理有重要指导价值。

### 3. **[Readable, Faithful, Used: Three Dissociable Properties of Demographic Identity in a Language Model](https://arxiv.org/abs/2608.18768v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-19
- **作者**: Fathin Difa Robbani
- **标签**: `cs.CL`
- **AI摘要**: 揭示了大语言模型中人口统计身份可读性、忠实度与因果使用的可分离性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且方法严谨，对LLM模拟人口具有重要理论价值

### 4. **[Gradient Mirage: Trainable yet Label-Unidentifiable Gradients in Large Language Model Split Learning](https://arxiv.org/abs/2608.18767v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-19
- **作者**: Shiyu Miao, Yunlong Mao, Zirui Huang et al.
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出Gradient Mirage防御大模型分布式学习隐私泄露
<details>
<summary>原始摘要</summary>
...
### 1. **[Learning What to Fail On: Failure-Mode Contextual Bandits for Adversarial Data Curation](https://arxiv.org/abs/2608.18681v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-19
- **作者**: Roie Kazoom, Ofir Cohen, Rami Puzis et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出失败模式上下文赌博机用于对抗数据筛选
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升模型鲁棒性

### 2. **[Denoising-Aware Inversion: Revealing Privacy Risks in Noise-Protected Text Embeddings](https://arxiv.org/abs/2608.18610v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Yubo Wang, Shujie Cui, James Bailey et al.
- **标签**: `cs.LG` `cs.AI` `cs.CR`
- **AI摘要**: 揭示了文本嵌入加噪保护下的隐私泄露风险
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对加噪嵌入提出自适应反演方法，创新性高且实验扎实

### 3. **[Comment-level Topic Drift Analysis in the Reddit Corpus](https://arxiv.org/abs/2608.19133v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Steven Morse, Daniel Runfola, Trenton W. Ford
- **标签**: `cs.CL`
- **AI摘要**: 分析Reddit评论的话题漂移
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模语料分析方法有新意但属增量创新

### 4. **[When Readability and Source Retention Diverge: An Evaluability Gap in AI Translation](https://arxiv.org/abs/2608.19083v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Chenchen Mao, Hanjing Shi, Haiyan Jia et al.
- **标签**: `cs.HC` `cs.CL`
- **AI摘要**: 揭示大模型翻译中的可评估性差距
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究严谨，但主题相对垂直，实用性一般

### 5. **[Institutional Books - Enriched Text: A customizable multilingual open-source pipeline for denoising, deduplicating, and annotating OCR text at scale](https://arxiv.org/abs/2608.19026v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: David Lowry-Duda, Matteo Cargnelutti, Catherine Brobston et al.
- **标签**: `cs.CL` `cs.DL`
- **AI摘要**: 提出大规模图书文本富文本处理流水线
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用性强但属工程改进，学术创新一般

## Vision Language Models

### 1. **[When Safety Overrides Vision: Exploring Dynamics between Vision Influence and Safety Alignment in Vision-Language Models](https://arxiv.org/abs/2608.18628v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-19
- **作者**: Mehak Gupta, Tanmoy Chakraborty
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 揭示视觉语言模型安全对齐掩盖感知证据的现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新图注意绑定机制，实验扎实且性能提升显著

### 3. **[ForeSightGuide: An Anticipatory Framework toward Accurate and Low-Redundancy Guidance for the Visually Impaired](https://arxiv.org/abs/2608.18993v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Zhiyuan Wang, Xu Li, Shikang Guo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出预测式视障辅助框架，降低信息冗余。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合VLM与轨迹预测，实验充分，实用性强。

### 4. **[ReWEIGH the Evidence: Calibrating Token-Level Ordinal Visual Evidence to Mitigate Hallucinations in Large Vision-Language Models](https://arxiv.org/abs/2608.19075v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Jihae Jeong, Junha Choi, Hwanjo Yu
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出ReWEIGH解码干预方法缓解视觉语言模型幻觉
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用且实验充分，分数合理

### 5. **[GS-VLA: Plug-and-Play Viewpoint Canonicalization for Frozen VLA Policies via Gaussian Splatting](https://arxiv.org/abs/2608.19066v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Yechan Park, HyunJin Kim
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出GS-VLA框架解决VLA模型视点偏移问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新结合高斯溅射适应视点，无需微调，实用性较好

## Diffusion Models

### 1. **[Diffusion Models for High-Dimensional Clustered Data: Intrinsic-Dimension Adaptivity via Bayesian Classification](https://arxiv.org/abs/2608.19067v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Yuga Iguchi, Paul Fearnhead
- **标签**: `stat.ML` `cs.LG` `math.ST`
- **AI摘要**: 扩散模型对高维聚类数据的自适应理论分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有创新且实验充分，具有较好的实用价值

## Multimodal

### 1. **[Generalized Audio-Driven Synthesis of Precise Drummer Motion](https://arxiv.org/abs/2608.19055v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-19
- **作者**: Álvaro G. Iñesta, Mattia Ryffel, Amit H. Bermano et al.
- **标签**: `cs.CV` `cs.GR` `cs.SD`
- **AI摘要**: 提出了基于扩散模型的通用音频驱动精确鼓手动作合成方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新双目标损失与新指标，方法扎实且应用前景好。

### 2. **[FRAGMENT: Factorized Graph Representations for Document Generation and Editing via Entity-Aware Transformations](https://arxiv.org/abs/2608.18679v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Ayoub El Bouchtili, Guilhaume Leroy-Meline
- **标签**: `cs.CV`
- **AI摘要**: 提出基于因子化图表示的文档生成与编辑框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，但在实用性上有一定局限

### 3. **[X2Streaming-TTS: Causal Token-Level Text-to-Speech from Streaming Text with Speech-State Inheritance](https://arxiv.org/abs/2608.18661v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Rime Wen, Zehan Liu, Shawn Qin et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出支持因果流式文本的TTS框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好实用价值高，实验扎实且行文清晰

### 4. **[VA-Judger: Reward Modeling from Human Preference Feedback for Joint Video-Audio Generation](https://arxiv.org/abs/2608.18607v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Yinming Huang, Shuyuan Tu, Xi Yan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出VA-Judger视听生成奖励模型及数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性高且实验扎实，有效解决视听对齐评估难题

### 5. **[Pretraining Reusable Inference Across Views with Synthetic Task Priors](https://arxiv.org/abs/2608.19115v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Jielong Lu, Zhihao Wu, Jiajun Yu et al.
- **标签**: `cs.LG` `cs.MM`
- **AI摘要**: 提出可复用的多视角推理元学习方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实验扎实，但属于细分领域应用

## Image Generation

### 1. **[Mise-en-Scène: Implicit Layout Emergence in Diffusion Transformers for Human-AI Design Co-Creation](https://arxiv.org/abs/2608.19000v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Zipeng Xu, Ryan Murdock, Umberto Michieli
- **标签**: `cs.CV`
- **AI摘要**: 提出基于扩散Transformer的隐式布局生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合扩散模型实现设计协同创作，实验充分。

## Video Generation

### 1. **[EfficientSync: Real-Time Lip Synchronization via Deformation-Based Reference Texture Mixing](https://arxiv.org/abs/2608.18832v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Fa-Ting Hong, Runzhen Liu, Luchuan Song et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出高效的实时音视频同步嘴形生成框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实用性高，实验充分，行文清晰。

### 2. **[CamWorldQA: Perceptual Quality Assessment of Camera-Controlled World Video Generation](https://arxiv.org/abs/2608.18710v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Yunhe Li, Likun Wu, Sijing Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个相机控制视频生成质量评估基准CamWorldQA
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补相机控制视频评估空白，方法新颖且实验充分

## Agent

### 1. **[Eureka: Task-Conditioned Meta-Agent Orchestration for Scientific Discovery](https://arxiv.org/abs/2608.19047v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-08-19
- **作者**: Alizer Wong, Heng Cui, Yi Tan et al.
- **标签**: `cs.AI` `math.NT`
- **AI摘要**: 提出Eureka元智能体架构以驱动科学发现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验充分，显著提升智能体能力

### 3. **[What is Missing from AI Post-Training AI: An Empirical Analysis](https://arxiv.org/abs/2608.19072v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-19
- **作者**: Joy Jia Yin Lim, Xin Huang, Hao Peng et al.
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 揭示AI自主训练缺乏策略反思机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 分析深入且实验充分，具有较高实用价值

### 4. **[CTIFoundry: An Agent-Native Corpus Scaffold for Cyber Threat Intelligence](https://arxiv.org/abs/2608.18613v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-19
- **作者**: Yutong Cheng, Changze Li, Qian Cui et al.
- **标签**: `cs.AI` `cs.CR`
- **AI摘要**: 提出面向智能体的CTI语料支架CTIFoundry
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新显著且基准测试扎实，提升智能体性能

### 5. **[SkillForge: Self-Distilling Agents for Project-Specific Issue Resolution](https://arxiv.org/abs/2608.18933v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Silin Chen, Han Li, Xiaodong Gu et al.
- **标签**: `cs.SE` `cs.AI`
- **AI摘要**: 提出SkillForge框架主动获取项目知识以提升软件修复能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实验扎实，有效提升大模型软件修复性能

## Distributed Computing

### 1. **[Tight Energy Lower Bounds for Distributed Graph Algorithms](https://arxiv.org/abs/2608.18992v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-19
- **作者**: Fabien Dufoulon, Gopal Pandurangan, Peter Robinson
- **标签**: `cs.DC` `cs.DS`
- **AI摘要**: 提出了分布式图算法能耗下界的通用信息论技术
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且理论严密，对分布式计算领域贡献显著

### 2. **[A Fast Deterministic Algorithm for $(Δ+1)$-edge coloring in CONGEST](https://arxiv.org/abs/2608.19184v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-19
- **作者**: Sebastian Brandt, Ananth Narayanan, Alexandre Nolin
- **标签**: `cs.DC`
- **AI摘要**: 首个CONGEST模型下的确定性多项式时间边染色算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破性解决CONGEST模型边染色问题，理论贡献显著

### 3. **[Upper and Lower Bounds on the Space Complexity of Multi-word Single-Writer Registers](https://arxiv.org/abs/2608.19167v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-19
- **作者**: Yuanhao Wei, Yousof Yavari
- **标签**: `cs.DC`
- **AI摘要**: 给出单写寄存器空间复杂度的上下界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论贡献显著，证明严谨，属分布式计算领域

### 4. **[Coordination on a Budget: Federated Active Learning with Few Labels](https://arxiv.org/abs/2608.18634v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Liam Mohr, Daphna Weinshall
- **标签**: `cs.LG`
- **AI摘要**: 联邦主动学习在低预算下的异质性反转与协同框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论与实证兼备，低预算协同框架设计新颖有效。

### 5. **[Pre-Compiled Pipeline Shards for Distributed LLM Inference on Intel AI PC Fleets](https://arxiv.org/abs/2608.19147v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Tate Berenbaum, Muthaiah Venkatachalam
- **标签**: `cs.DC` `cs.AI` `cs.SE`
- **AI摘要**: 利用闲置AI PC集群实现大模型分布式推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 分布式推理方案创新实用，实验扎实且条理清晰。

## Information Retrieval

### 1. **[rEDMRec: Distilling Large Language Model Reasoning into an Editable Experience Memory for Recommendation](https://arxiv.org/abs/2608.18952v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-19
- **作者**: Minh Hoang Nguyen, Tung Le, Huy Tien Nguyen
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 提出rEDMRec将LLM推理蒸馏为可编辑经验记忆用于推荐
<details>
<summary>原始摘要</summary>
...
### 2. **[Think-to-Personalize: Unifying Reasoning and Retrieval for User-Centric Personalized Dense Retrieval](https://arxiv.org/abs/2608.18855v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Angqing Jiang, Gaoming Zhang, Jianchun Song et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出结合大模型推理与个性化检索的TTP框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用，实验充分，但属于特定应用场景。

### 3. **[GateDiffInt: Gate-Mediated Controllable Diffusion and Multi-Intent LLM Distillation for User Behavior Modeling](https://arxiv.org/abs/2608.18764v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Jialong Duan, Zichen Zhang, Zirui Tu et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出GateDiffInt用于用户行为建模与意图蒸馏
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合扩散与大模型蒸馏，工业界验证充分但偏应用

### 4. **[SIDScope: A Diagnostic Resource for Semantic-ID Interfaces in Generative Recommendation](https://arxiv.org/abs/2608.18779v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Jiandong Ding, Huijie Qin, Tiandeng Wu et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 提出了生成推荐中语义ID接口的诊断资源SIDScope
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作具有实用价值且实验扎实，但属于特定领域的诊断工具，创新性中等

### 5. **[GreekBarRetrieval: A Benchmark for Greek Statutory Retrieval](https://arxiv.org/abs/2608.18752v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-19
- **作者**: Ernest Beta, Odysseas S. Chlapanis, Dimitrios Galanis et al.
- **标签**: `cs.IR` `cs.CL`
- **AI摘要**: 提出希腊语法律检索基准及重构方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了希腊语法律检索空白，实验充分严谨。

## Computer Vision

### 1. **[Orthogonal Polynomial Approximation for Matrix Log Normalization in Global Covariance Pooling](https://arxiv.org/abs/2608.19021v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-19
- **作者**: Md Rifat Ur Rahman, Md Raihan Khan, Md Sakib Hossain Shovon et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出正交多项式近似替代谱对数，解决矩阵对数归一化数值不稳定问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新有效，实验充分，提升了协方差池化性能

### 2. **[USR-Drive: Unified Driving Scene Representation via Joint Denoising of 3D Gaussians and Boxes](https://arxiv.org/abs/2608.19036v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-19
- **作者**: Li-Heng Chen, Haokai Pang, Chengye Su et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出统一去噪3D高斯与边界框的自动驾驶场景表示方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合几何重建与检测，实验充分，效果显著。

### 3. **[Beyond Trial Averaging: Anchoring Neural and Visual Representations for Few-Repetition Brain-to-Image Retrieval](https://arxiv.org/abs/2608.19128v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Zhenyao Cui, Siyuan Kan, Dingkun Liu et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出NEAR框架解决少重复脑电图像检索问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点明确且实验充分，具有较高的自动驾驶实用价值。

### 5. **[SPK: Eliciting Structured Prior Knowledge for Interpretable Out-of-Distribution Detection in Real-Time Object Detection](https://arxiv.org/abs/2608.19080v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Changshun Wu, Weicheng He, Xiaowei Huang et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出了SPK框架用于提升实时目标检测的OoD检测能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新显式先验知识，实验充分，提升显著

## Machine Learning

### 1. **[Transportable Causal Effect Estimation across Networks under Interference](https://arxiv.org/abs/2608.18932v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-19
- **作者**: Xiaojing Du, Jiuyong Li, Lin Liu et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出了网络干扰下因果效应的可迁移估计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且有实验验证，具备较高的学术价值

### 2. **[Score the Algebra, Not the Span: Dimension Reduction for Transfer Operator Models of Dynamical Systems](https://arxiv.org/abs/2608.18918v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-19
...
- **评分理由**: 创新性强且理论扎实，具较高应用潜力

### 3. **[Leaf Values as Coordinates: Exact Contrastive Explanation for Gradient-Boosted Ensembles](https://arxiv.org/abs/2608.19127v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-19
- **作者**: Emanuele Luzio
...
- **评分理由**: 创新性强，实用性高，实验严谨，表述清晰。

### 4. **[A single design choice determines whether machine learning models of materials make physically impossible predictions](https://arxiv.org/abs/2608.18714v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-19
- **作者**: Can Polat, Mustafa Kurban, Erchin Serpedin et al.
- **标签**: `cond-mat.mtrl-sci` `cs.LG` `physics.comp-ph`
- **AI摘要**: 揭示设计选择决定材料机器学习模型物理合理性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且实验严谨，对材料AI具有重要方法论价值

### 5. **[ADEPT: Accelerating Dexterity via Pre-Training and Post-Training using Reinforcement Learning](https://arxiv.org/abs/2608.19182v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-19
- **作者**: Jayjun Lee, Jessica Yin, Asif Rana et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出了ADEPT强化学习框架以加速灵巧手具身智能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性预训练与后训练策略有效解决了高自由度机器人任务
