...
- **评分理由**: 创新弱强泛化方法，实验充分但略显增量

### 2. **[Compositional Online Learning for Semantic Data Processing Systems](https://arxiv.org/abs/2608.27244v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Paweł Liskowski, Fuheng Zhao, Benjamin Han et al.
- **标签**: `cs.DB` `cs.AI`
- **AI摘要**: 提出语义数据系统中的组合式在线学习框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖地利用LLM延迟隐藏学习开销，系统性强但限定在特定场景。

### 3. **[JudgeStealer: Extracting LLM Judging Capabilities across Evaluation Protocols](https://arxiv.org/abs/2608.26982v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Chen Chen, Yaolin Chen, Xuehan Sun et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出了首个大模型裁判能力的高效提取框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实验扎实，但在应用范围上具有一定局限性。

### 4. **[Sophistication in GenAI Use: Field Evidence from a Large Firm](https://arxiv.org/abs/2608.27364v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Nicholas J. Hallman, Zachary T. Kowaleski, Anu Puvvada et al.
- **标签**: `cs.AI` `econ.GN`
- **AI摘要**: 基于企业大数据分析员工使用生成式AI的成熟度与影响因素
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法扎实，利用大厂海报数据分析，对AI应用管理具实用价值。

### 5. **[LLMs Can Design Near-Optimal OR Algorithms](https://arxiv.org/abs/2608.27296v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Jackie Baek
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 评估LLM设计运筹学算法的能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 评估全面且具有实用价值，方法稳健但缺乏理论突破。

## Natural Language Processing

### 1. **[Pair-Level Essay-Scale Republication and Reuse from Fragmented Historical Text Reuse: A Workflow Study on Eighteenth-Century Books and Newspapers](https://arxiv.org/abs/2608.27343v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Ke Shu, Kira Hinderks, Eetu Mäkelä et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出历史文本重用的配对证据整合工作流。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且实验扎实，但创新性相对一般。

### 2. **[Research Design Tracking and Assessment for the Social Sciences](https://arxiv.org/abs/2608.27049v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Marco Rovera, Sergiu Burlacu, Dominique Cappelletti et al.
- **标签**: `cs.CL` `cs.CY`
- **AI摘要**: 提出社科研究设计自动化追踪与评估任务及框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新任务有实用价值，评估全面但方法偏常规

### 3. **[Reasoning about In-Context Samples for Machine-Translation](https://arxiv.org/abs/2608.27036v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Maxime Bouthors, Josep Crego, François Yvon
- **标签**: `cs.CL`
- **AI摘要**: 提出片段式推理框架以提升机器翻译性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好且实验充分，但属于中规中矩的改进

### 4. **[Representing and Parsing Korean Constituency Structure at Different Levels of Granularity](https://arxiv.org/abs/2608.27035v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Jungyeul Park, KyungTae Lim, Zihao Huang et al.
- **标签**: `cs.CL`
- **AI摘要**: 评估韩语成分句法分析的不同粒度表示
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究系统且扎实，但创新性相对一般。

### 5. **[ITL: Interpretable Document Alignment with Structured Reference Frameworks](https://arxiv.org/abs/2608.27031v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Raúl Giráldez, Dayrelis Mena, Jesús S. Aguilar--Ruiz
- **标签**: `cs.CL`
- **AI摘要**: 提出可解释的文档对齐与结构化参考框架方法ITL
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且具实际价值，实验评估充分，表述清晰。

## Multimodal

### 1. **[How AI Experiences Art: Emergent Aesthetic Structure in a Self-Supervised Multimodal Embedding Space](https://arxiv.org/abs/2608.27121v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Corey D. C. Heath
- **标签**: `cs.MM` `cs.CV` `cs.LG`
- **AI摘要**: 自监督多模态嵌入空间中的美学结构发现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究新颖且具实用价值，方法及实验较为扎实

### 2. **[A Multi-Modal AI Framework for Real-Time Queue Prediction, Management and Optimisation in Intelligent Border Control Systems](https://arxiv.org/abs/2608.27010v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Varvara Mama, Eleni Veroni, Nikolaos Kapsalis et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出多模态AI边境排队预测与优化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性和实用性良好，但基于合成数据评估，严格度一般。

## Agent

### 1. **[SWE-Prime: Fewer Trajectories, Better Performance](https://arxiv.org/abs/2608.27449v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Dewu Zheng, Ruizhe Ye, Yanlin Wang et al.
- **标签**: `cs.SE` `cs.AI` `cs.CL`
- **AI摘要**: 提出SWE-Prime多粒度数据筛选方法，提升软件工程大模型效能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性两阶段筛选方法，实验扎实且实用性强，表述清晰。

### 2. **[Verify Smarter, Evolve Further: Efficient Harness Evolution through Behavior-Aware Verification](https://arxiv.org/abs/2608.27311v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Jinghan Xu, Yikai Zhang, Aili Chen et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出HarnessLens框架以高效演化智能体框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了长期精神健康智能体基准的空白

### 4. **[GRAIN: Bridging Name and Narrative Shifts in Real-World Graph Reasoning through Invariance-Rewarded Agentic RL](https://arxiv.org/abs/2608.27142v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Zike Yuan, Han Zhang, Jianzhi Yan et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出GRAIN框架提升大模型图推理鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入不变性奖励的强化学习，实验充分

### 5. **[GraphMemix: Query-Aware Evidence Forests for Long-Term Multimodal Agent Memory](https://arxiv.org/abs/2608.26983v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Geng Li, Yuhao Wang, Dong Li et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出图记忆框架GraphMemix优化多模态智能体长记忆
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验充分，具备良好的综合表现

## Distributed Computing

### 1. **[FoldPipe: Bounded Remote Streaming of Native Molecular Shards with Asynchronous Prefetch](https://arxiv.org/abs/2608.27029v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-27
- **作者**: Dhiren Mukesh Khatri
- **标签**: `cs.PF` `cs.LG`
- **AI摘要**: FoldPipe实现分子图数据异步预取流式传输。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作偏工程集成，创新与性能提升幅度有限，实验严谨但结果不确定。

## Information Retrieval

### 1. **[A Point-of-Prescription Safety-Check System for Adverse Drug Reactions in Rural Bangladeshi Hospitals: A Feasibility Study](https://arxiv.org/abs/2608.27239v1)**
- **评分**: ⭐ 72/100 | **日期**: 2026-08-27
- **作者**: Shahir Abdullah
- **标签**: `cs.HC` `cs.LG`
- **AI摘要**: 提出孟加拉国农村医院的轻量级药物不良反应检查系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题切合实际，方法可行，但属于可行性研究，验证尚在规划中。

## Computer Vision

### 1. **[KISS-GS: 3D Gaussian Splatting Compression Kept Simple](https://arxiv.org/abs/2608.26948v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Wieland Morgenstern, Friedrich Elias Branschke, Florian Fleischmann et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出模块化3DGS压缩方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解耦训练与压缩，效果显著但属改进路线

### 2. **[AraMS-28k: The Largest Publicly Released Line-Level Dataset of Historical Arabic Manuscripts with Margin and Insertion-Anchor Annotations](https://arxiv.org/abs/2608.26921v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Mohamed Guechaoui, Mohamed Diaa Zellagui, Souleyman Chaib et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 发布最大的阿拉伯手稿行级数据集AraMS-28k
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大且标注精细，方法坚实，实用性强

### 3. **[Property-Specific Recoverability from Contact PPG to Camera rPPG under Heterogeneous Observation Conditions](https://arxiv.org/abs/2608.27392v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Timothy Oladunni, Farouk Ganiyu-Adewumi
- **标签**: `eess.SP` `cs.AI`
- **AI摘要**: 评估相机rPPG信号恢复的属性特异性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入，分析全面，对rPPG领域有参考价值

### 4. **[Detection of Christmas tree plantations from high-resolution aerial imagery. A case study in the French Morvan](https://arxiv.org/abs/2608.27290v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Francesca Razzano, Emanuele Dalsasso, Adrien Baysse-Lainé et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出高分辨率遥感圣诞树种植园分割方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合困难负样本挖掘，实验评估充分

### 5. **[TADP: Task-Aware Deformable Prediction for Single-Stage 3D Object Detection](https://arxiv.org/abs/2608.27282v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Su Wang, Yaochen Li, Min Yang et al.
- **标签**: `cs.CV` `cs.AI` `cs.RO`
- **AI摘要**: 提出任务感知可变形预测方法用于3D目标检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有创新，实验充分，达到了先进水平

## Machine Learning

### 1. **[Soft Active Electromyography Interface for Machine Learning-Enabled Silent Speech Recognition](https://arxiv.org/abs/2608.27048v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Yuta Kurotaki, Shusuke Yamakoshi, Reitaro Yoshida et al.
- **标签**: `cs.LG` `cs.HC` `cs.SD`
- **AI摘要**: 提出软体肌电接口实现静默语音识别
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较强，应用潜力好，实验严谨且表达清晰。

### 2. **[Beyond F1: Evaluating Coverage and Failure Recovery in AI Model Security Scanners](https://arxiv.org/abs/2608.27424v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Qianlong Lan, Vinothini Pandurangan, Anuj Kaul et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 评估AI安全扫描器的覆盖率与恢复能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨且实用，但属于评估方向的增量创新

### 3. **[Learning a Continuous Sepsis Severity Score Without Hour-by-Hour Supervision: A Two-Site Retrospective Study](https://arxiv.org/abs/2608.27421v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Kevin Zhu, Ryan Zhang, Baraa Abed et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出一种基于轨迹学习的连续脓毒症严重程度评分
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有创新且多中心验证扎实，但实用性仍需临床进一步证实。

### 4. **[Making Latent Evolution Explicit: Operator-Structured Transitions for World Action Models](https://arxiv.org/abs/2608.27259v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Xiaoxiao Lu, Yunlong Dong, Jiahao Shi et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出LEON算子结构化潜空间演化模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，实验扎实，但领域局限在机器人世界模型。

### 5. **[Profit based evaluation of machine learning for nitrogen recommendations in winter wheat](https://arxiv.org/abs/2608.27205v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Xulong Wang, Po Yang
- **标签**: `cs.LG`
- **AI摘要**: 机器学习用于冬小麦施氮应基于利润评估。
<details>
<summary>原始摘要</summary>
