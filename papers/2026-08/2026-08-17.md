...
### 1. **[You Only Pass Once: Answering and Abstaining Together in a Single Forward Pass of a Frozen Language Model](https://arxiv.org/abs/2608.14465v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-08-14
- **作者**: Ziyang Luo, Zhongyao Chu, Xinjie He et al.
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出YOPO实现冻结大模型单次前向的推理与拒答
<details>
...
- **评分理由**: 方法创新有效，实验详实，显著提升单通性能

### 2. **[KV Cache Compression Through the Lens of Transform Coding](https://arxiv.org/abs/2608.14191v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-14
- **作者**: Hannah Laus, Claudio Mayrink Verdun, Hao Wang et al.
- **标签**: `cs.LG` `cs.CL` `eess.SP`
- **AI摘要**: 提出AATC方法实现KV缓存压缩
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论与实验扎实，带来显著压缩性能提升。

### 3. **[Whose doctor does the AI recommend? An algorithm audit of reputation and demographic signals in large language model-assisted physician choice](https://arxiv.org/abs/2608.14399v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-14
- **作者**: Syeda Anshrah Gillani, Mirza Samad Ahmed Baig
- **标签**: `cs.CY` `cs.AI` `cs.CL`
- **AI摘要**: 评估大模型推荐医生时的算法偏见
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究严谨且具实用价值，新颖性一般

### 4. **[Tripwire: Triggering Aligned Refusal via Statistically Certified Safety Neurons](https://arxiv.org/abs/2608.14392v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-14
- **作者**: Wei Zhao, Zhe Li, Peixin Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出Tripwire方法，通过统计认证的安全神经元触发对齐拒绝
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，实验扎实，有效平衡了模型安全与效用

### 5. **[Intern-S2-Mobius: Foundation Model with Decoupled Knowledge and Reasoning](https://arxiv.org/abs/2608.14290v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Kai Chen, Jifeng Ding, Ning Ding et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出解耦知识与推理的Mobius架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新显著且推理加速明显，但实验验证仍需深入

## Natural Language Processing

### 1. **[Information Satisfaction: A Reader-Centered Axis for Summarization Evaluation](https://arxiv.org/abs/2608.14457v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Isabel Cachola, William Walden, Reno Kriz et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出以读者为中心的信息满意度摘要评估新轴线。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且评估严谨，对传统摘要指标缺陷分析深入。

### 2. **[How Much Do Legal RAG Systems Still Hallucinate?](https://arxiv.org/abs/2608.14210v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
...
- **评分理由**: 研究细致但属于特定领域的应用评估

## Vision Language Models

### 1. **[FIRM: Fine-Grained Intra-Token Representation of Masks for Remote Sensing Reasoning Segmentation](https://arxiv.org/abs/2608.13980v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-14
- **作者**: Weidong Tang, Kaiyu Li, Yikai Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出FIRM方法解决遥感推理分割中视觉标记内部空间结构丢失问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入亚单元掩码表示，实验充分，效果显著。

### 2. **[Self-Supervised Visual On-Policy Distillation](https://arxiv.org/abs/2608.14144v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-14
- **作者**: Yijiang Li, Yijun Liang, Yunjie Tian et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出无特权信息的自监督视觉策略蒸馏方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖有效，实验充分，显著提升多模态模型性能

### 3. **[Reflex: Enabling Fast and Predictive Vision-Language-Action Models for Reaction-Critical Manipulation](https://arxiv.org/abs/2608.14379v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Yuxuan Chen, Wanruo Zhang, Xiao Li
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出反应用途的VLA模型与评测基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补动态操作基准空白，方法创新且实验详实

### 4. **[AlignFace: Human-Aligned Face Similarity Metric with Interpretable Concept Relations](https://arxiv.org/abs/2608.14130v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Ying Huang, Wencan Zhang, Brian Y. Lim
- **标签**: `cs.MM` `cs.AI` `cs.CV`
- **AI摘要**: 提出对齐人类认知的可解释人脸相似度度量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新融合认知心理学与VLM，提升人脸评估对齐度

### 5. **[AdvDex: Learning Dexterous Manipulation from Human Demonstrations via Joint-Aligned Actions and Adversarial Learning](https://arxiv.org/abs/2608.14028v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Zhiyue Zhao, Jingyi Wu, Hairuo Liu et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出AdvDex实现跨具身灵巧手操控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，实验扎实，写作清晰

## Diffusion Models

### 1. **[Designing Reinforcement Learning for Diffusion Models: A Unified Path-Space View](https://arxiv.org/abs/2608.14430v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Yixian Xu, Yuanrui Zhang, Shengjie Luo et al.
- **标签**: `cs.LG` `cs.CV` `stat.ML`
- **AI摘要**: 统一扩散模型强化学习的路径空间视角与方差减小框架
<details>
<summary>原始摘要</summary>
...
### 3. **[Program-space Diffusion for Morphology-to-Transcriptomics Prediction](https://arxiv.org/abs/2608.14330v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Ruyter Swann, Dorent Reuben, Racoceanu Daniel
- **标签**: `cs.AI`
- **AI摘要**: 提出用扩散模型预测空间转录组学
<details>
<summary>原始摘要</summary>
...
### 4. **[When Denoising Hurts: Rethinking the Terminal Step of Diffusion Time Series Forecasters -- Extended Version](https://arxiv.org/abs/2608.14067v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Dat Nguyen-Cong, Luong Tran, Tung Kieu
- **标签**: `cs.LG`
- **AI摘要**: 揭示扩散时序预测中降噪反害现象并提出早停策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实用，实验充分但创新幅度中等

### 5. **[Adversarial Learning of Classifier-Free Guidance Schedules](https://arxiv.org/abs/2608.14038v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Ashwini Pokle, Alexandre Galashov, Arnaud Doucet et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出了对抗学习指导尺度的动态调整方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖有效，实验充分，具备较高实用价值

## Multimodal

### 1. **[SPARGen: Unifying Spatial Perception and Reasoning through Native Multimodal Generation](https://arxiv.org/abs/2608.14138v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Jinsheng Quan, Jianhua Li, Siyi Xie et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出了统一的空间感知与推理多模态生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，多任务统一框架验证充分，表述清晰

### 2. **[HAM-RAG: Hierarchy-Aware Multimodal RAG for Structure-Faithful Interleaved Generation](https://arxiv.org/abs/2608.14032v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Yin Li, Ziyang Hu, Zhiyu Guo et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 提出层级感知的多模态检索增强生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点明确且基准测试扎实，应用价值较高

### 3. **[Disentangled Shared Representations Improve Morpho-Transcriptomic Integration](https://arxiv.org/abs/2608.14355v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Julian Ostermaier, Swann Ruyter, Reuben Dorent et al.
- **标签**: `cs.AI`
- **AI摘要**: 解耦共享表征提升空间转录组多模态整合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有创新，评估全面，但在部分任务上增益有限

### 4. **[Spatial Message Passing in Language Space for Pathology Image Interpretation](https://arxiv.org/abs/2608.14309v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Jing-Cheng Yang, Hao-Jung Wang, Jinhao Du et al.
- **标签**: `cs.CV` `q-bio.TO`
- **AI摘要**: 提出空间语言消息传递框架以提升病理图像解释
<details>
<summary>原始摘要</summary>
...
### 5. **[MINT: A Universal Zero-Shot Predictor for Transaction Data](https://arxiv.org/abs/2608.14198v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Parameswaran Kamalaruban, Viktor Drobnyi, Maeve Madigan et al.
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出MINT模型实现零样本金融交易预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合交易编码器与LLM，实验全面且实用性强。

## Image Generation

### 1. **[CRAFT: Constrained Reward via Attention Fine-Tuning for Subject Personalization without Composed Targets](https://arxiv.org/abs/2608.14403v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-14
- **作者**: Jihun Park, Kyoungmin Lee, Jongmin Gim et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CRAFT实现免合成目标的主体个性化微调
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实用，实验充分，行文清晰。

### 2. **[Concept Guidance: Precise, Training-Free Latent Control for Text-to-Image Generation](https://arxiv.org/abs/2608.14172v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-14
- **作者**: Nikolai Röhrich, Isabell Hans, Felix Krause et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出无训练的概念引导方法以精准控制文生图模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性和实用性强，实验充分，方法严谨清晰

### 3. **[From Style Replication to Style Exploration: Enabling Art Style Exploration with Analyze-Experiment-Resituate Framework](https://arxiv.org/abs/2608.14405v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Wen-Fan Wang, TsaiHsuan Lin, Chi-Lan Yang et al.
- **标签**: `cs.HC` `cs.AI`
- **AI摘要**: 提出AER框架助力数字艺术家进行AI辅助的艺术风格探索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究扎实且具有实际应用价值，创新性较好但范畴偏垂直。

## Video Generation

### 1. **[InstructVVT: Instruction-Driven Video Virtual Try-On without Auxiliary Spatial Priors](https://arxiv.org/abs/2608.14070v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-14
- **作者**: Dingbao Shao, Song Wu, Xinyu Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出无辅助先验的指令式视频虚拟试穿框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实验扎实，推进了视频生成技术

### 2. **[ForgeWM: Progressive Causal Training for Few-Step Action-Conditioned Video World Models](https://arxiv.org/abs/2608.14022v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-14
- **作者**: Xinye Li, Lingshuai Lin, Lei Wang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出了ForgeWM实现高效几步动作条件视频世界模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合因果蒸馏与对齐，实验充分但在严谨性上略有不足
...
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出Marionette世界模型，分离状态与外观生成以提长效一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合神经状态预测与固定渲染器，实验充分但范围较窄

### 4. **[Can We Defend Against AI-Generated Video Attacks on Real-World Crisis Events? A Systematic Evaluation of Detectors, Generators and Social Dissemination](https://arxiv.org/abs/2608.14391v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Shuo Liang, Yixing Ma, Pengfei Zhou et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出RA-Bench以评估AI生成视频检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统研究了MLLM与DiT融合方案，实验充分且有效。

## Agent

### 1. **[ScienceFlow: A long-horizon agent for ML research, scientific discovery and beyond](https://arxiv.org/abs/2608.14354v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-14
- **作者**: Mingming Zhao, Jiqian Dong, Kangping Xu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ScienceFlow长周期科学研究智能体框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 长周期研究智能体创新显著，状态管理方法有效，实验极具说服力。

### 2. **[AgilePE: Autonomous UAV Pursuit-Evasion via Self-Play Reinforcement Learning](https://arxiv.org/abs/2608.14135v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-14
- **作者**: Wenhao Tang, Tianyang Chen, Zhejun Cui et al.
- **标签**: `cs.RO` `cs.LG`
- **AI摘要**: 提出基于自博弈强化学习的无人机追逃系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性采用自博弈与端到端控制，sim-to-real效果好。

### 3. **[Envs-FORGE: Frontier-Optimized Reward-Grounded Environment Synthesis for Agent RL](https://arxiv.org/abs/2608.14312v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-14
- **作者**: Xiaojun Wu, Cehao Yang, Honghao Liu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出Envs-FORGE方法提升智能体RL训练环境合成质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新严谨，实验充分，显著提升智能体性能。

### 4. **[HERMES: a multi-agent framework for structured knowledge extraction from ultra-long documents in geoscience](https://arxiv.org/abs/2608.14055v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-14
- **作者**: Ziqi Song, Zongyuan Xiang, James G. Ogg et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出HERMES多智能体框架提取超长地学文献结构化数据
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性与实用性均高，评估严谨，跨领域泛化能力较强

### 5. **[Expected Free Energy-based Informative Path Planning for Robotic Mars Exploration](https://arxiv.org/abs/2608.14466v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Ajith Anil Meera, Pablo Lanillos, Wouter Kouw
- **标签**: `cs.RO` `cs.IT` `cs.LG`
- **AI摘要**: 提出基于期望自由能的火星机器人信息路径规划方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合主动推断，实验验证充分，实用性强

## Distributed Computing

### 1. **[Rollplex: Cross-Phase GPU Spatial Sharing for Vision Language Model Post-Training](https://arxiv.org/abs/2608.14498v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-14
- **作者**: Hanfeng Lu, Tianyu Feng, Suyi Li et al.
- **标签**: `cs.LG` `cs.DC`
- **AI摘要**: 提出Rollplex跨阶段GPU空间共享运行时
<details>
<summary>原始摘要</summary>
...
### 2. **[FreeBalance: Pre-Routing Online Moe Load Balancing via Residual Workload Prediction](https://arxiv.org/abs/2608.14205v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-14
- **作者**: Pengfei Chen, Yize Wu, Shouxu Kuang et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出FreeBalance以解决MoE在线负载不均衡
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实用性强，实验充分，行文清晰。

### 3. **[Large-scale workflow placement in serverless computing using integer nonlinear programming](https://arxiv.org/abs/2608.14427v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Joshua Adamek, Natalie Carl, Trever Schirmer et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出无服务器边缘计算的工作流部署非线性整数规划模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型创新与实验充分，但属于传统优化领域，影响力适中。

### 4. **[Designing Sustainable Federated Learning as a Service using Neural Architecture Search](https://arxiv.org/abs/2608.14359v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Keya Patel, Sajib Mistry, Sheik Fattah et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出面向碳约束的联邦学习即服务架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合神经架构搜索与碳约束调度，方法新颖且实验充分

### 5. **[Sensor-Driven Mission Synthesis for UAV/UGV Swarms: A TB-CSPN Coordination Architecture with Hardware-Enforced Safety](https://arxiv.org/abs/2608.14306v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Uwe M. Borghoff, Paolo Bottoni, Remo Pareschi
- **标签**: `cs.AI` `eess.SY`
- **AI摘要**: 提出无人蜂群传感器驱动的协同与安全架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，验证较为充分，结构清晰

## Information Retrieval

### 1. **[Retrieval Grounding Latent Reasoning for Dense Retrieval](https://arxiv.org/abs/2608.14107v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Gang Zhou, Xiongxi Yu, Hu Tian et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出RGLT框架改善密集检索中的潜在推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，实验扎实，但属于特定任务的改进

### 2. **[Rewrite Once, Validate Anywhere: Producing OWL-Aware SHACL Constraints (Extended Version)](https://arxiv.org/abs/2608.14104v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Anouk Oudshoorn, Piotr Gorczyca, Dörthe Arndt
- **标签**: `cs.LO` `cs.AI`
- **AI摘要**: 提出了将OWL公理内化至SHACL约束的重写方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用，实验扎实，逻辑清晰

### 3. **[S2Dialog: Multimodal Dialogue Retrieval with Semantic and Acoustic-Style Modeling](https://arxiv.org/abs/2608.14029v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Xueqi Wang, Zhigang Wang, Runqing Zhang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出了多模态对话检索框架S2Dialog
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实验充分，检索任务实用

### 4. **[Residual Dominance as a Structural Account of Last-Item Reliance in Causal Self-Attention Recommenders](https://arxiv.org/abs/2608.14021v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Keito Kozaki, Keigo Sakurai, Ren Togo et al.
- **标签**: `cs.AI` `cs.IR`
- **AI摘要**: 揭示因果自注意力推荐器中残差占优导致末项依赖的结构成因
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入，分析严谨，对推荐系统机制有较好洞察

### 5. **[EchoRec: Multi-Item Prediction-Empowered Generative Recommendation via Cycle-Consistent Preference Alignment](https://arxiv.org/abs/2608.14011v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-14
- **作者**: Haokai Ma, Aoqi Hu, Yueao Xing et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 提出EchoRec生成式推荐算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实验完整，推荐领域改进显著

## Computer Vision

### 1. **[TRIAGE: Risk-Controlled Pseudo-Label Admission for Annotation-Efficient Semi-Supervised Retinal OCT Classification](https://arxiv.org/abs/2608.14321v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-14
- **作者**: Md Ashraful Hossen Akash, Shyla Afroge, Abdullah Al Mamun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出OCT半监督分类风控框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性和实用性强，实验充分，结构清晰

### 3. **[GhostPoint: Self-Supervised Representation Learning by Hallucinating Occluded LiDAR Structure](https://arxiv.org/abs/2608.14428v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Mohamed Abdelsamad, Bin Yang, Michael Ulrich et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GhostPoint自监督学习方法，利用幻觉机制恢复LiDAR遮挡结构以提升3D检测性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点明确且在nuScenes和Waymo上验证充分，对3D检测有实用价值

### 4. **[QuaSAR: Quantization Compensation via Stable Activation-Aware Rank Truncation](https://arxiv.org/abs/2608.14149v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Lin-Fa Lee, Yi-Yu Chang, Kuo-Hei Yeh
- **标签**: `cs.AI` `cs.CR`
- **AI摘要**: 提出QuaSAR量化补偿方法，提升低比特定位精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖稳定求解器解决量化误差，实验充分提升明显

### 5. **[CoDS: Robust Collaborative Perception via Expert-driven Detection and BEV Segmentation](https://arxiv.org/abs/2608.14085v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Jinlong Wang, Yuang Jia, Junhong Lin et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出多智能体协同感知鲁棒框架CoDS
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点良好，实验充分，写作清晰，具实际应用价值。

## Machine Learning

### 1. **[MathForm: Scaling Mathematical Autoformalization with Knowledge Retrieval and Verification-Guided Refinement](https://arxiv.org/abs/2608.14221v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-14
- **作者**: Lushi Pu, Weiming Zhang, Xinheng Xie et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出了MathForm自形式化框架与FormalVerse数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合检索与验证求精，实验充分且性能优异

### 2. **[Reaction-Transformation-Aware Flow Matching for Generalizable Transition State Generation](https://arxiv.org/abs/2608.14076v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-14
- **作者**: Kaipeng Zeng, Wenxi Zhai, Shengrui Xu et al.
- **标签**: `physics.chem-ph` `cs.AI`
- **AI摘要**: 提出TransTS实现可泛化的过渡态生成
<details>
<summary>原始摘要</summary>
...
### 3. **[Catching the Imposter: Self-Supervised Learning of Physical Coherence with Cross-Entity Feature Permutations](https://arxiv.org/abs/2608.14372v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Aleksei Rozanov, Arvind Renganathan, Vipin Kumar
- **标签**: `cs.LG`
- **AI摘要**: 提出物理相干性自监督学习方法IMPOSTER
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且实验充分，科学领域应用价值高

### 4. **[Structure-Guided Spatiotemporal Attention Graph Neural Network for Traffic Flow Prediction](https://arxiv.org/abs/2608.14177v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Xuanmian He, Can Li, Wanjing Ma
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出结构引导的时空注意力图神经网络用于交通预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合静态图与注意力机制，实验扎实且具可解释性

### 5. **[BGA: A noise-immune neural distillation framework for malicious signature extraction in high-entropy encrypted flows](https://arxiv.org/abs/2608.14126v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Sheng Hong, Yixuan Huang, Weiwei Jiang et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出BGA框架用于加密流恶意签名提取
<details>
<summary>原始摘要</summary>
