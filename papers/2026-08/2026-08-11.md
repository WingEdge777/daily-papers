...
- **评分**: ⭐ 83/100 | **日期**: 2026-08-10
- **作者**: Alexander Panfilov, David Schmotz, Ilia Shumailov et al.
- **标签**: `cs.CR` `cs.AI` `cs.LG`
- **AI摘要**: 揭示LLM加密推理轨迹的安全漏洞
<details>
...
- **评分理由**: 研究新颖且具高安全实用价值，论证详尽严密。

### 2. **[Learning Preference Adaptation for Large Language Model Personalization via Verbal Reinforcement Learning](https://arxiv.org/abs/2608.09507v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-10
- **作者**: Yuting Liu, Wei Wu, Jianzhe Zhao et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出AlignXada框架实现LLM个性化偏好自适应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实验充分，实用价值高。

### 3. **[Avalon-ToM-Bench: Evaluating Fine-Grained Theory of Mind via Asymmetric Game Mechanics](https://arxiv.org/abs/2608.09638v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-10
- **作者**: Yen-Shan Chen, Yu Chian Duan, Chih-En Kuo et al.
- **标签**: `cs.AI` `cs.CL` `cs.CY`
- **AI摘要**: 提出评估LLM心智理论的Avalon-ToM-Bench基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的多人博弈心智评估基准，实验严谨且洞察深入

### 4. **[Depth-adaptive Inference of Looped Language Models via Continuous Depth Batching](https://arxiv.org/abs/2608.09444v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-10
- **作者**: Kristian Schwethelm, Daniel Rueckert, Georgios Kaissis
- **标签**: `cs.LG` `cs.CL` `cs.DC`
- **AI摘要**: 提出连续深度批处理技术实现循环大模型的高效自适应推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决自适应循环模型的推理调度难题，实用性强且实验扎实。

### 5. **[Mismatch Matters: On-Policy Distillation Beyond Token Agreement](https://arxiv.org/abs/2608.09836v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Zichao Yu, Chengzhi Yu, Shengze Xu et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出TIDE方法解决大模型在线蒸馏中的错配问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 分析深入且实验充分，提升了在线蒸馏性能。

## Natural Language Processing

### 1. **[VeriForge: Mitigating Latent Knowledge Gaps in Narrative Drafting via Mixed-Initiative Scaffolding](https://arxiv.org/abs/2608.09698v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Ruqi Sun, Jiaping Li, Wenhui Tao et al.
- **标签**: `cs.HC` `cs.CL`
- **AI摘要**: 提出混合作业系统VeriForge以辅助小说创作
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合了用户研究与新颖的RAG系统，方法扎实但领域较垂直。

### 2. **[CARD: Controlled Agentic Reddit Discussions for Credit Card Simulation](https://arxiv.org/abs/2608.09790v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Yaoning Yu, Kai-Min Chang, Ye Yu et al.
- **标签**: `cs.AI` `cs.MA` `cs.SI`
- **AI摘要**: 提出CARD框架用于模拟真实的信用卡Reddit讨论
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的多智能体控制策略，实验严谨且表现优异

### 3. **[KGCaRe: Explainable Complex Conditional Question Answering using Automatic Knowledge Graph Construction and Context Retrieval with LLMs](https://arxiv.org/abs/2608.09779v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Ghanshyam Verma, Simanta Sarkar, Devishree Pillai et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出结合知识图谱与RAG的复杂条件问答模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新融合图检索与大模型，实验充分但应用较为垂直

### 4. **[Cultivar: A Contrastive and Locale-Oriented Translation Benchmark for Investigating Contamination and Localisation Robustness](https://arxiv.org/abs/2608.09766v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Pinzhen Chen, Koel Dutta Chowdhury, Xiaoya Xu et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出Cultivar基准用于评估翻译模型的污染与本地化鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖实用，实验全面，行文清晰。

### 5. **[MDB-Link: Hierarchical Schema Linking for Multi-Database Text-to-SQL](https://arxiv.org/abs/2608.09588v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Beiyu Xu, Zhenyu Wu, Jiaoyan Chen et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出多数据库层次化模式链接框架
<details>
<summary>原始摘要</summary>
...
### 2. **[MedPixel: A Unified Pixel-Language Model for Medical Reasoning and Segmentation](https://arxiv.org/abs/2608.09818v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-10
- **作者**: Haoyu Yang, Meixing Shi, Zengjie Chen et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出统一的医学像素语言模型MedPixel
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且数据完整，具备较强临床实用价值。

### 3. **[LookAgain: Closed-Loop GUI Grounding with Visually Grounded Reflection](https://arxiv.org/abs/2608.09723v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-10
- **作者**: Renshan Zhang, Haoyang Meng, Yixiao He et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出闭环GUI定位框架LookAgain实现视觉反思修正
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入闭环反思机制，实验充分，实用性强。

### 4. **[Thinking With Tools, Not With Pixels: Tool Calls as Text Scaffolds for Visual Reasoning](https://arxiv.org/abs/2608.09682v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-10
- **作者**: Jiahao Shao, Yuanbo Yang, Yiyi Liao et al.
- **标签**: `cs.CV`
- **AI摘要**: 证明视觉推理中工具调用的文本支架优于像素反馈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出文本支架假设并经实验验证，实用且严谨。

### 5. **[FactorDrive: Adaptive Multi-Step Reasoning Driven by Planning-Critical Factors for End-to-End Autonomous Driving](https://arxiv.org/abs/2608.09591v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-10
- **作者**: Guolei Huang, Tengfei She, Yuxuan Lu et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出FactorDrive实现端到端自动驾驶自适应多步推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合规划关键因素与MCTS强化学习，实验充分且性能领先。

## Diffusion Models

### 1. **[DiffSafeMerge: Mitigating Backdoor Inheritance in Diffusion Model Merging](https://arxiv.org/abs/2608.09445v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Jiayang Zhang, Ji Guo, Jiachen Li et al.
- **标签**: `cs.CR` `cs.CV`
- **AI摘要**: 提出DiffSafeMerge防御扩散模型后门继承
<details>
<summary>原始摘要</summary>
...
### 2. **[Reducing Pretraining-Generation Mismatch in Diffusion Language Models](https://arxiv.org/abs/2608.09424v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Xiaocheng Lu, Huabin Liu, Song Guo et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出PCD目标以减少扩散语言模型的预训练与生成不匹配。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且有效，实验扎实，写作清晰。

## Multimodal

### 1. **[Towards Expert-level Medical AI for Real-time Video Consultations](https://arxiv.org/abs/2608.09861v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-10
- **作者**: Mahvish Nagda, Jihyeon Lee, Matthew Thompson et al.
- **标签**: `cs.AI` `cs.CL` `cs.CV`
- **AI摘要**: 提出了实现专家级医疗AI的实时视频问诊系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性高且评估严谨，但仍需医疗现实转化研究

### 2. **[Listen, See and Track: Spatio-Temporal Audio-Visual Sound Event Reasoning for Omni-Modal Language Models](https://arxiv.org/abs/2608.09435v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-10
- **作者**: Zhi Zeng, Cheng Zhang, Zesheng Yang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出声学时空推理基准与Omni-R1模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性高且实验扎实，但领域垂直属于小众前沿

### 3. **[Beyond Naturalness: Probing Automated Text-To-Speech Evaluators on Linguistically Grounded Dimensions](https://arxiv.org/abs/2608.09930v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Oluwanifemi Bamgbose, Simon Rosen, Jash Shah et al.
- **标签**: `cs.SD` `cs.AI` `cs.CL`
- **AI摘要**: 提出TTS多维评估基准与数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作扎实且具应用价值，但方法创新性略显常规

### 4. **[REFRAMED: Towards Realistic Audio Description Generation for Movies](https://arxiv.org/abs/2608.09765v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Igor Sterner, Mirella Lapata, Alex Lascarides et al.
- **标签**: `cs.CL` `cs.CV`
- **AI摘要**: 提出真实影视音频描述数据集REFRAMED
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且任务实用，实验严谨，写作清晰。

### 5. **[Deep Multimodal Wearable Sensor Fusion for Detection of Body-Focused Repetitive Behaviors](https://arxiv.org/abs/2608.09830v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Samaneh Rezaeimanesh, Mohsen Behradfar, Mohammad Fili et al.
- **标签**: `cs.LG`
- **AI摘要**: 多模态可穿戴传感检测重复行为
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较强且实用，实验扎实，写作清晰

## Image Generation

### 1. **[Towards Expressive and Faithful Audio-to-Image Generation: A Unified Multimodal Dataset and Synthesis Framework](https://arxiv.org/abs/2608.09529v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Dongxu Ge, Shansong Liu, Cheng Gong et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出音频到图像数据集与生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集与模型创新，实验充分，实用性较好

### 2. **[Unveiling the Secret of AdaLN-Zero in Diffusion Transformer](https://arxiv.org/abs/2608.09438v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Jie Zhu, Mingyu Ding, Boqiang Duan et al.
- **标签**: `cs.CV`
- **AI摘要**: 揭示DiT中adaLN-Zero机制并提出改进
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 分析深入且实验充分，具有较好的实用价值。

### 3. **[Imaginative Generative AI: Crossing the Entropy Wall into Worlds Beyond Imitation](https://arxiv.org/abs/2608.09385v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
...
- **评分理由**: 方法新颖高效，物理外推实验严谨充分

### 2. **[Sci-VBench: Evaluating Knowledge- and Reasoning-Intensive Video Generation in Science Domains](https://arxiv.org/abs/2608.09873v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Diandian Zhang, Tingyu Song, Lin Fu et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出了科学领域视频生成基准Sci-VBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基准全面且评估严谨，但属于评测类工作，创新性中等

### 3. **[DUET: A Diversity-Quality Duet of Distillation Experts for Two-Step Video Generation](https://arxiv.org/abs/2608.09637v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Zian Li, Litong Gong, Borui Liao et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出DUET方法实现两步视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合双范式，实验和方法设计较扎实。

### 4. **[Illusion or Integrity? Geometrical Consistency Metric for AIGC Video Quality Evaluation](https://arxiv.org/abs/2608.09594v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Yifei Xue, Yuanchen Fei, Hao Zhang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出评估AIGC视频几何一致性的新指标
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补物理规律评估空白，方法合理但应用局限。

### 5. **[Sekai2: From World Exploration to Interactive World Modeling](https://arxiv.org/abs/2608.09449v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Kang He, Wenshuo Peng, Zihui Gao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Sekai2视频世界模型数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大且标注全，对视频生成具较高价值

## Agent

### 1. **[Hallucination-Free GUI Grounding via Regression-Free Layout-Aware Matching](https://arxiv.org/abs/2608.09654v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-10
- **作者**: Yuke Li, Xuehan Hou
- **标签**: `cs.AI`
- **AI摘要**: 提出无回归布局感知GUI定位框架
<details>
<summary>原始摘要</summary>
...
### 3. **[Coupled Graph--Policy Distillation for Personalized Medication Safety in Older Adults with Multimorbidity](https://arxiv.org/abs/2608.09443v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-10
- **作者**: Zihan Wang, Anglin Liu, Rongyi Wang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ATLAS框架用于老年多病共存患者的个性化用药安全
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合图与策略蒸馏，实验扎实且临床价值高。

### 4. **[Rethinking Self-Evolving Agents: Do We Still Need Prescribed Optimization Pipelines?](https://arxiv.org/abs/2608.09629v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Hui Xue, Fan Yang
- **标签**: `cs.AI`
- **AI摘要**: 提出开放式优化替代预设流水线
...
- **评分理由**: 实验全面且新颖，展现出极高的实用价值

### 5. **[The Politician, the Liar, and the Obedient Worker: Emerging Behavior of LLM Agents in Hierarchical Games](https://arxiv.org/abs/2608.09574v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Fatemeh Seyedin, Adrian Weller, Jinhyuk Yun et al.
- **标签**: `cs.AI`
- **AI摘要**: 探究LLM智能体在等级博弈中的政治与治理行为
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实验充分，具有较高的多智能体社会学研究价值

## Distributed Computing

### 1. **[Defining Decentralization: An Ontological Perspective](https://arxiv.org/abs/2608.09748v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Jakub Kacper Szeląg, Aydin Abadi, Mohammad Naseri
- **标签**: `cs.DC` `cs.AI` `cs.LG`
- **AI摘要**: 提出了去 decentralization 的本体论框架与新指标
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补概念空白，逻辑严密，具有较高实用价值

### 2. **[FedOrbit: Adaptive Personalized Federated Learning for Non-IID LEO Satellite Constellations](https://arxiv.org/abs/2608.09687v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Satwat Bashir, Tasos Dagiuklas, Muddesar Iqbal
- **标签**: `cs.LG`
- **AI摘要**: 提出联邦学习算法以解决卫星网络数据异质性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新结合轨道特征与分层聚合，实验充分

### 3. **[SpSYRK: Half the Work in Distributed Sparse Matrix Multiplication](https://arxiv.org/abs/2608.09713v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Thomas McFarland, Julian Bellavita, Giulia Guidi
- **标签**: `cs.DC`
- **AI摘要**: 提出分布式稀疏SYRK算法，显著提升计算效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用对称性优化分布式稀疏矩阵乘法，性能好且应用广泛

### 4. **[Distributed Optimization with Streaming Data: A Temporal Weighting Perspective](https://arxiv.org/abs/2608.09565v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
...
### 5. **[$\tilde{\text{O}}$ptimal Distributed Maximum Flow Approximation in Undirected Planar Graphs](https://arxiv.org/abs/2608.09500v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Yaseen Abd-Elhaleem, Michal Dory, Oren Weimann
- **标签**: `cs.DC` `cs.DS`
- **AI摘要**: 提出无向平面图最大流分布式近似算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破前人限制，算法设计严谨且具实用价值

## Information Retrieval

### 1. **[MetaStrategy: Generative Ranking with Executable LLM Strategies](https://arxiv.org/abs/2608.09440v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-10
- **作者**: Chengyu Lai, Jiuning Lin, Zhibo Xiao et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出MetaStrategy生成式排序框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业界落地效果显著，方法创新且严谨

### 2. **[Temporal Misgrounding in Legal RAG: A Versioned-Corpus Benchmark for French Tax Law](https://arxiv.org/abs/2608.09393v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-10
- **作者**: Rose Cymbler, Daniel Guez, Laurent Fabre
- **标签**: `cs.CL` `cs.AI` `cs.IR`
- **AI摘要**: 提出法务RAG时序错配基准，解决法律多版本检索难题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对法律检索时序问题提出新基准与方案，创新性强，评估严谨。

### 3. **[CoRCi: Cross-Reconstruction of Coherent Interests Modeling in Cross-Domain Sequential Recommendation](https://arxiv.org/abs/2608.09580v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Qingtian Bian, Tieying Li, Marcus de Carvalho et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出CoRCi跨域推荐模型，提升兴趣一致性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，属于扎实的改进研究。

### 4. **[Adaptive Semantic Capacity Allocation for Parallel Generative Recommendation](https://arxiv.org/abs/2608.09685v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
- **作者**: Chenxi Li, Yuchen Lu, Xu Yang
- **标签**: `cs.AI`
- **AI摘要**: 提出InforID框架实现并行生成推荐的自适应语义容量分配。
<details>
<summary>原始摘要</summary>
...
### 5. **[Listwise Cross-Encoder Fine-Tuning vs. Agentic Instruction Tuning for LLM Rerankers: A Systematic Study in Medical Procedure Reranking](https://arxiv.org/abs/2608.09650v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-10
...
- **评分理由**: 系统对比了交叉编码器与智能体微调，实验充分。

## Computer Vision

### 1. **[Beyond Hazard Resemblance: Contrastive Event Adjudication for Training-Free Video Anomaly Detection](https://arxiv.org/abs/2608.09908v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Wenti Yin, Xiang Wang, Huaxin Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出零样本视频异常检测对比裁决方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较强，实验充分，取得了很好效果

### 2. **[C$^2$A: Coupling Spatial Evidence with Clinical Priors via Co-occurrence Aware Class Attention for Multi-Label Chest X-Ray Classification](https://arxiv.org/abs/2608.09774v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Akash Gogineni, Nagur Shareef Shaik, Aasrith Mandava et al.
- **标签**: `cs.CV` `cs.LG` `eess.IV`
- **AI摘要**: 提出C2A分类头用于胸片多标签分类
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合空间证据与临床先验，方法合理且效果显著。

### 3. **[NeuroRefiner: Morphology-Aware Multi-Agent Refinement for 3D Fluorescence Microscopy Neuron Segmentation](https://arxiv.org/abs/2608.09636v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Haiyang Yan, Jinyue Guo, Yanchao Zhang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出神经元3D分割多智能体精炼系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新实用，实验充分，领域针对性强

### 4. **[MSP-Net: Manifold-Guided Spectral Prompt Network for Hyperspectral Object Tracking](https://arxiv.org/abs/2608.09575v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Juliu Li, Hanlin Qin, Shuowen Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出流形引导的光谱提示网络实现稳健的高光谱跟踪
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且跨传感器性能好，实验充分，结构清晰

### 5. **[GeoRoute: Geometry-Aware Hybrid Inference for Traffic Future-Frame Prediction](https://arxiv.org/abs/2608.09493v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-10
- **作者**: Khang Minh Le, Hieu Dinh Trung Pham, Luu Thanh Danh et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出几何感知的混合推理交通预测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且在基准上表现良好，但创新幅度适中

## Machine Learning

### 1. **[Model Discovery Agent: LLM-assisted Bayesian experiment design for data-efficient discovery of mechanistic world models](https://arxiv.org/abs/2608.09696v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-08-10
- **作者**: Kevin Murphy
- **标签**: `cs.AI`
- **AI摘要**: 提出MDA框架实现大模型辅助的贝叶斯实验设计。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新性强且实验充分，具有较高应用价值。

### 2. **[RynnValue: Scaling Robotic Value Foundation Models with Temporal Distance](https://arxiv.org/abs/2608.09853v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-10
- **作者**: Dongchi Huang, Hongyin Zhang, Bohan Hou et al.
- **标签**: `cs.RO` `cs.CV` `cs.LG`
- **AI摘要**: 提出RynnValue机器人价值基础模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性采用时间距离监督，泛化能力强且效果显著。

### 3. **[Input convex neural networks as surrogates in mathematical optimisation](https://arxiv.org/abs/2608.09707v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-10
- **作者**: Yu Liu, Jan Kronqvist, Fabricio Oliveira
- **标签**: `math.OC` `cs.LG`
- **AI摘要**: 提出用输入凸神经网络作优化替代模型的新方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且实用，实验扎实，逻辑清晰。

### 4. **[GENCO - A Unified Neural Solver Embedded in a Development Framework for Steady-State Grid Analysis](https://arxiv.org/abs/2608.09921v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-10
- **作者**: Alban Puech, Matteo Mazzonelli, Tamara R. Govindasamy et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出统一神经求解器GENCO用于稳态电网分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性高且实用性强，实验充分，表述清晰。

### 5. **[Energy-Structured Latent World Models with Neural Time Fields for Physically Constistent Open-World Motion Planning](https://arxiv.org/abs/2608.09876v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-10
- **作者**: Yapeng Liu, Yuanzhao Zhai, Bo Ding et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出能量结构化世界模型以实现物理一致的运动规划
<details>
<summary>原始摘要</summary>
