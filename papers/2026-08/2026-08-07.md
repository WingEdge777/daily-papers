...
### 1. **[Runtime Observability for Heterogeneous Attention Memory](https://arxiv.org/abs/2608.05863v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Fanzhe Wei, Li Liu, Ziyang Wang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出异构注意力内存运行时可观测性框架
<details>
...
- **评分理由**: 创新性强，形式化验证与实证结合严谨，工程价值高。

### 2. **[Learning When to Trust via Selective Context Preference Optimization](https://arxiv.org/abs/2608.06377v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Xian Sun, Wei Chow, Yingshuo Wang et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出SCOPE框架以提升模型对外部上下文的选择性信任能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过MIST基准与SCOPE优化策略，有效解决模型盲目信任误导信息的问题。

### 3. **[Benchmarking and Enhancing LLMs for Rule-Intensive Review of National Standard Documents](https://arxiv.org/abs/2608.06312v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Tao Wang, Qihao Yang, Rongjiao Liang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出GB/T-Bench基准与多智能体框架以提升标准文档审查能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了高质量基准与多智能体框架，实验严谨且具有实际应用价值。

### 4. **[On-Policy Self-Distillation without Any Supervision](https://arxiv.org/abs/2608.06296v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Yijiang Li, Bingyang Wang, Yijun Liang et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出无需外部监督的自蒸馏方法U-OPSD
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，无需额外标注即可提升模型推理能力

### 5. **[MetaboLLM: a metabolomics-specialized large language model for biochemical knowledge integration and predictive metabolite graph construction](https://arxiv.org/abs/2608.06253v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Dohyun Ku, Min Gu Kwak, Francisco J. Pasquel et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出MetaboLLM模型实现代谢组学知识整合与图预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型在代谢组学领域具有创新性，实验设计严谨且实用价值高。

## Natural Language Processing

### 1. **[Tytan: Interactive Neurosymbolic Construction of Analytic Semantic Schemas from Relational Data](https://arxiv.org/abs/2608.06331v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Donna Hooshmand, Shubham Shahi, Cameron Barrie et al.
- **标签**: `cs.DB` `cs.AI`
- **AI摘要**: 提出Tytan系统实现关系数据库语义模式的自动化构建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合神经符号与LLM，在模式构建任务上表现卓越且评估严谨。

### 2. **[NeSy-RAG: Neuro-Symbolic RAG for Explainable Question Answering](https://arxiv.org/abs/2608.06292v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Jonas Gann, Michael Gertz
- **标签**: `cs.CL` `cs.SC`
- **AI摘要**: 提出NeSy-RAG框架，通过神经符号推理提升RAG可解释性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合神经符号推理与RAG，有效提升了推理透明度与准确性。

### 3. **[Decolonizing Linguistic Policies in Automated Speech Recognition: A Framework for Cross-Culturally Competent Speech AI](https://arxiv.org/abs/2608.06141v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Jay L. Cunningham, Mark Atta Mensah, Richard Martinez et al.
- **标签**: `cs.CL` `cs.CY` `cs.HC`
- **AI摘要**: 提出语音识别去殖民化框架与三害分类法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 跨学科视角独特，理论框架完善，对AI公平性有重要意义

### 4. **[Beyond Sequence Order: Syntax-Informed Positional Embeddings for Transformers](https://arxiv.org/abs/2608.06111v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Haris Riaz, Hyungji Kim, Mihai Surdeanu
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出语法增强的位置编码方法SiPE
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且性能提升显著，实验设计严谨扎实。

### 5. **[Clinical Communication Processing with Models Trained on LLM-Generated Synthetic Data: A Structured Survey and Novel Application Case Studies](https://arxiv.org/abs/2608.05993v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Alexander Apartsin, Yehudit Aperstein
- **标签**: `cs.CL`
- **AI摘要**: 利用合成数据提升临床沟通NLP任务性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性综述与多案例研究，方法创新且实用性强，但缺乏真实数据验证。
...
- **评分理由**: 通过因果干预框架深入剖析视觉工具使用，方法严谨且洞察深刻。

### 2. **[Visual Grounding in Zero-Shot Vision-Language Control](https://arxiv.org/abs/2608.06154v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: J. de Curtò, Dayani Plasencia, Diego Sánchez et al.
- **标签**: `cs.RO` `cs.AI` `cs.CV`
- **AI摘要**: 揭示视觉语言模型在零样本控制中的视觉接地失效问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨的消融实验揭示了模型局限性并提出了改进方案。

### 3. **[The Low Frequency Trap: Video Language Models Fail at Simple Event Bookkeeping](https://arxiv.org/abs/2608.06361v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Sarvesh Baskar, Zikui Cai, Shayan Shabihi et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示视频语言模型在事件计数上的时序推理缺陷。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过可执行追踪评估法精准诊断模型时序能力瓶颈。

### 4. **[Mapping Armenian Paris: Extracting and Geocoding Commercial Advertisements from the 20th-Century Diaspora Press](https://arxiv.org/abs/2608.05911v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Chahan Vidal-Gorène, Seda Kirakosyan, Edita Matevosyan
- **标签**: `cs.CV`
- **AI摘要**: 利用VLM提取并地理化亚美尼亚侨民报纸广告
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用VLM解决低资源语言历史文档处理难题，方法论严谨且实用。

### 5. **[Respect Your Zero-Shot Uncertainty: Conservative Calibration for Test-Time-Adapted Vision-Language Models](https://arxiv.org/abs/2608.05945v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Jingyan Jiang, Yaru Sun, Xiao Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ZAEC方法校准TTA模型置信度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对TTA过拟合导致的校准失效，提出基于零样本熵的校准方法，实验扎实且实用。

## Diffusion Models

### 1. **[Sample-Adaptive Latent Rewards for Uncertainty-Guided Diffusion Post-Training](https://arxiv.org/abs/2608.06125v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Rui Li, Yuanzhi Liang, Ke Hao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SURE框架，通过不确定性引导提升扩散模型对齐效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入潜在空间不确定性评估，有效缓解奖励黑客问题，实验表现优异。

## Multimodal

### 1. **[PaDoc: Layout-Grounded Parallel Decoding for Document Parsing](https://arxiv.org/abs/2608.06146v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Hao Yu, Jiabo Zhan, Kang Liu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出PaDoc实现文档解析的并行化解码
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过布局引导的并行解码显著提升了文档解析效率与性能。

### 2. **[Audio-to-Score Transcription using Pre-trained Features, Data Augmentation, and the New SheetSage-A2S Dataset](https://arxiv.org/abs/2608.06165v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Eoin Cummins, Zhongyi Huang, Alexandre D'Hooge et al.
- **标签**: `cs.SD` `cs.AI` `cs.MM`
- **AI摘要**: 提出SheetSage数据集并改进音频转乐谱模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入大规模流行音乐数据集并显著提升转录性能，方法扎实。

### 3. **[ECG-LENS: Lead-Aware Clinical Context Enriched ECG Report Generation and Evaluation](https://arxiv.org/abs/2608.05893v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Akanta Das, Tasinul Islam Ahon, Ahmed Mahir Sultan Rumi et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ECG-LENS框架实现多导联心电图自动报告生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且评估指标科学，在临床应用上具有较高价值。

### 4. **[Seeing Is Not Deciding: Can Multimodal LLMs Act as Effective CEOs?](https://arxiv.org/abs/2608.05864v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Yuyang Dai, Xueqing Peng, Yuxia Wang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出多模态CEO基准，揭示视觉信息对决策的双重影响。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究设计严谨，揭示了多模态决策中的信号拥挤悖论。

### 5. **[MoCA: Implicit Social Context Analysis](https://arxiv.org/abs/2608.05825v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Wenhao Xu, Kaiwen Zhang, Hao Li et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出MoCA任务与CoDAR框架以提升多模态隐性社交理解能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入隐性社交分析任务，方法论严谨且实验充分。

## Image Generation

### 1. **[Energy-Guided Flow Matching](https://arxiv.org/abs/2608.05811v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Haoyang Tong, Yu He, Fang Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出能量引导流匹配模型，实现高效高质量图像生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态端点优化流匹配过程，在图像生成任务中表现优异且高效。

## Video Generation

### 1. **[GAUGE: A Measurement-Grounded Benchmark for Physical Fidelity in Simulation Engines and Video World Models](https://arxiv.org/abs/2608.05948v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Shuai Wang, Yaxin Feng, Xuekun Jiang et al.
- **标签**: `cs.AI` `cs.CV` `cs.RO`
- **AI摘要**: 提出评估物理模拟与视频模型真实性的基准GAUGE
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过真实数据校准评估物理引擎与视频模型，方法严谨且具有重要应用价值。

### 2. **[EmoWorld: A Decoupled Affective Field for Controllable Emotional Video Generation](https://arxiv.org/abs/2608.06231v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Bingyuan Wang, Baistan Zhyldyzbekov, Kunyu Feng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出解耦情感场框架实现可控视频情感生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦情感维度提升了视频生成的可控性与质量

### 3. **[Wan-Animate-2: Pushing the Application Boundaries of Character Animation](https://arxiv.org/abs/2608.06009v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Guangyuan Wang, Li Hu, Dechao Meng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出端到端实时角色动画框架Wan-Animate-2
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且实现了实时推理，在角色动画领域具有显著实用价值。

### 4. **[MASS: Multiplayer World Models with Authoritative Shared State](https://arxiv.org/abs/2608.06257v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Ziqi Cai, Siqi Yang, Yimu Wang et al.
- **标签**: `cs.CV` `cs.HC`
- **AI摘要**: 提出解耦世界状态与渲染的MAS架构，实现高效多智能体模拟。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新显著，解决了多视角一致性问题，实验规模大且严谨。

### 5. **[Diff-VF: Training-free High-quality Long Video Generation via Diffusion Model](https://arxiv.org/abs/2608.05976v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Haoning Yang, Xinyuan Chen, Yaohui Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出无需训练的长视频生成框架Diff-VF
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过三种策略实现长视频生成，方法创新且实验扎实。

## Agent

### 1. **[Certifying Collective Reasoning in Multi-Agent Systems via Koopman Spectral Analysis](https://arxiv.org/abs/2608.05956v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Nuzhat Khan, Indrakshi Dey
- **标签**: `cs.MA` `eess.SY`
- **AI摘要**: 利用Koopman算子实现多智能体推理的收敛性与可解释性认证。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，将动力系统理论引入多智能体推理，方法严谨且实用。

### 2. **[When History Lies: Evaluating and Improving Tool Use under Misleading Multi-Turn Histories](https://arxiv.org/abs/2608.06057v1)**
- **评分**: ⭐ 86/100 | **日期**: 2026-08-06
- **作者**: Xiaoqing Wu, Xingyu Fan, Feifei Li et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出解决工具调用中历史信息污染的鲁棒性训练方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对历史污染问题提出了创新基准与蒸馏方案，实验严谨且效果显著。
...
- **评分理由**: 通过方差缩减与随时有效停止机制，大幅提升评估效率。

### 4. **[FormBharo: Designing and Evaluating a Voice Agent for Conversational Form Filling in Rural India](https://arxiv.org/abs/2608.06027v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-08-06
- **作者**: Aman Dalmia, Sanskriti Midha, Jigar Doshi
- **标签**: `cs.CL` `cs.AI` `cs.HC`
- **AI摘要**: 开发语音代理实现农村表单自动填写
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决实际痛点，评估方法严谨且实用性强。

### 5. **[Hardware Keystores for AI Agent Signing Workflows: A Zero-Trust MCP Enforcement Architecture](https://arxiv.org/abs/2608.06130v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-08-06
- **作者**: Leo Sambrook, Sampo Sovio
- **标签**: `cs.CR` `cs.AI` `cs.LG`
- **AI摘要**: 基于硬件密钥库的AI代理零信任签名架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过硬件隔离解决AI代理密钥泄露，方法严谨且实用。

## Distributed Computing

### 1. **[Routing LLM Inference to the Cleanest Grid in Real Time](https://arxiv.org/abs/2608.06188v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Aleks Bernhard, Arif Baran Yardimci
- **标签**: `cs.DC` `cs.PF`
- **AI摘要**: 通过实时碳感知路由优化LLM推理能耗
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且具备极高的工程落地价值与环境效益

### 2. **[TensorCast: The Missing Tensor Management Layer in Large Language Model Infrastructure](https://arxiv.org/abs/2608.06007v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Yuhan Zhou, Yuchu Luo, Hao Nie et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出TensorCast解耦张量管理与计算逻辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且实验充分，显著提升了分布式推理效率

### 3. **[PLB: Priority-Aware Load Balancing for Replicated Databases under Constrained Resources](https://arxiv.org/abs/2608.06140v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Belkis Djeffal, Pierre Bourhis, Romain Rouvoy
- **标签**: `cs.DB` `cs.DC`
- **AI摘要**: 提出一种优先级感知的数据库负载均衡方案
<details>
<summary>原始摘要</summary>
...
### 4. **[MultiMoQ: Multi-Access Media-Over-QUIC for Robust Immersive Video Streaming](https://arxiv.org/abs/2608.06102v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Yitong Li, Xinjiao Li, Ruonan Chai et al.
- **标签**: `cs.NI` `cs.MM`
- **AI摘要**: 提出MultiMoQ实现多路径沉浸式视频流传输
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多路径QUIC优化提升了视频流的鲁棒性与性能

### 5. **[Hybrid-Adaptive Thread Tuning to Mitigate Simulation Execution Bottlenecks in High-Performance Reinforcement Learning Inference](https://arxiv.org/abs/2608.06025v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Jiming Su, Hantao Hua, Lujia Yin et al.
- **标签**: `cs.LG` `cs.MA` `cs.PF`
- **AI摘要**: 提出AutoThread自适应线程调度以优化RL仿真效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合PINO与排队论优化线程分配，实验结果显著且方法创新。

## Information Retrieval

### 1. **[Beyond Top-K: Replacing Black-Box Retrieval with Interpretable Agentic Operations](https://arxiv.org/abs/2608.06305v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-08-06
- **作者**: Sagar Tamang, Ayush Vyas, Tabarakul Hazarika
- **标签**: `cs.AI` `cs.CL` `cs.IR`
- **AI摘要**: 提出READ框架，通过代理操作取代黑盒检索以提升金融文档处理准确性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对长文档检索痛点提出创新代理方案，实验严谨且对比显著，具有高实用价值。

### 2. **[Gryphon-v2: One Model in Place of a Cascade - Generate-and-Rank Recommender with Rollout Distillation](https://arxiv.org/abs/2608.06213v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Anna Lipkina, Daria Tikhonovich, Viktor Yanush et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出Gryphon-v2统一生成与排序模型替代复杂推荐级联
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏技术简化级联架构并实现显著线上性能提升

### 3. **["I don't know anything about laptops!" - User Perception of Digital Product Advisors Adapting to Their Knowledge Levels](https://arxiv.org/abs/2608.06091v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Kevin Schott, Andrea Papenmeier, Daniel Hienert et al.
- **标签**: `cs.HC` `cs.IR`
- **AI摘要**: 研究数字助手如何根据用户知识水平调整产品推荐策略。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，针对性强，为对话式商务提供了实用设计准则。

### 4. **[Cleo: A Transparent and Controllable Chatbot for Conversational Commerce](https://arxiv.org/abs/2608.06068v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Kevin Schott, Jan Lattenkamp, Daniel Hienert et al.
- **标签**: `cs.HC` `cs.IR`
- **AI摘要**: 提出透明可控的对话式电商推荐系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合确定性排序与LLM，提升了决策支持的透明度与准确性。

### 5. **[DARAD: Dual Adapters and Ranking-Aware Distillation for Continual Remote Sensing Image-Text Retrieval](https://arxiv.org/abs/2608.06059v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Xi Chen, Xu Chen, Xiangyang Jia et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出双适配器与排序蒸馏框架解决遥感跨模态持续检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法针对遥感特性设计，实验充分且逻辑清晰，具有较强实用性。

## Computer Vision

### 1. **[Toward Deployable Bangla Sign Language Recognition with Expert-Validated Data and a Lightweight Attention-Based Model](https://arxiv.org/abs/2608.06252v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Saad Ahmed, Md Khalid Syfullaha
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出轻量级BdSL识别模型与专家验证数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集质量高，模型轻量化且部署性能优异，实验严谨。

### 2. **[Prior-SG: Task and Prior Driven Region Segmentation for Scene Graphs in Arbitrarily-Structured Environments](https://arxiv.org/abs/2608.06170v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-08-06
- **作者**: Giorgio Tonetti, Laurent Kneip, Abel Gawel et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 基于大模型先验的场景图语义分割框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过LLM先验解决开放空间场景图构建，方法创新且实验扎实。

### 3. **[TLNM: Externally Validated Tooth Detection, Numbering and Segmentation from Smartphone Photographs Using Mask R-CNN](https://arxiv.org/abs/2608.06275v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Arash Nedaei, Henna Tiensuu, Elina Väyrynen et al.
- **标签**: `cs.CV` `eess.IV`
- **AI摘要**: 基于Mask R-CNN的智能手机牙齿检测与分割模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且验证充分，在移动端牙科筛查领域应用价值高。

### 4. **[PRISM: Distribution-Gated Flow Matching for Controllable Unpaired Image Translation](https://arxiv.org/abs/2608.06240v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Elad Yoshai, Natan T. Shaked
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出分布门控流匹配框架实现可控图像翻译
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在多项任务中表现优异。

### 5. **[HOPE: Hand-Object Pressure Estimation from Monocular Videos](https://arxiv.org/abs/2608.06192v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Subin Jeon, Byungjun Kim, Hanbyul Joo
- **标签**: `cs.CV`
- **AI摘要**: 提出基于单目视频的手部压力估计框架HOPE
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将压力估计转化为手部顶点视频预测任务，实验扎实。

## Machine Learning

### 1. **[An Optimal Agnostic PAC Algorithm](https://arxiv.org/abs/2608.06363v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Markus Engelund Mathiasen, Jian Qian, Nikita Zhivotovskiy
- **标签**: `cs.LG` `cs.AI` `cs.DS`
- **AI摘要**: 提出首个达到统计最优的不可知PAC学习算法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了学习理论中长期存在的样本复杂度最优性问题。

### 2. **[Scalable estimation of VARMA models](https://arxiv.org/abs/2608.06340v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Daniel Paulin, Victor Elvira
- **标签**: `stat.ML` `cs.LG` `math.ST`
- **AI摘要**: 提出一种高效VARMA模型估计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过充分统计量实现与序列长度无关的计算，理论严谨且实用性极强。

### 3. **[Minimax Optimal Early-Stopped Gradient Descent for Gaussian Mixture Classification](https://arxiv.org/abs/2608.06250v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Alex Buna, Shirley Xiaoqi Liu, Patrick Rebeschini
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出早停梯度下降实现高斯混合分类的极小极大最优性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且贡献显著，解决了过参数化模型中的隐式偏差问题。

### 4. **[THBKG: A Temporal Biomedical Knowledge Graph for Decision-Aligned Clinical Advancement Prediction](https://arxiv.org/abs/2608.05982v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-06
- **作者**: Pui Chung Siu, Claudia Cabrera, Mani Mudaliar et al.
- **标签**: `cs.LG` `q-bio.QM`
- **AI摘要**: 构建时序生物知识图谱以预测临床试验进展
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入时序维度解决临床决策预测难题，方法严谨且应用价值高。

### 5. **[Optimal Rates for Learning with Monotone Adversaries](https://arxiv.org/abs/2608.06337v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-06
- **作者**: Anay Mehrotra
- **标签**: `stat.ML` `cs.DS` `cs.LG`
- **AI摘要**: 证明单调对抗下学习存在额外对数损失
<details>
<summary>原始摘要</summary>
