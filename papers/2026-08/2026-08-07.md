...
### 1. **[Reducing belief in conspiracy theories as they unfold using large language models](https://arxiv.org/abs/2608.06151v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-06
- **作者**: Thomas H. Costello, Nathaniel Rabb, Michael Nicholas Stagnaro et al.
- **标签**: `cs.HC` `cs.AI`
- **AI摘要**: 利用大语言模型减少阴谋论信念
<details>
...
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出RRC方法以解锁生成式奖励模型在强化学习中的应用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点有效且实验充分，具有较高的实用价值。

### 3. **[DASH: Divergence-Adaptive Supervision Horizons for On-Policy Self-Distillation of Reasoning Models](https://arxiv.org/abs/2608.06243v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: ZhiYan Hou, Xinyu Tang, Hongyan An et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出自适应蒸馏视界算法提升大模型推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖有效，实验充分，但属于强化学习与蒸馏的局部改进

### 4. **[What Current AI Benchmarks Leave Unmeasured: Modality, Search, Citations, and Implications (for Safety Evaluations)](https://arxiv.org/abs/2608.06202v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Ro Encarnación, Tina Behzad, Emma Lurie et al.
- **标签**: `cs.HC` `cs.AI`
- **AI摘要**: 揭示AI基准评测未测量的行为差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究系统且严谨，对AI安全评估有较高参考价值。

### 5. **[LLM Inference Under Bursty Workload Distribution: Modifying the WAIT Algorithm](https://arxiv.org/abs/2608.06135v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Anjali Gangadhar Katageria, Shobha Rani, Raghu Nandan Sengupta
- **标签**: `cs.LG`
- **AI摘要**: 提出了针对突发负载的LLM推理调度算法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 改进了WAIT算法以适应突发流量，评估充分但创新性一般。

## Natural Language Processing

### 1. **[RP-OPSD: Reasoning-Pivot-Guided On-Policy Self-Distillation for Multilingual Reasoning Transfer](https://arxiv.org/abs/2608.06347v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Xinye Wang, Junxiao Liu, Shujian Huang
- **标签**: `cs.CL`
- **AI摘要**: 提出RP-OPSD方法实现跨语言推理迁移
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点合理，实验充分，实用性强

### 2. **[MameLoshnLM: Yiddish Language Model and Evaluation Benchmark](https://arxiv.org/abs/2608.05850v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Uri Katz, Omer Goldman, Tomasz Limisiewicz et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 首个开源意第绪语大模型及评测基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补低资源语种空白，方法全面，实验扎实

### 3. **[Bias Analysis of L2 Speaking Assessment Systems Using Concept Activation Vectors](https://arxiv.org/abs/2608.06300v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Arya Labroo, Mengjie Qian, Kate Knill
- **标签**: `cs.AI`
- **AI摘要**: 用概念激活向量分析语音测评系统偏差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有创新，实验较充分，写作清晰。

### 4. **[SAGA: Score-Weighted Adaptive Generation Alignment for Low-Resource Nordic Language Models](https://arxiv.org/abs/2608.06179v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Hoda Fakharzadehjahromy, Emil Wiman, Andreas Bueff et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出SAGA框架利用依存句法分析器对低资源北欧语言模型进行无人工标注的对齐优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新地用句法分析替代人工偏好标注，提升显著，方法扎实且实验充分

### 5. **[Schema-Guided Hierarchical Information Extraction and Semantic Evaluation Using Generative AI](https://arxiv.org/abs/2608.06167v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Modhurita Mitra, Jan-Willem Versteeg, Maarten D. Schermer et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出基于生成式AI的模式引导分层信息提取与语义评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且在卫生技术评估领域效果显著，具备良好泛化性

## Vision Language Models

### 1. **[SkillMemo: Expert-guided Skill Memory Framework for Compositional Embodied Manipulation](https://arxiv.org/abs/2608.05970v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-06
- **作者**: Changyuan Wang, Chubin Zhang, Zhenyu Wu et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出专家引导的具身技能记忆框架，提升组合泛化能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，显著增强策略的组合泛化性能。

### 2. **[Domain-Grounded Candidate Selection for Agentic Image Editing: A Shadow Removal Case](https://arxiv.org/abs/2608.06075v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Shilin Hu, Jingyi Xu, Dimitris Samaras et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出了物理引导的智能体阴影去除候选选择方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合传统物理先验与商业VLM，实验扎实且提升明显。

### 3. **[Universal Concept Disruption for SAM3 Image Segmentation](https://arxiv.org/abs/2608.05983v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Hao Wang, Yuxuan Zhang, Wei Yang
- **标签**: `cs.CV`
- **AI摘要**: 提出SAM3通用概念对抗攻击方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，实验扎实，实用性有潜力

### 4. **[ViSR-KGC: Visual Subgraph Reasoning with Vision-Language Models for Multimodal Knowledge Graph Completion](https://arxiv.org/abs/2608.05833v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Jiafan Li, Mengxue Yang, Jiaqi Zhu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出基于视觉子图推理的多模态知识图谱补全方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合VLM与图结构，方法合理但属特定场景应用

### 5. **[M$^3$R-Bench: A Unified Benchmark for Evidence-Grounded Multimodal Metaphor Understanding](https://arxiv.org/abs/2608.05817v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Hong Jiang, Junnan Zhu, Jingwang Huang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出了多模态隐喻理解基准与推理模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作完整且基准扎实，但在基础理论突破上较为常规

## Multimodal

### 1. **[M$^3$Prune: Hierarchical Collaborative Pruning for Efficient Multi-Modal Multi-Agent Retrieval-Augmented Generation](https://arxiv.org/abs/2608.05967v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Taolin Zhang, Weizi shao, Zijie Zhou et al.
- **标签**: `cs.MM`
- **AI摘要**: 提出了多模态多智能体检索增强生成的高效剪枝框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且有效，实验充分，具有较高应用价值

### 2. **[GSBF: Gaussian Splatting for Environment-Aware Beamforming](https://arxiv.org/abs/2608.05896v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Yijie Bian, Wei Guo, Zixin Wang et al.
- **标签**: `cs.AI` `cs.IT`
- **AI摘要**: 提出基于高斯溅射的环境感知波束成形方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合3D高斯与无线通信创新性强，实验和实用性良好

### 3. **[Whence the Voice? Self-supervised Dual-source Audio-Visual Localisation via Selective Convergence](https://arxiv.org/abs/2608.05816v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Han Hu, Dongheng Lin, Yuqi Hou et al.
- **标签**: `cs.MM`
- **AI摘要**: 提出自监督双源视听定位的渐进式框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的视听选择性收敛机制，消融实验与评估基准较扎实

## Image Generation

### 1. **[Controllable Clothing: Precise Labels and Generation for Virtual Try-On with Latent Diffusion Models](https://arxiv.org/abs/2608.05834v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-06
- **作者**: Max Rehman Linder
- **标签**: `cs.CV`
- **AI摘要**: 提出基于隐扩散模型的虚拟试衣可控生成方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用但实验与理论推导略显简单，增量研究

## Agent

### 1. **[EnvACE: Internalizing Environment Dynamics via World Rehearsal for Agentic Reinforcement Learning](https://arxiv.org/abs/2608.06197v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-06
- **作者**: Zishan Xu, Zhiyuan Yao, Yuxin Chen et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出EnvACE框架，通过世界排练实现内化环境动态的智能体强化学习。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入世界排练方法，实验扎实且实用性强，具有较高学术价值。

### 2. **[AppDeltaWorld: Transition-Grounded Delta Code World Model for Mobile GUI Agents](https://arxiv.org/abs/2608.05891v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-06
- **作者**: Weikai Xu, Yunren Feng, Haoxiang Lei et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出移动GUI世界模型AppDeltaWorld
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性采用差分代码世界模型，提升GUI智能体性能

### 3. **[RepoOMP: Repository-Aware Hotspot OpenMP Parallelization via Dependency-Aware Context Reduction](https://arxiv.org/abs/2608.05855v1)**
- **评分**: ⭐ 81/100 | **日期**: 2026-08-06
- **作者**: Yongjie Qian, Ke Gao, Zhibin Zhang et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出基于依赖感知上下文缩减的仓库级OpenMP并行化混合框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性与实用性强，实验充分，显著提升并行化效率

### 4. **[CodeGrep: An RL-Trained Retrieval Agent for LLM Coding Agents](https://arxiv.org/abs/2608.05886v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-08-06
- **作者**: Wuya Chen, Yihao yang, Yang Cao et al.
- **标签**: `cs.SE` `cs.AI`
- **AI摘要**: 提出CodeGrep提升大模型代码智能体的检索效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效降低了大模型代码代理的代币消耗
...
- **评分理由**: 创新性较强，实验充实，对智能体训练有较高实用价值。

## Distributed Computing

### 1. **[From Passive Mirrors to Active Agents: Holonic Digital Twins for Physical AI over Networks](https://arxiv.org/abs/2608.06227v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Christo Kurisummoottil Thomas, Omar Hashash, Walid Saad
- **标签**: `cs.NI` `cs.AI` `cs.IT`
- **AI摘要**: 提出全onic数字孪生网络以支撑物理AI
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的分布式AI框架，理论严密但缺乏实验验证。

### 2. **[ML-for-ML](https://arxiv.org/abs/2608.06046v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Yutong Zhao, Noga H. Rotman, Gianni Antichi et al.
- **标签**: `cs.NI` `cs.DC` `cs.LG`
- **AI摘要**: 联合优化网络与机器学习参数以加速训练
<details>
<summary>原始摘要</summary>
...
### 3. **[Operating Multi-Node Full Fine-Tuning on NVIDIA B300: A Field Report on Telemetry-Based Triage, Negative Results, and Operational Hardening](https://arxiv.org/abs/2608.05944v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Seon Ho Kim, Ui Jeong Jeon, Su Hyeon Kim et al.
- **标签**: `cs.DC` `cs.LG`
- **AI摘要**: NVIDIA B300集群微调实战与运维调优经验
<details>
<summary>原始摘要</summary>
...
### 4. **[BALANCE: Hybrid Autoregressive-Speculative LLM Inference in Wireless Edge Networks](https://arxiv.org/abs/2608.05926v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Guanqiao Qu, Shuo Chen, Qian Chen et al.
- **标签**: `cs.NI` `cs.AI`
- **AI摘要**: 边缘网络中混合自回归推测推理框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，求解方法严谨，实用性强。

## Information Retrieval

### 1. **[Learning from Failures: Retrieval-Centric CoT via Hard Negatives for Unified Multimodal Retrieval](https://arxiv.org/abs/2608.06060v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Zelong Sun, Jun Wang, Kaicheng Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出检索中心化思维链的统一多模态检索框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的检索思维链设计，实验充分，实用性强。

### 2. **[Mapping Similarity Spaces across Embedding Models with Synthetic Query Probing](https://arxiv.org/abs/2608.05857v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-08-06
- **作者**: Marcin Rozmus, Peter van der Putten
- **标签**: `cs.CL`
- **AI摘要**: 提出合成查询探测方法以校准嵌入模型相似度
<details>
<summary>原始摘要</summary>
...
### 3. **[Improving Interoperability among Defence and National Security Ontologies: Analysis and Evaluation Tasks](https://arxiv.org/abs/2608.05867v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-06
- **作者**: Jonathon Dilworth, Pedro Giesteira Cotovio, David Herron et al.
- **标签**: `cs.AI`
- **AI摘要**: 构建国防本体评估赛道并分析60多个本体
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作详实具有实用价值但创新性一般

## Computer Vision

### 1. **[EvReflection: Event-Driven Micro-Dynamics for Reflection Removal](https://arxiv.org/abs/2608.06184v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Jiaxiao Wang, Dachun Kai, Huyue Zhu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个基于事件相机的去反射网络
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新引入事件流去反光，实验扎实，实用性强。

### 2. **[CogVis: Must Open-Vocabulary Change Detection Perceive the Scene Anew for Every Query?](https://arxiv.org/abs/2608.06150v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Zijie Wang, Chen Zhong, Wei He
- **标签**: `cs.AI` `cs.CV`
- **AI摘要**: 提出认知记忆引导的开放词汇变化检测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，提升了检测性能与吞吐量

### 3. **[Big, Bright, or Invisible: A Frozen-Feature Benchmark of 3D CT Foundation Models](https://arxiv.org/abs/2608.05960v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Maulik Chevli, Johannes Brandt, Rickmer Braren et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 评估并基准测试3D CT基础模型性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统评估全面，但属于基准测试，创新性适中。

### 4. **[To See a World in a Living Context: Unified Indoor-Outdoor Urban World Generation](https://arxiv.org/abs/2608.05879v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Xiaobin Huang, Zilong Huang, Yang Luo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出了首个统一室内外的3D城市场景生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 室内外统一生成的创新显著，实验充分但整体仍具增量性质

### 5. **[Does FLAIR super-resolution erase or hallucinate small white-matter lesions?](https://arxiv.org/abs/2608.06311v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Zahra Khodakarami, Yue Li, Pulkit Khandelwal et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 评估FLAIR超分辨率对白质病变分割的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究了超分辨率算法对白质病变的影响，方法严谨实用。

## Machine Learning

### 1. **[Alternating Levenberg-Marquardt Training of Physics-Informed Neural Networks with Fourier-Enhanced Features](https://arxiv.org/abs/2608.05892v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-08-06
- **作者**: Yulun Wu, Matthieu Barreau, Miguel Aguiar et al.
- **标签**: `cs.LG` `math.NA`
- **AI摘要**: 提出FALM-PINN优化框架求解偏微分方程
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且理论严谨，大幅降低求解误差。

### 2. **[BaKron: Efficient Quantization with Kronecker-Factored Hessians](https://arxiv.org/abs/2608.06291v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Johann Birnick, Rayan Saab
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出高效Kronecker量化算法BaKron
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法改进有创新且实用，实验完备但属于细分优化

### 3. **[MicroEvo: Knowledge-Guided LLM Sampling for Efficient Microarchitecture Design Space Exploration](https://arxiv.org/abs/2608.06183v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Jia Xiong, Runkai Li, Chenxu Niu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出MicroEvo实现高效微架构设计搜索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合LLM与MCTS提升设计空间探索效率，方法新颖且实验充分

### 4. **[QuanTiMedAI: Quantum-Enhanced Time-Series Model guided by Agentic AI for Cardiac Arrest Mortality Prediction](https://arxiv.org/abs/2608.06294v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Mutasim Fuad Sarker, Adiba Rahman Namira, Wafa Binte Alam et al.
- **标签**: `cs.AI` `cs.ET`
- **AI摘要**: 提出量子增强与智能体引导的心脏骤停预测模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合量子计算与大模型，实验充分但属特定医疗场景

### 5. **[Surv-IPTB: An Attention-Based Model for Estimating Individual Probability of Treatment Benefit with Survival Data](https://arxiv.org/abs/2608.06288v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Lev V. Utkin, Stanislav K. Kogan, Andrei V. Konstantinov
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出生存数据下的个体治疗受益评估注意力模型
<details>
<summary>原始摘要</summary>
