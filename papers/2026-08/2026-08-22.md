...
### 1. **[Pandora's AI Model Routing Box: Efficient Allocation with Costly Value Estimation](https://arxiv.org/abs/2608.20316v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Adam Fisch, Shubhendu Trivedi, Fantine Huot et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出潘多拉路由器以优化AI模型路由与评估成本
<details>
...
- **评分理由**: 理论结合经典模型且实验扎实，但属于进阶路由优化

### 2. **[LoRA-GA$^2$: Low Rank Adaptation with Multi-step Gradient Adaptive Alignment](https://arxiv.org/abs/2608.19800v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-08-20
- **作者**: Haonan He, Xinyue Fan
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出LoRA-GA2多步梯度对齐微调算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好且实验充分，提升了低秩适应性能

### 3. **[ConceptGuard: Benchmarking Context-Sensitive Unlearning in Large Language Models](https://arxiv.org/abs/2608.20338v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Sahil Kale, Ian Harris
- **标签**: `cs.CL`
- **AI摘要**: 提出概念级大模型遗忘基准ConceptGuard
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好但方法和实验有提升空间

### 4. **[Phantom Gains: Auditing Self-Improvement Against a Measured Null](https://arxiv.org/abs/2608.20290v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Cheng Xu, Nan Yan, Liming Chen et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 揭示语言模型自我改进评估中的测量缺陷
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 指出现有评估方法的盲点并提出对照基准，具有较高严谨性

### 5. **[Which Eviction Policy Should an LLM Cache Use? A Systematic Study Across Workloads, Capacities, and Encoders](https://arxiv.org/abs/2608.20280v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
...
### 1. **[PersonalBench: Measuring the Authorship Gap in LLM Personalization](https://arxiv.org/abs/2608.19746v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Yash Ganpat Sawant
- **标签**: `cs.CL`
- **AI摘要**: 提出PersonalBench评估大模型个性化写作的作者身份差距
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作扎实且具应用价值，但创新性相对一般

### 2. **[Towards Quantifying Benchmark Optimization in ASR Models](https://arxiv.org/abs/2608.19936v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Theo Lebryk, David Ayllon, Alice Baird et al.
- **标签**: `cs.SD` `cs.AI`
- **AI摘要**: 量化评估ASR模型的基准优化现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性与实用性较好，实验严谨且结构清晰

## Vision Language Models

### 1. **[V-REX: Efficient Specialist VLM Training for Veterinary X-Rays](https://arxiv.org/abs/2608.20069v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Tim Elsner, Nicole McNally, Andre Dourson et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出高效的兽医X射线VLM训练方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实用，但领域相对垂直局限

### 2. **[Question-Guided Evidence Acquisition for Multimodal Visual Question Answering](https://arxiv.org/abs/2608.19739v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-08-20
- **作者**: Alin-Ionut Popa
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出Q-Guide提升文档VQA的视觉感知能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有效且实验充分，具有良好的实用价值

### 3. **[EXIMO: VLM Guided Exploration of VLA Policies](https://arxiv.org/abs/2608.19891v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Bhavya Sukhija, Oliver Groth, Mohit Shridhar et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出EXIMO算法，利用VLM引导VLA策略高效微调。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合VLM与VLA，实用性与严谨性良好。

### 4. **[Towards Clinically Faithful Medical Image Captioning via Enhanced Vision-Language Alignment](https://arxiv.org/abs/2608.19825v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Yunseo Lee, Hyun Jun Kim, Heeseung Shin et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出了增强医疗图像对齐的字幕生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实验扎实，但实用性受限于特定任务

## Multimodal

### 1. **[Dynamic Gated Cross-Modal Fusion with Sarcastic-aware Contrastive Regularization for Multimodal Sarcasm Detection](https://arxiv.org/abs/2608.19942v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Hao Guo, Subin Huang, Junjie Chen et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出了动态门控跨模态融合与对比正则化的多模态讽刺检测方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点和实验较扎实，属于领域内的有效改进

### 2. **[When Saying No Makes Better Videos: Designing Dual Gatekeeping for Pedagogically Grounded AI Content Creation](https://arxiv.org/abs/2608.19812v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Yearim Kim, Njun Baek, Nojun Kwak
- **标签**: `cs.AI` `cs.CV`
- **AI摘要**: 提出双重把关机制提升AI教育视频质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合理论与实验验证了拒绝机制在教育视频生成中的效用，创新性中等。

### 3. **[Projector Is All You Train](https://arxiv.org/abs/2608.19726v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Nyx Iskandar, Saathvik Selvan, Slater Victoroff
- **标签**: `cs.CL` `cs.CV` `cs.LG`
- **AI摘要**: 仅训练投影层即可实现强大多模态性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好，实验扎实，但属于特定方向的优化。

## Agent

### 1. **[Inducing Task Models from Computer-Use Traces](https://arxiv.org/abs/2608.20319v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Yucheng Jiang, Zora Zhiruo Wang, Ruishi Chen et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出任务模型归纳法从电脑使用痕迹中提取分层任务模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在智能体和工作流建模领域具有实用价值

### 2. **[Repo0: Design-Driven Zero-to-All Code Generation](https://arxiv.org/abs/2608.19854v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Silin Chen, Haoyi Teng, Xiaodong Gu et al.
- **标签**: `cs.SE` `cs.AI`
- **AI摘要**: 提出Repo0实现零起点代码生成与演化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新Dual-DAG架构与演化机制，实验充分实用性强。

### 3. **[MileGPO: Milestone Inference with Local Evidence for Graph-Based Policy Optimization of Long-Horizon LLM Agents](https://arxiv.org/abs/2608.19803v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Bo Qian, Yuting Wu, Shuang Zeng et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出MileGPO算法解决长周期智能体信用分配问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，提升了智能体强化学习性能

### 4. **[SafeBranch: Branch-Pair Safety Alignment for Embodied Agents](https://arxiv.org/abs/2608.19729v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Hyunse Lee, Jiwoo Jeong, Haneul Lee et al.
- **标签**: `cs.AI` `cs.CV` `cs.RO`
- **AI摘要**: 提出SafeBranch框架以提升具身智能体安全性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新分支对齐方法，实验充分但范围受限

### 5. **[Beyond Memory Majority: Latent-Source Reasoning for Multi-Agent Memory Arbitration](https://arxiv.org/abs/2608.19701v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Chenchen Lin, Wenhao Yuan, Xuehe Wang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出CAMA框架解决多智能体记忆关联偏差问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，方法严谨，具较高实用价值

## Information Retrieval

### 1. **[$TCP_α$: Margin-Controlled Confidence estimation for reliable Music Information Retrieval](https://arxiv.org/abs/2608.20326v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Parampreet Singh, Anushka Singh, Sumit Kumar et al.
- **标签**: `eess.AS` `cs.LG`
- **AI摘要**: 提出可信音乐信息检索的边缘控制置信度估计方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且实验严谨，对音乐信息检索领域很有价值

### 2. **[Do Sequential Recommendation Benchmarks Really Require Higher-Order Sequence Modelling?](https://arxiv.org/abs/2608.19833v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Aleksandr V. Petrov, Praveen Chandar, Paul N. Bennett et al.
- **标签**: `cs.IR`
- **AI摘要**: 揭示序列推荐基准并不真正需要高阶建模
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过简单基线对复杂模型提出质疑，实验扎实且具有启发性

## Computer Vision

### 1. **[MOSAIC: Modality-agnostic Spectral Alignment for Federated Image-level Weakly Supervised Tumor Segmentation under Client-specific Missing Modalities](https://arxiv.org/abs/2608.19788v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-20
- **作者**: Tarun Kumar Garg, Vaanathi Sundaresan
- **标签**: `eess.IV` `cs.CV`
- **AI摘要**: 提出联邦多模态弱监督肿瘤分割框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且实验充分，但弱监督任务实用性有一定局限。

### 2. **[Prompt-Conditioned Channel Attention for Hierarchical Feature Modulation toward Anatomy-Agnostic Segmentation](https://arxiv.org/abs/2608.20229v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Mosharof Hossain, Md Rabiul Islam, Limon Halder et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出提示条件通道注意力机制以实现医学图像分割。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新有效，实验基准全面，写作清晰严谨。

### 3. **[DPC-Net: Dual-Prior Collaborative Network for All-in-One Image Restoration](https://arxiv.org/abs/2608.20141v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Zhaokun He, Kangbiao Shi, Axi Niu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出双先验协同网络用于全能图像恢复
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合视觉语言模型与底层先验，实验充分但属常规改进

### 4. **[ID-VTG: Image-Disambiguated Video Temporal Grounding](https://arxiv.org/abs/2608.20127v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Minghang Zheng, Jingli Wei, Hongyi Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出图像消歧视频时序定位任务及新基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 任务创新性强，实验充分，具有较高实用价值

### 5. **[BeyondMasks: Evaluating Causal and Physical Consistency in Video Object Removal](https://arxiv.org/abs/2608.20107v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Yigit Ekin, Enes Sanli, Aykut Erdem et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出视频物体移除因果一致性评估基准BeyondMasks
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作完整且切中痛点，但评估基准类创新上限有限

## Machine Learning

### 1. **[Scale-Aware Pretraining of Time Series Foundation Models via Multi-Patch Token Alignment and Hybrid Masking](https://arxiv.org/abs/2608.20005v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-20
- **作者**: Taihua Chen, Xiang Ma, Yixin Zhang et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出SATS模型实现时间序列多尺度预训练。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的尺度感知对齐与混合掩码机制，实验扎实且提升显著。

### 2. **[Rethinking Patch Based Multivariate Time Series Forecasting with Semantic Structured Partitioning](https://arxiv.org/abs/2608.19966v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Jiazhe Wang, Zhiquan Huang, Linjing Xue et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出SCPaT模型改进多元时间序列预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实验充分，方法切中现有痛点

### 3. **[A Layered Simplex Architecture for Large Alphabets](https://arxiv.org/abs/2608.19908v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Meir Feder, Yaniv Fogel, Ruediger Urbanke
- **标签**: `cs.IT` `cs.LG` `stat.ML`
- **AI摘要**: 提出一种简单高效的大字母表贝叶斯估计器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且分析严谨，在多个基准测试表现优异

### 4. **[PETA:Parameter-Efficient Test-Time Adaptation for Virtual Screening](https://arxiv.org/abs/2608.19906v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Jia-Qi Lin, Yinghua Yao, Chang-Dong Wang et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出PETA测试时适应框架用于虚拟筛选
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较强且实用，实验充分，写作清晰。

### 5. **[Fourier is Frontier: Frequency-Aware Autoencoding for High-Fidelity Music Reconstruction](https://arxiv.org/abs/2608.19843v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Kangdi Wang, Yusheng Dai, Jin Xu
- **标签**: `cs.SD` `cs.MM`
- **AI摘要**: 提出复数谱自编码器ear-VAE2，解决音乐高频丢失与相位失真问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合傅里叶变换解决音频重建缺陷，实验扎实且实用性强
