...
### 1. **[MACRO: Markov Chain Routing of Transformer Layers](https://arxiv.org/abs/2608.05872v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Paweł Batorski, Abtin Pourhadi, Akylgali Aitaza et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出MACRO马尔可夫链路由方法提升大模型性能
<details>
...
- **评分理由**: 创新性好且实用，评估严谨，表述清晰。

### 2. **[Poli-Bias: Understanding and Measuring Large Language Model Biases in International Political Conflicts](https://arxiv.org/abs/2608.06123v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Massi-Nissa Abboud, Aladin Djuhera, Elena Cabrio et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出评估大语言模型政治偏见的计数反事实框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好且实用，评估严谨但范围有限

### 3. **[Mind the Gaps: Mixture-of-Minds for Human Simulation](https://arxiv.org/abs/2608.06115v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Pranav Dahiya
- **标签**: `cs.AI`
- **AI摘要**: 提出混合思维模型实现高精度群体人类模拟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性较好且精度高，但局限于特定领域

### 4. **[Signal or Spurious Cue? A Randomized Audit of Survey-Country Metadata in LLM Social Inference](https://arxiv.org/abs/2608.06085v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Yifan Lyu, Xinran Li, Jiaqi Qiao et al.
- **标签**: `cs.AI`
- **AI摘要**: 评估LLM社会推断中元数据的影响与局限。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实验严谨，但方法实用性与普适性受限。

### 5. **[LangChoiceBench: Measuring and Explaining Programming-Language Choice in LLMs](https://arxiv.org/abs/2608.06041v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Lukas Twist, Twm Stone, Helen Yannakoudakis et al.
- **标签**: `cs.SE` `cs.CL`
- **AI摘要**: 提出评估大模型编程语言选择倾向的基准LangChoiceBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且实验充分，具有较高的实用价值与清晰度

## Natural Language Processing

### 1. **[Training-Free Token-Level Steering for LLM Personalized Co-Writing](https://arxiv.org/abs/2608.06069v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Wenhao Mao, Chengbin Hou, Weixiao Wang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出无训练的个性化协同写作框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且实用，实验充分，但属于增量改进。

### 2. **[HERALD: Counterfactual Audits and Minimal Repairs for Proof-of-Retrieval Rewards](https://arxiv.org/abs/2608.06012v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Zhuowen Liu, Bohan Cui, YinShang Guo et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出HERALD算法用于检索增强奖励的抗反事实审计与修复
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性和实验严谨，但语言偏晦涩影响可读性

### 3. **[How Far Do Simple Transformations Translate Across Text Embedding Models?](https://arxiv.org/abs/2608.05980v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Sid Ali Hamideche, Louis Adrien Dufrene, Quentin Lampin et al.
- **标签**: `cs.LG`
- **AI摘要**: 探究简单变换在异构文本嵌入模型间的泛化性与局限
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 评估全面且结论严谨，对嵌入转换研究有实际参考价值。

### 4. **[CourseGraph: Finding overlaps and differences in Computer Science courses across universities](https://arxiv.org/abs/2608.05910v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Arthur Nijdam, Paul Stankovski Wagner, Sara Ramezanian
- **标签**: `cs.AI` `cs.CY`
- **AI摘要**: 提出CourseGraph自动评估跨校课程重叠
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合BERT与随机森林进行课程对齐，方法清晰且实验充分

### 5. **[Decomposed Entailment for Factuality Checking and Hallucination Detection](https://arxiv.org/abs/2608.05823v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Achir Oukelmoun, Nasredine Semmar, Gaël De Chalendar
- **标签**: `cs.CL`
- **AI摘要**: 提出HallDetect无参考幻觉检测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有效且实验严谨，但属于特定任务的改进。

## Vision Language Models

### 1. **[VLMs for Videogame Data Annotation](https://arxiv.org/abs/2608.05949v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-06
- **作者**: Katrin Schmid, Iuri Frosio
- **标签**: `cs.AI` `cs.CV` `cs.LG`
- **AI摘要**: 研究利用VLM进行视频游戏帧序列奖励信号标注
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题有应用价值但方法创新性和实验严谨性有提升空间

## Multimodal

### 1. **[BioKD: Selective Physiology-to-Video Knowledge Distillation via Reliability Gate for Emotion Recognition](https://arxiv.org/abs/2608.06023v1)**
- **评分**: ⭐ 79/100 | **日期**: 2026-08-06
- **作者**: Bojing Hou, Ruohao Li, Yitong Zhu et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出生理到视频知识蒸馏框架以改进情绪识别
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入可靠性门控蒸馏机制，实验评估充分，实用性强。

## Agent

### 1. **[Contextual Information Policy Optimization for Search Agents](https://arxiv.org/abs/2608.06128v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Xingyu Guo, Wei Chen, Linlin Yang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出CIPO强化学习框架优化搜索智能体证据利用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖有效且实验充分，提升了大模型推理的证据真实性

### 2. **[Evaluating Investment Logic in Large Language Models: A Real-World Benchmark Towards Personalzied Financial Agents](https://arxiv.org/abs/2608.06108v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Yuanhong Jiang, Jingjie Zou, Zhenghong Lin et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出金融智能体基准InvestLogicBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好且实用度高，实验严谨，论文清晰度达标。

### 3. **[Enhancing Social Intelligence in LLMs with Hierarchical Reasoning and Utterance-Level Goal Rewarding](https://arxiv.org/abs/2608.05832v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Xiaofeng Wang, Kakam Chong, Shuai Xiao et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出TSR框架与LHRL-VGR算法增强大模型社交智能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性高，基准实验扎实，提升显著，写作清晰。

### 4. **[The Bitter Lesson of Tool Calling](https://arxiv.org/abs/2608.06370v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Ishan Patel, Sahil Sen, Elias Lumer et al.
- **标签**: `cs.CL`
- **AI摘要**: 评估并证明程序化工具调用优于原生JSON
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用有效，但局限于模拟数据与单中心验证

## Computer Vision

### 1. **[Floating Radiance Networks](https://arxiv.org/abs/2608.05920v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Krzysztof Byrski, Rafał Tobiasz, Grzegorz Wilczyński et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出浮动辐射网络实现神经渲染与光线追踪融合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新结合显示几何与神经场，实验充分，应用广泛

### 2. **[D-CLOT: Double Closed Loop Optimal Transport for Unsupervised Action Segmentation](https://arxiv.org/abs/2608.05877v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Elena Bueno-Benito, Mariella Dimiccoli
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出双闭环最优传输无监督动作分割方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决原型不一致问题，实验充分，效果显著。

### 3. **[UQ-Loc: Uncertainty-Aware LiDAR Scene Coordinate Regression](https://arxiv.org/abs/2608.06307v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Jacek Komorowski
- **标签**: `cs.CV`
- **AI摘要**: 提出了UQ-Loc不确定性感知的LiDAR场景坐标回归方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新点明确且实验扎实，属于经典的领域内改进工作。

### 4. **[OTLesMix: Wasserstein Barycenter and Optimal Transport Map for Synthetic Lesion Generation with Diverse Shapes and Locations](https://arxiv.org/abs/2608.06264v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Robin Trombetta, Carole Lartizien
- **标签**: `cs.CV` `cs.LG` `eess.IV`
- **AI摘要**: 提出OTLesMix方法生成多样化病灶用于医学图像分割
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合最优 transport 和 Wasserstein 重心，实验较充分。

### 5. **[Depth-Guided Video Object Counting in Crowded Scenes](https://arxiv.org/abs/2608.06236v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Yuanjing Xu, Xinyan Liu, Weidong Chen et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出深度引导的拥挤场景视频目标计数方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新引入深度信息解决遮挡计数问题，实验充分

## Machine Learning

### 1. **[Does Latent Context Help? A Controlled Evaluation of Inverse Reinforcement Learning in Arctic Shipping](https://arxiv.org/abs/2608.06105v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Vaishnav Vaidheeswaran, Dilith Jayakody, Biruk Ambaw et al.
- **标签**: `cs.LG` `cs.AI` `cs.MA`
- **AI摘要**: 评估逆强化学习在北极航运中的隐式上下文效果
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工作扎实且评估严谨，但在算法架构上创新性一般

### 2. **[Evidential Rule Learning for Interpretable Classification with Abstention](https://arxiv.org/abs/2608.05859v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-06
- **作者**: Javier Fumanal-Idocin, Javier Andreu-Perez
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出可解释的证据规则学习方法FERL
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性好，实验充分，理论与应用价值较高

### 3. **[The Tamed Subgradient Unadjusted Langevin Algorithm beyond Convexity](https://arxiv.org/abs/2608.06283v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Iosif Lytras, Nikolaos Makras, Sotirios Sabanis
- **标签**: `cs.LG` `math.OC` `math.PR`
- **AI摘要**: 提出SG-TULA算法并应用于大模型预训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论与应用创新俱佳，但属于进阶算法改进

### 4. **[Stochastic Dynamics on Persistence Diagram Space via Reinforcement Learning](https://arxiv.org/abs/2608.06276v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Farzana Nasrin
- **标签**: `stat.ML` `cs.LG` `math.AT`
- **AI摘要**: 提出基于强化学习的持久同调图随机动力学框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合强化学习与拓扑数据分析，理论与实验扎实

### 5. **[Hypothesis Testing with Conditional Queries: Learnability and the Value of Interaction](https://arxiv.org/abs/2608.06262v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-06
- **作者**: Zonghuan Xu
- **标签**: `cs.LG` `math.ST`
- **AI摘要**: 研究条件查询下的假设检验与交互的价值
<details>
<summary>原始摘要</summary>
