...
### 1. **[Forecasting Downstream Performance of LLMs With Proxy Metrics](https://arxiv.org/abs/2605.18607v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-18
- **作者**: Arkil Patel, Siva Reddy, Marius Mosbach et al.
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出基于专家轨迹的LLM性能预测代理指标
<details>
...
- **评分**: ⭐ 84/100 | **日期**: 2026-05-18
- **作者**: Payal Chandak, Victoria Alkin, David Wu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出评估大模型医疗伦理多元性的审计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论严谨，通过IRT模型提升了基准评估的科学性。

### 4. **[DashAttention: Differentiable and Adaptive Sparse Hierarchical Attention](https://arxiv.org/abs/2605.18753v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Yuxiang Huang, Nuno M. T. Gonçalves, Federico Alvetreti et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出可微自适应稀疏层级注意力机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过α-entmax实现端到端可微，提升长文本建模效率。

### 5. **[Predictable Confabulations: Factual Recall by LLMs Scales with Model Size and Topic Frequency](https://arxiv.org/abs/2605.18732v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Matthew L. Smith, Jonathan P. Shock, Samuel T. Segun et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 揭示LLM事实召回与模型规模及训练频率的缩放定律
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实证分析量化了事实召回的缩放规律，方法严谨且具有高实用价值。

## Natural Language Processing

### 1. **[Presupposition and Reasoning in Conditionals: A Theory-Based Study of Humans and LLMs](https://arxiv.org/abs/2605.18352v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Tara Azin, Yongan Yu, Raj Singh et al.
- **标签**: `cs.CL`
- **AI摘要**: 对比人类与LLM在条件句预设推理上的差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，揭示了LLM在语用推理上的局限性

### 2. **[Readers make targeted regressions to plausible errors in reanalysis of "noisy-channel garden-path" sentences](https://arxiv.org/abs/2605.18563v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-18
- **作者**: Thomas Hikaru Clark, Roger Levy, Edward Gibson
- **标签**: `cs.CL`
- **AI摘要**: 揭示了读者如何通过眼动回归纠正语言理解中的噪声错误。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究结合认知科学与语言模型，方法严谨，具有理论深度。

### 3. **[Ancient Greek to Modern Greek Machine Translation: A Novel Benchmark and Fine-Tuning Experiments on LLMs and NMT Models](https://arxiv.org/abs/2605.18504v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-18
- **作者**: Spyridon Mavromatis, Sokratis Sofianopoulos, Prokopis Prokopidis et al.
- **标签**: `cs.CL`
- **AI摘要**: 构建古希腊语-现代希腊语平行语料库并优化翻译模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建方法创新，实验详实，有效提升了低资源语言翻译性能。

### 4. **[GUT-IS: A Data-Driven Approach to Integrating Constructs and Their Relations in Information Systems](https://arxiv.org/abs/2605.18567v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-18
- **作者**: Maximilian Reinhardt, Jonas Scharfenberger, Burkhardt Funk
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出一种基于聚类与嵌入的IS领域构念整合方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，通过语义纯度与简约性的权衡解决构念不一致问题。

## Vision Language Models

### 1. **[Vision-OPD: Learning to See Fine Details for Multimodal LLMs via On-Policy Self-Distillation](https://arxiv.org/abs/2605.18740v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Qianhao Yuan, Jie Lou, Xing Yu et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 通过区域到全局自蒸馏提升多模态模型细粒度感知能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出无需外部工具的自蒸馏框架，有效提升视觉细节理解，方法创新且实验扎实。

### 2. **[CrossView Suite: Harnessing Cross-view Spatial Intelligence of MLLMs with Dataset, Model and Benchmark](https://arxiv.org/abs/2605.18621v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Wei Wang, Yuqian Yuan, Tianwei Lin et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出跨视角空间推理框架与数据集，提升MLLM空间智能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性解决了跨视角推理的数据、基准与模型对齐难题。

### 3. **[Starve to Perceive: Taming Lazy Perception in VLMs with Constrained Visual Bandwidth](https://arxiv.org/abs/2605.18603v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Yuhuan Wu, Cong Wei, Fangzhen Lin et al.
- **标签**: `cs.CV`
- **AI摘要**: 通过限制视觉带宽强制模型习得主动感知能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，有效解决了视觉语言模型的懒惰感知问题。

### 4. **[What is Holding Back Latent Visual Reasoning?](https://arxiv.org/abs/2605.18445v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: André G. Viveiros, Nuno Gonçalves, André F. T. Martins et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 揭示视觉推理中潜在标记的局限性与改进路径
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入剖析了潜在视觉推理失效的原因，实验严谨且见解深刻。

### 5. **[Geometry-Aware Uncertainty Coresets for Robust Visual In-Context Learning in Histopathology](https://arxiv.org/abs/2605.18419v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Franciskus Xaverius Erick, Johanna Paula Müller, Bernhard Kainz
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出GAUC方法优化病理学视觉上下文学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出几何感知核心集选择，显著提升VLM鲁棒性与准确度

## Diffusion Models

### 1. **[SURGE: Approximation-free Training Free Particle Filter for Diffusion Surrogate](https://arxiv.org/abs/2605.18745v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Lifu Wei, Yinuo Ren, Naichen Shi et al.
- **标签**: `stat.ML` `cs.LG` `math.NA`
- **AI摘要**: 提出无梯度扩散模型采样算法URGE
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Girsanov定理实现无梯度采样，理论严谨且性能优越。

### 2. **[Spectral Progressive Diffusion for Efficient Image and Video Generation](https://arxiv.org/abs/2605.18736v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Howard Xiao, Brian Chao, Lior Yariv et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出频域渐进扩散加速图像视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过频域分析实现高效生成，方法创新且实用性强。

### 3. **[SafeDiffusion-R1: Online Reward Steering for Safe Diffusion Post-Training](https://arxiv.org/abs/2605.18719v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Komal Kumar, Ankan Deria, Abhishek Basu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出在线强化学习框架实现扩散模型安全对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过CLIP嵌入引导实现高效安全对齐，性能提升显著

### 4. **[Continuous Diffusion Scales Competitively with Discrete Diffusion for Language](https://arxiv.org/abs/2605.18530v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Zhihan Yang, Wei Guo, Shuibai Zhang et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出RePlaid实现连续扩散模型高效扩展
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过架构对齐证明连续扩散模型具备强竞争力

## Multimodal

### 1. **[Seeing Together:Multi-Robot Cooperative Egocentric Spatial Reasoning with Multimodal Large Language Models](https://arxiv.org/abs/2605.18431v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-18
- **作者**: Kunyu Peng, Zhikun Zhou, Kailun Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出多机器人协作空间推理框架SP-CoR及基准数据集。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，数据集规模大，实验验证充分，方法论严谨。

### 2. **[EgoExoMem: Cross-View Memory Reasoning over Synchronized Egocentric and Exocentric Videos](https://arxiv.org/abs/2605.18734v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Ruiping Liu, Junwei Zheng, Yufan Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个跨视角视频记忆推理基准EgoExoMem
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入双视角推理框架，实验严谨且具有挑战性

### 3. **[Semantic Generative Tuning for Unified Multimodal Models](https://arxiv.org/abs/2605.18714v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Songsong Yu, Yuxin Chen, Ying Shan et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出SGT范式，以分割任务对齐多模态理解与生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过生成式代理任务弥合理解与生成鸿沟，方法创新且实验扎实。

### 4. **[OmniPro: A Comprehensive Benchmark for Omni-Proactive Streaming Video Understanding](https://arxiv.org/abs/2605.18577v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Ruixiang Zhao, Jie Yang, Zijie Xin et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个全模态主动流式视频理解基准OmniPro
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了主动流式评估空白，方法严谨且具有高实用价值。

### 5. **[WavFlow: Audio Generation in Waveform Space](https://arxiv.org/abs/2605.18749v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-18
- **作者**: Feiyan Zhou, Luyuan Wang, Shoufa Chen et al.
- **标签**: `cs.SD` `cs.CV`
- **AI摘要**: 提出WavFlow直接生成原始波形音频
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 绕过压缩直接建模波形，方法创新且实验扎实。

## Image Generation

### 1. **[Vision Foundation Models as Generalist Tokenizers for Image Generation](https://arxiv.org/abs/2605.18390v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-18
- **作者**: Anlin Zheng, Qi Han, Xin Wen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出VFMTok通用视觉分词器，提升生成效率与质量。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性利用冻结VFM实现高效分词，实验结果优异，方法论严谨。

### 2. **[Improved Baselines with Representation Autoencoders](https://arxiv.org/abs/2605.18324v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Jaskirat Singh, Boyang Zheng, Zongze Wu et al.
- **标签**: `cs.CV` `cs.AI` `cs.GR`
- **AI摘要**: 提出RAEv2，通过多层特征融合与重参数化提升扩散模型效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新显著，实验详实，大幅提升了训练效率与生成质量。
...
- **评分**: ⭐ 88/100 | **日期**: 2026-05-18
- **作者**: Shangwen Zhu, Qianyu Peng, Zhao Pu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出自然语言驱动的多实体交互视频世界模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入语言接口实现精细化控制，实验扎实且性能优异。

### 2. **[Aurora: Unified Video Editing with a Tool-Using Agent](https://arxiv.org/abs/2605.18748v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Yongsheng Yu, Ziyun Zeng, Zhiyuan Xiao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Aurora智能体框架实现视频编辑自动化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过VLM智能体解决视频编辑中的输入模糊问题，创新性强。

### 3. **[LongLive-2.0: An NVFP4 Parallel Infrastructure for Long Video Generation](https://arxiv.org/abs/2605.18739v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Yukang Chen, Luozhou Wang, Wei Huang et al.
- **标签**: `cs.CV` `cs.DC`
- **AI摘要**: 基于NVFP4的长视频生成并行训练与推理架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出NVFP4并行架构显著提升长视频生成效率，实验扎实。

### 4. **[Advancing Narrative Long Video Generation via Training-Free Identity-Aware Memory](https://arxiv.org/abs/2605.18733v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Jinzhuo Liu, Jiangning Zhang, Wencan Jiang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出IAMFlow框架实现长视频身份一致性生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入显式身份追踪，实验严谨且性能优越。

### 5. **[InstructAV2AV: Instruction-Guided Audio-Video Joint Editing](https://arxiv.org/abs/2605.18467v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Haojie Zheng, Yixin Yang, Siqi Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 首个指令引导的音视频联合编辑框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出了创新的音视频协同编辑方法，数据集与实验扎实。

## Agent

### 1. **[Overeager Coding Agents: Measuring Out-of-Scope Actions on Benign Tasks](https://arxiv.org/abs/2605.18583v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-18
- **作者**: Yubin Qu, Ying Zhang, Yanjun Zhang et al.
- **标签**: `cs.SE` `cs.AI` `cs.CL`
- **AI摘要**: 提出评估AI智能体越权行为的基准框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了智能体越权风险，方法严谨且具有重要安全价值。

### 2. **[Qumus: Realization of An Embodied AI Quantum Material Experimentalist](https://arxiv.org/abs/2605.18407v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-18
- **作者**: Lihan Shi, Zhaoyi Joy Zheng, Xinzhe Juan et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci` `cs.AI`
- **AI摘要**: 首个实现量子材料自主制备的具身智能实验系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 将具身智能与物理实验结合，实现了材料制备的自动化突破

### 3. **[Same Signal, Different Semantics: A Cross-Framework Behavioral Analysis of Software Engineering Agents](https://arxiv.org/abs/2605.18332v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-18
- **作者**: Wei Ma, Zhi Chen, Jingxu Gu et al.
- **标签**: `cs.SE` `cs.AI`
- **AI摘要**: 揭示软件工程智能体行为信号的框架依赖性与语义差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模实证研究揭示了框架对智能体行为的决定性影响，方法严谨且结论具有重要启示意义。

### 4. **[Code as Agent Harness](https://arxiv.org/abs/2605.18747v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Xuying Ning, Katherine Tieu, Dongqi Fu et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出以代码作为智能体基础设施的统一框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统梳理了代码在智能体系统中的核心作用，视角新颖且实用性强。

### 5. **[ESI-Bench: Towards Embodied Spatial Intelligence that Closes the Perception-Action Loop](https://arxiv.org/abs/2605.18746v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Yining Hong, Jiageng Liu, Han Yin et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出ESI-Bench基准以评估具身智能体的主动感知与决策能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过主动感知闭环评估具身智能，方法严谨且具有重要研究价值。

## Distributed Computing

### 1. **[A Readiness-Driven Runtime for Pipeline-Parallel Training under Runtime Variability](https://arxiv.org/abs/2605.18750v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Ruitao Liu, Xinyang Tian, Shuo Chen et al.
- **标签**: `cs.DC` `cs.LG`
- **AI摘要**: 提出RRFP运行时以解决流水线并行中的负载不均
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态调度解决流水线气泡问题，性能提升显著，实验扎实。

### 2. **[Ranking Opinions with Few States in Population Protocols](https://arxiv.org/abs/2605.18707v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Tom-Lukas Breitkopf, Julien Dallot, Antoine El-Hayek et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出CIRCLES协议解决多数派问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 显著降低了状态复杂度，理论贡献扎实且逻辑严密。

### 3. **[PopPy: Opportunistically Exploiting Parallelism in Python Compound AI Applications](https://arxiv.org/abs/2605.18697v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Stephen Mell, David Mell, Konstantinos Kallas et al.
- **标签**: `cs.DC` `cs.AI` `cs.PL`
- **AI摘要**: PopPy通过自动并行化提升复合AI应用性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统创新性解决Python并行化难题，实验效果显著。

### 4. **[EPIC: Abstraction and Polymorphism of In-Network Collectives on Ethernet](https://arxiv.org/abs/2605.18683v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Yitao Yuan, Jianglong Nie, Tianyu Bai et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出以太网内计算协议EPIC
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且验证严谨，有效解决以太网计算兼容性

### 5. **[Efficient Gradient Methods for Distributed Saddle Problems](https://arxiv.org/abs/2605.18604v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Ruichen Luo, Anton Rodomanov, Sebastian U. Stich
- **标签**: `math.OC` `cs.DC` `cs.MA`
- **AI摘要**: 提出分布式鞍点问题最优通信算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且通信复杂度达到最优，具有显著学术贡献。

## Information Retrieval

### 1. **[Will It Go Viral? Grounding Micro-Video Popularity Prediction on the Open Web](https://arxiv.org/abs/2605.18653v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Ryang Heo, Dongha Lee
- **标签**: `cs.MM`
- **AI摘要**: 引入外部网络上下文预测短视频热度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出新颖的开放网络接地方法，实验严谨且实用性强。

### 2. **[Improving BM25 Code Retrieval Under Fixed Generic Tokenization: Adaptive q-Log Odds as a Drop-In BM25 Fix](https://arxiv.org/abs/2605.18561v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Santosh Kumar Radha, Oktay Goktas
- **标签**: `cs.IR` `cs.AI` `cs.SE`
- **AI摘要**: 提出q-log odds改进BM25代码检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且提升显著，实验严谨，实用性强

### 3. **[Infini-News: Efficiently Queryable Access to 1.3 Billion Processed Common Crawl News Articles](https://arxiv.org/abs/2605.18337v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
...
- **评分理由**: 提供了高效的CC-News索引与处理工具，极大降低了研究门槛。

### 4. **[Traditional statistical representations outperform generative AI in identifying expert peer reviewers](https://arxiv.org/abs/2605.18752v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-18
- **作者**: Vicente Amado Olivo, Tereza Jerabkova, Jakub Klencki et al.
- **标签**: `cs.IR` `astro-ph.IM` `cs.DL`
- **AI摘要**: 统计方法在专家识别中优于大模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实证对比揭示了传统检索在细分领域优于生成式AI

### 5. **[Query-Conditioned Knowledge Alignment for Reliable Cross-System Medical Reasoning](https://arxiv.org/abs/2605.18570v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-18
- **作者**: Yan Jiao, Jingran Xu, Pin-Han Ho et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出查询条件化实体对齐框架，提升跨系统医疗推理可靠性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了医疗知识图谱的非对称对齐难题。
...
- **评分理由**: 通过几何验证改进了现有度量指标的可靠性

### 2. **[PIXLRelight: Controllable Relighting via Intrinsic Conditioning](https://arxiv.org/abs/2605.18735v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Miguel Farinha, Ronald Clark
- **标签**: `cs.CV` `cs.GR` `cs.LG`
- **AI摘要**: 提出一种基于内在条件控制的实时单图重光照方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理渲染与神经渲染，实现了高效且高质量的重光照。

### 3. **[CMAG: Concept-Scaffolded Retrieval for Marketplace Avatar Generation](https://arxiv.org/abs/2605.18680v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Rajeev Goel, Jason Ding, Phani Harish Wajjala et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CMAG框架实现语义驱动的3D虚拟形象生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且流程严谨，有效解决了多模态检索的兼容性问题。

### 4. **[StableHand: Quality-Aware Flow Matching for World-Space Dual-Hand Motion Estimation from Egocentric Video](https://arxiv.org/abs/2605.18553v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Huajian Zeng, Chaohua Yao, Yuantai Zhang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出质量感知流匹配模型，提升自我中心双手的运动估计精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过质量评估优化流匹配，在遮挡场景下效果显著，方法创新且实验扎实。

### 5. **[LESSViT: Robust Hyperspectral Representation Learning under Spectral Configuration Shift](https://arxiv.org/abs/2605.18541v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Haozhe Si, Yuxuan Wan, Yuqing Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出LESSViT实现跨传感器高光谱鲁棒表征学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过低秩分解优化注意力机制，有效解决了跨光谱配置泛化难题。

## Machine Learning

### 1. **[Learning Normal Representations for Blood Biomarkers](https://arxiv.org/abs/2605.18701v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-18
- **作者**: Aashna P. Shah, Michelle M. Li, Yash Lal et al.
- **标签**: `cs.LG` `q-bio.QM`
- **AI摘要**: 提出NORMA模型优化血液生物标志物个性化解读
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模数据验证了方法有效性，兼具创新与临床应用价值

### 2. **[Pocket Foundation Models: Distilling TFMs into CPU-Ready Gradient-Boosted Trees](https://arxiv.org/abs/2605.18654v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-18
- **作者**: Aditya Tanna, Nassim Bouarour, Mohamed Bouadi et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 通过蒸馏将大模型转化为高效树模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验规模大，论证严谨。

### 3. **[Generating Physically Consistent Molecules with Energy-Based Models](https://arxiv.org/abs/2605.18381v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-18
- **作者**: Christoph Griesbacher, Lea Bogensperger, Andreas Habring et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出EBMol模型实现物理一致分子生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入能量模型并结合流匹配，性能达到SOTA。

### 4. **[Learned Memory Attenuation in Sage-Husa Kalman Filters for Robust UAV State Estimation](https://arxiv.org/abs/2605.18704v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Kenan Majewski, Marcin Żugaj
- **标签**: `eess.SP` `cs.LG`
- **AI摘要**: 提出NDR-SHKF提升无人机状态估计鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合递归网络与自适应滤波，方法创新且实验扎实。

### 5. **[Distilling Tabular Foundation Models for Structured Health Data](https://arxiv.org/abs/2605.18702v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-18
- **作者**: Aditya Tanna, Nassim Bouarour, Mohamed Bouadi et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出抗泄露蒸馏法，提升医疗表格模型推理效率。
<details>
<summary>原始摘要</summary>
