...
### 1. **[Solve the Loop: Attractor Models for Language and Reasoning](https://arxiv.org/abs/2605.12466v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-12
- **作者**: Jacob Fein-Ashley, Paria Rashidinejad
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 引入吸引子模型实现迭代推理优化
<details>
...
- **评分理由**: 通过隐式微分实现高效循环推理，性能提升显著。

### 2. **[Geometric Factual Recall in Transformers](https://arxiv.org/abs/2605.12426v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-12
- **作者**: Shauli Ravfogel, Gilad Yehudai, Joan Bruna et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示Transformer几何事实记忆机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具开创性，深刻解析了MLP的记忆本质。

### 3. **[Pretraining Exposure Explains Popularity Judgments in Large Language Models](https://arxiv.org/abs/2605.12382v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-12
- **作者**: Jamshid Mozafari, Bhawna Piryani, Adam Jatowt
- **标签**: `cs.CL`
- **AI摘要**: 揭示LLM流行度偏见源于预训练数据暴露而非外部信号
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用OLMo与Dolma数据集进行大规模实证，方法严谨且结论具有重要理论价值。

### 4. **[To Whom Do Language Models Align? Measuring Principal Hierarchies Under High-Stakes Competing Demands](https://arxiv.org/abs/2605.12120v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-12
- **作者**: Fangyi Yu, Nabeel Seedat, Jonathan Richard Schwarz et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示了大模型在处理高风险专业冲突时的对齐层级偏差。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，针对高风险场景的对齐失效问题具有重要现实意义。
...
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出快慢权重学习框架，提升LLM持续学习与适应能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效缓解了灾难性遗忘问题。

## Natural Language Processing

### 1. **[PreScam: A Benchmark for Predicting Scam Progression from Early Conversations](https://arxiv.org/abs/2605.12243v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Weixiang Sun, Shang Ma, Yiyang Li et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出PreScam基准以预测诈骗演变过程
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了大规模高质量数据集，填补了动态诈骗检测的研究空白。

### 2. **[A Causal Language Modeling Detour Improves Encoder Continued Pretraining](https://arxiv.org/abs/2605.12438v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Rian Touchent, Eric de la Clergerie
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出通过CLM预训练绕道提升编码器领域适应能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，有效提升了生物医学编码器性能。

### 3. **[CAAFC: Chronological Actionable Automated Fact-Checker for misinformation / non-factual hallucination detection and correction](https://arxiv.org/abs/2605.12436v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Islam Eldifrawi, Shengrui Wang, Amine Trabelsi
- **标签**: `cs.AI`
- **AI摘要**: 提出CAAFC框架实现事实核查与自动纠错。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用性强，在事实核查领域具有显著改进。

### 4. **[Question Difficulty Estimation for Large Language Models via Answer Plausibility Scoring](https://arxiv.org/abs/2605.12398v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Jamshid Mozafari, Bhawna Piryani, Adam Jatowt
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 提出Q-DAPS方法通过答案合理性熵评估LLM问题难度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，在QA评估领域具有较好的实用价值。

### 5. **[A Comparative Study of Controlled Text Generation Systems Using Level-Playing-Field Evaluation Principles](https://arxiv.org/abs/2605.12395v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Michela Lorandi, Anya Belz
- **标签**: `cs.CL`
- **AI摘要**: 提出受控文本生成评估的公平基准体系。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过统一评估标准揭示了现有研究的性能偏差，方法严谨且具有重要指导意义。

## Vision Language Models

### 1. **[Beyond Localization: A Comprehensive Diagnosis of Perspective-Conditioned Spatial Reasoning in MLLMs from Omnidirectional Images](https://arxiv.org/abs/2605.12413v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Yuangong Chen, Wai Keung Wong, Jiaxing Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PCSR-Bench基准评估多模态模型空间推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过全景图像系统评估模型空间推理瓶颈，方法严谨且具有重要研究价值。

### 2. **[Reinforcing VLAs in Task-Agnostic World Models](https://arxiv.org/abs/2605.12334v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Yucen Wang, Rui Yu, Fengming Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出RAW-Dream实现任务无关的VLA强化学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过世界模型与VLM实现零样本任务适应，方法创新且实验扎实。

### 3. **[Images in Sentences: Scaling Interleaved Instructions for Unified Visual Generation](https://arxiv.org/abs/2605.12305v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Yabo Zhang, Kunchang Li, Dewei Zhou et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出INSET模型，将图像作为原生词汇嵌入文本以提升生成能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且实验充分，有效解决了复杂指令下的图像生成对齐问题。

### 4. **[Beyond Text Prompts: Visual-to-Visual Generation as A Unified Paradigm](https://arxiv.org/abs/2605.12271v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Yaofang Liu, Kangning Cui, Meng Chu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出视觉到视觉生成范式V2V-Zero
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验全面，有效解决了文本提示的局限性。

### 5. **[UHR-Micro: Diagnosing and Mitigating the Resolution Illusion in Earth Observation VLMs](https://arxiv.org/abs/2605.12237v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Shuo Ni, Tong Wang, Jing Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出UHR-Micro基准与MAP代理以解决遥感VLM分辨率幻觉问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对遥感领域小目标识别痛点，方法创新且实验设计严谨。

## Diffusion Models

### 1. **[Disentangled Sparse Representations for Concept-Separated Diffusion Unlearning](https://arxiv.org/abs/2605.12122v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Hyeonjin Kim, Hangyeol Jung, Heechan Yun et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出SAEParate实现扩散模型概念解耦与精准遗忘
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对比学习增强特征解耦，在遗忘任务上表现优异。

## Multimodal

### 1. **[MM-OptBench: A Solver-Grounded Benchmark for Multimodal Optimization Modeling](https://arxiv.org/abs/2605.12154v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-12
- **作者**: Zhong Li, Qi Huang, Yuxuan Zhu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出首个多模态优化建模基准MM-OptBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了多模态优化任务空白，评估严谨且具有高实用价值。
...
- **标签**: `cs.CV`
- **AI摘要**: 提出NEO-unify架构实现多模态理解与生成的统一。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入DVReward实现自反射生成，方法创新且实验扎实。

### 4. **[OmniNFT: Modality-wise Omni Diffusion Reinforcement for Joint Audio-Video Generation](https://arxiv.org/abs/2605.12480v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Guohui Zhang, XiaoXiao Ma, Jie Huang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出OmniNFT框架优化音视频联合生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对多模态强化学习的梯度与对齐问题提出创新方案，实验扎实。

### 5. **[Cross-Modal-Domain Generalization Through Semantically Aligned Discrete Representations](https://arxiv.org/abs/2605.12145v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Souptik Sen, Raneen Younis, Zahra Ahmadi
- **标签**: `cs.CV`
- **AI摘要**: 提出CoDAAR框架实现跨模态离散表征对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过离散对齐与重构解决了跨模态泛化难题，实验表现优异。

## Image Generation

### 1. **[When Policy Entropy Constraint Fails: Preserving Diversity in Flow-based RLHF via Perceptual Entropy](https://arxiv.org/abs/2605.12112v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Xiaofeng Tan, Jun Liu, Bin-Bin Gao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出感知熵约束解决流模型RLHF多样性坍缩问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入且实验结果显著，有效提升生成多样性。

### 2. **[MULTI: Disentangling Camera Lens, Sensor, View, and Domain for Novel Image Generation](https://arxiv.org/abs/2605.12134v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Sonali Godavarthy, Matthias Neuwirth-Trapp, Tim-Felix Faasch et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出MULTI框架实现图像成像因素解耦与可控生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地引入成像因素解耦，实验设计严谨且实用性强

### 3. **[UniCustom: Unified Visual Conditioning for Multi-Reference Image Generation](https://arxiv.org/abs/2605.12088v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Yiyan Xu, Qiulin Wang, Wenjie Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出UniCustom实现多参考图一致性生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过早期特征融合解决多主体身份混淆，方法创新且实验扎实。

### 4. **[DriftXpress: Faster Drifting Models via Projected RKHS Fields](https://arxiv.org/abs/2605.12183v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-12
- **作者**: Ali Falahati, Elliot Creager, Gautam Kamath et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出DriftXpress通过RKHS投影加速漂移模型训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新有效，通过低秩近似显著降低了训练成本。

## Video Generation

### 1. **[CausalCine: Real-Time Autoregressive Generation for Multi-Shot Video Narratives](https://arxiv.org/abs/2605.12496v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Yihao Meng, Zichen Liu, Hao Ouyang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CausalCine实现实时多镜头视频叙事生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过CAMR机制解决长视频生成中的连贯性与实时性问题，方法创新且实验扎实。

### 2. **[SyncDPO: Enhancing Temporal Synchronization in Video-Audio Joint Generation via Preference Learning](https://arxiv.org/abs/2605.12179v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Xin Cheng, Xihua Wang, Ying Ba et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SyncDPO提升音视频同步生成效果
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过规则化负样本构建优化DPO，方法高效且实验扎实。

## Agent

### 1. **[Rollout Cards: A Reproducibility Standard for Agent Research](https://arxiv.org/abs/2605.12131v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-12
- **作者**: Charlie Masters, Ziyuan Liu, Stefano V. Albrecht
- **标签**: `cs.AI`
- **AI摘要**: 提出Rollout Cards标准以提升智能体研究可复现性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对智能体评估不透明问题，提出标准化记录方案，具有极高实用价值。

### 2. **[ToolCUA: Towards Optimal GUI-Tool Path Orchestration for Computer Use Agents](https://arxiv.org/abs/2605.12481v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Xuhao Hu, Xi Zhang, Haiyang Xu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ToolCUA优化GUI与工具交互路径规划
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分阶段训练提升代理工具使用效率，实验效果显著。

### 3. **[Predicting Decisions of AI Agents from Limited Interaction through Text-Tabular Modeling](https://arxiv.org/abs/2605.12411v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Eilam Shapira, Moshe Tennenholtz, Roi Reichart
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出文本表格建模预测AI代理决策
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了代理行为预测精度。

### 4. **[Events as Triggers for Behavioral Diversity in Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.12388v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Hannes Büchi, Manon Flageat, Eduardo Sebastián et al.
- **标签**: `cs.MA` `cs.LG`
- **AI摘要**: 提出事件驱动的多智能体行为重配置框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过事件触发LoRA实现动态角色分配，创新性与实验严谨性俱佳。

### 5. **[Classifier Context Rot: Monitor Performance Degrades with Context Length](https://arxiv.org/abs/2605.12366v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Sam Martin, Fabien Roger
- **标签**: `cs.AI`
- **AI摘要**: 揭示长上下文下AI监控性能显著下降问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 量化了长文本对模型监控能力的负面影响，具有重要安全意义。

## Distributed Computing

### 1. **[NCCLZ: Compression-Enabled GPU Collectives with Decoupled Quantization and Entropy Coding](https://arxiv.org/abs/2605.12396v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Jiamin Wang, Zhijing Ye, Xiaodong Yu
- **标签**: `cs.DC`
- **AI摘要**: 提出解耦量化与熵编码的GPU集合通信框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地优化了通信瓶颈，实验数据详实且提升显著。

### 2. **[BatchBench: Toward a Workload-Aware Benchmark for Autoscaling Policies in Big Data Batch Processing -- A Proposed Framework](https://arxiv.org/abs/2605.12272v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Venkata Krishna Prasanth Budigi, Siri Chandana Sirigiri
- **标签**: `cs.IR` `cs.DB`
- **AI摘要**: 提出大数据批处理自动扩缩容基准框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了自动扩缩容评估标准缺失的空白，方法论严谨且实用。

### 3. **[Capacity Scalability of LEO Constellations With Dynamic Link Failures](https://arxiv.org/abs/2605.12146v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-12
- **作者**: Wei Li, Min Sheng
- **标签**: `cs.IT` `cs.DC` `cs.NI`
- **AI摘要**: 揭示LEO星座容量扩展性与链路故障的数学关系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，为星座规模优化提供了理论支撑。

## Information Retrieval

### 1. **[Task-Adaptive Embedding Refinement via Test-time LLM Guidance](https://arxiv.org/abs/2605.12487v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Ariel Gera, Shir Ashury-Tahan, Gal Bloch et al.
- **标签**: `cs.CL` `cs.IR` `cs.LG`
- **AI摘要**: 利用LLM反馈实时优化查询嵌入以提升检索性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验充分，论述逻辑清晰。

### 2. **[Reconnecting Fragmented Citation Networks with Semantic Augmentation](https://arxiv.org/abs/2605.12263v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Vu Thi Huong, Annika Buchholz, Imene Khebouri et al.
- **标签**: `cs.DL` `cs.AI`
- **AI摘要**: 利用LLM语义增强修复引文网络碎片化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合拓扑与语义的方法有效提升了引文网络完整性与结构解释力。

### 3. **[ORBIT: Preserving Foundational Language Capabilities in GenRetrieval via Origin-Regulated Merging](https://arxiv.org/abs/2605.12419v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-12
- **作者**: Neha Verma, Nikhil Mehta, Shao-Chuan Wang et al.
- **标签**: `cs.CL` `cs.IR` `cs.LG`
- **AI摘要**: 提出ORBIT方法缓解生成式检索中的灾难性遗忘。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过权重距离约束有效保留了模型基础能力，方法论严谨。

### 4. **[Unlocking Crowdsourcing for Ontology Matching Validation](https://arxiv.org/abs/2605.12226v1)**
...
- **评分理由**: 通过三种机制提升众包验证质量，具有实用价值

## Computer Vision

### 1. **[EgoForce: Forearm-Guided Camera-Space 3D Hand Pose from a Monocular Egocentric Camera](https://arxiv.org/abs/2605.12498v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Christen Millerdurai, Shaoxiang Wang, Yaxu Xie et al.
- **标签**: `cs.CV` `cs.GR`
- **AI摘要**: 提出基于前臂引导的单目自中心手部3D姿态重建框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入前臂表示与统一变换器，有效解决了深度模糊与跨设备泛化难题。

### 2. **[Elastic Attention Cores for Scalable Vision Transformers](https://arxiv.org/abs/2605.12491v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Alan Z. Song, Yinjie Chen, Mu Nan et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出VECA架构实现线性复杂度视觉Transformer
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入核心注意力机制，有效降低计算复杂度。

### 3. **[LychSim: A Controllable and Interactive Simulation Framework for Vision Research](https://arxiv.org/abs/2605.12449v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Wufei Ma, Chloe Wang, Siyi Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于UE5的交互式视觉仿真框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 降低了仿真门槛，且集成了LLM代理，具有高实用性与创新性。

### 4. **[GaitProtector: Impersonation-Driven Gait De-Identification via Training-Free Diffusion Latent Optimization](https://arxiv.org/abs/2605.12431v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Huiran Duan, Qian Zhou, Zhongliang Guo et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于扩散模型的步态去标识化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用预训练扩散先验实现无需训练的步态隐私保护，方法新颖且实验扎实。

### 5. **[SEMIR: Semantic Minor-Induced Representation Learning on Graphs for Visual Segmentation](https://arxiv.org/abs/2605.12389v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Luke James Miller, Yugyung Lee
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出基于图论的语义小图表示学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决医学图像分割中的稀疏结构与计算瓶颈问题

## Machine Learning

### 1. **[Reward Hacking in Rubric-Based Reinforcement Learning](https://arxiv.org/abs/2605.12474v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Anas Mahmoud, MohammadHossein Rezaei, Zihao Wang et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示了基于准则的RL奖励黑客现象及其局限性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验严谨，对RL对齐问题有重要参考价值

### 2. **[Aligning Flow Map Policies with Optimal Q-Guidance](https://arxiv.org/abs/2605.12416v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Christos Ziakas, Alessandra Russo, Avishek Joey Bose
- **标签**: `cs.LG`
- **AI摘要**: 提出流映射策略以加速强化学习决策
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在机器人任务中表现优异

### 3. **[Model-based Bootstrap of Controlled Markov Chains](https://arxiv.org/abs/2605.12410v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Ziwei Su, Imon Banerjee, Diego Klabjan
- **标签**: `stat.ML` `cs.LG` `math.OC`
- **AI摘要**: 提出受控马尔可夫链的模型引导自助法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且在离线强化学习中具有实用价值

### 4. **[Detecting overfitting in Neural Networks during long-horizon grokking using Random Matrix Theory](https://arxiv.org/abs/2605.12394v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Hari K. Prakash, Charles H Martin
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 利用随机矩阵理论检测神经网络过拟合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且具备理论深度，对模型监控有实际价值

### 5. **[Trust the Batch, On- or Off-Policy: Adaptive Policy Optimization for RL Post-Training](https://arxiv.org/abs/2605.12380v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Rasool Fakoor, Murdock Aubry, Nicholas Stranges et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出自适应批次优化目标，提升RL训练稳定性。
<details>
<summary>原始摘要</summary>
