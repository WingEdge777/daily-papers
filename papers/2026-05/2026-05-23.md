...
### 1. **[Evaluating Commercial AI Chatbots as News Intermediaries](https://arxiv.org/abs/2605.22785v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Mirac Suzgun, Emily Shen, Federico Bianchi et al.
- **标签**: `cs.CL`
- **AI摘要**: 评估AI聊天机器人新闻处理的准确性与地域偏差
<details>
...
- **评分理由**: 研究方法严谨，系统性揭示了AI在跨语言检索中的局限性。

### 2. **[Is Capability a Liability? More Capable Language Models Make Worse Forecasts When It Matters Most](https://arxiv.org/abs/2605.22672v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Nick Merrill, Jaeho Lee, Ezra Karger
- **标签**: `cs.AI`
- **AI摘要**: 大模型在极端预测任务中存在逆向扩展现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 揭示了模型能力与预测准确度在尾部风险下的负相关性，方法严谨且具有重要应用价值。

### 3. **[AMEL: Accumulated Message Effects on LLM Judgments](https://arxiv.org/abs/2605.22714v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-05-21
- **作者**: Sid-ali Temkit
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 揭示了大语言模型评估中的历史偏见效应及其规律。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模实验揭示了评估偏见，方法严谨且结论实用。

### 4. **[Vector Policy Optimization: Training for Diversity Improves Test-Time Search](https://arxiv.org/abs/2605.22817v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Ryan Bahlous-Boldi, Isha Puri, Idan Shenfeld et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出VPO算法，通过向量奖励优化提升模型多样性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验设计严谨，对推理搜索有显著贡献。

### 5. **[Gated DeltaNet-2: Decoupling Erase and Write in Linear Attention](https://arxiv.org/abs/2605.22791v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Ali Hatamizadeh, Yejin Choi, Jan Kautz
- **标签**: `cs.AI`
- **AI摘要**: 提出解耦擦除与写入的Gated DeltaNet-2
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦门控机制提升线性注意力模型性能，实验扎实。

## Natural Language Processing

### 1. **[Tokenisation via Convex Relaxations](https://arxiv.org/abs/2605.22821v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Jan Tempus, Philip Whittington, Craig W. Schmidt et al.
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出ConvexTok算法，通过凸优化实现词元化最优解。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且严谨，有效提升了词元化效率与模型性能。

### 2. **[Tokenization with Split Trees](https://arxiv.org/abs/2605.22705v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Craig W. Schmidt, Michael Krumdick, Adam Wiemerslage et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出ToaST分词法，优化压缩率并提升模型效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升了分词效率与模型性能。

### 3. **[Chinese sensorimotor and embodiment norms for 3,000 lexicalized concepts](https://arxiv.org/abs/2605.22616v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Jing Chen, Gábor Parti, Yin Zhong et al.
- **标签**: `cs.CL`
- **AI摘要**: 构建三千词汇感官知觉数据库
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补中文感官规范空白，方法严谨且验证充分

### 4. **[DeferMem: Query-Time Evidence Distillation via Reinforcement Learning for Long-Term Memory QA](https://arxiv.org/abs/2605.22411v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Jianing Yin, Tan Tang
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出DeferMem框架，通过RL优化长记忆问答的证据提取。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将检索与蒸馏解耦，实验效果显著且高效。

### 5. **[Moral Semantics Survive Machine Translation: Cross-Lingual Evidence from Moral Foundations Corpora](https://arxiv.org/abs/2605.22660v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Maciej Skorski
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 验证机器翻译在道德语义分类中的跨语言有效性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论扎实，通过多维度验证证明了跨语言迁移的可行性
...
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Jongseo Lee, Hyuntak Lee, Sunghun Kim et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出DeltaDirect解决视频大模型运动方向感知盲区问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 诊断深入，方法有效，显著提升了视频模型的方向理解能力。

### 2. **[Cambrian-P: Pose-Grounded Video Understanding](https://arxiv.org/abs/2605.22819v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Jihan Yang, Zifan Zhao, Xichen Pan et al.
- **标签**: `cs.CV`
- **AI摘要**: 引入相机位姿监督提升视频多模态模型空间推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过位姿回归头增强视频理解，实验扎实且效果显著。

### 3. **[SegCompass: Exploring Interpretable Alignment with Sparse Autoencoders for Enhanced Reasoning Segmentation](https://arxiv.org/abs/2605.22658v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Zhenyu Lu, Liupeng Li, Jinpeng Wang et al.
- **标签**: `cs.CV` `cs.LG` `cs.MM`
- **AI摘要**: 利用稀疏自编码器实现可解释的推理分割对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过SAE构建白盒对齐路径，方法创新且实验扎实。

### 4. **[What Does the Caption Really Say? Counterfactual Phrase Intervention for Compositional Data Selection in Vision-Language Pretraining](https://arxiv.org/abs/2605.22651v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Hyejin Go, Semi Lee, Hyesong Choi
- **标签**: `cs.CV`
- **AI摘要**: 提出CPI方法提升视觉语言模型组合性理解能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过反事实短语干预优化数据筛选，方法创新且实验扎实。

### 5. **[AtelierEval: Agentic Evaluation of Humans & LLMs as Text-to-Image Prompters](https://arxiv.org/abs/2605.22645v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Hanjun Luo, Zhimu Huang, Sylvia Chung et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出首个评估T2I提示词能力的基准AtelierEval与智能体评测框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了提示词评估空白，方法严谨且具备高相关性，具有显著学术价值。

## Diffusion Models

### 1. **[A Tutorial on Diffusion Theory: From Differential Equations to Diffusion Models](https://arxiv.org/abs/2605.22586v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Jiayi Fu, Yuxia Wang
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 系统阐述扩散模型的微分方程理论框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，为扩散模型提供了清晰的数学视角。

### 2. **[Uniform Diffusion Models Revisited: Leave-One-Out Denoiser and Absorbing State Reformulation](https://arxiv.org/abs/2605.22765v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Samson Gourevitch, Yazid Janati, Dario Shariatian et al.
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出留一法改进均匀扩散模型参数化与采样
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，有效弥补了UDM与MDM的性能差距，具有较高学术价值。

### 3. **[SeqLoRA: Bilevel Orthogonal Adaptation for Continual Multi-Concept Generation](https://arxiv.org/abs/2605.22743v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Javad Parsa, Enis Simsar, Amir Joudaki et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出SeqLoRA实现多概念生成，解决干扰与遗忘问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，有效提升多概念生成保真度与扩展性。

### 4. **[The Value of Covariance Matching in Gaussian DDPMs and the Lanczos Sampler](https://arxiv.org/abs/2605.22723v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Md Sahil Akhtar, Aymane El Gadarri, Vivek F. Farias et al.
- **标签**: `cs.LG` `cs.AI` `cs.IT`
- **AI摘要**: 提出Lanczos采样器实现全协方差匹配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新显著，通过Lanczos方法解决了计算瓶颈。

### 5. **[Live Music Diffusion Models: Efficient Fine-Tuning and Post-Training of Interactive Diffusion Music Generators](https://arxiv.org/abs/2605.22717v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Zachary Novack, Stephen Brade, Haven Kim et al.
- **标签**: `cs.SD` `cs.AI` `cs.LG`
- **AI摘要**: 提出LMDM实现高效实时音乐生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过KV缓存优化扩散模型，显著提升实时生成效率。

## Multimodal

### 1. **[AnyMo: Geometry-Aware Setup-Agnostic Modeling of Human Motion in the Wild](https://arxiv.org/abs/2605.22715v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Baiyu Chen, Zechen Li, Wilson Wongso et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出AnyMo实现穿戴式设备动作建模的通用化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过物理仿真与多模态对齐解决了传感器设置依赖问题

### 2. **[Beyond Acoustic Emotion Recognition: Multimodal Pathos Analysis in Political Speech Using LLM-Based and Acoustic Emotion Models](https://arxiv.org/abs/2605.22732v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Juergen Dietrich
- **标签**: `cs.AI` `cs.CL` `cs.HC`
- **AI摘要**: LLM在政治演讲情感分析中优于传统声学模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且对比严谨，但案例样本量较小。

### 3. **[FashionLens: Toward Versatile Fashion Image Retrieval via Task-Adaptive Learning](https://arxiv.org/abs/2605.22552v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Haokun Wen, Xuemeng Song, Xinghao Xie et al.
- **标签**: `cs.CV` `cs.MM`
- **AI摘要**: 提出FashionLens实现多任务时尚图像检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 框架创新且基准全面，但在模型架构上属于增量改进。

### 4. **[From Recognition to Reasoning: Benchmarking and Enhancing MLLMs on Real-World Receipt Document Understanding](https://arxiv.org/abs/2605.22413v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Yandi Wang, Libin Zhan, Ziwei Huang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ReceiptBench基准与两阶段训练框架提升文档理解能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了高质量数据集并引入GRPO优化，在文档理解任务上表现优异。

### 5. **[Seeing the Poem: Image-Semantic Detection of AI-Generated Modern Chinese Poetry with MLLMs](https://arxiv.org/abs/2605.22654v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-21
- **作者**: Shanshan Wang, Fengying Ye, Hanjia Lyu et al.
- **标签**: `cs.CL` `cs.CV`
- **AI摘要**: 提出图像语义引导的现代诗歌AI生成检测方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入图像辅助检测，实验结果优于基线，方法论证充分。

## Image Generation

### 1. **[MaSC: A Masked Similarity Metric for Evaluating Concept-Driven Generation](https://arxiv.org/abs/2605.22469v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Patryk Bartkowiak, Lennart Petersen, Bartosz Kotrys et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MaSC指标，通过掩码分解提升图像生成评估准确性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过空间分解评估概念保留与提示遵循，性能优于现有基线。

### 2. **[S2ED: From Story to Executable Descriptions for Consistency-Aware Story Illustration](https://arxiv.org/abs/2605.22448v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Sijing Yin, Jiamou Liu, Xiao Tang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出S2ED框架实现故事插画的一致性生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多智能体协作实现长文本到图像的一致性，方法创新且实验扎实。

### 3. **[DecQ: Detail-Condensing Queries for Enhanced Reconstruction and Generation in Representation Autoencoders](https://arxiv.org/abs/2605.22777v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Tianhang Wang, Yitong Chen, Wei Song et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出DecQ解决RAE重建与生成权衡问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过轻量级查询提升重建质量并加速生成，方法创新且实验扎实。

## Video Generation

### 1. **[WorldKV: Efficient World Memory with World Retrieval and Compression](https://arxiv.org/abs/2605.22718v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Jung Yi, Minjae Kim, Paul Hyunbin Cho et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出WorldKV实现高效长程视频生成一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入推理机制优化运动轨迹，提升了视频生成的物理合理性。

### 3. **[Cell Phantom Video Generation in Elliptical Fourier Descriptor Domain](https://arxiv.org/abs/2605.22563v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-21
- **作者**: Francesco Benedetto, Roberto Basla, Luca Magri et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于EFD域的细胞幻影视频生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过傅里叶描述符建模细胞形态演变，有效缓解标注数据匮乏问题。

## Agent

### 1. **[Superhuman Safe and Agile Racing through Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.22748v1)**
- **评分**: ⭐ 92/100 | **日期**: 2026-05-21
- **作者**: Ismail Geles, Leonard Bauersfeld, Markus Wulfmeier et al.
- **标签**: `cs.RO` `cs.AI` `cs.LG`
- **AI摘要**: 多智能体强化学习实现无人机超人竞速
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多智能体博弈实现高动态环境下的安全与敏捷控制，突破性显著。

### 2. **[Advancing Mathematics Research with AI-Driven Formal Proof Search](https://arxiv.org/abs/2605.22763v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: George Tsoukalas, Anton Kovsharov, Sergey Shirobokov et al.
- **标签**: `cs.AI`
- **AI摘要**: AI驱动形式化证明解决数学难题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 首次大规模验证AI解决开放数学问题的有效性

### 3. **[Self-Evolving Multi-Agent Systems via Decentralized Memory](https://arxiv.org/abs/2605.22721v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Guangya Hao, Yunbo Long, Zhuokai Zhao
- **标签**: `cs.MA`
- **AI摘要**: 提出去中心化记忆框架以提升多智能体系统性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论证明严谨，实验覆盖广泛，显著提升了MAS效率与性能。
...
- **作者**: Qianshu Cai, Yonggang Zhang, Xianzhang Jia et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出MOSS系统实现智能体源码级自我演化。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过源码重写解决结构性故障，创新性与实用性强。

### 5. **[Factored Diffusion Policies:Compositionally Generalized Robot Control with a Single Score Network](https://arxiv.org/abs/2605.22596v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-21
- **作者**: Sayan Mitra, Ege Yuceel, Noah Giles et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出因子化扩散策略实现机器人控制组合泛化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过共享网络实现因子化组合，理论严谨且实验效果显著。

## Distributed Computing

### 1. **[Monotone Erasure Codes](https://arxiv.org/abs/2605.22426v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Vivien Bammert, Annalisa Cimatti, Orestis Alpos et al.
- **标签**: `cs.IT` `cs.DC`
- **AI摘要**: 提出单调纠删码以支持广义容错。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，为区块链通信提供了高效新方案。

### 2. **[Nf-PEAK: Process-Based Energy Attribution for Nextflow Workflows on Kubernetes Clusters](https://arxiv.org/abs/2605.22393v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Philipp Thamm, Somayeh Mohammadi, Kathleen West et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出一种Kubernetes工作流能耗细粒度归因方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了集群能耗测量难题

### 3. **[AI-Driven Multi-Region Provisioning for Cloud Services Using Spot Fleets](https://arxiv.org/abs/2605.22778v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Javier Fabra, Enrique Molina-Giménez, Pedro García-López
- **标签**: `cs.DC`
- **AI摘要**: 基于AI的多区域云资源调度优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过预测模型实现跨区域竞价实例调度，显著降低成本且实验严谨。

### 4. **[KAPPS: A knowledge-based CPPS Architecture for the Circular Factory](https://arxiv.org/abs/2605.22457v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Etienne Hoffmann, Jan-Felix Klein, Sören Weindel et al.
- **标签**: `cs.AI` `eess.SY`
- **AI摘要**: 提出KAPPS架构以支持循环制造
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 设计科学方法论严谨，有效解决制造不确定性问题

### 5. **[Exploiting Multicast for Accelerating Collective Communication](https://arxiv.org/abs/2605.22428v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Chao Xu, Xu Zhang, Zihang Luo et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出MultiWrite机制优化集合通信
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多播技术有效降低通信冗余，提升训练效率

## Information Retrieval

### 1. **[ChronoMedKG: A Temporally-Grounded Biomedical Knowledge Graph and Benchmark for Clinical Reasoning](https://arxiv.org/abs/2605.22734v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-21
- **作者**: Md Shamim Ahmed, Farzaneh Firoozbakht, Lukas Galke Poech et al.
- **标签**: `cs.CL`
- **AI摘要**: 构建首个时序生物医学知识图谱及临床推理基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入时序维度，方法严谨且实用价值高

### 2. **[One prompt is not enough: Instruction Sensitivity Undermines Embedding Model Evaluation](https://arxiv.org/abs/2605.22544v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Yevhen Kostiuk, Kenneth Enevoldsen
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 揭示指令嵌入模型对提示词的敏感性及评估局限
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究严谨，揭示了当前评估基准的系统性偏差。

### 3. **[Diversed Model Discovery via Structured Table Discovery](https://arxiv.org/abs/2605.22766v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Zhengyuan Dong, Renée J. Miller
- **标签**: `cs.IR`
- **AI摘要**: 提出基于结构化表格的模型检索框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用表格数据提升模型检索的多样性与准确度，方法严谨且创新。

### 4. **[BeLink: Biomedical Entity Linking Meets Generative Re-Ranking](https://arxiv.org/abs/2605.22501v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Darya Shlyk, Stefano Montanelli, Lawrence Hunter
- **标签**: `cs.CL` `cs.AI` `cs.IR`
- **AI摘要**: 提出BeLink框架优化生物医学实体链接效率与精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过指令微调优化重排序，在性能与效率上均有显著提升。

### 5. **[Matching with Deliberation: Test-Time Evolutionary Hierarchical Multi-Agents for Zero-Shot Compositional Image Retrieval](https://arxiv.org/abs/2605.22478v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Xingtian Pei, Yukun Song, Changwei Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PDF框架实现零样本组合图像检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入多智能体与测试时扩展定律，性能显著提升。

## Computer Vision

### 1. **[Sensor2Sensor: Cross-Embodiment Sensor Conversion for Autonomous Driving](https://arxiv.org/abs/2605.22809v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Jiahao Wang, Bo Sun, Yijing Bai et al.
- **标签**: `cs.CV`
- **AI摘要**: 利用扩散模型将行车记录仪视频转换为多模态传感器数据
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过4DGS实现跨模态转换，显著提升自动驾驶数据多样性

### 2. **[Spectral Tail Auxiliary Learning for AI-Generated Image Detection](https://arxiv.org/abs/2605.22751v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Xingyi Li, Jiahui Zhang, Yiheng Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出STAL框架，利用频谱尾部特征提升AI生成图像检测能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过频谱分析发现尾部异常，方法创新且无推理开销，实验扎实。

### 3. **[H-Flow: Self-supervised Human Scene Flow via Physics-inspired Joint Multi-modal Learning](https://arxiv.org/abs/2605.22629v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Zhanbo Huang, Xiaoming Liu, Yu Kong
- **标签**: `cs.CV`
- **AI摘要**: 提出物理驱动的自监督人体场景流估计方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理先验与多模态学习，有效解决非刚性形变估计难题。

### 4. **[MoSA: Motion-constrained Stress Adaptation for Mitigating Real-to-Sim Gap in Continuum Dynamics via Learning Residual Anisotropy](https://arxiv.org/abs/2605.22597v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Jiaxu Wang, Junhao He, Jingkai Sun et al.
- **标签**: `cs.LG` `cs.AI` `cs.GR`
- **AI摘要**: 提出MoSA框架以学习残差各向异性，缩小物理仿真差距。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理先验与神经网络，在仿真建模上具有创新性与实用性。

### 5. **[Rethinking Noise-Robust Training for Frozen Vision Foundation Models: A Cross-Dataset Benchmark with a Case Study of Small-Loss Failure](https://arxiv.org/abs/2605.22591v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Zitong Li, Haoyu Wang
- **标签**: `cs.CV`
- **AI摘要**: 冻结视觉模型噪声标签学习基准研究
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验规模宏大，深入剖析了小损失假设的局限性。

## Machine Learning

### 1. **[Towards a General Intelligence and Interface for Wearable Health Data](https://arxiv.org/abs/2605.22759v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Girish Narayanswamy, Maxwell A. Xu, A. Ali Heydari et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出可穿戴设备通用健康基础模型与智能体架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模预训练与智能体协同提升了健康预测的泛化能力

### 2. **[A Martingale Kernel Independence Test](https://arxiv.org/abs/2605.22549v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Felix Laumann, Zhaolu Liu, Mauricio Barahona
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出鞅核独立性检验，实现高效无置换推断。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新显著，计算效率提升巨大，理论严谨。

### 3. **[Represented Is Not Computed: A Causal Test of Candidate Algorithmic Intermediates in a Transformer](https://arxiv.org/abs/2605.22488v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Ishita Darade, Sushrut Thorat
- **标签**: `cs.LG`
- **AI摘要**: 揭示探针与因果机制在算法解释上的差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果测试挑战了探针法在解释模型内部机制的可靠性

### 4. **[When Stronger Triggers Backfire: A High-Dimensional Theory of Backdoor Attacks](https://arxiv.org/abs/2605.22481v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Donald Flynn, Hadas Yaron Goldhirsh, Jonathan P. Keating et al.
- **标签**: `cs.LG` `math.ST`
- **AI摘要**: 揭示高维后门攻击中触发器强度的反直觉效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具备高维统计分析的深度，结论具有启发性。

### 5. **[Lost in Tokenization: Fundamental Trade-offs in Graph Tokenization for Transformers](https://arxiv.org/abs/2605.22471v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Maya Bechler-Speicher, Gilad Yehudai, Gil Harari et al.
- **标签**: `cs.LG`
- **AI摘要**: 揭示图Transformer分词机制的理论权衡与表达限制
<details>
<summary>原始摘要</summary>
