...
### 1. **[Tool Calling is Linearly Readable and Steerable in Language Models](https://arxiv.org/abs/2605.07990v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Zekun Wu, Ze Wang, Seonglae Cho et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 揭示大模型工具调用内部表征的线性可读性与可控性
<details>
...
- **评分理由**: 通过激活干预实现高精度工具切换，机制解释深入且实用。

### 2. **[CktFormalizer: Autoformalization of Natural Language into Circuit Representations](https://arxiv.org/abs/2605.07782v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Jing Xiong, Qi Han, Chenchen Ding et al.
- **标签**: `cs.CL` `cs.PL`
- **AI摘要**: 利用Lean 4实现硬件代码自动形式化验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过依赖类型系统解决硬件生成中的逻辑错误，方法严谨且实用性极高。

### 3. **[LLM hallucinations in the wild: Large-scale evidence from non-existent citations](https://arxiv.org/abs/2605.07723v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Zhenyue Zhao, Yihe Wang, Toby Stuart et al.
- **标签**: `cs.DL` `cs.AI` `cs.CY`
- **AI摘要**: 揭示大模型导致学术引用幻觉激增及其不平等影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模实证研究揭示了AI幻觉对科研诚信的系统性威胁

### 4. **[Gradient Starvation in Binary-Reward GRPO: Why Group-Mean Centering Fails and Why the Simplest Fix Works](https://arxiv.org/abs/2605.07689v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Wenhua Nie, Jianan Wu, Junlin Liu et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出Sign优势函数解决GRPO梯度饥饿问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论证明严谨，实验效果显著，有效改进了RLVR训练。

### 5. **[The Coupling Tax: How Shared Token Budgets Undermine Visible Chain-of-Thought Under Fixed Output Limits](https://arxiv.org/abs/2605.07686v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Wenhua Nie, Junlin Liu, Jianan Wu et al.
- **标签**: `cs.LG`
- **AI摘要**: 揭示推理预算耦合对模型性能的负面影响及缓解方案。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入分析推理预算分配问题，理论与实验扎实，实用性强。

## Natural Language Processing

### 1. **[Future Validity is the Missing Statistic: From Impossibility to $Φ$-Estimation for Grammar-Faithful Speculative Decoding](https://arxiv.org/abs/2605.07698v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Wenhua Nie, Zijie Meng, Kun Zou et al.
- **标签**: `cs.LG` `cs.IT`
- **AI摘要**: 提出未来有效性函数修正投机采样分布偏差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新深刻，解决了语法约束生成的采样偏差问题

### 2. **[Trajectory as the Teacher: Few-Step Discrete Flow Matching via Energy-Navigated Distillation](https://arxiv.org/abs/2605.07924v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Amin Karimi Monsefi, Dominic Culver, Nikhil Bhendawade et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出TS-DFM通过能量引导优化轨迹，提升离散流匹配效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决轨迹瓶颈，实验结果显著，方法论严谨。

### 3. **[PolySQL: Scaling Text-to-SQL Evaluation Across SQL Dialects via Automated Backend Isomorphism](https://arxiv.org/abs/2605.07796v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Yotam Perlitz, Elad Venezian, Corentin Royer et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出PolySQL实现跨数据库方言的SQL评估
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且解决了跨方言评估的实际痛点，实验严谨。

### 4. **[Accurate and Efficient Statistical Testing for Word Semantic Breadth](https://arxiv.org/abs/2605.08048v1)**
...
- **评分理由**: 方法创新且严谨，有效解决了语义方向偏差导致的假阳性问题。

### 5. **[Uncertainty-Aware Structured Data Extraction from Full CMR Reports via Distilled LLMs](https://arxiv.org/abs/2605.08045v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Yi Yu, Parker Martin, Zhenyu Bu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出CMR报告结构化提取与置信度评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合蒸馏模型与不确定性量化，临床应用价值高。

## Vision Language Models

### 1. **[MedVIGIL: Evaluating Trustworthy Medical VLMs Under Broken Visual Evidence](https://arxiv.org/abs/2605.07919v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Hanqi Jiang, Junhao Chen, Yi Pan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MedVIGIL评估医疗VLM的视觉证据鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 临床专家构建的高质量基准，显著提升了医疗模型评估的严谨性。

### 2. **[One Token Per Frame: Reconsidering Visual Bandwidth in World Models for VLA Policy](https://arxiv.org/abs/2605.07931v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Zuojin Tang, Shengchao Yuan, Xiaoxin Bai et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出OneWM-VLA，通过单token压缩实现高效长程规划。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升了VLA模型长程任务性能。

### 3. **[Semantic-Aware Adaptive Visual Memory for Streaming Video Understanding](https://arxiv.org/abs/2605.07897v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Hang Wu, Sherin Mary Mathews, Yujun Cai et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出语义感知流式视频记忆框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过语义引导与动态检索显著提升视频理解效率与性能

### 4. **[Video Understanding Reward Modeling: A Robust Benchmark and Performant Reward Models](https://arxiv.org/abs/2605.07872v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Yuancheng Wei, Linli Yao, Lei Li et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出视频奖励模型基准VURB与数据集VUP-35K
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了视频理解奖励模型的新基准与数据集，方法严谨且贡献显著。

### 5. **[GazeVLM: Active Vision via Internal Attention Control for Multimodal Reasoning](https://arxiv.org/abs/2605.07817v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Brown Ebouky, Gabriele Carrino, Niccolo Avogaro et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出GazeVLM，通过注视标记实现主动视觉推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏与正则化有效解决多任务对齐与奖励稀疏问题

### 3. **[HEART: Hyperspherical Embedding Alignment via Kent-Representation Traversal in Diffusion Models](https://arxiv.org/abs/2605.07973v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Arani Roy, Shristi Das Biswas, Kaushik Roy
- **标签**: `cs.CV`
- **AI摘要**: 基于Kent分布的扩散模型超球面编辑框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用超球面几何特性实现无需微调的精准图像编辑

### 4. **[When Diffusion Model Can Ignore Dimension: An Entropy-Based Theory](https://arxiv.org/abs/2605.07969v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Ahmad Aghapour, Erhan Bayraktar
- **标签**: `cs.LG` `cs.IT`
- **AI摘要**: 提出基于熵的扩散模型收敛理论，解释高维采样效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，从信息论视角解释了扩散模型维度无关性。

### 5. **[BRIDGE: Background Routing and Isolated Discrete Gating for Coarse-Mask Local Editing](https://arxiv.org/abs/2605.07846v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Peilin Xiong, Honghui Yuan, Junwen Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出BRIDGE架构解决局部编辑中掩码形状偏差问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了多源数据碎片化问题，实用性与工程价值高

### 2. **[STARFlow2: Bridging Language Models and Normalizing Flows for Unified Multimodal Generation](https://arxiv.org/abs/2605.08029v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Ying Shen, Tianrong Chen, Yuan Gao et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出STARFlow2统一多模态生成架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过归一化流与LLM架构融合，实现高效多模态生成。

### 3. **[Anisotropic Modality Align](https://arxiv.org/abs/2605.07825v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Xiaomin Yu, Yijiang Li, Yuhui Zhang et al.
- **标签**: `cs.MM` `cs.CV`
- **AI摘要**: 提出AnisoAlign框架以修正模态间各向异性偏差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过几何分析解决模态鸿沟，理论与实验均表现扎实

## Image Generation

### 1. **[SCOPE: Structured Decomposition and Conditional Skill Orchestration for Complex Image Generation](https://arxiv.org/abs/2605.08043v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-08
- **作者**: Tianfei Ren, Zhipeng Yan, Yiming Zhao et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出SCOPE框架以解决复杂图像生成的语义一致性难题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过结构化分解与技能编排提升了生成意图的实现率，方法创新且评估严谨。

### 2. **[What Matters for Diffusion-Friendly Latent Manifold? Prior-Aligned Autoencoders for Latent Diffusion](https://arxiv.org/abs/2605.07915v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Zhengrong Yue, Taihang Hu, Mengting Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PAE优化潜在空间以提升扩散模型生成质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过量化潜在流形属性并引入先验对齐，显著提升了生成效率与质量。
...
- **评分理由**: 引入自适应路由与增强网格，显著提升生成质量与可控性

### 2. **[SARA: Semantically Adaptive Relational Alignment for Video Diffusion Models](https://arxiv.org/abs/2605.07800v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Jiesong Lian, Zixiang Zhou, Ruizhe Zhong et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SARA通过语义自适应对齐提升视频扩散模型生成质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入语义显著性路由机制，有效提升了文本对齐与运动质量

### 3. **[OphEdit: Training-Free Text-Guided Editing of Ophthalmic Surgical Videos](https://arxiv.org/abs/2605.07695v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Ritul Jangir, Arkya Jyoti Bagchi, Aiman Farooq et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个眼科手术视频零训练文本编辑框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，解决了医疗视频编辑的结构与时序一致性难题。
...
- **AI摘要**: 揭示长记忆导致LLM智能体协作意图下降的记忆诅咒现象。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究视角独特且实验严谨，揭示了长上下文对协作的负面影响。

### 2. **[Reason to Play: Behavioral and Brain Alignment Between Frontier LRMs and Human Game Learners](https://arxiv.org/abs/2605.08019v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Botos Csaba, Sreejan Kumar, Austin Tudor David Andrews et al.
- **标签**: `cs.AI` `q-bio.NC`
- **AI摘要**: LRM在人类游戏学习行为与脑活动预测上表现优异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究结合fMRI与游戏行为，论证了LRM作为人类认知计算模型的潜力，方法严谨且创新性强。

### 3. **[Ask Early, Ask Late, Ask Right: When Does Clarification Timing Matter for Long-Horizon Agents?](https://arxiv.org/abs/2605.07937v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Anmol Gulati, Hariom Gupta, Elias Lumer et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示长程智能体澄清时机对任务成功率的影响。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模实验量化了澄清时机与任务类型的关系，方法严谨且具高实用价值。

### 4. **[TraceFix: Repairing Agent Coordination Protocols with TLA+ Counterexamples](https://arxiv.org/abs/2605.07935v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Shuren Xia, Qiwei Li, Taqiya Ehsan et al.
- **标签**: `cs.AI` `cs.MA`
- **AI摘要**: 利用TLA+验证提升多智能体协作协议安全性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合形式化验证与LLM，显著降低死锁并提升鲁棒性。

### 5. **[ADKO: Agentic Decentralized Knowledge Optimization](https://arxiv.org/abs/2605.07863v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-08
- **作者**: Lucas Nerone Rillo, Zhanhong Jiang, Nastaran Saadati et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出一种去中心化智能体知识优化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析严谨，结合了贝叶斯优化与智能体协作，创新性强。

## Distributed Computing

### 1. **[Stencil Computations on Cerebras Wafer-Scale Engine](https://arxiv.org/abs/2605.07954v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Elia Belli, Daniele De Sensi
- **标签**: `cs.DC` `cs.CE` `cs.ET`
- **AI摘要**: 提出CStencil框架，实现WSE-3上高性能模板计算。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过架构重构显著提升计算效率，实验对比严谨且结果突出。

### 2. **[\mathsf{VISTA}: Decentralized Machine Learning in Adversary Dominated Environments](https://arxiv.org/abs/2605.07841v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Hanzaleh Akbari Nodehi, Parsa Moradi, Soheil Mohajer et al.
- **标签**: `cs.LG` `cs.AI` `cs.DC`
- **AI摘要**: 提出VISTA算法解决对抗环境下的去中心化学习问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入激励机制处理多数对抗节点，理论与实验扎实。

### 3. **[Accelerating Precise End-to-End Simulation: Latency-Sensitive Many-core System Modeling](https://arxiv.org/abs/2605.07750v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Yinrong Li, Zexin Fu, Yichao Zhang et al.
- **标签**: `cs.AR` `cs.DC`
- **AI摘要**: 提出一种高精度多核架构仿真建模方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 仿真效率显著提升且精度高，对硬件设计有实用价值。

### 4. **[On the Tradeoffs of On-Device Generative Models in Federated Predictive Maintenance Systems](https://arxiv.org/abs/2605.07860v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Usevalad Milasheuski, Piero Baraldi, Enrico Zio et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 联邦生成模型在预测性维护中的权衡分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统评估了不同生成模型在联邦环境下的性能与通信权衡

### 5. **[A Scalable Recipe on SuperMUC-NG Phase 2: Efficient Large-Scale Training of Language Models](https://arxiv.org/abs/2605.07726v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-08
- **作者**: Ajay Navilarekal Rajgopal, Nikolai Solmsdorf
- **标签**: `cs.DC`
- **AI摘要**: 在SuperMUC-NG上实现大模型高效分布式训练方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提供了实用的HPC大模型训练指南，实验严谨且具有高复用性。

## Information Retrieval

### 1. **[TRACE: Tourism Recommendation with Accountable Citation Evidence](https://arxiv.org/abs/2605.07677v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Zixu Zhao, Sijin Wang, Yu Hou et al.
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 提出可追溯旅游推荐基准TRACE
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入证据引用与拒绝恢复机制，显著提升了推荐系统的可信度与实用性。

### 2. **[Conformal Path Reasoning: Trustworthy Knowledge Graph Question Answering via Path-Level Calibration](https://arxiv.org/abs/2605.08077v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Shuhang Lin, Chuhao Zhou, Xiao Lin et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出CPR框架提升KGQA预测的置信度与效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过共形预测改进路径推理，理论严谨且实验效果显著。

### 3. **[FAVOR: Efficient Filter-Agnostic Vector ANNS Based on Selectivity-Aware Exclusion Distances](https://arxiv.org/abs/2605.07770v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Junjie Song, Yu Liu, Guoyu Hu et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出FAVOR算法优化混合向量检索效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合SSM与稀疏注意力，在多项任务中实现性能与效率平衡。

### 2. **[PET-Adapter: Test-Time Domain Adaptation for Full and Limited-Angle PET Image Reconstruction](https://arxiv.org/abs/2605.08030v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Rüveyda Yilmaz, Yuli Wu, Johannes Stegmaier et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出PET-Adapter实现PET图像重建的测试时域自适应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验设计严谨，显著提升了重建效率。

### 3. **[MPD$^2$-Router: Mask-aware Multi-expert Prior-regularized Dual-head Deferral Router in Glaucoma Screening and Diagnosis](https://arxiv.org/abs/2605.08024v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Wenxin Zhan
- **标签**: `cs.AI`
- **AI摘要**: 提出多专家协同的青光眼筛查分流框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且考虑临床约束，实验验证充分。

### 4. **[SphereVAD: Training-Free Video Anomaly Detection via Geodesic Inference on the Unit Hypersphere](https://arxiv.org/abs/2605.08003v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Chao Huang, Penfei Wei, Wei Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于超球面几何推理的零样本视频异常检测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出无需训练的几何推理方法，实验效果优异。

### 5. **[Seeing Across Skies and Streets: Feedforward 3D Reconstruction from Satellite, Drone, and Ground Images](https://arxiv.org/abs/2605.07978v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Qiwei Wang, Zhongyao Tuo, Xianghui Ze et al.
- **标签**: `cs.CV`
- **AI摘要**: 引入无人机视角实现跨视图3D重建与定位
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入中间视角解决跨视图定位的3D结构缺失问题，方法创新且实验扎实。

## Machine Learning

### 1. **[Physics-Informed Reduced-Order Operator Learning for Hyperelasticity in Continuum Micromechanics](https://arxiv.org/abs/2605.07738v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Hamidreza Eivazi, Henning Wessels
- **标签**: `physics.comp-ph` `cs.LG`
- **AI摘要**: 提出结合EquiNO与Q-DEIM的超弹性微观力学算子学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合降阶模型与物理约束，显著提升计算效率与精度。

### 2. **[Reinforcement Learning for Exponential Utility: Algorithms and Convergence in Discounted MDPs](https://arxiv.org/abs/2605.08053v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
...
- **评分理由**: 理论基础扎实，填补了风险敏感RL算法的空白。

### 3. **[Don't Get Your Kroneckers in a Twist: Gaussian Processes on High-Dimensional Incomplete Grids](https://arxiv.org/abs/2605.08036v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Mads Greisen Højlund, August Smart Lykke-Møller, Henry Moss et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出CUTS-GPR实现高维大规模高斯过程回归
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且在大规模数据上验证了高效性

### 4. **[PropSplat: Map-Free RF Field Reconstruction via 3D Gaussian Propagation Splatting](https://arxiv.org/abs/2605.08035v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: William Bjorndahl, Maninder Pal Singh, Farhad Nouri et al.
- **标签**: `eess.SP` `cs.LG`
- **AI摘要**: 提出无需地图的RF场重建方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验严谨且在多场景下表现优越。

### 5. **[Semiparametric Efficient Test for Interpretable Distributional Treatment Effects](https://arxiv.org/abs/2605.08034v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Houssam Zenati, Arthur Gretton
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出DR-ME实现分布处理效应的高效可解释检验
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论严谨且具有创新性，在因果推断领域有较好应用价值。
