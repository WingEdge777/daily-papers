...
### 1. **[Convergence Without Understanding: When Language Models Agree on Representations but Disagree on Reasoning](https://arxiv.org/abs/2605.23315v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-22
- **作者**: Muhammad Usama, Dong Eui Chang
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 揭示大模型表征趋同但推理策略存在本质差异
<details>
...
- **评分理由**: 理论创新性强，通过信息论视角解释了模型退化现象。

### 3. **[It's the humans, not the data: Geopolitical bias in LLMs originates in post-training, amplified by the language of the prompt](https://arxiv.org/abs/2605.23825v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-22
- **作者**: Stuart Bladon, Brinnae Bent
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 研究发现大模型地缘偏见源于后训练而非预训练数据。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对比基座与对话模型，揭示了对齐过程对偏见的塑造作用，方法严谨且结论具有重要意义。

### 4. **[Instance-Optimal Estimation with Multiple LLM Judges on a Budget](https://arxiv.org/abs/2605.23362v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-22
- **作者**: Junghyun Lee, Sanghwa Kim, Yassir Jedra et al.
- **标签**: `cs.LG` `cs.IT` `math.ST`
- **AI摘要**: 提出LLM评估的预算分配最优估计算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，解决了LLM评估成本与精度的权衡问题。

### 5. **[Training-Free Looped Transformers](https://arxiv.org/abs/2605.23872v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Lizhang Chen, Jonathan Li, Chen Liang et al.
- **标签**: `cs.LG` `math.NA` `stat.ML`
- **AI摘要**: 提出无需训练的循环Transformer推理方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过ODE视角实现推理时循环，显著提升模型性能且无需微调。

## Natural Language Processing

### 1. **[Structure-Guided Entity Resolution: Fine-Tuning LLMs for Robust Name Matching in Complex Linguistic Contexts](https://arxiv.org/abs/2605.23597v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-22
- **作者**: Shivam Chourasia, Hitesh Kapoor, Nilesh Patil
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出结构引导的LLM微调框架以提升跨语言实体匹配精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且在工业级大规模数据集上验证了极高实用价值。

### 2. **[OnePred: Next-Query Prediction via Recursive Intent Memory in Multi-Turn Conversations](https://arxiv.org/abs/2605.23668v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Jiangwang Chen, Bowen Zhang, Zixin Song et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出递归意图记忆模型实现高效预测用户下一次查询
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过递归记忆压缩历史，有效平衡了预测质量与计算效率。

### 3. **[Asking For An Old Friend: Diagnosing and Mitigating Temporal Failure Modes in LLM-based Statutory Question Answering](https://arxiv.org/abs/2605.23497v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Max Prior, Andreas Schultz, Matthias Grabmair
- **标签**: `cs.CL`
- **AI摘要**: 提出法律问答时效性评估基准及RAG改进方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对法律时效性痛点，实验严谨且方案实用性强。

### 4. **[Multilingual Knowledge Transfer under Data Constraints via Lexical Interventions](https://arxiv.org/abs/2605.23885v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-22
- **作者**: Anastasiia Sedova, Natalie Schluter, Skyler Seto et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出LINK方法通过词汇替换实现高效跨语言知识迁移。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验设计严谨，评估指标全面。

### 5. **[Metadata Predictability Is Not Evidence Dependence: An Intervention-Based Audit for Weak-Label Benchmarks](https://arxiv.org/abs/2605.23701v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-22
- **作者**: Kan Shao
- **标签**: `cs.CL`
- **AI摘要**: 提出评估弱标签基准的新审计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过干预测试区分元数据与证据依赖，方法严谨且实用。

## Vision Language Models

### 1. **[ETCHR: Editing To Clarify and Harness Reasoning](https://arxiv.org/abs/2605.23897v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Beichen Zhang, Yuhong Liu, Jinsong Li et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出解耦式图像编辑框架以增强多模态模型推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升了多模态模型推理性能。

### 2. **[PGT: Procedurally Generated Tasks for improving visual grounding in MLLMs](https://arxiv.org/abs/2605.23883v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Rim Assouel, Amir Bar, Michal Drozdzal et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 通过程序化生成任务提升多模态模型的细粒度视觉理解能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了视觉定位的监督不足问题

### 3. **[PhotoFlow: Agentic 3D Virtual Photography Missions](https://arxiv.org/abs/2605.23771v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Jiarui Guo, Haojia Wei, Yiming Zhang et al.
- **标签**: `cs.CV` `cs.AI` `cs.MA`
- **AI摘要**: 提出PhotoFlow代理实现虚拟摄影任务
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入闭环摄影代理，基准测试严谨且实用。

### 4. **[SPACENUM: Revisiting Spatial Numerical Understanding in VLMs](https://arxiv.org/abs/2605.23898v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-22
- **作者**: Jianshu Zhang, Yijiang Li, Huifeixin Chen et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出SpaceNum框架揭示VLMs空间数值理解缺陷
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估了VLMs空间数值推理能力，实验设计严谨且分析深入。

### 5. **[Debiased Negative Mining Improves Out-of-distribution Detection with Pre-trained Vision-Language Models](https://arxiv.org/abs/2605.23797v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-22
- **作者**: Bo Peng, Jie Lu, Guangquan Zhang et al.
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出去偏负样本挖掘方法以提升VLM的OOD检测性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过理论框架修正采样偏差，显著提升了OOD检测的准确性与鲁棒性。

## Diffusion Models

### 1. **[Precise: SDE-Consistent Stochastic Sampling for RL Post-Training of Flow-Matching Models](https://arxiv.org/abs/2605.23522v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-22
- **作者**: Jade Zou, Tao Huang, Weijie Kong et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出Precise采样器优化流匹配模型RL训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过SDE一致性改进采样，显著提升训练效率与对齐效果。

### 2. **[VDE: Training-Free Accelerating Rectified Flow Model via Velocity Decomposition and Estimation](https://arxiv.org/abs/2605.23381v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Junwen Tan, Jinglin Liang, Hongyuan Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出VDE方法实现无训练加速流模型推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过速度分解与估计优化推理，实验效果显著且方法创新。

### 3. **[Contrastive Distribution Matching for Amortized Sequential Monte Carlo in Discrete Diffusion](https://arxiv.org/abs/2605.23346v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Jaihoon Kim, Taehoon Yoon, Prin Phunyaphibarn et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出CDM框架加速离散扩散模型采样
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验充分，论证严谨。

### 4. **[DiLaDiff: Distilled Latent-Augmented Diffusion for Language Modeling](https://arxiv.org/abs/2605.23605v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-22
- **作者**: Jean-Marie Lemercier, Tomas Geffner, Karsten Kreis et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出DiLaDiff提升扩散语言模型采样效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过潜在空间与蒸馏技术优化了扩散模型推理性能

### 5. **[Hybrid Quantum-Classical Corrective Diffusion Modeling for Meteorological Downscaling](https://arxiv.org/abs/2605.23403v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-22
- **作者**: Rui Wang, Edoardo Pasetto, Amer Delilbasic et al.
- **标签**: `cs.LG` `physics.ao-ph` `quant-ph`
- **AI摘要**: 提出混合量子扩散模型用于气象降尺度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入量子电路优化降尺度，实验严谨但泛化性有待提升。

## Multimodal

### 1. **[DDX-TRACE: A Benchmark for Medical Diagnostic Trajectories in VLMs](https://arxiv.org/abs/2605.23629v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-22
- **作者**: Jiazhen Pan, Weixiang Shen, Jun Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出评估医疗诊断轨迹的基准DDX-TRACE
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将诊断评估从结果转向过程，方法严谨且具高临床应用价值。

### 2. **[PathNavigate: A Training-Free Pathology Agent with Surprise-Guided Scan and Shared Slide Memory for Whole-Slide Image VQA](https://arxiv.org/abs/2605.23559v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Chunze Yang, Qidong Liu, Wenjie Zhao et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出无需训练的病理图像导航智能体
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过惊喜引导扫描提升了病理VQA的效率与准确性

### 3. **[Multimodal Distribution Matching for Vision-Language Dataset Distillation](https://arxiv.org/abs/2605.23482v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Jongoh Jeong, Hoyong Kwon, Minseok Kim et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出多模态数据集蒸馏框架MDM
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了多模态蒸馏效率。

### 4. **[Leveraging Foundation Models for Causal Generative Modeling](https://arxiv.org/abs/2605.23861v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-22
- **作者**: Aneesh Komanduri, Xintao Wu
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出利用基础模型进行因果生成建模的FM-CGM框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合大模型与扩散模型实现零样本因果推理，方法创新且逻辑清晰。

### 5. **[Beyond Binary Edits Robust Multimodal Knowledge Editing with Adversarial Subspace Alignment](https://arxiv.org/abs/2605.23780v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-22
- **作者**: Haoyuan Wang, Xiaohao Liu, Jiajie Su et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ASAM框架提升多模态模型知识编辑的鲁棒性与泛化能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对抗子空间对齐解决多模态编辑泛化难题，方法创新且实验扎实。

## Image Generation

### 1. **[PiD: Fast and High-Resolution Latent Decoding with Pixel Diffusion](https://arxiv.org/abs/2605.23902v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-22
- **作者**: Yifan Lu, Qi Wu, Jay Zhangjie Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PiD像素扩散解码器，实现高效高分辨率图像生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过扩散模型统一解码与超分，推理速度与质量显著提升。

## Video Generation

### 1. **[LaMo: Self-Supervised Latent Motion Priors for Physical Realism in Video Generation](https://arxiv.org/abs/2605.23878v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Bo Jiang, Depu Meng, Yihan Hu et al.
- **标签**: `cs.CV`
- **AI摘要**: 通过自监督潜在运动先验提升视频生成物理真实性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且即插即用，实验验证充分，提升了物理一致性。

### 2. **[CRONOS: Benchmarking Counterfactual Physical Consistency in Video Models](https://arxiv.org/abs/2605.23699v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: León Begiristain, Olaf Dünkel, Adam Kortylewski
- **标签**: `cs.CV`
- **AI摘要**: 提出CRONOS基准评估视频模型的物理一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过受控干预揭示了视频生成模型在物理推理上的缺陷

### 3. **[EM-Vid: Training-Free Entity-Centric Memory for Efficient and Consistent Multi-Shot Video Generation](https://arxiv.org/abs/2605.23610v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Jente Vandersanden, Matheus Gadelha, Chun-Hao P. Huang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出实体中心化记忆机制提升视频生成一致性与效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入实体索引记忆库，有效解决多镜头一致性问题。

### 4. **[One-Forcing: Towards Stable One-Step Autoregressive Video Generation](https://arxiv.org/abs/2605.23458v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Jiaqi Feng, Justin Cui, Yuanhao Ban et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出One-Forcing实现高效单步视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过GAN损失优化蒸馏，显著提升单步生成质量与效率。

### 5. **[DFSAttn: Dynamic Fine-grained Sparse Attention for Efficient Video Generation](https://arxiv.org/abs/2605.23445v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Jie Hu, Zixiang Gao, Yutong He et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出DFSAttn实现高效视频生成稀疏注意力机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，在多项基准测试中表现卓越。

### 2. **[Socially fluent AI decouples conversational signals from source identity in online interaction](https://arxiv.org/abs/2605.23426v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-22
- **作者**: Lixiang Yan, Yueqiao Jin, Xibin Han et al.
- **标签**: `cs.HC` `cs.AI`
- **AI摘要**: 揭示人类难以识别AI社交身份的心理偏差
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Zisu Huang, Jingwen Xu, Yifan Yang et al.
- **标签**: `cs.AI`
- **AI摘要**: 系统性评估模型生成技能的生命周期与效用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究全面且严谨，揭示了技能提取与消费的机制

### 4. **[LLM-driven design of physics-constrained constitutive models: two agents are better than one](https://arxiv.org/abs/2605.23754v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Marius Tacke, Matthias Busch, Kian Abdolazizi et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出多智能体LLM框架实现物理约束本构模型自动生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入审查智能体确保物理一致性，方法创新且实用性强

### 5. **[MemAudit: Post-hoc Auditing of Poisoned Agent Memory via Causal Attribution and Structural Anomaly Detection](https://arxiv.org/abs/2605.23723v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Zhewen Tan, Yilun Yao, Huiyan Jin et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出MemAudit审计中毒记忆
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果归因与结构异常检测有效审计记忆注入攻击

## Distributed Computing

### 1. **[XWind: A Cross-site Router for Large Language Model Inference Serving at Renewable Energy Farms](https://arxiv.org/abs/2605.23348v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-22
- **作者**: Tella Rajashekhar Reddy, Atharva Deshmukh, Liangcheng Yu et al.
- **标签**: `cs.DC` `cs.AI` `cs.NI`
- **AI摘要**: 提出风能驱动的AI推理路由架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决能源与算力匹配问题，实验严谨且效果显著。

### 2. **[HyperParallel-MoE: Multi-Core Interleaved Scheduling for Fast MoE Training on Ascend NPUs](https://arxiv.org/abs/2605.23764v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Zewen Jin, Congkun Ai, Guangpeng Zhang et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出HyperParallel-MoE实现昇腾NPU异构并行调度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对MoE训练的异构资源调度优化，方法创新且实验扎实。

### 3. **[Herring: Parallel Batch-Order-Fairness on DAG-based Blockchain Consensus](https://arxiv.org/abs/2605.23648v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Marko Putnik, Jérémie Decouchant
- **标签**: `cs.DC`
- **AI摘要**: 提出Herring协议实现DAG区块链并行批处理公平排序
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决公平排序性能瓶颈，实验严谨且对比充分

### 4. **[Unextractable Protocol Models: Collaborative Training and Inference without Weight Materialization](https://arxiv.org/abs/2605.23464v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Alexander Long, Chamin Hewa Koneputugodage, Thalaiyasingam Ajanthan et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出一种分布式模型权重保护框架，防止模型被窃取。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验严谨，有效解决了分布式训练安全问题。

### 5. **[SDNator is Not Another SDN Controller: Enabling Extensible Data-Driven Control in Cyber-Physical Systems](https://arxiv.org/abs/2605.23816v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-22
- **作者**: Y. Lin, R. Zhang, E. Balta et al.
- **标签**: `cs.NI` `cs.DC`
- **AI摘要**: 提出SDNator框架实现CPS数据驱动控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且实验详实，有效提升了CPS控制灵活性与性能。

## Information Retrieval

### 1. **[TubiFM: Unified Item, Carousel, and Search Ranking for Streaming Discovery](https://arxiv.org/abs/2605.23702v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-22
- **作者**: Alexandre Salle, Chenglei Niu, Suchismit Mahapatra et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出统一用户故事模型，优化流媒体推荐与搜索排序。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大模型统一多任务排序，显著提升性能并降低延迟。

### 2. **[HARNESS-LM: A Three-Phase Training Recipe for Harnessing SLMs in Sponsored Search Retrieval](https://arxiv.org/abs/2605.23572v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-22
- **作者**: Vipul Gupta, Shikhar Mohan, Lakshya Kumar et al.
- **标签**: `cs.IR` `cs.AI` `cs.LG`
- **AI摘要**: 提出三阶段蒸馏框架优化检索模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业级落地效果显著，方法论严谨且具备高实用性。

### 3. **[A Pragmatic Approach to Learned Indexing in RocksDB: Targeted Optimizations with Minimal System Modification](https://arxiv.org/abs/2605.23815v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Shubham Vashisth, Olivier Michaud, Bettina Kemme et al.
- **标签**: `cs.DB` `cs.DC`
- **AI摘要**: 提出MountDB实现RocksDB学习索引集成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过最小化改动实现生产级数据库性能提升，方法实用且实验扎实。

### 4. **[Is Dimensionality a Barrier for Retrieval Models?](https://arxiv.org/abs/2605.23556v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Kiril Bangachev, Guy Bresler, Jonathan Kogan et al.
- **标签**: `cs.LG` `cs.IR` `math.CO`
- **AI摘要**: 揭示了检索模型维度与边际的理论关系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，解决了检索嵌入维度的关键问题

### 5. **[Towards Generalizable and Efficient Large-Scale Generative Recommenders](https://arxiv.org/abs/2605.23312v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Qiuling Xu, Ko-Jen Hsiao, Moumita Bhattacharya
- **标签**: `cs.IR`
- **AI摘要**: 提出大规模生成式推荐系统优化方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业界落地经验丰富，解决了扩展性与效率瓶颈

## Computer Vision

### 1. **[From Activation to Causality: Discovery of Causal Visual Representations in the Human Brain](https://arxiv.org/abs/2605.23895v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Yuval Golbari, Navve Wasserman, Matias Cosarinsky et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出BrainCause框架通过因果测试验证脑部视觉表征。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且严谨，有效解决了传统激活分析的假阳性问题。

### 2. **[HorizonStream: Long-Horizon Attention for Streaming 3D Reconstruction](https://arxiv.org/abs/2605.23889v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Chong Cheng, Peilin Tao, Nanjie Yao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出长程注意力机制实现高效流式3D重建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过几何线性注意力解决了长序列重建的漂移与内存瓶颈，创新性强。

### 3. **[Learning a Particle Dynamics Model with Real-world Videos](https://arxiv.org/abs/2605.23845v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Chanho Kim, Suhas V. Sumukh, Li Fuxin
- **标签**: `cs.CV`
- **AI摘要**: 基于高斯溅射的真实视频粒子动力学学习模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过渲染监督实现真实视频动力学建模，方法创新且实用。

### 4. **[MuellerPT: Decomposition Driven Pretraining for Dense Learning in Mueller Polarimetry](https://arxiv.org/abs/2605.23840v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Adam Tlemsani, Yingdian Li, Maxime Giot et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MuellerPT预训练框架实现偏振成像高效分割与分类
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 物理导向预训练创新性强，实验设计严谨且效果显著。

### 5. **[Not Too Generative, Not Too Discriminative: The Human Alignment Sweet Spot](https://arxiv.org/abs/2605.23819v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Jorge Chang Ortega, Bastien Le Lan, Thomas Serre et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 通过JEM模型揭示视觉对齐需平衡生成与判别目标。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，通过控制变量法深入探讨了人类视觉对齐机制。

## Machine Learning

### 1. **[Learning Individual Dynamics from Sparse Cross-Sectional Snapshots](https://arxiv.org/abs/2605.23470v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-22
- **作者**: Christian Lagemann, Kai Lagemann, Steven L. Brunton et al.
- **标签**: `cs.LG` `cs.AI` `cs.CE`
- **AI摘要**: 提出CADENCE框架，从稀疏快照中恢复个体动态轨迹。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，解决了稀疏数据下轨迹推断的难题。

### 2. **[Coupling-Robust Accuracy in Multiphysics Physics Informed Neural Networks via Kronecker-Preconditioned Optimization](https://arxiv.org/abs/2605.23391v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-22
- **作者**: Youngjae Park, Jaemin Kim, Junghwa Hong
- **标签**: `cs.LG` `math.NA`
- **AI摘要**: 提出Kronecker预处理优化提升PINN耦合鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入，实验验证充分，解决了多物理场PINN难题。

### 3. **[Preisach Attention: A Hysteretic Model of Sequential Memory](https://arxiv.org/abs/2605.23603v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-22
- **作者**: Piotr Frydrych
- **标签**: `cs.LG` `cond-mat.dis-nn` `cs.AI`
- **AI摘要**: 引入Preisach算子实现高效序列建模
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，证明了其在长序列记忆中的优势。

### 4. **[Selective Ambulance Dispatch Under Contextual Travel-Time Uncertainty](https://arxiv.org/abs/2605.23378v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-22
- **作者**: Zikun Lin, Daniel Zhuoyu Long, Viet Anh Nguyen
- **标签**: `math.OC` `cs.LG`
- **AI摘要**: 提出IDEAL框架优化救护车调度效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合弱监督学习与凸优化，在急救调度领域具有显著创新与实用价值。

### 5. **[Complete-muE: Optimal Hyperparameter Transfer and Scaling for MoE Models](https://arxiv.org/abs/2605.23893v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-22
- **作者**: Hongwu Peng, Ohiremen Dibua, Yuanjun Xiong et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出Complete-muE实现MoE超参迁移
<details>
<summary>原始摘要</summary>
