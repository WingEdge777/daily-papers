...
### 1. **[Natural Synthesis: Outperforming Reactive Synthesis Tools with Large Reasoning Models](https://arxiv.org/abs/2605.15131v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-14
- **作者**: Frederik Schmitt, Matthias Cosler, Niklas Metzger et al.
- **标签**: `cs.LG`
- **AI摘要**: 利用大模型实现自动逻辑综合与形式化验证
<details>
...
- **评分理由**: 结合神经符号方法解决综合难题，创新性与实用性兼备。

### 2. **[OpenDeepThink: Parallel Reasoning via Bradley--Terry Aggregation](https://arxiv.org/abs/2605.15177v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Shang Zhou, Wenhao Chai, Kaiyuan Liu et al.
- **标签**: `cs.AI`
- **AI摘要**: 基于Bradley-Terry的并行推理优化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过成对比较提升推理性能，方法新颖且实验扎实。

### 3. **[An Interpretable Latency Model for Speculative Decoding in LLM Serving](https://arxiv.org/abs/2605.15051v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Linghao Kong, Megan Flynn, Michael Peng et al.
- **标签**: `cs.LG` `cs.PF`
- **AI摘要**: 提出LLM投机解码延迟建模框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型解释性强，对生产环境部署具有实际指导价值。

### 4. **[InfoSFT: Learn More and Forget Less with Information-Aware Token Weighting](https://arxiv.org/abs/2605.14967v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Mahdi Sabbaghi, George Pappas, Adel Javanmard et al.
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出信息感知权重法优化SFT，提升泛化并减少遗忘。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法简洁有效，实验充分，在SFT领域有显著改进。

### 5. **[A Hardware-Aware, Per-Layer Methodology for Post-Training Quantization of Large Language Models](https://arxiv.org/abs/2605.14929v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Earl Killian
- **标签**: `cs.LG` `cs.AR`
- **AI摘要**: 提出SOP量化法，提升LLM压缩效率与硬件性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且硬件适配性强，实验评估详实，具有高实用价值。

## Natural Language Processing

### 1. **[PROCESS-2: A Benchmark Speech Corpus for Early Cognitive Impairment Detection](https://arxiv.org/abs/2605.14888v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Madhurananda Pahar, Caitlin H. Illingworth, Bahman Mirheidari et al.
- **标签**: `cs.SD` `cs.LG`
- **AI摘要**: 发布用于认知障碍检测的PROCESS-2大规模语音数据集。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大且验证严谨，为语音认知评估提供重要基准。

### 2. **[Tokenizer Fertility and Zero-Shot Performance of Foundation Models on Ukrainian Legal Text: A Comparative Study](https://arxiv.org/abs/2605.14890v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-14
- **作者**: Volodymyr Ovcharov
- **标签**: `cs.CL`
- **AI摘要**: 评估乌克兰法律文本下大模型分词效率与零样本表现。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对特定语言法律任务的实证研究，方法严谨且具实用价值。

### 3. **[Proposal and study of statistical features for string similarity computation and classification](https://arxiv.org/abs/2605.15110v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-05-14
- **作者**: E. O. Rodrigues, D. Casanova, M. Teixeira et al.
- **标签**: `cs.LG` `cs.CL` `cs.IT`
- **AI摘要**: 提出基于统计特征的字符串相似度计算方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新性较好，但在大规模实际应用中的通用性仍需进一步验证。

### 4. **[Conversion of Lexicon-Grammar tables to LMF. Application to French](https://arxiv.org/abs/2605.14816v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-05-14
- **作者**: Eric Laporte, Elsa Tolone, Mathieu Constant
- **标签**: `cs.CL`
- **AI摘要**: 将法语词汇语法表转换为LMF标准格式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实现了词汇资源的标准化与互操作，具有实用价值

## Vision Language Models

### 1. **[LATERN: Test-Time Context-Aware Explainable Video Anomaly Detection](https://arxiv.org/abs/2605.15054v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Mitchell Piehl, Muchao Ye
- **标签**: `cs.CV`
- **AI摘要**: 提出LATERN框架实现视频异常检测的时序证据聚合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过记忆机制与递归聚合提升了VLM在异常检测中的时序连贯性与解释力。

### 2. **[Evo-Depth: A Lightweight Depth-Enhanced Vision-Language-Action Model](https://arxiv.org/abs/2605.14950v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Tao Lin, Yuxin Du, Jiting Liu et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出轻量级深度增强VLA模型提升机器人操作精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验验证充分，结构清晰。

### 3. **[Chain-of-Procedure: Hierarchical Visual-Language Reasoning for Procedural QA](https://arxiv.org/abs/2605.14928v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Guanhua Chen, Yutong Yao, Shenghe Sun et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出CoP框架提升视觉程序问答推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对视觉程序问答提出新基准与分层推理框架，实验效果显著。

### 4. **[SteerSeg: Attention Steering for Reasoning Video Segmentation](https://arxiv.org/abs/2605.14908v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Ali Cheraghian, Hamidreza Dastmalchi, Abdelwahed Khamis et al.
- **标签**: `cs.CV`
- **AI摘要**: 通过提示词引导注意力机制优化视频推理分割效果
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出轻量级注意力引导框架，有效提升多模态模型定位精度

### 5. **[Your CLIP has 164 dimensions of noise: Exploring the embeddings covariance eigenspectrum of contrastively pretrained vision-language transformers](https://arxiv.org/abs/2605.14893v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Jakub Grzywaczewski, Dawid Płudowski, Przemysław Biecek
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 揭示CLIP潜在空间存在噪声维度并提出剪枝优化方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过谱分析揭示模型噪声结构，方法新颖且具实用价值

## Multimodal

### 1. **[SpeakerLLM: A Speaker-Specialized Audio-LLM for Speaker Understanding and Verification Reasoning](https://arxiv.org/abs/2605.15044v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: KiHyun Nam, Jungwoo Heo, Siu Bae et al.
- **标签**: `cs.SD` `cs.AI` `cs.LG`
- **AI摘要**: 提出SpeakerLLM实现说话人理解与验证推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入分层标记器，在音频理解与验证任务上表现出色。

### 2. **[Do Composed Image Retrieval Benchmarks Require Multimodal Composition?](https://arxiv.org/abs/2605.14787v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Matteo Attimonelli, Alessandro De Bellis, Aryo Pradipta Gema et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 揭示CIR基准存在单模态捷径，提出更严谨评估方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过审计揭示了基准测试的缺陷，方法严谨且具有重要指导意义。

### 3. **[From Text to Voice: A Reproducible and Verifiable Framework for Evaluating Tool Calling LLM Agents](https://arxiv.org/abs/2605.15104v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Md Tahmid Rahman Laskar, Xue-Yong Fu, Seyyed Saeed Sarfjoo et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出语音工具调用评估框架，实现文本基准的自动化音频转换。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，评估严谨，对语音智能体研究有重要价值。

### 4. **[Octopus: History-Free Gradient Orthogonalization for Continual Learning in Multimodal Large Language Models](https://arxiv.org/abs/2605.14938v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Yuehao Liu, Shanyan Guan, Weijia Zhang et al.
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出HiFGO框架解决多模态大模型持续学习遗忘问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出无历史数据梯度正交化，实验效果显著，方法论严谨。

### 5. **[Streaming Speech-to-Text Translation with a SpeechLLM](https://arxiv.org/abs/2605.14766v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Titouan Parcollet, Shucong Zhang, Xianrui Zheng et al.
- **标签**: `cs.CL` `cs.AI` `eess.AS`
- **AI摘要**: 提出一种支持实时流式语音翻译的LLM架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了SpeechLLM流式处理延迟问题，方法创新且实用。
...
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Min Zhao, Hongzhou Zhu, Kaiwen Zheng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Causal Forcing++实现实时视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果一致性蒸馏提升了极少步数下的视频生成效率与质量。

### 2. **[DriveCtrl: Conditioned Sim-to-Real Driving Video Generation](https://arxiv.org/abs/2605.15116v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Haonan Zhao, Yiting Wang, Jingkun Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出深度引导的自动驾驶视频生成框架DriveCtrl
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，通过结构感知适配器有效缩小了仿真到现实的差距。

### 3. **[EverAnimate: Minute-Scale Human Animation via Latent Flow Restoration](https://arxiv.org/abs/2605.15042v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Wuyang Li, Yang Gao, Mariam Hassan et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出EverAnimate实现长视频稳定生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过潜在流恢复解决长视频漂移问题，实验效果显著。

### 4. **[MechVerse: Evaluating Physical Motion Consistency in Video Generation Models](https://arxiv.org/abs/2605.14843v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Rahul Jain, Mayank Patel, Asim Unmesh et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MechVerse基准以评估视频生成模型的物理运动一致性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该研究填补了视频生成在机械运动约束评估方面的空白，方法严谨且具有高实用价值。

### 5. **[Probing into Camera Control of Video Models](https://arxiv.org/abs/2605.14815v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Chen Hou, Christian Rupprecht
- **标签**: `cs.CV`
- **AI摘要**: 提出无需训练的几何引导相机控制方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过位移场实现相机控制，方法创新且无需微调，评估全面。

## Agent

### 1. **[Hand-in-the-Loop: Improving Dexterous VLA via Seamless Interventional Correction](https://arxiv.org/abs/2605.15157v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Zhuohang Li, Liqun Huang, Wei Xu et al.
- **标签**: `cs.RO` `cs.LG`
- **AI摘要**: 提出HandITL解决灵巧手干预抖动问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过平滑干预机制显著提升了灵巧操作的成功率与效率

### 2. **[Case-Based Calibration of Adaptive Reasoning and Execution for LLM Tool Use](https://arxiv.org/abs/2605.15041v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Renning Pang, Tian Lan, Leyuan Liu et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 基于案例的LLM工具调用优化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过案例驱动的强化学习提升工具使用准确性与效率

### 3. **[WARD: Adversarially Robust Defense of Web Agents Against Prompt Injections](https://arxiv.org/abs/2605.15030v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Tri Cao, Yulin Chen, Hieu Cao et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出WARD防御框架以提升Web智能体抗注入能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对抗训练与大规模数据集显著提升了防御鲁棒性与效率

### 4. **[Beyond Individual Intelligence: Surveying Collaboration, Failure Attribution, and Self-Evolution in LLM-based Multi-Agent Systems](https://arxiv.org/abs/2605.14892v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Shihao Qi, Jie Ma, Rui Xing et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出LIFE框架整合多智能体协作与自进化机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性梳理了多智能体协作与自进化的因果链条，具有很高的学术参考价值。

### 5. **[Temporal Fair Division in Multi-Agent Systems: From Precise Alternation Metrics to Scalable Coordination Proxies](https://arxiv.org/abs/2605.14879v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Nikolaos Al. Papadopoulos
- **标签**: `cs.MA` `cs.GT` `cs.LG`
- **AI摘要**: 提出时间公平分配指标RP，实现高效多智能体资源调度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架创新且实验严谨，有效解决了多智能体协调难题。

## Distributed Computing

### 1. **[A Prototyping Framework for Distributed Control of Multi-Robot Systems](https://arxiv.org/abs/2605.15049v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-14
- **作者**: Junaid Ahmed Memon, Allan Andre Do Nascimento, Kostas Margellos et al.
- **标签**: `cs.RO` `cs.MA` `eess.SY`
- **AI摘要**: 提出多机器人分布式控制原型框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 框架有效衔接理论与实验，验证方法严谨且实用。

## Computer Vision

### 1. **[Characterizing the visual representation of objects from the child's view](https://arxiv.org/abs/2605.14990v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Jane Yang, Tarun Sepuri, Alvin Wei Ming Tan et al.
- **标签**: `cs.CV`
- **AI摘要**: 分析幼儿视角下的物体视觉表征规律
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用大规模数据集揭示了幼儿视觉输入特征，方法严谨且见解深刻。

### 2. **[H-OmniStereo: Zero-Shot Omnidirectional Stereo Matching with Heading-Aligned Normal Priors](https://arxiv.org/abs/2605.14963v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Chenxing Jiang, Zhe Tong, Pusen Gao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出零样本全景立体匹配框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过航向对齐法向量先验解决畸变，泛化性强且数据集规模大。

### 3. **[Multi-scale Coarse-to-fine Modeling for Test-time Human Motion Control](https://arxiv.org/abs/2605.14935v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Nhat Le, Daochang Liu, Anh Nguyen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出多尺度粗细结合的人体动作生成模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且效率显著提升，实验论证充分。

### 4. **[Masked Next-Scale Prediction for Self-supervised Scene Text Recognition](https://arxiv.org/abs/2605.14885v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Zhuohao Chen, Zeng Li, Yifei Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出掩码下一尺度预测框架以增强场景文本识别的层次化特征学习。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入跨尺度预测机制，实验充分且在多项基准上达到SOTA。

### 5. **[SR-Prominence: A Crowdsourced Protocol and Dataset Suite for Perceptually-Weighted Super-Resolution Artifact Evaluation](https://arxiv.org/abs/2605.14847v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Ivan Molodetskikh, Kirill Malyshev, Mark Mirgaleev et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SR-Prominence数据集以量化超分伪影的感知显著性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入感知加权评估指标，显著提升了超分模型评估的科学性。

## Machine Learning

### 1. **[Logging Policy Design for Off-Policy Evaluation](https://arxiv.org/abs/2605.15108v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Connor Douglas, Joel Persson, Foster Provost
- **标签**: `stat.ML` `cs.AI` `cs.IR`
- **AI摘要**: 提出离线评估日志策略设计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具有极高的实际应用价值，改进了OPE数据收集方法。

### 2. **[Average Gradient Outer Product in kernel regression provably recovers the central subspace for multi-index models](https://arxiv.org/abs/2605.15082v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Libin Zhu, Damek Davis, Dmitriy Drusvyatskiy et al.
- **标签**: `stat.ML` `cs.LG` `math.ST`
- **AI摘要**: 证明AGOP在核回归中能有效恢复多指标模型的中心子空间。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且揭示了预测与表征学习的样本复杂度差异。

### 3. **[NeuroTrain: Surveying Local Learning Rules for Spiking Neural Networks with an Open Benchmarking Framework](https://arxiv.org/abs/2605.15058v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Alessio Caviglia, Filippo Marostica, Roberta Bardini et al.
- **标签**: `cs.NE` `cs.AI`
- **AI摘要**: 提出SNN训练算法分类体系及开源基准框架NeuroTrain
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统梳理了SNN训练算法并提供统一评估框架，实用性强

### 4. **[Generalized Priority-Aware Shapley Value](https://arxiv.org/abs/2605.15018v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Kiljae Lee, Ziqi Liu, Weijing Tang et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出广义优先级Shapley值以解决循环依赖
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新扎实，有效解决复杂优先级下的评估难题

### 5. **[Learning Developmental Scaffoldings to Guide Self-Organisation](https://arxiv.org/abs/2605.14998v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Milton L. Montero, Elias Najarro, Jakob Schauser et al.
- **标签**: `cs.AI` `eess.SY` `q-bio.QM`
- **AI摘要**: 提出联合学习自组织规则与初始预模式的开发模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合NCA与SIREN，通过信息论分析揭示了初始条件对自组织动力学的引导作用。
