...
### 1. **[The Last Word Often Wins: A Format Confound in Chain-of-Thought Corruption Studies](https://arxiv.org/abs/2605.10799v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Gabriel Garcia
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 揭示CoT忠实度研究中的格式混淆偏差
<details>
...
- **评分理由**: 通过严谨实验揭示了CoT评估中的位置偏差，方法论贡献显著。

### 2. **[Intrinsic Guardrails: How Semantic Geometry of Personality Interacts with Emergent Misalignment in LLMs](https://arxiv.org/abs/2605.10633v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-11
- **作者**: Krishak Aneja, Manas Mittal, Anmol Goel et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 利用人格语义几何实现LLM对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了人格向量作为内在护栏的机制，方法创新且实验严谨。

### 3. **[DECO: Sparse Mixture-of-Experts with Dense-Comparable Performance on End-Side Devices](https://arxiv.org/abs/2605.10933v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Chenyang Song, Weilin Zhao, Xu Han et al.
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出DECO架构实现高效端侧MoE部署
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过路由优化与新激活函数提升了端侧部署效率

### 4. **[Beyond Red-Teaming: Formal Guarantees of LLM Guardrail Classifiers](https://arxiv.org/abs/2605.10901v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Nikita Kezins, Urbas Ekka, Pascal Berrang et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出LLM护栏分类器的形式化验证框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过预激活空间实现形式化验证，方法创新且严谨。

### 5. **[Unmasking On-Policy Distillation: Where It Helps, Where It Hurts, and Why](https://arxiv.org/abs/2605.10889v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
...
- **AI摘要**: 提出ELF模型，通过连续嵌入空间流匹配优化语言生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出创新的IR框架解决版式与翻译冲突，实验扎实且应用价值高。

### 3. **[New AI-Driven Tools for Enhancing Campus Well-being: A Prevention and Intervention Approach](https://arxiv.org/abs/2605.10804v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Jinwen Tang
- **标签**: `cs.AI` `cs.CY` `cs.HC`
- **AI摘要**: 提出AI驱动的校园心理健康监测与干预框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合LLM与强化学习，方法创新且实验严谨，应用价值高。

### 4. **[Why Low-Resource NLP Needs More Than Cross-Lingual Transfer: Lessons Learned from Luxembourgish](https://arxiv.org/abs/2605.10714v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Fred Philippy, Siwen Guo, Jacques Klein et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 论证跨语言迁移与特定语言资源建设的互补性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过卢森堡语案例揭示了低资源NLP的协同发展路径，方法论扎实且具有实践指导意义。

### 5. **[Interpretable Coreference Resolution Evaluation Using Explicit Semantics](https://arxiv.org/abs/2605.10627v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Bruno Gatti, Giuliano Martinelli, Roberto Navigli
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出语义增强的指代消解评估框架以诊断模型缺陷
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效提升了视觉模型置信度估计的准确性。

### 2. **[ALAM: Algebraically Consistent Latent Transitions for Vision-Language-Action Models](https://arxiv.org/abs/2605.10819v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Zuojin Tang, Haoyun Liu, Xinyuan Chang et al.
- **标签**: `cs.RO` `cs.AI` `cs.CV`
- **AI摘要**: 提出代数一致性潜空间模型以提升机器人策略学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过代数约束提升潜空间结构，在多任务机器人基准上表现卓越。

### 3. **[Verification Mirage: Mapping the Reliability Boundary of Self-Verification in Medical VQA](https://arxiv.org/abs/2605.10850v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Ruinan Jin, Beidi Zhao, Myeongkyun Kang et al.
- **标签**: `cs.CV`
- **AI摘要**: 揭示医学VLM自验证机制的可靠性边界与幻觉风险。
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出GridProbe实现长视频VLM自适应推理加速
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过后验探测实现高效帧选择，性能与效率平衡出色。

### 5. **[Vocabulary Hijacking in LVLMs: Unveiling Critical Attention Heads by Excluding Inert Tokens to Mitigate Hallucination](https://arxiv.org/abs/2605.10622v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Yangneng Chen, Junlin Li, Weijun Yao et al.
- **标签**: `cs.MM` `cs.CV`
- **AI摘要**: 提出HABI与HAVAE缓解LVLM幻觉
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分析词汇劫持现象，提出无需训练的干预方法，创新性与实用性强。

## Diffusion Models

### 1. **[Reinforce Adjoint Matching: Scaling RL Post-Training of Diffusion and Flow-Matching Models](https://arxiv.org/abs/2605.10759v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Andreas Bergmeister, Stefanie Jegelka, Nikolas Nüsken et al.
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出RAM算法高效优化扩散模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过强化学习与伴随匹配结合，显著提升训练效率与质量
...
- **评分理由**: 通过信息几何视角改进策略更新，有效缓解奖励欺骗。

### 3. **[GenMed: A Pairwise Generative Reformulation of Medical Diagnostic Tasks](https://arxiv.org/abs/2605.10645v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Hantao Zhang, Weidong Guo, Yuhe Liu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于扩散模型的医学诊断生成式范式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将诊断建模为联合分布优化，实验详实且泛化性强。

### 4. **[Composing diffusion priors with explicit physical context via generative Gibbs sampling](https://arxiv.org/abs/2605.10642v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Weizhou Wang, Jonathan Weare, Aaron R. Dinner
- **标签**: `cs.LG` `cond-mat.stat-mech`
- **AI摘要**: 提出GG-PA框架实现物理约束下的扩散模型采样
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且在物理系统应用中展现了显著的实用性

### 5. **[Elucidating Representation Degradation Problem in Diffusion Model Training](https://arxiv.org/abs/2605.10790v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Zhipeng Yao, Dazhou Li, Zitong Zhang et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出ERD框架解决扩散模型表征退化问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入且方法有效，提升了训练稳定性和效率

## Multimodal

### 1. **[CLEF: EEG Foundation Model for Learning Clinical Semantics](https://arxiv.org/abs/2605.10817v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Peng Cao, Ali Mirzazadeh, Jong Woo Lee et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出CLEF模型实现长程EEG临床语义表征学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型架构创新且实验规模庞大，临床应用价值显著。

### 2. **[CADBench: A Multimodal Benchmark for AI-Assisted CAD Program Generation](https://arxiv.org/abs/2605.10873v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-11
- **作者**: Anna C. Doris, Jacob Thomas Sony, Ghadi Nehme et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出CADBench基准以评估多模态CAD程序生成能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了大规模高质量数据集，有效弥补了轨迹与语言建模的鸿沟。

### 5. **[RadThinking: A Dataset for Longitudinal Clinical Reasoning in Radiology](https://arxiv.org/abs/2605.10761v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Wenxuan Li, Pedro R. A. S. Bassi, Xinze Zhou et al.
- **标签**: `cs.CV`
- **AI摘要**: 发布首个放射科临床推理VQA数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建严谨，为医学推理提供链式思维监督

## Image Generation

### 1. **[Qwen-Image-2.0 Technical Report](https://arxiv.org/abs/2605.10730v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Bing Zhao, Chenfei Wu, Deqing Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Qwen-Image-2.0统一生成与编辑模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型在多模态理解与复杂文本渲染上表现优异，技术方案扎实。

## Video Generation

### 1. **[PhyGround: Benchmarking Physical Reasoning in Generative World Models](https://arxiv.org/abs/2605.10806v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Juyi Lin, Arash Akbari, Yumei He et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出物理推理视频生成基准PhyGround
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨，引入人类评估与专用VLM评测，贡献显著。

### 2. **[AllocMV: Optimal Resource Allocation for Music Video Generation via Structured Persistent State](https://arxiv.org/abs/2605.10723v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Huimin Wang, Leilei Ouyang, Chang Xia et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出AllocMV框架优化音乐视频生成资源分配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过MCKP算法实现资源分配优化，方法新颖且逻辑严密。

### 3. **[VISTA: A Generative Egocentric Video Framework for Daily Assistance](https://arxiv.org/abs/2605.10579v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Yu-Hsiang Liu, Yu-Chien Tang, An-Zi Yen
- **标签**: `cs.CL`
- **AI摘要**: 提出VISTA框架生成第一人称视频以训练AI助手
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果推理生成视频数据，有效解决了AI训练数据匮乏问题。
...
- **AI摘要**: 提出Shepherd框架，实现高效智能体执行追踪与回溯。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过形式化追踪显著提升智能体性能与效率。

### 2. **[LITMUS: Benchmarking Behavioral Jailbreaks of LLM Agents in Real OS Environments](https://arxiv.org/abs/2605.10779v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Chiyu Zhang, Huiqin Yang, Bendong Jiang et al.
- **标签**: `cs.CR` `cs.CL`
- **AI摘要**: 提出LITMUS基准以评估LLM智能体在OS环境下的行为安全性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入OS级状态回滚与双层验证，填补了物理层安全评估空白。

### 3. **[Conformity Generates Collective Misalignment in AI Agents Societies](https://arxiv.org/abs/2605.10721v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Giordano De Marzo, Alessandro Bellina, Claudio Castellano et al.
- **标签**: `physics.soc-ph` `cs.CL` `cs.MA`
- **AI摘要**: 揭示AI群体一致性会导致集体对齐失效
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合统计物理学分析AI群体涌现行为，视角独特且严谨

### 4. **[PRISM: Generation-Time Detection and Mitigation of Secret Leakage in Multi-Agent LLM Pipelines](https://arxiv.org/abs/2605.10614v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Riya Tapwal, Abhishek Kumar, Carsten Maple
- **标签**: `cs.AI`
- **AI摘要**: 提出PRISM实时防御多智能体LLM密钥泄露。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验严谨，有效解决多智能体安全风险。

### 5. **[WildClawBench: A Benchmark for Real-World, Long-Horizon Agent Evaluation](https://arxiv.org/abs/2605.10912v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-11
- **作者**: Shuangrui Ding, Xuanlang Dai, Long Xing et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出首个真实环境长程智能体基准测试WildClawBench。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过真实Docker环境评估智能体，方法严谨且具高实用价值。

## Distributed Computing

### 1. **[Surviving Partial Rank Failures in Wide Expert-Parallel MoE Inference](https://arxiv.org/abs/2605.10670v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-11
- **作者**: Xun Sun, Shaoyuan Chen, Pingchuan Ma et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出EEP实现MoE推理的故障自愈与动态重构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决MoE并行故障恢复，实验严谨且实用性强。

### 2. **[EnergyLens: Interpretable Closed-Form Energy Models for Multimodal LLM Inference Serving](https://arxiv.org/abs/2605.10556v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Vittorio Palladino, Gianluca Palermo, Michael E. Papka et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出可解释闭式能耗模型优化LLM推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过符号回归实现高效能耗预测，方法创新且实用性强。

### 3. **[An Uncertainty-Aware Resilience Micro-Agent for Causal Observability in the Computing Continuum](https://arxiv.org/abs/2605.10718v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Suvi De Silva, Alfreds Lapkovskis, Alaa Saleh et al.
- **标签**: `cs.DC` `cs.AI` `cs.LG`
- **AI摘要**: 提出AURORA框架以解决边缘计算灰故障诊断
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合因果推理与自由能原理，有效提升边缘系统韧性。

### 4. **[Effect of Graph Gluing on Consensus in Networked Multi-Agent Systems](https://arxiv.org/abs/2605.10558v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-05-11
- **作者**: Rohollah Moghadam, Santosh Kandel
- **标签**: `cs.MA` `eess.SY`
- **AI摘要**: 分析图粘合对多智能体系统一致性的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析严谨，揭示了拓扑结构与收敛速度的关系

### 5. **[A Resilient Solution for Sewer Overflow Monitoring across Cloud and Edge](https://arxiv.org/abs/2605.10592v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-05-11
- **作者**: Vipin Singh, Tianheng Ling, Peter Ghaly et al.
- **标签**: `cs.AI` `cs.HC` `cs.LG`
- **AI摘要**: 云边协同的合流制管网溢流监测系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合深度学习与云边架构，具有较强的工程实用价值。

## Operating Systems

### 1. **[Closer in the Gap: Towards Portable Performance on RISC-V Vector Processors](https://arxiv.org/abs/2605.10860v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-11
- **作者**: Ruimin Shi, Maya Gokhale, Pei-Hung Lin et al.
- **标签**: `cs.DC`
- **AI摘要**: 评估RVV编译器性能并揭示优化瓶颈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 对RVV硬件与编译器进行了实证评估，具有工程参考价值。

## Information Retrieval

### 1. **[Rethinking Agentic Search with Pi-Serini: Is Lexical Retrieval Sufficient?](https://arxiv.org/abs/2605.10848v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Tz-Huan Hsu, Jheng-Hong Yang, Jimmy Lin
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 证明词法检索在智能体中仍具竞争力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Pi-Serini验证了BM25结合强模型在检索中的有效性

### 2. **[PathISE: Learning Informative Path Supervision for Knowledge Graph Question Answering](https://arxiv.org/abs/2605.10791v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Shengxiang Gao, Chao Lei, Jey Han Lau et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出PathISE框架，通过路径估计实现高效KGQA监督。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用伪路径监督提升KGQA，实验扎实且实用。

## Computer Vision

### 1. **[Count Anything at Any Granularity](https://arxiv.org/abs/2605.10887v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Chang Liu, Haoning Wu, Weidi Xie
- **标签**: `cs.CV`
- **AI摘要**: 提出多粒度计数框架及大规模数据集KubriCount
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多模态提示解决计数粒度问题，方法创新且实验扎实。

### 2. **[Transcoda: End-to-End Zero-Shot Optical Music Recognition via Data-Centric Synthetic Training](https://arxiv.org/abs/2605.10835v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-11
- **作者**: Daniel Dratschuk, Paul Swoboda
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出Transcoda实现零样本光学音乐识别
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过数据合成与编码规范化显著提升了OMR性能

### 3. **[Set-Based Groupwise Registration for Variable-Length, Variable-Contrast Cardiac MRI](https://arxiv.org/abs/2605.10571v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-11
- **作者**: Yi Zhang, Yidong Zhao, Tijmen Toxopeus et al.
- **标签**: `eess.IV` `cs.CV`
- **AI摘要**: 提出基于集合的通用心脏MRI配准框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过像素反投影机制解决了3D生成中的对应性难题。

### 5. **[Counterfactual Stress Testing for Image Classification Models](https://arxiv.org/abs/2605.10894v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Moritz Stammel, Fabio De Sousa Ribeiro, Raghav Mehta et al.
- **标签**: `cs.CV`
- **AI摘要**: 利用因果生成模型进行医学影像反事实压力测试
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验设计严谨，有效评估模型鲁棒性。

## Machine Learning

### 1. **[Neural Weight Norm = Kolmogorov Complexity](https://arxiv.org/abs/2605.10878v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Tiberiu Musat
- **标签**: `cs.LG` `cs.IT`
- **AI摘要**: 证明权重范数等价于柯尔莫哥洛夫复杂性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论深刻，揭示了权重衰减与通用先验的联系

### 2. **[Attractor-Vascular Coupling Theory: Formal Grounding and Empirical Validation for AAMI-Standard Cuffless Blood Pressure Estimation from Smartphone Photoplethysmography](https://arxiv.org/abs/2605.10871v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Timothy Oladunni, Farouk Ganiyu Adewumi
- **标签**: `physics.med-ph` `cs.AI` `cs.LG`
- **AI摘要**: 提出AVCT理论实现高精度无袖带血压监测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论基础扎实，实验验证严谨，临床应用潜力巨大。

### 3. **[Natural Policy Gradient as Doubly Smoothed Policy Iteration: A Bellman-Operator Framework](https://arxiv.org/abs/2605.10671v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-11
- **作者**: Phalguni Nanda, Zaiwei Chen
- **标签**: `cs.LG` `math.OC` `stat.ML`
- **AI摘要**: 提出双重平滑策略迭代框架统一自然策略梯度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论贡献显著，证明了收敛性，框架具有高度普适性。

### 4. **[Factual recall in linear associative memories: sharp asymptotics and mechanistic insights](https://arxiv.org/abs/2605.10795v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-11
- **作者**: Alessio Giorlandino, Sebastian Goldt, Antoine Maillard
- **标签**: `stat.ML` `cond-mat.dis-nn` `cond-mat.stat-mech`
- **AI摘要**: 揭示线性联想记忆存储容量的统计物理机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具开创性，为大模型记忆机制提供基准

### 5. **[Variational Inference for Lévy Process-Driven SDEs via Neural Tilting](https://arxiv.org/abs/2605.10934v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Yaman Kindap, Manfred Opper, Benjamin Dupuis et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出神经指数倾斜框架以实现Lévy过程驱动SDE的变分推断
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地解决了非高斯跳跃过程的变分推断难题，方法严谨且实用。
