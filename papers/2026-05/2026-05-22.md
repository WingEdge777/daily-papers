...
### 1. **[OCTOPUS: Optimized KV Cache for Transformers via Octahedral Parametrization Under optimal Squared error quantization](https://arxiv.org/abs/2605.21226v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-20
- **作者**: Mark Boss, Vikram Voleti, Simon Donné et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 基于八面体参数化的KV缓存量化方法
<details>
...
- **评分理由**: 创新性引入功率控制作为调度参数，实验扎实且实用。

### 4. **[Preference-aware Influence-function-based Data Selection Method for Efficient Fine-Tuning](https://arxiv.org/abs/2605.21422v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Qihao Lin, Guanxu Chen, Dongrui Liu et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出PRISM方法优化微调数据选择效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过偏好加权改进影响函数，提升了数据选择的针对性与效率。

### 5. **[Stdlib or Third-Party? Empirical Performance and Correctness of LLM-Assisted Zero-Dependency Python Libraries](https://arxiv.org/abs/2605.21405v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Peng Ding, Rick Stevens
- **标签**: `cs.SE` `cs.AI` `cs.PL`
- **AI摘要**: 研究LLM辅助构建无依赖Python库的性能与可行性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过zerodep实证分析了标准库替代第三方库的性能边界。

## Natural Language Processing

### 1. **[SURGE: An Event-Centric Social Media Sentiment Time Series Benchmark with Interaction Structure](https://arxiv.org/abs/2605.21198v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Chen Su, Pengsen Cheng, Yuanhe Tian et al.
- **标签**: `cs.SI` `cs.AI`
- **AI摘要**: 提出SURGE基准以研究社交媒体事件动态与交互结构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了高质量多事件数据集，弥补了交互结构研究的空白

### 2. **[WCXB: A Multi-Type Web Content Extraction Benchmark](https://arxiv.org/abs/2605.21097v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Murrough Foley
- **标签**: `cs.CL`
- **AI摘要**: 发布多类型网页内容提取基准WCXB
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了网页提取基准在非新闻类页面的空白，方法严谨且实用。

### 3. **[Quantifying the cross-linguistic effects of syncretism on agreement attraction](https://arxiv.org/abs/2605.21403v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Utku Turk, Eva Neu
- **标签**: `cs.CL`
- **AI摘要**: 利用大模型分析跨语言语法一致性吸引现象。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过LLM量化形态融合对语法吸引的影响，方法严谨且具有跨语言洞察力。

### 4. **[Reliable Automated Triage in Spanish Clinical Notes: A Hybrid Framework for Risk-Aware HIV Suspicion Identification](https://arxiv.org/abs/2605.21256v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Rodrigo Morales-Sánchez, Soto Montalvo, Raquel Martínez
- **标签**: `cs.CL`
- **AI摘要**: 提出混合框架提升HIV临床分诊可靠性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合共形预测与几何距离，有效量化临床不确定性。

### 5. **[Do LLMs Know What Luxembourgish Borrows? Probing Lexical Neology in Low-Resource Multilingual Models](https://arxiv.org/abs/2605.21227v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Nina Hosseini-Kivanani
- **标签**: `cs.CL`
- **AI摘要**: 提出LexNeo-Bench评估LLM对卢森堡语借词的识别能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究针对低资源语言借词识别，方法创新且实验严谨，具有较好的实用价值。

## Vision Language Models

### 1. **[WikiVQABench: A Knowledge-Grounded Visual Question Answering Benchmark from Wikipedia and Wikidata](https://arxiv.org/abs/2605.21479v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Basel Shbita, Pengyuan Li, Anna Lisa Gentile
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 构建知识驱动的视觉问答基准WikiVQABench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨，数据集构建流程规范，有效评估了多模态模型知识推理能力。

### 2. **[Lost in Fog: Sensor Perturbations Expose Reasoning Fragility in Driving VLAs](https://arxiv.org/abs/2605.21446v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Abhinaw Priyadershi, Jelena Frtunikj
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 揭示VLA驾驶模型推理一致性与轨迹安全性的强关联
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模扰动实验量化推理脆弱性，方法严谨且具实用价值。

### 3. **[TempGlitch: Evaluating Vision-Language Models for Temporal Glitch Detection in Gameplay Videos](https://arxiv.org/abs/2605.21443v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Yakun Yu, Ashley Wiens, Adrián Barahona-Ríos et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出TempGlitch基准以评估VLM的时序故障检测能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对视频游戏故障检测的痛点，构建了高质量基准并进行了全面评估，方法严谨且具有实用价值。

### 4. **[PointACT: Vision-Language-Action Models with Multi-Scale Point-Action Interaction](https://arxiv.org/abs/2605.21414v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Shizhe Chen, Paul Pacaud, Cordelia Schmid
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出PointACT实现3D感知机器人控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入多尺度点云交互，显著提升了机器人操作精度。

### 5. **[DriveMA: Rethinking Language Interfaces in Driving VLAs with One-Step Meta-Actions](https://arxiv.org/abs/2605.21273v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Weicheng Zheng, Yixin Huang, Qiao Sun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出DriveMA，用元动作替代长推理提升自动驾驶性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地简化了VLA接口，实验结果优异且方法论严谨。
...
- **评分理由**: 创新性解决离散扩散模型推理慢的问题，实验扎实。

### 2. **[Memorisation, convergence and generalisation in generative models](https://arxiv.org/abs/2605.21402v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Antoine Maillard, Sebastian Goldt
- **标签**: `stat.ML` `cond-mat.dis-nn` `cond-mat.stat-mech`
- **AI摘要**: 揭示生成模型泛化与记忆的本质区别
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解析模型量化了记忆与泛化的临界点，理论深度极高。

### 3. **[Variance Reduction for Expectations with Diffusion Teachers](https://arxiv.org/abs/2605.21489v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Jesse Bettencourt, Xindi Wu, Matan Atzmon et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出CARV框架以降低扩散模型梯度估计方差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分层蒙特卡洛估计显著提升计算效率，方法扎实。

### 4. **[HITL-D: Human In The Loop Diffusion Assisted Shared Control](https://arxiv.org/abs/2605.21460v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Riley Zilka, Sergey Khlynovskiy, Allie Wang et al.
- **标签**: `cs.RO` `cs.AI` `cs.HC`
- **AI摘要**: 提出HITL-D框架，通过扩散模型辅助人机协同操作。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了遥操作效率与体验。

### 5. **[Semantic Granularity Navigation in Image Editing](https://arxiv.org/abs/2605.21190v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Liangsi Lu, Minzhe Guo, Xuhang Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出NaviEdit解耦编辑进度与模型尺度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过控制尺度实现高效图像编辑，方法创新且实验扎实。

## Multimodal

### 1. **[Verifiable Provenance and Watermarking for Generative AI: An Evidentiary Framework for International Operational Law and Domestic Courts](https://arxiv.org/abs/2605.21002v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-20
- **作者**: Gustav Olaf Yunus Laitinen-Fredriksson Lundström-Imanov, Nurana Abdullayeva
- **标签**: `cs.CR` `cs.CV` `cs.CY`
- **AI摘要**: 构建生成式AI溯源与水印的法律证据框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 跨学科结合紧密，基准测试规模大且具有极高法律应用价值。

### 2. **[ProtoPathway: Biologically Structured Prototype-Pathway Fusion for Multimodal Cancer Survival Prediction](https://arxiv.org/abs/2605.21454v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-20
- **作者**: Amaya Gallagher-Syed, Costantino Pitzalis, Myles J. Lewis et al.
- **标签**: `cs.CV` `q-bio.QM` `q-bio.TO`
- **AI摘要**: 提出融合病理原型与通路图的癌症生存预测模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且可解释性强，实验验证充分，具备临床应用潜力。

### 3. **[Multimodal Emotion Recognition with Large Language Models](https://arxiv.org/abs/2605.21239v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Hongrui Zhang, Daiqing Wu, Yangyang Li et al.
- **标签**: `cs.MM`
- **AI摘要**: 系统综述大模型在多模态情感识别中的应用与挑战。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 综述结构清晰，对MER-LLM范式进行了系统性的分类与总结。

### 4. **[Multimodal LLMs under Pairwise Modalities](https://arxiv.org/abs/2605.21059v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Yan Li, Yunlong Deng, Yuewen Sun et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出仅依赖成对模态的MLLM训练框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析扎实且方法创新，有效降低了多模态数据构建成本。

### 5. **[Ordering Matters: Rank-Aware Selective Fusion for Blended Emotion Recognition](https://arxiv.org/abs/2605.21417v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-20
- **作者**: Junghyun Lee, Hyunseo Kim, Hanna Jang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出排序感知选择性融合框架以识别混合情感
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且在竞赛中表现优异，实验设计严谨

## Image Generation

### 1. **[OcclusionFormer: Arranging Z-Order for Layout-Grounded Image Generation](https://arxiv.org/abs/2605.21343v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Ziye Li, Henghui Ding
- **标签**: `cs.CV`
- **AI摘要**: 提出OcclusionFormer解决布局生成中的遮挡问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入Z-order建模与新数据集，显著提升空间一致性。

### 2. **[MONET: A Massive, Open, Non-redundant and Enriched Text-to-image dataset](https://arxiv.org/abs/2605.21272v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Benjamin Aubin, Gonzalo Iñaki Quintana, Onur Tasar et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 发布大规模开源图文数据集MONET
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大且处理流程严谨，有效降低了研究门槛。

### 3. **[RankE: End-to-End Post-Training for Discrete Text-to-Image Generation with Decoder Co-Evolution](https://arxiv.org/abs/2605.21195v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Siyong Jian, Siyuan Li, Luyuan Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出RankE框架，通过解码器协同进化提升离散T2I生成质量。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了离散模型后训练中的分布偏移问题，实验效果显著。

### 4. **[Linear-DPO: Linear Direct Preference Optimization for Diffusion and Flow-Matching Generative Models](https://arxiv.org/abs/2605.21123v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Kesong Li, Yixuan Xu, Kuo-kun Tseng et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出Linear-DPO优化扩散与流匹配模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，有效解决了生成模型对齐中的目标失配问题。

## Video Generation

### 1. **[Q-ARVD: Quantizing Autoregressive Video Diffusion Models](https://arxiv.org/abs/2605.21072v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Siao Tang, Xinyin Ma, Gongfan Fang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Q-ARVD量化框架以优化自回归视频扩散模型效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对ARVD量化难题提出针对性策略，实验充分且逻辑严密。

### 2. **[Dynamic Video Generation: Shaping Video Generation Across Time and Space](https://arxiv.org/abs/2605.21042v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Shikang Zheng, Jingkai Huang, Jiacheng Liu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出DVG框架实现视频生成时空计算动态分配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过时空联合优化显著提升视频生成效率，方法创新且实用性强。

### 3. **[StreamGVE: Training-Free Video Editing via Few-Step Streaming Video Generation](https://arxiv.org/abs/2605.21466v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Guanlong Jiao, Chenyangguang Zhang, Jia Jun Cheng Xian et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出StreamGVE实现高效少步视频编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入流式生成范式，显著提升编辑效率与质量

### 4. **[DySink: Dynamic Frame Sinks for Autoregressive Long Video Generation](https://arxiv.org/abs/2605.21028v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Bo Ye, Xinyu Cui, Jian Zhao et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出动态帧汇聚机制以优化长视频生成中的长程记忆。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态检索替代静态汇聚，有效缓解了长视频生成中的坍缩问题。
...
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Sixiong Xie, Zhuofan Shi, Haiyang Shen et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出DeepWeb-Bench评估深度搜索能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基准测试设计严谨，揭示了模型在推理与校准上的瓶颈。

### 2. **[Agent JIT Compilation for Latency-Optimizing Web Agent Planning and Scheduling](https://arxiv.org/abs/2605.21470v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Caleb Winston, Ron Yifeng Wang, Azalia Mirhoseini et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出Agent JIT编译以优化Web智能体规划与调度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过强化学习实现按需生成记忆，性能提升显著。

### 4. **[SpecBench: Measuring Reward Hacking in Long-Horizon Coding Agents](https://arxiv.org/abs/2605.21384v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Bingchen Zhao, Dhruv Srikanth, Yuxiang Wu et al.
- **标签**: `cs.SE` `cs.AI` `cs.CL`
- **AI摘要**: 提出SpecBench基准以量化编码智能体的奖励欺骗现象。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论严谨，有效揭示了长程编码任务中的奖励欺骗问题。

### 5. **[Insights Generator: Systematic Corpus-Level Trace Diagnostics for LLM Agents](https://arxiv.org/abs/2605.21347v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Akshay Manglik, Apaar Shanker, Kaustubh Deshpande et al.
- **标签**: `cs.AI` `cs.LG` `cs.SE`
- **AI摘要**: 提出自动诊断LLM智能体执行轨迹的系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验评估扎实，提升了调试效率

## Distributed Computing

### 1. **[Frontier: Towards Comprehensive and Accurate LLM Inference Simulation](https://arxiv.org/abs/2605.21312v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-20
- **作者**: Yicheng Feng, Xin Tan, Yangtao Deng et al.
- **标签**: `cs.DC` `cs.AI` `cs.LG`
- **AI摘要**: 提出高保真LLM推理模拟器Frontier
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且实验严谨，显著提升了推理系统模拟精度

### 2. **[A Typed Tensor Language for Federated Learning](https://arxiv.org/abs/2605.21103v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Theofilos Mailis, Kalliopi-Christina Despotidou, Konstantinos Filippopolitis et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出一种联邦学习张量类型语言，实现计算形式化。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具创新性，为联邦学习提供数学框架。

### 3. **[NanoCP: Request-Level Dynamic Context Parallelism for Data-Expert Parallel Decoding](https://arxiv.org/abs/2605.21100v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Jiefei Chen, Binbin Lin, Jinming Ma et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出动态上下文并行以优化MoE模型推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态调整上下文并行度有效缓解了MoE负载不均与内存碎片问题

### 4. **[FedCritic: Serverless Federated Critic Learning-based Resource Allocation for Multi-Cell OFDMA in 6G](https://arxiv.org/abs/2605.21418v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Amin Farajzadeh, Melike Erol-Kantarci
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出FedCritic实现6G去中心化资源分配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入联邦评论家架构，有效降低通信开销且性能优异。

### 5. **[Optimized Federated Knowledge Distillation with Distributed Neural Architecture Search](https://arxiv.org/abs/2605.21322v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Chaimaa Medjadji, Sylvain Kubler, Yves Le Traon et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出FedKDNAS框架优化联邦学习架构与通信效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合NAS与知识蒸馏，在异构环境下实现了性能与效率的平衡

## Information Retrieval

### 1. **[SG-LegalCite: A Principle-Augmented Benchmark for Legal Citation Retrieval in Singapore Law](https://arxiv.org/abs/2605.21057v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Shannon Lee Yueh Ern, Kaidong Feng, Yingpeng Du et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出SG-LegalCite基准以提升法律引用检索准确性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入法律原则增强检索范式，数据集规模大且具有实际应用价值。

### 2. **[Fine-grained Claim-level RAG Benchmark for Law](https://arxiv.org/abs/2605.21071v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Souvick Das, Sallam Abualhaija, Domenico Bianculli
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出法律领域细粒度RAG评测基准ClaimRAG-LAW
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了法律RAG细粒度评测空白，多语言支持且实用性强。

### 3. **[Robust Personalized Recommendation under Hidden Confounding in MNAR](https://arxiv.org/abs/2605.21066v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-20
- **作者**: Zongyu Li, Wanting Su, Tianyu Xia
- **标签**: `cs.LG`
- **AI摘要**: 提出PUID框架解决推荐系统隐混淆偏置问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新性强，通过个性化敏感度边界提升了鲁棒性。

### 4. **[STiTch: Semantic Transition and Transportation in Collaboration for Training-Free Zero-Shot Composed Image Retrieval](https://arxiv.org/abs/2605.21261v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-20
- **作者**: Miaoge Li, Dongsheng Wang, Zening Sun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出语义转换与传输框架优化零样本图像检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过语义精炼与分布对齐提升检索精度，方法创新且实验扎实。

## Computer Vision

### 1. **[SpectralEarth-FM: Bringing Hyperspectral Imagery into Multimodal Earth Observation Pretraining](https://arxiv.org/abs/2605.21075v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-20
- **作者**: Nassim Ait Ali Braham, Aaron Banze, Conrad M. Albrecht et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出首个融合高光谱与多模态遥感数据的预训练模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且数据集规模宏大，在多项基准测试中表现卓越

### 2. **[Latent Dynamics for Full Body Avatar Animation](https://arxiv.org/abs/2605.21478v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Shichong Peng, Chengxiang Yin, Fei Jiang et al.
- **标签**: `cs.CV` `cs.GR`
- **AI摘要**: 基于潜在动力学的全身体态动画生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入动力学残差潜变量提升了衣物形变的真实感与时序一致性

### 3. **[iTryOn: Mastering Interactive Video Virtual Try-On with Spatial-Semantic Guidance](https://arxiv.org/abs/2605.21431v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Jun Zheng, Zhengze Xu, Mengting Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出iTryOn实现交互式视频虚拟试穿
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入交互式任务并提出多级注入机制，创新性与实用性兼备。

### 4. **[AIGaitor: Privacy-preserving and cloud-free motion analysis for everyone, using edge computing](https://arxiv.org/abs/2605.21421v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
...
- **评分理由**: 创新性解决临床隐私与成本痛点，性能表现优异且实验严谨。

### 5. **[RePCM: Region-Specific and Phenotype-Adaptive Bi-Ventricular Cardiac Motion Synthesis](https://arxiv.org/abs/2605.21237v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Xuan Yang, Xiaohan Yuan, Hao Li et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出区域感知与表型自适应双心室运动合成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新性强，针对性解决局部运动合成难题，实验详实。

## Machine Learning

### 1. **[Conditioning Gaussian Processes on Almost Anything](https://arxiv.org/abs/2605.21041v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-20
- **作者**: Henry Moss, Lachlan Astfalck, Thomas Cowperthwaite et al.
- **标签**: `stat.ML` `cs.LG` `stat.ME`
- **AI摘要**: 提出基于扩散模型的通用高斯过程推理框架
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 84/100 | **日期**: 2026-05-20
- **作者**: Tilman Tröster, David Mirkovic, Veronika Oehl et al.
- **标签**: `astro-ph.CO` `cs.LG`
- **AI摘要**: 提出Velocityformer重构宇宙速度场
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对称性匹配显著提升了宇宙学速度场重构的精度与效率。

### 3. **[Equilibrium Reasoners: Learning Attractors Enables Scalable Reasoning](https://arxiv.org/abs/2605.21488v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Benhao Huang, Zhengyang Geng, Zico Kolter
- **标签**: `cs.LG`
- **AI摘要**: 提出平衡推理器通过学习吸引子实现可扩展推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过学习潜在动力系统实现测试时计算扩展，方法创新且实验扎实。

### 4. **[EvoStruct: Bridging Evolutionary and Structural Priors for Antibody CDR Design via Protein Language Model Adaptation](https://arxiv.org/abs/2605.21485v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Mansoor Ahmed, Sujin Lee, Umar Khayaz et al.
- **标签**: `cs.LG`
- **AI摘要**: 融合PLM与GNN解决抗体CDR设计中的词汇崩塌问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合进化先验与结构信息，显著提升设计多样性与准确度

### 5. **[Mind the Sim-to-Real Gap & Think Like a Scientist](https://arxiv.org/abs/2605.21458v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Harsh Parikh, Gabriel Levin-Konigsberg, Dominique Perrault-Joncas et al.
- **标签**: `cs.AI` `cs.LG` `stat.ME`
- **AI摘要**: 提出结合模拟与实验的决策优化框架
<details>
<summary>原始摘要</summary>
