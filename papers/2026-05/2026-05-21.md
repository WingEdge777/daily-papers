...
### 1. **[ThoughtTrace: Understanding User Thoughts in Real-World LLM Interactions](https://arxiv.org/abs/2605.20087v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-19
- **作者**: Chuanyang Jin, Binze Li, Haopeng Xie et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 构建首个用户思维标注数据集以优化人机交互理解。
<details>
...
- **评分理由**: 填补了用户意图数据的空白，方法严谨且应用价值高。

### 2. **[Not Every Rubric Teaches Equally: Policy-Aware Rubric Rewards for RLVR](https://arxiv.org/abs/2605.20164v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Utkarsh Tyagi, Xingang Guo, MohammadHossein Rezaei et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出POW3R框架优化RLVR评分权重
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了训练效率与效果。

### 3. **[Draft Less, Retrieve More: Hybrid Tree Construction for Speculative Decoding](https://arxiv.org/abs/2605.20104v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Yuhao Shen, Tianyu Liu, Xinyi Hu et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出Graft框架通过剪枝与检索结合提升推测解码效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合剪枝与检索，实验详实，显著提升推理速度

### 4. **[CopT: Contrastive On-Policy Thinking with Continuous Spaces for General and Agentic Reasoning](https://arxiv.org/abs/2605.20075v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Dachuan Shi, Hanlin Zhu, Xiangchi Yuan et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出先答后思的CopT框架，提升推理效率与准确性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地反转推理顺序并引入对比验证，实验效果显著。

### 5. **[FlexDraft: Flexible Speculative Decoding via Attention Tuning and Bonus-Guided Calibration](https://arxiv.org/abs/2605.20022v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Yaojie Zhang, Jianuo Huang, Junlong Ke et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出FlexDraft框架，通过注意力微调与动态解码提升推理效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且针对大模型推理瓶颈，实验设计与逻辑严密。

## Natural Language Processing

### 1. **[Neurosymbolic Learning for Inference-Time Argumentation](https://arxiv.org/abs/2605.20098v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Gabriel Freedman, Adam Dejl, Adam Gould et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出神经符号推理框架实现可信论证验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合神经符号与论证理论，提升了模型可解释性。

### 2. **[PromptRad: Knowledge-Enhanced Multi-Label Prompt-Tuning for Low-Resource Radiology Report Labeling](https://arxiv.org/abs/2605.20052v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Ying-Jia Lin, Tzu-Chin Lo, Ping-Chien Li et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出PromptRad实现低资源放射报告标注
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且在低数据下表现优异，实验严谨。

### 3. **[Language Mutations Sustain the Persistences of Conspiracy Theories on Social Media](https://arxiv.org/abs/2605.20050v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Calvin Yixiang Cheng, Dorian Quelle, Scott A. Hale
- **标签**: `cs.CL`
- **AI摘要**: 揭示语言变异如何延长阴谋论在社交媒体上的传播周期。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，对内容审核策略具有实际参考价值。

### 4. **[Mind Your Moras: Orthography-Aware Error Analysis of Neural Japanese Morphological Generation](https://arxiv.org/abs/2605.20043v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Wen Zhang
- **标签**: `cs.CL`
- **AI摘要**: 揭示日语形态生成中的正字法错误模式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过正字法分析揭示了模型在日语形态变化中的系统性缺陷。

### 5. **[What Are LLMs Doing to Scientific Communication? Measuring Changes in Writing Practices and Reading Experience](https://arxiv.org/abs/2605.19936v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Filip Miletić, Neele Falk
- **标签**: `cs.CL`
- **AI摘要**: 分析LLM对科研写作风格与阅读体验的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，量化了LLM对学术语言演变的影响，具有现实意义。

## Vision Language Models

### 1. **[From Seeing to Thinking: Decoupling Perception and Reasoning Improves Post-Training of Vision-Language Models](https://arxiv.org/abs/2605.20177v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Juncheng Wu, Hardy Chen, Haoqin Tu et al.
- **标签**: `cs.CL` `cs.CV`
- **AI摘要**: 提出分阶段训练以解耦感知与推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦感知与推理提升VLM性能，方法论严谨且实验充分。

### 2. **[CaMo: Camera Motion Grounded Evaluation and Training for Vision-Language Models](https://arxiv.org/abs/2605.20165v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Hsiang-Wei Huang, Junbin Lu, Kuang-Ming Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CaMo框架以提升VLM相机运动理解能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过空间叙事评估揭示了VLM的空间理解缺陷，方法创新且实验严谨。

### 3. **[Rethinking Visual Attribution for Chest X-ray Reasoning in Large Vision Language Models](https://arxiv.org/abs/2605.20158v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Guangzhi Xiong, Qiao Jin, Sanchit Sinha et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出MedFocus提升医学多模态模型视觉归因可信度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果评估框架验证归因方法，方法创新且实验严谨。

### 4. **[SetCon: Towards Open-Ended Referring Segmentation via Set-Level Concept Prediction](https://arxiv.org/abs/2605.20110v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Zhixiong Zhang, Yizhuo Li, Shuangrui Ding et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SetCon实现开放集指代分割
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过集级概念预测提升多目标分割性能，实验扎实且效果显著。

### 5. **[GeoX: Mastering Geospatial Reasoning Through Self-Play and Verifiable Rewards](https://arxiv.org/abs/2605.20006v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Kyeongjin Ahn, Seungeon Lee, Krishna P. Gummadi et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出GeoX自博弈框架，提升地理空间推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需大规模标注，实验结果表现优异。

## Diffusion Models

### 1. **[Probability-Conserving Flow Guidance](https://arxiv.org/abs/2605.20079v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Parsa Esmati, Junha Hyung, Amirhossein Dadashzadeh et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出AdaMaG引导方法以保持生成流概率守恒
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，解决了扩散模型引导中的流形偏离问题。

### 2. **[D$^3$-Subsidy: Online and Sequential Driver Subsidy Decision-Making for Large-Scale Ride-Hailing Market](https://arxiv.org/abs/2605.20036v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Taijie Chen, Rui Su, Siyuan Feng et al.
- **标签**: `cs.LG`
- **AI摘要**: 基于扩散模型的网约车补贴决策框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入扩散模型解决大规模动态补贴调度，实验扎实。

### 3. **[Stitched Value Model for Diffusion Alignment](https://arxiv.org/abs/2605.19804v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Hyojun Go, Hyungjin Chung, Prune Truong et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出StitchVM实现高效扩散模型对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过模型拼接技术显著提升了扩散模型对齐效率与性能

### 4. **[LIFT and PLACE: A Simple, Stable, and Effective Knowledge Distillation Framework for Lightweight Diffusion Models](https://arxiv.org/abs/2605.19729v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Hyunsoo Han, Sangyeop Yeo, Jaejun Yoo
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出LIFT与PLACE框架提升扩散模型蒸馏效率与稳定性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分阶段蒸馏与局部自适应策略，显著提升了极高压缩比下的模型性能。

### 5. **[Efficient Long-Context Modeling in Diffusion Language Models via Block Approximate Sparse Attention](https://arxiv.org/abs/2605.19726v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Wenhu Zhang, Yiming Wu, Huanyu Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出BA-Att框架实现高效长上下文扩散语言模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升了长序列计算效率。

## Multimodal

### 1. **[RECIPE: Procedural Planning via Grounding in Instructional Video](https://arxiv.org/abs/2605.19976v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Luigi Seminara, Antonino Furnari, Lorenzo Torresani
- **标签**: `cs.CV`
- **AI摘要**: 利用视频接地质量作为奖励优化程序规划
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过强化学习解决视频指令规划中的噪声与多路径问题，效果显著。

### 2. **[AffectVerse: Emotional World Models for Multimodal Affective Computing](https://arxiv.org/abs/2605.19950v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Bo Zhao, Fanghua Ye, Yixin Ji et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出AffectVerse模型，通过情感世界模块实现动态情感预测。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入情感世界模型提升了多模态情感计算的预测能力，实验扎实。

### 3. **[GroupAffect-4: A Multimodal Dataset of Four-Person Collaborative Interaction](https://arxiv.org/abs/2605.19765v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Meisam Jamshidi Seikavandi, Alice Modica, Anna Obara et al.
- **标签**: `cs.AI` `cs.DB`
- **AI摘要**: 发布多模态四人协作情感数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建严谨，多模态数据对齐完整，具有较高科研价值。

### 4. **[Stage-adaptive Token Selection for Efficient Omni-modal LLMs](https://arxiv.org/abs/2605.20035v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Zijie Xin, Jie Yang, Ruixiang Zhao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SEATS方法实现多模态大模型高效推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过层级自适应剪枝显著提升推理效率，方法创新且实验扎实。

### 5. **[A Nash Equilibrium Framework For Training-Free Multimodal Step Verification](https://arxiv.org/abs/2605.20033v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Rohit Sinha, Kunal Tilaganji, Tanuja Ganu et al.
- **标签**: `cs.CV` `cs.GT`
- **AI摘要**: 基于纳什均衡的无训练多模态验证框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出新颖博弈论验证方法，实验扎实且效果显著。

## Image Generation

### 1. **[PixVerve: Advancing Native UHR Image Generation to 100MP with a Large-Scale High-Quality Dataset](https://arxiv.org/abs/2605.20147v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Haojun Chen, Haoyang He, Chengming Xu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PixVerve数据集实现原生100MP图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了超高分辨率生成数据集空白，评估协议完善，具有较高实用价值。

### 2. **[CPC-VAR:Continual Personalized and Compositional Generation in Visual Autoregressive Models](https://arxiv.org/abs/2605.19750v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Junhao Li, Xinhao Zhong, Yi sun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出VAR模型持续个性化生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了VAR模型持续学习遗忘与多概念合成难题，方法创新且实验扎实。

### 3. **[FlowErase-RL: Rethinking Concept Erasure as Reward Optimization in Flow Matching Models](https://arxiv.org/abs/2605.19739v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Yi Sun, Zhiqi Zhang, Xinhao Zhong et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于强化学习的流匹配概念擦除框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入奖励优化机制，实验效果显著且稳健

## Video Generation

### 1. **[MSAVBench: Towards Comprehensive and Reliable Evaluation of Multi-Shot Audio-Video Generation](https://arxiv.org/abs/2605.20183v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Yujie Wei, Yujin Han, Zhekai Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个多镜头音视频生成评估基准MSAVBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了多镜头生成评估空白，方法严谨且指标对齐度高

### 2. **[CogOmniControl: Reasoning-Driven Controllable Video Generation via Creative Intent Cognition](https://arxiv.org/abs/2605.19995v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Hongji Yang, Songlian Li, Yucheng Zhou et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出推理驱动的视频生成框架CogOmniControl
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过认知模型与扩散模型闭环提升了复杂条件下的视频生成质量。

### 3. **[Aero-World: Action-Conditioned Aerial Video Generation from Inertial Controls](https://arxiv.org/abs/2605.19728v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Abdul Mohaimen Al Radi, Kunyang Li, Yuzhang Shang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Aero-World实现惯性控制的无人机视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且基准评估扎实，有效提升了动作对齐度

## Agent

### 1. **[ClinSeekAgent: Automating Multimodal Evidence Seeking for Agentic Clinical Reasoning](https://arxiv.org/abs/2605.20176v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Juncheng Wu, Letian Zhang, Yuhan Wang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出ClinSeekAgent实现临床多模态证据主动检索与推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 框架创新性强，实验设计严谨，显著提升了临床决策支持能力。

### 2. **[A Methodology for Selecting and Composing Runtime Architecture Patterns for Production LLM Agents](https://arxiv.org/abs/2605.20173v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Vasundra Srinivasan
- **标签**: `cs.AI` `cs.SE`
- **AI摘要**: 提出LLM智能体运行时架构模式与SDB设计方法
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.NE` `cs.AI` `cs.LG`
- **AI摘要**: 提出EvoTrace分析进化编码智能体机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过EvoTrace与EvoReplay揭示了智能体进化过程的本质，方法严谨且具有诊断价值。

### 4. **[Probing Embodied LLMs: When Higher Observation Fidelity Hurts Problem Solving](https://arxiv.org/abs/2605.20072v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Oussama Zenkri, Oliver Brock
- **标签**: `cs.AI` `cs.RO`
- **AI摘要**: 揭示具身智能中高保真观测反而降低任务表现的现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实验发现噪声能抑制重复动作，研究视角独特且严谨

### 5. **[Does Code Cleanliness Affect Coding Agents? A Controlled Minimal-Pair Study](https://arxiv.org/abs/2605.20049v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Priyansh Trivedi, Olivier Schmitt
- **标签**: `cs.SE` `cs.AI`
- **AI摘要**: 研究表明代码整洁度虽不影响AI代理成功率，但能提升效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨的最小对实验揭示了代码质量对AI代理行为的影响。

## Distributed Computing

### 1. **[FiLark: a streaming-first software framework for end-to-end exploration, annotation, and algorithm integration in distributed acoustic sensing](https://arxiv.org/abs/2605.20132v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Jintao Li, Weichang Li, Kai Tong et al.
- **标签**: `physics.geo-ph` `cs.LG` `eess.SP`
- **AI摘要**: 提出FiLark框架实现DAS数据流式处理与交互分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过流式抽象解决DAS高频数据处理难题，实用性强且架构清晰

### 2. **[Real-Time Parallel Counterfactual Regret Minimization](https://arxiv.org/abs/2605.19928v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Boning Li, Longbo Huang
- **标签**: `cs.GT` `cs.AI` `cs.LG`
- **AI摘要**: 提出实时并行CFR框架，显著提升博弈求解效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 并行化设计创新且实用，实验验证充分，逻辑清晰。

### 3. **[Your Neighbors Know: Leveraging Local Neighborhoods for Backdoor Detection in Decentralized Learning](https://arxiv.org/abs/2605.19969v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Sayan Biswas, Antoine Boutet, Davide Frey et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出去中心化学习后门检测框架Argus
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且具备理论保证，实验验证充分有效。

### 4. **[Deep Tech to Space: Space Data Centers and AI Revolution at the Edge](https://arxiv.org/abs/2605.19892v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Jonas Weiss, Patricia Sagmeister, Gabriel Maiolini Capez et al.
- **标签**: `cs.DC` `cs.AI` `cs.ET`
- **AI摘要**: 提出轨道数据中心架构以优化卫星数据处理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构设计创新且实用，但实验验证部分略显不足

### 5. **[Decentralized Direct Volume Rendering: A Browser-Native GPU Architecture for MRI Digital Twins in Resource-Constrained Settings](https://arxiv.org/abs/2605.19737v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Oserebameh Augustine Beckley
- **标签**: `cs.GR` `cs.CV`
- **AI摘要**: 基于WebGPU的去中心化MRI数字孪生渲染架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出浏览器原生渲染方案，有效降低医疗数字孪生部署成本。

## Information Retrieval

### 1. **[Auditing Privacy in Multi-Tenant RAG under Account Collusion](https://arxiv.org/abs/2605.19847v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-19
...
- **评分理由**: 创新性解决多租户RAG合谋隐私泄露问题，方法严谨。

### 2. **[BiRD: A Bidirectional Ranking Defense Mechanism for Retrieval Augmented Generation](https://arxiv.org/abs/2605.20123v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Chengcai Gao, Zhihong Sun, Xiaochuan Shi et al.
- **标签**: `cs.CR` `cs.IR`
- **AI摘要**: 提出BiRD双向排序防御机制以提升RAG鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性利用双向排序特征，实验充分且性能提升显著。

### 3. **[BalanceRAG: Joint Risk Calibration for Cascaded Retrieval-Augmented Generation](https://arxiv.org/abs/2605.20084v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Zijun Jia, Yuanchang Ye, Sen Jia et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出BalanceRAG实现级联RAG风险校准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过联合阈值校准优化RAG检索效率与准确性，方法严谨且实用。

### 4. **[ContextRAG: Extraction-Free Hierarchical Graph Construction for Retrieval-Augmented Generation](https://arxiv.org/abs/2605.19735v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Roman Prosvirnin, Sergei Kuznetsov, Seungmin Jin
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出无需LLM提取的层级图RAG构建方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 显著降低索引成本，方法论创新且实验对比充分。

### 5. **[Chunking German Legal Code](https://arxiv.org/abs/2605.19806v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-19
- **作者**: Max Prior, Natalia Milanova, Andreas Schultz
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 研究德国法律语料的检索增强生成分块策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对比多种分块方法，证明了保留法律结构对检索效果的重要性。

## Computer Vision

### 1. **[TideGS: Scalable Training of Over One Billion 3D Gaussian Splatting Primitives via Out-of-Core Optimization](https://arxiv.org/abs/2605.20150v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-19
- **作者**: Chonghao Zhong, Linfeng Shi, Hua Chen et al.
- **标签**: `cs.CV` `cs.PF`
- **AI摘要**: 提出TideGS实现十亿级高斯溅射外存训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破显存限制，在单卡上实现超大规模场景重建，创新性与实用性极高。

### 2. **[PiG-Avatar: Hierarchical Neural-Field-Guided Gaussian Avatars](https://arxiv.org/abs/2605.20185v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Julian Kaltheuner, Jan Spindler, Sina Kitz et al.
- **标签**: `cs.GR` `cs.CV`
- **AI摘要**: 提出PiG-Avatar实现高保真数字人建模
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解耦几何与形变，通过神经场优化实现高质量渲染

### 3. **[Interpretable Computer Vision for Defect Detection in X-ray Tomography of Aerospace SiC/SiC Composites](https://arxiv.org/abs/2605.20159v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
...
- **评分理由**: 方法创新且实用，实验严谨，具备工业应用价值。

### 4. **[Beyond Prediction Accuracy: Target-Space Recovery Profiles for Evaluating Model-Brain Alignment](https://arxiv.org/abs/2605.20127v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Ken Nakamura, Tomoya Nakai, Ryuto Yashiro et al.
- **标签**: `q-bio.NC` `cs.AI` `cs.LG`
- **AI摘要**: 提出评估模型与大脑表征对齐的新框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且严谨，有效揭示了预测准确度掩盖的差异。

### 5. **[Beyond Isotropy in JEPAs: Hamiltonian Geometry and Symplectic Prediction](https://arxiv.org/abs/2605.20107v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Robert Jenkinson Alvarez
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出HamJEPA利用哈密顿动力学优化表征学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，通过哈密顿耦合提升了表征性能。

## Machine Learning

### 1. **[Explainable Wastewater Digital Twins: Adaptive Context-Conditioned Structured Simulators with Self-Falsifying Decision Support](https://arxiv.org/abs/2605.19826v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-19
- **作者**: Gary Simethy, Daniel Ortiz Arroyo, Petar Durdevic
- **标签**: `cs.AI`
- **AI摘要**: 提出可解释废水数字孪生系统以优化曝气决策。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，在工业控制领域具有高实用价值。

### 2. **[Streamlined Constraint Reasoning via CNN Pattern Recognition on Enumerated Solutions](https://arxiv.org/abs/2605.19895v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-19
- **作者**: Patrick Spracklen
- **标签**: `cs.AI`
- **AI摘要**: 利用CNN识别解结构并驱动LLM生成约束优化求解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验效果显著，在约束求解领域有极高应用价值。

### 3. **[HaorFloodAlert: Deseasonalized ML Ensemble for 72-Hour Flood Prediction in Bangladesh Haor Wetlands](https://arxiv.org/abs/2605.20167v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Salma Hoque Talukdar Koli, Fahima Haque Talukder Jely, Md. Samiul Alim et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 针对孟加拉湿地的洪水预警系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 去季节化模型有效提升了预测精度，实用性极强。

### 4. **[When Does Model Collapse Occur in Structured Interactive Learning?](https://arxiv.org/abs/2605.20151v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Yuchen Wu, Kangjie Zhou, Weijie Su
- **标签**: `cs.LG` `math.ST`
- **AI摘要**: 揭示交互学习中模型崩溃的拓扑条件
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且创新性强，对多模型交互有重要指导意义

### 5. **[TrajTok: Adaptive Spatial Tokenization for Trajectory Representation Learning](https://arxiv.org/abs/2605.20134v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-19
- **作者**: Zhen Xiong, Shang-Ling Hsu, Cyrus Shahabi
- **标签**: `cs.LG`
- **AI摘要**: 提出自适应多分辨率轨迹表征学习框架
<details>
<summary>原始摘要</summary>
