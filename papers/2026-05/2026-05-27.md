...
- **作者**: Matt L. Wiemann, Lindsay M. Smith, Peter Melchior et al.
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出DiscoverPhysics基准以评估LLM的科学发现与推理能力。
<details>
...
- **评分理由**: 通过动态物理模拟测试模型推理，方法严谨且创新性强。

### 2. **[Reading the Finetuning Prior: Verbatim Content Recovery via Contrastive Decoding Diffing](https://arxiv.org/abs/2605.25902v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Michał Brzozowski, Zuzanna Dubanowska, Enrico Cassano et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出CDD方法，无需权重访问即可高精度提取微调数据。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，在黑盒条件下优于白盒方法，实验严谨。

### 3. **[An Efficient and Privacy-Preserving Architecture for Cross-Institutional Collaborative RAG](https://arxiv.org/abs/2605.25716v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Chenxin Mao, Shangyu Liu, Zhenzhe Zheng et al.
- **标签**: `cs.CR` `cs.DC`
- **AI摘要**: 提出FedRAG实现跨机构隐私保护检索增强生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决分布式注意力隐私问题，性能提升显著

### 4. **[How Should LLMs Consume High-Quality Data? Optimal Data Scheduling via Quality-Aware Functional Scaling Laws](https://arxiv.org/abs/2605.25698v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Zhitao Zhu, Xili Wang, Shizhe Wu et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出基于数据质量的动态调度策略以优化大模型训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，实验效果显著，对训练调度有重要参考价值

### 5. **[Forgetting in Language Models: Capacity, Optimization, and Self-Generated Replay](https://arxiv.org/abs/2605.26097v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Martin Marek, Dongkyu Cho, Shikai Qiu et al.
- **标签**: `cs.LG`
- **AI摘要**: 利用自生成样本解决大模型灾难性遗忘问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出自生成回放机制，有效缓解遗忘且无需存储旧数据

## Natural Language Processing

### 1. **[StakeBench: Evaluating Language Understanding Grounded in Market Commitment](https://arxiv.org/abs/2605.26074v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Yunhua Pei, Jingyu Hu, Yiwei Shi et al.
- **标签**: `cs.CL` `cs.AI` `q-fin.GN`
- **AI摘要**: 提出基于市场承诺的金融NLP评估框架StakeBench。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过真实市场行为验证模型理解，方法创新且严谨。

### 2. **[Forgotten Words: Benchmarking NeoBERT for Dementia Detection in Low-Resource Conversational Filipino and English Speech](https://arxiv.org/abs/2605.26007v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Rez Samantha Z. Floresca, Edric Castel C. Hao, Hannah Grachiella Buñales et al.
- **标签**: `cs.CL`
- **AI摘要**: 首个菲律宾语痴呆症检测研究
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补低资源语言临床NLP空白，实验设计严谨且结论明确。

### 3. **[TTPrint: Evidence-Grounded TTP Extraction via Diverge-then-Converge Verification](https://arxiv.org/abs/2605.25836v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Yutong Cheng, Changze Li, Raihan Sultan Pasha Basuki et al.
- **标签**: `cs.CR` `cs.AI` `cs.CL`
- **AI摘要**: 提出分歧-收敛框架实现高精度TTP提取
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升了威胁情报提取性能。

### 4. **[Testing the Deliteralization Hypothesis in Human and Machine Translation](https://arxiv.org/abs/2605.25686v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
...
- **评分理由**: 研究方法严谨，系统性验证了LLM翻译的演进规律。

### 5. **[WhoSaidIt: Human-LLM Collaborative Annotation for Text-Based Multilingual Speaker-Attribute Classification](https://arxiv.org/abs/2605.26070v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Lingyu Gao, Will Monroe, David Smith et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出人机协作框架优化多语言说话人属性标注。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，对标注质量提升显著。

## Vision Language Models

### 1. **[LLaVA-OneVision-2: Towards Next-Generation Perceptual Intelligence](https://arxiv.org/abs/2605.25979v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Xiang An, Yin Xie, Feilong Tang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出codec-stream编码提升视频理解与时空定位能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入编解码流标记化，显著提升长视频处理性能。

### 2. **[MAGIC: Multimodal Alignment & Grounding-aware Instruction Coreset for Vision-Language Models](https://arxiv.org/abs/2605.26004v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-25
- **作者**: Shristi Das Biswas, Kaushik Roy
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出MAGIC方法实现高效多模态指令微调数据集精简。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且高效，实验详实，显著提升了训练效率与性能。

### 3. **[Capability and Robustness Cannot Both Be Free: An Information-Theoretic Bound for Vision-Language-Action Models](https://arxiv.org/abs/2605.25889v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-25
- **作者**: Jianwei Tai
- **标签**: `cs.CR` `cs.LG`
- **AI摘要**: 提出VLA模型鲁棒性与性能的理论权衡边界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过信息论证明了VLA模型的鲁棒性上限，理论严谨且具有重要指导意义。

### 4. **[EVIDENT: Routing MLLM Adaptation through Entity-Grounded Visual Evidence for Cross-Domain Video Temporal Grounding](https://arxiv.org/abs/2605.26104v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Geo Ahn, Jiwook Han, Youngrae Kim et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出EVIDENT框架提升视频时序定位的跨域泛化能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将推理内化至潜在空间，显著提升效率与性能。

## Diffusion Models

### 1. **[Everything at Every Scale: Scale-Invariant Diffusion with Continuous Super-Resolution](https://arxiv.org/abs/2605.26032v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Zixin Jessie Chen, Zhuo Chen, Archer Wang et al.
- **标签**: `cs.CV` `cond-mat.stat-mech` `cs.AI`
- **AI摘要**: 提出SKILD统一生成与超分任务
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将多尺度扩散模型统一化，实验效果显著且方法严谨。

### 2. **[Looped Diffusion Language Models](https://arxiv.org/abs/2605.26106v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Sanghyun Lee, Chunsan Hong, Seungryong Kim et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出循环掩码扩散模型提升训练与推理效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入层循环机制，显著提升计算效率与性能表现。

### 3. **[$D^2$-Monitor: Dynamic Safety Monitoring for Diffusion LLMs via Hesitation-Aware Routing](https://arxiv.org/abs/2605.25893v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Aoxi Liu, Yupeng Chen, James Oldfield et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出D2-Monitor实现扩散模型高效安全监测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入犹豫感知路由，兼顾监测精度与计算效率。

### 4. **[OMGTex: One-stage Multi-style Facial Texture Reconstruction without Geometry Guidance](https://arxiv.org/abs/2605.25778v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Zitong Xiao, Yuda Qiu, Zisheng Ye et al.
- **标签**: `cs.CV`
- **AI摘要**: 首个无需几何引导的端到端人脸纹理重建扩散模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地去除了几何依赖，并构建了高质量数据集，实验充分。

### 5. **[Concept Unlearning via Cross-Attention Activation Projection for Diffusion Models](https://arxiv.org/abs/2605.25765v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Saemi Moon, Suhyeon Jun, Seoyeon Lee et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出PURE方法实现扩散模型概念遗忘
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过跨注意力激活投影实现高效遗忘，性能优异。

## Multimodal

### 1. **[Hidden in Plain Tokens: Simply Robust, Gradient-Free Watermark for Synthetic Audio](https://arxiv.org/abs/2605.25967v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Georgios Milis, Yubin Qin, Yihan Wu et al.
- **标签**: `cs.LG` `cs.SD`
- **AI摘要**: 提出一种无需梯度的音频水印技术
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用词表冗余实现鲁棒水印，方法创新且实验扎实。

### 2. **[Double Triangle Annotation: A Scalable Human-in-the-Loop Framework for High-Precision Historical Document Annotation](https://arxiv.org/abs/2605.25781v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Yi Ren
- **标签**: `cs.CL`
- **AI摘要**: 提出双三角标注框架实现高精度历史文档信息提取
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合多模态模型共识与人机交互，实验严谨且实用性强。

### 3. **[Context-driven Missing-Modality Learning for Robust Medical Diagnosis with Image-Tabular Data](https://arxiv.org/abs/2605.25968v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Tianling Liu, Lequan Yu, Tong Han et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CMML框架解决医疗多模态缺失难题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效提升了缺失模态下的诊断性能

### 4. **[STaT: Resolving Shape Distortion in Non-Stationary Time Series via Tri-Modal Synergy](https://arxiv.org/abs/2605.25943v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Hui Cheng, Jinsheng Guo, Zhenhao Weng et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出STaT架构解决非平稳时间序列形状失真问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过符号、时序与文本三模态协同，显著提升预测精度与形态还原度。

### 5. **[Prism: A Plug-in Reproducible Infrastructure for Scalable Multimodal Continual Instruction Tuning](https://arxiv.org/abs/2605.26110v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-25
- **作者**: Jun-Tao Tang, Yu-Cheng Shi, Zhen-Hao Xie et al.
- **标签**: `cs.LG` `cs.CL` `cs.CV`
- **AI摘要**: 提出Prism框架以解耦多模态持续指令微调的工程实现。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过插件化设计解决了MCIT代码耦合问题，提升了研究效率。

## Image Generation

### 1. **[Reinforcing Few-step Generators via Reward-Tilted Distribution Matching](https://arxiv.org/abs/2605.26108v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Yushi Huang, Xiangxin Zhou, Ruoyu Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出RTDMD框架，实现高效少步扩散模型偏好对齐。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在多项指标上达到SOTA水平。

### 2. **[Channel-wise Vector Quantization](https://arxiv.org/abs/2605.26089v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Wei Song, Tianhang Wang, Yitong Chen et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出通道级向量量化与自回归生成范式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入通道级量化，实验效果显著且逻辑清晰。

### 3. **[Towards Anatomically Plausible Human Image Generation via Synthetic Localized Preferences](https://arxiv.org/abs/2605.25759v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Bao Li, Yuliang Xiu, Zhen Liu
- **标签**: `cs.CV`
- **AI摘要**: 提出ASAP框架通过局部偏好优化提升人体生成解剖准确性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且针对性强，实验设计严谨，有效解决解剖伪影问题

### 4. **[DyCoRM: Dynamic Criterion-Aware Reward Modeling for Text-to-Image Generation](https://arxiv.org/abs/2605.25876v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Jiaying Qian, Ziheng Jia, Qian Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出动态准则感知奖励模型以提升文生图对齐度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入动态准则建模与新数据集，方法创新且实验扎实。

## Video Generation

### 1. **[On-Policy Adversarial Flow Distillation for Autoregressive Video Generation](https://arxiv.org/abs/2605.26105v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Yang Luo, Shengju Qian, Xiaohang Tang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出AFD框架实现黑盒视频模型的高效蒸馏
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，解决了自回归视频生成的蒸馏难题

### 2. **[Where Concept Erasure Should Occur: Concept-Layer Alignment in Text-to-Video Diffusion Models](https://arxiv.org/abs/2605.25941v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Yiwei Xie, Ping Liu, Zheng Zhang
- **标签**: `cs.CV`
- **AI摘要**: 提出CLEAR框架实现视频模型概念擦除
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过层级对齐优化概念擦除，方法创新且实验扎实。

### 3. **[PixelWizard: Towards Efficient High-Fidelity Video Generation at Ultra-Large Spatial Resolution](https://arxiv.org/abs/2605.25801v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Wenxue Li, Jingjing Ren, Peng Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出分层解耦与加速采样框架实现超高清视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决高分辨率视频生成的结构与效率瓶颈，实验扎实。

### 4. **[Helix4D: Complex 4D Mesh Generation](https://arxiv.org/abs/2605.26109v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Jiraphon Yenphraphai, Jianqi Chen, Jian Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Helix4D框架实现高质量动态网格生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过跨帧注意力与时序编码优化4D生成，方法创新且实验扎实

### 5. **[Paris 2.0: A Decentralized Diffusion Model for Video Generation](https://arxiv.org/abs/2605.26064v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Ali Rouzbayani, Bidhan Roy, Marcos Villagra et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 首个去中心化训练的视频生成模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过去中心化计算显著提升视频生成质量，创新性强。

## Agent

### 1. **[PathWISE: Multi-Agent Cancer Pathway Triaging Ontology Learning from Clinical Flowcharts](https://arxiv.org/abs/2605.25970v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Sofiat Abioye, Ufaq Khan, Shazad Ashraf et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出多智能体框架将临床流程图转化为可执行代码
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地结合LLM与确定性算法，有效解决医疗流程自动化难题。

### 2. **[The Behavioral Credibility Trilemma: When Calibrated Autonomy Becomes Impossible](https://arxiv.org/abs/2605.25739v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Lauri Lovén, Nam Do, Hassan Mehmood et al.
- **标签**: `cs.LG` `cs.GT` `stat.ML`
- **AI摘要**: 揭示强化学习自主性与校准的数学不可能三角
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，实验验证充分，对智能体对齐有深远影响。

### 3. **[MobileGym: A Verifiable and Highly Parallel Simulation Platform for Mobile GUI Agent Research](https://arxiv.org/abs/2605.26114v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-25
- **作者**: Dingbang Wu, Rui Hao, Haiyang Wang et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 高效移动端GUI智能体仿真平台
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出可验证且高并发的仿真框架，有效提升智能体训练效率。

### 4. **[Automated Benchmark Auditing for AI Agents and Large Language Models](https://arxiv.org/abs/2605.26079v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-25
- **作者**: Junlin Wang, Federico Bianchi, Shang Zhu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出自动化审计框架以纠正AI基准测试中的错误。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，显著提升了基准测试的可靠性。

### 5. **[From Model Scaling to System Scaling: Scaling the Harness in Agentic AI](https://arxiv.org/abs/2605.26112v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Shangding Gu
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出代理AI系统架构设计框架以提升长程任务表现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 强调系统架构对代理AI的重要性，并提供了参考实现。

## Distributed Computing

### 1. **[From Accounting to Coordination: A Virtual Water-Aware Electricity-Computation-Water Nexus Framework for Data Center Dispatch](https://arxiv.org/abs/2605.25854v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Haiyang You, Chengwei Lou, Jin Zhao et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ECW框架优化数据中心水资源调度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将虚拟水足迹纳入电力调度优化，方法严谨且具备实际应用价值。

### 2. **[Joint Optimization of Training and Inference in Federated Edge Learning via Constrained Multi-Objective Deep Reinforcement Learning](https://arxiv.org/abs/2605.25916v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Zhen Li, Jun Cai, Chao Yang et al.
- **标签**: `cs.LG` `cs.DC` `cs.NI`
- **AI摘要**: 提出C-MOPPO优化边缘联邦学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效平衡了多目标优化需求。

### 3. **[Proof of Useful Attestation: A Consensus Primitive for Attestation-Native Chains](https://arxiv.org/abs/2605.25844v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Stefan Stefanović
- **标签**: `cs.CR` `cs.DC` `cs.GT`
- **AI摘要**: 提出PoUA共识机制以优化证明工作权重
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 机制设计新颖且具备经济学证明，实用性较强

### 4. **[Profiling-Driven Adaptive Distributed Transformer Inference on Embedded Edge Deployment](https://arxiv.org/abs/2605.25682v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Muhammad Azlan Qazi, Alexandros Iosifidis, Qi Zhang
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 提出嵌入式边缘分布式推理自适应策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对边缘硬件通信瓶颈提出有效优化，实验扎实。

## Information Retrieval

### 1. **[DeGRe: Dense-supervised Generative Reranking for Recommendation](https://arxiv.org/abs/2605.25749v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Chaotian Song, Jingyao Zhang, Chenghao Chen et al.
- **标签**: `cs.IR` `cs.AI` `cs.LG`
- **AI摘要**: 提出DeGRe框架，通过稠密监督提升重排序效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且工业落地效果显著，实验严谨，逻辑清晰。

### 2. **[SIREN: Unified Multi-Granularity Semantic Interaction for Multi-Modal Lifelong User Interest Modeling](https://arxiv.org/abs/2605.25726v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Yaqian Zhang, Ruyi Yu, Tianyi Li et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出多粒度语义交互框架SIREN，提升多模态推荐性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业界落地效果显著，方法创新且实验充分，具有高实用价值。

### 3. **[Retrieval-Augmented Detection of Potentially Abusive Clauses in Chilean Terms of Service](https://arxiv.org/abs/2605.26019v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Christoffer Loeffler, Tomás Rey Pizarro, Daniel Ignacio Miranda Vásquez et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出智利合同条款检索增强检测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，数据集构建扎实，评估严谨。

### 4. **[SemBridge: Language Transfer in Sparse Encoders via Multilingual Semantic Bridges](https://arxiv.org/abs/2605.26002v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Seongtae Hong, Youngjoon Jang, Jia-Heui Ju et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出SemBridge实现稀疏编码器跨语言迁移
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效提升多语言检索性能。

### 5. **[GCIB: Graph Contrastive Information Bottleneck for Multi-Behavior Recommendation](https://arxiv.org/abs/2605.25690v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-25
- **作者**: Likang Wu, Zihao Chen, Jianxin Zhang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出GCIB框架以优化多行为推荐中的噪声与稀疏性问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合信息瓶颈与对比学习，方法创新且实验详实。

## Computer Vision

### 1. **[A Clinically Validated Foundation Model for Comprehensive Lung Pathology Interpretation](https://arxiv.org/abs/2605.25878v1)**
- **评分**: ⭐ 92/100 | **日期**: 2026-05-25
- **作者**: Zhengrui Guo, Zhengyu Zhang, Jiabo Ma et al.
- **标签**: `eess.IV` `cs.CV`
- **AI摘要**: 提出肺病理基础模型并完成临床验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 多中心前瞻性验证与RCT实验设计极其严谨，临床价值极高。

### 2. **[TriSplat: Simulation-Ready Feed-Forward 3D Scene Reconstruction](https://arxiv.org/abs/2605.26115v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Weijie Wang, Zimu Li, Jinchuan Shi et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出TriSplat实现直接输出仿真就绪的三角面片三维重建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合 occupancy 与扩散模型，实验详实且应用价值高。

### 4. **[Global Structure-from-Motion Meets Feedforward Reconstruction](https://arxiv.org/abs/2605.26103v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Linfei Pan, Johannes Schönberge, Marc Pollefeys
- **标签**: `cs.CV`
- **AI摘要**: 结合传统SfM与前馈重建的混合框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 融合了两种方法的优势，实验充分且性能领先。

### 5. **[Look Both Ways Before You Cross: Lifting Cross Fields From 2D Visual Priors](https://arxiv.org/abs/2605.26062v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Dale Decatur, Jacob Serfaty, Oded Stein et al.
- **标签**: `cs.GR` `cs.CV`
- **AI摘要**: 利用视觉先验实现网格跨场计算
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入视觉先验优化网格，方法论严谨且实用。

## Machine Learning

### 1. **[Branched Signature Kernel Solvers for ODEs with rough Single-Trajectory signals](https://arxiv.org/abs/2605.25826v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Munawar Ali, Qi Feng, Charlie Pyle et al.
- **标签**: `math.NA` `cs.CE` `cs.LG`
- **AI摘要**: 提出基于分支签名核的单轨迹ODE求解器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入计数采样，理论严谨且实验覆盖广泛，实用价值高。

### 2. **[PAC Learning with Bandit Feedback: Sharp Sample Complexity in the Realizable Setting](https://arxiv.org/abs/2605.25678v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-25
- **作者**: Steve Hanneke, Qinglin Meng, Shay Moran et al.
- **标签**: `stat.ML` `cs.DS` `cs.LG`
- **AI摘要**: 提出带反馈PAC学习的样本复杂度理论刻画
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论贡献显著，引入新维度并提供最优算法，严谨性高。

### 3. **[Goal-driven Bayesian Optimal Experimental Design for Robust Decision-Making Under Model Uncertainty](https://arxiv.org/abs/2605.26093v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Jinwoo Go, Xiaoning Qian, Byung-Jun Yoon
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出目标导向的贝叶斯实验设计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论扎实，在决策任务中表现优异。

### 4. **[Global Convergence of Wasserstein Policy Gradient for Entropy-Regularized Reinforcement Learning](https://arxiv.org/abs/2605.26078v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Zhaoyu Zhu, Rui Gao, Shuang Li
- **标签**: `cs.LG`
- **AI摘要**: 揭示了WPG算法的全局收敛性及PL几何结构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论深度极高，通过Bellman结构证明了收敛性，具有重要的学术价值。

### 5. **[Rethinking Weak Supervision in Anomaly Detection: A Comprehensive Benchmark](https://arxiv.org/abs/2605.26068v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-25
- **作者**: Xu Yao, Siyuan Zhou, Wu Zhenbo et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 构建WSADBench统一弱监督异常检测评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性基准测试揭示了弱监督异常检测的性能边界与规律
