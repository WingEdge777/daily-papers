...
### 1. **[DARTS: Targeting Prognostic Covariates in Budget-Constrained Sequential Experiments](https://arxiv.org/abs/2605.06608v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Kateryna Husar, Alexander Volfovsky
- **标签**: `stat.ML` `cs.LG` `stat.ME`
- **AI摘要**: 提出DARTS算法优化预算受限下的协变量选择与因果推断。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论严谨，有效解决了实验设计中的预算权衡问题。

### 2. **[ReActor: Reinforcement Learning for Physics-Aware Motion Retargeting](https://arxiv.org/abs/2605.06593v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: David Müller, Agon Serifi, Sammy Christen et al.
- **标签**: `cs.RO` `cs.GR` `cs.LG`
- **AI摘要**: 基于强化学习的物理感知运动重定向框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过双层优化实现物理一致的运动迁移，方法创新且实用。

### 3. **[BRICKS: Compositional Neural Markov Kernels for Zero-Shot Radiation-Matter Simulation](https://arxiv.org/abs/2605.06591v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Richard Hildebrandt, Evangelos Kourlitis, Baran Hashemi et al.
- **标签**: `cs.LG` `hep-ph`
- **AI摘要**: 提出基于流匹配的辐射物质交互神经模拟器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合流匹配与马尔可夫核，在物理模拟领域具有高实用性与严谨性。

### 4. **[Towards Metric-Faithful Neural Graph Matching](https://arxiv.org/abs/2605.06588v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Jyotirmaya Shivottam, Subhankar Mishra
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出双Lipschitz几何框架优化图匹配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架扎实且实验验证了几何约束的有效性

### 5. **[On the Safety of Graph Representation Learning](https://arxiv.org/abs/2605.06576v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Xiaoguang Guo, Zehong Wang, Ziming Li et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出GRL-Safety基准以评估图表示学习的安全性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估了图学习的安全性，实验严谨且具有重要实用价值。
