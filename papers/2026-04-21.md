...
### 1. **[Find, Fix, Reason: Context Repair for Video Reasoning](https://arxiv.org/abs/2604.16243v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Haojian Huang, Chuanyu Qin, Yinchuan Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 引入教师模型干预以增强视频推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地结合了教师干预与GRPO优化，实验效果显著。

### 2. **[Information Router for Mitigating Modality Dominance in Vision-Language Models](https://arxiv.org/abs/2604.16264v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Seulgi Kim, Mohit Prabhushankar, Ghassan AlRegib
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出MoIR路由机制以平衡多模态信息贡献
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过信息级融合解决模态主导问题，方法创新且实验扎实。

### 3. **[DenTab: A Dataset for Table Recognition and Visual QA on Real-World Dental Estimates](https://arxiv.org/abs/2604.16099v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Laziz Hamdi, Amine Tamasna, Thierry Paquet
- **标签**: `cs.CV`
- **AI摘要**: 提出DenTab数据集及表格推理流水线
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建扎实，提出的路由流水线有效解决了表格算术推理难题。

### 4. **[Making Image Editing Easier via Adaptive Task Reformulation with Agentic Executions](https://arxiv.org/abs/2604.15917v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Bo Zhao, Kairui Guo, Runnan Du et al.
- **标签**: `cs.CV`
- **AI摘要**: 通过智能体自适应重构任务提升图像编辑性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效解决了指令编辑的鲁棒性问题

### 5. **[UniEditBench: A Unified and Cost-Effective Benchmark for Image and Video Editing via Distilled MLLMs](https://arxiv.org/abs/2604.15871v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Lifan Jiang, Tianrun Wu, Yuhang Pei et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出统一图像视频编辑评测基准及蒸馏评估模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏大模型实现高效评测，方法论严谨且具备高实用价值。
...
### 1. **[Robust Synchronisation for Federated Learning in The Face of Correlated Device Failure](https://arxiv.org/abs/2604.16090v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Stefan Behfar, Richard Mortier
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 提出AW-PSP算法解决联邦学习中设备失效相关性与偏差问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态采样与马尔可夫预测提升了联邦学习的公平性与鲁棒性

### 2. **[T-RBFT: A Scalable and Efficient Byzantine Consensus Based on Trusted Execution Environment for Consortium Blockchain](https://arxiv.org/abs/2604.16053v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Wen Gao, Xinhong Hei, Yichuan Wang
- **标签**: `cs.DC`
- **AI摘要**: 提出基于TEE的T-RBFT共识机制以提升联盟链性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合TEE与分片技术优化了共识效率，实验验证充分

### 3. **[New Kids: An Architecture and Performance Investigation of Second-Generation Serverless Platforms](https://arxiv.org/abs/2604.15916v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Trever Schirmer, Aris Wiegand, Lucca di Benedetto et al.
- **标签**: `cs.DC`
- **AI摘要**: 分析第二代无服务器平台的架构与性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估了新型无服务器架构，实验规模宏大且结论明确。

### 4. **[Accuracy Is Speed: Towards Long-Context-Aware Routing for Distributed LLM Serving](https://arxiv.org/abs/2604.15732v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Takeshi Yoshimura, Valentijn Dymphnus van de Beek, Tatsuhiro Chiba
- **标签**: `cs.DC`
- **AI摘要**: 提出TTCA指标并设计LAAR路由以优化长文本推理效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将准确率与系统延迟结合，方法论证扎实。

### 5. **[Training Time Prediction for Mixed Precision-based Distributed Training](https://arxiv.org/abs/2604.16145v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-04-17
- **作者**: Minchul Kang, Changyong Shin, Jinwoo Jeong et al.
- **标签**: `cs.LG` `cs.AI` `cs.DC`
- **AI摘要**: 提出一种混合精度感知分布式训练时间预测模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对混合精度训练的预测误差问题，方法有效且实验扎实。

## Information Retrieval

### 1. **[Sketch and Text Synergy: Fusing Structural Contours and Descriptive Attributes for Fine-Grained Image Retrieval](https://arxiv.org/abs/2604.15735v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-04-17
- **作者**: Siyuan Wang, Hanchen Gao, Guangming Zhu et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出融合草图与文本的细粒度图像检索框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多模态协同与特征对齐提升检索精度，方法扎实且贡献了新数据集。

### 2. **[A Case Study on the Impact of Anonymization Along the RAG Pipeline](https://arxiv.org/abs/2604.15958v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-04-17
- **作者**: Andreea-Elena Bodea, Stephen Meisenbacher, Florian Matthes
- **标签**: `cs.CR` `cs.CL`
- **AI摘要**: 研究RAG管道中匿名化处理的最佳位置以平衡隐私与效用。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了RAG隐私保护策略的空白，实验设计合理且实用。
...
### 1. **[When Do Early-Exit Networks Generalize? A PAC-Bayesian Theory of Adaptive Depth](https://arxiv.org/abs/2604.15764v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Dongxin Guo, Jikun Wu, Siu Ming Yiu
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出早退网络PAC-Bayesian泛化理论
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新显著，界限紧致且实验验证充分。

### 2. **[ASMR-Bench: Auditing for Sabotage in ML Research](https://arxiv.org/abs/2604.16286v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Eric Gan, Aryan Bhatt, Buck Shlegeris et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ASMR-Bench基准以评估AI研究中的代码篡改检测能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 选题新颖且具有重要安全意义，实验设计严谨，评估结果详实。

### 3. **[Sample Complexity Bounds for Stochastic Shortest Path with a Generative Model](https://arxiv.org/abs/2604.16111v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Jean Tarbouriech, Matteo Pirotta, Michal Valko et al.
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 揭示SSP问题样本复杂度下界及学习难度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，首次证明SSP在特定条件下不可学习

### 4. **[A Wasserstein Geometric Framework for Hebbian Plasticity](https://arxiv.org/abs/2604.16052v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Ulrich Tan
- **标签**: `math.OC` `cs.LG` `math.PR`
- **AI摘要**: 提出基于Wasserstein几何的赫布学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，将神经可塑性统一于变分几何框架，严谨性高。

### 5. **[Discovering quantum phenomena with Interpretable Machine Learning](https://arxiv.org/abs/2604.16015v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Paulin de Schoulepnikoff, Hendrik Poulsen Nautrup, Hans J. Briegel et al.
- **标签**: `quant-ph` `cond-mat.stat-mech` `cs.LG`
- **AI摘要**: 提出可解释机器学习框架以发现量子物理定律
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合变分自编码器与符号回归，在量子数据分析上具有创新性与实用性。
