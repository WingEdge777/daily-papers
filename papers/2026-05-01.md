...
### 1. **[State Beyond Appearance: Diagnosing and Improving State Consistency in Dial-Based Measurement Reading](https://arxiv.org/abs/2604.26614v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-29
- **作者**: Yuanze Hu, Gen Li, Yuqin Lan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出TriSCA框架提升仪表读数的一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 诊断分析深入，提出的对齐框架有效解决了视觉鲁棒性问题。

### 2. **[SpatialFusion: Endowing Unified Image Generation with Intrinsic 3D Geometric Awareness](https://arxiv.org/abs/2604.26341v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-29
- **作者**: Haiyi Qiu, Kaihang Pan, Jiacheng Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 引入空间Transformer实现三维几何感知图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入几何引导机制，显著提升空间一致性与生成质量。

### 3. **[CurEvo: Curriculum-Guided Self-Evolution for Video Understanding](https://arxiv.org/abs/2604.26707v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
...
- **评分理由**: 引入课程学习优化视频自进化，方法创新且实验扎实。

### 4. **[Progressive Semantic Communication for Efficient Edge-Cloud Vision-Language Models](https://arxiv.org/abs/2604.26508v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Cyril Shih-Huan Hsu, Wig Yuan-Cheng Cheng, Chrysa Papagianni
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出边缘云协同的渐进式语义通信框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过元自编码器实现VLM高效传输，实验验证充分且实用。

### 5. **[Delineating Knowledge Boundaries for Honest Large Vision-Language Models](https://arxiv.org/abs/2604.26419v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Junru Song, Yimeng Hu, Yijing Chen et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出Visual-Idk框架提升VLM拒答未知问题的能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法系统且实验扎实，有效提升了模型知识边界的识别能力。
...
### 1. **[Unified 4D World Action Modeling from Video Priors with Asynchronous Denoising](https://arxiv.org/abs/2604.26694v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-29
- **作者**: Jun Guo, Qiwei Li, Peiyan Li et al.
- **标签**: `cs.RO` `cs.AI` `cs.CV`
- **AI摘要**: 提出X-WAM模型实现机器人动作与4D世界建模统一
<details>
<summary>原始摘要</summary>
...
### 1. **[A Semantic Quantum Circuit Cache for Scalable and Distributed Quantum-Classical Workflows](https://arxiv.org/abs/2604.26788v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-29
- **作者**: Mar Tejedor, Javier Conejero, Rosa M. Badia
- **标签**: `cs.DC` `quant-ph`
- **AI摘要**: 提出量子电路缓存系统以消除冗余计算
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过ZX演算与图哈希实现语义等价，显著提升量子计算效率。

### 2. **[Folding Tensor and Sequence Parallelism for Memory-Efficient Transformer Training & Inference](https://arxiv.org/abs/2604.26294v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-29
- **作者**: Vasu Shyam, Anna Golubeva, Quentin Anthony
- **标签**: `cs.CL` `cs.DC`
- **AI摘要**: 提出TSP并行策略优化显存效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合张量与序列并行，有效降低显存开销。

### 3. **[Adaptive Self-Organization in Anonymous Dynamic Networks](https://arxiv.org/abs/2604.26931v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Garrett Parzych, Joshua J. Daymude
- **标签**: `cs.DC`
- **AI摘要**: 提出匿名动态网络自组织算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，解决了动态网络下的分布收敛问题。

### 4. **[FaaSMoE: A Serverless Framework for Multi-Tenant Mixture-of-Experts Serving](https://arxiv.org/abs/2604.26881v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Minghe Wang, Trever Schirmer, Mohammadreza Malekabbasi et al.
- **标签**: `cs.DC` `cs.LG`
- **AI摘要**: 提出基于FaaS的MoE多租户推理架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过FaaS实现MoE专家按需调用，显著提升了资源利用率。

### 5. **[Asynchronous Federated Unlearning with Invariance Calibration for Medical Imaging](https://arxiv.org/abs/2604.26809v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Zhaoyuan Cai, Xinglin Zhang
- **标签**: `cs.LG`
- **AI摘要**: 提出异步联邦遗忘框架AFU-IC
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了联邦学习遗忘的异步延迟与数据残留问题，方法创新且实验扎实。

## Information Retrieval

### 1. **[When to Retrieve During Reasoning: Adaptive Retrieval for Large Reasoning Models](https://arxiv.org/abs/2604.26649v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-29
- **作者**: Dongxin Guo, Jikun Wu, Siu Ming Yiu
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 提出推理感知检索框架，提升推理模型检索效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决推理模型检索时机问题，实验严谨且提升显著。

### 2. **[Factorized Latent Reasoning for LLM-based Recommendation](https://arxiv.org/abs/2604.26760v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Tianqi Gao, Chengkai Huang, Zihan Wang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出FLR框架，通过分解潜在推理提升推荐性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了多维偏好建模问题。

### 3. **[Efficient Listwise Reranking with Compressed Document Representations](https://arxiv.org/abs/2604.26483v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Hervé Déjean, Stéphane Clinchant
- **标签**: `cs.IR`
- **AI摘要**: 提出RRK压缩文档表示实现高效重排序
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏压缩文档表示显著提升重排序效率与性能

### 4. **[CARD: Non-Uniform Quantization of Visual Semantic Unit for Generative Recommendation](https://arxiv.org/abs/2604.26427v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Yibiao Wei, Jie Zou, Pengfei Zhang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出CARD框架解决生成式推荐的语义编码与量化不均问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了推荐系统的语义表示质量

### 5. **[Benchmarking Complex Multimodal Document Processing Pipelines: A Unified Evaluation Framework for Enterprise AI](https://arxiv.org/abs/2604.26382v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Saurabh K. Singh, Sachin Raj
- **标签**: `cs.CL` `cs.AI` `cs.IR`
- **AI摘要**: 提出企业文档AI全链路评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估多模态文档处理流水线，指标全面且具实践价值。
...
### 1. **[Stochastic Scaling Limits and Synchronization by Noise in Deep Transformer Models](https://arxiv.org/abs/2604.26898v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-29
- **作者**: Andrea Agazzi, Giuseppe Bruno, Eloy Mosig García et al.
- **标签**: `math.PR` `cs.LG` `stat.ML`
- **AI摘要**: 证明Transformer层演化收敛至随机粒子系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，揭示了Transformer深度与噪声同步机制

### 2. **[On the Learning Curves of Revenue Maximization](https://arxiv.org/abs/2604.26922v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-29
- **作者**: Steve Hanneke, Alkis Kalavasis, Shay Moran et al.
- **标签**: `cs.LG` `cs.DS` `cs.GT`
- **AI摘要**: 揭示了单物品拍卖中收益最大化学习曲线的收敛速率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论贡献扎实，填补了收益最大化学习理论的空白。

### 3. **[Causal Learning with Neural Assemblies](https://arxiv.org/abs/2604.26919v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-29
- **作者**: Evangelia Kopadi, Dimitris Kalles
- **标签**: `cs.LG` `cs.AI` `cs.NE`
- **AI摘要**: 提出DIRECT机制实现神经组件因果学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过局部可塑性实现因果推断，兼具生物合理性与可解释性。

### 4. **[Uncertainty-Aware Predictive Safety Filters for Probabilistic Neural Network Dynamics](https://arxiv.org/abs/2604.26836v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-29
- **作者**: Bernd Frauenknecht, Lukas Kesper, Daniel Mayfrank et al.
- **标签**: `cs.LG` `eess.SY`
- **AI摘要**: 提出UPSi提升强化学习安全性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合概率集成模型与安全滤波，方法创新且实验扎实。

### 5. **[Who Trains Matters: Federated Learning under Enrollment and Participation Selection Biases](https://arxiv.org/abs/2604.26604v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-29
- **作者**: Gota Morishita
- **标签**: `cs.LG`
- **AI摘要**: 提出FedIPW框架以纠正联邦学习中的选择偏差。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，系统性地解决了联邦学习中的样本选择偏差问题。
