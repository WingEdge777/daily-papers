...
### 1. **[AEGIS: Anchor-Enforced Gradient Isolation for Knowledge-Preserving Vision-Language-Action Fine-Tuning](https://arxiv.org/abs/2604.16067v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Guransh Singh
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出AEGIS通过正交投影解决VLM微调中的灾难性遗忘问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决梯度冲突，方法论严谨且具备高实用价值

### 2. **[Do Vision-Language Models Truly Perform Vision Reasoning? A Rigorous Study of the Modality Gap](https://arxiv.org/abs/2604.16256v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Yige Xu, Yongjie Wang, Zizhuo Wu et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出CrossMath基准揭示VLM视觉推理缺陷
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨的跨模态对比实验揭示了VLM的视觉推理局限性

### 3. **[MARCH: Multi-Agent Radiology Clinical Hierarchy for CT Report Generation](https://arxiv.org/abs/2604.16175v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Yi Lin, Yihao Ding, Yonghui Wu et al.
- **标签**: `cs.AI` `cs.CV`
- **AI摘要**: 提出多智能体放射报告生成框架MARCH
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过模拟临床分级协作提升了医疗报告的准确性与可靠性

### 4. **[Mind's Eye: A Benchmark of Visual Abstraction, Transformation and Composition for Multimodal LLMs](https://arxiv.org/abs/2604.16054v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Rohit Sinha, Aditya Kanade, Sai Srinivas Kancheti et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出Mind's Eye基准评估MLLM视觉推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了创新的视觉认知评估框架，实验设计严谨且对比详实。

### 5. **[Beyond a Single Frame: Multi-Frame Spatially Grounded Reasoning Across Volumetric MRI](https://arxiv.org/abs/2604.15808v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Lama Moukheiber, Caleb M. Yeung, Haotian Xue et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出SGMRI-VQA基准以提升MRI空间推理能力
<details>
<summary>原始摘要</summary>
...
### 1. **[TwoHamsters: Benchmarking Multi-Concept Compositional Unsafety in Text-to-Image Models](https://arxiv.org/abs/2604.15967v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-17
- **作者**: Chaoshuo Zhang, Yibo Liang, Mengke Tian et al.
- **标签**: `cs.CR` `cs.CV`
- **AI摘要**: 提出多概念组合不安全性基准TwoHamsters
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对T2I模型组合风险的评估具有重要现实意义，方法严谨。

### 2. **[The Amazing Stability of Flow Matching](https://arxiv.org/abs/2604.16079v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-04-17
- **作者**: Rania Briq, Michael Kamp, Ohad Fried et al.
- **标签**: `cs.CV`
- **AI摘要**: 揭示流匹配模型在数据剪枝下的鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究视角独特，但实验规模与深度有待提升

## Video Generation

### 1. **[Efficient Video Diffusion Models: Advancements and Challenges](https://arxiv.org/abs/2604.15911v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Shitong Shao, Lichen Bai, Pengfei Wan et al.
- **标签**: `cs.CV`
- **AI摘要**: 系统综述高效视频扩散模型的方法、挑战与未来方向。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结构清晰的综述，对视频生成领域的高效优化技术进行了全面梳理。
...
### 1. **[CroSatFL: Energy-Efficient Federated Learning with Cross-Aggregation for Satellite Edge Computing](https://arxiv.org/abs/2604.15779v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Nan Yang, Bahman Javadi, Rodrigo Neves Calheiros et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出卫星边缘计算节能联邦学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对卫星环境的能效优化方案创新且实验扎实

### 2. **[cuNNQS-SCI: A Fully GPU-Accelerated Framework for High-Performance Configuration Interaction Selection withNeural Network QQantum States](https://arxiv.org/abs/2604.15768v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Daran Sun, Bowen Kan, Haoquan Long et al.
- **标签**: `cs.DC` `cs.AI` `cs.CE`
- **AI摘要**: 提出全GPU加速的NNQS-SCI框架以提升量子计算性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过全GPU架构解决通信瓶颈，显著提升了计算效率与扩展性。

### 3. **[PoSME: Proof of Sequential Memory Execution via Latency-Bound Pointer Chasing with Causal Hash Binding](https://arxiv.org/abs/2604.15751v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: David L. Condrey
- **标签**: `cs.CR` `cs.DC`
- **AI摘要**: 提出PoSME算法实现抗ASIC的内存顺序执行证明
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且实验扎实，有效解决了内存延迟绑定问题

### 4. **[Logarithmic-Time Geodesically Convex Decomposition in Programmable Matter](https://arxiv.org/abs/2604.16112v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Henning Hillebrandt, Andreas Padalkin, Christian Scheideler et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出可编程物质的对数时间测地凸分解算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法复杂度优化显著，理论严谨且具有创新性

### 5. **[Compositional Design, Implementation, and Verification of Swarms (Technical Report)](https://arxiv.org/abs/2604.16097v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Florian Furbach, Lucas Clorius, Roland Kuhn et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出组合式蜂群协议设计与验证框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新显著，提升了分布式系统开发的模块化能力。

## Information Retrieval

### 1. **[Skill-RAG: Failure-State-Aware Retrieval Augmentation via Hidden-State Probing and Skill Routing](https://arxiv.org/abs/2604.15771v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Kai Wei, Raymond Li, Xi Zhu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出基于隐状态探测的技能路由RAG框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过诊断检索失败原因并动态路由技能，显著提升了复杂任务的鲁棒性。

### 2. **[On the Equivalence Between Auto-Regressive Next Token Prediction and Full-Item-Vocabulary Maximum Likelihood Estimation in Generative Recommendation--A Short Note](https://arxiv.org/abs/2604.15739v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Yusheng Huang, Shuang Yang, Zhaojie Liu et al.
- **标签**: `cs.IR`
- **AI摘要**: 证明了生成式推荐中AR-NTP与FV-MLE的数学等价性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论贡献扎实，为生成式推荐提供了重要的数学基础。

### 3. **[Beyond One-Size-Fits-All: Adaptive Test-Time Augmentation for Sequential Recommendation](https://arxiv.org/abs/2604.16121v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Xibo Li, Liang Zhang
- **标签**: `cs.IR`
- **AI摘要**: 提出AdaTTA自适应序列推荐增强框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对用户异质性提出RL增强策略，创新性与实验严谨度较好

### 4. **[CHOP: Chunkwise Context-Preserving Framework for RAG on Multi Documents](https://arxiv.org/abs/2604.15802v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Hyunseok Park, Jihyeon Kim, Jongeun Kim et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出CHOP框架以提升RAG检索准确性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过上下文元数据增强检索区分度，方法创新且实验扎实。

### 5. **[UsefulBench: Towards Decision-Useful Information as a Target for Information Retrieval](https://arxiv.org/abs/2604.15827v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-04-17
- **作者**: Tobias Schimanski, Stefanie Lewandowski, Christian Woerle et al.
- **标签**: `cs.IR` `cs.CL`
- **AI摘要**: 提出UsefulBench以评估检索的决策有用性。
<details>
<summary>原始摘要</summary>
...
### 1. **[Geometric regularization of autoencoders via observed stochastic dynamics](https://arxiv.org/abs/2604.16282v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Sean Hill, Felix X. -F. Ye
- **标签**: `cs.LG` `math.DS` `math.PR`
- **AI摘要**: 提出几何正则化自编码器以学习随机动力学
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，通过切丛惩罚显著提升了流形动力学建模精度

### 2. **[Enhancing AI and Dynamical Subseasonal Forecasts with Probabilistic Bias Correction](https://arxiv.org/abs/2604.16238v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Hannah Guan, Soukayna Mouatadid, Paulo Orenstein et al.
- **标签**: `cs.LG` `physics.ao-ph` `stat.ML`
- **AI摘要**: 提出概率偏差校正框架显著提升次季节天气预报精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在国际竞赛中夺冠，方法创新且实用价值极高

### 3. **[Towards Universal Convergence of Backward Error in Linear System Solvers](https://arxiv.org/abs/2604.16075v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Michał Dereziński, Yuji Nakatsukasa, Elizaveta Rebrova
- **标签**: `math.NA` `cs.DS` `cs.LG`
- **AI摘要**: 提出线性系统求解的通用反向误差收敛算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破了条件数限制，理论创新性与实用性极强

### 4. **[Breaking the Training Barrier of Billion-Parameter Universal Machine Learning Interatomic Potentials](https://arxiv.org/abs/2604.15821v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Yuanchang Zhou, Hongyu Wang, Yiming Du et al.
- **标签**: `cs.DC` `cs.LG`
- **AI摘要**: 提出MatRIS-MoE与Janus框架，实现十亿参数势函数高效训练。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破了超大规模势函数训练瓶颈，在Exascale系统上表现卓越。

### 5. **[Closing the Theory-Practice Gap in Spiking Transformers via Effective Dimension](https://arxiv.org/abs/2604.15769v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Dongxin Guo, Jikun Wu, Siu Ming Yiu
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出脉冲Transformer的表达力理论与设计准则
<details>
<summary>原始摘要</summary>
