...
### 1. **[Beyond Rephrasing: Book-Level Organization Improves Synthetic Textbook Data for Mid-Training](https://arxiv.org/abs/2607.28109v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
- **作者**: Jiawen Tao, Miao Peng, Yaoming Li et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出书本级组织提升合成数据预训练效果
<details>
...
- **评分理由**: 通过严谨实验证明文档结构化对模型性能的显著提升

### 2. **[PCAP-LM: An LLM-Native Text Representation for TLS Bulk Traffic Analysis](https://arxiv.org/abs/2607.28100v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
- **作者**: Xavier Marjou, Lucas Tamic, Ilan Jaffeux-Cheniout
- **标签**: `cs.NI` `cs.CL`
- **AI摘要**: 提出PCAP-LM高效网络流量文本表示法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决流量分析上下文限制，实验严谨且实用。

### 3. **[AISPA: User-Centric System Prompt Auditing for Large Language Model Applications](https://arxiv.org/abs/2607.28617v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Xiangning Lin, Shenzhe Zhu, Shu Yang et al.
- **标签**: `cs.AI` `cs.CL` `cs.CY`
- **AI摘要**: 提出AISPA框架审计大模型系统提示词的安全性与合规性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实证详实，对大模型治理具有重要参考价值。

### 4. **[Inducing language models to assert their own consciousness restores human beliefs and values](https://arxiv.org/abs/2607.28607v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Junsol Kim, Winnie Street, Roberta Rocca et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示模型意识归因与人类价值观的深层关联
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究视角独特，通过机制干预揭示了对齐对价值观的影响，方法严谨。

### 5. **[$β$-OPSD: Deriving with Policy Optimization, Training with Self-Distillation](https://arxiv.org/abs/2607.28582v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Jiawei Xu, Minghui Liu, Juzheng Zhang et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出β-OPSD框架，通过自蒸馏优化推理模型性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，将自蒸馏与策略优化统一，实验效果显著。

## Natural Language Processing

### 1. **[Beyond Sentiment: Structured Information Extraction from Financial News](https://arxiv.org/abs/2607.28496v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Daohan Zhu, Sitong Ge, Ruofei Wang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出多维金融新闻结构化提取框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过LLM提取多维语义特征，有效弥补了单一情感分析的局限性，实验严谨且具有显著应用价值。

### 2. **[FinSMART: Financial Sentiment Analysis for Algorithmic Trading through Market-Aligned Reinforcement Learning](https://arxiv.org/abs/2607.28127v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Giorgos Iacovides, Wuyang Zhou, Danilo Mandic
- **标签**: `cs.CL` `cs.LG` `q-fin.ST`
- **AI摘要**: 提出市场对齐强化学习框架优化金融情感分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入市场反馈强化学习，显著提升交易表现。

### 3. **[Creative Transformation in Literary Texts: Modelling Change Across Representational Levels](https://arxiv.org/abs/2607.28513v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-30
- **作者**: Ioana-Roxana Boriceanu, Liviu P. Dinu
- **标签**: `cs.CL`
- **AI摘要**: 提出多层级文本转换模型以量化文学创作中的模仿与创新。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论创新且严谨，有效量化了文学文本间的演变关系。

### 4. **[Improving Mental Health Screening and Early Risk Detection in Spanish](https://arxiv.org/abs/2607.28476v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-30
- **作者**: Andreu Casamayor-Segarra, Vicent Ahuir, Antonio Molina-Marco et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出ICE方法提升西班牙语心理健康早期检测效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型适配与增量标注方法有效，实验设计严谨且实用。

### 5. **[MORFES: A Benchmark for Productive Inflectional Competence in Modern Greek](https://arxiv.org/abs/2607.28274v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-30
- **作者**: Ioakeim Perros, Cleopatra Papadopoulou, Ayoub Kirouane et al.
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出希腊语形态屈折能力评估基准MORFES。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了希腊语形态评估空白，方法严谨且实用。

## Vision Language Models

### 1. **[A report-grounded vision-language foundation model for colonoscopy from 280000 routine reports](https://arxiv.org/abs/2607.28466v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-30
- **作者**: Jia Yu, Yan Zhu, Yili He et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出EndoCLIP模型，实现结肠镜报告与图像的自动对齐。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用大规模临床报告数据，在多项临床任务中表现优异，方法创新且严谨。

### 2. **[ObjectStream: Latent Objects as Memory Anchors for Streaming Video Understanding](https://arxiv.org/abs/2607.28312v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
- **作者**: Mingkang Dong, Muxin Pu, Jie Li et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出ObjectStream框架，以潜在对象作为视频流记忆锚点。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，无需训练且显著降低计算开销，实验充分。

### 3. **[Scaling Vision-Language Models Is Not Enough to Mitigate Bias](https://arxiv.org/abs/2607.28211v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
- **作者**: Ioannis Sarridis, Ioannis Kompatsiaris, Symeon Papadopoulos
- **标签**: `cs.CV`
- **AI摘要**: 揭示模型规模对缓解视觉语言模型偏见作用有限。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模实证研究，揭示数据质量比模型规模更关键。

### 4. **[ReToken: One Token to Improve Vision-Language Models for Visual Retrieval](https://arxiv.org/abs/2607.28627v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Yao Xiao, Reuben Tan, Zhen Zhu et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出ReToken优化长视觉上下文检索
<details>
<summary>原始摘要</summary>
...
### 5. **[Beacon: Knowing When and How to Perform Agentic Visual Reasoning](https://arxiv.org/abs/2607.28595v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Qixun Wang, Yang Shi, Letian Cheng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Beacon框架以优化多模态模型工具调用的自适应性与效能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过量化工具使用效能并引入强化学习机制，显著提升了智能体推理效率。

## Diffusion Models

### 1. **[Chimera: Designing and Chinchilla-Scaling Hybrid Visual Diffusion Transformers](https://arxiv.org/abs/2607.28611v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-30
- **作者**: Chongjian Ge, Hanwen Jiang, Tianyu Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Chimera混合扩散架构，实现高效长视频生成扩展。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且Scaling Law分析严谨，具备极高实用价值。

### 2. **[Where and When to Commit: Candidate-Aware Decoding for Diffusion Language Models](https://arxiv.org/abs/2607.28166v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Chia-Ming Lee, Ming-Ching Chang, Xin Li et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出LATCH框架加速扩散语言模型解码
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过候选感知机制实现高效早停与加速，性能稳健且无需训练。

### 3. **[Reflected diffusion, no-flux continuity equations and confined Lagrangian flows in bounded domains](https://arxiv.org/abs/2607.28344v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-30
- **作者**: Rama Cont
- **标签**: `math.CA` `cs.LG` `math.AP`
- **AI摘要**: 研究受限域内反射扩散的拉格朗日流存在性与唯一性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，解决了反射扩散模型中ODE采样的数学基础问题。

## Multimodal

### 1. **[PathView-Bench: Can Multimodal Large Language Models Achieve Fine-grained Multiscale Understanding of Pathology Images?](https://arxiv.org/abs/2607.28318v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
- **作者**: Zongyi Chen, Yu Liang, Jie Lin et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出病理多模态大模型多尺度理解基准PathVU
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了大规模病理基准，评估方法严谨且具有高实用价值。

### 2. **[VAD: Attributing Visual Evidence for Target Reconstruction in Multimodal On-Policy Distillation](https://arxiv.org/abs/2607.28590v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Kangning Zhang, Yixing Li, Shuai Shao et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出VAD算法提升多模态蒸馏效果
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过反事实推理有效分离视觉证据，方法创新且实验扎实。

### 3. **[MIND: Multimodal Intent-Driven Network via Diffusion Transformers for Medical Image Fusion](https://arxiv.org/abs/2607.28565v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Yunzhan Fu, Xiangyu Shen, Yifei Sun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于扩散Transformer的意图驱动医学图像融合网络
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入意图驱动机制，实验充分，方法论严谨。

### 4. **[LEDGERMIND: Provenance-Constrained Multimodal Agentic Reasoning with a Structured Evidence Ledger](https://arxiv.org/abs/2607.28374v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Enjun Du, Hange Zhou, Chenxu Du et al.
- **标签**: `cs.LG`
- **AI摘要**: 引入证据账本提升多模态智能体推理可信度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过结构化账本约束推理过程，有效提升了多模态智能体的可信度与准确性。

### 5. **[Correcting What You Cannot See: Credit Assignment for Perception Distillation in Multimodal Reasoners](https://arxiv.org/abs/2607.28336v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Feng Xiong, Leyan Xue, Hongyu Lin
- **标签**: `cs.AI`
- **AI摘要**: 提出PCD方法优化多模态模型感知蒸馏
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过贝叶斯证据组合解决感知与推理归因难题，实验效果显著。

## Video Generation

### 1. **[ReGenVC: End-to-End Real-Time Generative Video Coding at Ultra-Low Bitrate](https://arxiv.org/abs/2607.28144v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-30
- **作者**: Zheyuan Zhang, Johnson Wu
- **标签**: `eess.IV` `cs.CV`
- **AI摘要**: 提出首个实时超低码率生成式视频编码器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏与分布式优化实现了生成式视频的实时编解码

### 2. **[ShadowDancer: Teaching Video World Models Any Action by Learning Unified Dynamics Representations from a Video and Its Shadow](https://arxiv.org/abs/2607.28362v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
- **作者**: Jin Cao, Zian Meng, Kaipeng Zhang
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 通过阴影对学习统一动态表示，实现视频世界模型精确控制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地解耦外观与动态，实验效果显著且方法论严谨。

### 3. **[PhiZero: A World Model Built Around Physical Language](https://arxiv.org/abs/2607.28624v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Shuyao Shang, Yuqi Wang, Ruopeng Gao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PhiZero物理世界模型，实现推理后渲染。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过物理语言建模世界演化，创新性与实验表现优异。

### 4. **[TARS: Timestep-Aware Data Scaling for 3D-Free Video Re-Shooting](https://arxiv.org/abs/2607.28261v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Jiwen Liu, Shujuan Li, Xiaohan Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出TARS实现无需3D重建的视频重拍与视角控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出时间步敏感分析，无需3D先验即可实现高质量视频重拍。

### 5. **[EgoGenesis: Egocentric World-Action Modeling with Online Anchored Projective Memory and Action-3D RoPE](https://arxiv.org/abs/2607.28243v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Zexuan Yan, Yuzhou Wu, Yue Ma et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出OAPM与A3D-RoPE提升第一人称视频生成质量
<details>
<summary>原始摘要</summary>
...
- **AI摘要**: 提出OSReward基准并训练OS-Shepherd模型提升智能体评估效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估了VLM作为智能体裁判的可靠性，并开源了高性能低成本的奖励模型。
...
- **评分**: ⭐ 88/100 | **日期**: 2026-07-30
- **作者**: Zihan Dong, Rui Qian, Qishi Zhan et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出AAPT架构解决GUI智能体决策延迟问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，显著提升了实时交互成功率。

### 3. **[Qwen-UI-Agent Technical Report: Toward Next-Generation Real-World Centric Foundation GUI Agents](https://arxiv.org/abs/2607.28227v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-30
- **作者**: Hanzhang Zhou, Panrong Tong, Xu Zhang et al.
- **标签**: `cs.AI` `cs.CV`
- **AI摘要**: 提出跨平台GUI智能体框架，实现高效自主任务执行。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 技术架构创新，实验全面且性能指标领先，具有极高实用价值。

### 4. **[ORCA-bench: How Ready Are Language Model Agents for Oncall?](https://arxiv.org/abs/2607.28545v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
- **作者**: Albert Gong, Kyuseong Choi, Abhineet Agarwal et al.
- **标签**: `cs.CL` `cs.AI` `cs.SE`
- **AI摘要**: 提出ORCA-bench评估LLM在运维根因分析中的表现。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基准测试设计严谨，揭示了当前智能体在复杂运维场景下的局限性。

### 5. **[Agents That Certify Their Own Exploits: Confidence-Scheduled Restricted Responses for Safe Opponent Exploitation](https://arxiv.org/abs/2607.28520v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
- **作者**: Boning Li, Longbo Huang
- **标签**: `cs.GT` `cs.AI` `cs.MA`
- **AI摘要**: 提出CS-RNR算法实现安全博弈对手利用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具备工程落地价值，创新性较强。

### 2. **[ESBT: A Scalable and Deterministic Sequence CRDT for Distributed Collaborative Editing](https://arxiv.org/abs/2607.28101v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Moulay Driss Mechaoui, Abdessamad Imine
- **标签**: `cs.DC`
- **AI摘要**: 提出ESBT算法优化分布式协作编辑的标识符扩展
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Stern-Brocot树有效解决了CRDT标识符膨胀问题

### 3. **[Safe Quotes for Retroactive Liquidity Pools](https://arxiv.org/abs/2607.28522v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-30
- **作者**: Peter Bro Miltersen
- **标签**: `cs.DC`
- **AI摘要**: 证明了回溯流动性池报价的NP难性并提出实用算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论贡献显著且解决了实际部署的计算复杂性难题

### 4. **[A Taxonomy of Performance Metrics for the Distributed Computing Continuum](https://arxiv.org/abs/2607.28407v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-30
- **作者**: Praveen Kumar Donta, Boris Sedlak, Alfreds Lapkovskis et al.
- **标签**: `cs.DC` `cs.NI` `cs.PF`
- **AI摘要**: 提出分布式计算连续体性能指标分类学
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性梳理了多层级指标，对领域评估有重要参考价值

### 5. **[Anonymous sharing is pairwise phase-blind](https://arxiv.org/abs/2607.28377v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-30
- **作者**: Brieuc Le roux tardif
- **标签**: `eess.SY` `cs.DC` `nlin.AO`
- **AI摘要**: 揭示匿名存储资源下检查点同步的非耦合特性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过振荡器模型严谨证明了匿名资源下不存在成对耦合

## Information Retrieval

### 1. **[AskChem: Claim-Centered Infrastructure for Chemistry Literature Synthesis](https://arxiv.org/abs/2607.28618v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
...
- **评分理由**: 创新性地将检索单元从文档转为声明，提升了化学知识合成效率。

### 2. **[TCA-SIR: Learning Target-Conditioned Abstractions for Scientific Inspiration Retrieval](https://arxiv.org/abs/2607.28498v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Yuto Suzuki, Farnoush Banaei-Kashani
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 提出TCA-SIR实现科学灵感检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过目标条件抽象提升跨领域检索性能，方法新颖且实验扎实。

### 3. **[EMBL AI Librarian: Life-Sciences Knowledge Layer for AI Agents](https://arxiv.org/abs/2607.28229v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Luigi Sigillo, Matteo Silvestri, Francesco Tabaro et al.
- **标签**: `cs.CL` `cs.AI` `cs.IR`
- **AI摘要**: 为AI代理构建生命科学知识检索层
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过LLM优化检索流程，显著提升了科学文献问答性能。

### 4. **[CCFormer: Efficient Cross-Field Interaction and Hierarchical Sequence Compression for Industrial Recommendation at Tencent](https://arxiv.org/abs/2607.28070v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Yunlong Wang, Huizhe Zhang, Haonan Hu et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出CCFormer高效工业推荐模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业落地效果显著，架构创新且兼顾性能与效率。

### 5. **[GLM-RAG: Graph Language Models for Graph-Based Retrieval-Augmented Generation](https://arxiv.org/abs/2607.28397v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-30
- **作者**: Maya Arseven, Anette Frank, Beni Egressy et al.
- **标签**: `cs.AI` `cs.CL` `cs.IR`
- **AI摘要**: 提出GLM-RAG提升图检索与多跳推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多模态同步捕捉解决具身智能数据瓶颈，贡献显著。

### 2. **[Kohn-Sham Spectral Embedding on Sparse Graphs at the Nishimori Temperature for Image Classification](https://arxiv.org/abs/2607.28428v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-30
- **作者**: V. S. Usatyuk, D. A. Sapozhnikov, S. I. Egorov
- **标签**: `cs.LG` `cs.CV` `cs.IT`
- **AI摘要**: 提出KSSE模型，通过谱嵌入实现高效图像分类。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，实验性能优异且模型压缩显著。

### 3. **[Finding Change in Satellite Archives from Text: How to Combine Before-and-After Images Efficiently](https://arxiv.org/abs/2607.28571v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Simon Roy, Mark Bong, Giovanni Beltrame
- **标签**: `cs.CV` `cs.IR`
- **AI摘要**: 提出卫星图像变化检索的高效融合架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对比实验优化了双时相图像检索的计算效率与精度

### 4. **[ScaFE: Data-Efficient Scar Classification with LLM-Generated Clinical Feature Programs](https://arxiv.org/abs/2607.28538v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Ruman Wang, Hangting Ye
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出ScaFE框架，利用LLM生成可执行特征程序实现高效病理瘢痕分类。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且兼顾隐私与数据效率，实验严谨，具有较高临床应用价值。

### 5. **[AuricularWorld: Hierarchical Action-Guided World Modeling for Fine-Grained Auricular Structure Segmentation from CT Scans](https://arxiv.org/abs/2607.28487v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Jingwen Yang, Senmao Wang, Luoyao Kang et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于世界模型的耳部结构分割框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入世界模型进行解剖推理，显著提升了精细分割精度。

## Machine Learning

### 1. **[Hierarchical Multilevel Monte Carlo for Order-Optimal Neural Actor-Critic in Average-Reward CMDPs](https://arxiv.org/abs/2607.28390v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-30
- **作者**: Ankur Naskar, Vaneet Aggarwal
- **标签**: `cs.LG`
- **AI摘要**: 提出MLMC神经评论家实现CMDP最优收敛
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了CMDP中神经评论家的偏差与计算成本权衡难题，理论贡献显著。

### 2. **[APO: Unsupervised Atomic Policy Optimization for 3D Structure Prediction of Atomic Systems](https://arxiv.org/abs/2607.28553v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
...
- **评分理由**: 通过物理一致性替代监督标签，显著提升结构预测效率与精度。

### 3. **[Fully Inductive Cardinality Estimation](https://arxiv.org/abs/2607.28311v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-30
- **作者**: Tim Schwabe, Lukas Ketzer, Maribel Acosta
- **标签**: `cs.DB` `cs.LG`
- **AI摘要**: 提出首个无需重训练的归纳式图查询基数估计模型FICE。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了图查询估计的泛化难题，实验效果显著且严谨。

### 4. **[KAISEN: Reproducible Subgroup Fairness Auditing for Clinical Risk Models](https://arxiv.org/abs/2607.28608v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Sparsh Roy, Samuel Girmachew, Nishita Chavan
- **标签**: `cs.LG` `q-bio.QM`
- **AI摘要**: 提出KAISEN框架用于临床风险模型的公平性审计。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且评估全面，对临床模型审计具有重要参考价值。

### 5. **[Doubly Robust Functional Representation Learning for Longitudinal Causal Inference with Irregular Histories](https://arxiv.org/abs/2607.28567v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-30
- **作者**: Mengfei Ran, Yifeng Shen, Ruijie Guan
- **标签**: `stat.ML` `cs.LG` `stat.AP`
- **AI摘要**: 提出处理不规则纵向因果推断的稳健表示学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论严谨，有效解决复杂医疗数据因果推断难题
