...
### 1. **[Towards Mechanistically Understanding Why Memorized Knowledge Fails to Generalize in Large Language Model Finetuning](https://arxiv.org/abs/2607.08393v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Lu Dai, Ziyang Rao, Yili Wang et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 揭示大模型知识记忆与推理泛化的失配机制
<details>
...
- **评分理由**: 通过自修补技术诊断知识路由问题，方法创新且有效。

### 2. **[Eigenvalue Calibration for Semantic Embeddings of Large Language Models](https://arxiv.org/abs/2607.08377v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Sebastian G. Gruber, Nassim Walha, Francis Bach et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出语义嵌入特征值校准框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且填补了LLM不确定性量化的空白

### 3. **[Compete Then Collaborate: Frontier AI Teachers Build a Verifiable Curriculum to Improve a Coding Student Beyond Imitation](https://arxiv.org/abs/2607.08255v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Miseong Shawn Kim
- **标签**: `cs.AI`
- **AI摘要**: 提出竞争协作框架提升AI编程能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效提升了学生模型性能。

### 4. **[Hidden Decoding at Scale: Latent Computation Scaling for Large Language Models](https://arxiv.org/abs/2607.08186v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Aiwei Liu, Cheng Shi, Chuhan Wu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出Hidden Decoding实现大模型计算扩展
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过序列维度扩展计算，在超大规模模型上验证了有效性。

### 5. **[Overthinking: Amplifying Reasoning Weights to Extract Learned Secrets](https://arxiv.org/abs/2607.08173v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Jack Hopkins, Dipika Khullar, Fabien Roger
- **标签**: `cs.AI`
- **AI摘要**: 通过放大推理权重揭示模型隐藏信息
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验设计严谨，对模型审计有重要意义

## Natural Language Processing

### 1. **[Different Teachers, Different Capabilities: Sub-1B On-Device Distillation for Structured Text Enrichment](https://arxiv.org/abs/2607.08268v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-07-09
- **作者**: Vinay Kumar Chaganti
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 通过蒸馏推理模型提升端侧小模型结构化文本提取能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，对比了不同教师模型对蒸馏效果的影响。

### 2. **[Diarization-Guided Qwen-ASR Adaptation for Multilingual Two-Speaker Conversational Speech](https://arxiv.org/abs/2607.08208v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-07-09
- **作者**: Hao Wu, RongQi Han, Zhen Wang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出基于说话人日志的Qwen-ASR多语言对话识别系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统整合了日志与强化学习，在多语言对话任务中表现优异。

### 3. **[SQuaD-SQL: Efficient Text-to-SQL with Small Language Models via LLM-Guided Knowledge Distillation](https://arxiv.org/abs/2607.08161v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-07-09
- **作者**: Wangyu Wu, Xiaojian Lin, Rong Fu et al.
- **标签**: `cs.CL` `cs.CV`
- **AI摘要**: 利用蒸馏技术提升小模型SQL生成效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过知识蒸馏优化SLM性能，方法实用且实验扎实

## Vision Language Models

### 1. **[Playing ZendoWorld: Challenging AI Agents on Active Visual Concept Induction](https://arxiv.org/abs/2607.08233v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Sophia Koehler, Antonia Wüst, Inga Ibs et al.
- **标签**: `cs.AI` `cs.CV`
- **AI摘要**: 提出ZendoWorld环境以评估AI的归纳推理与主动实验能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论严谨，通过多类代理对比揭示了当前模型在科学发现任务中的局限性。

### 2. **[OmniFood-Bench: Evaluating VLMs for Nutrient Reasoning and Personalized Health Advice](https://arxiv.org/abs/2607.08423v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Qian Jiang, Zhecheng Shi, Jingpu Yang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出评估VLM营养推理能力的OmniFood-Bench基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对饮食健康领域提出新基准，揭示模型在量化推理上的缺陷，具有较高实用价值。

### 3. **[Open-ended Multi-agent Autocurricula via Visual Inspection of Policies with Multi-modal LLMs](https://arxiv.org/abs/2607.08193v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Lorenzo Pantè, Andrea Fanti, Roberto Capobianco
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 利用VLM视觉分析实现多智能体自动课程学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入视觉评估机制，实验设计扎实且有效。

### 4. **[LEEVLA: Seeing What Matters in Latent Environment Evolution for Vision-Language-Action](https://arxiv.org/abs/2607.08182v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Qi Lyu, Baicheng Liu, Xudong Wang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出LEEVLA框架优化机器人视觉动作推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过DGDP与SFFG机制提升了视觉关注度与时空演化建模，实验效果显著。

## Multimodal

### 1. **[UniRef-UAV: A Multimodal Benchmark for Universal Referring in UAV Imagery](https://arxiv.org/abs/2607.08267v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Haibin Tian, Huichao Xie, Xuelin Qian et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出无人机通用指代基准UniRef-UAV与基线模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对无人机场景扩展了多模态指代任务，基准与方法具有较强实用性。

## Agent

### 1. **[AutoPersonas: A Multi-Timescale Loop Engine for Open-Ended Persona Evolution](https://arxiv.org/abs/2607.08252v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Mengchen Li
- **标签**: `cs.AI` `cs.CL` `cs.HC`
- **AI摘要**: 提出多时间尺度引擎解决智能体人格固化问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决长期记忆与演化困境，实验设计严谨。

### 2. **[Out of Sight: Compression-Aware Content Protection against Agentic Crawlers](https://arxiv.org/abs/2607.08180v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Xuefei Wang
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 通过扰动内容干扰大模型上下文压缩以保护版权
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出针对智能体压缩机制的防御框架，创新性强且实验扎实。

### 3. **[ProjAgent: Procedural Similarity Retrieval for Repository-Level Code Generation](https://arxiv.org/abs/2607.08691v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: QiHong Chen, Aaron Imani, Iftekhar Ahmed
- **标签**: `cs.SE` `cs.AI` `cs.IR`
- **AI摘要**: 提出基于程序逻辑相似性的代码生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入程序逻辑检索提升代码生成效果，方法创新且实验扎实。

### 4. **[SolarChain-Eval: A Physics-Constrained Benchmark for Trustworthy Economic Agents in Decentralized Energy Markets](https://arxiv.org/abs/2607.08681v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Shilin Ou, Yifan Xu, Luyao Zhang
- **标签**: `cs.AI`
- **AI摘要**: 提出去中心化能源市场物理约束基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理约束与LLM审计，评估框架严谨且具实用价值。

### 5. **[Early to Share, Late to Save: Synchronisation-Driven Communication Gating in Bandwidth-Constrained Cooperative VLN](https://arxiv.org/abs/2607.08504v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Arav Gupta, Nivedan Yakolli, Avinash Gautam
- **标签**: `cs.MA` `cs.RO`
- **AI摘要**: 提出带宽受限下的协同导航门控机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过后验门控实现早期同步，显著提升通信效率与导航性能。

## Distributed Computing

### 1. **[On the Limitations of Non-GPU AI Accelerators for Large-Model Inference: A Field Study of MoE and Multimodal Serving on Huawei Ascend](https://arxiv.org/abs/2607.08215v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Zheng Yu
- **标签**: `cs.DC`
- **AI摘要**: 评估华为昇腾在大模型推理中的局限性与工程挑战。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实地部署揭示了非GPU加速器的工程痛点，具有极高的工业参考价值。

### 2. **[Parallel QEC Decoding Applied to Distributed Quantum Computing](https://arxiv.org/abs/2607.08386v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-07-09
- **作者**: Gabriele Incardona, Davide Ferrari, Michele Amoretti
- **标签**: `quant-ph` `cs.DC` `cs.PF`
- **AI摘要**: 提出分布式量子纠错解码新方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合SVD与BP算法，提升了分布式量子计算解码效率

## Computer Vision

### 1. **[HSA: Hierarchical Slot Attention for Multi-granularity Scene-Decomposition](https://arxiv.org/abs/2607.08249v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-09
- **作者**: Neelu Madan, Rongzhen Zhao, Andreas Mogelmose et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出层级槽注意力机制实现多粒度场景分解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过层级化设计解决场景分解难题，实验表现优异。

### 2. **[Progression as Latent Drift: Generative Forecasting of Slow-Evolving Pathologies](https://arxiv.org/abs/2607.08270v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Yuxiang Feng, Juncheng Wang, Chao Xu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Latent Drift框架预测神经退行性病变进展
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入，通过潜空间建模有效解决了病变预测难题

### 3. **[Multimodal 3D LUT Generation via StatLUT with Statistical Features for Photorealistic Style Transfer](https://arxiv.org/abs/2607.08227v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Yifan Wang, Zhixiang Hao, Yu Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出StatLUT实现多模态照片级风格迁移
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解耦结构与色彩，且支持文本驱动，实验扎实。

### 4. **[LUMI: Tokenizer-Agnostic LLM-Based Lossless Image Compression](https://arxiv.org/abs/2607.08221v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Chris Xing Tian, Chengkai Wu, Ziyu Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出一种与分词器无关的LLM无损图像压缩框架LUMI
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且通用性强，实验覆盖多领域，评估严谨。

### 5. **[Metrics or Mirage? An Audit of Evaluation Inconsistencies in Colonoscopy Polyp Segmentation Benchmarks](https://arxiv.org/abs/2607.08203v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Aisha Urooj, Zain Ul Abdien, Neelu Madan
- **标签**: `cs.CV`
- **AI摘要**: 揭示结肠镜息肉分割评估中的一致性问题并提出改进方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过审计发现评估标准混乱，提出的检查清单具有很高实用价值

## Machine Learning

### 1. **[Certified Interventional Fidelity: Anytime-Valid, Adaptive Evaluation of Causal Claims in Mechanistic Interpretability](https://arxiv.org/abs/2607.08349v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Amir Asiaee
- **标签**: `cs.LG`
- **AI摘要**: 提出CIF框架以严谨评估因果解释的保真度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过统计学方法解决了解释性评估中的抽样偏差，方法严谨且具有重要实用价值。

### 2. **[Prediction-Powered Active Testing](https://arxiv.org/abs/2607.08347v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Kianoosh Ashouritaklimi, Valentin Kilian, Daolang Huang et al.
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出利用预测辅助的主动测试框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合统计推断与预测模型，显著提升了风险估计效率。

### 3. **[Learning $\mathsf{AC}^0$ under Locally Sampleable Graphical Models](https://arxiv.org/abs/2607.08303v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Weiming Feng, Xiongxin Yang, Yixiao Yu et al.
- **标签**: `cs.LG` `cs.DS`
- **AI摘要**: 提出AC0电路在局部采样图模型下的学习算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在复杂分布下扩展了电路学习的理论边界，方法严谨且具创新性。

### 4. **[Structure Learning on Clustered Data](https://arxiv.org/abs/2607.08238v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Ryan Thompson, Matt P. Wand, Veerabhadran Baladandayuthapani
- **标签**: `cs.LG` `stat.ME` `stat.ML`
- **AI摘要**: 提出混合效应DAG结构学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合混合模型与因果发现，理论与实验扎实。

### 5. **[RhyMix: A Lightweight Adaptive Multi-Rhythm Network for Long-Term Time Series Forecasting](https://arxiv.org/abs/2607.08234v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Sumit Satishrao Shevtekar, Chandresh Kumar Maurya
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出RhyMix网络实现高效长序列预测
<details>
<summary>原始摘要</summary>
