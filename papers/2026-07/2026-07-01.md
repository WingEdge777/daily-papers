...
### 1. **[Signed-Permutation Coordinate Transport for RMSNorm Transformers](https://arxiv.org/abs/2606.31963v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-30
- **作者**: John Sweeney
- **标签**: `cs.LG` `cs.CL` `stat.ML`
- **AI摘要**: 提出RMSNorm符号置换坐标传输方法
<details>
...
- **评分理由**: 解决了模型对齐中的规范对称性问题，理论与实验均极具深度。

### 2. **[A Lifecycle and Application-Stack Survey of Large Language Model Vulnerabilities: Attacks, Risks, Defenses, and Open Problems](https://arxiv.org/abs/2606.31639v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-30
- **作者**: Seyed Bagher Hashemi Natanzi, Bo Tang
- **标签**: `cs.CR` `cs.AI` `cs.GT`
- **AI摘要**: 系统化梳理LLM全生命周期安全漏洞与防御框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 全面且深刻的系统性综述，对LLM安全研究具有极高参考价值。

### 3. **[Moral Safety in LLMs: Exposing Performative Compliance with Puzzled Cues](https://arxiv.org/abs/2606.31644v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-30
- **作者**: Mohammadamin Shafiei, Shuyue Stella Li, Yulia Tsvetkov
- **标签**: `cs.CL` `cs.CY`
- **AI摘要**: 揭示大模型道德合规的表演性偏差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究视角新颖，方法严谨，对AI安全性评估有重要意义。

### 4. **[Introspective Coupling: Self-Explanation Training Tracks Behavioral Change Despite Fixed Supervision](https://arxiv.org/abs/2606.32038v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Zifan Carl Guo, Laura Ruis, Jacob Andreas et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出固定监督下实现模型忠实内省的训练方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了固定解释数据对模型行为追踪的有效性，方法创新且实验严谨。

### 5. **[Reinforcement Learning with Metacognitive Feedback Elicits Faithful Uncertainty Expression in LLMs](https://arxiv.org/abs/2606.32032v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Gabrielle Kaili-May Liu, Avi Caciularu, Gal Yona et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出RLMF框架提升大模型元认知与不确定性校准能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入元认知反馈优化，实验严谨且实用性强。

## Natural Language Processing

### 1. **[Explicit Fuzzy Logic in the Feed-Forward Layer: Self-Forgetting Quantifiers Discover Legible Grammatical-Licensing Detectors](https://arxiv.org/abs/2606.31845v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Mark Oskin
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出NC-FFN实现可解释的语法许可检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入模糊逻辑，提升了Transformer的可解释性与性能。

### 2. **[LuxEmo: Expressive Text-to-Speech Corpus for Luxembourgish](https://arxiv.org/abs/2606.31947v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-30
- **作者**: Nina Hosseini-Kivanani, Sandipana Dowerah
- **标签**: `cs.CL`
- **AI摘要**: 发布卢森堡语情感语音数据集LuxEmo
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对低资源语言构建高质量数据集，方法严谨且实用。

### 3. **[STEB: Style Text Embedding Benchmark](https://arxiv.org/abs/2606.31741v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-30
- **作者**: Rafael Rivera Soto, Anna Wegmann, Cristina Aggazzotti
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出首个风格文本嵌入基准测试STEB
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了风格嵌入评估的空白，实验规模大且严谨。

### 4. **[Is Natural Always Appropriate? Investigating Naturalness and Appropriateness Across Different Domains for TTS Evaluation](https://arxiv.org/abs/2606.31729v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-30
- **作者**: Dominika Woszczyk, Andreas Triantafyllopoulos, Jura Miniota et al.
- **标签**: `eess.AS` `cs.LG`
- **AI摘要**: 揭示TTS评估中自然度与适用性的差异及领域依赖性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入探讨了TTS评估的局限性，实验设计严谨且结论具有指导意义。

### 5. **[Cross-lingual Relation Extraction with Large Language Models: Zero-Shot, Few-Shot, and Fine-Tuned Evaluation on Romanian](https://arxiv.org/abs/2606.31718v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-30
- **作者**: Dragos-Mitrut Vasile, Elena-Simona Apostol, Stefan-Adrian Toma et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 评估LLM在罗马尼亚语关系抽取中的跨语言表现。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，对比了多种模型，对低资源语言应用有参考价值。

## Vision Language Models

### 1. **[CoLT: Teaching Multi-Modal Models to Think with Chain of Latent Thoughts](https://arxiv.org/abs/2606.31986v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Lianyu Hu, Shengqian Qin, Zeqin Liao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CoLT框架，通过潜在思维链提升多模态推理效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，显著提升推理速度，实验设计严谨且全面。

### 2. **[No Place to Hide: Benchmarking Video Hallucination with Background-Controlled Pairs](https://arxiv.org/abs/2606.31933v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Haojian Huang, Harold Haodong Chen, Meng Luo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出VidPair-Halluc基准以评估视频模型幻觉
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过背景控制的配对视频有效提升了幻觉评估的严谨性。

### 3. **[Breaking Failure Cascades: Step-Aware Reinforcement Learning for Medical Multimodal Reasoning](https://arxiv.org/abs/2606.31825v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Junha Jung, Minbyul Jeong, Suhyeon Lim et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出MRPO算法通过步骤奖励优化医疗多模态推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对医疗推理级联错误提出分步奖励，方法创新且实验扎实。

### 4. **[UniCoder: Unified Visual-to-Code Generation via Symbolic Rewards and Reference-Guided Code Optimization](https://arxiv.org/abs/2606.31732v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Yaozhi Zheng, Yilei Jiang, Manyuan Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出UniCoder通过符号奖励与引导优化提升视觉代码生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入符号属性对齐与引导优化，实验表现优异

### 5. **[Think While You Map: Asynchronous Vision-Language Agents for Incremental 3D Scene Graphs](https://arxiv.org/abs/2606.31471v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Deniz Bickici, Michael Pabst, Shohei Mori et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出异步视觉语言代理实现增量式3D场景图构建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了异构空间蒸馏难题，提升了轻量模型性能

### 2. **[Mesh BDF: Barycentric Dominance Field for 3D Native Mesh Generation](https://arxiv.org/abs/2606.31777v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Gaochao Song, Haohan Weng, Luo Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出BDF将网格拓扑转化为连续场，提升3D生成质量。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将网格连接性转化为连续信号，实验表现优异。

### 3. **[Look But Don't Touch with Sparse Autoencoders for Unlearning in Diffusion Models](https://arxiv.org/abs/2606.31699v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Enrico Cassano, Riccardo Renzulli, Rayyan Ahmed et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 揭示SAE在扩散模型干预中的局限并提出检测替换法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入剖析了SAE在概念干预中的失效机理，方法论严谨且具有启发性。

### 4. **[Introduction to Stochastic Differential Equations for Generative Machine Learning: A Variational Perspective](https://arxiv.org/abs/2606.31576v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-30
- **作者**: Ole Winther, Paul Jeha, Sander Dieleman et al.
- **标签**: `cs.LG`
- **AI摘要**: 综述随机微分方程在生成模型中的变分框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 内容详实且逻辑清晰，为扩散模型提供了统一的变分视角。

## Multimodal

### 1. **[Modality-Driven Search with Holistic Trace Judging for ARC-AGI-2](https://arxiv.org/abs/2606.31543v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-30
- **作者**: Johan Land
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 多模态搜索与整体判断提升ARC推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多模态生成与整体判断显著提升ARC基准性能

### 2. **[FedLAB: Traceable Semantic Codebooks for Federated Multimodal Graph Foundation Learning](https://arxiv.org/abs/2606.32016v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Zekai Chen, Kairui Yang, Xuaner Chen et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出联邦多模态图可追溯语义码本框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，有效解决联邦学习可解释性问题

### 3. **[DigitalCoach: Communication and Grounding Gaps in Human and Agentic Computer Use Coaching](https://arxiv.org/abs/2606.31980v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Meng Chen, Anya Ji, Tsung-Han Wu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出DigitalCoach数据集以评估AI辅助软件教学能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建扎实，深入分析了AI教学中的视觉与交互缺陷

### 4. **[Harnessing Textual Refusal Directions for Multimodal Safety](https://arxiv.org/abs/2606.31876v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Moreno D'Incà, Massimiliano Mancini, Nicu Sebe
- **标签**: `cs.AI` `cs.CV` `cs.LG`
- **AI摘要**: 提出MARS方法实现多模态安全对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用文本拒绝方向实现多模态安全，方法创新且实验扎实。

### 5. **[Evo-PI: Aligning Medical Reasoning via Evolving Principle-Guided Supervision](https://arxiv.org/abs/2606.31800v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Xianda Zheng, Huan Gao, Meng-Fen Chiang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出演化原则引导的医疗多模态推理框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态原则演化提升推理能力，方法创新且实验扎实。

## Image Generation

### 1. **[GEAR: Guided End-to-End AutoRegression for Image Synthesis](https://arxiv.org/abs/2606.32039v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Bin Lin, Zheyuan Liu, Chenguo Lin et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GEAR实现端到端自回归图像生成训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需微调，在全景生成领域具有显著实用价值。

### 3. **[Arena-T2I Hard: Benchmarking and Improving Faithfulness with Dependency-Aware Checklist](https://arxiv.org/abs/2606.31711v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Yuanhao Ban, Tong Xie, Sohyun An et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出依赖感知核对表以提升文生图模型忠实度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 基准测试具有挑战性，提出的训练方法有效平衡了美感与忠实度。

### 4. **[InstanceControl: Controllable Complex Image Generation without Instance Labeling](https://arxiv.org/abs/2606.31924v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-30
- **作者**: Xiaoyu Liu, Huan Wang, Fan Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出无需实例标注的多实例可控图像生成方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用VLM自动解析实例并优化掩码，有效解决属性混淆问题。

### 5. **[Histogram-constrained Image Generation](https://arxiv.org/abs/2606.31683v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-30
- **作者**: Haoming Liu, Yuanhe Guo, Yijia Cao et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出基于直方图约束的扩散模型图像生成方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过最优传输实现分布级控制，方法新颖且实用性强。

## Video Generation

### 1. **[World Narrative Model for Highly Controllable Video Generation: A Paradigm Shift from Pixel Sampling to Physical World Orchestration](https://arxiv.org/abs/2606.31946v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Ye Chen, Xuanhong Chen, Yupeng Zhu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出WNM框架实现可控视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦物理叙事与渲染过程，显著提升了视频生成的可控性。

### 2. **[MemLearner: Learning to Query Context memory for Video World Models](https://arxiv.org/abs/2606.31734v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-30
- **作者**: Jiwen Yu, Jianxiong Gao, Jianhong Bai et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MemLearner通过自适应查询提升视频世界模型长期一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效解决了视频生成中的记忆缺失问题

## Agent

### 1. **[A Self-Evolving Agentic System for Automated Generation and Execution of Biological Protocols](https://arxiv.org/abs/2606.31763v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-30
- **作者**: Yankai Jiang, Weiting Tang, Haoran Sun et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ProtoPilot实现生物实验自动化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了机器人奖励设计难题。

### 3. **[QVal: Cheaply Evaluating Dense Supervision Signals for Long-Horizon LLM Agents](https://arxiv.org/abs/2606.32034v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Sergio Hernández-Gutiérrez, Matteo Merler, Ilze Amanda Auzina et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出QVal评估框架，高效衡量LLM智能体稠密监督信号质量。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，有效解决了智能体训练评估成本高的问题。

### 4. **[Generative Skill Composition for LLM Agents](https://arxiv.org/abs/2606.32025v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Xinyu Zhao, Zhen Tan, Vaishnav Tadiparthi et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出SkillComposer实现技能组合优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升了智能体任务成功率。

### 5. **[TRIAGE: Role-Typed Credit Assignment for Agentic Reinforcement Learning](https://arxiv.org/abs/2606.32017v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Yuanda Xu, Zhengze Zhou, Hejian Sang et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出TRIAGE框架优化智能体信用分配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过语义角色分类改进强化学习信用分配，实验效果显著。

## Distributed Computing

### 1. **[PEERS: A Parallel and Exact Effective Resistance Solver via Implicit Inversion and Augmented Symbolic Analysis](https://arxiv.org/abs/2606.31535v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-30
- **作者**: Baiyu Chen, Lin Gan, Guangwen Yang et al.
- **标签**: `cs.AR` `cs.DC` `math.NA`
- **AI摘要**: 提出PEERS高效精确电阻求解器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了EDA领域电阻计算的精度与内存瓶颈，理论与实验表现卓越。

### 2. **[Interface-Variant Dynamics in Software Ecosystems: Resolver-Induced Selection and Adoption in Package Graphs](https://arxiv.org/abs/2606.31817v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Faruk Alpay, Baris Basaran
- **标签**: `cs.SE` `cs.DC`
- **AI摘要**: 量化分析包管理器对接口演化的选择效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过演化生物学视角量化软件生态演化，方法严谨且创新。

### 3. **[FedXDS: Leveraging Model Attribution Methods to counteract Data Heterogeneity in Federated Learning](https://arxiv.org/abs/2606.31742v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Maximilian Andreas Hoefler, Karsten Mueller, Wojciech Samek
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 利用XAI指导联邦学习数据共享以缓解异构性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入XAI解决联邦学习数据异构问题，实验扎实且隐私保障完备。

### 4. **[The Logic of Data Access and Data Exchanges](https://arxiv.org/abs/2606.31858v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-30
- **作者**: Alexandru Baltag, Sonja Smets
- **标签**: `cs.LO` `cs.MA`
- **AI摘要**: 提出扩展动态认知逻辑以建模数据访问与交换
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 逻辑严密且具理论创新，但应用场景相对小众。

### 5. **[Decoupling Trust in Byzantine CRDTs: Fine-grained Post-Compromise Handling without Breaking Causality](https://arxiv.org/abs/2606.31759v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-30
- **作者**: Amos Brocco
- **标签**: `cs.DC` `cs.DS`
- **AI摘要**: 解耦身份与内容信任以处理拜占庭CRDT
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出细粒度信任模型，有效解决后妥协场景下的因果一致性问题。

## Information Retrieval

### 1. **[GR2 Technical Report](https://arxiv.org/abs/2606.31984v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Yufei Li, Zaiwei Zhang, Mingfu Liang et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 提出GR2重排序框架，提升工业推荐系统性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且在工业级场景验证了显著效果，严谨实用。

## Computer Vision

### 1. **[MuSViT: A Foundation Vision Model for Sheet Music Representation](https://arxiv.org/abs/2606.31811v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-06-30
- **作者**: Carlos Penarrubia, Antonio Rios-Vila, Eliseo Fuentes-Martinez et al.
- **标签**: `cs.CV`
- **AI摘要**: 首个乐谱领域视觉基础模型MuSViT
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出领域专用视觉模型，实验扎实且性能优越

### 2. **[LUNA: Learning Universal 3D Human Animation Beyond Skinning](https://arxiv.org/abs/2606.31981v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Peng Li, Rawal Khirodkar, Junxuan Li et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出LBS-free通用3D人体动画模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，摆脱了传统皮肤绑定限制，实验扎实。

### 3. **[AnyBokeh: Physics-Guided Any-to-Any Bokeh Editing with Optical Fingerprint Transfer](https://arxiv.org/abs/2606.31959v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Xinyu Hou, Xiaoming Li, Zongsheng Yue et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出AnyBokeh实现物理引导的任意光圈与焦点编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过光学指纹迁移避免了全聚焦重建，方法创新且实验扎实。

### 4. **[LeCropFollow: Latent Space Planning for Navigation in Unstructured Crop Fields](https://arxiv.org/abs/2606.31941v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Felipe Tommaselli, Francisco Affonso, Arthur Pompeu et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 基于潜在空间规划的农业机器人导航框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验严谨，有效解决了非结构化农田导航难题。

### 5. **[RESOLVE: A Multi-Resolution and Multi-Modal Dataset for Roadside Cooperative Perception](https://arxiv.org/abs/2606.31895v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Shaozu Ding, Linan Song, Marco De Vincenzi et al.
- **标签**: `cs.CV`
- **AI摘要**: 发布多模态路侧感知数据集RESOLVE
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大且设计严谨，对路侧感知研究有重要价值。

## Machine Learning

### 1. **[Random Reshuffling Dominates Stochastic Gradient Descent](https://arxiv.org/abs/2606.32005v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-30
- **作者**: Zijian Liu
- **标签**: `math.OC` `cs.LG` `stat.ML`
- **AI摘要**: 证明随机重排在凸优化中优于SGD
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了长期存在的理论与实践不匹配的公开问题

### 2. **[Calibration, Not Compilation: Detecting and Repairing Misspecified Probabilistic Programs Written by Language Models](https://arxiv.org/abs/2606.31630v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-30
- **作者**: Jian Xu, Delu Zeng, John Paisley et al.
- **标签**: `cs.LG`
- **AI摘要**: 利用贝叶斯校准修复概率编程模型错误
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过校准而非编译验证模型，显著提升了LLM生成代码的统计正确性。

### 3. **[Radial Suppression Accelerates Algorithmic Generalization: A Geometric Analysis of Delayed Generalization](https://arxiv.org/abs/2606.32000v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
...
- **评分理由**: 理论分析深入，实验验证了加速泛化的有效性。

### 4. **[Interface-Aware Neural Newton Preconditioning for Robust Cohesive Zone Model Simulations](https://arxiv.org/abs/2606.31921v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Zhangyong Liang, Huanhuan Gao
- **标签**: `cs.LG` `math.NA`
- **AI摘要**: 提出IA-NNP预处理器以提升CZM模拟收敛性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入神经预处理解决CZM非线性收敛难题，实验扎实。

### 5. **[Low-dimensional topology of deep neural networks](https://arxiv.org/abs/2606.31856v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-30
- **作者**: Junyu Ren, Lek-Heng Lim
- **标签**: `cs.LG` `math.GT`
- **AI摘要**: 利用低维拓扑分析神经网络架构的表达能力
<details>
<summary>原始摘要</summary>
