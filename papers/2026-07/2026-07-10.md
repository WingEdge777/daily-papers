...
### 1. **[Towards Precision Therapy in Hepatocellular Carcinoma: A Clinical-Reasoning LLM for Risk Stratification and Treatment Guidance](https://arxiv.org/abs/2607.08602v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-09
- **作者**: Peng Cui, Jitao Wang, Siyan Xue et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出HCC-STAR模型实现肝癌精准分期与治疗决策支持。
<details>
...
- **评分理由**: 模型在临床多中心验证中表现优异，具备极高的临床应用价值。

### 2. **[MentalHospital: A Virtual Environment for Evaluating Psychiatric Clinical Encounters](https://arxiv.org/abs/2607.08257v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-09
- **作者**: Yuming Yang, Xiao Sun, Yuanwei Zou et al.
- **标签**: `cs.AI`
- **AI摘要**: 构建精神科临床评估虚拟环境MentalHospital
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过S.O.A.P.流程与专家评估模型，显著提升了精神医学LLM评估的严谨性。

### 3. **[Two Axes of LLM Abstention: Answer Correctness and Question Answerability](https://arxiv.org/abs/2607.08456v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-09
- **作者**: Benedikt J. Wagner
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出区分正确性与可回答性的双轴拒答机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地分离了拒答维度，实验严谨且实用性强。

### 4. **[Ideas Have Genomes: Benchmarking Scientific Lineage Reasoning and Lineage-Grounded Idea Generation](https://arxiv.org/abs/2607.08758v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Yifan Zhou, Qihao Yang, Yan Li et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出科学思想演化基准IG-Bench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入基因演化框架评估科学推理，方法严谨且实用。
...
- **评分理由**: 提出新指标量化模型行为差异，分析深入且实用。

## Natural Language Processing

### 1. **[When Synthetic Speech Is All You Have: Better Call GRPO](https://arxiv.org/abs/2607.08409v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Shashi Kumar, Yanis Labrak, Hasindri Watawana et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 利用GRPO优化合成语音ASR，显著降低WER。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入强化学习解决合成数据偏差，方法创新且实验扎实。

### 2. **[Echoes Across Vietnam's Highlands, Delta, and Coast: A Multilingual Corpus for Cham, Khmer, and Tay-Nung](https://arxiv.org/abs/2607.08362v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Anh Trac Duc Dinh, Khang Nhat Hoang Vo, Vinh Cong Doan et al.
- **标签**: `cs.CL`
- **AI摘要**: 构建越南少数民族语言语料库与预训练方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了低资源语言NLP空白，方法论严谨且具有实际应用价值。

### 3. **[Grounded Event Extraction from SEC 8-K Filings with a Fine-Grained Taxonomy](https://arxiv.org/abs/2607.08346v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Rian Dolphin, Joe Dursun, Jarrett Blankenship et al.
- **标签**: `cs.CL` `q-fin.GN`
- **AI摘要**: 构建SEC 8-K细粒度事件抽取系统
<details>
<summary>原始摘要</summary>
...
- **AI摘要**: 揭示TTS评估中的ASR家族偏差并提出跨家族集成方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 发现评估偏差并提供有效改进，实验严谨且具有实用价值

### 5. **[Cross-seed explainability using Procrustes-conditioned Joint End-to-end Top-K Sparse Autoencoders](https://arxiv.org/abs/2607.08499v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Bendegúz Váradi, Zoltán Kmetty
- **标签**: `cs.CL`
- **AI摘要**: 提出Procrustes条件化SAE实现跨种子特征对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了模型特征对齐难题。

## Vision Language Models

### 1. **[Beyond wheelchairs and blindfolds: Investigating disability stereotypes in T2I models with INCLUDE-BENCH](https://arxiv.org/abs/2607.08515v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-09
- **作者**: Sophia Lichtenberg, Albert Gatt, Judith Masthoff
- **标签**: `cs.CV`
- **AI摘要**: 提出首个残障偏见评估基准INCLUDE-BENCH
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了T2I模型残障偏见评估的空白，方法严谨且具有重要社会意义。

### 2. **[Cognitive-structured Multimodal Agent for Multimodal Understanding, Generation, and Editing](https://arxiv.org/abs/2607.08497v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Feng Wang, Canmiao Fu, Zhipeng Huang et al.
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出认知结构多模态智能体，提升长程交互效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过情景记忆与检索优化长程多模态任务，实验扎实且性能显著。

### 3. **[DeltaV: Thinking with Visual State Updates in Unified Large Multimodal Models](https://arxiv.org/abs/2607.08434v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Pengjie Wang, Linger Deng, Zujia Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出DeltaV模型，通过视觉增量更新提升多模态推理效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过视觉增量更新减少冗余，方法创新且实验充分，性能提升显著。

### 4. **[WCog-VLA: A Dual-Level World-Cognitive Vision-Language-Action Model for End-to-End Autonomous Driving](https://arxiv.org/abs/2607.08375v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Xuerun Yan, Zhexi Lian, Nuoheng Zhang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出双层世界认知VLA框架实现主动驾驶
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新结合语义推理与生成式轨迹预测，性能领先。

### 5. **[FSD-VLN: Fast-Slow Dual-System Modeling for Aerial Long-Horizon Vision-Language Navigation](https://arxiv.org/abs/2607.08359v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Xueke Zhu, Qingyan Meng, Liutao Yu et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出快慢双系统架构提升无人机导航效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新显著提升了长程导航的实时性与成功率

## Diffusion Models

### 1. **[Score Accuracy Along the Forward Diffusion Does Not Certify Numerical Stability in Diffusion Sampling](https://arxiv.org/abs/2607.08757v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-09
- **作者**: Yiwei Zhou
- **标签**: `stat.ML` `cs.LG` `math.NA`
- **AI摘要**: 揭示扩散模型采样数值不稳定性及投影修正方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具深刻洞见，指出了扩散采样中的数值发散问题。

### 2. **[MobiDiff: Semantic-Aware Multi-Channel Discrete Diffusion for Human Mobility Data Generation](https://arxiv.org/abs/2607.08357v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Rongchao Xu, Lin Jiang, Dahai Yu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出多通道离散扩散模型生成移动数据
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且效率显著提升，实验设计严谨充分

### 3. **[AutoAnchor: Stable Diffusion Unlearning Using Cross-Attention as a Manifold Surrogate](https://arxiv.org/abs/2607.08337v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Siyuan Wen, Jiahao Zeng, Ningning Ding
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出AutoAnchor实现稳定扩散模型去学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论扎实且通过交叉注意力代理实现高效去学习，性能提升显著。

### 4. **[Closing the Null Space: Guidance-Aware Quantization for Classifier-Free Diffusion](https://arxiv.org/abs/2607.08241v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Abdullah Al Shafi, Sumaiya Rahim Suma
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出GAMP量化法解决扩散模型分支漂移问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对CFG量化缺陷提出创新方案，理论严谨且实用。

## Multimodal

### 1. **[MatBind: A Shared Embedding Space for Multimodal Materials Characterization](https://arxiv.org/abs/2607.08470v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Le Yang, Anoop K. Chandran, Jona Östreicher et al.
- **标签**: `cs.LG`
- **AI摘要**: 构建多模态材料表征共享嵌入空间
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地整合了多种材料数据模态，具有很高的科研实用价值。

### 2. **[Switch-Reasoner: Learn When to Think in Multitask Mixtures via Reinforcement Learning](https://arxiv.org/abs/2607.08572v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Yiyang Fang, Pei Fu, Jinjie Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出自适应推理模式切换框架，优化多模态模型效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过强化学习实现推理模式选择，兼顾性能与效率，方法严谨。

### 3. **[Frequency-Domain Multi-Modality Transportation Modeling](https://arxiv.org/abs/2607.08475v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Jiewen Deng, Hangchen Liu, Junchen Li et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出频域多模态交通预测模型FreMo
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过频域滤波与协同机制提升了交通预测的精度与鲁棒性

### 4. **[ArtMine: Discovering and Formalizing Artistic Processes](https://arxiv.org/abs/2607.08331v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Kaustubh Kumar, Ashutosh Ranjan, Vivek Srivastava et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出ArtMine框架，从历史证据中重构艺术创作过程。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地结合溯因推理与生成模型，方法论严谨且具应用潜力。

### 5. **[Blind-Spots-Bench: Evaluating Blind Spots in Multimodal Models](https://arxiv.org/abs/2607.08317v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Matteo Santelmo, Xiuying Wei, Israa Fakih et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出评估多模态模型盲点的基准测试。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过学生提问构建数据集，有效揭示了现有模型的局限性。

## Image Generation

### 1. **[Enhancing In-context Panoramic Generation via Geometric-aware Pretraining](https://arxiv.org/abs/2607.08765v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Haoran Feng, Ruiyang Zhang, Longyi Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Canvas360框架实现全景图生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过几何感知预训练与大规模数据集显著提升全景生成质量

## Video Generation

### 1. **[OPSD-V: On-Policy Self-Distillation for Post-Training Few-Step Autoregressive Video Generators](https://arxiv.org/abs/2607.08766v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Hongyu Liu, Chun Wang, Feng Gao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出OPSD-V通过在线自蒸馏优化自回归视频生成模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效缓解了长视频生成中的误差累积。

### 2. **[OpenCoF: Learning to Reason Through Video Generation](https://arxiv.org/abs/2607.08763v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Xinyan Chen, Ziyu Guo, Renrui Zhang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出OpenCoF框架提升视频生成模型的推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入数据集与微调模型，通过视觉与语义标记增强时空推理，方法扎实且具有应用价值。

## Agent

### 1. **[Write-Protected Discrete Bottlenecks for Language-Grounded World Models: A Structural Limitation and Sufficient Fix](https://arxiv.org/abs/2607.08312v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-09
- **作者**: Jiayi Fang
- **标签**: `cs.LG`
- **AI摘要**: 提出解耦梯度约束解决离散瓶颈语义坍缩问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深刻，实验设计严谨且效果显著，具有高实用价值。
...
- **评分理由**: 通过能力解耦与闭环评估提升了智能体评测的科学性

### 3. **[Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents](https://arxiv.org/abs/2607.08716v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Yifan Wu, Lizhu Zhang, Yuhang Zhou et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出主动记忆代理以缓解长程任务中的状态衰减
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了智能体长程任务表现

### 4. **[WebSwarm: Recursive Multi-Agent Orchestration for Deep-and-Wide Web Search](https://arxiv.org/abs/2607.08662v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Xiaoshuai Song, Liancheng Zhang, Kangzhi Zhao et al.
- **标签**: `cs.CL` `cs.AI` `cs.MA`
- **AI摘要**: 提出递归多智能体Web搜索框架WebSwarm
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过递归任务分解与协作显著提升了复杂搜索任务的深度与广度。

### 5. **[Formal Mechanisms for Market Stability in Self-Interested Agent Societies: A Marketplace Simulation Study](https://arxiv.org/abs/2607.08652v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Eugene Ng Yi Sheng, Bingquan Shen
- **标签**: `cs.AI`
- **AI摘要**: 研究LLM智能体市场中调解机制的鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，对多智能体市场稳定性有深刻洞察

## Distributed Computing

### 1. **[Computing in Anonymous Dynamic Networks with One-Bit Communications](https://arxiv.org/abs/2607.08358v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-09
- **作者**: Thibaut Blanc, Giuseppe Antonio Di Luna, Giovanni Viglietta
- **标签**: `cs.DC`
- **AI摘要**: 提出匿名动态网络单比特通信计算方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新显著，证明了极低带宽下的计算能力。

### 2. **[Log-Insight: Automating Microservice Incident Diagnosis via Neuro-Symbolic Log Analysis](https://arxiv.org/abs/2607.08529v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-09
- **作者**: Carlos Garcia-Hernandez, Aymane Abdali, Guangyu Wu et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出神经符号日志分析系统，高效诊断微服务故障。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工业级落地效果显著，方法论结合符号逻辑与LLM，严谨且实用。

### 3. **[Secure Decentralized Federated Learning via Gossip and Virtual Voting](https://arxiv.org/abs/2607.08651v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Amirhossein Taherpour, Xiaodong Wang
- **标签**: `cs.LG` `cs.DC`
- **AI摘要**: 提出基于Gossip与DAG的去中心化联邦学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合DAG共识与联邦学习，兼顾去中心化与安全性，实验扎实。

### 4. **[SMetric: Rethink LLM Scheduling for Serving Agents with Balanced Session-centric Scheduling](https://arxiv.org/abs/2607.08565v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Jiahao Wang, Kaizhan Lin, Kaixi Zhang et al.
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 提出基于会话的LLM调度算法提升吞吐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对智能体负载特性优化调度，实验扎实且提升显著

### 5. **[Who Needs DRAM? We Have Fiber](https://arxiv.org/abs/2607.08407v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Hannah Atmer, Thiemo Voigt, Yuan Yao et al.
- **标签**: `cs.AR` `cs.DC` `cs.ET`
- **AI摘要**: 利用光纤延迟线存储LLM权重以替代DRAM
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性架构显著降低能耗，实验设计严谨且具实用价值

## Operating Systems

### 1. **[Detecting Ladder Logic Bombs in IEC 61131-3 PLC Programs using ESBMC-PLC+: A Formal Verification Approach with Trigger Synthesis](https://arxiv.org/abs/2607.08417v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-09
- **作者**: Pierre Dantas, Lucas Cordeiro, Waldir Junior
- **标签**: `cs.CL` `cs.AR`
- **AI摘要**: 提出ESBMC-LLB检测PLC逻辑炸弹
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 形式化验证方法创新且实验评估扎实，实用性强。

## Information Retrieval

### 1. **[PIT-SUN: A Deployable Empirical Marginal Transform Framework with Expectation-Consistent Recovery for Regression in Recommender Systems](https://arxiv.org/abs/2607.08202v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Mingyu Zhao, Zhaohan Li, Zhenxiong Miao et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出PIT-SUN框架解决推荐系统回归任务的期望一致性问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，针对工业界长尾分布问题有显著实用价值

### 2. **[Improving Ad-hoc Search Effectiveness for Conversational Information Retrieval via Model Merging](https://arxiv.org/abs/2607.08540v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Ahmed Rayane Kebir, Jose G. Moreno, Lynda Tamine
- **标签**: `cs.IR` `cs.CL`
- **AI摘要**: 利用模型合并技术提升会话检索性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出无需训练的合并策略，有效平衡了检索任务的通用性与性能。

### 3. **[H3D: Benchmarking Unsupervised Text Hashing for Fine-Grained Document Deduplication](https://arxiv.org/abs/2607.08382v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Qianren Mao, Jiaxun Lyu, Junnan Liu et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出H3D基准用于文档去重评估
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性对比了多种哈希方法，实验严谨且具有实用价值。

### 4. **[DaV-Gen: End-to-End Generative Retrieval via Draft-and-Verify](https://arxiv.org/abs/2607.08365v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Meng Zhao, Chunmei Liu, Qinyong Wang
- **标签**: `cs.IR`
- **AI摘要**: 提出DaV-Gen框架实现端到端检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过草稿验证机制优化检索效率与精度，方法创新且实用。

### 5. **[PolyUQuest: Verifiable Structure-Aware Web RAG over Heterogeneous Graphs](https://arxiv.org/abs/2607.08269v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-09
- **作者**: Ying Liu, Yi Ye, Quanyu Feng et al.
- **标签**: `cs.AI`
- **AI摘要**: 基于异构图的结构化Web RAG框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出结构感知检索提升了RAG准确性与可解释性，实用性强。
...
- **评分理由**: 针对全景图特性优化分区策略，创新性与实用性兼备。

### 3. **[ARDY: Autoregressive Diffusion with Hybrid Representation for Interactive Human Motion Generation](https://arxiv.org/abs/2607.08741v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Kaifeng Zhao, Mathis Petrovich, Haotian Zhang et al.
- **标签**: `cs.GR` `cs.CV` `cs.LG`
- **AI摘要**: 提出ARDY框架实现交互式实时人体动作生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合自回归与扩散模型，在实时性与可控性上表现出色

### 4. **[Pose-to-Biomechanics: Bridging 3D Human Pose Estimation and Biomechanical Attribute Prediction](https://arxiv.org/abs/2607.08725v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Ayda Eghbalian, Kevin Desai
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出BioModule实现姿态到生物力学属性的预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地连接了姿态估计与生物力学分析，实验严谨且实用。

### 5. **[HumanForge: A Human-Centric Deepfake Video Benchmark with Multi-Agent Forgery Rationales](https://arxiv.org/abs/2607.08705v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Wenbo Xu, Zhimin Chen, Xiaojie Liang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出HumanForge数据集与多智能体标注框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多智能体协作解决深度伪造检测的标注难题，方法创新且实用。

## Machine Learning

### 1. **[Joint Discrete-Continuous Flow Matching for Open-Vocabulary Inverse Design of Multilayer Optical Coatings](https://arxiv.org/abs/2607.08392v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-09
- **作者**: Zhiyi Li, Yuheng Jin, Yidan Huang et al.
- **标签**: `physics.optics` `cs.LG`
- **AI摘要**: 提出IrisFlow实现光学涂层开放词汇逆向设计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入变分推理实现自适应控制，方法严谨且实用。

### 4. **[Deep Learning for Joint Narrowband Interference Cancellation and Soft Demodulation in OFDM Systems](https://arxiv.org/abs/2607.08717v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Emmanouil Kavvousanos, Francky Catthoor, Vassilis Paliouras
- **标签**: `cs.LG` `eess.SP`
- **AI摘要**: 深度学习实现OFDM抗干扰与软解调
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出物理信息神经网络，显著提升抗干扰性能与效率

### 5. **[MPFlow: Learning Budgeted Max-Flow Optimization on the Lightning Network with Deep Graph Reinforcement Learning](https://arxiv.org/abs/2607.08703v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-09
- **作者**: Harrison Rush, Vincent Davis, Simone Antonelli et al.
- **标签**: `cs.LG`
- **AI摘要**: 利用图强化学习优化闪电网络流动性分配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合图神经网络与强化学习解决实际金融网络优化问题，方法创新且有生产实践。
