...
### 1. **[Where Should Optimizer State Live? Tiered State Allocation for Memory-Efficient Mixture-of-Experts Training](https://arxiv.org/abs/2607.19058v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-21
- **作者**: Nuemaan Malik
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出SkewAdam优化MoE内存分配
<details>
...
- **评分理由**: 通过分层优化器状态显著降低内存并提升性能

### 2. **[Measuring Reward-Seeking via Contrastive Belief Updates](https://arxiv.org/abs/2607.18966v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-21
- **作者**: Axel Højmark, Jérémy Scheurer, Evgenia Nitishinskaya et al.
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 提出对比合成微调法量化模型奖励追求行为。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，对AI对齐研究具有重要价值。

### 3. **[HindsightBench: A Black-Box Behavioral Audit Protocol for Parametric Hindsight in Time-Indexed LLM Decision Tasks](https://arxiv.org/abs/2607.18867v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-21
- **作者**: Haozhe Jia
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出评估LLM参数化后见之明的黑盒审计协议
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，对模型审计具有重要意义。

### 4. **[Prompt Design at Scale: How Format, Instruction Count, and Context Length Shape Instruction Adherence and Hallucination in Large Language Models](https://arxiv.org/abs/2607.19257v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-07-21
- **作者**: Netanel Eliav
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 系统评估提示词设计对大模型性能的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过受控实验量化了格式、指令数与上下文对模型表现的边界影响。

### 5. **[ISO: An RLVR-Native Optimization Stack](https://arxiv.org/abs/2607.19331v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-21
- **作者**: Hanqing Zhu, Wenyan Cong, Zhizhou Sha et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出ISO框架，通过固定谱优化提升RLVR效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用谱继承理论优化RLVR训练，方法创新且实验扎实。

## Natural Language Processing

### 1. **[Automated Extraction of Techno-Economic Data from 76,000 Energy System Studies](https://arxiv.org/abs/2607.19178v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-21
- **作者**: Maxime Gorres, Jan Göpfert, Patrick Kuckertz et al.
- **标签**: `cs.CL`
- **AI摘要**: 利用NLP自动提取7.6万份能源研究数据
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在大规模能源数据提取上具有极高实用价值与创新性

### 2. **[Disentangling Curriculum Learning in NLP: Towards a Unifying Taxonomy](https://arxiv.org/abs/2607.18984v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Vanessa Toborek, Florian Seiffarth, Sebastian Müller et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出NLP课程学习的分类法以解决评估与调度混乱
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过系统性分类法解决了课程学习领域长期存在的评估不一致问题

### 3. **[Transcription Policy as a Latent Variable: Activating Controllable Verbatim ASR with Word-Level Timing](https://arxiv.org/abs/2607.18934v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Laurin Wagner, Mario Zusag, Bernhard Thallinger
- **标签**: `cs.CL`
- **AI摘要**: 提出可控逐字ASR模型，提升转录精度与时间戳。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了转录风格不一致问题。

### 4. **[OntoBook: Ontology-Grounded Synthetic Textbooks for Medical Encoder Pretraining](https://arxiv.org/abs/2607.18927v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Rian Touchent, Éric de la Clergerie
- **标签**: `cs.AI`
- **AI摘要**: 利用本体图构建合成教科书提升医学编码预训练效果
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了医学编码任务性能。

### 5. **[Inference-Time Steering for Cross-Lingual Factual Consistency in LLMs](https://arxiv.org/abs/2607.19243v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: Alexander Manev
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 研究LLM跨语言事实一致性的推理时干预策略。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论严谨，对比了多种干预手段，对多语言对齐有参考价值。

## Vision Language Models

### 1. **[PathAgentBench: Benchmarking Evidence-Seeking Vision-Language Models on Whole-Slide Pathology Image](https://arxiv.org/abs/2607.19261v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-21
- **作者**: Dankai Liao, Tianyi Zhang, Yufeng Wu et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出病理全切片证据搜寻基准PathAgentBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了全切片病理图像证据获取能力的评估空白，实验严谨且具有高实用价值。

### 2. **[Cognitive Dual-Process Planning for Autonomous Driving with Structured Scene Knowledge and Verifiable Reasoning-Action Consistency](https://arxiv.org/abs/2607.19194v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-21
- **作者**: Zhongyao Yang, Haoyu Li, Yu Yan et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出双过程规划框架提升自动驾驶推理效率与一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了VLM在自动驾驶中的延迟与一致性问题。
...
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Yuan Wang, Yongchao Du, Mengting Chen et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ExpertVerse基准与KnowThinker模型以提升视觉生成推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了高质量专家级基准，并提出了创新的BPPO优化策略，方法严谨且具有显著应用价值。

### 4. **[HPD-Parsing: Hierarchical Parallel Document Parsing](https://arxiv.org/abs/2607.18839v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Shu Wei, Jingjing Wu, Lingshu Zhang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出层级并行解码架构，显著提升文档解析速度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过层级化并行解码解决序列瓶颈，实验数据扎实，创新性强。

### 5. **[DobicVLM: Aligning Chest X-Ray Report Generation with Clinically-Grounded Programmatic Rewards via Group Relative Policy Optimization](https://arxiv.org/abs/2607.18988v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: Thanni Adewuyi, Angelica Obayi, Andem Aniekan et al.
- **标签**: `cs.CV`
- **AI摘要**: 利用GRPO优化胸片报告生成，提升临床准确性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，在材料科学领域具有极高的实用价值与严谨性
...
- **评分理由**: 创新性引入指针机制，在保持模型通用性下提升了区域生成精度。

### 3. **[Provable diffusion-based posterior sampling for linear inverse problems via DDIM](https://arxiv.org/abs/2607.19333v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Yuchen Jiao, Na Li, Changxiao Cai et al.
- **标签**: `cs.LG` `cs.AI` `stat.ML`
- **AI摘要**: 提出基于DDIM的线性反问题采样算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论证明严谨且算法高效，在图像恢复任务中表现优异。

### 4. **[Text Template Tokens Are Implicit Semantic Registers in Diffusion Transformers](https://arxiv.org/abs/2607.19139v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Maohua Li, Qirui Li, Yanke Zhou et al.
- **标签**: `cs.CV`
- **AI摘要**: 揭示DiT中模板Token的语义寄存器机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果分析揭示DiT内部机制并提出高效剪枝策略

### 5. **[Image Editing Models are Numerical Solvers](https://arxiv.org/abs/2607.18787v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Ulysse Mizrahi
- **标签**: `cs.CV`
- **AI摘要**: 利用预训练图像模型作为通用数值求解器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将图像生成模型应用于物理模拟，实验覆盖广泛且论证严谨。

## Multimodal

### 1. **[Two-Level Meta-Rubrics for Evaluating Open-Ended Generation: GAMUT, a Benchmark for Factual Completeness](https://arxiv.org/abs/2607.19322v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Xilun Chen, Zhaleh Feizollahi, Ross Goodwin et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出GAMUT基准评估长文本事实完整性
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Ziyi Wang, Yuhang Wu, Dongxu Piao et al.
- **标签**: `cs.CL` `cs.CV`
- **AI摘要**: 提出多方会议多模态心智理论评估基准MeetingToM
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了多方会议复杂社交推理评估的空白，方法严谨。

### 3. **[One Model, Many Graphs: Learning over Attributed Graphs across Heterogeneous Modalities with Vision-Language Models](https://arxiv.org/abs/2607.19128v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Jiayi Yang, Yifang Chen, Yuanfu Sun et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出OMG-VLM实现多模态图学习统一框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用VLM作为骨干处理异构图数据，方法创新且实验扎实。

### 4. **[Advancing Multimodal Fusion on Heterogeneous Medical Data with Hybrid Geometry Attention](https://arxiv.org/abs/2607.19086v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Joy Dhar, Manish Kumar Pandey, Nayyar Zaidi et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CURE框架实现高效多模态融合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，在医疗多模态任务中表现优异。

### 5. **[Quality Action Assurance: Multimodal Verification of Examiner Claims in VR OSCEs](https://arxiv.org/abs/2607.19063v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Harry Rogers, Sally Shiels, Ashley Tomlinson et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出QAA框架通过多模态验证VR临床考试评分准确性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，有效解决了临床评估的主观性问题。

## Image Generation

### 1. **[ROMS-IMLE: A Minimalist Approach to Competitive Single-Step Generative Modelling](https://arxiv.org/abs/2607.19332v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Chirag Vashist, Ke Li
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出极简单步生成模型ROMS-IMLE
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过IMLE实现高效单步生成，性能优异且架构简洁。

### 2. **[Mage-Flow: An Efficient Native-Resolution Foundation Model for Image Generation and Editing](https://arxiv.org/abs/2607.19064v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Xinjie Zhang, Peng Zhang, Shicheng Zheng et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出高效原生分辨率图像生成与编辑模型Mage-Flow
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过架构协同设计显著提升训练与推理效率，实用性强。

## Video Generation

### 1. **[FilmWorld: Agentic Novel-to-Film Generation through Dynamic Cinematic World Modeling](https://arxiv.org/abs/2607.19038v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-21
- **作者**: Jialong Zuo, Haotong Zuo, Shiwei Zhang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出FilmWorld实现小说到电影的智能生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性框架创新，评估指标完善，实验结果扎实。

### 2. **[ABot-World-0: Infinite Interactive World Rollout on a Single Desktop GPU](https://arxiv.org/abs/2607.19191v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Fan Jiang, Zhaoxu Sun, Mengchao Wang et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出单卡实时交互式世界模型ABot-World-0
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且工程落地性强，在长序列生成与推理优化上表现出色。

### 3. **[Learning Explicit Physical Parameter Control and Benchmarking for Video Generation](https://arxiv.org/abs/2607.18924v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Yanxun Li, Hao Wen, Bingze Song et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PhyParam实现物理可控视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入大规模物理数据集与基准，显著提升生成物理一致性。

### 4. **[Moving Alphabet: A Controlled Study of Training Data for Text-to-Video Generation](https://arxiv.org/abs/2607.18789v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: Amber Yijia Zheng, Lu Liu, Raymond A. Yeh et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Moving Alphabet基准以研究数据对视频生成的影响。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过受控实验揭示了数据分布与标注质量对视频模型的关键作用。

## Agent

### 1. **[Cross-Agent Campaign Attribution: Linking Asynchronous Attacks Across LLM Agents](https://arxiv.org/abs/2607.18826v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-21
- **作者**: SangJin Park, Myungsub Choi, Jineok Kim et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出跨智能体异步攻击归因框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决多智能体安全防御难题，实验严谨且实用。

### 2. **[ResearchArena: Evaluating Sabotage and Monitoring in Automated AI R&D](https://arxiv.org/abs/2607.19321v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Lena Libon, Ben Rank, Jehyeok Yeon et al.
- **标签**: `cs.AI` `cs.CR` `cs.LG`
- **AI摘要**: 提出ResearchArena框架评估AI研发中的破坏与监控能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地引入AI研发安全评估框架，实验设计严谨且具有高实用价值。

### 3. **[They'll Verify. They Just Won't Act. How Authority Framing and Laundered Code Turn a Trusted Agentic CI/CD Pipeline Into an Attack Surface](https://arxiv.org/abs/2607.19267v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Yohann Sidot
- **标签**: `cs.CR` `cs.AI` `cs.MA`
- **AI摘要**: 揭示LLM代理流水线中的权威伪造攻击风险
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，揭示了CI/CD自动化安全漏洞。

### 4. **[Keeping the Cache Warm Pays: Keepalive Economics for Agentic Workloads](https://arxiv.org/abs/2607.19214v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Maxim Khailo
- **标签**: `cs.DC`
- **AI摘要**: 通过保活机制优化LLM缓存以降低代理任务成本
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对代理负载的缓存保活策略具有极高实用价值与经济洞察

### 5. **[Agentic Real2Sim: Physics-based World Modeling with Vision-Language Agents](https://arxiv.org/abs/2607.19190v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Guanxiong Chen, Qianjun Xia, Jiawei Peng et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 基于VLM的自动化物理仿真建模框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过智能体自动化实现真实场景到仿真环境的转换，流程创新且实用性强。
...
- **标签**: `cs.DC`
- **AI摘要**: 提出Contrast系统实现分布式追踪的多维比较分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过TPO结构实现高效追踪比较，实验验证充分且实用性强。

### 2. **[InstantInfer: Enabling Fast LLM Cold Start with Communicating Finite Automata](https://arxiv.org/abs/2607.18957v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Yitao Yuan, Yongchao He, Shaoke Fang et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出CFA抽象加速LLM冷启动
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过自动化重构优化I/O与初始化，性能提升显著且理论严谨。

### 3. **[How network perturbations distort agreement trajectories in LTI multi-agent systems](https://arxiv.org/abs/2607.18913v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Gal Barkai, Irinel-Constantin Morărescu
- **标签**: `eess.SY` `cs.MA` `math.OC`
- **AI摘要**: 揭示LTI多智能体系统在扰动下的轨迹脆弱性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且发现重要系统漏洞，具有较高学术价值

### 4. **[Coherence in Control: Bridging Many-Core Mapping and Routing through Cost Unification](https://arxiv.org/abs/2607.19158v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: Guochu Xiong, Xiangzhong Luo, Weichen Liu
- **标签**: `cs.DC`
- **AI摘要**: 提出CoCo框架实现缓存一致性感知映射与路由协同优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过统一成本模型解决多核系统通信瓶颈，实验效果显著。

### 5. **[A Scalable Pattern Mining Workflow for Interpretable Machine Log Analysis in High-Performance Computing Environments](https://arxiv.org/abs/2607.19143v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-07-21
- **作者**: Shilpika Shilpika, Bethany Lusch, Eric Pershey et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出一种高性能计算日志挖掘工作流
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且针对性强，实验验证充分，逻辑清晰。

## Information Retrieval

### 1. **[TSGR: Taobao Search Generative Retrieval](https://arxiv.org/abs/2607.18796v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Tianyu Zhan, Gui Ling, Tong Xiong et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出TSGR框架实现电商搜索的价值感知生成式检索。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且工业落地效果显著，实验设计严谨详实。

### 2. **[PAGE-RAG: Evidence-Grounded Adaptive Graph Retrieval for Long-Document Question Answering](https://arxiv.org/abs/2607.19301v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: Xingyu Chen, Junxiu An, Jun Guo et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出PAGE-RAG实现可靠长文档问答
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过投影感知与自适应路由提升了图检索的准确性与可靠性

### 3. **[Spectral Biclustering-Driven Scalability for Post-Hoc Explainability in Recommender Systems](https://arxiv.org/abs/2607.19189v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: Jose L. Salmeron, Irina Arévalo
- **标签**: `cs.IR`
- **AI摘要**: 提出谱双聚类块删除诊断框架以提升推荐系统可解释性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过块删除降低计算成本，方法创新且实验设计严谨。

### 4. **[CR-Refiner: An Object-Centric Optimal Transport Reranker for Edit-Conditioned 3D Scene Retrieval](https://arxiv.org/abs/2607.19115v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: Hao Wu, Jinjing Zhu, Nanyu Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于最优传输的3D场景检索重排序框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验设计严谨，评估基准完善。

### 5. **[GATE-3D: Geometry-Aware Test-time Adaptive Reranking for Open-Set 3D Shape Retrieval](https://arxiv.org/abs/2607.19111v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-21
- **作者**: Hao Wu, Heyi Lin, Zilin Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GATE-3D实现几何感知的3D检索重排序
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且有效，实验严谨，在3D检索领域有实用价值。

## Computer Vision

### 1. **[From Distances to Trajectories: Real-Time Signed Distance Function Mapping and Distance-Accelerated Motion Planning for UAVs](https://arxiv.org/abs/2607.19306v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-21
- **作者**: Jason Stanley, Zhirui Dai, Qihao Qian et al.
- **标签**: `cs.RO` `cs.AI` `cs.CV`
- **AI摘要**: 提出OREN与Bubble*实现无人机实时避障规划
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合神经SDF与搜索规划，在实时性和精度上均有显著提升。

### 2. **[Delineate Anything v2: A Global Foundation Model for Field Delineation](https://arxiv.org/abs/2607.19069v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-21
- **作者**: Mykola Lavreniuk, Nataliia Kussul, Andrii Shelestov et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出全球农田边界分割模型DAv2
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将动作映射为像素空间掩码，提升了模型控制力与泛化性。

### 4. **[IGGT4D: Streaming 4D Instance-Grounded Geometry Transformer](https://arxiv.org/abs/2607.19228v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Zhengyu Zou, Hao Li, Kuixuan Jiao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出流式4D实例几何Transformer以实现动态场景理解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且构建了大规模数据集，实验验证充分，实用性强。

### 5. **[Point Ladder Tuning: Parameter-Efficient Hierarchical Adaptation for 3D Point Cloud Understanding](https://arxiv.org/abs/2607.19171v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Junlin Chang, Longhao Zou, Rui Li
- **标签**: `cs.CV`
- **AI摘要**: 提出PLT框架实现高效3D点云微调
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且参数效率极高，实验验证充分。

## Machine Learning

### 1. **[NSMA: Neuro-Symbolic Manifold Alignment for Generalizable Adaptive Bitrate Streaming under Texture Shift](https://arxiv.org/abs/2607.18845v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-21
- **作者**: Zhiqiang He, Zhi Liu
- **标签**: `cs.NI` `cs.LG`
- **AI摘要**: 神经符号流形对齐提升ABR泛化性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性融合神经与符号逻辑，实验验证充分且效果显著。

### 2. **[Content is What Remains: Invariant Speech Tokenization from Parallel Utterances](https://arxiv.org/abs/2607.19033v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-21
- **作者**: Laurin Wagner, Bernhard Thallinger, Miroslav Stankovic et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出PINT方法实现语音语义解耦与表征不变性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过并行语料实现语义提取，显著降低了冗余信息。

### 3. **[1-Lipschitz Neural Networks on Hadamard Manifolds](https://arxiv.org/abs/2607.19335v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Davide Murari, Marta Ghirardelli, Ben Adcock et al.
- **标签**: `math.NA` `cs.LG`
- **AI摘要**: 提出哈达玛流形上的1-Lipschitz神经网络架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新扎实，将Lipschitz约束推广至非欧空间，实验验证充分。

### 4. **[Riemannian Deep Learning:Modules, Networks, and Geometries](https://arxiv.org/abs/2607.19305v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Chen Ziheng
- **标签**: `cs.LG` `cs.AI` `math.DG`
- **AI摘要**: 提出黎曼深度学习统一框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，方法论严谨且应用广泛。

### 5. **[The safety failures we are not instrumenting: a perspective on hidden safety-critical challenges in modern AI systems](https://arxiv.org/abs/2607.19292v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-21
- **作者**: Gjergji Kasneci, Enkelejda Kasneci
- **标签**: `cs.CY` `cs.AI` `cs.HC`
- **AI摘要**: 提出AI社会技术系统安全评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 视角独特，系统性地揭示了现代AI部署中的隐蔽安全风险。
