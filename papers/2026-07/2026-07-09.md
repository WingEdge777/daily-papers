...
### 1. **[Co-LMLM: Continuous-Query Limited Memory Language Models](https://arxiv.org/abs/2607.07707v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Yair Feldman, Linxi Zhao, Nathan Godey et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出连续查询LMLM，提升知识检索与生成精度。
<details>
...
- **评分理由**: 通过连续向量查询优化知识库交互，性能表现优异且具备高实用价值。

### 2. **[The Key to Going Linear: Analysis-Driven Transformer Linearization](https://arxiv.org/abs/2607.07706v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Anna Kuzina, Paul N. Whatmough, Babak Ehteshami Bejnordi
- **标签**: `cs.LG`
- **AI摘要**: 提出Transformer线性化新方法以提升长文本推理效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过结构化干预有效降低了线性化模型的性能损失，实验扎实。
...
- **评分理由**: 通过双模型博弈替代奖励模型，推理性能提升显著。

### 4. **[How Data Shapes RoPE Frequency Usage: From Positional Scale Matching to Length Generalization](https://arxiv.org/abs/2607.07678v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Xinyi Wu, Siyuan Liu, Ali Jadbabaie
- **标签**: `cs.LG`
- **AI摘要**: 揭示RoPE频率分布与数据依赖结构的内在关联机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架严谨，深入解释了RoPE频率选择与长文本泛化原理

### 5. **[Max Out GRPO Signal: Adaptive Trace Prefix Control for Hard Reasoning Problems](https://arxiv.org/abs/2607.07674v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Vladislav Beliaev
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出自适应前缀控制优化GRPO推理训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态调整前缀长度解决GRPO梯度消失问题，提升显著

## Natural Language Processing

### 1. **[A Word-Level Digital Reader of the Prasthanatrayi with Sankara's Bhasya: Corpus, Method, and an Open, Offline Reading Aid for the Advaita Vedanta Canon](https://arxiv.org/abs/2607.07282v1)**
...
- **评分理由**: 方法创新且实用，语料处理严谨，工具化成果显著。

### 2. **[DiaLLM: An Investigation into the Robustness-Generation Gap in English Dialect Adaptation](https://arxiv.org/abs/2607.07669v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Jordan Painter, Dipankar Srirag, Adarsh Kappiyath et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 研究LLM在方言生成与鲁棒性间的差距。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性对比了方言适配方法，实验严谨且具有实际应用价值。

### 3. **[Interpretable Uncertainty for Adaptive Retrieval and Reasoning in Question Answering](https://arxiv.org/abs/2607.07380v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Ritajit Dey, Iadh Ounis, Graham McDonald
- **标签**: `cs.IR`
- **AI摘要**: 基于内部状态的自适应检索与推理框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过内部状态量化不确定性，有效提升了RAG的决策效率与透明度。

### 4. **[From Text to Parameters: Predicting Item Parameters from Embedding Regularization with Reliability and Design Ceilings](https://arxiv.org/abs/2607.07141v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Shi-Ting Chen, Jinsong Chen
- **标签**: `cs.CL` `stat.ME`
- **AI摘要**: 利用文本嵌入预测项目参数的评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出评估上限与交叉验证方法，严谨且具实用价值。

### 5. **[Multi-Class vs. Multi-Label BERT for CVE-to-CWE Mapping: How Taxonomy Structure Shapes the Errors](https://arxiv.org/abs/2607.07573v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-08
- **作者**: Ana Schwengber Kelm, Christian Bockermann, Jörg Frochte
- **标签**: `cs.LG` `cs.CR`
- **AI摘要**: 对比多分类与多标签BERT在CVE分类中的表现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验严谨，对漏洞分类任务有实际参考价值。

## Vision Language Models

### 1. **[HIVE: Understanding Post-Hallucination Reasoning in Vision Language Models](https://arxiv.org/abs/2607.07507v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Feng He, Zhenting Wang, Qifan Wang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出HIVE框架揭示视觉语言模型幻觉后的推理机制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究视角独特，实验设计严谨，对理解多模态推理有重要价值。

### 2. **[When Prompts Ignore Structure: Graph-Based Attribute Reasoning for Calibrated VLMs](https://arxiv.org/abs/2607.07395v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Tanay Sodha, Aditya Sharma, Ramya Hebbalaguppe et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出符号属性图以优化VLM校准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过图神经网络建模属性依赖，显著提升了模型校准性能。

### 3. **[Generalist Vision-Language Models for Fast Radio Burst detection: a zero-shot benchmark against a specialized detector](https://arxiv.org/abs/2607.07382v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Raiff H. Santos, Amilcar R. Queiroz, Tharcisyo S. S. Duarte et al.
- **标签**: `cs.LG` `astro-ph.HE` `astro-ph.IM`
- **AI摘要**: 利用通用多模态模型实现FRB零样本检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验设计严谨，展示了通用模型在天文领域的潜力。

### 4. **[Ego-Human Motion Prediction with 3D-Aware LLM](https://arxiv.org/abs/2607.07001v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Yujin Bae, Jaewoo Jeong, Hyeonseong Kim et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Ego3DLM实现三维感知与动作语言的联合预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过三维场景感知与多模态联合训练，显著提升了预测一致性。

### 5. **[BUS: Brain-Inspired Unsupervised Self-Reflection for Advanced Multimodal Reasoning](https://arxiv.org/abs/2607.07361v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-08
- **作者**: Jiacheng Yang, Tongying Xiao, Yunkai Dang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出脑启发无监督自反思框架，提升VLM推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入脑科学后向预测机制，无需标注数据提升推理性能，实验扎实。

## Diffusion Models

### 1. **[Constrained Decoding for Diffusion Language Models via Efficient Inference over Finite Automata](https://arxiv.org/abs/2607.07026v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-08
- **作者**: Meihua Dang, Stefano Ermon
- **标签**: `cs.LG`
- **AI摘要**: 提出扩散语言模型约束解码算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新扎实，有效解决了扩散模型约束生成难题。

### 2. **[DiPhon: Diffusion on Graphons for Scalable Graph Generation](https://arxiv.org/abs/2607.07232v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-08
- **作者**: Sergio Rozada, Yiming Qin, Manuel Madeira et al.
- **标签**: `stat.ML` `cs.AI` `cs.LG`
- **AI摘要**: 基于Graphon的图生成扩散模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用Graphon实现图生成的尺寸扩展，理论严谨且创新性强。

### 3. **[Selective Timestep Weighting and Advantage-Based Replay for Sample-Efficient Diffusion RLHF](https://arxiv.org/abs/2607.07693v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Eric Zhu, Abhinav Shrivastava, Soumik Mukhopadhyay
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出加权采样与回放机制提升扩散模型RLHF效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入且修复方案高效，显著提升引导稳定性

### 5. **[HPG-Diff: Hierarchical physics-guided diffusion with differentiable connectivity constraints for topology optimization](https://arxiv.org/abs/2607.07233v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Jinbo Yang, Mingyue Yuan, Boyuan Zhang et al.
- **标签**: `cs.LG` `cs.CE`
- **AI摘要**: 提出HPG-Diff框架实现物理约束下的拓扑优化生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理引导与扩散模型，有效提升了拓扑优化的质量与泛化性。
...
- **AI摘要**: 提出SciReasoner实现跨学科结构推理与预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型在多科学领域表现卓越，推理可解释性强且实验严谨。

### 2. **[MedPMC: A Systematic Framework for Scaling High-Fidelity Medical Multimodal Data for Foundation Models](https://arxiv.org/abs/2607.07673v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-08
- **作者**: Hyunjae Kim, Dain Kim, Pan Xiao et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出MedPMC框架，高效构建高质量医学多模态数据集。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，显著提升了医学多模态模型性能。

### 3. **[Dual Latent Memory in Vision-Language-Action Models for Robotic Manipulation](https://arxiv.org/abs/2607.07608v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Hongyu Qu, Jianzhe Gao, Xiaobin Hu et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出LaMem-VLA，通过潜空间记忆提升机器人长程任务能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入潜空间记忆机制，实验验证充分且逻辑清晰。

### 4. **[MMAgent-R$^2$: Learning to Rerank and Reject for Agentic mRAG](https://arxiv.org/abs/2607.07383v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Tao Zhang, Ziqi Zhang, Zongyang Ma et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MMAgent-R2框架，优化多模态检索增强生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入重排序与主动拒绝机制，有效提升检索准确性与鲁棒性。

### 5. **[R^3: Advertisement Compliance Rectification via Group-Relative Experience Extractor and Curriculum Reinforcement](https://arxiv.org/abs/2607.07318v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Yuan Chen, Zhenyu Hu, Mengge Xue et al.
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 提出R^3框架实现视频广告合规性与语义一致性平衡
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且工业落地效果显著，实验设计严谨且实用性强。

## Image Generation

### 1. **[Stage-Aware Adaptation and Distribution Calibration for Subject-Driven Personalized Text-to-Image Generation](https://arxiv.org/abs/2607.07173v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-08
- **作者**: Wenyan Xu, Alizer Wong
- **标签**: `cs.CV`
- **AI摘要**: 提出阶段感知适配与分布校准提升个性化图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效平衡了身份一致性与多样性

### 2. **[An Hybrid Quantum-Classical Diffusion Model for Image Generation](https://arxiv.org/abs/2607.07072v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-07-08
- **作者**: Qipeng Qian, Keli Deng, Yuntao Qian
- **标签**: `cs.LG`
- **AI摘要**: 提出混合量子扩散模型用于图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合自编码器与量子扩散，有效降低量子计算资源需求。

## Video Generation

### 1. **[Scaling Mixture-of-Experts Video Pretraining for Embodied Intelligence](https://arxiv.org/abs/2607.07675v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-08
- **作者**: Shuailei Ma, Jiaqi Liao, Xinyang Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出面向具身智能的MoE视频预训练模型LingBot-Video
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合MoE架构与机器人数据，在具身视频生成领域有创新。

### 2. **[Infinite Worlds with Versatile Interactions](https://arxiv.org/abs/2607.07534v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-08
- **作者**: Zelin Gao, Qiuyu Wang, Jiapeng Zhu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出支持无限交互的实时世界模拟器LingBot-World 2.0
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型在交互性与实时性上有显著提升，架构创新且实用性强。
...
- **评分理由**: 方法论创新且实验规模宏大，对AI安全治理贡献显著。

### 2. **[EmbodiedGen V2: An Agentic, Simulation-Ready 3D World Engine for Embodied AI](https://arxiv.org/abs/2607.07459v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-08
- **作者**: Xinjie Wang, Liu Liu, Taojun Ding et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 构建可执行的具身智能3D仿真世界引擎
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出统一仿真管线，显著提升了具身智能训练效率与迁移能力。

### 3. **[Breaking Database Lock-in: Agentic Regeneration of High Performance Storage Readers for Database Bypass](https://arxiv.org/abs/2607.07696v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Victor Giannakouris, Immanuel Trummer
- **标签**: `cs.DB` `cs.AI`
- **AI摘要**: 利用大模型自动生成数据库存储读取器以绕过驱动瓶颈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过LLM自动化解码存储格式，性能提升显著。

### 4. **[A hierarchical memory architecture overcomes context limits in long-horizon multi-agent computational modeling](https://arxiv.org/abs/2607.07666v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Shivendra G. Tewari, Holly Kimko
- **标签**: `q-bio.QM` `cs.MA`
- **AI摘要**: 提出分层记忆架构解决长程多智能体上下文限制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且实验严谨，有效提升了长程任务的稳定性与准确性。
...
- **评分理由**: 研究揭示了代理架构中容量分配的非对称性，方法论严谨且具实用价值。

## Distributed Computing

### 1. **[Memory Scarcity, Open Models, and the Restructuring of the AI Industry, 2026-2030 -- A quantitative scenario analysis of inference economics, training-cost divergence, and infrastructure solvency](https://arxiv.org/abs/2607.07207v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-08
- **作者**: Satoshi Matsuoka
- **标签**: `econ.GN` `cs.AI` `cs.AR`
- **AI摘要**: 量化分析AI硬件经济与行业重构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型对算力经济与基础设施偿付能力的分析极具深度与前瞻性。

### 2. **[Scaling WaterLily.jl with MPI and an improved geometric multigrid solver](https://arxiv.org/abs/2607.07687v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-08
- **作者**: Bernat Font, Marin Lauber, Tzu-Yao Huang et al.
- **标签**: `physics.comp-ph` `cs.DC` `physics.flu-dyn`
- **AI摘要**: 实现WaterLily.jl的高效MPI并行与多重网格优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过MPI扩展与求解器改进显著提升了流体模拟的扩展性与性能

### 3. **[Continual Learning With Participation Privacy: An Auditable Buffering-Aggregation Recipe](https://arxiv.org/abs/2607.07209v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-08
- **作者**: T-H. Hubert Chan, Elaine Shi, Mengshi Zhao et al.
- **标签**: `cs.CR` `cs.LG`
- **AI摘要**: 提出参与隐私下的持续学习审计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了单编辑流下的隐私保护难题，理论严谨且具有创新性。

### 4. **[Voltron: Enabling Elastic Multi-Device Execution of LLM Inference for Empowered Edge Intelligence](https://arxiv.org/abs/2607.07046v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-08
- **作者**: Chanwoo Cho, Wooseok Kim, Yonglak Son et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出多设备协同推理框架以提升边缘端LLM性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决边缘计算资源瓶颈，实验验证有效，逻辑清晰。

## Information Retrieval

### 1. **[Seeing and Reflecting: Multimodal Memory-Enhanced Agent Collaboration for Recommendation](https://arxiv.org/abs/2607.07108v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-08
- **作者**: Hao Cong, Huizu Lin, Zihan Wang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出多模态记忆增强智能体推荐框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合双轨记忆机制，实验验证充分，逻辑清晰。

### 2. **[Evaluating RAG Metrics in Applied Contexts: An Experiment, Its Findings and Its Limitations](https://arxiv.org/abs/2607.07302v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-07-08
- **作者**: Quentin Brabant
- **标签**: `cs.CL`
- **AI摘要**: 评估RAG指标在实际业务场景中的有效性与局限性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实证分析对比多种RAG评估工具，方法论严谨但创新性中等。

## Computer Vision

### 1. **[Billions of Sketches Reveal Hidden Cultural Variation in Human Concepts](https://arxiv.org/abs/2607.07267v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-08
- **作者**: Arianna Pera, Mauro Martino, Nima Dehmamy et al.
- **标签**: `cs.CY` `cs.CL` `physics.soc-ph`
- **AI摘要**: 通过海量素描揭示人类概念的跨文化认知差异。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法创新，数据规模宏大，深刻揭示了视觉与语言认知的差异。

### 2. **[ECGLight: Compute-Light Framework For Paper ECG Digitization and Myocardial Infarction Screening](https://arxiv.org/abs/2607.07683v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Shreyasvi Natraj, Cyrus Achtari, Felice Gragnano et al.
- **标签**: `cs.LG`
- **AI摘要**: 轻量化纸质心电图数字化与MI筛查系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 端到端轻量化方案解决了资源受限场景的医疗痛点，实验扎实。

### 3. **[CARLA-GS: Decoupling Representation, Reasoning, and Physics Simulation for Autonomous Driving Corner-Case Synthesis](https://arxiv.org/abs/2607.07601v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Kaicong Huang, Meng Ma, Ruimin Ke
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出CARLA-GS框架实现自动驾驶角点场景合成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解耦视觉、推理与物理仿真，方法创新且实验扎实。

### 4. **[AA-ViT: Anatomically Aware Vision Transformer with Structural and Frequency Guidance for Contrast Enhanced Brain MRI Synthesis](https://arxiv.org/abs/2607.07553v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Talha Meraj, Tom Flannery, Charlie Cummins et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出AA-ViT模型实现脑部MRI对比增强合成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合结构与频率引导，临床验证充分，方法创新且严谨

### 5. **[Face-trace: Open-Set Attribution and Progressive Discovery of Synthetic Face Generators](https://arxiv.org/abs/2607.07545v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Alessia Infantino, Claudio Schiavella, Irene Amerini
- **标签**: `cs.CV`
- **AI摘要**: 提出开放集人脸生成器溯源与增量发现框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决未知生成器识别难题

## Machine Learning

### 1. **[Behavior Foundations for Quadruped Robots: ABot-C0 Technical Report](https://arxiv.org/abs/2607.07370v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-08
- **作者**: Xufeng Zhao, Fuzhi Yang, Jianhui Chen et al.
- **标签**: `cs.RO` `cs.AI` `cs.HC`
- **AI摘要**: 构建四足机器人通用运动控制系统ABot-C0
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据规模大且方法论创新，具备极高工程实用价值

### 2. **[Quantum simulation of real-world nonlinear dynamics via Koopman method](https://arxiv.org/abs/2607.07338v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-08
- **作者**: Baoyang Zhang, Dong An, Zhaoyuan Meng et al.
- **标签**: `quant-ph` `cs.AI` `physics.flu-dyn`
- **AI摘要**: 提出量子Koopman方法模拟非线性动力学
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合量子计算与算子理论，实验验证效果显著且严谨。

### 3. **[Is Randomness Necessary for Adaptive Data Analysis?](https://arxiv.org/abs/2607.07085v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-08
- **作者**: Edith Cohen, Haim Kaplan, Yishay Mansour et al.
- **标签**: `cs.CR` `cs.DS` `cs.LG`
- **AI摘要**: 证明随机性对自适应数据分析的必要性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了长期悬而未决的理论难题，结论深刻且严谨。

### 4. **[Recursive Self-Improvement in AI: From Bounded Self-Refinement to Autonomous Research Loops](https://arxiv.org/abs/2607.07663v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-08
- **作者**: Mingguang Chen, Licheng Wang, Bo Qu
- **标签**: `cs.AI`
- **AI摘要**: 系统梳理递归自我改进AI的分类与局限
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模文献综述构建了严谨的评估框架，具有极高的学术价值。

### 5. **[Neural Operator-enabled Topology-informed Evolutionary Strategy for PDE-Constrained Optimization](https://arxiv.org/abs/2607.07682v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-08
- **作者**: Xiangming Huang, Guannan Zhang, Lu Lu et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出神经算子驱动的拓扑演化策略用于PDE逆向设计
<details>
<summary>原始摘要</summary>
