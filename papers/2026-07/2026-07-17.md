...
### 1. **[Innocuous-Seeming Data, Latent Ideology: Ideological Generalisation in Finetuned LLMs](https://arxiv.org/abs/2607.14888v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-16
- **作者**: Robert Graham, Edward Stevinson, Yariv Barsheshat
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 揭示微调导致大模型产生广泛意识形态泛化现象
<details>
...
- **作者**: Patrik Wolf, Thomas Kleine Buening, Andreas Krause et al.
- **标签**: `cs.CL`
- **AI摘要**: 揭示LLM统计自洽性缺陷及宏观谬误
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且严谨，揭示了模型推理的系统性偏差。

### 3. **[Can We Trust Item Response Theory for AI Evaluation?](https://arxiv.org/abs/2607.15190v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Han Jiang, Sunbeom Kwon, Jinwen Luo et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示IRT在AI基准评估中的局限性与可靠性边界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究严谨，系统性评估了IRT在AI评估中的适用性，具有重要方法论价值。

### 4. **[T^2MLR: Transformer with Temporal Middle-Layer Recurrence](https://arxiv.org/abs/2607.15178v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Ziyang Cai, Xingyu Zhu, Yihe Dong et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 引入中间层递归提升Transformer推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过局部递归实现高效推理，方法新颖且实用性强。

### 5. **[Rubrics on Trial: Evolving Rubrics from a Single Query via Synthetic Pairwise Evidence](https://arxiv.org/abs/2607.15092v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Haocheng Yang, Licheng Pan, Xiaoxi Li et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出无需人工标注的动态评分标准生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效提升了LLM评估的准确性。

## Natural Language Processing

### 1. **[CoTu at EXACT 2026: Neuro-Symbolic Reasoning for Transparent Educational QA](https://arxiv.org/abs/2607.14735v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-16
- **作者**: Quoc-Khang Tran, Minh-Thien Nguyen, Phu-An Thai et al.
- **标签**: `cs.CL`
- **AI摘要**: 利用神经符号推理提升小模型教育问答的透明度与准确性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合Z3与Python编程实现逻辑推理，方法创新且实验表现优异。

### 2. **[Expanding the Lexicon of Ge'ez Based African Languages: A Comparative Study of Amharic and Tigrinya](https://arxiv.org/abs/2607.15209v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Hailay Kidu Teklehaymanot, Debela Desalegn Yadeta, Wolfgang Nejdl
- **标签**: `cs.CL`
- **AI摘要**: 通过扩展词表提升吉兹语系模型性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著改善了低资源语言处理能力。

### 3. **[ChronoQG: Towards a Temporally Expressive and Hop-Bounded Benchmark for Temporal Knowledge Graph Question Generation](https://arxiv.org/abs/2607.14770v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Xuemeng Liu, Zhengpin Li, Wanpeng Tang et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出首个时序知识图谱问答生成基准ChronoQG。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了时序问答生成领域空白，方法严谨且评估全面。

### 4. **[Gold-Guided Programmatic Distillation for Financial Reasoning over Hybrid Tables and Text](https://arxiv.org/abs/2607.14709v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Yun Dong, Erica Zhao, Elana Chen
- **标签**: `cs.CL`
- **AI摘要**: 提出基于程序蒸馏的金融推理框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过执行验证提升小模型推理能力，方法创新且实验扎实。

### 5. **[Linear representations of grammaticality in neural language models](https://arxiv.org/abs/2607.15175v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Jane Li, Najoung Kim
- **标签**: `cs.CL`
- **AI摘要**: 通过探针技术揭示了神经语言模型内部存在语法表征维度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨且创新，有效区分了语法与概率，具有较高学术价值。

## Vision Language Models

### 1. **[Symbal: Detecting Systematic Misalignments in Model-Generated Captions](https://arxiv.org/abs/2607.15216v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Maya Varma, Jean-Benoit Delbrouck, Sophie Ostmeier et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出Symbal检测多模态模型系统性对齐错误
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且基准全面，有效提升了模型审计的准确性与实用性。

### 2. **[FoMoVLA: Bridging Visual Foresight and Motion Guidance for Vision-Language-Action Models](https://arxiv.org/abs/2607.14739v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Wei Li, Peijin Jia, Yuan Ma et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出FoMoVLA框架，融合视觉预测与运动轨迹以增强VLA模型。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过结合未来特征预测与点追踪，显著提升了机器人策略的连续性与泛化能力。

### 3. **[Stop Thinking, Start Looking: Efficient Post-Training for Multimodal Document Question Answering via Reasoning-Free Alignment](https://arxiv.org/abs/2607.14682v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Harikrishnan P M, Goutham Vignesh, Ganesh Parab et al.
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 提出Perception-RFT，通过去推理化提升多模态问答效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了推理冗余与训练效率问题。

### 4. **[Action QFormer: Structured Representation Shaping under Action Supervision in Vision-Language-Action Models](https://arxiv.org/abs/2607.14635v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Yufeng Ji, Wenhao Tang, Haoyi Niu et al.
- **标签**: `cs.AI` `cs.CV` `cs.RO`
- **AI摘要**: 提出Action QFormer优化VLA动作表示
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过查询接口解耦动作监督与多模态表征，性能提升显著。
...
- **评分理由**: 利用arXiv修订数据训练智能体，方法新颖且实用。

## Diffusion Models

### 1. **[MeanFlowNFT: Bringing Forward-Process RL to Average-Velocity Generators](https://arxiv.org/abs/2607.15273v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Yushi Huang, Xiangxin Zhou, Jun Zhang et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出MeanFlowNFT实现高效RL对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过诱导瞬时速度预测器，有效提升了少步生成模型的对齐效果。

### 2. **[Mask-Aware Policy Gradients for Diffusion Language Models](https://arxiv.org/abs/2607.15200v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Haran Raajesh, Kulin Shah, Adam Klivans et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出掩码感知策略梯度以优化扩散语言模型生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分解MDP优化掩码策略，在数学与代码任务上表现优异。

### 3. **[Optimal Self-Distillation for Rectified Flow via Linear Probing](https://arxiv.org/abs/2607.14947v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
...
- **评分理由**: 理论严谨且证明了自蒸馏的性能提升，实验充分。

### 4. **[Introspective Attention Modulation for Safe Text-to-Image Generation](https://arxiv.org/abs/2607.14945v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Basim Azam, Hossein Rahmani, Naveed Akhtar
- **标签**: `cs.CV`
- **AI摘要**: 通过注意力机制调节实现安全文生图
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且实验扎实，有效提升了生成模型的安全性。

### 5. **[Rare Concept Generation via Counterfactual Inference in Diffusion Models](https://arxiv.org/abs/2607.14765v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Zhengyuan Jiang, Haipeng Liu, Meng Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CI-Diff框架，利用因果推理解决扩散模型罕见概念生成偏差。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入因果推理解决生成偏差具有创新性，实验验证充分，方法论严谨。

## Multimodal

### 1. **[MM-IssueLoc: A Controlled Benchmark for Evaluating Visual Evidence in Multimodal Repository-Level Issue Localization](https://arxiv.org/abs/2607.15205v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Shaoxiong Zhan, Shi Hu, Boyu Feng et al.
- **标签**: `cs.SE` `cs.AI`
- **AI摘要**: 提出多模态仓库级问题定位基准MM-IssueLoc
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了多模态软件工程评估空白，方法严谨且具有高实用价值。

### 2. **[SceneBind: Binding What and Where Across Vision, Audio and Language](https://arxiv.org/abs/2607.15265v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Mingfei Chen, Zijun Cui, Ruoke Zhang et al.
- **标签**: `cs.CV` `cs.AI` `cs.MM`
- **AI摘要**: 提出SceneBind实现视听语言多模态空间语义对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入空间语义槽，实验严谨，有效提升检索与定位能力。

### 3. **[TikStance: A Multimodal and Hierarchical Dataset for Multi-target Stance Analysis in TikTok Political Conversations](https://arxiv.org/abs/2607.15240v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Yazhi Zhang, Fuqiang Niu, Bowen Zhang
- **标签**: `cs.CL`
- **AI摘要**: 发布首个TikTok多模态政治立场分析数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了短视频平台政治对话分析的数据空白，标注质量高且具有研究价值。
...
- **评分理由**: 通过标准化测试评估模型，方法严谨且具有实用价值。

### 5. **[AlphaWiSE: Adaptive Weight Interpolation for Continual Multimodal Representation Learning](https://arxiv.org/abs/2607.15094v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Sarthak Jain, Qiran Hu, Zhen Zhu et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出AlphaWiSE权重插值法解决多模态持续学习遗忘问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验充分，有效提升多模态检索性能

## Image Generation

### 1. **[TAMF-VTON: Texture-Aware Mask-Free Virtual Try-On via High-Fidelity Image Synthesis](https://arxiv.org/abs/2607.14807v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Jie Wang, Qian He, Gaofeng He et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出无掩码、纹理感知的虚拟试穿框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验充分，具备商业落地潜力

### 2. **[Multi-Axis Max@K Reinforcement Learning for Representative Diversity in Text-to-Image Generation](https://arxiv.org/abs/2607.14962v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Ku Onoda, Paavo Parmas, Hiroki Furuta et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出多轴Max@K强化学习提升T2I模型生成多样性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效改善了生成模型的多样性与公平性。
...
- **评分理由**: 创新性引入分层潜在空间，兼顾推理一致性与生成效率

### 2. **[From Draft to Draft-Free: One-Step Video Object Removal via Privileged Distillation and Fast Planting](https://arxiv.org/abs/2607.14976v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Zizhao Chen, Ping Wei, Guang Dai et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出D2DF框架实现高效一步视频物体移除
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏与自引导机制显著提升了视频修复的效率与质量

### 3. **[CODA: Algorithm-Hardware Co-design for Edge Video Diffusion via NMP-Enabled Compute-Cache Operator Disaggregation](https://arxiv.org/abs/2607.14908v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Yuanpeng Zhang, YuXuan Wu, Yitong Xiao et al.
- **标签**: `cs.AR` `cs.DC`
- **AI摘要**: 提出CODA架构加速边缘视频扩散模型推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法硬件协同设计有效解决了边缘端缓存瓶颈

### 4. **[FlashDecoder: Real-Time Latent-to-Pixel Streaming Decoder with Transformers](https://arxiv.org/abs/2607.14898v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Minguk Kang, Suha Kwak
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出FlashDecoder实现高效实时视频解码
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新显著提升解码速度与内存效率，实验详实。

### 5. **[ReBind: Multi-Reference Video Editing via Structured Instructions with Explicit Reference Relationships](https://arxiv.org/abs/2607.14681v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Xinyu Liu, Shihao Li, Weihong Lin et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ReBind框架实现多参考图视频编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过显式绑定机制解决多参考源对齐难题，方法创新且实验扎实。

## Agent

### 1. **[LQCDMaster: Agentic Scientific Computing for Lattice Quantum Chromodynamics Research](https://arxiv.org/abs/2607.15001v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-16
- **作者**: Haofei Gao, Tingjia Miao, Wenkai Jin et al.
- **标签**: `hep-lat` `cs.AI` `hep-ph`
- **AI摘要**: 提出LQCDMaster智能体实现格点QCD计算自动化。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过梯度更新压缩历史，显著提升长程任务表现

### 3. **[MemPoison: Uncovering Persistent Memory Threats and Structural Blind Spots in LLM Agents](https://arxiv.org/abs/2607.14651v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-16
- **作者**: Jifeng Gao, Kang Xia, Yi Zhang et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出MemPoison框架揭示LLM智能体记忆注入攻击风险
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估了智能体记忆安全，方法严谨且具有高实用价值。
...
- **评分理由**: 通过显式状态管理和任务调度显著提升了搜索效率与鲁棒性。

## Distributed Computing

### 1. **[Don't Predict, Prioritize: Rethinking GPU Reliability Assessment](https://arxiv.org/abs/2607.15115v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Difeng Ma, Changhua Pei, Yuanwei Lu et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出HeaRank框架通过风险排序优化GPU集群可靠性管理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将预测转为排序问题，在生产环境验证有效

### 2. **[Ground-Side Mission Plan Compilation with Policy-as-Code Guardrails for Cloud-Native Satellite Platforms](https://arxiv.org/abs/2607.14798v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Hsiu-Chi Tsai, Chia-Tung Chung
- **标签**: `cs.DC`
- **AI摘要**: 卫星云原生任务编译与策略合规工具
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了卫星任务链编译空白，设计严谨且实用性强。

### 3. **[What's in a Smoothness Constant? Tighter Rates for Local SGD with Bounded Second-order Heterogeneity](https://arxiv.org/abs/2607.14731v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Kumar Kshitij Patel, Rustem Islamov, Sebastian U Stich et al.
- **标签**: `cs.LG` `math.OC` `stat.ML`
- **AI摘要**: 证明了局部SGD在凸优化下的紧致收敛界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过二阶异构性假设提升了局部SGD的理论收敛分析

### 4. **[Memory-Exhaustion Attack on the Blocklace Byzantine-Repelling Conflict-Free Replicated Data Type](https://arxiv.org/abs/2607.15185v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-07-16
- **作者**: Erick Lavoie
- **标签**: `cs.DC`
- **AI摘要**: 揭示了Blocklace协议的内存耗尽攻击漏洞
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过理论分析发现协议存在严重的安全设计缺陷，具有较高的学术价值。

### 5. **[Modeling and Validation of Quality of Control for Edge-Offloaded Collaborative Navigation](https://arxiv.org/abs/2607.14853v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-07-16
- **作者**: Neelabhro Roy, Mikael Hammarling, Victor Nan Fernandez-Ayala et al.
- **标签**: `cs.RO` `cs.MA` `eess.SY`
- **AI摘要**: 边缘卸载协同导航QoC建模与验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过5G测试床验证了控制与通信协同设计的有效性

## Information Retrieval

### 1. **[Bridge Evidence: Static Retrieval Utility Does Not Predict Causal Utility in Multi-Step Agentic Search](https://arxiv.org/abs/2607.15253v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Debayan Mukhopadhyay, Utshab Kumar Ghosh, Shubham Chatterjee
- **标签**: `cs.IR` `cs.CL`
- **AI摘要**: 揭示静态检索与智能体因果效用不匹配，提出桥梁文档概念。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，揭示了智能体检索评估的新范式，具有较高学术价值。

### 2. **[Mutable Low-Rank Sketches for Retrain-Free Recommendation](https://arxiv.org/abs/2607.15242v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Hector J. Garcia, Nick Clayton
- **标签**: `cs.LG`
- **AI摘要**: 提出可变低秩草图以实现实时推荐更新
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且性能优越，理论证明严谨，实用性强。

### 3. **[CoSimRec: Measuring Coordinated-Content Penetration in Recommender Feedback Loops](https://arxiv.org/abs/2607.15114v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Nan Li, Jiahong Shao, Jiuyang Lyu
- **标签**: `cs.IR` `cs.SI`
- **AI摘要**: 提出CoSimRec框架评估推荐系统协同攻击渗透率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效量化了反馈循环中的协同攻击影响。

### 4. **[LLM-Based Re-Ranking for Real Estate Search](https://arxiv.org/abs/2607.14835v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
...
- **评分理由**: 结合工业界落地与大规模评估，方法实用且效果显著。

## Computer Vision

### 1. **[Online Neural Space Time Memory for Dynamic Novel View Synthesis](https://arxiv.org/abs/2607.15271v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Baback Elmieh, Lynn Tsai, Zeman Li et al.
- **标签**: `cs.CV` `cs.GR` `cs.LG`
- **AI摘要**: 提出解耦更新机制实现实时动态新视角合成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦内存更新与应用，显著提升了实时性能与长时记忆稳定性。

### 2. **[CRISP: Constrained Refinement via Iterative Squeezing Process for Robust Medical Image Segmentation under Domain Shift](https://arxiv.org/abs/2607.15231v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Yizhou Fang, Pujin Cheng, Yixiang Liu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CRISP框架实现无目标域数据的鲁棒医学图像分割
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性利用秩稳定性先验，实验验证充分且效果显著。

### 3. **[Divergent Gaze Patterns in Artistic Viewing: Spatial and Temporal Signatures of Attention Across Autistic Individuals, Artists, and Neurotypical Observers](https://arxiv.org/abs/2607.15227v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Mohammed Amine Kerkouri, Daphné Senggaran, Renaud Jusiak et al.
- **标签**: `cs.CV` `cs.HC`
- **AI摘要**: 揭示自闭症群体独特的艺术视觉注意力模式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，通过多维度指标量化了不同群体的注视差异。

### 4. **[SUFLECA: Scaling Up Feature Learning for CAD-to-image Alignment](https://arxiv.org/abs/2607.15058v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Saad Ejaz, Miguel Fernandez-Cortizas, Javier Civera et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出SUFLECA实现零样本CAD对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且性能优于监督学习，实验扎实。

### 5. **[JADE-GS: Joint Alternating Deblurring Guided by Events in 3D Gaussian Splatting](https://arxiv.org/abs/2607.14990v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Haoyu Fu, Jiafeng Huang, Yuchen Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出JADE-GS实现事件相机驱动的动态场景三维重建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性融合事件流与高斯溅射，实验扎实且效率高。

## Machine Learning

### 1. **[Subjective Risk Decomposition: A New View for Uncertainty Quantification](https://arxiv.org/abs/2607.15196v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
...
- **评分理由**: 理论创新性强，统一了多种不确定性度量方法。

### 2. **[CFM-Bench: A Unified Multi-Domain, Multi-Task Benchmark for Channel Foundation Models](https://arxiv.org/abs/2607.14975v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Yuan Gao, Wenjun Yu, Jun Jiang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出首个统一的无线信道基础模型基准测试平台。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了信道模型评估标准缺失的空白，方法严谨且实用。

### 3. **[A Minimal Interpretable Architecture for Zero-Shot Reconstruction of Dynamical Systems](https://arxiv.org/abs/2607.14937v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Christoph Jürgen Hemmer, Florian Plaswig, Daniel Durstewitz
- **标签**: `cs.LG` `cs.AI` `math.DS`
- **AI摘要**: 提出极简DynaBase模型实现零样本动力系统重构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过极简架构实现高性能重构，理论分析深入且严谨。

### 4. **[Measuring Spatial Clustering via Metropolis-Hastings Diffusion Distance](https://arxiv.org/abs/2607.14880v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Thomas Weighill, Chidinma Williams
- **标签**: `math.ST` `cs.LG`
- **AI摘要**: 提出基于扩散距离的空间聚类度量方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具备实际应用价值，优于传统Moran's I指标

### 5. **[PAC Learning in Turn-Based Stochastic Games with Reachability Objectives: A Decentralized Private Approach via Expected Conditional Distance](https://arxiv.org/abs/2607.14877v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Ali Asadi, Krishnendu Chatterjee, Pavol Kebis
- **标签**: `cs.LG` `cs.GT`
- **AI摘要**: 提出TBSG去中心化私有学习算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 首次实现博弈论中的去中心化与私有信息学习，理论严谨。
