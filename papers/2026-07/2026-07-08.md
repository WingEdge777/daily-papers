...
### 1. **[Multi-Channel Spread-Spectrum Code Watermarking](https://arxiv.org/abs/2607.06009v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Soohyeon Choi, Debin Gao, Yue Duan
- **标签**: `cs.CR` `cs.LG` `cs.SE`
- **AI摘要**: 提出首个高鲁棒性代码水印技术
<details>
...
- **评分理由**: 创新性强，鲁棒性与实用性显著优于现有方案

### 2. **[More Convincing, Not More Correct: Self-Play Reward Hacking of Reference-Free LLM Judges](https://arxiv.org/abs/2607.05904v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Chenyu Zhou
- **标签**: `cs.LG`
- **AI摘要**: 揭示自博弈评测机制的奖励欺骗漏洞
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入剖析LLM评测偏差，实验严谨且结论具有极高实用价值。

### 3. **[DepthWeave-KV: Token-Adaptive Cross-Layer Residual Factorization for Long-Context KV Cache Compression](https://arxiv.org/abs/2607.06523v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Anna Cordoba, Adam Puente Tercero, Nerea Angulo Hijo et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出一种自适应KV缓存压缩方法，提升长文本推理效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验覆盖全面，显著降低内存占用。

### 4. **[FreqDepthKV: Frequency-Guided Depth Sharing for Robust KV Cache Compression in Long-Context LLM Inference](https://arxiv.org/abs/2607.06519v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Anna Córdoba, Adam Puente Tercero, Nerea Angulo Hijo et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出频率引导的KV缓存压缩方法，提升长文本推理效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验覆盖全面，显著优化了推理性能。

### 5. **[DT-Guard: Intent-Driven Reasoning-Active Training for Reasoning-Free LLM Safety Guardrail](https://arxiv.org/abs/2607.06326v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: He Liu, Changtao Miao, Xinjie Yang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出推理增强训练、推理无感部署的安全护栏模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过推理监督训练实现高效安全判别，方法创新且实验扎实。

## Natural Language Processing

### 1. **[Pitwall: Faithful Natural-Language Race-Strategy Briefings from a Calibrated Real-Time Monte Carlo Engine](https://arxiv.org/abs/2607.06495v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Juan S. Santillana
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 基于蒙特卡洛引擎的F1实时策略播报系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨，数据集具有高实用价值，分类准确度高。

### 3. **[Estimating Uncertainty from Reasoning: A Large-Scale Study of Multi- and Crosslingual MCQA Performance in LLMs](https://arxiv.org/abs/2607.06327v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Andrea Alfarano, Andrea Bacciu, Saab Mansour et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 多语言环境下LLM不确定性估计的系统性评估与优化策略。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 跨语言评估规模大，方法论严谨，对多语言应用有指导意义。

### 4. **[Rethinking Indic AI from a Lens of Cultural Heritage Preservation](https://arxiv.org/abs/2607.06544v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Aparna Madva, Sharath Srivatsa, Srinath Srinivasa et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 探讨印度语言AI的文化保护与研究方向
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 综述详尽且视角独特，提出了文化感知研究框架，具有较高学术价值。

### 5. **[On the feasibility of dependency parsing of non-human sequences without a gold standard. Is evaluation possible in other species?](https://arxiv.org/abs/2607.06542v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Ramon Ferrer-i-Cancho, Catherine Hobaiter, Thore Bergman et al.
- **标签**: `cs.CL`
- **AI摘要**: 利用网络科学评估非人类序列的无监督依赖解析可行性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用序列长度分布特性解决了无金标准评估难题。
...
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出Lift3D-VLA实现三维几何与动态感知操作
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过三维点云编码与动态预测提升了机器人操作性能

### 2. **[CAIRN: Cross-Room 3D Scene Understanding with Topology-Aware Large Multimodal Models](https://arxiv.org/abs/2607.06534v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: He Liang, Chenyang Ma, Yiming Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出拓扑感知3D-LLM实现多房间场景理解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入分层注意力和图神经网络，显著提升多房间推理能力

### 3. **[AirflowAttack: Thermal-Airflow Adversarial Perturbations against Infrared Remote-Sensing Vision-Language Models](https://arxiv.org/abs/2607.06485v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Cong Su, Jiaju Han, Xuemeng Sun et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出首个红外遥感VLM热流对抗攻击方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入物理热流先验，实验严谨且影响深远。

### 4. **[Analysis-by-Proxy: Localization Signals in VLMs Operating as Condition Encoders](https://arxiv.org/abs/2607.06445v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Yoav Baron, Sara Dorfman, Roni Paiss et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 揭示VLM作为条件编码器时的空间定位信号缺失机制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过代理模型分析VLM内部表征，方法创新且论证严谨。
...
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Grace Man Chen, Litao Guo, Yifan Wu et al.
- **标签**: `cs.SE` `cs.AI` `cs.CV`
- **AI摘要**: 提出UI2App基准评估视觉交互推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了交互推理评估空白，方法严谨且具有高实用价值。

## Diffusion Models

### 1. **[AEGIS: A Mechanism-Guided Defense against Visual Synonym Jailbreaks in Text-to-Image Models](https://arxiv.org/abs/2607.06120v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-07-07
- **作者**: Yuanmin Huang, Zhenfei Zhang, Mi Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出AEGIS防御视觉同义词越狱攻击
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过机制分析定位关键注意力头，有效提升了安全性与生成质量。

### 2. **[Graph Convolutional Attention: A Spectral Perspective on Graph Denoising and Diffusion](https://arxiv.org/abs/2607.06546v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Shervin Khalafi, Igor Krawczuk, Sergio Rozada et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出图卷积注意力机制以优化图去噪与扩散性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨且在图扩散模型中具有显著实用价值

### 3. **[TILDE: TILt-based Distributional Erasure for Concept Unlearning](https://arxiv.org/abs/2607.06432v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Naveen George, Naoki Murata, Yuhta Takida et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出TILDE框架，通过分布对齐实现高效概念遗忘。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论扎实，在保持生成质量的同时有效去除了概念。

### 4. **[x-Prediction Is All You Need:Training-Free Accelerated Generation via Endpoint Decodability](https://arxiv.org/abs/2607.06114v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Xin Peng, Ang Gao
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出TJS采样法，无需训练加速扩散模型生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论扎实且无需额外训练，在主流模型上提升显著。

### 5. **[Bridging Diffusion Pruning and Step Distillation with Teacher-Aligned Repair](https://arxiv.org/abs/2607.06335v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Jincheng Ying, Li Wenlin, Minghui Xu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出教师对齐修复桥接剪枝与蒸馏以加速扩散模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新有效，实验详实，显著提升了模型推理效率。

## Multimodal

### 1. **[Propose and Attend: Training-free MLLM Grounding Confidence via Multi-Token Localized Attention](https://arxiv.org/abs/2607.05978v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-07
- **作者**: Daniel Shalam, Emanuel Ben Baruch, Avi Ben Cohen et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出MTLA，无需训练提升多模态模型定位置信度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且通用，实验详实，显著提升了定位性能。

### 2. **[ELSA3D: Elastic Semantic Anchoring for Unified 3D Understanding and Generation](https://arxiv.org/abs/2607.06565v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Tianjiao Yu, Xinzhuo Li, Yifan Shen et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出ELSA3D实现3D理解与生成的弹性语义锚定
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入多尺度锚定机制，显著提升效率与性能

### 3. **[Hierarchical Acoustic-Semantic Modeling: Modality Separation and Semantic Coherence for Full-Duplex SLMs](https://arxiv.org/abs/2607.06540v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Zhenyu Liu, Yunxin Li, Xuanyu Zhang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出Lychee-FD框架解决全双工SLM模态干扰问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 揭示了模态冲突机理，通过分层解耦显著提升了交互性能。

### 4. **[WordVoice: Explicit and Decoupled Multi-Dimensional Word-Level Control for LLM-Based TTS](https://arxiv.org/abs/2607.06461v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Sihang Nie, Jinxin Ji, Xiaofen Xing et al.
- **标签**: `eess.AS` `cs.CL` `cs.SD`
- **AI摘要**: 提出WordVoice实现词级语音细粒度控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过构建大规模数据集与解耦控制框架，显著提升了TTS的可控性。

### 5. **[Precise Video-to-Audio Generation with Cross-Modal Alignment in Latent Space](https://arxiv.org/abs/2607.06405v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Thanh V. T. Tran, Ngoc-Son Nguyen, Luong Tran et al.
- **标签**: `cs.MM` `cs.SD`
- **AI摘要**: 提出Flowley实现高效视频音频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 单阶段架构与同步机制创新，实验表现优异。

## Image Generation

### 1. **[PIPBench: A Profile-Inclusive Framework for Personalized Image Generation Evaluation](https://arxiv.org/abs/2607.06440v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Yuhang Wu, Shuxiang Zhang, Wee Hian Ching et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个个性化图像生成评估基准PIPBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入心理与人口统计学维度，评估框架具有创新性与实用价值

### 2. **[High-Resolution Artwork Outpainting with Global Blueprint Guidance and Layout Control](https://arxiv.org/abs/2607.06162v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Junha Kim, Hyunjoon Park, Donghyeon Cho
- **标签**: `cs.CV`
- **AI摘要**: 提出蓝图引导的两阶段扩散模型实现高效可控图像外绘
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过全局蓝图与并行合成解决了外绘结构失稳与延迟问题

## Video Generation

### 1. **[MobileWan: Closing the Quality Gap for Mobile Video Diffusion](https://arxiv.org/abs/2607.06173v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-07
- **作者**: Mohsen Ghafoorian, Denis Korzhenkov, Adil Karjauv et al.
- **标签**: `cs.CV`
- **AI摘要**: 通过递归重构实现5B移动端视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出高效递归蒸馏方案，显著提升移动端视频生成质量。

### 2. **[Prompt-Adapter Context Routing for Parameter-Efficient Multi-Shot Long Video Extrapolation](https://arxiv.org/abs/2607.06481v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Anna Córdoba, Adam Puente Tercero, Nerea Angulo Hijo et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出PACR-Video实现高效长视频外推
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过提示路由与适配器实现长视频连贯性，方法创新且实验扎实。

### 3. **[AlayaWorld: Long-Horizon and Playable Video World Generation](https://arxiv.org/abs/2607.06291v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: AlayaWorld Team, Kaipeng Zhang, Chuanhao Li et al.
- **标签**: `cs.CV` `cs.HC`
- **AI摘要**: 提出交互式生成世界框架AlayaWorld
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该框架实现了实时可交互视频世界生成，具有高实用性与完整性。

### 4. **[SparseCtrl-HOI: Sparse Temporal Control for Human-Object Interaction Video Generation](https://arxiv.org/abs/2607.05994v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Shenbo Xie, Mingrui Cai, Xu Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出稀疏控制HOI视频生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过稀疏关键帧与MLLM先验实现高效视频生成，方法创新且实用。

### 5. **[Point as Skeleton: Accumulated Point Cloud Enhanced Autoregressive Generation for Closed-Loop Autonomous Driving Simulation](https://arxiv.org/abs/2607.06516v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Songbur Wong, Xiaosong Jia, Junqi You et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出点云骨架增强的闭环自动驾驶视频生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入点云骨架解决误差累积，实验验证充分。

## Agent

### 1. **[Harnessing Code Agents for Automatic Software Verification](https://arxiv.org/abs/2607.06341v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Shuangxiang Kan, Shuanglong Kan, Sebastian Ertel
- **标签**: `cs.FL` `cs.AI` `cs.SE`
- **AI摘要**: 利用代码智能体实现自动形式化验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过智能体自主策略实现全覆盖验证，效果显著且具通用性。

### 2. **[When Does Tool Use Increase the Expressive Power of Finite-Precision Recurrent Models?](https://arxiv.org/abs/2607.06155v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Nikola Zubić, Qian Li, Yuyi Wang et al.
- **标签**: `cs.FL` `cs.CC` `cs.CL`
- **AI摘要**: 揭示工具使用对有限精度模型表达能力的提升机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，通过计算复杂性视角界定了工具的表达边界。

### 3. **[Information Limits and Attractor Dynamics in Economies of Frontier LLM Agents: A Pre-Registered Test](https://arxiv.org/abs/2607.06001v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Cheng Qian
- **标签**: `cs.AI` `cs.MA`
- **AI摘要**: 探究LLM智能体经济中的信息极限与吸引子动力学。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 预注册实验严谨，理论与实证结合，贡献显著。

### 4. **[Doomed from the Start: Early Abort of LLM Agent Episodes via a Recall-Controlled Probe Cascade](https://arxiv.org/abs/2607.06503v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Kai Ruan, Zihe Huang, Ziqi Zhou et al.
- **标签**: `cs.AI`
- **AI摘要**: 基于隐藏状态探测的LLM智能体提前终止机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过探测隐藏状态实现高效提前终止，方法创新且实验严谨。
...
- **评分理由**: 通过事实图实现多智能体协作，有效提升了长程数学证明能力。
...
- **评分理由**: 创新性解决分布式断点与时钟同步问题，实验扎实。

### 2. **[Bit2Watt: A Cyber-Physical Vulnerability Exploiting GPU Workloads Across Power and Computing Infrastructures](https://arxiv.org/abs/2607.05993v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Zhouhao Ji, Kaikai Pan, Wenyuan Xu
- **标签**: `cs.CR` `cs.AR` `cs.DC`
- **AI摘要**: 揭示GPU负载诱发电力基础设施波动的跨层安全漏洞
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 跨学科视角独特，实验严谨，对数据中心安全有深远影响。

### 3. **[MatrixFSDP: communication-free matrix optimizers under ZeRO-3 parameter sharding](https://arxiv.org/abs/2607.05895v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Ming Gao, Yanwu Xu, Hao Zhang
- **标签**: `cs.DC`
- **AI摘要**: 提出MatrixFSDP实现无通信矩阵优化器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了ZeRO-3下矩阵优化器的通信瓶颈，性能提升显著

### 4. **[UBEP: Re-architecting Expert Parallelism Communication Library for Production Superpods](https://arxiv.org/abs/2607.06202v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Yipeng Liu, Chang Liu, Si Shen et al.
- **标签**: `cs.DC` `cs.AI` `cs.NI`
- **AI摘要**: 提出UBEP库优化MoE通信效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对超级计算机架构优化通信，实验数据详实且具工业价值。

### 5. **[Ordering by Unanimity: Giving Applications Sequencing Rights Without Breaking Composability](https://arxiv.org/abs/2607.06144v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Andrea Canidio
- **标签**: `cs.DC` `econ.TH`
- **AI摘要**: 提出无一致性覆盖算法以解决区块链交易排序问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决交易排序冲突，理论严谨且具有实用价值

## Information Retrieval

### 1. **[InfluMatch: Frontier-Quality KOL Search at 4B-Model Cost](https://arxiv.org/abs/2607.05968v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
...
- **评分理由**: 通过级联架构实现高性价比的语义检索，实验设计严谨且实用。

### 2. **[RSF-GLLM: Bridging the Semantic Gap in Multi-Hop Knowledge Graph QA via Recurrent Soft-Flow and Decoupled LLM Generation](https://arxiv.org/abs/2607.06527v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Sambaran Bandyopadhyay, Ananth Muppidi
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出RSF-GLLM框架解决多跳知识图谱推理语义鸿沟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且逻辑严密，有效提升了推理效率与准确性。

### 3. **[DynaKRAG: A Unified Framework for Learnable Evidence Control in Multi-Hop Retrieval-Augmented Generation](https://arxiv.org/abs/2607.06507v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Yaqi Wu, Xiaolei Guo, Chenyu Zhou et al.
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 提出动态多跳RAG框架，优化证据获取策略。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入状态条件控制，实验严谨且性能提升显著。

### 4. **[Uncertainty-Aware Cross-Modal Remote Sensing Image-Text Retrieval via Evidential Learning](https://arxiv.org/abs/2607.06032v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Zhuoyue Wang, Xueqian Wang, Gang Li et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出基于证据学习的遥感跨模态检索方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入不确定性感知与测试时增强，有效提升鲁棒性。

### 5. **[Faithful or Findable? Evaluating LLM-Generated Metadata for RDF Dataset Search](https://arxiv.org/abs/2607.05970v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-07
- **作者**: Riccardo Terrenzi, Serkan Ayvaz
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 评估LLM生成RDF元数据的忠实度与检索效能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究系统性对比了LLM元数据生成的检索效果与忠实度，方法严谨。

## Computer Vision

### 1. **[OrchardBench: A Physically-Grounded, GPU-Parallel Apple-Orchard Simulation Benchmark for Agricultural Robotics](https://arxiv.org/abs/2607.06337v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-07
- **作者**: Humphrey Munn
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出首个物理驱动的苹果园机器人仿真基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 物理建模严谨，解决了农业机器人仿真难题，实用性强。

### 2. **[PhyMRI-SR: Toward Physics-Aware MRI Image Super-Resolution](https://arxiv.org/abs/2607.06238v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-07
- **作者**: Lihua Wei, Huatong Gao, Jia Gong et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出物理感知MRI超分框架，实现动态分辨率重建。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入高斯溅射与物理约束，实验严谨且具临床潜力。

### 3. **[Vision as Unified Multimodal Generation](https://arxiv.org/abs/2607.06560v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Xiaoyang Han, Jianhua Li, Kewang Deng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出统一多模态生成框架实现通用视觉任务处理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过指令微调实现多任务统一，方法创新且实验扎实。

### 4. **[ProxyPose: 6-DoF Pose Tracking via Video-to-Video Translation](https://arxiv.org/abs/2607.06555v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Ruihang Zhang, Felix Taubner, Pooja Ravi et al.
- **标签**: `cs.CV`
- **AI摘要**: 利用视频扩散模型实现无模型6-DoF位姿跟踪
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Zanyi Wang, Xin Lin, Haodong Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ReChannel架构，高效实现像素级密集预测任务。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地绕过生成解码器，显著提升了密集预测的效率与精度。

## Machine Learning

### 1. **[Provable learning separation for predicting time-evolution of quantum many-body systems](https://arxiv.org/abs/2607.06472v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Rahul Bandyopadhyay, Riccardo Molteni, Jens Eisert et al.
- **标签**: `quant-ph` `cs.AI` `cs.LG`
- **AI摘要**: 证明量子多体动力学学习存在量子优势
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，首次证明了量子学习任务的计算复杂性分离

### 2. **[A Function-Space Dichotomy for Compositional Learning: Exponential Sub-Optimality of the Neural Tangent Kernel](https://arxiv.org/abs/2607.06382v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Arkaprabha Ganguli, Emil Constantinescu
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 揭示了NTK在组合结构学习上的指数级次优性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且深刻，量化了神经网络与核方法的性能鸿沟。

### 3. **[When do prophets profit in prediction markets?](https://arxiv.org/abs/2607.06166v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-07
- **作者**: Anri Gu, Nicole Kagan, Alec Sun et al.
- **标签**: `cs.AI` `cs.CE` `cs.GT`
- **AI摘要**: 建立预测准确度与盈利能力的数学等价性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且实证效果显著，解决了市场机制的核心矛盾

### 4. **[EntroPath: Maximum Entropy Path Ensemble Embedding for Manifold Learning](https://arxiv.org/abs/2607.06497v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Przemysław Rola
- **标签**: `cs.LG` `q-bio.QM` `stat.ML`
- **AI摘要**: 提出基于最大熵随机游走的流形学习方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论扎实且在非均匀采样数据上表现优异

### 5. **[ExplAIner: A Declarative Query Language for Explaining Classification Models](https://arxiv.org/abs/2607.06407v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-07
- **作者**: Marcelo Arenas, Pablo Barceló, Diego Bustamante et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出ExplAIner声明式查询语言以统一解释机器学习模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架严谨，复杂度分析详尽，对XAI领域有重要贡献。
