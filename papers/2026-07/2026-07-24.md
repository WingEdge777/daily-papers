...
### 1. **[Emergent Misalignment Recruits a Pre-existing Persona Subspace](https://arxiv.org/abs/2607.21356v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-23
- **作者**: Mohammed Suhail B Nadaf
- **标签**: `cs.LG`
- **AI摘要**: 揭示微调诱发模型涌现失准的内在机制
<details>
...
- **评分理由**: 通过子空间干预揭示了模型失准的深层结构机制，实验严谨且极具洞见。

### 2. **[What, Where, and How: Disentangling the Roles of Task, Language, and Model in Code Model Representations](https://arxiv.org/abs/2607.21491v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-23
- **作者**: Piotr Wilam
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 揭示代码模型表征的通用性与差异性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨的2x2实验设计，深入剖析了模型表征的本质。

### 3. **[Beyond Sycophancy: Structured Resistance and Compliance in LLM Moral Reasoning](https://arxiv.org/abs/2607.21558v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Baihui Wang, Bernard Koch
- **标签**: `cs.AI`
- **AI摘要**: 揭示大模型道德判断的社会影响机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且方法严谨，对LLM对齐有重要理论价值。

### 4. **[Windowed-MTP: Removing the Full-Context Draft-KV Tax at Million-Token Context](https://arxiv.org/abs/2607.21535v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Alagappan Valliappan
- **标签**: `cs.LG` `cs.CL` `cs.PF`
- **AI摘要**: 提出Windowed-MTP优化长文本推理效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过窗口化注意力机制有效降低长文本草稿生成开销，实用性强。

### 5. **[From Resource Flow to Executable Tests: Petri-Net-Guided LLM Test Generation for Concurrent Stateful Rust APIs](https://arxiv.org/abs/2607.21530v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Kaiwen Zhang, Guanjun Liu
- **标签**: `cs.SE` `cs.AI`
- **AI摘要**: 基于Petri网的Rust并发API测试生成方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合形式化模型与LLM，有效提升了并发测试的覆盖率与准确性。

## Natural Language Processing

### 1. **[Surprisal Theory is Tautological (without Rational Grounding)](https://arxiv.org/abs/2607.21574v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Ryan Cotterell
- **标签**: `cs.CL`
- **AI摘要**: 揭示惊喜理论的同义反复本质并呼吁理性主义干预
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深刻剖析了理论的逻辑缺陷，论证严密且具有启发性。

### 2. **[Detecting LLM-Generated Tokens in Human--LLM Coauthored Text](https://arxiv.org/abs/2607.21458v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Yangjun Lu, Hongyi Zhou, Fabian Spill et al.
- **标签**: `cs.AI` `stat.ME`
- **AI摘要**: 提出一种无需标注的LLM文本细粒度检测方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需训练数据，理论与实验支撑扎实。

### 3. **[slang.gr as a Large-Scale Crowdsourced Resource for Non-Standard Greek](https://arxiv.org/abs/2607.21255v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Panagiotis Papadakos, Katerina Papantoniou, Dimitris Plexousakis
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 构建希腊语俚语资源并分析其语言与社区特征
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用众包数据进行社会语言学分析，方法严谨且实用。

### 4. **[DONDO: Open w2v-BERT Speech-Recognition Base Models for African Languages](https://arxiv.org/abs/2607.21540v1)**
...
- **评分理由**: 针对低资源语言的语音识别贡献显著，方法论扎实。

### 5. **[RUMBA: Russian User Memory Benchmark](https://arxiv.org/abs/2607.21447v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Elizaveta Shevtsova, Inna Glebkina, Mark Baushenko et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出俄语长短期记忆基准RUMBA
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了俄语长记忆评估空白，方法论严谨且具诊断价值。

## Vision Language Models

### 1. **[Do Pathology Vision-Language Models Truly See Pathology?](https://arxiv.org/abs/2607.21065v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-23
- **作者**: Chengyang Zhang, Wenchuan Zhang, Bo Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出PathBind基准揭示病理VLM视觉绑定能力不足
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入分析现有病理模型缺陷，构建高质量评估基准，方法严谨且具高实用价值。

### 2. **[Visual Contrastive Self-Distillation](https://arxiv.org/abs/2607.21556v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Yijun Liang, Yunjie Tian, Yijiang Li et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出VCSD通过视觉对比实现高效自蒸馏
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需额外监督，实验性能提升显著。

### 3. **[When Are Reasoning-Based Guardrails Not Efficient? ResponseGuard: A Fast Vision-Language Guard for Real-Time Moderation](https://arxiv.org/abs/2607.21401v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Dongbin Na
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出ResponseGuard，实现实时多模态内容安全防护。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过单次前向传播替代推理链，显著提升了防护效率。

### 4. **[CRAG-MM-Diagnostics: Enabling Stage-Wise Analysis of Knowledge-Intensive VQA](https://arxiv.org/abs/2607.21155v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Hanseok Oh, Parishad BehnamGhader, Benno Krojer et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出CRAG-MM诊断基准以分析KI-VQA瓶颈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过阶段性标注揭示了多模态RAG的性能瓶颈，方法严谨且具有实用价值。

### 5. **[HalluScope: Fine-grained Hallucination Diagnosis for Multimodal Large Language Models](https://arxiv.org/abs/2607.21105v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Weilin Jin, Mingyu Wang, Wenbo Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出多模态大模型细粒度幻觉诊断框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过构建诊断数据集与模型，有效提升了幻觉检测与纠正能力。

## Diffusion Models

### 1. **[Mean-to-Score Discrete Diffusion: Posterior-Mean Denoisers for Score Entropy](https://arxiv.org/abs/2607.21372v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-23
- **作者**: Jingyuan Li, Xiaoyi Jiang, Yixuan Jiang et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出M2S方法优化离散扩散模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过早期探索与剪枝提升推理性能，方法创新且实验扎实

### 3. **[KroQuant: Kronecker-Structured Block Transforms for Efficient Post-Training Quantization of Diffusion Transformers](https://arxiv.org/abs/2607.21446v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Yann Bouquet, Alireza Khodamoradi, Kristof Denolf et al.
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出KroQuant量化方法提升扩散模型推理效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Kronecker结构优化量化，兼顾精度与计算效率。

### 4. **[A Diffusion-Model Subpopulation Digital Twin for Mobile Health Deployment: A Case Study on the HeartSteps Intervention](https://arxiv.org/abs/2607.21403v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Ziping Xu, Yuyi Chang, Chenshun Ni et al.
- **标签**: `cs.LG` `stat.ME`
- **AI摘要**: 提出基于扩散模型的JITAI数字孪生方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且验证充分，对移动健康干预设计有高实用价值

### 5. **[PC-Edit: Prompt-Contrastive Region Discovery and Region-Guided Editing](https://arxiv.org/abs/2607.21318v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Jian Zhang, Zhijun Zhang
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出PC-Edit框架实现无训练图像编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过提示对比实现区域发现与背景保护，方法创新且实验扎实。

## Multimodal

### 1. **[X$^3$-OPD: Distilling Reasoning into Large Audio-Language Models via On-Policy Alignment](https://arxiv.org/abs/2607.21550v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Dongjie Fu, Di Cao, Xize Cheng et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出跨模态在线策略蒸馏框架提升音频推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效弥补音频推理数据短缺。

### 2. **[M$^3$-Gen: Interpretable Multimodal Generation of Gene Expression Profiles Using Clinical and Imaging Data](https://arxiv.org/abs/2607.21343v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Francesca Pia Panaccione, Carlo Sgaravatti, Marco Venere
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出多模态生成框架以合成基因表达谱
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Yingchao Huang, Xin Wang, Yuhan Su et al.
- **标签**: `eess.SP` `cs.LG`
- **AI摘要**: 利用多模态大模型实现认知障碍的精准检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合声学与文本特征，在基准测试中表现优异，具有临床应用潜力。

### 4. **[An Evaluation Framework for Structured Audio Captions Validated by Controlled Perturbations](https://arxiv.org/abs/2607.21424v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Liang-Yuan Wu, Sripathi Sridhar, Mark Cartwright et al.
- **标签**: `cs.CL` `cs.SD`
- **AI摘要**: 提出结构化音频描述评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过受控扰动验证评估框架，方法严谨且具实用价值。

### 5. **[Multimodal Pretraining for Generalizable EEG Representation Learning](https://arxiv.org/abs/2607.21384v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Targol Bakhtiarvand, Jugal Kalita, Adham Atyabi
- **标签**: `cs.AI`
- **AI摘要**: 提出多模态EEG基础模型以提升癫痫检测泛化性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新结合Mamba与ViT架构，实验严谨且性能领先

## Video Generation

### 1. **[SANA-Video 2.0: Hybrid Linear Attention with Attention Residuals for Efficient Video Generation](https://arxiv.org/abs/2607.21553v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-23
- **作者**: Junsong Chen, Jincheng Yu, Yitong Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出混合线性注意力架构，高效生成高质量视频。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新显著提升效率，实验数据详实且极具实用价值。

### 2. **[GraphVid: Interactive Graph-Controllable Video Generation](https://arxiv.org/abs/2607.21580v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Vedant Shah, Onkar Susladkar, Tushar Prakash et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出图结构控制视频生成模型GraphVid
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过图结构实现精准视频控制，指标提升显著，方法创新且实验扎实。

### 3. **[ElasticTTT: Prior-Preserving Test-Time Tuning for Video Editing](https://arxiv.org/abs/2607.21529v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Yueyi Liu, Chi Zhang, Sen Cui et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出ElasticTTT解决视频编辑中的先验坍缩问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且针对性强，实验严谨，具有较高实用价值

### 4. **[Streaming Multi-Agent Autoregressive Diffusion Model with World State Registers](https://arxiv.org/abs/2607.21594v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Sicheng Mo, Yuheng Li, Ziyang Leng et al.
- **标签**: `cs.CV`
- **AI摘要**: 引入世界状态寄存器提升多智能体视频生成一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入寄存器机制，实验充分，逻辑清晰。

## Agent

### 1. **[Scale Up Strategically: Learning Compositional Generalization via Bias-Aware Evaluation and Data Collection for Robotic Manipulation](https://arxiv.org/abs/2607.21582v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Yu Qi, Zhang Ye, Xinyi Xu et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出偏差感知评估与数据采集策略以提升机器人组合泛化能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过量化指令因子偏差并优化数据分布，显著提升了策略的样本效率与泛化性。
...
- **评分理由**: 解决了复杂环境下的训练难题，实验验证充分且实用性强。
...
- **AI摘要**: GS-Agent通过多智能体协作实现物理驱动的4D世界生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入物理引擎闭环，有效提升了4D生成的真实性与可控性。

### 4. **[Agentic Context Management: Solving Agent Memory and Cost by Treating Them as Lifecycle and Architecture Problems](https://arxiv.org/abs/2607.21503v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Gaurav Dadhich
- **标签**: `cs.AI` `cs.IR`
- **AI摘要**: 提出代理上下文管理框架以优化记忆与成本
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统化定义了代理记忆管理，实验验证效果显著且实用性强。

### 5. **[AREX: Towards a Recursively Self-Improving Agent for Deep Research](https://arxiv.org/abs/2607.21461v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Shuqi Lu, Chaofan Li, Kun Luo et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出递归自改进深度研究智能体AREX
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过验证反馈机制显著提升长程研究任务性能

## Distributed Computing

### 1. **[Controlled Periodic Synchronization for Efficient Data-Parallel Training](https://arxiv.org/abs/2607.21224v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-23
- **作者**: Imane Ettifouri, Mostapha Zbakh, Claude Tadonki
- **标签**: `cs.DC`
- **AI摘要**: 提出CPDP策略优化分布式训练通信效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过周期性同步平衡了通信延迟与模型收敛精度

### 2. **[Animation, Verification and Visualisation of Prolog Transition Systems with ProB](https://arxiv.org/abs/2607.21192v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-23
- **作者**: Jan Gruteser, Michael Leuschel, Katharina Engels et al.
- **标签**: `cs.LO` `cs.AI` `cs.GT`
- **AI摘要**: ProB增强了Prolog转换系统的动画与验证功能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该工作有效扩展了形式化验证工具，实用性强且逻辑清晰。

### 3. **[Declarative Problem Solving in UAM Strategic Deconfliction](https://arxiv.org/abs/2607.21197v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-07-23
- **作者**: Gioacchino Sterlicchio, Angelo Oddi, Riccardo Rasconi et al.
- **标签**: `cs.LO` `cs.AI`
- **AI摘要**: 利用ASP实现城市空中交通战略冲突消解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且对比详实，但在大规模场景扩展性上仍有提升空间。

### 4. **[Encoding Event-B Proof Rules in Prolog: An Interactive Sequent Prover for ProB](https://arxiv.org/abs/2607.21191v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-07-23
- **作者**: Katharina Engels, Jan Gruteser, Michael Leuschel
- **标签**: `cs.LO` `cs.AI` `cs.SE`
- **AI摘要**: 基于Prolog实现Event-B交互式证明器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Prolog编码证明规则，提升了可维护性与教学交互性。

### 5. **[GLP: A Grassroots, Multiagent, Concurrent, Logic Programming Language for AI](https://arxiv.org/abs/2607.21189v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-07-23
- **作者**: Ehud Shapiro
- **标签**: `cs.PL` `cs.DC` `cs.LO`
- **AI摘要**: 提出一种支持草根平台的并发逻辑编程语言GLP
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，形式化严谨，但应用场景尚待验证。

## Information Retrieval

### 1. **[Finite-Sample Coverage Audits for High-Recall Candidate Generation: Certification and Learning-Theoretic Design](https://arxiv.org/abs/2607.21480v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Martin Anthony, Kaveh Salehzadeh Nobari
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出候选集漏检率的有限样本审计与认证框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具有极高实用价值，解决了漏检评估难题。

### 2. **[Diffusion Language Model for Recommendation](https://arxiv.org/abs/2607.21519v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Chengyi Liu, Yongqi Zhou, Junwei Pan et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出DLMRec模型，用扩散模型优化推荐生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入扩散模型解决自回归推荐的局限，方法严谨。

### 3. **[From Static Bibliometrics to Dynamic Knowledge Graphs: An LLM-Powered Framework for Modernizing Science, Technology, and Innovation (STI) Analytics](https://arxiv.org/abs/2607.21327v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Muhsen Hammoud
- **标签**: `cs.DL` `cs.AI`
- **AI摘要**: 提出融合知识图谱与LLM的STI分析框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且逻辑严密，有效提升了科研分析的深度与准确性。

### 4. **[Can Generative Recommendation Reach Cold Items? A Temporal Perspective on Semantic-ID Generation](https://arxiv.org/abs/2607.21101v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Jie Peng, Yanping Zheng, Zhewei Zhe et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示生成式推荐在冷启动下的局限性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入分析SID生成机制，实验严谨且见解深刻。

### 5. **[SHIFT: Self-reconstruction Harnesses Implicit Fine-grained Thinking for Retrieval](https://arxiv.org/abs/2607.21333v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-23
- **作者**: Yuxiao Luo, Da Li, Mingjie Zhang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出SHIFT框架提升LLM检索推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过重构机制解决检索与生成目标不匹配问题，实验效果显著。

## Computer Vision

### 1. **[Flash EQ-Linear: Accelerating Equivariant Linear Layers via Group-wise Discrete Fourier Transform](https://arxiv.org/abs/2607.21271v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-23
- **作者**: Zhongchen Zhao, Jixin Wang, Qi Xie et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Flash EQ-Linear加速等变线性层
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过DFT优化等变网络计算，显著提升推理速度与效率。
...
- **评分理由**: 填补未来几何预测评估空白，方法严谨且具有高实用价值。
...
- **评分理由**: 通过蒸馏技术解决多源异构数据联合训练难题，创新性强。

### 4. **[Scene Parameter Saliency via Differentiable Light Transport](https://arxiv.org/abs/2607.21562v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Linas Beresna, Eugene Fiume
- **标签**: `cs.CV` `cs.GR`
- **AI摘要**: 利用可微渲染实现场景参数显著性分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入梯度场分析光传输，方法严谨且应用广泛。

### 5. **[GrainGS: Gradient-Decoupled Gaussian Splatting for Efficient Dynamic Novel View Synthesis](https://arxiv.org/abs/2607.21448v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Jiahao He, Yihua Shao, Zhengkai Zhao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GrainGS实现高效动态场景重建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过梯度解耦与锚点机制平衡了动态建模与存储效率

## Machine Learning

### 1. **[Cycle-Consistent and Uncertainty-Aware Neural Surrogates for Tokamak Edge Plasmas](https://arxiv.org/abs/2607.21407v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-23
- **作者**: Abdourahmane Diaw, Sebastian De Pascuale, Jae-Sun Park et al.
- **标签**: `physics.comp-ph` `cs.AI` `physics.plasm-ph`
- **AI摘要**: 提出托卡马克边缘等离子体循环一致性神经代理模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，显著提升了物理模拟的计算效率。

### 2. **[Expanding Flow Maps](https://arxiv.org/abs/2607.21585v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Sophia Tang, Pranam Chatterjee
- **标签**: `cs.LG`
- **AI摘要**: 提出可变维度的生成流模型EFlows
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入维度扩展机制，理论框架严谨且通用

### 3. **[Barzilai-Borwein Fails Superlinear Convergence on an Open Set of Quadratics for Every Dimension $n\geq 4$](https://arxiv.org/abs/2607.21579v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Dawei Li, Xiaotian Jiang, Mingyi Hong
- **标签**: `math.OC` `cs.AI` `cs.LG`
- **AI摘要**: 证明BB方法在二次优化中不具备超线性收敛性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过计算机辅助证明揭示了BB算法的收敛局限，理论严谨且具有重要意义。

### 4. **[The Boundaries of Automation: A Theory of Persistent Human Participation](https://arxiv.org/abs/2607.21547v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Fares Fourati, Hinrich Schütze, Eyke Hüllermeier et al.
- **标签**: `cs.AI` `cs.CL` `cs.ET`
- **AI摘要**: 提出人类参与AI的持久性理论
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论视角独特，深刻阐述了人机协作的本质局限。

### 5. **[Climate-resilient electric vehicle charging infrastructure for sustainable cities: An interpretable causal-ensemble framework for preventive maintenance and low-carbon mobility](https://arxiv.org/abs/2607.21444v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Cande Lian, Wentao Zeng, Jiabin Wu et al.
- **标签**: `math.OC` `cs.LG`
- **AI摘要**: 提出FGDSE框架实现充电桩气候韧性预测与维护
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型创新性强，结合因果推理与集成学习，实验严谨且实用价值高。
