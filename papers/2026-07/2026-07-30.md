...
### 1. **[OptimismBench: Forecasting Bias and the Alignment Effect in Language Model Judgment](https://arxiv.org/abs/2607.26981v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-29
- **作者**: Seonglae Cho, Adriano Koshiyama
- **标签**: `cs.CL`
- **AI摘要**: 提出OptimismBench评估大模型概率判断的乐观偏差。
<details>
...
- **评分理由**: 方法创新且实验严谨，揭示了对齐对模型判断的影响。

### 2. **[Constitutional Midtraining: Content Presence Drives Alignment Gains](https://arxiv.org/abs/2607.26654v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-29
- **作者**: Desiree Cho, Cameron Tice, Bernie Hogan et al.
- **标签**: `cs.CL` `cs.AI` `cs.CY`
- **AI摘要**: 提出宪法预训练以增强模型对齐持久性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了对齐的鲁棒性。

### 3. **[Linguistic Monoculture in LLM-Assisted Language Use](https://arxiv.org/abs/2607.27134v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Suhas Thejaswi, Juhi Kulshreshta, Lutz Oettershagen
- **标签**: `cs.AI` `cs.CL` `cs.GT`
- **AI摘要**: 揭示LLM导致语言同质化的数学机制与社会影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过数学建模分析LLM对语言多样性的影响，理论严谨且视角新颖。
...
- **评分理由**: 提出GPU原生KV注入技术，显著提升推理效率与吞吐量。

### 5. **[HoF-Bench: Rediscovering Real AI-Discovered CVEs Without Frontier Models](https://arxiv.org/abs/2607.27030v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Petr Simecek, Elnaz Babayeva, Jiri Balhar et al.
- **标签**: `cs.CR` `cs.LG`
- **AI摘要**: 提出HoF-Bench基准以评估LLM发现CVE的能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨的基准测试量化了LLM在漏洞检测中的实际效能。

## Natural Language Processing

### 1. **[Generation or Judgement? A Paradigm Perspective on LLM-Based Emotion-Cause Pair Extraction in Conversation](https://arxiv.org/abs/2607.26967v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Weijie Feng, Hongchuang Wang, Binbin Liu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出判别式范式提升对话情感因果对提取性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对比生成与判别范式揭示了LLM局限并提出有效优化策略

### 2. **[Credit Cards, Confusion, Computation, and Consequences: What Can We Uncover About Language Model Reasoning?](https://arxiv.org/abs/2607.26952v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Arnav Hiray, Agam Shah, Caleb Lu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出金融领域数值推理基准CreditCardQA
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建扎实，对LLM金融推理能力评估有参考价值

### 3. **[DIRECT: Direct Decoding for Efficient and Aligned Sequence Labeling with Large Language Models](https://arxiv.org/abs/2607.26891v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Yilei Wang, Jiaxin Gan, Kexuan Zhang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出DIRECT框架提升序列标注的效率与对齐能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过DPO与KV缓存优化，在序列标注任务上实现了性能与效率的平衡。

### 4. **[When Does Span-Guided Detoxification Help? Human Preferences and Evaluator Diagnostics in a Controlled Comparison](https://arxiv.org/abs/2607.26795v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Kyungwon Park
- **标签**: `cs.CL`
- **AI摘要**: 对比跨度引导与非引导去毒策略的优劣
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，揭示了去毒策略在不同场景下的权衡。

### 5. **[AtmosERC: Modeling Dialogue-Level Affective Atmosphere for Emotion Recognition in Conversation](https://arxiv.org/abs/2607.26726v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Weijie Feng, Tongwei Zhang, Binbin Liu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出AtmosERC模型建模对话情感氛围以提升ERC性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入情感氛围建模，实验充分且具有实际应用价值。

## Vision Language Models

### 1. **[Hearsay: Vision-Language Medical Diagnoses Without an Image](https://arxiv.org/abs/2607.26886v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-29
- **作者**: Siddharth Vohra
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 揭示多模态模型在无图时产生偏见诊断的幻觉问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了模型在医疗诊断中的结构性偏见，方法严谨且具有重要临床警示意义。

### 2. **[TurboVLA: Real-Time Vision-Language-Action Model at 32 Hz on an RTX 4090 with <1 GB VRAM](https://arxiv.org/abs/2607.27205v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Hengyi Xie, Chenfei Yao, Xianjin Wu et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出轻量级VLA架构，实现高效机器人控制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新显著提升了推理效率，实验验证充分。

### 3. **[HumanCLAW: Can Vision-Language Models Act Through a Body?](https://arxiv.org/abs/2607.27180v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Siyao Li, Jiawei Gu, Shuai Liu et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出HumanCLAW框架以解耦VLM决策与运动控制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦决策与执行，有效量化了VLM的具身智能水平。

### 4. **[Anatomy Contextualized Adaption of CT Foundation Models](https://arxiv.org/abs/2607.27154v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Roshan Kenia, Stephanie L McNamara, William Lotter
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出ACA框架实现CT影像解剖级对齐与全局上下文融合。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且高效，实验详实，在医学影像领域具有较强实用价值。

### 5. **[Visual Credit Audit for Multimodal Spatial Reasoning](https://arxiv.org/abs/2607.27069v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Feixiang Liu, Qiang Qiu, Lanbo Sun et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出视觉信用审计框架以评估多模态空间推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且严谨，有效揭示了模型对视觉信息的依赖程度。

## Diffusion Models

### 1. **[Dual Inversion for Text-to-Image Diffusion Models: From Both Prompt and Noise Perspectives](https://arxiv.org/abs/2607.26735v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Xiaolong Liu, Junjian Li, Yuan Xiao et al.
- **标签**: `cs.CV` `cs.AI` `cs.MM`
- **AI摘要**: 提出双重反演方法实现精准图像重建与编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合提示词与噪声反演，显著提升了图像生成保真度。

### 2. **[FARI: Robust One-Step Inversion for Watermarking in Diffusion Models](https://arxiv.org/abs/2607.26723v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Jindong Yang, Han Fang, Weiming Zhang et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出FARI实现扩散模型快速鲁棒水印反演
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过单步反演与对抗微调提升了水印鲁棒性与效率

### 3. **[FreeShadow: Training-Free Shadow Removal via Illumination Transfer and Selective Content Preservation in Diffusion Models](https://arxiv.org/abs/2607.26715v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Yinan Wang, Yan Huang, Yong Xu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出无需训练的扩散模型去影方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且无需优化，实验效果扎实。

### 4. **[Anchoring and Steering Diffusion: Enhancing the Faithfulness of Text-to-Image Generation at Inference Time](https://arxiv.org/abs/2607.26647v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Xinyi Wang, Yuyang Huang, Yalin Su et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出AnchorSteer框架提升文生图对齐度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过语义锚定与反射式引导优化生成过程，方法创新且实验扎实。

## Multimodal

### 1. **[SciFigQual-Bench: A Benchmark for Scientific Figure Quality Assessment with Full-Manuscript Context](https://arxiv.org/abs/2607.27084v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Zihan Deng, Chuanzhi Xu, Huiqi Liang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出科学图表质量评估基准SciFigQual-Bench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了高质量多模态基准，评估维度全面且实验严谨。

### 2. **[SciFigAlign: Scoring Scientific Figures by Fine-tuned Alignment of Visuals with Manuscript Evidence](https://arxiv.org/abs/2607.27066v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Chuanzhi Xu, Zihan Deng, Huiqi Liang et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出SciFigAlign评估科研图表质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多模态对齐有效提升了科研图表评估的准确性与实用价值。

### 3. **[What Can Latent World Models Know? Physical Parameter Identifiability in Multimodal Predictive Representations](https://arxiv.org/abs/2607.27017v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Kaizhen Tan, Xin Xu, Siru Tao et al.
- **标签**: `cs.LG` `cs.RO`
- **AI摘要**: 探究潜空间世界模型对物理参数的表征能力与机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过受控实验揭示了预测目标对物理参数获取的影响

### 4. **[Zero-Shot Face-to-Speech Synthesis via Latent Space Adaptation of a Style-Diffusion TTS Model](https://arxiv.org/abs/2607.26742v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Carlos Muñoz-Romero, Jose A. Gonzalez-Lopez
- **标签**: `eess.AS` `cs.AI` `cs.SD`
- **AI摘要**: 提出一种基于人脸图像的零样本语音合成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且效果显著，实验设计严谨，具备跨语言潜力

### 5. **[MMAC: A Massive Multi-dimensional Benchmark for Audio Captioning](https://arxiv.org/abs/2607.27109v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Weijie Wu, Junbo Li, Lin Li et al.
- **标签**: `cs.SD` `cs.AI`
- **AI摘要**: 提出音频描述的多维度基准测试集MMAC
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了全面且细粒度的音频评估框架，具有较高实用价值

## Image Generation

### 1. **[Amortized Moment Matching for Visual Generation](https://arxiv.org/abs/2607.26860v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-29
- **作者**: Wenze Liu, Xintao Wang, Pengfei Wan et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出摊销矩匹配框架以优化扩散模型生成质量
<details>
<summary>原始摘要</summary>
...
### 1. **[Mitigating Compounding Error via Video Representation Regularization](https://arxiv.org/abs/2607.27036v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
...
- **评分理由**: 揭示了表征坍缩机制并提出有效正则化，实验扎实。

### 2. **[Ripple: Real-Time Streaming Audio-Video Generation With Cross-Modal Recurrent Memory](https://arxiv.org/abs/2607.26818v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Yanbo Ding, Zhizhi Guo, Quanyue Song et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Ripple实现实时音视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过循环记忆机制显著提升了实时生成效率与长时一致性。

### 3. **[DistillAlign: Coordinating Mode Covering and Mode Seeking in Autoregressive Video Distillation](https://arxiv.org/abs/2607.26811v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Jiaxing Li, Kai Zou, Cindy Zhou et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出联合蒸馏策略优化视频生成分布对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分布视角解决模式坍塌，方法论严谨且效果显著。

### 4. **[TPD: Temporal Prior Decoupling for Text-to-Video Diffusion Models](https://arxiv.org/abs/2607.26706v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Taewon Kang, Matthias Zwicker
- **标签**: `cs.CV`
- **AI摘要**: 提出TPD方法解决视频生成中后期事件抑制问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决时序抑制难题，方法无需训练且通用性强

### 5. **[Visko Orbis 1.0: A Live Model for Real-Time Interactive Long Video Generation](https://arxiv.org/abs/2607.26694v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
...
- **评分理由**: 创新性提出流式生成架构，性能与稳定性表现优异。

## Agent

### 1. **[TREK: A Travel Reasoning and Evaluation Kit for LLM Agents in Complex Trip Planning](https://arxiv.org/abs/2607.26977v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-29
- **作者**: Jinhu Qi, Wentao Zhang, Siu Man Ng et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出TREK基准以评估LLM智能体旅行规划能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过确定性评估机制解决了智能体规划任务的验证难题。

### 2. **[What Does It Take to Detect an AI Agent? Minimal Feature Sets for Behavioral Detection under Browser Automation](https://arxiv.org/abs/2607.26935v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-29
- **作者**: Vishisht Choudhary, Lukas Schmidt, Anne Zoë Kenntner et al.
- **标签**: `cs.AI` `cs.CR`
- **AI摘要**: 提出三分类框架有效识别AI代理行为
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将心理状态纳入世界模型，实验设计严谨且具有启发性。

### 4. **[Can AI agents conduct open-ended AI research? Early evidence from two case studies](https://arxiv.org/abs/2607.27191v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Peter Kirgis, Sayash Kapoor, Andrew Schwartz et al.
- **标签**: `cs.AI` `cs.CY` `cs.LG`
- **AI摘要**: 评估AI智能体在开放式科研中的表现与局限性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过影子评估揭示了AI在科研创新与决策上的瓶颈

### 5. **[MindForge: Teaching Small Language Models Whole-Life-Cycle Software Engineering via Source-Free Program Synthesis](https://arxiv.org/abs/2607.27146v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Yihao Chen, Shi Chang, Khaled Chawa et al.
- **标签**: `cs.SE` `cs.CL` `cs.LG`
- **AI摘要**: 提出MindForge框架提升小模型全生命周期软件工程能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过自动化流水线构建训练环境，显著提升了模型代码生成与工程任务表现。

## Distributed Computing

### 1. **[Hybrid Workflow Composition for Extreme-Scale Data Processing: A Case Study on the HL-LHC (Extended Version)](https://arxiv.org/abs/2607.26877v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Alan Malta Rodrigues, Douglas Thain
- **标签**: `cs.DC` `cs.SE`
- **AI摘要**: 提出混合工作流组合策略提升大规模数据处理效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过模拟框架优化任务粒度，显著提升吞吐量并降低开销。

### 2. **[Stable and Budget-Feasible Coalition Formation for Clustered Federated Learning: A Hedonic Potential-Game Approach](https://arxiv.org/abs/2607.26788v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Cengis Hasan
- **标签**: `cs.GT` `cs.LG`
- **AI摘要**: 提出联邦学习联盟博弈框架
...
- **评分理由**: 理论严谨且具备实际应用价值，创新性较强。

### 3. **[FedWeave: Rethinking the Unit of Specialization in Heterogeneous Federated MoE-LoRA](https://arxiv.org/abs/2607.26618v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Donghang Duan, Xu Zheng, Lizong Zhang et al.
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出FedWeave实现联邦MoE-LoRA高效异构聚合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地分离专家与路由聚合，理论与实验扎实。

### 4. **[Field Codes for Distributed Coupling Samplers and Certified Empirical Transport](https://arxiv.org/abs/2607.27078v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Hung Mai, Hai Nguyen, Luong Doan et al.
- **标签**: `cs.CC` `cs.IT` `cs.LG`
- **AI摘要**: 提出分布式最优传输的场编码编译框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具创新性，但应用场景较为垂直。

### 5. **[Defending Against Backdoor Attacks via Alignment Checking in Model-Contrastive Federated Learning](https://arxiv.org/abs/2607.26933v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Hongliang Zhang, Zhongyuan Yu, Guijuan Wang et al.
- **标签**: `cs.CR` `cs.AI` `cs.LG`
- **AI摘要**: 提出FedDAB防御联邦学习后门攻击
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.OS`
- **AI摘要**: 提出EDF调度器的演绎验证框架并应用于主流RTOS。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且具有实际工程价值，验证了多种主流系统。

## Information Retrieval

### 1. **[DenseOn with the LateOn: Fully Open Dense and Late-Interaction Models for Multilingual, Long-Context, and Code Search](https://arxiv.org/abs/2607.27178v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Raphaël Sourty, Antoine Chaffin, Paulo Roberto Moura Junior et al.
- **标签**: `cs.CL` `cs.IR`
- **AI摘要**: 提出开源检索模型DenseOn与LateOn
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 开源了高质量检索模型与训练配方，实验严谨且性能优异。

### 2. **[Improving Item Discoverability in e-Commerce Search via Related Intent Generation](https://arxiv.org/abs/2607.27172v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Ji Xin, Xiao Xiao, Ishan Bhatt et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 提出意图驱动的检索扩展系统以提升电商发现力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏技术实现高效检索，兼顾性能与成本。

### 3. **[WhisperRec: Latent Reasoning for Efficient Foundation Recommendation Models](https://arxiv.org/abs/2607.26621v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Hao Jiang, Peiru Du, Pengfei Yao et al.
- **标签**: `cs.IR` `cs.AI`
- **AI摘要**: 提出WhisperRec通过隐空间推理提升推荐效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决LLM推荐推理延迟问题，实验扎实且效果显著。

### 4. **[KAMR: Grounding Generation via Knowledge-Aligned Multi-hop Retrieval](https://arxiv.org/abs/2607.27136v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Xiaochen Wang, Yuan Zhong, Haoyu Wang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出KAMR提升多跳知识图谱检索效果
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对齐监督与局部扩展优化了多跳检索，实验扎实。

### 5. **[Learning from the Future: Privileged Self-Distillation for Sequential Recommendation](https://arxiv.org/abs/2607.27055v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-29
- **作者**: Jiakai Tang, Yang Zhang, See-Kiong Ng et al.
- **标签**: `cs.IR`
- **AI摘要**: 利用未来交互信息提升序列推荐性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过特权蒸馏利用未来信息，方法创新且实验扎实。

## Computer Vision

### 1. **[VidMap: Exploiting Temporal Structure for Video-Based Structure-from-Motion](https://arxiv.org/abs/2607.27194v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Zador Pataki, Paul-Edouard Sarlin, Marc Pollefeys
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 结合SLAM与SfM优势实现视频三维重建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过时序约束与全局优化提升了重建的鲁棒性与精度

### 2. **[From Passive Video to Editable Experience: Physically Grounded Experience Synthesis for Embodied Intelligence](https://arxiv.org/abs/2607.26903v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Jia Luo
- **标签**: `cs.AI` `cs.RO`
- **AI摘要**: 提出Pegasus框架实现人机动作迁移
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过图结构与物理验证桥接具身智能数据鸿沟，方法创新且严谨。

### 3. **[Conformalized Rate-Adaptive Sensing](https://arxiv.org/abs/2607.26887v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Jiawei Yang, Yao Zhang
- **标签**: `stat.ML` `cs.LG` `stat.AP`
- **AI摘要**: 提出自适应采样率的图像重建方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合共形预测实现高效且可控的采样决策，方法严谨且实用。

### 4. **[BATS: Resource-Efficient Volumetric Segmentation with Boundary-Aware Mixed-Resolution Tokens](https://arxiv.org/abs/2607.26829v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: David Hagerman, Roman Naeem, Fredrik Kahl
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出边界感知混合分辨率令牌机制以优化3D医学图像分割效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过稀疏化处理显著降低显存占用，实验验证充分且效果优异。

### 5. **[From Uncertainty to Determinism: Coarse-to-Fine Visual Floorplan Localization without Ray Matching](https://arxiv.org/abs/2607.26817v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Shiyong Meng, Bolei Chen, Ping Zhong et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出基于扩散模型的室内定位框架，无需射线匹配。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地引入扩散模型解决多模态定位歧义，实验扎实。

## Machine Learning

### 1. **[Cost-Sensitive Conformal Prediction and Human-in-the-Loop Abstention for Imbalanced High-Stakes Decision Support: A Multi-Domain Benchmark](https://arxiv.org/abs/2607.27143v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-29
- **作者**: Manpreet Singh, Akshatha Srikantha, Shyamal Lakhanpal
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出代价敏感的保形预测框架，提升不平衡数据下的决策可靠性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验规模宏大，针对高风险决策场景的改进具有显著的实用价值与严谨性。

### 2. **[TreeCCA: Canonical Correlation Analysis via Gradient-Boosted Trees](https://arxiv.org/abs/2607.27027v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-29
- **作者**: James Chapman
- **标签**: `cs.LG`
- **AI摘要**: 提出TreeCCA，用梯度提升树实现CCA。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，将树模型引入CCA并保持可解释性。

### 3. **[When Do Learned Diffusion Proposals Help Constraint Solving? A Controlled Study on Continuous Algebraic Systems](https://arxiv.org/abs/2607.27169v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Quang Bui, Sparsh Roy, Akash Gundimeda et al.
- **标签**: `cs.LG`
- **AI摘要**: 揭示扩散模型在代数约束求解中的适用边界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨对照实验界定学习型提案的真实效能

### 4. **[Skillful forecasting of offshore winds from satellite scatterometer constellations](https://arxiv.org/abs/2607.27152v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Francesco Pinto, Luca Lanzilao, Paco Lopez Dekker et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出WindCastNet实现卫星风场短临预报
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入卫星散射计数据，显著提升海上风电预报精度。

### 5. **[Hierarchical Spatio-Temporal Transformer for Coherent Emergency Department Forecasting](https://arxiv.org/abs/2607.27106v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-29
- **作者**: Filipa Lino, Bárbara Tavares, Carlos Santiago et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出分层Transformer实现急诊需求预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型架构创新且实验严谨，有效解决了多层级预测一致性问题。
