...
### 1. **[Ask the Right Comparison:Bias-Aware Bayesian Active Top-$k$ Ranking with LLM Judges](https://arxiv.org/abs/2607.02104v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-02
- **作者**: Jian Xu, Delu Zeng, John Paisley et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出偏差感知贝叶斯主动学习框架，提升LLM评测准确度。
<details>
...
- **评分理由**: 方法创新且实用，实验严谨，有效解决了LLM评测中的偏差问题。

### 2. **[Behind the Refusal: Determining Guardrail Activation via Behavioral Monitoring](https://arxiv.org/abs/2607.02121v1)**
...
### 3. **[LACUNA: A Testbed for Evaluating Localization Precision for LLM Unlearning](https://arxiv.org/abs/2607.02513v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Matteo Boglioni, Thibault Rousset, Siva Reddy et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出LACUNA基准以评估LLM去学习的参数定位精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过注入合成数据实现参数级定位，评估方法严谨且具高实用价值。

### 4. **[Program-as-Weights: A Programming Paradigm for Fuzzy Functions](https://arxiv.org/abs/2607.02512v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Wentao Zhang, Liliana Hotsko, Woojeong Kim et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出PAW范式，将自然语言编译为轻量级神经权重。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过权重编译显著降低推理成本，实验扎实。

### 5. **[DemoPSD: Disagreement-Modulated Policy Self-Distillation](https://arxiv.org/abs/2607.02502v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Yunhe Li, Hao Shi, Wenhao Liu et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出DemoPSD框架，通过差异调制实现自蒸馏以缓解信息泄露。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论扎实，实验对比充分，有效提升了模型泛化能力。

## Natural Language Processing

### 1. **[HaloGuard 1.0: An Open Weights Constitutional Classifier for Multilingual AI Safety](https://arxiv.org/abs/2607.02079v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-02
...
- **评分理由**: 模型轻量且性能优异，方法论严谨且具备高实用性。

### 2. **[The Future of NLP may not be at NLP Conferences: Scholarly Migration Patterns in Natural Language Processing](https://arxiv.org/abs/2607.02416v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: David Jurgens
- **标签**: `cs.CL`
- **AI摘要**: 分析NLP研究向通用机器学习会议迁移的趋势
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实证分析揭示了NLP学术发表的范式转移，方法严谨且具有洞察力。

### 3. **[OntoLearner: A Modular Python Library for Ontology Learning with Large Language Models](https://arxiv.org/abs/2607.01977v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Hamed Babaei Giglou, Jennifer D'Souza, Andrei Aioanei et al.
- **标签**: `cs.AI`
- **AI摘要**: OntoLearner框架统一本体学习评估与基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提供了首个本体学习评估框架，实验严谨且具有高实用价值。

### 4. **[Language Models as Measurement Apparatus for Culture](https://arxiv.org/abs/2607.02459v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Kent K. Chang
- **标签**: `cs.CL`
- **AI摘要**: 探讨大模型作为测量文化现象的工具及其方法论局限。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论视角独特且严谨，对NLP文化研究有深刻反思。

### 5. **[On the Role of Directionality in Structural Generalization](https://arxiv.org/abs/2607.02307v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Zichao Wei
- **标签**: `cs.CL` `cs.LG`
- **AI摘要**: 引入CCG定向类型提升结构化泛化能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入方向性提升了句法解析的结构泛化性能

## Vision Language Models

### 1. **[DeepGaze3.5-VL: Modeling Scanpaths via Autoregressive Token Prediction](https://arxiv.org/abs/2607.02083v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-02
- **作者**: Susmit Agrawal, Matthias Bethge, Matthias Kümmerer
- **标签**: `cs.CV`
- **AI摘要**: 基于VLMs的自回归扫描路径预测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过离散化坐标实现扫描路径建模，性能显著优于传统方法

### 2. **[Towards Robustness against Typographic Attack with Training-free Concept Localization](https://arxiv.org/abs/2607.02494v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Bohan Liu, Wenqian Ye, Guangzhi Xiong et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出无需训练的机制解释方法以防御视觉排版攻击
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过电路挖掘定位并干预CLIP视觉编码器，有效提升鲁棒性，方法创新且实验扎实。

### 3. **[EAGLE-360: Embodied Active Global-to-Local Exploration in 360$^\circ$](https://arxiv.org/abs/2607.02479v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Jingtao Xu, Zizhuo Lin, Jianwen Sun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出EAGLE-360框架实现全景主动视觉搜索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决全景畸变与探索效率问题，实验扎实。

### 4. **[LIME: Learning Intent-aware Camera Motion from Egocentric Video](https://arxiv.org/abs/2607.02417v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Boyang Sun, Jiajie Li, Yung-Hsu Yang et al.
- **标签**: `cs.RO` `cs.CV` `cs.LG`
- **AI摘要**: 提出LIME模型实现意图驱动的相机运动控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将被动视频转化为主动感知训练，方法严谨且实用。

### 5. **[The Moving Eye: Enhancing VLA Spatial Generalization via Hybrid Dynamic Data Collection](https://arxiv.org/abs/2607.02322v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Jincheng Tang, Yilong Zhu, Zhengyuan Xie et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出混合动态数据策略以提升VLA空间泛化能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过双臂协同解决VLA空间捷径学习问题，方法创新且实验扎实。
...
- **评分理由**: 创新性强，解决了扩散模型推理成本高的问题

### 2. **[ART for Diffusion Sampling: Continuous-Time Control and Actor-Critic Learning](https://arxiv.org/abs/2607.02137v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Yilie Huang, Wenpin Tang, Xun Yu Zhou
- **标签**: `cs.LG` `cs.AI` `eess.SY`
- **AI摘要**: 提出ART框架优化扩散采样时间步分配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过控制理论与强化学习优化采样效率，理论扎实且通用性强。

### 3. **[Training-free Controllable Human Motion Generation under Heterogeneous Constraints](https://arxiv.org/abs/2607.01990v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Xiaofei Hui, Bo Yan, Haoxuan Qu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出MIC框架实现无训练动作生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 将扩散模型建模为随机控制问题，创新性强且实验扎实。

### 4. **[From SRA to Self-Flow: Data Augmentation or Self-Supervision?](https://arxiv.org/abs/2607.02508v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Dengyang Jiang, Mengmeng Wang, Harry Yang et al.
- **标签**: `cs.CV`
- **AI摘要**: 揭示Self-Flow增益源于数据增强而非跨噪声交互
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过注意力分离实验解构了机制，结论具有启发性。

### 5. **[Hierarchical Anti-Aesthetics: Protecting Facial Privacy against Customized Diffusion Models](https://arxiv.org/abs/2607.02038v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Songping Wang, Yueming Lyu, Shiqi Liu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出分层反美学框架以保护人脸隐私
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多尺度美学扰动有效降低定制化模型的人脸泄露风险

## Multimodal

### 1. **[EduArt: An educational-level benchmark for evaluating art history knowledge in large language models](https://arxiv.org/abs/2607.02007v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-02
- **作者**: Gianmarco Spinaci, Lukas Klic, Giovanni Colavizza
- **标签**: `cs.CL` `cs.CV`
- **AI摘要**: 提出EduArt基准以评估多模态大模型艺术史知识。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨，揭示了模型在不同评估格式下的能力差异。

### 2. **[SelectTSL: Prompt-Guided Selective Target Sound Localization in Complex Scenarios](https://arxiv.org/abs/2607.02343v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Ziyang Jiang, Yu Chen, Zexu Pan et al.
- **标签**: `cs.SD` `cs.AI`
- **AI摘要**: 提出SelectTSL实现复杂场景下的目标声源定位
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合提示引导与相位增强，有效提升了选择性定位精度

### 3. **[Hidden Forgetting in Continual Multimodal Learning: When Accuracy Survives but Grounding Fails](https://arxiv.org/abs/2607.02020v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Qianyu Chen, Canran Xiao, Runxuan Tang
- **标签**: `cs.AI`
- **AI摘要**: 提出RCL框架解决多模态持续学习中的证据遗忘问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地揭示了证据路径遗忘现象，方法论严谨且实用。

### 4. **[InduceKV: Fixed-Footprint Continual Adaptation of Multimodal LLMs via Inducing KV Memories](https://arxiv.org/abs/2607.02010v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Qianyu Chen, Ziteng Feng, Canran Xiao et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出InduceKV实现多模态模型持续学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决固定内存下的适应问题。

### 5. **[Multimodal Knowledge Edit-Scoped Generalization for Online Recursive MLLM Editing](https://arxiv.org/abs/2607.01978v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Siyuan Li, Youyuan Zhang, Ruitong Liu et al.
- **标签**: `cs.AI` `cs.CL` `cs.CV`
- **AI摘要**: 提出ScopeEdit实现多模态模型的高效精准知识编辑
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，有效解决了多模态编辑的泛化边界问题

## Image Generation

### 1. **[Representation Distribution Matching for One-Step Visual Generation](https://arxiv.org/abs/2607.02375v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Lan Feng, Wuyang Li, Eloi Zablocki et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出RDM框架实现高效单步图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集规模大且填补了学术领域视觉生成的空白

### 3. **[DetailAnywhere: Fashion Detail Generation via Cross-Modal Feature Alignment Distillation](https://arxiv.org/abs/2607.02220v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Zijun Li, Yimin Zhou, Jia Sun et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出服装细节生成任务及CFAD框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 定义新任务并引入跨模态对齐蒸馏，实验扎实且应用价值高。

### 4. **[Optimizing Visual Generative Models via Distribution-wise Rewards](https://arxiv.org/abs/2607.02291v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Ruihang Li, Mengde Xu, Shuyang Gu et al.
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出分布级奖励优化视觉生成模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分布级奖励解决奖励黑客问题，实验效果显著且方法创新。

### 5. **[Wavelet-Guided Semantic Signal Compensation for Inversion-Free Image Editing](https://arxiv.org/abs/2607.02421v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-02
- **作者**: Anqi Tang, Wenhao Sun, Zhaoqiang Liu
- **标签**: `cs.CV`
- **AI摘要**: 提出小波引导补偿提升图像编辑效果
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过LLM协调轨迹与视觉生成，有效解决了动态物体持久性问题。

### 2. **[HandsOnWorld: Unconstrained Egocentric Video Generation with Camera-Disentangled Hand Control](https://arxiv.org/abs/2607.02075v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Yushuo Chen, Xiaoyu Shi, Xiaoshi Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出解耦相机手部运动的视频生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过单目视频构建数据集并实现精准手部控制，创新性强。
...
- **评分理由**: 研究视角新颖，实验设计严谨，对AI安全有重要参考价值
...
- **标签**: `cs.RO` `cs.CV` `cs.OS`
- **AI摘要**: 面向具身智能的便携式C++推理运行时
<details>
<summary>原始摘要</summary>
...
- **AI摘要**: 提出首个测试与代码协同演化基准TestEvo-Bench
<details>
<summary>原始摘要</summary>
...
- **标签**: `cs.DC`
- **AI摘要**: 提出Cadence协议实现极高流水线与多提议者共识
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决多提议者共识中的审查与隐藏问题，理论与实验扎实。

### 2. **[Towards Load-Aware Prefill Deflection for Disaggregated LLM Serving](https://arxiv.org/abs/2607.02043v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Shrikara Arun, Anjaly Parayil, Srikant Bharadwaj et al.
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 提出负载感知预填充卸载调度，优化LLM推理延迟。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对解耦推理架构的瓶颈提出创新调度，实验详实且提升显著。

### 3. **[QFedAgent: Quantum-Enhanced Personalized Federated Learning for Multi-Agent Activity Recognition](https://arxiv.org/abs/2607.02426v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Quoc Bao Phan, Tuy Tan Nguyen
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出量子增强联邦学习框架以优化多智能体活动识别
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过量子电路实现参数高效融合，在非IID场景下表现优异。

### 4. **[Elasticity in Parallel Sparse Triangular Solve](https://arxiv.org/abs/2607.02324v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Raphael S. Steiner, Christos K. Matzoros, Pál András Papp et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出弹性同步并行调度以加速稀疏三角求解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过重叠同步与计算显著提升了并行求解效率

### 5. **[Securing People and their Machines Against Major Faults](https://arxiv.org/abs/2607.02304v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Ohad Eitan, Idit Keidar, Ehud Shapiro
- **标签**: `cs.DC` `cs.CR` `cs.MA`
- **AI摘要**: 提出去中心化身份与状态恢复机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过社交图谱实现密钥与设备丢失的恢复，理论严谨且具有实用价值。
...
- **评分理由**: 针对NVM架构优化，在保持生产级特性的同时显著提升吞吐量。

## Information Retrieval

### 1. **[HNSW with Accuracy Guarantees Using Graph Spanners -- A Technical Report](https://arxiv.org/abs/2607.02338v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Minghao Li, Raghav Mittal, Sanjivni Rana et al.
- **标签**: `cs.DB` `cs.CL` `cs.IR`
- **AI摘要**: 提出HNSW认证与纠错框架，实现检索精度保证。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，将图稀疏化与统计学结合，实用价值高。

### 2. **[Bringing Agentic Search to Earth Observation Data Discovery](https://arxiv.org/abs/2607.02387v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Minghan Yu, Youran Sun, Chugang Yi et al.
- **标签**: `cs.IR` `cs.LG`
- **AI摘要**: 提出基于知识图谱的地球观测数据代理搜索系统。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合知识图谱与代理搜索，显著提升了检索性能与准确度。

### 3. **[Know Your Source: A Public Knowledge Store for Media Background Checks](https://arxiv.org/abs/2607.02383v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Benjamin Nichols, Michael Schlichtkrull, Nedjma Ousidhoum
- **标签**: `cs.CL`
- **AI摘要**: 提出MEDIAREF知识库以优化媒体背景核查
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过开源数据集解决了媒体背景核查的可复现性问题

### 4. **[Planning over Matrix-Factorization MDPs for Candidate Generation](https://arxiv.org/abs/2607.02115v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-02
- **作者**: Mikhail Trapeznikov, Maksim Utushkin
- **标签**: `cs.IR`
- **AI摘要**: 将矩阵分解检索建模为MDP以优化推荐序列
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地引入MDP规划提升静态推荐效果，实验扎实。

## Computer Vision

### 1. **[Population-Scale Segmentation of Penile Tissue in DIXON MRI using Deep Learning for Quantitative Phenotyping in Male Reproductive Health](https://arxiv.org/abs/2607.02127v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-07-02
- **作者**: Jan Ernsting, Gunnar Paul Kordes, Nils Johannaber et al.
- **标签**: `eess.IV` `cs.CV` `cs.LG`
- **AI摘要**: 基于深度学习的阴茎MRI自动分割方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且在大规模生物样本库中验证，实用性与严谨性极高。

### 2. **[Self-Auditing Residual Drifting for Pathology-Preserving Accelerated Knee MRI](https://arxiv.org/abs/2607.02428v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-02
- **作者**: Qing Lyu, Jianxu Wang, Mohammad Kawas et al.
- **标签**: `eess.IV` `cs.CV` `physics.med-ph`
- **AI摘要**: 提出自审计残差漂移模型以优化膝关节MRI重建。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且兼顾病理保真度与推理效率，实验扎实。

### 3. **[Alignment Is All You Need For X-to-4D Generation](https://arxiv.org/abs/2607.02516v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Qiaowei Miao, Kehan Li, Yawei Luo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Align4D框架实现多模态到4D内容的生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过多对齐技术提升了4D生成的一致性与质量。

### 4. **[Seek to Segment: Active Perception for Panoramic Referring Segmentation](https://arxiv.org/abs/2607.02497v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Song Tang, Shuming Hu, Xincheng Shuai et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出主动全景指代分割任务与PanoSeeker智能体
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入主动感知框架，实验设计严谨且实用性强。

### 5. **[GeoMix: Descriptor-Free Visual Localization via Global Context and Multi-Detector Training](https://arxiv.org/abs/2607.02486v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-02
- **作者**: Yejun Zhang, Xinjue Wang, Zihan Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GeoMix提升无描述符视觉定位精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多检测器训练与全局上下文增强几何判别力

## Machine Learning

### 1. **[Optimal Stabilizer Testing and Learning with Limited Quantum Memory](https://arxiv.org/abs/2607.02444v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-02
- **作者**: Srinivasan Arunachalam, Louis Schatzki
- **标签**: `quant-ph` `cs.CC` `cs.DS`
- **AI摘要**: 揭示量子存储对稳定子态测试与学习的复杂性影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新显著，证明了存储限制下的复杂性界限。

### 2. **[Prediction Sets for Counterfactual Decisions: Coverage, Optimality, and Conformal Prediction](https://arxiv.org/abs/2607.02206v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-02
- **作者**: Yurui Zheng, Ying Jin
- **标签**: `stat.ML` `cs.LG` `math.ST`
- **AI摘要**: 提出策略耦合覆盖框架以优化反事实决策
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，将共形预测与决策论结合，实验验证充分。

### 3. **[An Optimisation Framework for the Well-Conditioned Training of Physics-Informed Neural Networks](https://arxiv.org/abs/2607.02194v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-02
- **作者**: Joseph Webb, Sadok Jerad, Coralia Cartis
- **标签**: `cs.LG` `math.NA` `math.OC`
- **AI摘要**: 提出DSGNAR优化框架提升PINN精度与速度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 二阶优化方法显著改善PINN病态损失函数，实验效果极佳。

### 4. **[Born Discrete, Made Smooth: Variational Formulation of Shallow Neural Networks](https://arxiv.org/abs/2607.02003v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-02
- **作者**: Matej Benko, Pierre Bousquet, Iwona Chlebicka et al.
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出浅层网络变分公式，实现全局最优解求解。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，通过变分法避开迭代优化，数学严谨。

### 5. **[Dendritic In-Context Learning in a Single-Layer Spiking Neural Network](https://arxiv.org/abs/2607.02283v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-02
- **作者**: Juwei Shen, Yujie Wu, Changwen Chen
- **标签**: `cs.NE` `cs.LG`
- **AI摘要**: 单层脉冲神经网络实现上下文学习
<details>
<summary>原始摘要</summary>
