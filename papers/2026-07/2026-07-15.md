...
### 1. **[Watermark Forensics for Generative Models: An Information-Theoretic Perspective](https://arxiv.org/abs/2607.13003v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-14
- **作者**: Xiaoyu Li, Zheng Gao, Xiaoyan Feng et al.
- **标签**: `cs.CR` `cs.IT` `cs.LG`
- **AI摘要**: 提出生成模型水印的信息论分析框架
<details>
...
- **评分理由**: 理论严谨且具备突破性，为水印溯源提供了量化基准。

### 2. **[Extractable Memorization From First Principles](https://arxiv.org/abs/2607.12649v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-14
- **作者**: A. Feder Cooper, Marika Swanberg, Jamie Hayes et al.
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出匹配比较法以量化LLM记忆提取
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法论严谨，有效解决了记忆提取的评估偏差

### 3. **[A JoLT for the KV Cache: Near-Lossless KV Cache Compression via Joint Tucker and JL-Residual Allocation for LLMs](https://arxiv.org/abs/2607.12550v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-14
- **作者**: Rahul Krishnan, Volker Schulz
- **标签**: `cs.LG` `cs.CL` `math.OC`
- **AI摘要**: 提出JoLT压缩KV缓存，实现近无损的高效推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过张量分解与残差量化结合，显著提升了KV缓存压缩效率。

### 4. **[Resist and Update: Counterfactual Report Coordinates for Incentive-Compatible LLMs](https://arxiv.org/abs/2607.12985v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Sen Yang, Yuen-Hei Yeung
- **标签**: `cs.AI`
- **AI摘要**: 提出反事实报告坐标以实现LLM激励兼容性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且严谨，有效缓解模型谄媚问题，实用性强。

### 5. **[The Illusion of Robustness: Aggregate Accuracy Hides Prediction Flips under Task-Irrelevant Context](https://arxiv.org/abs/2607.12963v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Yanzhe Zhang, Sanmi Koyejo, Diyi Yang
- **标签**: `cs.CL`
- **AI摘要**: 揭示LLM在无关上下文下的预测不稳定性及尾部风险
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验严谨，揭示了聚合指标掩盖的个体预测波动问题。

## Natural Language Processing

### 1. **[The One-Word Census: Answer-Choice Conformity Across 44 Language Models](https://arxiv.org/abs/2607.12796v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Tapan Parikh
- **标签**: `cs.CL` `cs.AI` `cs.CY`
- **AI摘要**: 通过单词普查揭示大模型回答趋同性及演化规律。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法简洁创新，量化分析严谨，揭示了模型趋同现象。

### 2. **[Epistemic Stance Flexibility Probing: Measuring Prompt-Conditioned Register Shift in Large Language Models](https://arxiv.org/abs/2607.12739v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Binwen Liu, Yilin Ren
- **标签**: `cs.CL`
- **AI摘要**: 提出ESFP基准以评估大模型认知立场灵活性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地量化了模型在不同归因条件下的立场转换能力，方法严谨且具有实用价值。

### 3. **[Accuracy and Normalized Accuracy under Length Bias: Analysis, Guidelines, and a Bayesian Alternative](https://arxiv.org/abs/2607.12767v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Koen Oostermeijer
- **标签**: `cs.AI`
- **AI摘要**: 提出贝叶斯准确率以消除多选任务中的长度偏差。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 分析了长度偏差问题并提供了有效的贝叶斯替代方案，方法严谨且实用。

### 4. **[WikiSTAR: A System for Shedding Light on the Hidden History of Scientific Wikipedia Articles](https://arxiv.org/abs/2607.12441v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Omer Ehrlich, Nitzan Barzilay, Rona Aviram et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出WikiSTAR系统以追踪科学维基百科编辑历史
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合LLM与交互式可视化，有效挖掘科学知识演变，方法创新且实用。

### 5. **[Beyond Binary Detection: A Multi-Dimensional Taxonomy of Cancer Misinformation on Reddit](https://arxiv.org/abs/2607.12383v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Aria Pessianzadeh, Pooriya Jamie, Naima Sultana et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出癌症误导信息多维分类法并评估LLM表现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 分类框架创新且评估严谨，对公共卫生研究有实用价值

## Vision Language Models

### 1. **[Breaking Déjà Vu: Independent Auditing of Visual Place Recognition through Vision-Language Reasoning](https://arxiv.org/abs/2607.12818v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Sania Waheed, Michael Milford, Sarvapali D. Ramchurn et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出基于VLM的视觉定位审计框架，提升鲁棒性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，有效解决了VPR误匹配问题。

### 2. **[Visual Access Boundaries in Vision-Language Model Reasoning](https://arxiv.org/abs/2607.12815v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Hiroto Osaka, Shohei Taniguchi, Gouki Minegishi et al.
- **标签**: `cs.AI`
- **AI摘要**: 揭示VLM推理中视觉访问边界与计算瓶颈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果干预分析VLM推理机制，方法严谨且见解深刻。

### 3. **[UniVR: Thinking in Visual Space for Unified Visual Reasoning](https://arxiv.org/abs/2607.12800v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Zhongwei Ren, Yunchao Wei, Yao Zhao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出UniVR框架实现纯视觉推理与规划
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过VR-GRPO强化学习范式提升视觉推理能力，方法创新且实验扎实。

### 4. **[CoRe: A Comprehensive Framework for Cross-Image Comparative Reasoning in Vision-Language Models](https://arxiv.org/abs/2607.12786v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Lin Peng, Cong Wan, Zeyu Guo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CoRe框架提升多图比较推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过构建数据集与结构化奖励机制，显著提升了跨图推理精度。

### 5. **[VisCo: Leveraging Large Language Models as Intrinsic Encoders for Visual Token Compression](https://arxiv.org/abs/2607.12756v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Yupeng Zheng, Kai Zou, Bin Liu et al.
- **标签**: `cs.CV`
- **AI摘要**: 利用VLM自身作为压缩器实现高效视觉Token压缩
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出参数共享自编码框架，显著提升压缩效率与性能

## Diffusion Models

### 1. **[Accelerating Masked Diffusion Large Language Models: A Survey of Efficient Inference Techniques](https://arxiv.org/abs/2607.12829v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Daehoon Gwak, Minhyung Lee, Junwoo Park et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出dLLM推理延迟分解框架与加速技术分类体系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性梳理了dLLM加速技术，框架清晰且具有实用价值。

### 2. **[The Geometry of Memorization: Finite-Time Spectral Sensitivity as a Diagnostic for Flow Matching Models](https://arxiv.org/abs/2607.12616v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Shuchan Wang
- **标签**: `cs.LG`
- **AI摘要**: 提出FTSS指标诊断流匹配模型记忆现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过谱敏感度分析流模型几何特征，方法创新且实用

### 3. **[Steering Diffusion Models via Class-Contrastive Influence for Few-Shot Medical Classification](https://arxiv.org/abs/2607.12464v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Jeeyung Kim, Erfan Esmaeili, Qiang Qiu
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出C2I指标引导扩散模型生成高分类价值样本
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过梯度影响度优化合成数据，提升了医学图像分类性能

### 4. **[ReDiTT: Retrieval Augmented Conditional Diffusion Transformers for Asynchronous Time Series](https://arxiv.org/abs/2607.12391v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Saiyue Lyu, Zhitian Zhang, Ruizhi Deng et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出ReDiTT模型用于异步时间序列预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入检索增强扩散模型，提升了长序列预测的稳定性和多样性。

## Multimodal

### 1. **[FormalAnalyticGeo: A Neural-Symbolic Based Framework for Multimodal Analytic Geometry Problem Generation](https://arxiv.org/abs/2607.12982v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Ruoran Xu, Wending Gao, Qiufeng Wang
- **标签**: `cs.AI` `cs.MA` `cs.SC`
- **AI摘要**: 提出神经符号框架生成解析几何题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过形式化语言与SDF引擎实现高精度几何题生成，方法严谨且实用。

### 2. **[Open-KNEAD: Knowledge-grounded Nutrition Estimation via Agentic Decomposition](https://arxiv.org/abs/2607.12911v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Bruce Coburn, Jingbo Yue, Jinge Ma et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于代理的营养评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过代理分解与知识库检索提升了营养评估的准确性与可解释性。

### 3. **[AVSCap: Orchestrating Audio-Visual Synergy for Omni-modal Video Captioning](https://arxiv.org/abs/2607.12820v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Yanghai Wang, Jiahao Wang, Jiafu Tang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出AVSCap框架实现视听协同视频描述
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过跨模态事件绑定与强化学习显著提升视听协同能力

### 4. **[Segregate, Refine, Integrate: Decomposing Multimodal Fusion for Sentiment Analysis](https://arxiv.org/abs/2607.12686v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Alexios Filippakopoulos, Elias Kallioras, Nikolaos Xiros et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出SeRIn架构实现多模态特征解耦与高效融合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦模态路径显著提升了情感分析性能，实验扎实。

### 5. **[Self in Space: Benchmarking Self-Awareness and Spatial Cognition in UAV Embodied Intelligence](https://arxiv.org/abs/2607.12477v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Zhishan Zou, Guoyan Sun, Zhiwei Wei et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SIS-Bench基准评估无人机自我意识与空间认知能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入新颖基准与运动感知模型，实验严谨且具有实际应用价值。

## Image Generation

### 1. **[DiTailed: Ensuring Visual Object Consistency in Text-Image-to-Image Flow Matching Models](https://arxiv.org/abs/2607.12539v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Francesco Taioli, Daniel Coelho, Iaroslav Melekhov et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出FlowMirror提升图像编辑一致性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入新数据集并利用流匹配模型特性，方法创新且有效。

## Video Generation

### 1. **[WanToFight: Real-Time Generative Game Engine for Multi-Player Combat Interaction](https://arxiv.org/abs/2607.12592v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-14
- **作者**: Li Hu, Guangyuan Wang, Peng Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 首个实现实时多人对抗的生成式游戏引擎
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在视频扩散模型中实现了多人实时交互与高性能推理，创新性显著。
...
- **评分理由**: 创新性引入光流作为动作表征，实验效果显著且逻辑清晰。

## Agent

### 1. **[TerraZero: Procedural Driving Simulation for Zero-Demonstration Self-Play at Scale](https://arxiv.org/abs/2607.13028v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-14
- **作者**: Zhouchonghao Wu, Akshay Rangesh, Weixin Li et al.
- **标签**: `cs.LG` `cs.AI` `cs.RO`
- **AI摘要**: 提出TerraZero高效自动驾驶仿真与自博弈训练框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 仿真效率极高且无需人类演示，在基准测试表现优异

### 2. **[Evidence-Grounded Verified Agentic Reasoning: A Path Toward Eliminating LLM Hallucination in Empirical Inference via Tool-Attested Kernel Proofs](https://arxiv.org/abs/2607.12650v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-14
- **作者**: Junyu Ren
- **标签**: `cs.LG` `cs.AI` `cs.CY`
- **AI摘要**: 基于Lean内核的证据验证代理推理架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过形式化验证消除幻觉，方法严谨且创新性强。

### 3. **[Evidence-Grounded AI for Musculoskeletal Care](https://arxiv.org/abs/2607.12527v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-14
- **作者**: Wenjie Li, Yujie Zhang, Fanrui Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: OrthoPilot实现骨科全流程智能管理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入任务复杂度评估显著降低了计算成本与冗余

### 5. **[Function-Aware Fill-in-the-Middle as Mid-Training for Coding Agent Foundation Models](https://arxiv.org/abs/2607.12463v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-14
- **作者**: Yubo Wang, Jiarong Liang, Yuxuan Zhang et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出函数感知FIM预训练以增强编码智能体能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升了智能体基准表现。

## Distributed Computing

### 1. **[Constraint-Aware Aggregation for Federated Reinforcement Learning in Microgrid Energy Coordination](https://arxiv.org/abs/2607.12763v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Usman Haider, Karl Mason
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出约束感知联邦强化学习聚合策略
<details>
<summary>原始摘要</summary>
...
### 2. **[Proceedings of HLPP 2026: 19th International Symposium on High-Level Parallel Programming and Applications](https://arxiv.org/abs/2607.12917v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-07-14
- **作者**: Chong Li, Corinne Ancourt, Gaétan Hains
- **标签**: `cs.DC` `cs.PL`
- **AI摘要**: 探讨高性能并行编程与AI融合技术
<details>
<summary>原始摘要</summary>
...
- **作者**: Dimitrios Kafetzis
- **标签**: `cs.OS`
- **AI摘要**: 将推理流水线作为OS对象管理，实现微控制器高效调度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将推理任务OS化，实验详实，但在性能提升上略显保守。

### 3. **[SynapticOS: An Inference-First Runtime Architecture for Neural Processing Units on Resource-Constrained Microcontrollers](https://arxiv.org/abs/2607.12606v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Dimitrios Kafetzis
- **标签**: `eess.SY` `cs.OS`
- **AI摘要**: 面向微控制器的神经处理单元运行时架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对嵌入式AI推理的系统级优化，具备高实用性与严谨评估

## Information Retrieval

### 1. **[EvoGraph-R1: Self-Evolving Multimodal Knowledge Hypergraphs for Agentic Retrieval](https://arxiv.org/abs/2607.12764v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Jiashi Lin, Changhong Jiang, Xiangru Lin et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出自演化多模态知识超图RAG框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过MDP实现动态图推理，创新性与实用性兼备

### 2. **[Learning to Forget: Satiation-Aware Long-Sequence Transducers for Mitigating Post-Purchase Redundancy](https://arxiv.org/abs/2607.12714v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Yipin Dai, Ruocong Tang, Xing Fang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出SAM机制解决电商购买后的冗余推荐问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对性解决购买后兴趣饱和问题，实验验证充分，实用性强。

### 3. **[MESH: Scaling Up Retrieval with Heterogeneous Content Unification](https://arxiv.org/abs/2607.12392v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Jiaxing Qu, Yilin Chen, Junpeng Hou et al.
- **标签**: `cs.IR` `cs.LG`
- **AI摘要**: 提出MESH框架解决异构检索扩展偏差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过模块化架构有效提升长尾与新鲜内容检索性能

### 4. **[RecRec: Latent Interests Recursive Reasoning for Sequential Recommendation](https://arxiv.org/abs/2607.12945v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Wenhao Deng, Junchen Fu, Hanwen Du et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出解耦推理与预测的递归推荐框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地解耦了推理过程，实验扎实且效果显著。

### 5. **[Where Reasoning Matters: Rethinking Latent Reasoning in Semantic ID-based Generative Recommendation](https://arxiv.org/abs/2607.12425v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-14
- **作者**: Shangxin Yang, Min Gao, Zongwei Wang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出IBA框架优化语义ID推荐的计算资源分配
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过信息增益动态分配计算资源，方法新颖且实验扎实。

## Computer Vision

### 1. **[Exact and Calibrated Diffusion Reconstruction for Digital Breast Tomosynthesis](https://arxiv.org/abs/2607.12937v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-14
- **作者**: Imade Bouftini
- **标签**: `eess.IV` `cs.CV`
- **AI摘要**: 提出精确一致性与校准的DBT扩散重建方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过投影法实现数据一致性与不确定性校准，理论严谨且临床意义重大。

### 2. **[DermDepth: Toward Monocular Metric Scale 3D Reconstruction Models for Dermatology](https://arxiv.org/abs/2607.13010v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Héctor Carrión, Narges Norouzi
- **标签**: `cs.CV`
- **AI摘要**: 提出DermDepth实现单目皮肤三维重建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入合成数据集，显著提升临床测量精度。

### 3. **[X-Lens: Real-Time Metric Depth Estimation with Heterogeneous Cameras](https://arxiv.org/abs/2607.12993v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Heng Zhou, Shuhong Liu, Yonghao He et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出异构相机实时深度估计模型X-Lens
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型轻量高效，在多视角深度估计上表现优异。

### 4. **[Controllable Generation of Diverse Dermatological Imagery for Fair and Efficient Malignancy Classification](https://arxiv.org/abs/2607.12987v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Héctor Carrión, Narges Norouzi
- **标签**: `cs.CV`
- **AI摘要**: 提出cgDDI框架以生成多样化皮肤图像提升诊断公平性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，有效缓解了医疗数据偏差

### 5. **[Rank-1 Identity Consensus Predicts Gallery Enrollment in 1:N Face Matching More Accurately than Score Thresholding](https://arxiv.org/abs/2607.12903v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Gabriella Pangelinan, Aman Bhatta, Michael C. King et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出1-consistency方法提升人脸识别准确性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需阈值，在多场景下表现优于传统方案

## Machine Learning

### 1. **[LatentFlow: A General Framework for Conditioning Stochastic Processes](https://arxiv.org/abs/2607.12922v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-14
- **作者**: Louis Sharrock, Lachlan Astfalck, Henry Moss
- **标签**: `stat.ML` `cs.LG` `stat.ME`
- **AI摘要**: 提出无需训练的通用随机过程条件化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过潜在空间推断实现通用条件化，方法创新且高效。

### 2. **[Fisher Rank Inflation: A Spectral Signature of Memorization under Label Noise](https://arxiv.org/abs/2607.12438v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-14
- **作者**: Satwik Bathula, Anand A. Joshi
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出Fisher秩膨胀现象以识别标签噪声记忆。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论新颖且实验扎实，有效揭示了模型记忆机制。

### 3. **[A Shortcut to Statistically Steady-State Turbulence with Flow Matching](https://arxiv.org/abs/2607.13022v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Gianluca Galletti, Gerald Gutenbrunner, William Hornsby et al.
- **标签**: `physics.plasm-ph` `cs.LG`
- **AI摘要**: 利用流匹配直接生成湍流稳态分布
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地绕过瞬态模拟，显著提升计算效率

### 4. **[The Spectrum Is Not Enough: When Context Helps Time-Series Forecasting](https://arxiv.org/abs/2607.13006v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Mert Onur Cakiroglu, Mehmet Dalkilic, Hasan Kurban
- **标签**: `cs.LG`
- **AI摘要**: 提出诊断指标区分时序预测的频谱与上下文价值
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且实验扎实，有效揭示了频谱指标的局限性

### 5. **[Ensemble Controlled-Flow Filtering for Implicit Data Assimilation](https://arxiv.org/abs/2607.12975v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-14
- **作者**: Zhuoyuan Li, Yue Zhao, Ming Li
- **标签**: `stat.ML` `cs.LG` `math.NA`
- **AI摘要**: 提出EnCF算法解决隐式数据同化问题
<details>
<summary>原始摘要</summary>
