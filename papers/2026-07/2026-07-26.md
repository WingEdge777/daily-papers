...
- **评分理由**: 研究揭示了AI过度辅助问题，评估方法科学且具有重要教育启示。

### 2. **[From Evaluation to Optimisation: Hierarchy-Aware Training Signals for CWE Prediction in Python](https://arxiv.org/abs/2607.21069v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Muntasir Adnan, Manile Srun, Carlos C. N. Kuhn
- **标签**: `cs.LG`
- **AI摘要**: 提出利用层级惩罚优化CWE预测训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过强化学习显著提升了代码安全漏洞预测性能

### 3. **[QuantiBias: Benchmarking Quantization-Induced Bias in LLMs](https://arxiv.org/abs/2607.21063v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Emilio Ferrara
- **标签**: `cs.CL` `cs.CY` `cs.HC`
- **AI摘要**: 揭示量化导致大模型偏见增加并提出评估基准。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了量化带来的隐性偏见，方法严谨且具有重要实用价值。
...
- **评分理由**: 研究揭示了中介处理对模型安全对齐的复杂影响，实验设计严谨且具有重要安全启示。

### 5. **[Improved lower bounds for the Shannon capacity of odd cycles](https://arxiv.org/abs/2607.21517v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Nathaniel Itty, Christopher D. Rosin, Chase Carstensen et al.
- **标签**: `cs.IT` `cs.AI` `cs.DM`
- **AI摘要**: 利用大模型改进奇圈Shannon容量下界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过LLM辅助构造提升了组合数学中的容量下界，方法新颖且严谨。

## Natural Language Processing

### 1. **[PrefReward: Learning User Preference Matrix for Personalized Text Generation](https://arxiv.org/abs/2607.21067v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Yue Wu, Chengbing Wang, Yimeng Bai et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出PrefReward框架，通过偏好矩阵实现个性化文本生成。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且具有可解释性，实验验证充分，逻辑清晰。

### 2. **[news-crawler-LM: A Small Long-Context Model For High-Quality News Crawling](https://arxiv.org/abs/2607.21284v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-23
- **作者**: Pascal Stolzenburg, Jonas Golde, Max Dallabetta et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出轻量级长文本模型优化新闻网页内容提取
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型针对性强，实验对比充分，但在泛化性上仍有提升空间。
...
- **标签**: `cs.AI`
- **AI摘要**: 利用TensorRT加速IndexTTS-2实现实时流式合成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过工程优化显著提升了自回归TTS的推理速度与实用性

## Vision Language Models

### 1. **[Geo3R: Mitigating Spatial Reasoning Hallucination in Multimodal Large Language Models](https://arxiv.org/abs/2607.21085v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Mingyu Wang, Weilin Jin, Wenbo Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Geo3R框架以缓解MLLM的空间推理幻觉问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需训练，实验覆盖全面，论证严谨。

### 2. **[GeoThreat: Transferable Targeted Adversarial Attacks on Large Vision-Language Models for Remote Sensing Image Interpretation](https://arxiv.org/abs/2607.21036v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Yimin Fu, Yuefeng Bai, Baicheng Pan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出遥感LVLM对抗攻击方法GeoThreat
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对遥感领域提出创新攻击框架，实验充分且逻辑清晰。

## Multimodal

### 1. **[Thinkink: 2D Spatial Ink-native Interaction with LLMs](https://arxiv.org/abs/2607.21468v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Mohammad Hasan Payandeh, Daniel Vogel, Jian Zhao
- **标签**: `cs.HC` `cs.AI`
- **AI摘要**: 提出支持手写与草图交互的LLM空间化协作系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，创新性地将手写交互与LLM整合

## Agent

### 1. **[PATS: Policy-Aware Training Scaffolding for Agentic Reinforcement Learning](https://arxiv.org/abs/2607.21419v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Yipeng Shi, Zhipeng Ma, Yue Wang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出动态训练脚手架提升智能体学习效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，显著提升了RL性能与效率。

### 2. **[Sample-Efficient Learning from Agent Experience](https://arxiv.org/abs/2607.21051v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Chenhui Gou, Haoqin Tu, Yunhao Fang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出体验蒸馏法提升智能体样本效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过蒸馏交互历史显著提升样本效率，实验充分且方法创新。
...
- **评分理由**: 分层强化学习设计新颖，实验验证充分且效果显著

### 4. **[Agentic coding without the cloud: evaluating open-weight large language models on longitudinal data preparation tasks](https://arxiv.org/abs/2607.21482v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Mack Nixon, Liam Wright, Yevgeniya Kovalchuk et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出本地化开源模型数据处理评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对隐私敏感研究提供本地化AI方案，基准测试严谨且实用。

### 5. **[Euclid-MCP: A Model Context Protocol Server for Deterministic Logical Reasoning via Prolog](https://arxiv.org/abs/2607.21412v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Bartolomeo Bogliolo
- **标签**: `cs.AI` `cs.CL` `cs.SE`
- **AI摘要**: 基于Prolog的MCP服务器，提升LLM逻辑推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过标准化接口结合符号推理，有效解决LLM幻觉问题。

## Computer Vision

### 1. **[Stokes-Informed Diffusion for Robust Linear Polarization Estimation](https://arxiv.org/abs/2607.21239v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Yidong Luo, Chenggong Li, Yuchao Feng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GenPolar框架，通过扩散模型实现单图偏振估计。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理模型与扩散模型，在偏振估计任务上表现优异。

### 2. **[Achieving Text-based Person Retrieval with Any Granularity](https://arxiv.org/abs/2607.21057v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Jialong Zuo, Hanyu Zhou, Dongyue Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出多粒度文本行人检索框架CMAM及评估基准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过合成数据解决工业缺陷样本稀缺问题，实验验证有效。

### 4. **[Self-Supervised Learning of Structured Dynamics from Videos](https://arxiv.org/abs/2607.21576v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Lukas Knobel, Andrew Zisserman, Yuki M. Asano
- **标签**: `cs.CV`
- **AI摘要**: 提出SDM模型解耦视频相机与物体运动
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过自监督学习有效分离动态特征，方法创新且实验扎实。

### 5. **[UnDA: Unpaired Domain Alignment for Cross-Modal Knowledge Transfer in Medical Imaging](https://arxiv.org/abs/2607.21546v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Rafsan Jany, Shadab Tanjeed Ahmad, Ahsan Bulbul et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出UnDA框架实现非配对医学影像跨模态知识迁移
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入不确定性加权最优传输，实验设计严谨。

## Machine Learning

### 1. **[Demographically-Informed Heat-Mortality Risk Curves via Risk Graph Neural Networks](https://arxiv.org/abs/2607.21131v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Alex O. Davies, Eunice Lo, Rui Zhu
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 利用图神经网络优化热死亡风险曲线预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合人口统计学特征提升了流行病学模型的预测精度与稳健性

### 2. **[Relative Value Learning](https://arxiv.org/abs/2607.21120v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Marc Höftmann, Jan Robine, Stefan Harmeling
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出相对价值学习框架，通过学习状态差值优化强化学习。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，方法创新且在Atari基准上表现优异。

### 3. **[A Polynomial Architecture-Attribution Co-Design Framework for Exact Aumann-Shapley Attribution in GNNs](https://arxiv.org/abs/2607.21094v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Bizu Feng, Zhimu Yang, Shuming Wang et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出PolyGIN架构实现Aumann-Shapley精确归因
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多项式架构设计解决了图神经网络归因的近似误差问题，理论严谨且实验扎实。

### 4. **[Nipping the Butterfly Effect in the Bud: Self-Output Fine-Tuning for Autoregressive Weather Prediction](https://arxiv.org/abs/2607.21080v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Yun-Ye Cai, Hsuan-Tien Lin
- **标签**: `cs.LG`
- **AI摘要**: 提出SOFT方法缓解气象预测误差累积
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入，提出的微调策略简单有效，实验结果显著。

### 5. **[Beyond Sufficiency: Time Series Explanation with Counterfactual Necessity](https://arxiv.org/abs/2607.21573v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Hongnan Ma, Yiwei Shi, Mengyue Yang et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出TimePNS框架，通过反事实必要性提升时间序列解释准确度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入因果必要性概念，方法论严谨且实验验证充分，具有较好实用价值。
