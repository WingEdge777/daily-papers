...
### 1. **[MedGame: Storytelling Gamification Empowered by Large Language Models for Medical Education](https://arxiv.org/abs/2607.21570v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Qian Wu, Xinrong Zhou, Zizhan Ma et al.
- **标签**: `cs.CL` `cs.HC`
- **AI摘要**: MedGame通过LLM将临床案例转化为交互式叙事游戏
<details>
...
- **评分理由**: 创新性地结合了医学教育与叙事游戏，评估体系完善。

### 2. **[Error Certificates for KV-Cache Eviction via Randomized Design](https://arxiv.org/abs/2607.21475v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Peng Xie
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 引入随机缓存淘汰机制以量化误差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且提出新颖的误差归因方法，实用性强

### 3. **[Test-Time Scaling via Error Localization](https://arxiv.org/abs/2607.21453v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Rajiv Shailesh Chitale, Rahul Madhavan, Taneesh Gupta et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出TTEL算法实现推理时错误定位与分支重试
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过token级错误定位优化推理效率，实验效果显著。

### 4. **[Anti-Periodic Positional Encoding: Möbius Boundary Conditions Make In-Context Retrieval Reliable](https://arxiv.org/abs/2607.21405v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Ji Ho Bae
- **标签**: `cs.CL`
- **AI摘要**: 提出莫比乌斯旋转位置编码以提升检索稳定性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入反周期边界条件，显著改善检索可靠性且不损失困惑度。
...
- **评分理由**: 选题新颖，方法论严谨，对提升模型写作自然度有实用价值。

### 2. **[When Trivia Is Not Trivial: Everyday Knowledge Failures in Multilingual LLMs](https://arxiv.org/abs/2607.21445v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Anna Mosolova, Djamé Seddah
- **标签**: `cs.CL`
- **AI摘要**: 提出TriviaRoomQA基准评估LLM日常文化知识差距
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 构建了多语言基准测试，揭示了LLM在流行文化知识上的局限性。

### 3. **[Word meaning co-determines vowel-inherent spectral change. A corpus-based investigation of conversational Mandarin](https://arxiv.org/abs/2607.21391v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Xiaoyun Jin, Mirjam Ernestus, R. Harald Baayen
- **标签**: `cs.CL`
- **AI摘要**: 语义特征影响普通话元音发音轨迹
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合语料库与语义嵌入，揭示了语义对语音生成的调节作用。

### 4. **[Phonetic forced alignment for low-resource language varieties: Model training and evaluation on Chengdu Mandarin](https://arxiv.org/abs/2607.21332v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-07-23
- **作者**: Zhiheng Qian, Aini Li, Hai Hu et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出成都话低资源语音强制对齐方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对低资源方言提出有效对齐方案，实验扎实且提升显著。

### 5. **[VibeVoice-ASR-BitNet Technical Report](https://arxiv.org/abs/2607.21075v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-07-23
- **作者**: Songchen Xu, Ting Song, Shaohan Huang et al.
- **标签**: `cs.SD` `cs.CL` `eess.AS`
- **AI摘要**: 提出一种基于BitNet的轻量化ASR模型，实现高效边缘推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过异构量化显著提升推理速度，技术方案扎实且实用性强。

## Vision Language Models

### 1. **[MVEI & EmObserver: Empowering MLLM-Oriented Visual Emotional Intelligence via Emotion Statement Judgement](https://arxiv.org/abs/2607.21061v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Daiqing Wu, Dongbao Yang, Jiashu Yao et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ESJ框架与MVEI基准以提升MLLM视觉情感智能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入情感判断范式，构建了高质量基准与模型，实验严谨且具有实际应用价值。

### 2. **[3D-Aware VLMs with Implicit and Explicit Geometries](https://arxiv.org/abs/2607.21595v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Wenhao Li, Xueying Jiang, Quanhao Qian et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出VLM-IE3D框架，融合隐式与显式几何提升VLM空间推理能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过RGB视频学习几何先验，无需额外3D输入，方法创新且实验扎实。

### 3. **[MIRROR: Learning from the Other View for Multi-Modal Reasoning](https://arxiv.org/abs/2607.21552v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Wen Ye, Yuxiao Qu, Aviral Kumar et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出MIRROR框架通过多视角互补提升多模态推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了多模态推理不一致问题

### 4. **[Towards Privacy-Preserving Federated Prompt Tuning under Data Heterogeneity: A Subspace-Decomposed Expert Approach](https://arxiv.org/abs/2607.21417v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Yuhua Wang, Xiaodong Li, Yihao Guo et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出FedSEPT实现隐私保护联邦提示微调
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过子空间分解与专家融合提升了异构数据下的性能

### 5. **[V-DEAL: Diagnosing Video Safety De-Calibration as an Understanding-Refusal Coupling Failure](https://arxiv.org/abs/2607.21151v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Zhetong Zhang, Honghao Fu, Miao Xu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出V-DEAL框架诊断视频大模型安全对齐失效问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 揭示了视频与文本理解耦合的安全性漏洞，诊断方法严谨且有效。

## Diffusion Models

### 1. **[Bridging the Gap Between Plausibility and Admissibility: Constraint-Aware Flow Maps for Dynamic Graph Systems](https://arxiv.org/abs/2607.21421v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Michael Romei de Socio, Gian Luca Pozzato, Alessio Merlo
- **标签**: `cs.AI`
- **AI摘要**: 引入符号约束提升动态图生成模型的结构可行性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，有效解决了生成模型可行性问题。

### 2. **[SlerpFlow: Spherical Trajectory Correction for Rectified Flow Inversion](https://arxiv.org/abs/2607.21326v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Wenbin Duan, Yan Shu, Zhuoyuan Fu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SlerpFlow实现高保真扩散模型反演
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过球面插值修正轨迹，显著提升FLUX反演精度与效率。

### 3. **[Transformer-based Diffusion models for Hydrological Time Series Probabilistic Imputation and Forecasting](https://arxiv.org/abs/2607.21200v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-07-23
- **作者**: Ferdinand Bhavsar, Lionel Benoit, Maxime Savatier et al.
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 利用Transformer扩散模型实现水文序列填补与预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合了扩散模型与Transformer，在水文数据处理上表现优异。

## Multimodal

### 1. **[Unlearning Under Imbalance: Benchmarking Fairness in Multimodal LLM Unlearning](https://arxiv.org/abs/2607.21300v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Lorenzo Orsingher, Thomas De Min, Massimiliano Mancini et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出FAIRGET基准与FAUN算法以解决多模态模型遗忘偏见。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对多模态遗忘中的不平衡偏见问题，方法创新且实验严谨。

### 2. **[Show, Don't Tell: Evaluating Spatial Cognition in Generative Pixels Rather Than LLM Text](https://arxiv.org/abs/2607.21072v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Xu Wang, Kaixiang Yao, Miao Pan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ProVisE框架评估生成模型的空间认知能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将像素空间作为评估维度，实验设计严谨且具备高实用价值。

### 3. **[Out of Sight, Still in Mind: Token Compression for Omni-LLMs](https://arxiv.org/abs/2607.21179v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Suho Yoo, Youngjoon Jang, Hyebin Cho et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出ReMo框架，通过跨模态压缩视觉Token以降低推理成本。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验验证充分，有效提升了多模态模型效率。

### 4. **[C-PTQ: Fisher-weighted Channel-wise Sensitivity for Post-training Quantization of MLLMs](https://arxiv.org/abs/2607.21076v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Jiameng Li, Han Zhou, Matthew B. Blaschko
- **标签**: `cs.CV`
- **AI摘要**: 提出基于Fisher信息的通道量化方法，提升MLLM压缩性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过二阶导数优化量化，方法创新且实验验证充分，实用性强。

### 5. **[Safeguards for Speech2Speech LLM-Assistants: A Case Study in Automotive Applications](https://arxiv.org/abs/2607.21180v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-07-23
- **作者**: Gregor Endler, Sebastian Kraus, Lukas Stappen
- **标签**: `cs.AI`
- **AI摘要**: 分析车载S2S模型安全防护的局限与挑战
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对车载场景的S2S防护方案进行了实证评估，逻辑清晰但创新性适中。

## Agent

### 1. **[The Dark Room in the Reward Channel: Dense Prediction Rewards Collapse GRPO-Trained LLM Agents -- and What Actually Works](https://arxiv.org/abs/2607.21273v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-23
- **作者**: Yu Wang
- **标签**: `cs.LG`
- **AI摘要**: 揭示GRPO训练中稠密奖励导致的坍缩机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入剖析了强化学习中奖励机制失效的根本原因，理论与实验扎实。

### 2. **[Toward cryptographically verifiable authorization for autonomous AI agents: A security hypothesis, preliminary formal model, and proof-of-concept implementation](https://arxiv.org/abs/2607.21325v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: M. Llambí-Morillas, D. Fernández-Fernández
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出AI代理加密可验证授权模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，形式化严谨，为代理安全提供新范式

### 3. **[ICAE-Bench: Evaluating Coding Agents as Interactive Project Builders](https://arxiv.org/abs/2607.21217v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Zhongyuan Peng, Dan Huang, Chuyu Zhang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出交互式编程智能体评测基准ICAE-Bench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对智能体开发场景设计了创新且严谨的评测框架

### 4. **[Causal-AgentIR: Self-Evolving Causal Memory for Adaptive Image Restoration Agents](https://arxiv.org/abs/2607.21125v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Hu Gao, Yulong Chen, Lizhuang Ma
- **标签**: `cs.CV`
- **AI摘要**: 提出自演化因果记忆图像修复智能体框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过因果图谱实现记忆演化，提升了修复任务的适应性与逻辑性。

### 5. **[AttriMem: Attribution-Guided Process Feedback for Agent Memory Learning](https://arxiv.org/abs/2607.21106v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Qinfeng Li, Yuntai Bao, Xinyan Yu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出AttriMem框架，通过归因反馈优化智能体记忆构建。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决记忆构建的信用分配问题，实验效果显著。

## Distributed Computing

### 1. **[Solving Large Traveling Salesman Problems (TSPs) by a Recursive Clustering Algorithm and a Scalable FPGA-Based Implementation](https://arxiv.org/abs/2607.21182v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-07-23
- **作者**: Junqi Huang, Hawraa Abbas Almurieb, T. Nandha Kumar et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出递归聚类与FPGA实现求解大规模TSP
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法创新性较好，但实验验证规模与对比尚有提升空间

## Information Retrieval

### 1. **[A Comparative Evaluation of Embeddings and LLMs in a Greek Book Publisher Setting - The CUP Dataset](https://arxiv.org/abs/2607.21274v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-23
- **作者**: Katerina Papantoniou, Panagiotis Papadakos, Theodore Patkos et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 构建希腊语图书检索基准CUP并评估多种检索方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了希腊语特定领域检索基准的空白，实验设计严谨。

### 2. **[Transparent by Design, Usable in Practice? A Formative Usability Study of a Conversational Product Advisor](https://arxiv.org/abs/2607.21513v1)**
- **评分**: ⭐ 72/100 | **日期**: 2026-07-23
- **作者**: Kevin Schott, Dagmar Kern, Daniel Hienert
- **标签**: `cs.HC` `cs.IR`
- **AI摘要**: 研究对话式产品顾问的可用性与透明度设计。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法扎实，但样本量较小，属于增量研究。

## Computer Vision

### 1. **[GLAM-SLAM: Real-time Gaussian Large-scale Mapping via Flow Densification and Spatial Decomposition](https://arxiv.org/abs/2607.21416v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Panagiotis Mermigkas, Argyris Manetas, Petros Maragos
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出一种实时大规模高斯溅射SLAM系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了长序列场景下的内存与实时性瓶颈，实验充分且性能优异。

### 2. **[Incremental Optimal Assignment for Real-Time Crowd Tracking](https://arxiv.org/abs/2607.21368v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Ismail H. Toroslu
- **标签**: `cs.CV` `cs.DS`
- **AI摘要**: 提出增量式最优分配算法加速人群追踪
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用稀疏性实现最优匹配，性能提升显著且理论严谨。

### 3. **[Detectors Learn the Wrong Thing: Shortcut-Resistant Adversarial Training Against Physically Realizable Attacks](https://arxiv.org/abs/2607.21243v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Yuanhao Huang, Yilong Ren, Jinlei Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出InsCAT框架解决对抗纹理捷径问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对比学习有效抑制对抗攻击的捷径效应，实验严谨且实用性强。

### 4. **[Spectral Transformation for Layer-wise Global Rank Discovery in Federated LoRA for Vision Transformers](https://arxiv.org/abs/2607.21074v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Hariharan Ramesh, Jyotikrishna Dass
- **标签**: `cs.LG` `cs.DC`
- **AI摘要**: 提出SpecTraL实现联邦LoRA高效秩发现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过谱变换解决联邦LoRA聚合误差，理论严谨且实用。

### 5. **[TransBiolab: A Real-World Multi-View Dataset of Cluttered Transparent Biomedical Objects](https://arxiv.org/abs/2607.21071v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Ke Ma, Yifei Wang, Meng Wang et al.
- **标签**: `cs.CV` `cs.MM` `cs.RO`
- **AI摘要**: 发布了用于生物实验室透明物体操作的真实多视图数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了实验室透明物体识别数据集空白，实验设计严谨且实用性强。

## Machine Learning

### 1. **[MSBraM: A Multi-scale Self-supervised Brain Foundation Model for Hierarchical EEG Dynamics Learning](https://arxiv.org/abs/2607.21402v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Tao Zhou, Jing Han, Lingyu Shu et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出多尺度自监督脑电基础模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多尺度分词与掩码策略提升了脑电表征学习的泛化性

### 2. **[SPORD: A Simulation-Propose-then-OR-Dispose Approach for Supply Chain Planning](https://arxiv.org/abs/2607.21354v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Jiayin He, Yutong Pan, Sen Yang et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出SPORD方法优化供应链规划
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过仿真与优化解耦，显著提升了大规模供应链决策效率。

### 3. **[Gradient Concentration, Not Weight Saliency, Explains Representation-Level Class Unlearning](https://arxiv.org/abs/2607.21353v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Billel Habbati, Alessio Merlo, Luca Verderame et al.
- **标签**: `cs.LG`
- **AI摘要**: 揭示梯度集中而非权重显著性主导机器遗忘。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严谨消融实验挑战了现有遗忘方法的机制假设。

### 4. **[Filter Learning for Subgraphs: Algebras and Performance Risk Bounds](https://arxiv.org/abs/2607.21263v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Purui Zhang, Feng Ji, Yanan Zhao et al.
- **标签**: `cs.LG` `eess.SP`
- **AI摘要**: 提出子图滤波学习框架及代数模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具备数学证明，在图信号处理领域有创新。

### 5. **[Towards a Certifying Grounder](https://arxiv.org/abs/2607.21199v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-23
- **作者**: Daimy Van Caudenberg, Alexander Ek, Carlos Cantero et al.
- **标签**: `cs.LO` `cs.AI`
- **AI摘要**: 提出CertiFOX框架实现可验证的逻辑接地
<details>
<summary>原始摘要</summary>
