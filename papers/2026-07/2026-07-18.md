...
### 1. **[SmartRAG: Native Graph-Based RAG for Mobile Device](https://arxiv.org/abs/2607.14661v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Zhihan Jiang, Meng Li, Shenghao Liu et al.
- **标签**: `cs.AI`
- **AI摘要**: 端侧图增强检索框架SmartRAG
<details>
...
- **评分理由**: 创新性结合图谱与轻量化模型，兼顾性能与隐私。

### 2. **[PolyQ: Codesigning End-to-End Quantization Framework for Scalable Edge CPU LLM Inference](https://arxiv.org/abs/2607.14618v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Hyunwoo Oh, Suyeon Jang, Hanning Chen et al.
- **标签**: `cs.LG` `cs.AR` `cs.OS`
- **AI摘要**: 提出PolyQ框架实现CPU端高效量化推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过编译优化解决了CPU端细粒度量化开销问题，性能提升显著。
...
- **评分理由**: 创新性地揭示了Web规模数据投毒风险，分析严谨。

### 4. **[In-Place Tokenizer Expansion for Pre-trained LLMs](https://arxiv.org/abs/2607.15232v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Jimmy T. H. Smith, Tarek Dakhran, Alberto Cabrera et al.
- **标签**: `cs.CL` `cs.AI` `cs.LG`
- **AI摘要**: 提出原地扩展预训练模型分词器的方法，提升多语言处理效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且实验扎实，有效解决了模型词表扩展的效率问题。

### 5. **[MedFailBench: A Clinician-Built Open-Source Benchmark for Medical AI Safety Boundary Inspection](https://arxiv.org/abs/2607.15166v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Goktug Ozkan
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出医疗AI安全边界评估基准与失效分类体系。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了医疗AI安全评估空白，方法科学且实用性强。

## Natural Language Processing

### 1. **[Latent Trajectory Discrimination for AI-Generated Text Detection](https://arxiv.org/abs/2607.14967v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Gianluca Bonifazi, Christopher Buratti, Michele Marchetti et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出GTCL框架通过建模生成轨迹提升AI文本检测性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将文本检测转化为轨迹判别问题，实验表现稳健。

### 2. **[Does generative AI supersede supervised XMLC? A Benchmark Study on Automated Subject Indexing with German Scientific Literature](https://arxiv.org/abs/2607.14882v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Maximilian Kähler, Katja Konermann, Lisa Kluge et al.
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 对比评估XMLC与LLM在德语文献自动标引中的表现。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，对比了传统XMLC与LLM在长尾词标引上的优劣，具有实际应用价值。

### 3. **[RW-Voice-EQ Bench: A Real World Benchmark for Evaluating Voice AI Systems](https://arxiv.org/abs/2607.14846v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: David Ayllon, Alice Baird, Jeffrey Brooks et al.
- **标签**: `cs.SD` `cs.AI`
- **AI摘要**: 提出多维度语音AI评估基准RW-Voice-EQ
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了语音AI真实场景评估空白，方法严谨且实用。

### 4. **[Dialogue Summarization with Emotion Dynamics Using Topic- and Participant-Centric Decomposition](https://arxiv.org/abs/2607.14769v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Linyun Xiang, Mark Neerincx, Stephanie Tan
- **标签**: `cs.CL` `cs.AI` `cs.MA`
- **AI摘要**: 提出基于主题与参与者分解的情感对话摘要框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多视角分解与情感轨迹建模提升了对话摘要质量

### 5. **[Language Identification via Compositional Data Analysis: A Linear-Time Classifier Based on Log-Ratio Geometry](https://arxiv.org/abs/2607.15238v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-07-16
- **作者**: Paul-Andrei Pogăcean, Sanda-Maria Avram
- **标签**: `cs.CL`
- **AI摘要**: 利用对数比几何实现高效语言识别
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法新颖且高效，但在复杂场景下实用性有限

## Vision Language Models

### 1. **[GeoDetect: Geometric Adversarial Detection for VLPs](https://arxiv.org/abs/2607.14737v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Afsaneh Hasanebrahimi, Hanxun Huang, Christopher Leckie et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 利用几何特性检测多模态模型对抗样本
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过量化指标与证据驱动推理有效提升模型鲁棒性

### 3. **[On Success and Simplicity: A Second Look at Transferable Vision-Language Attack Pipeline](https://arxiv.org/abs/2607.14974v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Yuchen Ren, Zhengyu Zhao, Chenhao Lin et al.
- **标签**: `cs.CV` `cs.CR`
- **AI摘要**: 提出SimVLA简化攻击流程，显著提升迁移性与效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过简化复杂流程并优化跨模态交互，在性能与效率上均有显著提升。

### 4. **[U-shaped Multi-granularity Learning for Vision-Language Models](https://arxiv.org/abs/2607.14966v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
...
- **评分理由**: 通过U型结构解决视觉语言模型粒度困境，实验表现优异。

### 5. **[VideoChat3: Fully Open Video MLLM for Efficient and Generalist Video Understanding](https://arxiv.org/abs/2607.14935v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Xinhao Li, Yuhan Zhu, Xiangyu Zeng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出高效全开源视频多模态大模型VideoChat3
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型架构创新且数据集全面，兼顾效率与泛化性能。

## Diffusion Models

### 1. **[WanSong v1.0 Technical Report](https://arxiv.org/abs/2607.14749v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-07-16
- **作者**: Binghui Chen, Pandeng Li, Yu Liu et al.
- **标签**: `eess.AS` `cs.CV`
- **AI摘要**: 基于扩散模型的长音频生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出了纯扩散模型生成长音频，技术路线创新且实用性强。

## Multimodal

### 1. **[Beyond Single Expert: Harmonizing Diverse Visual Priors in MLLMs for Spatial Understanding](https://arxiv.org/abs/2607.15054v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Xiao Lin, Xiaohu Huang, Kai Han
- **标签**: `cs.CV`
- **AI摘要**: 提出ViPS框架融合多模型视觉先验以提升MLLM空间理解能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态融合多模型先验实现空间理解突破，方法创新且实验详实。

### 2. **[Video = World + Event Stream](https://arxiv.org/abs/2607.15038v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Lianghua Huang, Zhi-Fan Wu, Yupeng Shi et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出将视频建模为世界与事件流的统一框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地解耦视频结构，实时交互性能表现优秀。

### 3. **[Multimodal Semantic-Aware Contrastive Learning For False Negative Mitigation in 3D Medical Imaging](https://arxiv.org/abs/2607.14995v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Sara Ketabi, Matthias W. Wagner, Cynthia Hawkins et al.
- **标签**: `cs.LG` `q-bio.QM`
- **AI摘要**: 提出MseaCL框架缓解医学影像对比学习假阴性问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过语义相似度引导优化对比学习，在脑肿瘤分类任务中表现优异。

### 4. **[An LLM-Based Automatic Sportscast Solution for Robot Soccer Matches](https://arxiv.org/abs/2607.14809v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Francesco Petri, Michele Brienza, Daniele Nardi et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出机器人足球赛自动解说系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合神经符号架构实现实时解说，创新性与实用性兼备。

### 5. **[Large Audio Language Models for Spoofing-Aware Speaker Verification](https://arxiv.org/abs/2607.14753v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-16
- **作者**: Sofya Savelyeva, Mariia Perunova, Evgeny Kushnir et al.
- **标签**: `cs.SD` `cs.AI`
- **AI摘要**: 利用大音频语言模型实现防欺骗说话人验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统评估了LALM在SASV任务中的潜力与局限，方法严谨。

## Agent

### 1. **[When Words Are Safe But Actions Kill: Probing Physical Danger Beyond Text Safety in Hidden-State Risk Space](https://arxiv.org/abs/2607.15218v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-07-16
- **作者**: Weimeng Wang, Ziqiang Wang, Zihang Zhan et al.
- **标签**: `cs.AI` `cs.CR`
- **AI摘要**: 提出PRISM探测器以识别具身智能体的物理安全风险。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了物理与文本危险的表征差异，方法论严谨且实用。

### 2. **[Stigmergic Graph Memory: An Environment-Aware Approach for Many-to-Many Multi-Agent Pickup and Delivery](https://arxiv.org/abs/2607.15182v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Aditya Dutta, Joon-Seok Kim
- **标签**: `cs.MA` `cs.RO`
- **AI摘要**: 提出SGM记忆层优化多智能体仓储调度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，显著提升了仓储吞吐效率。

### 3. **[Scaling Behavior Foundation Model for Humanoid Robots](https://arxiv.org/abs/2607.15163v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Weishuai Zeng, Kangning Yin, Xiaojie Niu et al.
- **标签**: `cs.RO` `cs.AI`
- **AI摘要**: 提出人形机器人行为基础模型及高效缩放范式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过运动追踪范式与架构优化显著提升控制精度与泛化性

### 4. **[Digital Pantheon: Simulating and Auditing Coalition Formation with LLM Agents](https://arxiv.org/abs/2607.15095v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Dylan Van Mulders, Matthias Bogaert, Dirk Van den Poel
- **标签**: `cs.CL` `cs.AI` `cs.MA`
- **AI摘要**: 基于LLM的政党联盟谈判模拟与溯源框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过DPO与RAG实现意识形态对齐，MILT溯源机制创新且严谨。

### 5. **[BrainPilot: Automating Brain Discovery with Agentic Research](https://arxiv.org/abs/2607.15079v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Haoxuan Li, Tianci Gao, Jianhe Li et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出BrainPilot多智能体系统，实现脑科学研究自动化。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统架构创新且具备高实用性，实验设计严谨且评估全面。

## Computer Vision

### 1. **[DAPGNet: Dynamic Adaptive Physics-Guided Graph Diffusion Network for Hyperspectral Image Classification](https://arxiv.org/abs/2607.15128v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Pengkun Wang, Weijia Cao, Ning Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出物理先验引导的图扩散网络用于高光谱图像分类
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新性强，实验充分且在多数据集上表现优异。

### 2. **[URVC: A Unified Real-Time Neural Video Coding Model with Temporal, Spatial, and Perceptual Adaptivity](https://arxiv.org/abs/2607.15033v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Xihua Sheng, Chang Wen Chen
- **标签**: `cs.MM`
- **AI摘要**: 提出一种具备时空与感知自适应的实时神经视频编码框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了神经视频编码的灵活性问题，方法创新且实用性强。

### 3. **[Demographically-Conditioned Synthetic Medical Images for Bias Mitigation and Bias Detection in Disease Classifiers](https://arxiv.org/abs/2607.14984v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Mahmoud Ibrahim, Bart Elen, Chang Sun et al.
- **标签**: `cs.AI`
- **AI摘要**: 利用扩散模型生成数据以缓解并检测医疗影像偏见
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将生成模型用于公平性审计，实验严谨且结论显著。

### 4. **[Domain Adaptation of Mismatched Proximal Denoiser for Plug-and-Play Image Reconstruction](https://arxiv.org/abs/2607.14894v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Guixian Xu, Jinglai Li, Junqi Tang
- **标签**: `eess.IV` `cs.LG` `math.OC`
- **AI摘要**: 提出近端匹配以解决PnP图像重建的域失配问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，提出的近端匹配方法在域适应中效果显著。

### 5. **[Physics-Informed Diffusion for Biomechanically Plausible 3D Sign Language Generation](https://arxiv.org/abs/2607.14836v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Emanuele Colonna, Moises Diaz, Gennaro Vessio et al.
- **标签**: `cs.CV`
- **AI摘要**: 引入物理约束的扩散模型提升手语生成质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理约束与扩散模型，有效解决骨骼运动真实性问题

## Machine Learning

### 1. **[Data Driven Block Replacement Scheduling](https://arxiv.org/abs/2607.15229v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Aniruddhan Ganesaraman, VIdyadhar Kulkarni
- **标签**: `cs.LG` `math.OC` `stat.AP`
- **AI摘要**: 提出数据驱动的块替换调度算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且界限最优，具有较强的工业应用价值。

### 2. **[Explaining Process Control Optimisation Recommendations via GradientSHAP and Implicit Differentiation](https://arxiv.org/abs/2607.14970v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Paul Darm, Cem Alpturk, Kenneth Ulrich et al.
- **标签**: `cs.AI`
- **AI摘要**: 利用IFT与SHAP实现工业优化过程的可解释性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合IFT与SHAP提升了优化解释的效率，具有较强的工业应用价值。

### 3. **[Evaluating Epistemic Uncertainty: Beyond OOD Detection and Active Learning](https://arxiv.org/abs/2607.14817v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Jakub Paplhám, Willem Waegeman, Eyke Hüllermeier et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出评估认知不确定性的新框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且揭示了现有评估指标的局限性

### 4. **[GAttNHP: Group Attention Neural Hawkes Process for Extrapolation Reasoning in Temporal Knowledge Graphs](https://arxiv.org/abs/2607.14733v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Xiangni Tian, Kaixian Yu, Runpeng Dai et al.
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出GAttNHP模型优化时序知识图谱预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合Hawkes过程与注意力机制，有效处理长尾时序依赖。

### 5. **[Scalable Training of Continuous-Time Spiking Neural Networks with Differentiable Spike-Time Discretization](https://arxiv.org/abs/2607.14672v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-16
- **作者**: Yusuke Sakemi, Tomoya Takeuchi, Takeo Hosomi et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出DSTD框架以高效训练脉冲神经网络
<details>
<summary>原始摘要</summary>
