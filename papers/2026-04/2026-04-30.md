...
### 1. **[MarkIt: Training-Free Visual Markers for Precise Video Temporal Grounding](https://arxiv.org/abs/2604.25886v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Pengcheng Fang, Yuxia Chen, Xiaohao Cai
- **标签**: `cs.MM`
- **AI摘要**: 提出MarkIt框架，通过视觉标记提升视频时序定位精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，无需训练且兼容性好，实验结果表现优异。

### 2. **[SIEVES: Selective Prediction Generalizes through Visual Evidence Scoring](https://arxiv.org/abs/2604.25855v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Hector G. Rodriguez, Marcus Rohrbach
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出SIEVES框架提升多模态模型选择性预测的可靠性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过视觉证据评分实现跨模型泛化，方法创新且实验扎实。

### 3. **[Instruction-Evidence Contrastive Dual-Stream Decoding for Grounded Vision-Language Reasoning](https://arxiv.org/abs/2604.25809v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Yashwant Pravinrao Bangde, Debaditya Roy
- **标签**: `cs.CV`
- **AI摘要**: 提出双流对比解码框架以增强视觉推理的忠实度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验全面，有效缓解了视觉语言模型的幻觉问题。

### 4. **[Toward Multimodal Conversational AI for Age-Related Macular Degeneration](https://arxiv.org/abs/2604.25720v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Ran Gu, Benjamin Hou, Mélanie Hébert et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出OcularChat实现AMD智能诊断与交互式临床解释
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型在AMD诊断任务上表现优异，且具备临床解释能力，方法严谨。

### 5. **[DDA-Thinker: Decoupled Dual-Atomic Reinforcement Learning for Reasoning-Driven Image Editing](https://arxiv.org/abs/2604.25477v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Hanqing Yang, Qiang Zhou, Yongchao Du et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出DDA-Thinker框架，通过双原子强化学习优化图像编辑推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解耦规划与生成，通过双原子奖励机制提升推理编辑能力，实验扎实。
...
### 1. **[Golden RPG: Confidence-Adaptive Region-Aware Noise for Compositional Text-to-Image Generation](https://arxiv.org/abs/2604.25314v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Hao Li
- **标签**: `cs.CV`
- **AI摘要**: 提出区域感知噪声预测器提升组合式文生图质量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，有效解决了多区域生成的语义瓶颈。

### 2. **[Refinement via Regeneration: Enlarging Modification Space Boosts Image Refinement in Unified Multimodal Models](https://arxiv.org/abs/2604.25636v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-28
- **作者**: Jiayi Guo, Linqing Wang, Jiangshan Wang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出RvR框架，通过条件重生成提升图像精修效果。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将精修从编辑转为重生成，实验结果显著。

### 3. **[GPT-Image-2 in the Wild: A Twitter Dataset of Self-Reported AI-Generated Images from the First Week of Deployment](https://arxiv.org/abs/2604.25370v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-28
- **作者**: Kidus Zewde, Simiao Ren, Xingyu Shen et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 发布首个GPT-Image-2推特数据集并揭示其元数据缺失问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 数据集构建严谨且具有时效性，对AI内容溯源有重要参考价值。

## Video Generation

### 1. **[Mutual Forcing: Dual-Mode Self-Evolution for Fast Autoregressive Audio-Video Character Generation](https://arxiv.org/abs/2604.25819v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Yupeng Zhou, Lianghua Huang, Zhifan Wu et al.
- **标签**: `cs.CV` `cs.SD`
- **AI摘要**: 提出互促机制实现高效音视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过自蒸馏优化推理效率，方法创新且实验扎实。

### 2. **[A Systematic Post-Train Framework for Video Generation](https://arxiv.org/abs/2604.25427v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-28
- **作者**: Zeyue Xue, Siming Fu, Jie Huang et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出视频生成模型后训练框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性整合SFT与RLHF，显著提升视频生成质量与效率。

### 3. **[HuM-Eval: A Coarse-to-Fine Framework for Human-Centric Video Evaluation](https://arxiv.org/abs/2604.25361v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-28
- **作者**: Bingzi Zhang, Kaisi Guan, Ruihua Song
- **标签**: `cs.CV`
- **AI摘要**: 提出一种以人为中心的视频评估框架HuM-Eval
<details>
<summary>原始摘要</summary>
...
### 1. **[Scalable Inference Architectures for Compound AI Systems: A Production Deployment Study](https://arxiv.org/abs/2604.25724v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Srikanta Prasad S, Utkarsh Arora
- **标签**: `cs.AI`
- **AI摘要**: 提出一种高效的复合AI系统推理架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过生产环境验证，显著提升了多智能体系统的性能与成本效益。

### 2. **[Assistants, Not Architects: The Role of LLMs in Networked Systems Design](https://arxiv.org/abs/2604.25506v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Pratyush Sahu, Rahul Bothra, Venkat Arun et al.
- **标签**: `cs.NI` `cs.AI`
- **AI摘要**: 提出Kepler框架优化网络系统架构设计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过SMT约束求解弥补LLM在架构设计中的逻辑缺陷

### 3. **[SpecFed: Accelerating Federated LLM Inference with Speculative Decoding and Compressed Transmission](https://arxiv.org/abs/2604.25777v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-28
- **作者**: Ce Zheng, Xinghan Wang, Jiahong Ning et al.
- **标签**: `eess.SP` `cs.DC`
- **AI摘要**: 提出SpecFed加速联邦LLM推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合投机解码与压缩传输，有效缓解联邦推理通信瓶颈。

### 4. **[Subspace Optimization for Efficient Federated Learning under Heterogeneous Data](https://arxiv.org/abs/2604.25467v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-28
- **作者**: Shuchen Zhu, Zhengyang Huang, Yuqi Xu et al.
- **标签**: `cs.LG` `math.OC`
- **AI摘要**: 提出子空间优化法提升联邦学习效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论严谨，有效缓解异构数据下的通信开销。

### 5. **[CUDA Kernel Optimization and Counter-Free Performance Analysis for Depthwise Convolution in Cloud Environments](https://arxiv.org/abs/2604.25422v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-28
- **作者**: Huriyeh Babak, Melanie Schaller
- **标签**: `cs.DC` `eess.SY`
- **AI摘要**: 提出无计数器CUDA内核优化与性能分析方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，对云端部署有参考价值

## Operating Systems

### 1. **[Embedded Rust or C Firmware? Lessons from an Industrial Microcontroller Use Case with Ariel OS](https://arxiv.org/abs/2604.25679v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-28
- **作者**: Bipin Thapa, Daniele Alfonso, Lorenzo Bini et al.
- **标签**: `cs.OS`
- **AI摘要**: 对比Rust与C在嵌入式固件中的性能与开发表现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实证研究证明Rust在嵌入式领域具备替代C的潜力

## Information Retrieval

### 1. **[Action-Aware Generative Sequence Modeling for Short Video Recommendation](https://arxiv.org/abs/2604.25834v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Wenhao Li, Zihan Lin, Zhengxiao Guo et al.
- **标签**: `cs.AI` `cs.IR`
- **AI摘要**: 提出A2Gen模型，通过细化动作序列提升短视频推荐精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型创新性强，工业界大规模部署验证了其实用价值与严谨性。

### 2. **[From Citation Selection to Citation Absorption: A Measurement Framework for Generative Engine Optimization Across AI Search Platforms](https://arxiv.org/abs/2604.25707v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Zhang Kai, Yao Jingang
- **标签**: `cs.IR`
- **AI摘要**: 提出生成式引擎优化框架，量化引用选择与吸收机制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 框架创新且实证详实，对搜索引擎优化具有重要参考价值。

### 3. **[K-CARE: Knowledge-driven Symmetrical Contextual Anchoring and Analogical Prototype Reasoning for E-commerce Relevance](https://arxiv.org/abs/2604.25683v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Chen Yifei, Tian Zhixing, Wang Chenyang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出K-CARE框架解决电商搜索相关性知识瓶颈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过外部知识增强与类比推理解决长尾问题，工业落地效果显著。

### 4. **[Health System Scale Semantic Search Across Unstructured Clinical Notes](https://arxiv.org/abs/2604.25605v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Faith Wavinya Mutinda, Spandana Makeneni, Anna Lin et al.
- **标签**: `cs.IR` `cs.AI` `cs.DB`
- **AI摘要**: 实现大规模临床笔记语义检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工程化落地效果显著，且具备临床实用价值。

### 5. **[Stop Using the Wilcoxon Test: Myth, Misconception and Misuse in IR Research](https://arxiv.org/abs/2604.25349v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Julián Urbano
- **标签**: `cs.IR` `stat.AP` `stat.ME`
- **AI摘要**: 揭示IR领域误用Wilcoxon检验的问题
<details>
<summary>原始摘要</summary>
...
### 1. **[Semi-Markov Reinforcement Learning for City-Scale EV Ride-Hailing with Feasibility-Guaranteed Actions](https://arxiv.org/abs/2604.25848v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-28
- **作者**: An Nguyen, Hoang Nguyen, Phuong Le et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出半马尔可夫决策模型优化电动车队调度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合MILP与强化学习，理论严谨且实验效果显著。

### 2. **[Optimization-Free Topological Sort for Causal Discovery via the Schur Complement of Score Jacobians](https://arxiv.org/abs/2604.25295v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-28
- **作者**: Rui Wu, Hong Xie
- **标签**: `cs.LG`
- **AI摘要**: 提出SSTS算法实现因果发现
...
- **评分理由**: 通过Schur补将因果发现转化为代数问题，创新性强且实验扎实。

### 3. **[Variational Neural Belief Parameterizations for Robust Dexterous Grasping under Multimodal Uncertainty](https://arxiv.org/abs/2604.25897v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Clinton Enwerem, Shreya Kalyanaraman, John S. Baras et al.
- **标签**: `cs.RO` `cs.LG` `eess.SY`
- **AI摘要**: 提出变分神经信念以提升灵巧抓取鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了抓取中的不确定性问题。

### 4. **[Barriers to Universal Reasoning With Transformers (And How to Overcome Them)](https://arxiv.org/abs/2604.25800v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Oliver Kraus, Yash Sarrof, Yuekun Yao et al.
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出符号标记法提升Transformer长度泛化能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深刻，通过符号标记法解决了长度泛化难题。

### 5. **[Residual-loss Anomaly Analysis of Physics-Informed Neural Networks: An Inverse Method for Change-point Detection in Nonlinear Dynamical Systems with Regime Switching](https://arxiv.org/abs/2604.25655v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-28
- **作者**: Yuhe Bai, Chengli Tan, Jiaqi Li et al.
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出基于PINN的非线性系统变点检测与参数估计统一框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验充分，有效解决了动力系统参数突变问题。
