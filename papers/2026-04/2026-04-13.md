...
### 1. **[Faithful GRPO: Improving Visual Spatial Reasoning in Multimodal Language Models via Constrained Policy Optimization](https://arxiv.org/abs/2604.08476v1)**
...
- **评分理由**: 方法创新且实验扎实，有效解决了多模态推理中的幻觉问题。

### 2. **[Lost in the Hype: Revealing and Dissecting the Performance Degradation of Medical Multimodal Large Language Models in Image Classification](https://arxiv.org/abs/2604.08333v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-09
- **作者**: Xun Zhu, Fanbin Mo, Xi Chen et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 揭示医疗多模态大模型分类性能退化的四大失效模式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过特征探测深入剖析模型性能瓶颈，方法严谨且具有重要临床指导意义

### 3. **[OpenVLThinkerV2: A Generalist Multimodal Reasoning Model for Multi-domain Visual Tasks](https://arxiv.org/abs/2604.08539v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-09
...
- **评分理由**: 方法创新且无需额外训练，实验验证充分，效果显著。

### 5. **[Phantasia: Context-Adaptive Backdoors in Vision Language Models](https://arxiv.org/abs/2604.08395v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-09
- **作者**: Nam Duong Tran, Phi Le Nguyen
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出Phantasia攻击，提升VLM后门隐蔽性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多奖励Langevin动力学优化生成，方法创新且效果显著。
...
- **评分理由**: 通过注意力机制引导实现无需训练的计数对齐，方法创新且实验扎实。
...
- **评分理由**: 创新性引入物理感知表征，方法论严谨且实验结果表现优异。
...
- **评分理由**: 结合联邦学习与LoRA实现隐私保护，方法创新且实验扎实。
...
- **标签**: `cs.DC` `cs.AI`
- **AI摘要**: 提出LegoDiffusion实现扩散模型微服务化与高效调度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解耦扩散工作流实现细粒度资源管理，性能提升显著。

### 3. **[Quantization Impact on the Accuracy and Communication Efficiency Trade-off in Federated Learning for Aerospace Predictive Maintenance](https://arxiv.org/abs/2604.08474v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-09
- **作者**: Abdelkarim Loukili
- **标签**: `cs.LG`
- **AI摘要**: 量化FL在航空预测维护中的通信与精度权衡研究
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实证分析揭示MIG局限并提出有效改进方案

### 5. **[NL-CPS: Reinforcement Learning-Based Kubernetes Control Plane Placement in Multi-Region Clusters](https://arxiv.org/abs/2604.08434v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-09
...
- **评分理由**: 利用神经上下文赌博机优化节点布局，方法新颖且实验充分。
...
- **评分理由**: 创新性引入Stackelberg博弈优化资源分配，实验严谨且实用价值极高。
...
- **标签**: `cs.CV`
- **AI摘要**: 提出Bag of Bags方法提升残片拼接检索效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了搜索与行为改变的机制，方法论严谨且具有实际应用意义。
...
- **AI摘要**: 提出卷积神经网络解码器，显著提升量子纠错性能与效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该研究在量子纠错领域实现突破，解码精度与速度大幅提升。
...
- **评分理由**: 方法创新且实验充分，在无监督环境下表现优异，具有高实用价值。
