...
### 1. **[V-tableR1: Process-Supervised Multimodal Table Reasoning with Critic-Guided Policy Optimization](https://arxiv.org/abs/2604.20755v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Yubo Jiang, Yitong An, Xin Yang et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出V-tableR1框架，实现表格推理的逻辑验证。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过过程监督强化学习提升视觉推理，方法创新且实验扎实。

### 2. **[Render-in-the-Loop: Vector Graphics Generation via Visual Self-Feedback](https://arxiv.org/abs/2604.20730v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Guotao Liang, Zhangcheng Wang, Juncheng Hu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出视觉反馈机制以优化SVG生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过视觉闭环提升SVG生成质量，方法新颖且实验扎实。

### 3. **[The Expense of Seeing: Attaining Trustworthy Multimodal Reasoning Within the Monolithic Paradigm](https://arxiv.org/abs/2604.20665v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Karan Goyal, Dikshant Kukreja
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出模态翻译协议以量化视觉瓶颈
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新深刻，通过信息论揭示多模态模型缺陷

### 4. **[Exploring Spatial Intelligence from a Generative Perspective](https://arxiv.org/abs/2604.20570v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Muzhi Zhu, Shunyao Jiang, Huanyi Zheng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出首个生成式空间智能评估基准GSI-Bench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入生成式空间评估，方法严谨且具有实用价值。

### 5. **[Evian: Towards Explainable Visual Instruction-tuning Data Auditing](https://arxiv.org/abs/2604.20544v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Zimu Jia, Mingjie Xu, Andrew Estornell et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出EVIAN框架实现视觉指令微调数据的可解释性审计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分解评估范式显著提升数据质量，方法创新且实验扎实。
...
### 1. **[DynamicRad: Content-Adaptive Sparse Attention for Long Video Diffusion](https://arxiv.org/abs/2604.20470v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Yongji Long, Shijun Liang, Jintao Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出动态稀疏注意力机制提升视频生成效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过自适应稀疏化显著提升推理速度，实验扎实且实用性强。

### 2. **[X-Cache: Cross-Chunk Block Caching for Few-Step Autoregressive World Models Inference](https://arxiv.org/abs/2604.20289v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Yixiao Zeng, Jianlei Zheng, Chaoda Zheng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出跨分块缓存机制加速世界模型推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决少步扩散模型推理瓶颈，实验扎实且加速显著。
...
### 1. **[Distributed Quantum Optimization for Large-Scale Higher-Order Problems with Dense Interactions](https://arxiv.org/abs/2604.20599v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Seongmin Kim, Vincent R. Pascuzzi, Travis S. Humble et al.
- **标签**: `quant-ph` `cs.CE` `cs.DC`
- **AI摘要**: 提出分布式量子优化框架解决大规模高阶优化问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过分布式策略有效提升了量子计算的实用性与规模。

### 2. **[FedSIR: Spectral Client Identification and Relabeling for Federated Learning with Noisy Labels](https://arxiv.org/abs/2604.20825v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-22
- **作者**: Sina Gholami, Abdulmoneam Ali, Tania Haghighi et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出FedSIR框架通过谱分析解决联邦学习标签噪声问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用谱一致性识别噪声并进行重标注，方法创新且实验扎实。

### 3. **[Distributed Quantum-Enhanced Optimization: A Topographical Preconditioning Approach for High-Dimensional Search](https://arxiv.org/abs/2604.20639v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-22
- **作者**: Dominik Soós, Marc Paterno, John Stenger et al.
- **标签**: `quant-ph` `cs.DC`
- **AI摘要**: 分布式量子预处理优化高维搜索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出量子预处理与经典求解结合，有效缓解高维优化瓶颈。

### 4. **[Differentially Private Clustered Federated Learning with Privacy-Preserving Initialization and Normality-Driven Aggregation](https://arxiv.org/abs/2604.20596v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-22
- **作者**: Jie Xu, Haaris Mehmood, Rogier Van Dalen et al.
- **标签**: `cs.LG` `cs.CR`
- **AI摘要**: 提出PINA框架实现隐私保护聚类联邦学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合LoRA与聚类机制，有效缓解DP噪声并提升收敛性。

### 5. **[Extending Contract Verification for Parallel Programming Models to Fortran](https://arxiv.org/abs/2604.20410v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-22
- **作者**: Yussur Mustafa Oraji, Christian Bischof
- **标签**: `cs.DC` `cs.PL`
- **AI摘要**: 将CoVer框架扩展至Fortran以实现并行程序验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过跨语言合同验证提升了并行计算的可靠性与效率

## Operating Systems

### 1. **[Mythos and the Unverified Cage: Z3-Based Pre-Deployment Verification for Frontier-Model Sandbox Infrastructure](https://arxiv.org/abs/2604.20496v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Dominik Blain
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出COBALT框架用于AI沙箱算术漏洞形式化验证
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合Z3求解器解决基础设施安全问题，方法严谨且实用。

## Information Retrieval

### 1. **[Self-Aware Vector Embeddings for Retrieval-Augmented Generation: A Neuroscience-Inspired Framework for Temporal, Confidence-Weighted, and Relational Knowledge](https://arxiv.org/abs/2604.20598v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-22
- **作者**: Naizhong Xu
- **标签**: `cs.IR` `cs.CL` `cs.DB`
- **AI摘要**: 提出SmartVector框架，实现RAG时效与置信度感知。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过神经科学启发提升了RAG的检索准确度与鲁棒性。

### 2. **[Coverage, Not Averages: Semantic Stratification for Trustworthy Retrieval Evaluation](https://arxiv.org/abs/2604.20763v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Andrew Klearman, Radu Revutchi, Rohin Garg et al.
- **标签**: `cs.IR` `cs.AI` `cs.LG`
- **AI摘要**: 提出语义分层评估法以提升检索系统可靠性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过统计学视角解决检索评估偏差，方法严谨且实用性强。

### 3. **[Break the Optimization Barrier of LLM-Enhanced Recommenders: A Theoretical Analysis and Practical Framework](https://arxiv.org/abs/2604.20490v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Zhangchi Zhu, Wei Zhang
- **标签**: `cs.IR`
- **AI摘要**: 提出TF-LLMER优化LLM推荐模型训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析深入，针对性解决优化瓶颈，实验扎实。

### 4. **[Unlocking the Forecasting Economy: A Suite of Datasets for the Full Lifecycle of Prediction Market: [Experiments \& Analysis]](https://arxiv.org/abs/2604.20421v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Huaiyu Jia, Luofeng Zhou, Wentao Zhang et al.
- **标签**: `cs.LG`
- **AI摘要**: 构建了去中心化预测市场的全生命周期数据集
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了预测市场数据整合空白，具有高实用价值与严谨性

### 5. **[Onyx: Cost-Efficient Disk-Oblivious ANN Search](https://arxiv.org/abs/2604.20401v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Deevashwer Rathee, Jean-Luc Watson, Zirui Neil Zhao et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出Onyx架构，优化SSD上隐私ANN搜索的成本与延迟。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过协同设计ANN与ORAM层，显著提升了隐私搜索的效率。
...
### 1. **[Gauge-Equivariant Graph Neural Networks for Lattice Gauge Theories](https://arxiv.org/abs/2604.20797v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-22
- **作者**: Ali Rayat, Yaohang Li, Gia-Wei Chern
- **标签**: `cond-mat.str-el` `cs.LG` `hep-lat`
- **AI摘要**: 提出规范等变图神经网络，解决晶格规范场论学习难题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，将规范对称性嵌入消息传递，理论与实验扎实。

### 2. **[Auto-ART: Structured Literature Synthesis and Automated Adversarial Robustness Testing](https://arxiv.org/abs/2604.20704v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-22
- **作者**: Abhijit Talluri
- **标签**: `cs.CR` `cs.LG`
- **AI摘要**: 提出Auto-ART框架实现对抗鲁棒性自动化评估与文献综合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合元科学分析与工程框架，有效弥补了鲁棒性评估的碎片化问题。

### 3. **[AAC: Admissible-by-Architecture Differentiable Landmark Compression for ALT](https://arxiv.org/abs/2604.20744v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-22
- **作者**: An T. Le, Vien Ngo
- **标签**: `cs.AI` `cs.LG` `cs.RO`
- **AI摘要**: 提出可微地标压缩模块，保证启发式搜索的容许性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论严谨，在路径规划领域具有实用价值。

### 4. **[Lifecycle-Aware Federated Continual Learning in Mobile Autonomous Systems](https://arxiv.org/abs/2604.20745v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Beining Wu, Jun Huang
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出生命周期感知的联邦持续学习框架以缓解模型遗忘。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了分布式系统的模型漂移。

### 5. **[Fast Bayesian equipment condition monitoring via simulation based inference: applications to heat exchanger health](https://arxiv.org/abs/2604.20735v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-22
- **作者**: Peter Collett, Alexander Johannes Stasik, Simone Casolo et al.
- **标签**: `cs.LG` `eess.SY` `physics.comp-ph`
- **AI摘要**: 利用SBI加速换热器故障诊断
<details>
<summary>原始摘要</summary>
