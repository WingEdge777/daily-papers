...
### 1. **[A systematic evaluation of vision-language models for observational astronomical reasoning tasks](https://arxiv.org/abs/2604.24589v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-27
- **作者**: Wenke Ren, Hengxiao Guo, Wenwen Zuo et al.
- **标签**: `cs.AI` `astro-ph.GA` `astro-ph.IM`
- **AI摘要**: 提出天文视觉语言模型基准AstroVLBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估了VLMs在天文任务中的表现，方法严谨且具有高实用价值。

### 2. **[EXACT: an explainable anomaly-aware vision foundation model for analysis of 3D chest CT](https://arxiv.org/abs/2604.24146v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-27
- **作者**: Xuguang Bai, Mingxuan Liu, Tongxi Song et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出EXACT模型实现3D CT异常定位与可解释分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型在弱监督下实现高精度定位，具有极高的临床应用价值。

### 3. **[Meta-CoT: Enhancing Granularity and Generalization in Image Editing](https://arxiv.org/abs/2604.24625v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Shiyi Zhang, Yiji Cheng, Tiankai Hang et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出Meta-CoT框架，通过两级分解提升图像编辑的粒度与泛化能力。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新性强，通过元任务分解显著提升了编辑性能与泛化性。

### 4. **[CF-VLA: Efficient Coarse-to-Fine Action Generation for Vision-Language-Action Policies](https://arxiv.org/abs/2604.24622v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Fan Du, Feng Yan, Jianxiong Wu et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出粗细结合的VLA动作生成框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过两阶段生成显著提升了机器人动作推理效率与性能

### 5. **[Improving Vision-language Models with Perception-centric Process Reward Models](https://arxiv.org/abs/2604.24583v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Yingqian Min, Kun Zhou, Yifan Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出感知导向过程奖励模型以提升VLM推理准确性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过细粒度过程奖励模型优化VLM推理，方法创新且实验扎实。
...
### 1. **[TextGround4M: A Prompt-Aligned Dataset for Layout-Aware Text Rendering](https://arxiv.org/abs/2604.24459v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Dongxing Mao, Yilin Wang, Linjie Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出TextGround4M数据集以提升文本渲染布局精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 大规模数据集与评估指标填补了布局感知生成的空白

### 2. **[Seeing Is No Longer Believing: Frontier Image Generation Models, Synthetic Visual Evidence, and Real-World Risk](https://arxiv.org/abs/2604.24197v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Shuai Wu, Xue Li, Yanna Feng et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 分析前沿图像模型带来的视觉证据造假风险与应对策略。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性评估了生成式视觉模型的社会风险并提出了多层防御框架。
...
- **作者**: Weijie Wang, Xiaoxuan He, Youping Gu et al.
- **标签**: `cs.CV`
- **AI摘要**: 通过强化学习和3D约束提升视频生成的几何一致性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将GRPO应用于视频3D一致性优化，平衡了生成质量与物理规律。
...
### 1. **[Incisor: Ex Ante Cloud Instance Selection for HPC Jobs](https://arxiv.org/abs/2604.24464v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Michael A. Laurenzano, Shihan Cheng, David A. B. Hyde
- **标签**: `cs.DC`
- **AI摘要**: 利用LLM自动化云端HPC实例选择
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合程序分析与LLM，显著降低云成本与运行时间

### 2. **[SpotVista: Availability-Aware Recommendation System for Reliable and Cost-Efficient Multi-Node Spot Instances](https://arxiv.org/abs/2604.24548v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-27
- **作者**: Taeyoon Kim, Kyumin Kim, Kyunghwan Kim et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出多节点竞价实例推荐系统SpotVista
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对多节点可用性优化，实验对比详实，实用价值高。

### 3. **[A Survey on Split Learning for LLM Fine-Tuning: Models, Systems, and Privacy Optimizations](https://arxiv.org/abs/2604.24468v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-27
- **作者**: Zihan Liu, Yizhen Wang, Rui Wang et al.
- **标签**: `cs.CR` `cs.CL` `cs.DC`
- **AI摘要**: 首个大模型拆分学习微调综述，涵盖模型、系统与隐私。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性梳理了拆分学习微调LLM领域，结构清晰，具有很高参考价值。

### 4. **[Exact, Efficient, and Reliable Multi-Objective and Multi-Constrained IoT Workflow Scheduling in Edge-Hub-Cloud Cyber-Physical Systems](https://arxiv.org/abs/2604.24340v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-27
- **作者**: Andreas Kouloumpris, Georgios L. Stavrinides, Maria K. Michael et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出边缘计算混合整数线性规划调度方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且对比实验充分，解决了多约束调度难题

### 5. **[X-NegoBox: An Explainable Privacy-Budget Negotiation Framework for Secure Peer-to-Peer Energy Data Exchange](https://arxiv.org/abs/2604.24326v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-27
- **作者**: Poushali Sengupta, Sabita Maharjan, Frank Eliassen et al.
- **标签**: `cs.CR` `cs.AI`
- **AI摘要**: 提出可解释的隐私预算协商框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入协商机制与可解释性，提升了隐私保护的灵活性。

## Information Retrieval

### 1. **[Learning to Rotate: Temporal and Semantic Rotary Encoding for Sequential Modeling](https://arxiv.org/abs/2604.24717v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-27
- **作者**: Hailing Cheng, Daqi Sun, Xinyu Lu
- **标签**: `cs.AI`
- **AI摘要**: 提出SIREN-RoPE将旋转空间参数化以增强注意力机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入可学习旋转维度，实验验证有效且开销极低

### 2. **[XGRAG: A Graph-Native Framework for Explaining KG-based Retrieval-Augmented Generation](https://arxiv.org/abs/2604.24623v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-27
- **作者**: Zhuoling Li, Ha Linh Hong Tran Nguyen, Valeria Bladinieres et al.
- **标签**: `cs.AI` `cs.IR` `cs.LG`
- **AI摘要**: 提出XGRAG框架实现图RAG的可解释性分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了图RAG的可解释性。

### 3. **[Modeling Behavioral Intensity and Transitions for Generative Recommendation](https://arxiv.org/abs/2604.24472v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-27
- **作者**: Wenxuan Yang, Xiaoyang Xu, Hanyu Zhang et al.
- **标签**: `cs.IR` `cs.AI` `cs.LG`
- **AI摘要**: 提出BITRec模型优化多行为推荐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过HBA与TRE机制显著提升了多行为序列建模的精度与效率

### 4. **[SEARCH-R: Structured Entity-Aware Retrieval with Chain-of-Reasoning Navigator for Multi-hop Question Answering](https://arxiv.org/abs/2604.24515v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-04-27
- **作者**: Yuqing Fu, Yimin Deng, Wanyu Wang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出SEARCH-R框架优化多跳问答的推理路径与检索效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合推理导航与依赖树检索，方法创新且实验验证充分。

### 5. **[Learning to Route Queries to Heads for Attention-based Re-ranking with Large Language Models](https://arxiv.org/abs/2604.24608v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-04-27
- **作者**: Yuxing Tian, Fengran Mo, Zhiqi Huang et al.
- **标签**: `cs.IR` `cs.AI` `cs.CL`
- **AI摘要**: 提出RouteHead实现查询自适应注意力头选择
<details>
<summary>原始摘要</summary>
...
### 1. **[The Optimal Sample Complexity of Multiclass and List Learning](https://arxiv.org/abs/2604.24749v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-04-27
- **作者**: Chirag Pabbaraju
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 确定了多类学习的最优样本复杂度，解决了长期存在的猜想。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 成功证明了DS维度对样本复杂度的决定性作用，解决了该领域十年来的核心难题。

### 2. **[Scalable Hyperparameter-Divergent Ensemble Training with Automatic Learning Rate Exploration for Large Models](https://arxiv.org/abs/2604.24708v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Hailing Cheng, Tao Huang, Chen Zhu et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出HDET框架实现多副本超参自动探索与优化。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性利用分布式副本进行超参搜索，实用性强。

### 3. **[Computational Design and Experimental Validation of Photoactive PARP1 Inhibitors](https://arxiv.org/abs/2604.24634v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Simon Axelrod, Miroslav Kašpar, Kristýna Jelínková et al.
- **标签**: `physics.chem-ph` `cs.LG`
- **AI摘要**: 计算驱动筛选光控PARP1抑制剂
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合计算模拟与实验验证，高效筛选光敏药物，方法严谨且具有临床转化潜力。

### 4. **[Enhancing molecular dynamics with equivariant machine-learned densities](https://arxiv.org/abs/2604.24563v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Mihail Bogojeski, Muhammad R. Hasyim, Leslie Vogt-Maranto et al.
- **标签**: `physics.chem-ph` `cs.LG` `stat.ML`
- **AI摘要**: 提出DenSNet实现电子密度预测与分子动力学模拟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过SE(3)等变网络预测电子密度，在分子模拟领域具有显著创新与实用价值。

### 5. **[Efficient learning by implicit exploration in bandit problems with side observations](https://arxiv.org/abs/2604.24555v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-27
- **作者**: Tomas Kocak, Gergely Neu, Michal Valko et al.
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出隐式探索算法解决部分可观测在线学习问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法在部分反馈环境下实现了近乎最优的遗憾界，理论严谨且具备高效性。
