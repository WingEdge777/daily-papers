...
### 1. **[Lost in Translation: Do LVLM Judges Generalize Across Languages?](https://arxiv.org/abs/2604.19405v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Md Tahmid Rahman Laskar, Mohammed Saidul Islam, Mir Tafseer Nayeem et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出首个多语言多模态评测基准MM-JudgeBench
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了多语言LVLM评测空白，实验规模大且分析深入。

### 2. **[SpanVLA: Efficient Action Bridging and Learning from Negative-Recovery Samples for Vision-Language-Action Model](https://arxiv.org/abs/2604.19710v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-21
- **作者**: Zewei Zhou, Ruining Yang, Xuewei et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出SpanVLA框架提升自动驾驶推理效率与鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合流匹配与GRPO优化，方法创新且实验详实，具有应用潜力。

### 3. **[Multi-modal Reasoning with LLMs for Visual Semantic Arithmetic](https://arxiv.org/abs/2604.19567v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-21
- **作者**: Chuou Xu, Liya Ji, Qifeng Chen
- **标签**: `cs.AI`
- **AI摘要**: 提出SAri-RFT框架提升多模态模型视觉语义推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过强化学习解决视觉语义算术难题，方法创新且实验扎实。

### 4. **[VCE: A zero-cost hallucination mitigation method of LVLMs via visual contrastive editing](https://arxiv.org/abs/2604.19412v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-21
- **作者**: Yanbin Huang, Yisen Li, Guiyao Tie et al.
- **标签**: `cs.CV` `cs.CL`
- **AI摘要**: 提出VCE方法，通过对比编辑抑制LVLM幻觉。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需微调，实验设计严谨，实用性强。

### 5. **[Assessing VLM-Driven Semantic-Affordance Inference for Non-Humanoid Robot Morphologies](https://arxiv.org/abs/2604.19509v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-04-21
- **作者**: Jess Jones, Raul Santos-Rodriguez, Sabine Hauert
- **标签**: `cs.RO` `cs.MA`
- **AI摘要**: 评估VLM在非人形机器人形态下的语义可供性推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究视角独特，实验设计严谨，揭示了VLM在机器人应用中的保守性局限。
...
### 1. **[Generative Drifting for Conditional Medical Image Generation](https://arxiv.org/abs/2604.19736v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Zirong Li, Siyuan Mei, Weiwen Wu et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GDM框架实现高效高保真3D医学图像生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入漂移框架，在保持单步推理的同时提升了生成质量。

### 2. **[Counting Worlds Branching Time Semantics for post-hoc Bias Mitigation in generative AI](https://arxiv.org/abs/2604.19431v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-04-21
- **作者**: Alessandro G. Buda, Giuseppe Primiero, Leonardo Ceragioli et al.
- **标签**: `cs.LO` `cs.AI`
- **AI摘要**: 提出CTLF逻辑以量化评估生成式AI的偏见问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入分支时间逻辑，为偏见缓解提供形式化保障

## Video Generation

### 1. **[CityRAG: Stepping Into a City via Spatially-Grounded Video Generation](https://arxiv.org/abs/2604.19741v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Gene Chou, Charles Herrmann, Kyle Genova et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CityRAG实现地理空间感知的视频生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过地理数据增强视频生成的一致性，方法创新且应用价值高。

### 2. **[CoInteract: Physically-Consistent Human-Object Interaction Video Synthesis via Spatially-Structured Co-Generation](https://arxiv.org/abs/2604.19636v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Xiangyang Luo, Xiaozhe Xin, Tao Feng et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出CoInteract实现物理一致的人机交互视频合成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过MoE与双流结构显著提升了交互视频的稳定性和真实感

### 3. **[TS-Attn: Temporal-wise Separable Attention for Multi-Event Video Generation](https://arxiv.org/abs/2604.19473v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Hongyu Zhang, Yufan Deng, Zilin Pan et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出TS-Attn机制提升多事件视频生成的一致性
<details>
<summary>原始摘要</summary>
...
### 4. **[ReImagine: Rethinking Controllable High-Quality Human Video Generation via Image-First Synthesis](https://arxiv.org/abs/2604.19720v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-21
- **作者**: Zhengwentai Sun, Keru Zheng, Chenghong Li et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于图像先验的人体视频生成框架
<details>
<summary>原始摘要</summary>
...
### 1. **[POLAR-PIC: A Holistic Framework for Matrixized PIC with Co-Designed Compute, Layout, and Communication](https://arxiv.org/abs/2604.19337v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-21
- **作者**: Yizhuo Rao, Xingjian Cui, Shangzhi Pang et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出POLAR-PIC框架优化等离子体模拟性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过协同设计显著提升大规模计算效率，实验详实。

### 2. **[FEPLB: Exploiting Copy Engines for Nearly Free MoE Load Balancing in Distributed Training](https://arxiv.org/abs/2604.19654v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Shuyao Qi, Haoyuan Liu, Shizhen Zhao
- **标签**: `cs.DC`
- **AI摘要**: 利用NVLink复制引擎实现MoE负载均衡
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性利用硬件特性优化通信，实验详实且实用。

### 3. **[DPC: A Distributed Page Cache over CXL](https://arxiv.org/abs/2604.19494v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Shai Bergman, Zhe Yang, Julien Eudine et al.
- **标签**: `cs.DC` `cs.OS`
- **AI摘要**: 基于CXL的分布式页缓存架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用CXL内存语义实现单副本缓存，显著提升性能

### 4. **[CROWDio: A Practical Mobile Crowd Computing Framework with Developer-Oriented Design, Adaptive Scheduling, and Fault Resilience](https://arxiv.org/abs/2604.19363v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Lakshani Manamperi, Disumi Pathirana, Thiwanka Pathirana et al.
- **标签**: `cs.DC`
- **AI摘要**: 提出CROWDio框架以优化移动众包计算的调度与容错
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统设计完备，实验评估充分，解决了移动计算关键痛点

### 5. **[Mass Matrix Assembly on Tensor Cores for Implicit Particle-In-Cell Methods](https://arxiv.org/abs/2604.19286v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Luca Pennati, Stefano Markidis
- **标签**: `cs.CE` `cs.DC`
- **AI摘要**: 利用张量核心加速隐式PIC方法中的质量矩阵组装
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过矩阵乘法重构算子，显著提升了计算效率与性能。

## Operating Systems

### 1. **[Scheduling Analysis of UAV Flight Control Workloads using Raspberry Pi 5 Using PREEMPT_RT Linux](https://arxiv.org/abs/2604.19275v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-21
- **作者**: Luiz Giacomossi, Håkan Forsberg, Ivan Tomasic et al.
- **标签**: `eess.SY` `cs.OS` `cs.RO`
- **AI摘要**: 分析树莓派5实时内核对无人机控制的延迟优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，对实时系统调度分析具有实用价值

## Information Retrieval

### 1. **[LoopCTR: Unlocking the Loop Scaling Power for Click-Through Rate Prediction](https://arxiv.org/abs/2604.19550v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Jiakai Tang, Runfeng Zhang, Weiqiu Wang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出LoopCTR实现计算与参数解耦的CTR预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出循环扩展范式，有效平衡性能与部署开销。

### 2. **[From Experience to Skill: Multi-Agent Generative Engine Optimization via Reusable Strategy Learning](https://arxiv.org/abs/2604.19516v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Beining Wu, Fuyou Mao, Jiong Lin et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出MAGEO框架实现生成式引擎优化策略复用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多智能体协作与策略蒸馏提升GEO效率与准确性

### 3. **[CS3: Efficient Online Capability Synergy for Two-Tower Recommendation](https://arxiv.org/abs/2604.19269v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Lixiang Wang, Shaoyun Shi, Peng Wang et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出CS3框架优化双塔召回性能
<details>
<summary>原始摘要</summary>
...
### 4. **[ECLASS-Augmented Semantic Product Search for Electronic Components](https://arxiv.org/abs/2604.19664v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-21
- **作者**: Nico Baumgart, Markus Lange-Hegermann, Jan Henze
- **标签**: `cs.IR`
- **AI摘要**: 利用ECLASS增强电子元件语义检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入工业标准提升了检索精度，方法扎实且实用。

### 5. **[From Top-1 to Top-K: A Reproducibility Study and Benchmarking of Counterfactual Explanations for Recommender Systems](https://arxiv.org/abs/2604.19663v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-21
- **作者**: Quang-Huy Nguyen, Thanh-Hai Nguyen, Khac-Manh Thai et al.
- **标签**: `cs.IR` `cs.LG`
- **AI摘要**: 系统性重现并评估推荐系统反事实解释方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过统一框架对11种方法进行基准测试，提升了领域可复现性。
...
### 1. **[An Efficient Black-Box Reduction from Online Learning to Multicalibration, and a New Route to $Φ$-Regret Minimization](https://arxiv.org/abs/2604.19592v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-21
...
- **评分理由**: 解决了多校准核心难题，理论贡献极高且简洁。

### 2. **[When Graph Structure Becomes a Liability: A Critical Re-Evaluation of Graph Neural Networks for Bitcoin Fraud Detection under Temporal Distribution Shift](https://arxiv.org/abs/2604.19514v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-21
- **作者**: Saket Maganti
- **标签**: `cs.LG` `cs.AI` `cs.CR`
- **AI摘要**: 揭示图神经网络在比特币欺诈检测中的数据泄露问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过严格归纳评估揭示了图结构的误导性，具有极高的实证价值。

### 3. **[Generalization at the Edge of Stability](https://arxiv.org/abs/2604.19740v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Mario Tuci, Caner Korkmaz, Umut Şimşekli et al.
- **标签**: `cs.LG` `cs.AI` `cs.CV`
- **AI摘要**: 提出锐度维度以解释神经网络泛化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新深刻，通过动力系统视角解释了边缘稳定性现象。

### 4. **[Ultrametric OGP - parametric RDT \emph{symmetric} binary perceptron connection](https://arxiv.org/abs/2604.19712v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Mihailo Stojnic
- **标签**: `cs.LG` `cond-mat.dis-nn` `cs.IT`
- **AI摘要**: 建立对称感知器OGP与参数化RDT的理论联系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，揭示了计算复杂性几何特征间的深刻联系

### 5. **[Learning Hybrid-Control Policies for High-Precision In-Contact Manipulation Under Uncertainty](https://arxiv.org/abs/2604.19677v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-21
- **作者**: Hunter L. Brown, Geoffrey Hollinger, Stefan Lee
- **标签**: `cs.RO` `cs.AI` `cs.LG`
- **AI摘要**: 提出MATCH框架实现高精度接触操作的混合力位控制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，有效提升了复杂环境下的操作成功率。
